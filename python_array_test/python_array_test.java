...
@A byte  v1;//Stub field
@D (4)byte []  ar_i8;//Value array
@D (4)@A byte []  ar_u8;//Value array
@D (4)@A short []  ar_u16;//Value array
@D (4)@A int []  ar_u32;//Value array
}
...
@A(5) String  c1;//Value array
@A(5) String  c2;//Value array
}
...
@A byte  v1;//Stub field
@A short  v2;//Stub field
@A int  v3;//Stub field
@D (2)@A int []  ar_u32;//Value array
@D (2)int []  ar_i32;//Value array
@D (2)@A short []  ar_u16;//Value array
@D (2)short []  ar_i16;//Value array
@D (2)@A byte []  ar_u8;//Value array
@D (2)byte []  ar_i8;//Value array
@A(32) String  ar_c;//Value array
@D (2)double []  ar_d;//Value array
@D (2)float []  ar_f;//Value array
}
