...
inline static e_MAV_MODE _en__v(UMAX id)
{
    switch(id)
    {
        case 0:
...
inline static UMAX _id__v(e_MAV_MODE en)
{
    switch(en)
    {
...
inline static UMAX _id__O(e_MAV_MISSION_TYPE en)
{
    switch(en)
    {
...
inline static UMAX _id__W(e_MAV_CMD en)
{
    switch(en)
    {
...
{
    uint8_t * data = src->data;
    return  _en__v(get_bits(data, 328, 4));
}
...
{
    uint8_t * data = src->data;
    return  _en__v(get_bits(data, 640, 4));
}
