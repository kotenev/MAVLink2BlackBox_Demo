...
*	This should match the commands sent in SET_POSITION_TARGET_LOCAL_NED if the vehicle is being controlled
*	this way*/
extern void c_CommunicationChannel_on_POSITION_TARGET_LOCAL_NED_3(Bounds_Inside * bi, Pack * pack);
/**
...
extern void c_CommunicationChannel_on_COMMAND_ACK_77(Bounds_Inside * bi, Pack * pack);
/**
*Setpoint in roll, pitch, yaw and thrust from the operator*/
Pack * c_CommunicationChannel_new_MANUAL_SETPOINT_81();
/**
*Setpoint in roll, pitch, yaw and thrust from the operator*/
extern void c_CommunicationChannel_on_MANUAL_SETPOINT_81(Bounds_Inside * bi, Pack * pack);
/**
...
*Sets a desired vehicle attitude. Used by an external controller to command the vehicle (manual controller
*	or other system)*/
extern void c_CommunicationChannel_on_SET_ATTITUDE_TARGET_82(Bounds_Inside * bi, Pack * pack);
/**
...
*Reports the current commanded attitude of the vehicle as specified by the autopilot. This should match
*	the commands sent in a SET_ATTITUDE_TARGET message if the vehicle is being controlled this way*/
extern void c_CommunicationChannel_on_ATTITUDE_TARGET_83(Bounds_Inside * bi, Pack * pack);
/**
...
*Sets a desired vehicle position in a local north-east-down coordinate frame. Used by an external controller
*	to command the vehicle (manual controller or other system)*/
extern void c_CommunicationChannel_on_SET_POSITION_TARGET_LOCAL_NED_84(Bounds_Inside * bi, Pack * pack);
/**
...
*Sets a desired vehicle position, velocity, and/or acceleration in a global coordinate system (WGS84).
*	Used by an external controller to command the vehicle (manual controller or other system)*/
extern void c_CommunicationChannel_on_SET_POSITION_TARGET_GLOBAL_INT_86(Bounds_Inside * bi, Pack * pack);
/**
*Reports the current commanded vehicle position, velocity, and acceleration as specified by the autopilot.
...
/**
*Array test #0.*/
extern void c_CommunicationChannel_on_ARRAY_TEST_0_150(Bounds_Inside * bi, Pack * pack);
/**
*Array test #1.*/
extern void c_CommunicationChannel_on_ARRAY_TEST_1_151(Bounds_Inside * bi, Pack * pack);
/**
*Array test #3.*/
extern void c_CommunicationChannel_on_ARRAY_TEST_3_153(Bounds_Inside * bi, Pack * pack);
/**
*Array test #4.*/
extern void c_CommunicationChannel_on_ARRAY_TEST_4_154(Bounds_Inside * bi, Pack * pack);
/**
*Array test #5.*/
extern void c_CommunicationChannel_on_ARRAY_TEST_5_155(Bounds_Inside * bi, Pack * pack);
/**
*Array test #6.*/
extern void c_CommunicationChannel_on_ARRAY_TEST_6_156(Bounds_Inside * bi, Pack * pack);
/**
*Array test #7.*/
extern void c_CommunicationChannel_on_ARRAY_TEST_7_157(Bounds_Inside * bi, Pack * pack);
/**
*Array test #8.*/
extern void c_CommunicationChannel_on_ARRAY_TEST_8_158(Bounds_Inside * bi, Pack * pack);
/**
...
inline static e_MAV_MODE _en__T(UMAX id)
{
    switch(id)
    {
        case 0:
...
inline static UMAX _id__T(e_MAV_MODE en)
{
    switch(en)
    {
...
inline static e_MAV_MISSION_TYPE _en__s(UMAX id)
{
    switch(id)
    {
        case 0:
...
inline static UMAX _id__s(e_MAV_MISSION_TYPE en)
{
    switch(en)
    {
...
inline static UMAX _id__E(e_MAV_CMD en)
{
    switch(en)
    {
...
{
    uint8_t * data = src->data;
    return  _en__T(get_bits(data, 328, 4));
}
...
{
    uint8_t * data = src->data;
    return  _en__T(get_bits(data, 640, 4));
}
...
INLINER uint16_t* p150_ar_u16_GET(Pack * src, uint16_t*  dst, int32_t pos) //Value array
{
    uint8_t * data = src->data;
...
INLINER uint32_t* p150_ar_u32_GET(Pack * src, uint32_t*  dst, int32_t pos) //Value array
{
    uint8_t * data = src->data;
    for(int32_t BYTE = 8, dst_max = pos + 4; pos < dst_max ; pos++,  BYTE += 4)
...
INLINER uint8_t p150_v1_GET(Pack * src)//Stub field
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  24, 1)));
}
INLINER int8_t* p150_ar_i8_GET(Pack * src, int8_t*  dst, int32_t pos) //Value array
{
    uint8_t * data = src->data;
...
INLINER uint8_t* p150_ar_u8_GET(Pack * src, uint8_t*  dst, int32_t pos) //Value array
{
    uint8_t * data = src->data;
...
INLINER uint32_t* p151_ar_u32_GET(Pack * src, uint32_t*  dst, int32_t pos) //Value array
{
    uint8_t * data = src->data;
...
INLINER uint32_t* p153_ar_u32_GET(Pack * src, uint32_t*  dst, int32_t pos) //Value array
{
    uint8_t * data = src->data;
    for(int32_t BYTE = 0, dst_max = pos + 4; pos < dst_max ; pos++,  BYTE += 4)
        dst[pos] = ((get_bytes(data,  BYTE, 4)));
...
INLINER uint8_t p153_v_GET(Pack * src)//Stub field
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  16, 1)));
}
INLINER uint32_t* p154_ar_u32_GET(Pack * src, uint32_t*  dst, int32_t pos) //Value array
{
    uint8_t * data = src->data;
    for(int32_t BYTE = 0, dst_max = pos + 4; pos < dst_max ; pos++,  BYTE += 4)
        dst[pos] = ((get_bytes(data,  BYTE, 4)));
...
INLINER uint8_t p154_v_GET(Pack * src)//Stub field
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  16, 1)));
}
INLINER char16_t * p155_c1_GET(Bounds_Inside * src, char16_t *  dst, int32_t pos) //Value array
{
    uint8_t * data = src->base.pack->data;
...
INLINER char16_t * p155_c2_GET(Bounds_Inside * src, char16_t *  dst, int32_t pos) //Value array
{
    uint8_t * data = src->base.pack->data;
    for(int32_t BYTE = src->BYTE, dst_max = pos + src->items; pos < dst_max ; pos++,  BYTE += 2)
        dst[pos] = ((get_bytes(data,  BYTE, 2)));
...
INLINER uint16_t p156_v2_GET(Pack * src)//Stub field
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  0, 2)));
}
INLINER uint16_t* p156_ar_u16_GET(Pack * src, uint16_t*  dst, int32_t pos) //Value array
{
    uint8_t * data = src->data;
...
INLINER uint32_t p156_v3_GET(Pack * src)//Stub field
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  6, 4)));
}
INLINER uint32_t* p156_ar_u32_GET(Pack * src, uint32_t*  dst, int32_t pos) //Value array
{
    uint8_t * data = src->data;
...
INLINER uint8_t p156_v1_GET(Pack * src)//Stub field
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  18, 1)));
}
INLINER int32_t* p156_ar_i32_GET(Pack * src, int32_t*  dst, int32_t pos) //Value array
{
    uint8_t * data = src->data;
...
INLINER int16_t* p156_ar_i16_GET(Pack * src, int16_t*  dst, int32_t pos) //Value array
{
    uint8_t * data = src->data;
...
INLINER uint8_t* p156_ar_u8_GET(Pack * src, uint8_t*  dst, int32_t pos) //Value array
{
    uint8_t * data = src->data;
...
INLINER int8_t* p156_ar_i8_GET(Pack * src, int8_t*  dst, int32_t pos) //Value array
{
    uint8_t * data = src->data;
...
INLINER double* p156_ar_d_GET(Pack * src, double*  dst, int32_t pos) //Value array
{
    uint8_t * data = src->data;
...
INLINER float* p156_ar_f_GET(Pack * src, float*  dst, int32_t pos) //Value array
{
    uint8_t * data = src->data;
...
INLINER char16_t * p156_ar_c_GET(Bounds_Inside * src, char16_t *  dst, int32_t pos) //Value array
{
    uint8_t * data = src->base.pack->data;
    for(int32_t BYTE = src->BYTE, dst_max = pos + src->items; pos < dst_max ; pos++,  BYTE += 2)
        dst[pos] = ((get_bytes(data,  BYTE, 2)));
...
INLINER uint16_t* p157_ar_u16_GET(Pack * src, uint16_t*  dst, int32_t pos) //Value array
{
    uint8_t * data = src->data;
...
INLINER uint32_t* p157_ar_u32_GET(Pack * src, uint32_t*  dst, int32_t pos) //Value array
{
    uint8_t * data = src->data;
...
INLINER double* p157_ar_d_GET(Pack * src, double*  dst, int32_t pos) //Value array
{
    uint8_t * data = src->data;
...
INLINER float* p157_ar_f_GET(Pack * src, float*  dst, int32_t pos) //Value array
{
    uint8_t * data = src->data;
...
INLINER int32_t* p157_ar_i32_GET(Pack * src, int32_t*  dst, int32_t pos) //Value array
{
    uint8_t * data = src->data;
...
INLINER int16_t* p157_ar_i16_GET(Pack * src, int16_t*  dst, int32_t pos) //Value array
{
    uint8_t * data = src->data;
...
INLINER uint8_t* p157_ar_u8_GET(Pack * src, uint8_t*  dst, int32_t pos) //Value array
{
    uint8_t * data = src->data;
...
INLINER int8_t* p157_ar_i8_GET(Pack * src, int8_t*  dst, int32_t pos) //Value array
{
    uint8_t * data = src->data;
...
INLINER char16_t * p157_ar_c_GET(Bounds_Inside * src, char16_t *  dst, int32_t pos) //Value array
{
    uint8_t * data = src->base.pack->data;
    for(int32_t BYTE = src->BYTE, dst_max = pos + src->items; pos < dst_max ; pos++,  BYTE += 2)
        dst[pos] = ((get_bytes(data,  BYTE, 2)));
...
INLINER uint16_t* p158_ar_u16_GET(Pack * src, uint16_t*  dst, int32_t pos) //Value array
{
    uint8_t * data = src->data;
    for(int32_t BYTE = 0, dst_max = pos + 2; pos < dst_max ; pos++,  BYTE += 2)
        dst[pos] = ((get_bytes(data,  BYTE, 2)));
...
INLINER uint32_t p158_v3_GET(Pack * src)//Stub field
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  4, 4)));
}
INLINER double* p158_ar_d_GET(Pack * src, double*  dst, int32_t pos) //Value array
{
    uint8_t * data = src->data;
