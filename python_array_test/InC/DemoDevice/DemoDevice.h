...
{
    if(src->base.field_bit !=  10 && !try_visit_field(src, 10)) return 0;
    uint8_t * data = src->base.pack->data;
    return ((get_bytes(data,  src->BYTE, 1)));
}
INLINER void p77_progress_SET(uint8_t  src, Bounds_Inside * dst)
{
    if(dst->base.field_bit != 10)insert_field(dst, 10, 0);
    uint8_t * data = dst->base.pack->data;
...
INLINER uint16_t* p150_ar_u16_GET(Pack * src, uint16_t*  dst, int32_t pos) //Value arra
{
    uint8_t * data = src->data;
    for(int32_t BYTE = 0, dst_max = pos + 4; pos < dst_max ; pos++,  BYTE += 2)
        dst[pos] = ((get_bytes(data,  BYTE, 2)));
    return dst;
}

static const  uint32_t p150_ar_u16_LEN = 4; //return array length

INLINER  uint16_t*  p150_ar_u16_GET_(Pack * src) {return p150_ar_u16_GET(src, malloc(4 * sizeof(uint16_t)), 0);}
INLINER void p150_ar_u16_SET(uint16_t*  src, int32_t pos, Pack * dst) //Value arra
{
    uint8_t * data = dst->data;
    for(int32_t BYTE =  0, src_max = pos + 4; pos < src_max; pos++, BYTE += 2)
        set_bytes((src[pos]), 2, data,  BYTE);
}
INLINER uint32_t* p150_ar_u32_GET(Pack * src, uint32_t*  dst, int32_t pos) //Value arra
{
    uint8_t * data = src->data;
    for(int32_t BYTE = 8, dst_max = pos + 4; pos < dst_max ; pos++,  BYTE += 4)
...
static const  uint32_t p150_ar_u32_LEN = 4; //return array length

INLINER  uint32_t*  p150_ar_u32_GET_(Pack * src) {return p150_ar_u32_GET(src, malloc(4 * sizeof(uint32_t)), 0);}
INLINER void p150_ar_u32_SET(uint32_t*  src, int32_t pos, Pack * dst) //Value arra
{
    uint8_t * data = dst->data;
    for(int32_t BYTE =  8, src_max = pos + 4; pos < src_max; pos++, BYTE += 4)
        set_bytes((src[pos]), 4, data,  BYTE);
}
INLINER uint8_t p150_v1_GET(Pack * src)//Stub fiel
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  24, 1)));
}
INLINER void p150_v1_SET(uint8_t  src, Pack * dst)//Stub fiel
{
    uint8_t * data = dst->data;
    set_bytes((src), 1, data,  24);
}
INLINER int8_t* p150_ar_i8_GET(Pack * src, int8_t*  dst, int32_t pos) //Value arra
{
    uint8_t * data = src->data;
    for(int32_t BYTE = 25, dst_max = pos + 4; pos < dst_max ; pos++,  BYTE += 1)
        dst[pos] = ((int8_t)(get_bytes(data,  BYTE, 1)));
    return dst;
}

static const  uint32_t p150_ar_i8_LEN = 4; //return array length

INLINER  int8_t*  p150_ar_i8_GET_(Pack * src) {return p150_ar_i8_GET(src, malloc(4 * sizeof(int8_t)), 0);}
INLINER void p150_ar_i8_SET(int8_t*  src, int32_t pos, Pack * dst) //Value arra
{
    uint8_t * data = dst->data;
    for(int32_t BYTE =  25, src_max = pos + 4; pos < src_max; pos++, BYTE += 1)
        set_bytes((uint8_t)(src[pos]), 1, data,  BYTE);
}
INLINER uint8_t* p150_ar_u8_GET(Pack * src, uint8_t*  dst, int32_t pos) //Value arra
{
    uint8_t * data = src->data;
    for(int32_t BYTE = 29, dst_max = pos + 4; pos < dst_max ; pos++,  BYTE += 1)
        dst[pos] = ((get_bytes(data,  BYTE, 1)));
    return dst;
}

static const  uint32_t p150_ar_u8_LEN = 4; //return array length

INLINER  uint8_t*  p150_ar_u8_GET_(Pack * src) {return p150_ar_u8_GET(src, malloc(4 * sizeof(uint8_t)), 0);}
INLINER void p150_ar_u8_SET(uint8_t*  src, int32_t pos, Pack * dst) //Value arra
{
    uint8_t * data = dst->data;
    for(int32_t BYTE =  29, src_max = pos + 4; pos < src_max; pos++, BYTE += 1)
        set_bytes((src[pos]), 1, data,  BYTE);
}
INLINER uint32_t* p151_ar_u32_GET(Pack * src, uint32_t*  dst, int32_t pos) //Value arra
{
    uint8_t * data = src->data;
    for(int32_t BYTE = 0, dst_max = pos + 4; pos < dst_max ; pos++,  BYTE += 4)
        dst[pos] = ((get_bytes(data,  BYTE, 4)));
    return dst;
}

static const  uint32_t p151_ar_u32_LEN = 4; //return array length

INLINER  uint32_t*  p151_ar_u32_GET_(Pack * src) {return p151_ar_u32_GET(src, malloc(4 * sizeof(uint32_t)), 0);}
INLINER void p151_ar_u32_SET(uint32_t*  src, int32_t pos, Pack * dst) //Value arra
{
    uint8_t * data = dst->data;
    for(int32_t BYTE =  0, src_max = pos + 4; pos < src_max; pos++, BYTE += 4)
        set_bytes((src[pos]), 4, data,  BYTE);
}
INLINER uint32_t* p153_ar_u32_GET(Pack * src, uint32_t*  dst, int32_t pos) //Value arra
{
    uint8_t * data = src->data;
    for(int32_t BYTE = 0, dst_max = pos + 4; pos < dst_max ; pos++,  BYTE += 4)
        dst[pos] = ((get_bytes(data,  BYTE, 4)));
...
static const  uint32_t p153_ar_u32_LEN = 4; //return array length

INLINER  uint32_t*  p153_ar_u32_GET_(Pack * src) {return p153_ar_u32_GET(src, malloc(4 * sizeof(uint32_t)), 0);}
INLINER void p153_ar_u32_SET(uint32_t*  src, int32_t pos, Pack * dst) //Value arra
{
    uint8_t * data = dst->data;
    for(int32_t BYTE =  0, src_max = pos + 4; pos < src_max; pos++, BYTE += 4)
        set_bytes((src[pos]), 4, data,  BYTE);
}
INLINER uint8_t p153_v_GET(Pack * src)//Stub fiel
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  16, 1)));
}
INLINER void p153_v_SET(uint8_t  src, Pack * dst)//Stub fiel
{
    uint8_t * data = dst->data;
    set_bytes((src), 1, data,  16);
}
INLINER uint32_t* p154_ar_u32_GET(Pack * src, uint32_t*  dst, int32_t pos) //Value arra
{
    uint8_t * data = src->data;
    for(int32_t BYTE = 0, dst_max = pos + 4; pos < dst_max ; pos++,  BYTE += 4)
        dst[pos] = ((get_bytes(data,  BYTE, 4)));
...
static const  uint32_t p154_ar_u32_LEN = 4; //return array length

INLINER  uint32_t*  p154_ar_u32_GET_(Pack * src) {return p154_ar_u32_GET(src, malloc(4 * sizeof(uint32_t)), 0);}
INLINER void p154_ar_u32_SET(uint32_t*  src, int32_t pos, Pack * dst) //Value arra
{
    uint8_t * data = dst->data;
    for(int32_t BYTE =  0, src_max = pos + 4; pos < src_max; pos++, BYTE += 4)
        set_bytes((src[pos]), 4, data,  BYTE);
}
INLINER uint8_t p154_v_GET(Pack * src)//Stub fiel
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  16, 1)));
}
INLINER void p154_v_SET(uint8_t  src, Pack * dst)//Stub fiel
{
    uint8_t * data = dst->data;
    set_bytes((src), 1, data,  16);
}
INLINER char16_t * p155_c1_GET(Bounds_Inside * src, char16_t *  dst, int32_t pos) //Value arra
{
    uint8_t * data = src->base.pack->data;
    for(int32_t BYTE = src->BYTE, dst_max = pos + src->items; pos < dst_max ; pos++,  BYTE += 2)
        dst[pos] = ((get_bytes(data,  BYTE, 2)));
...
INLINER int32_t p155_c1_LEN(Bounds_Inside * src)
{
    return (src->base.field_bit !=  0 && !try_visit_field(src, 0)  ||  !try_visit_item(src, 0)) ? 0 : src->items;
}
INLINER  char16_t* p155_c1_TRY_(Bounds_Inside * src)
{
    if(src->base.field_bit !=  0 && !try_visit_field(src, 0)  ||  !try_visit_item(src, 0)) return NULL;
    char16_t * ret = p155_c1_GET(src, malloc((src->items + 1) * 2), 0);
    ret[src->items] = 0;//the terminating null character.
    return ret;
}
INLINER void p155_c1_SET(char16_t *  src, int32_t pos, int32_t items, Bounds_Inside * dst) //Value arra
{
    if(dst->base.field_bit != 0 && insert_field(dst, 0, items) ||
            ! try_visit_item(dst, 0)) insert_item(dst, 0, items);
    uint8_t * data = dst->base.pack->data;
...
INLINER char16_t * p155_c2_GET(Bounds_Inside * src, char16_t *  dst, int32_t pos) //Value arra
{
    uint8_t * data = src->base.pack->data;
    for(int32_t BYTE = src->BYTE, dst_max = pos + src->items; pos < dst_max ; pos++,  BYTE += 2)
        dst[pos] = ((get_bytes(data,  BYTE, 2)));
...
INLINER int32_t p155_c2_LEN(Bounds_Inside * src)
{
    return (src->base.field_bit !=  1 && !try_visit_field(src, 1)  ||  !try_visit_item(src, 0)) ? 0 : src->items;
}
INLINER  char16_t* p155_c2_TRY_(Bounds_Inside * src)
{
    if(src->base.field_bit !=  1 && !try_visit_field(src, 1)  ||  !try_visit_item(src, 0)) return NULL;
    char16_t * ret = p155_c2_GET(src, malloc((src->items + 1) * 2), 0);
    ret[src->items] = 0;//the terminating null character.
    return ret;
}
INLINER void p155_c2_SET(char16_t *  src, int32_t pos, int32_t items, Bounds_Inside * dst) //Value arra
{
...
INLINER uint16_t p156_v2_GET(Pack * src)//Stub fiel
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  0, 2)));
}
INLINER void p156_v2_SET(uint16_t  src, Pack * dst)//Stub fiel
{
    uint8_t * data = dst->data;
    set_bytes((src), 2, data,  0);
}
INLINER uint16_t* p156_ar_u16_GET(Pack * src, uint16_t*  dst, int32_t pos) //Value arra
{
    uint8_t * data = src->data;
    for(int32_t BYTE = 2, dst_max = pos + 2; pos < dst_max ; pos++,  BYTE += 2)
        dst[pos] = ((get_bytes(data,  BYTE, 2)));
    return dst;
}

static const  uint32_t p156_ar_u16_LEN = 2; //return array length

INLINER  uint16_t*  p156_ar_u16_GET_(Pack * src) {return p156_ar_u16_GET(src, malloc(2 * sizeof(uint16_t)), 0);}
INLINER void p156_ar_u16_SET(uint16_t*  src, int32_t pos, Pack * dst) //Value arra
{
    uint8_t * data = dst->data;
    for(int32_t BYTE =  2, src_max = pos + 2; pos < src_max; pos++, BYTE += 2)
        set_bytes((src[pos]), 2, data,  BYTE);
}
INLINER uint32_t p156_v3_GET(Pack * src)//Stub fiel
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  6, 4)));
}
INLINER void p156_v3_SET(uint32_t  src, Pack * dst)//Stub fiel
{
    uint8_t * data = dst->data;
    set_bytes((src), 4, data,  6);
}
INLINER uint32_t* p156_ar_u32_GET(Pack * src, uint32_t*  dst, int32_t pos) //Value arra
{
    uint8_t * data = src->data;
    for(int32_t BYTE = 10, dst_max = pos + 2; pos < dst_max ; pos++,  BYTE += 4)
        dst[pos] = ((get_bytes(data,  BYTE, 4)));
    return dst;
}

static const  uint32_t p156_ar_u32_LEN = 2; //return array length

INLINER  uint32_t*  p156_ar_u32_GET_(Pack * src) {return p156_ar_u32_GET(src, malloc(2 * sizeof(uint32_t)), 0);}
INLINER void p156_ar_u32_SET(uint32_t*  src, int32_t pos, Pack * dst) //Value arra
{
    uint8_t * data = dst->data;
    for(int32_t BYTE =  10, src_max = pos + 2; pos < src_max; pos++, BYTE += 4)
        set_bytes((src[pos]), 4, data,  BYTE);
}
INLINER uint8_t p156_v1_GET(Pack * src)//Stub fiel
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  18, 1)));
}
INLINER void p156_v1_SET(uint8_t  src, Pack * dst)//Stub fiel
{
    uint8_t * data = dst->data;
    set_bytes((src), 1, data,  18);
}
INLINER int32_t* p156_ar_i32_GET(Pack * src, int32_t*  dst, int32_t pos) //Value arra
{
    uint8_t * data = src->data;
    for(int32_t BYTE = 19, dst_max = pos + 2; pos < dst_max ; pos++,  BYTE += 4)
        dst[pos] = ((int32_t)(get_bytes(data,  BYTE, 4)));
    return dst;
}

static const  uint32_t p156_ar_i32_LEN = 2; //return array length

INLINER  int32_t*  p156_ar_i32_GET_(Pack * src) {return p156_ar_i32_GET(src, malloc(2 * sizeof(int32_t)), 0);}
INLINER void p156_ar_i32_SET(int32_t*  src, int32_t pos, Pack * dst) //Value arra
{
    uint8_t * data = dst->data;
    for(int32_t BYTE =  19, src_max = pos + 2; pos < src_max; pos++, BYTE += 4)
        set_bytes((uint32_t)(src[pos]), 4, data,  BYTE);
}
INLINER int16_t* p156_ar_i16_GET(Pack * src, int16_t*  dst, int32_t pos) //Value arra
{
    uint8_t * data = src->data;
    for(int32_t BYTE = 27, dst_max = pos + 2; pos < dst_max ; pos++,  BYTE += 2)
        dst[pos] = ((int16_t)(get_bytes(data,  BYTE, 2)));
    return dst;
}

static const  uint32_t p156_ar_i16_LEN = 2; //return array length

INLINER  int16_t*  p156_ar_i16_GET_(Pack * src) {return p156_ar_i16_GET(src, malloc(2 * sizeof(int16_t)), 0);}
INLINER void p156_ar_i16_SET(int16_t*  src, int32_t pos, Pack * dst) //Value arra
{
    uint8_t * data = dst->data;
    for(int32_t BYTE =  27, src_max = pos + 2; pos < src_max; pos++, BYTE += 2)
        set_bytes((uint16_t)(src[pos]), 2, data,  BYTE);
}
INLINER uint8_t* p156_ar_u8_GET(Pack * src, uint8_t*  dst, int32_t pos) //Value arra
{
    uint8_t * data = src->data;
    for(int32_t BYTE = 31, dst_max = pos + 2; pos < dst_max ; pos++,  BYTE += 1)
        dst[pos] = ((get_bytes(data,  BYTE, 1)));
    return dst;
}

static const  uint32_t p156_ar_u8_LEN = 2; //return array length

INLINER  uint8_t*  p156_ar_u8_GET_(Pack * src) {return p156_ar_u8_GET(src, malloc(2 * sizeof(uint8_t)), 0);}
INLINER void p156_ar_u8_SET(uint8_t*  src, int32_t pos, Pack * dst) //Value arra
{
    uint8_t * data = dst->data;
    for(int32_t BYTE =  31, src_max = pos + 2; pos < src_max; pos++, BYTE += 1)
        set_bytes((src[pos]), 1, data,  BYTE);
}
INLINER int8_t* p156_ar_i8_GET(Pack * src, int8_t*  dst, int32_t pos) //Value arra
{
    uint8_t * data = src->data;
    for(int32_t BYTE = 33, dst_max = pos + 2; pos < dst_max ; pos++,  BYTE += 1)
        dst[pos] = ((int8_t)(get_bytes(data,  BYTE, 1)));
    return dst;
}

static const  uint32_t p156_ar_i8_LEN = 2; //return array length

INLINER  int8_t*  p156_ar_i8_GET_(Pack * src) {return p156_ar_i8_GET(src, malloc(2 * sizeof(int8_t)), 0);}
INLINER void p156_ar_i8_SET(int8_t*  src, int32_t pos, Pack * dst) //Value arra
{
    uint8_t * data = dst->data;
    for(int32_t BYTE =  33, src_max = pos + 2; pos < src_max; pos++, BYTE += 1)
        set_bytes((uint8_t)(src[pos]), 1, data,  BYTE);
}
INLINER double* p156_ar_d_GET(Pack * src, double*  dst, int32_t pos) //Value arra
{
    uint8_t * data = src->data;
    for(int32_t BYTE = 35, dst_max = pos + 2; pos < dst_max ; pos++,  BYTE += 8)
        dst[pos] = (longBitsToDouble(get_bytes(data,  BYTE, 8)));
    return dst;
}

static const  uint32_t p156_ar_d_LEN = 2; //return array length

INLINER  double*  p156_ar_d_GET_(Pack * src) {return p156_ar_d_GET(src, malloc(2 * sizeof(double)), 0);}
INLINER void p156_ar_d_SET(double*  src, int32_t pos, Pack * dst) //Value arra
{
    uint8_t * data = dst->data;
    for(int32_t BYTE =  35, src_max = pos + 2; pos < src_max; pos++, BYTE += 8)
        set_bytes(doubleToLongBits(src[pos]), 8, data,  BYTE);
}
INLINER float* p156_ar_f_GET(Pack * src, float*  dst, int32_t pos) //Value arra
{
    uint8_t * data = src->data;
    for(int32_t BYTE = 51, dst_max = pos + 2; pos < dst_max ; pos++,  BYTE += 4)
        dst[pos] = (intBitsToFloat(get_bytes(data,  BYTE, 4)));
    return dst;
}

static const  uint32_t p156_ar_f_LEN = 2; //return array length

INLINER  float*  p156_ar_f_GET_(Pack * src) {return p156_ar_f_GET(src, malloc(2 * sizeof(float)), 0);}
INLINER void p156_ar_f_SET(float*  src, int32_t pos, Pack * dst) //Value arra
{
    uint8_t * data = dst->data;
    for(int32_t BYTE =  51, src_max = pos + 2; pos < src_max; pos++, BYTE += 4)
        set_bytes(floatToIntBits(src[pos]), 4, data,  BYTE);
}
INLINER char16_t * p156_ar_c_GET(Bounds_Inside * src, char16_t *  dst, int32_t pos) //Value arra
{
    uint8_t * data = src->base.pack->data;
    for(int32_t BYTE = src->BYTE, dst_max = pos + src->items; pos < dst_max ; pos++,  BYTE += 2)
        dst[pos] = ((get_bytes(data,  BYTE, 2)));
...
INLINER int32_t p156_ar_c_LEN(Bounds_Inside * src)
{
    return (src->base.field_bit !=  472 && !try_visit_field(src, 472)  ||  !try_visit_item(src, 0)) ? 0 : src->items;
}
INLINER  char16_t* p156_ar_c_TRY_(Bounds_Inside * src)
{
    if(src->base.field_bit !=  472 && !try_visit_field(src, 472)  ||  !try_visit_item(src, 0)) return NULL;
    char16_t * ret = p156_ar_c_GET(src, malloc((src->items + 1) * 2), 0);
    ret[src->items] = 0;//the terminating null character.
    return ret;
}
INLINER void p156_ar_c_SET(char16_t *  src, int32_t pos, int32_t items, Bounds_Inside * dst) //Value arra
{
...
INLINER uint16_t* p157_ar_u16_GET(Pack * src, uint16_t*  dst, int32_t pos) //Value arra
{
    uint8_t * data = src->data;
    for(int32_t BYTE = 0, dst_max = pos + 2; pos < dst_max ; pos++,  BYTE += 2)
        dst[pos] = ((get_bytes(data,  BYTE, 2)));
    return dst;
}

static const  uint32_t p157_ar_u16_LEN = 2; //return array length

INLINER  uint16_t*  p157_ar_u16_GET_(Pack * src) {return p157_ar_u16_GET(src, malloc(2 * sizeof(uint16_t)), 0);}
INLINER void p157_ar_u16_SET(uint16_t*  src, int32_t pos, Pack * dst) //Value arra
{
    uint8_t * data = dst->data;
    for(int32_t BYTE =  0, src_max = pos + 2; pos < src_max; pos++, BYTE += 2)
        set_bytes((src[pos]), 2, data,  BYTE);
}
INLINER uint32_t* p157_ar_u32_GET(Pack * src, uint32_t*  dst, int32_t pos) //Value arra
{
    uint8_t * data = src->data;
    for(int32_t BYTE = 4, dst_max = pos + 2; pos < dst_max ; pos++,  BYTE += 4)
        dst[pos] = ((get_bytes(data,  BYTE, 4)));
    return dst;
}

static const  uint32_t p157_ar_u32_LEN = 2; //return array length

INLINER  uint32_t*  p157_ar_u32_GET_(Pack * src) {return p157_ar_u32_GET(src, malloc(2 * sizeof(uint32_t)), 0);}
INLINER void p157_ar_u32_SET(uint32_t*  src, int32_t pos, Pack * dst) //Value arra
{
    uint8_t * data = dst->data;
    for(int32_t BYTE =  4, src_max = pos + 2; pos < src_max; pos++, BYTE += 4)
        set_bytes((src[pos]), 4, data,  BYTE);
}
INLINER double* p157_ar_d_GET(Pack * src, double*  dst, int32_t pos) //Value arra
{
    uint8_t * data = src->data;
    for(int32_t BYTE = 12, dst_max = pos + 2; pos < dst_max ; pos++,  BYTE += 8)
        dst[pos] = (longBitsToDouble(get_bytes(data,  BYTE, 8)));
    return dst;
}

static const  uint32_t p157_ar_d_LEN = 2; //return array length

INLINER  double*  p157_ar_d_GET_(Pack * src) {return p157_ar_d_GET(src, malloc(2 * sizeof(double)), 0);}
INLINER void p157_ar_d_SET(double*  src, int32_t pos, Pack * dst) //Value arra
{
    uint8_t * data = dst->data;
    for(int32_t BYTE =  12, src_max = pos + 2; pos < src_max; pos++, BYTE += 8)
        set_bytes(doubleToLongBits(src[pos]), 8, data,  BYTE);
}
INLINER float* p157_ar_f_GET(Pack * src, float*  dst, int32_t pos) //Value arra
{
    uint8_t * data = src->data;
    for(int32_t BYTE = 28, dst_max = pos + 2; pos < dst_max ; pos++,  BYTE += 4)
        dst[pos] = (intBitsToFloat(get_bytes(data,  BYTE, 4)));
    return dst;
}

static const  uint32_t p157_ar_f_LEN = 2; //return array length

INLINER  float*  p157_ar_f_GET_(Pack * src) {return p157_ar_f_GET(src, malloc(2 * sizeof(float)), 0);}
INLINER void p157_ar_f_SET(float*  src, int32_t pos, Pack * dst) //Value arra
{
    uint8_t * data = dst->data;
    for(int32_t BYTE =  28, src_max = pos + 2; pos < src_max; pos++, BYTE += 4)
        set_bytes(floatToIntBits(src[pos]), 4, data,  BYTE);
}
INLINER int32_t* p157_ar_i32_GET(Pack * src, int32_t*  dst, int32_t pos) //Value arra
{
    uint8_t * data = src->data;
    for(int32_t BYTE = 36, dst_max = pos + 2; pos < dst_max ; pos++,  BYTE += 4)
        dst[pos] = ((int32_t)(get_bytes(data,  BYTE, 4)));
    return dst;
}

static const  uint32_t p157_ar_i32_LEN = 2; //return array length

INLINER  int32_t*  p157_ar_i32_GET_(Pack * src) {return p157_ar_i32_GET(src, malloc(2 * sizeof(int32_t)), 0);}
INLINER void p157_ar_i32_SET(int32_t*  src, int32_t pos, Pack * dst) //Value arra
{
    uint8_t * data = dst->data;
    for(int32_t BYTE =  36, src_max = pos + 2; pos < src_max; pos++, BYTE += 4)
        set_bytes((uint32_t)(src[pos]), 4, data,  BYTE);
}
INLINER int16_t* p157_ar_i16_GET(Pack * src, int16_t*  dst, int32_t pos) //Value arra
{
    uint8_t * data = src->data;
    for(int32_t BYTE = 44, dst_max = pos + 2; pos < dst_max ; pos++,  BYTE += 2)
        dst[pos] = ((int16_t)(get_bytes(data,  BYTE, 2)));
    return dst;
}

static const  uint32_t p157_ar_i16_LEN = 2; //return array length

INLINER  int16_t*  p157_ar_i16_GET_(Pack * src) {return p157_ar_i16_GET(src, malloc(2 * sizeof(int16_t)), 0);}
INLINER void p157_ar_i16_SET(int16_t*  src, int32_t pos, Pack * dst) //Value arra
{
    uint8_t * data = dst->data;
    for(int32_t BYTE =  44, src_max = pos + 2; pos < src_max; pos++, BYTE += 2)
        set_bytes((uint16_t)(src[pos]), 2, data,  BYTE);
}
INLINER uint8_t* p157_ar_u8_GET(Pack * src, uint8_t*  dst, int32_t pos) //Value arra
{
    uint8_t * data = src->data;
    for(int32_t BYTE = 48, dst_max = pos + 2; pos < dst_max ; pos++,  BYTE += 1)
        dst[pos] = ((get_bytes(data,  BYTE, 1)));
    return dst;
}

static const  uint32_t p157_ar_u8_LEN = 2; //return array length

INLINER  uint8_t*  p157_ar_u8_GET_(Pack * src) {return p157_ar_u8_GET(src, malloc(2 * sizeof(uint8_t)), 0);}
INLINER void p157_ar_u8_SET(uint8_t*  src, int32_t pos, Pack * dst) //Value arra
{
    uint8_t * data = dst->data;
    for(int32_t BYTE =  48, src_max = pos + 2; pos < src_max; pos++, BYTE += 1)
        set_bytes((src[pos]), 1, data,  BYTE);
}
INLINER int8_t* p157_ar_i8_GET(Pack * src, int8_t*  dst, int32_t pos) //Value arra
{
    uint8_t * data = src->data;
    for(int32_t BYTE = 50, dst_max = pos + 2; pos < dst_max ; pos++,  BYTE += 1)
        dst[pos] = ((int8_t)(get_bytes(data,  BYTE, 1)));
    return dst;
}

static const  uint32_t p157_ar_i8_LEN = 2; //return array length

INLINER  int8_t*  p157_ar_i8_GET_(Pack * src) {return p157_ar_i8_GET(src, malloc(2 * sizeof(int8_t)), 0);}
INLINER void p157_ar_i8_SET(int8_t*  src, int32_t pos, Pack * dst) //Value arra
{
    uint8_t * data = dst->data;
    for(int32_t BYTE =  50, src_max = pos + 2; pos < src_max; pos++, BYTE += 1)
        set_bytes((uint8_t)(src[pos]), 1, data,  BYTE);
}
INLINER char16_t * p157_ar_c_GET(Bounds_Inside * src, char16_t *  dst, int32_t pos) //Value arra
{
    uint8_t * data = src->base.pack->data;
    for(int32_t BYTE = src->BYTE, dst_max = pos + src->items; pos < dst_max ; pos++,  BYTE += 2)
        dst[pos] = ((get_bytes(data,  BYTE, 2)));
...
INLINER int32_t p157_ar_c_LEN(Bounds_Inside * src)
{
    return (src->base.field_bit !=  416 && !try_visit_field(src, 416)  ||  !try_visit_item(src, 0)) ? 0 : src->items;
}
INLINER  char16_t* p157_ar_c_TRY_(Bounds_Inside * src)
{
    if(src->base.field_bit !=  416 && !try_visit_field(src, 416)  ||  !try_visit_item(src, 0)) return NULL;
    char16_t * ret = p157_ar_c_GET(src, malloc((src->items + 1) * 2), 0);
    ret[src->items] = 0;//the terminating null character.
    return ret;
}
INLINER void p157_ar_c_SET(char16_t *  src, int32_t pos, int32_t items, Bounds_Inside * dst) //Value arra
{
...
INLINER uint16_t* p158_ar_u16_GET(Pack * src, uint16_t*  dst, int32_t pos) //Value arra
{
    uint8_t * data = src->data;
    for(int32_t BYTE = 0, dst_max = pos + 2; pos < dst_max ; pos++,  BYTE += 2)
        dst[pos] = ((get_bytes(data,  BYTE, 2)));
...
static const  uint32_t p158_ar_u16_LEN = 2; //return array length

INLINER  uint16_t*  p158_ar_u16_GET_(Pack * src) {return p158_ar_u16_GET(src, malloc(2 * sizeof(uint16_t)), 0);}
INLINER void p158_ar_u16_SET(uint16_t*  src, int32_t pos, Pack * dst) //Value arra
{
    uint8_t * data = dst->data;
    for(int32_t BYTE =  0, src_max = pos + 2; pos < src_max; pos++, BYTE += 2)
        set_bytes((src[pos]), 2, data,  BYTE);
}
INLINER uint32_t p158_v3_GET(Pack * src)//Stub fiel
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  4, 4)));
}
INLINER void p158_v3_SET(uint32_t  src, Pack * dst)//Stub fiel
{
    uint8_t * data = dst->data;
    set_bytes((src), 4, data,  4);
}
INLINER double* p158_ar_d_GET(Pack * src, double*  dst, int32_t pos) //Value arra
{
    uint8_t * data = src->data;
    for(int32_t BYTE = 8, dst_max = pos + 2; pos < dst_max ; pos++,  BYTE += 8)
        dst[pos] = (longBitsToDouble(get_bytes(data,  BYTE, 8)));
    return dst;
}

static const  uint32_t p158_ar_d_LEN = 2; //return array length

INLINER  double*  p158_ar_d_GET_(Pack * src) {return p158_ar_d_GET(src, malloc(2 * sizeof(double)), 0);}
INLINER void p158_ar_d_SET(double*  src, int32_t pos, Pack * dst) //Value arra
{
    uint8_t * data = dst->data;
