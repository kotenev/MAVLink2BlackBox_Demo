...
public class DemoDevice extends Host
{
    ...
    } public static class CHANGE_OPERATOR_CONTROL extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        ...
        } static final Meta meta = new Meta(5, 0, 0, 0, 4, 24, 0, _G);
...
//ke
        ...
        {key_SET(src.toCharArray(), 0, src.length(), ph);} public void key_SET(char[]  src, int pos, int items, Bounds.Inside ph) //ke
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(7, 0, 0, 0, 1, 0, 0, _Z);
    ...
    } public static class PARAM_VALUE extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        ...
        } public void param_id_SET(String src, Bounds.Inside ph) {param_id_SET(src.toCharArray(), 0, src.length(), ph);} public void param_id_SET(char[]  src, int pos, int items, Bounds.Inside ph)
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(22, 2, 0, 0, 10, 68, 0, _b);
    } public static class PARAM_SET extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        ...
        } public void param_id_SET(String src, Bounds.Inside ph) {param_id_SET(src.toCharArray(), 0, src.length(), ph);} public void param_id_SET(char[]  src, int pos, int items, Bounds.Inside ph)
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(23, 0, 0, 0, 8, 52, 0, _P);
...
//Heading / track uncertainty in degrees * 1e5
        ...
        public void hdg_acc_SET(long  src, Bounds.Inside ph)//Heading / track uncertainty in degrees * 1e5
        {
            ...
            set_bytes((src) & -1L, 4, data,  ph.BYTE);
        } static final Meta meta = new Meta(24, 4, 0, 1, 31, 236, 0, _mB, _jB, _oB, _RB, _cB);
...
//Servo output 16 value, in microsecond
        ...
        public void servo16_raw_SET(char  src, Bounds.Inside ph)//Servo output 16 value, in microsecond
        {
            ...
            set_bytes((char)(src) & -1L, 2, data,  ph.BYTE);
        } static final Meta meta = new Meta(36, 8, 1, 0, 22, 168, 0, _pF, _mF, _jF, _oF, _RF, _cF, _hF, _CF);
...
//Timestamp (microseconds since UNIX epoch or microseconds since system boot
        ...
        } static final Meta meta = new Meta(48, 0, 0, 0, 14, 104, 0, _Dw);
...
//Timestamp (microseconds since UNIX epoch or microseconds since system boot
        ...
        public void time_usec_SET(long  src, Bounds.Inside ph)//Timestamp (microseconds since UNIX epoch or microseconds since system boot
        {
            ...
            set_bytes((src) & -1L, 8, data,  ph.BYTE);
        } static final Meta meta = new Meta(49, 0, 0, 0, 13, 96, 0, _Kw);
    } public static class PARAM_MAP_RC extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        ...
        } public void param_id_SET(String src, Bounds.Inside ph) {param_id_SET(src.toCharArray(), 0, src.length(), ph);} public void param_id_SET(char[]  src, int pos, int items, Bounds.Inside ph)
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(50, 0, 0, 0, 22, 168, 0, _qw);
...
//WIP: Component which requested the command to be execute
        ...
        public void target_component_SET(char  src, Bounds.Inside ph)//WIP: Component which requested the command to be execute
        {
            ...
            set_bytes((char)(src) & -1L, 1, data,  ph.BYTE);
        } static final Meta meta = new Meta(77, 0, 0, 0, 3, 10, 0, _Tg, _qg, _Hg, _Qg);
...
//Flow rate in radians/second about Y axi
        ...
        public void flow_rate_y_SET(float  src, Bounds.Inside ph)//Flow rate in radians/second about Y axi
        {
            ...
            set_bytes(Float.floatToIntBits(src) & -1L, 4, data, ph.BYTE);
        } static final Meta meta = new Meta(100, 0, 0, 1, 27, 208, 0, _cm, _hm);
    ...
    } public static class AUTOPILOT_VERSION extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        ...
        } public void uid2_SET(char[]  src, int pos, Bounds.Inside ph)
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + 18; pos < src_max; pos++, BYTE += 1)
                set_bytes((char)(src[pos]) & -1L, 1, data,  BYTE);
        } static final Meta meta = new Meta(148, 2, 4, 1, 54, 421, 0, _AD);
...
//Quaternion of landing target orientation (w, x, y, z order, zero-rotation is 1, 0, 0, 0
        ...
        public void position_valid_SET(char  src, Bounds.Inside ph)
        {
            ...
            set_bytes((char)(src) & -1L, 1, data,  ph.BYTE);
        } static final Meta meta = new Meta(149, 0, 0, 1, 31, 239, 0, _cD, _hD, _CD, _DD, _kD);
    } public static class ARRAY_TEST_0 extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        ARRAY_TEST_0() { super(meta, 0); }
        ARRAY_TEST_0(int bytes) { super(meta, bytes); }
        public char[] ar_u16_GET(char[]  dst_ch, int pos)  //Value arra
        {
            for(int BYTE = 0, dst_max = pos + 4; pos < dst_max ; pos++,  BYTE += 2)
                dst_ch[pos] = (char)((char) get_bytes(data,  BYTE, 2));
            return dst_ch;
        }
        public char[] ar_u16_GET()//Value arra
        {return ar_u16_GET(new char[4], 0);} public void ar_u16_SET(char[]  src, int pos)  //Value arra
        {
            for(int BYTE =  0, src_max = pos + 4; pos < src_max; pos++, BYTE += 2)
                set_bytes((char)(src[pos]) & -1L, 2, data,  BYTE);
        }
        public long[] ar_u32_GET(long[]  dst_ch, int pos)  //Value arra
        {
            for(int BYTE = 8, dst_max = pos + 4; pos < dst_max ; pos++,  BYTE += 4)
                dst_ch[pos] = (get_bytes(data,  BYTE, 4));
            return dst_ch;
        }
        public long[] ar_u32_GET()//Value arra
        {return ar_u32_GET(new long[4], 0);} public void ar_u32_SET(long[]  src, int pos)  //Value arra
        {
            for(int BYTE =  8, src_max = pos + 4; pos < src_max; pos++, BYTE += 4)
                set_bytes((src[pos]) & -1L, 4, data,  BYTE);
        }
        public char v1_GET()//Stub fiel
        {  return (char)((char) get_bytes(data,  24, 1)); }
        public void v1_SET(char  src) //Stub fiel
        {  set_bytes((char)(src) & -1L, 1, data,  24); }
        public byte[] ar_i8_GET(byte[]  dst_ch, int pos)  //Value arra
        {
            for(int BYTE = 25, dst_max = pos + 4; pos < dst_max ; pos++,  BYTE += 1)
                dst_ch[pos] = (byte)((byte) get_bytes(data,  BYTE, 1));
            return dst_ch;
        }
        public byte[] ar_i8_GET()//Value arra
        {return ar_i8_GET(new byte[4], 0);} public void ar_i8_SET(byte[]  src, int pos)  //Value arra
        {
            for(int BYTE =  25, src_max = pos + 4; pos < src_max; pos++, BYTE += 1)
                set_bytes((byte)(src[pos]) & -1L, 1, data,  BYTE);
        }
        public char[] ar_u8_GET(char[]  dst_ch, int pos)  //Value arra
        {
            for(int BYTE = 29, dst_max = pos + 4; pos < dst_max ; pos++,  BYTE += 1)
                dst_ch[pos] = (char)((char) get_bytes(data,  BYTE, 1));
            return dst_ch;
        }
        public char[] ar_u8_GET()//Value arra
        {return ar_u8_GET(new char[4], 0);} public void ar_u8_SET(char[]  src, int pos)  //Value arra
        {
            for(int BYTE =  29, src_max = pos + 4; pos < src_max; pos++, BYTE += 1)
                set_bytes((char)(src[pos]) & -1L, 1, data,  BYTE);
        }
        static final Meta meta = new Meta(150, 4, 4, 0, 33, 264);
    } public static class ARRAY_TEST_1 extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        ARRAY_TEST_1() { super(meta, 0); }
        ARRAY_TEST_1(int bytes) { super(meta, bytes); }
        public long[] ar_u32_GET(long[]  dst_ch, int pos)  //Value arra
        {
        ...
        {return ar_u32_GET(new long[4], 0);} public void ar_u32_SET(long[]  src, int pos)  //Value arra
        {
            for(int BYTE =  0, src_max = pos + 4; pos < src_max; pos++, BYTE += 4)
                set_bytes((src[pos]) & -1L, 4, data,  BYTE);
        }
        static final Meta meta = new Meta(151, 0, 4, 0, 16, 128);
    } public static class ARRAY_TEST_3 extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        ARRAY_TEST_3() { super(meta, 0); }
        ARRAY_TEST_3(int bytes) { super(meta, bytes); }
        public long[] ar_u32_GET(long[]  dst_ch, int pos)  //Value arra
        {
            for(int BYTE = 0, dst_max = pos + 4; pos < dst_max ; pos++,  BYTE += 4)
                dst_ch[pos] = (get_bytes(data,  BYTE, 4));
        ...
        public char v_GET()//Stub fiel
        {  return (char)((char) get_bytes(data,  16, 1)); }
        public void v_SET(char  src) //Stub fiel
        {  set_bytes((char)(src) & -1L, 1, data,  16); }
        static final Meta meta = new Meta(153, 0, 4, 0, 17, 136);
    } public static class ARRAY_TEST_4 extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        ARRAY_TEST_4() { super(meta, 0); }
        ARRAY_TEST_4(int bytes) { super(meta, bytes); }
        public long[] ar_u32_GET(long[]  dst_ch, int pos)  //Value arra
        {
            for(int BYTE = 0, dst_max = pos + 4; pos < dst_max ; pos++,  BYTE += 4)
                dst_ch[pos] = (get_bytes(data,  BYTE, 4));
        ...
        public void v_SET(char  src) //Stub fiel
        {  set_bytes((char)(src) & -1L, 1, data,  16); }
        static final Meta meta = new Meta(154, 0, 4, 0, 17, 136);
    } public static class ARRAY_TEST_5 extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        ARRAY_TEST_5() { super(meta, 0); }
        ARRAY_TEST_5(int bytes) { super(meta, bytes); }
        public String c1_TRY(Bounds.Inside ph)//Value arra
//Value arra
        {
            if(ph.field_bit !=  0 && !try_visit_field(ph, 0)  ||  !try_visit_item(ph, 0)) return null;
            return new String(c1_GET(ph, new char[ph.items], 0));
        }
        public char[] c1_GET(Bounds.Inside ph, char[]  dst_ch, int pos) //Value arra
        {
            for(int BYTE = ph.BYTE, dst_max = pos + ph.items; pos < dst_max ; pos++,  BYTE += 2)
                dst_ch[pos] = (char)((char) get_bytes(data,  BYTE, 2));
            return dst_ch;
        ...
        {
            return (ph.field_bit !=  0 && !try_visit_field(ph, 0)  ||  !try_visit_item(ph, 0)) ? 0 : ph.items;
        } public void c1_SET(String src, Bounds.Inside ph) //Value arra
        {c1_SET(src.toCharArray(), 0, src.length(), ph);} public void c1_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Value arra
        {
            if(ph.field_bit != 0 && insert_field(ph, 0, items) || ! try_visit_item(ph, 0))
                insert_item(ph, 0, items);
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } public String c2_TRY(Bounds.Inside ph)//Value arra
//Value arra
        {
            if(ph.field_bit !=  1 && !try_visit_field(ph, 1)  ||  !try_visit_item(ph, 0)) return null;
            return new String(c2_GET(ph, new char[ph.items], 0));
        }
        public char[] c2_GET(Bounds.Inside ph, char[]  dst_ch, int pos) //Value arra
        {
            for(int BYTE = ph.BYTE, dst_max = pos + ph.items; pos < dst_max ; pos++,  BYTE += 2)
                dst_ch[pos] = (char)((char) get_bytes(data,  BYTE, 2));
            return dst_ch;
        ...
        } public void c2_SET(String src, Bounds.Inside ph) //Value arra
        {c2_SET(src.toCharArray(), 0, src.length(), ph);} public void c2_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Value arra
        {
            if(ph.field_bit != 1 && insert_field(ph, 1, items) || ! try_visit_item(ph, 0))
                insert_item(ph, 0, items);
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(155, 0, 0, 0, 1, 0, 0, _MT, _BT);
    } public static class ARRAY_TEST_6 extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        ARRAY_TEST_6() { super(meta, 0); }
        ARRAY_TEST_6(int bytes) { super(meta, bytes); }
        public char v2_GET()//Stub fiel
        {  return (char)((char) get_bytes(data,  0, 2)); }
        public void v2_SET(char  src) //Stub fiel
        {  set_bytes((char)(src) & -1L, 2, data,  0); }
        public char[] ar_u16_GET(char[]  dst_ch, int pos)  //Value arra
        {
        ...
        public char[] ar_u16_GET()//Value arra
        {return ar_u16_GET(new char[2], 0);} public void ar_u16_SET(char[]  src, int pos)  //Value arra
        {
            for(int BYTE =  2, src_max = pos + 2; pos < src_max; pos++, BYTE += 2)
                set_bytes((char)(src[pos]) & -1L, 2, data,  BYTE);
        }
        public long v3_GET()//Stub fiel
        {  return (get_bytes(data,  6, 4)); }
        public void v3_SET(long  src) //Stub fiel
        {  set_bytes((src) & -1L, 4, data,  6); }
        public long[] ar_u32_GET(long[]  dst_ch, int pos)  //Value arra
        {
        ...
        public long[] ar_u32_GET()//Value arra
        {return ar_u32_GET(new long[2], 0);} public void ar_u32_SET(long[]  src, int pos)  //Value arra
        {
            for(int BYTE =  10, src_max = pos + 2; pos < src_max; pos++, BYTE += 4)
                set_bytes((src[pos]) & -1L, 4, data,  BYTE);
        }
        public char v1_GET()//Stub fiel
        {  return (char)((char) get_bytes(data,  18, 1)); }
        public void v1_SET(char  src) //Stub fiel
        {  set_bytes((char)(src) & -1L, 1, data,  18); }
        public int[] ar_i32_GET(int[]  dst_ch, int pos)  //Value arra
        {
            for(int BYTE = 19, dst_max = pos + 2; pos < dst_max ; pos++,  BYTE += 4)
                dst_ch[pos] = (int)((int) get_bytes(data,  BYTE, 4));
            return dst_ch;
        }
        public int[] ar_i32_GET()//Value arra
        {return ar_i32_GET(new int[2], 0);} public void ar_i32_SET(int[]  src, int pos)  //Value arra
        {
            for(int BYTE =  19, src_max = pos + 2; pos < src_max; pos++, BYTE += 4)
                set_bytes((int)(src[pos]) & -1L, 4, data,  BYTE);
        }
        public short[] ar_i16_GET(short[]  dst_ch, int pos)  //Value arra
        {
            for(int BYTE = 27, dst_max = pos + 2; pos < dst_max ; pos++,  BYTE += 2)
                dst_ch[pos] = (short)((short) get_bytes(data,  BYTE, 2));
            return dst_ch;
        }
        public short[] ar_i16_GET()//Value arra
        {return ar_i16_GET(new short[2], 0);} public void ar_i16_SET(short[]  src, int pos)  //Value arra
        {
            for(int BYTE =  27, src_max = pos + 2; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        }
        public char[] ar_u8_GET(char[]  dst_ch, int pos)  //Value arra
        {
        ...
        public char[] ar_u8_GET()//Value arra
        {return ar_u8_GET(new char[2], 0);} public void ar_u8_SET(char[]  src, int pos)  //Value arra
        {
            for(int BYTE =  31, src_max = pos + 2; pos < src_max; pos++, BYTE += 1)
                set_bytes((char)(src[pos]) & -1L, 1, data,  BYTE);
        }
        public byte[] ar_i8_GET(byte[]  dst_ch, int pos)  //Value arra
        {
        ...
        public byte[] ar_i8_GET()//Value arra
        {return ar_i8_GET(new byte[2], 0);} public void ar_i8_SET(byte[]  src, int pos)  //Value arra
        {
            for(int BYTE =  33, src_max = pos + 2; pos < src_max; pos++, BYTE += 1)
                set_bytes((byte)(src[pos]) & -1L, 1, data,  BYTE);
        }
        public double[] ar_d_GET(double[]  dst_ch, int pos)  //Value arra
        {
            for(int BYTE = 35, dst_max = pos + 2; pos < dst_max ; pos++,  BYTE += 8)
                dst_ch[pos] = (double)(Double.longBitsToDouble(get_bytes(data, BYTE, 8)));
            return dst_ch;
        }
        public double[] ar_d_GET()//Value arra
        {return ar_d_GET(new double[2], 0);} public void ar_d_SET(double[]  src, int pos)  //Value arra
        {
            for(int BYTE =  35, src_max = pos + 2; pos < src_max; pos++, BYTE += 8)
                set_bytes(Double.doubleToLongBits(src[pos]), 8, data,  BYTE);
        }
        public float[] ar_f_GET(float[]  dst_ch, int pos)  //Value arra
        {
            for(int BYTE = 51, dst_max = pos + 2; pos < dst_max ; pos++,  BYTE += 4)
                dst_ch[pos] = (float)(Float.intBitsToFloat((int) get_bytes(data,  BYTE, 4)));
            return dst_ch;
        }
        public float[] ar_f_GET()//Value arra
        {return ar_f_GET(new float[2], 0);} public void ar_f_SET(float[]  src, int pos)  //Value arra
        {
            for(int BYTE =  51, src_max = pos + 2; pos < src_max; pos++, BYTE += 4)
                set_bytes(Float.floatToIntBits(src[pos]) & -1L, 4, data, BYTE);
        }
        public String ar_c_TRY(Bounds.Inside ph)//Value arra
//Value arra
        {
        ...
        public char[] ar_c_GET(Bounds.Inside ph, char[]  dst_ch, int pos) //Value arra
        {
            for(int BYTE = ph.BYTE, dst_max = pos + ph.items; pos < dst_max ; pos++,  BYTE += 2)
                dst_ch[pos] = (char)((char) get_bytes(data,  BYTE, 2));
            return dst_ch;
        ...
        } public void ar_c_SET(String src, Bounds.Inside ph) //Value arra
        {ar_c_SET(src.toCharArray(), 0, src.length(), ph);} public void ar_c_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Value arra
        {
            if(ph.field_bit != 472 && insert_field(ph, 472, items) || ! try_visit_item(ph, 0))
                insert_item(ph, 0, items);
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(156, 3, 3, 0, 60, 472, 0, _jT);
    } public static class ARRAY_TEST_7 extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        ARRAY_TEST_7() { super(meta, 0); }
        ARRAY_TEST_7(int bytes) { super(meta, bytes); }
        public char[] ar_u16_GET(char[]  dst_ch, int pos)  //Value arra
        {
        ...
        {return ar_u16_GET(new char[2], 0);} public void ar_u16_SET(char[]  src, int pos)  //Value arra
        {
            for(int BYTE =  0, src_max = pos + 2; pos < src_max; pos++, BYTE += 2)
                set_bytes((char)(src[pos]) & -1L, 2, data,  BYTE);
        }
        public long[] ar_u32_GET(long[]  dst_ch, int pos)  //Value arra
        {
        ...
        {return ar_u32_GET(new long[2], 0);} public void ar_u32_SET(long[]  src, int pos)  //Value arra
        {
            for(int BYTE =  4, src_max = pos + 2; pos < src_max; pos++, BYTE += 4)
                set_bytes((src[pos]) & -1L, 4, data,  BYTE);
        }
        public double[] ar_d_GET(double[]  dst_ch, int pos)  //Value arra
        {
        ...
        {return ar_d_GET(new double[2], 0);} public void ar_d_SET(double[]  src, int pos)  //Value arra
        {
            for(int BYTE =  12, src_max = pos + 2; pos < src_max; pos++, BYTE += 8)
                set_bytes(Double.doubleToLongBits(src[pos]), 8, data,  BYTE);
        }
        public float[] ar_f_GET(float[]  dst_ch, int pos)  //Value arra
        {
        ...
        {return ar_f_GET(new float[2], 0);} public void ar_f_SET(float[]  src, int pos)  //Value arra
        {
            for(int BYTE =  28, src_max = pos + 2; pos < src_max; pos++, BYTE += 4)
                set_bytes(Float.floatToIntBits(src[pos]) & -1L, 4, data, BYTE);
        }
        public int[] ar_i32_GET(int[]  dst_ch, int pos)  //Value arra
        {
        ...
        {return ar_i32_GET(new int[2], 0);} public void ar_i32_SET(int[]  src, int pos)  //Value arra
        {
            for(int BYTE =  36, src_max = pos + 2; pos < src_max; pos++, BYTE += 4)
                set_bytes((int)(src[pos]) & -1L, 4, data,  BYTE);
        }
        public short[] ar_i16_GET(short[]  dst_ch, int pos)  //Value arra
        {
        ...
        {return ar_i16_GET(new short[2], 0);} public void ar_i16_SET(short[]  src, int pos)  //Value arra
        {
            for(int BYTE =  44, src_max = pos + 2; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        }
        public char[] ar_u8_GET(char[]  dst_ch, int pos)  //Value arra
        {
        ...
        {return ar_u8_GET(new char[2], 0);} public void ar_u8_SET(char[]  src, int pos)  //Value arra
        {
            for(int BYTE =  48, src_max = pos + 2; pos < src_max; pos++, BYTE += 1)
                set_bytes((char)(src[pos]) & -1L, 1, data,  BYTE);
        }
        public byte[] ar_i8_GET(byte[]  dst_ch, int pos)  //Value arra
        {
        ...
        {return ar_i8_GET(new byte[2], 0);} public void ar_i8_SET(byte[]  src, int pos)  //Value arra
        {
            for(int BYTE =  50, src_max = pos + 2; pos < src_max; pos++, BYTE += 1)
                set_bytes((byte)(src[pos]) & -1L, 1, data,  BYTE);
        }
        public String ar_c_TRY(Bounds.Inside ph)//Value arra
//Value arra
        ...
        {ar_c_SET(src.toCharArray(), 0, src.length(), ph);} public void ar_c_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Value arra
        {
            if(ph.field_bit != 416 && insert_field(ph, 416, items) || ! try_visit_item(ph, 0))
                insert_item(ph, 0, items);
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(157, 2, 2, 0, 53, 416, 0, _ET);
    } public static class ARRAY_TEST_8 extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        ARRAY_TEST_8() { super(meta, 0); }
        ARRAY_TEST_8(int bytes) { super(meta, bytes); }
        public char[] ar_u16_GET(char[]  dst_ch, int pos)  //Value arra
        {
            for(int BYTE = 0, dst_max = pos + 2; pos < dst_max ; pos++,  BYTE += 2)
                dst_ch[pos] = (char)((char) get_bytes(data,  BYTE, 2));
        ...
        {return ar_d_GET(new double[2], 0);} public void ar_d_SET(double[]  src, int pos)  //Value arra
        {
            for(int BYTE =  8, src_max = pos + 2; pos < src_max; pos++, BYTE += 8)
                set_bytes(Double.doubleToLongBits(src[pos]), 8, data,  BYTE);
        }
        static final Meta meta = new Meta(158, 2, 1, 0, 24, 192);
...
//Timestamp (microseconds since UNIX epoch or microseconds since system boot
        ...
        public void time_usec_SET(long  src, Bounds.Inside ph)//Timestamp (microseconds since UNIX epoch or microseconds since system boot
        {
            ...
            set_bytes((src) & -1L, 8, data,  ph.BYTE);
        } static final Meta meta = new Meta(242, 0, 0, 0, 53, 416, 0, _Py);
...
//Timestamp (microseconds since UNIX epoch or microseconds since system boot
        ...
        public void time_usec_SET(long  src, Bounds.Inside ph)//Timestamp (microseconds since UNIX epoch or microseconds since system boot
        {
            ...
            set_bytes((src) & -1L, 8, data,  ph.BYTE);
        } static final Meta meta = new Meta(243, 0, 0, 0, 54, 424, 0, _pk);
...
//The callsign, 8+nul
        ...
        {callsign_SET(src.toCharArray(), 0, src.length(), ph);} public void callsign_SET(char[]  src, int pos, int items, Bounds.Inside ph) //The callsign, 8+nul
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(246, 3, 1, 0, 28, 210, 0, _Ek);
...
//Nam
        ...
        {name_SET(src.toCharArray(), 0, src.length(), ph);} public void name_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Nam
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(250, 0, 0, 1, 21, 160, 0, _ek);
...
//Name of the debug variabl
        ...
        {name_SET(src.toCharArray(), 0, src.length(), ph);} public void name_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Name of the debug variabl
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(251, 0, 1, 0, 9, 64, 0, _Pk);
...
//Name of the debug variabl
        ...
        {name_SET(src.toCharArray(), 0, src.length(), ph);} public void name_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Name of the debug variabl
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(252, 0, 1, 0, 9, 64, 0, _Mf);
...
//Status text message, without null termination characte
        ...
        {text_SET(src.toCharArray(), 0, src.length(), ph);} public void text_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Status text message, without null termination characte
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(253, 0, 0, 0, 2, 4, 0, _Ff);
...
//tune in board specific forma
        ...
        {tune_SET(src.toCharArray(), 0, src.length(), ph);} public void tune_SET(char[]  src, int pos, int items, Bounds.Inside ph) //tune in board specific forma
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(258, 0, 0, 0, 3, 16, 0, _Cf);
...
//Camera definition URI (if any, otherwise only basic functions will be available)
        ...
        {cam_definition_uri_SET(src.toCharArray(), 0, src.length(), ph);} public void cam_definition_uri_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Camera definition URI (if any, otherwise only basic functions will be available)
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(259, 3, 2, 0, 93, 731, 0, _Yf);
...
//Video stream UR
        ...
        {uri_SET(src.toCharArray(), 0, src.length(), ph);} public void uri_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Video stream UR
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(269, 3, 1, 0, 17, 130, 2, _SK);
...
//Video stream UR
        ...
        {uri_SET(src.toCharArray(), 0, src.length(), ph);} public void uri_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Video stream UR
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(270, 3, 1, 0, 18, 138, 2, _tK);
...
//Password. Leave it blank for an open AP
        ...
        {password_SET(src.toCharArray(), 0, src.length(), ph);} public void password_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Password. Leave it blank for an open AP
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(299, 0, 0, 0, 1, 2, 2, _VK, _OK);
...
//Node name string. For example, "sapog.px4.io"
        ...
        {name_SET(src.toCharArray(), 0, src.length(), ph);} public void name_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Node name string. For example, "sapog.px4.io"
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(311, 0, 2, 1, 37, 288, 0, _pE);
    } public static class PARAM_EXT_REQUEST_READ extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        ...
        } public void param_id_SET(String src, Bounds.Inside ph) {param_id_SET(src.toCharArray(), 0, src.length(), ph);} public void param_id_SET(char[]  src, int pos, int items, Bounds.Inside ph)
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(320, 0, 0, 0, 5, 32, 0, _yE);
...
//Parameter valu
        ...
        {param_value_SET(src.toCharArray(), 0, src.length(), ph);} public void param_value_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Parameter valu
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(322, 2, 0, 0, 5, 38, 2, _EE, _TE);
...
//Parameter valu
        ...
        {param_value_SET(src.toCharArray(), 0, src.length(), ph);} public void param_value_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Parameter valu
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(323, 0, 0, 0, 3, 22, 2, _YE, _lE);
...
//Parameter value (new value if PARAM_ACK_ACCEPTED, current value otherwise
        ...
        {param_value_SET(src.toCharArray(), 0, src.length(), ph);} public void param_value_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Parameter value (new value if PARAM_ACK_ACCEPTED, current value otherwise
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(324, 0, 0, 0, 2, 9, 2, _ZE, _IE);
    ...
    public static class LoopBackDemoChannel  extends Channel
    {
        ...
        public static ARRAY_TEST_0 new_ARRAY_TEST_0() {return new  ARRAY_TEST_0();}
        public static ARRAY_TEST_1 new_ARRAY_TEST_1() {return new  ARRAY_TEST_1();}
        public static ARRAY_TEST_3 new_ARRAY_TEST_3() {return new  ARRAY_TEST_3();}
        public static ARRAY_TEST_4 new_ARRAY_TEST_4() {return new  ARRAY_TEST_4();}
        public static ARRAY_TEST_5 new_ARRAY_TEST_5() {return new  ARRAY_TEST_5();}
        public static ARRAY_TEST_6 new_ARRAY_TEST_6() {return new  ARRAY_TEST_6();}
        public static ARRAY_TEST_7 new_ARRAY_TEST_7() {return new  ARRAY_TEST_7();}
        public static ARRAY_TEST_8 new_ARRAY_TEST_8() {return new  ARRAY_TEST_8();}
            ...
            for(boolean LOOP = false; ;)
            {
                switch(id)
                {
                    ...
                    case 150:
                        ...
                        final ARRAY_TEST_0 pi150 = (ARRAY_TEST_0) pack;
                        ph.setPack(pi150);
                        on_ARRAY_TEST_0.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi150));
                        if(LOOP) break;
                        return null;
                    case 151:
                        if(pack == null) return new ARRAY_TEST_1();
                        final ARRAY_TEST_1 pi151 = (ARRAY_TEST_1) pack;
                        ph.setPack(pi151);
                        on_ARRAY_TEST_1.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi151));
                        if(LOOP) break;
                        return null;
                    case 153:
                        if(pack == null) return new ARRAY_TEST_3();
                        final ARRAY_TEST_3 pi153 = (ARRAY_TEST_3) pack;
                        ph.setPack(pi153);
                        on_ARRAY_TEST_3.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi153));
                        if(LOOP) break;
                        return null;
                    case 154:
                        if(pack == null) return new ARRAY_TEST_4();
                        final ARRAY_TEST_4 pi154 = (ARRAY_TEST_4) pack;
                        ph.setPack(pi154);
                        on_ARRAY_TEST_4.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi154));
                        if(LOOP) break;
                        return null;
                    case 155:
                        if(pack == null) return new ARRAY_TEST_5(-1);
                        final ARRAY_TEST_5 pi155 = (ARRAY_TEST_5) pack;
                        ph.setPack(pi155);
                        on_ARRAY_TEST_5.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi155));
                        if(LOOP) break;
                        return null;
                    case 156:
                        if(pack == null) return new ARRAY_TEST_6(-1);
                        final ARRAY_TEST_6 pi156 = (ARRAY_TEST_6) pack;
                        ph.setPack(pi156);
                        on_ARRAY_TEST_6.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi156));
                        if(LOOP) break;
                        return null;
                    case 157:
                        if(pack == null) return new ARRAY_TEST_7(-1);
                        final ARRAY_TEST_7 pi157 = (ARRAY_TEST_7) pack;
                        ph.setPack(pi157);
                        on_ARRAY_TEST_7.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi157));
                        if(LOOP) break;
                        return null;
                    case 158:
                        if(pack == null) return new ARRAY_TEST_8();
                        final ARRAY_TEST_8 pi158 = (ARRAY_TEST_8) pack;
                        ph.setPack(pi158);
                        on_ARRAY_TEST_8.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi158));
                        if(LOOP) break;
                        return null;
                    case 230:
        ...
        public final Collection<OnReceive.Handler<ARRAY_TEST_0, LoopBackDemoChannel>> on_ARRAY_TEST_0 = new OnReceive<>();
        public final Collection<OnReceive.Handler<ARRAY_TEST_1, LoopBackDemoChannel>> on_ARRAY_TEST_1 = new OnReceive<>();
        public final Collection<OnReceive.Handler<ARRAY_TEST_3, LoopBackDemoChannel>> on_ARRAY_TEST_3 = new OnReceive<>();
        public final Collection<OnReceive.Handler<ARRAY_TEST_4, LoopBackDemoChannel>> on_ARRAY_TEST_4 = new OnReceive<>();
        public final Collection<OnReceive.Handler<ARRAY_TEST_5, LoopBackDemoChannel>> on_ARRAY_TEST_5 = new OnReceive<>();
        public final Collection<OnReceive.Handler<ARRAY_TEST_6, LoopBackDemoChannel>> on_ARRAY_TEST_6 = new OnReceive<>();
        public final Collection<OnReceive.Handler<ARRAY_TEST_7, LoopBackDemoChannel>> on_ARRAY_TEST_7 = new OnReceive<>();
        public final Collection<OnReceive.Handler<ARRAY_TEST_8, LoopBackDemoChannel>> on_ARRAY_TEST_8 = new OnReceive<>();
    ...
    private static final Field _Z = new Field(5, true, -6, 2, 1, 0, 0, 0, 1);
    ...
    private static final Field _mB = new Field(0, false, 1, 4, 1, 0, 0, 0);
    private static final Field _jB = new Field(0, true, 1, 4, 1, 0, 0, 0);
    private static final Field _oB = new Field(0, true, 1, 4, 1, 0, 0, 0);
    private static final Field _RB = new Field(0, true, 1, 4, 1, 0, 0, 0);
    private static final Field _cB = new Field(0, true, 1, 4, 1, 0, 0, 0);
    private static final Field _pF = new Field(0, true, 1, 2, 1, 0, 0, 0);
    private static final Field _mF = new Field(0, true, 1, 2, 1, 0, 0, 0);
    private static final Field _jF = new Field(0, true, 1, 2, 1, 0, 0, 0);
    private static final Field _oF = new Field(0, true, 1, 2, 1, 0, 0, 0);
    private static final Field _RF = new Field(0, true, 1, 2, 1, 0, 0, 0);
    private static final Field _cF = new Field(0, true, 1, 2, 1, 0, 0, 0);
    private static final Field _hF = new Field(0, true, 1, 2, 1, 0, 0, 0);
    private static final Field _CF = new Field(0, true, 1, 2, 1, 0, 0, 0);
    private static final Field _Dw = new Field(0, true, 1, 8, 1, 0, 0, 0);
    private static final Field _Kw = new Field(0, true, 1, 8, 1, 0, 0, 0);
    private static final Field _qw = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
    private static final Field _Tg = new Field(0, false, 1, 1, 1, 0, 0, 0);
    private static final Field _qg = new Field(0, false, 1, 4, 1, 0, 0, 0);
    private static final Field _Hg = new Field(0, false, 1, 1, 1, 0, 0, 0);
    private static final Field _Qg = new Field(0, false, 1, 1, 1, 0, 0, 0);
    private static final Field _cm = new Field(0, false, 1, 4, 1, 0, 0, 0);
    private static final Field _hm = new Field(0, false, 1, 4, 1, 0, 0, 0);
    private static final Field _AD = new Field(0, false, 18, 1, 1, 0, 0, 0);
    private static final Field _cD = new Field(0, false, 1, 4, 1, 0, 0, 0);
    private static final Field _hD = new Field(0, false, 1, 4, 1, 0, 0, 0);
    private static final Field _CD = new Field(0, false, 1, 4, 1, 0, 0, 0);
    private static final Field _DD = new Field(0, false, 4, 4, 1, 0, 0, 0);
    private static final Field _kD = new Field(0, false, 1, 1, 1, 0, 0, 0);
    private static final Field _Py = new Field(0, true, 1, 8, 1, 0, 0, 0);
    private static final Field _pk = new Field(0, true, 1, 8, 1, 0, 0, 0);
    private static final Field _Ek = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
    private static final Field _ek = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
    private static final Field _Pk = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
    private static final Field _Mf = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
    private static final Field _Ff = new Field(5, true, -6, 2, 1, 0, 0, 0, 1);
    private static final Field _Cf = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
    private static final Field _Yf = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
    private static final Field _AK = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
    private static final Field _SK = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
    private static final Field _tK = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
    private static final Field _VK = new Field(5, true, -6, 2, 1, 0, 0, 0, 1);
    private static final Field _OK = new Field(5, true, -7, 2, 1, 0, 0, 0, 1);
    private static final Field _pE = new Field(5, true, -7, 2, 1, 0, 0, 0, 1);
    private static final Field _yE = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
    private static final Field _EE = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
    private static final Field _TE = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
    private static final Field _YE = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
    private static final Field _lE = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
    private static final Field _ZE = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
    private static final Field _IE = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
    private static final Field _MT = new Field(5, true, -3, 2, 1, 0, 0, 0, 1);
    private static final Field _BT = new Field(5, true, -3, 2, 1, 0, 0, 0, 1);
    private static final Field _jT = new Field(5, true, -6, 2, 1, 0, 0, 0, 1);
    private static final Field _ET = new Field(5, true, -6, 2, 1, 0, 0, 0, 1);
