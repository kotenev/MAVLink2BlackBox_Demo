...
public class GroundControl extends Host {
	...
	public static class CHANGE_OPERATOR_CONTROL extends Pack {
		...
		static final Meta meta = new Meta(5, 0, 0, 0, 4, 24, 0, _A);
	}
	...
	public static class PARAM_REQUEST_READ extends Pack {
		...
		static final Meta meta = new Meta(20, 0, 0, 0, 5, 32, 0, _M);
	}
	...
	public static class GPS_RAW_INT extends Pack {
		...
		static final Meta meta = new Meta(24, 4, 0, 1, 31, 236, 0, _pg, _og, _Kg, _Sg, _jg);
	}
	...
	public static class SERVO_OUTPUT_RAW extends Pack {
		...
		static final Meta meta = new Meta(36, 8, 1, 0, 22, 168, 0, _PX, _pX, _oX, _KX, _SX, _jX, _QX, _GX);
	}
	...
	public static class SET_GPS_GLOBAL_ORIGIN extends Pack {
		...
		static final Meta meta = new Meta(48, 0, 0, 0, 14, 104, 0, _Bs);
	}
	...
	public static class GPS_GLOBAL_ORIGIN extends Pack {
		...
		static final Meta meta = new Meta(49, 0, 0, 0, 13, 96, 0, _Ts);
	}
	...
	public static class PARAM_MAP_RC extends Pack {
		...
		static final Meta meta = new Meta(50, 0, 0, 0, 22, 168, 0, _xs);
	}
	...
	public static class COMMAND_ACK extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(77, 0, 0, 0, 3, 10, 0, _ak, _xk, _Ik, _hk);
	}
	...
	public static class OPTICAL_FLOW extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(100, 0, 0, 1, 27, 208, 0, _jp, _Qp);
	}
	...
	public static class AUTOPILOT_VERSION extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(148, 2, 4, 1, 54, 421, 0, _fB);
	}
	...
	public static class LANDING_TARGET extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(149, 0, 0, 1, 31, 239, 0, _jB, _QB, _GB, _BB, _EB);
	}

	/**
	 * Array test #0.
	 */
	public static class ARRAY_TEST_0 extends Pack implements CommunicationChannel.Sendable {

		ARRAY_TEST_0() { super(meta, 0); }

		public void ar_u16_SET(char[] src, int pos)  //Value array
		{
			for (int BYTE = 0, src_max = pos + 4; pos < src_max; pos++, BYTE += 2)
				set_bytes((char) (src[pos]) & -1L, 2, data, BYTE);
		}

		public void ar_u32_SET(long[] src, int pos)  //Value array
		{
			for (int BYTE = 8, src_max = pos + 4; pos < src_max; pos++, BYTE += 4)
				set_bytes((src[pos]) & -1L, 4, data, BYTE);
		}

		public void v1_SET(char src) //Stub field
		{ set_bytes((char) (src) & -1L, 1, data, 24); }

		public void ar_i8_SET(byte[] src, int pos)  //Value array
		{
			for (int BYTE = 25, src_max = pos + 4; pos < src_max; pos++, BYTE += 1)
				set_bytes((byte) (src[pos]) & -1L, 1, data, BYTE);
		}

		public void ar_u8_SET(char[] src, int pos)  //Value array
		{
	 ...
	 * Array test #1.
	 */
	public static class ARRAY_TEST_1 extends Pack implements CommunicationChannel.Sendable {
	 ...
	 * Array test #3.
	 */
	public static class ARRAY_TEST_3 extends Pack implements CommunicationChannel.Sendable {
		...
		public void v_SET(char src) //Stub field
		{ set_bytes((char) (src) & -1L, 1, data, 16); }
	 ...
	 * Array test #4.
	 */
	public static class ARRAY_TEST_4 extends Pack implements CommunicationChannel.Sendable {
	 ...
	 * Array test #5.
	 */
	public static class ARRAY_TEST_5 extends Pack implements CommunicationChannel.Sendable {

		ARRAY_TEST_5() { super(meta, 0); }

		public void c1_SET(String src, Bounds.Inside ph)//Value array
		{c1_SET(src.toCharArray(), 0, src.length(), ph);}

		public void c1_SET(char[] src, int pos, int items, Bounds.Inside ph) //Value array
		{
		...
		public void c2_SET(String src, Bounds.Inside ph) //Value array
		{c2_SET(src.toCharArray(), 0, src.length(), ph);}

		public void c2_SET(char[] src, int pos, int items, Bounds.Inside ph) //Value array
		{
		...
		static final Meta meta = new Meta(155, 0, 0, 0, 1, 0, 0, _Fa, _ga);
	}

	/**
	 * Array test #6.
	 */
	public static class ARRAY_TEST_6 extends Pack implements CommunicationChannel.Sendable {

		ARRAY_TEST_6() { super(meta, 0); }

		public void v2_SET(char src) //Stub field
		{ set_bytes((char) (src) & -1L, 2, data, 0); }
		...
		public void v3_SET(long src) //Stub field
		{ set_bytes((src) & -1L, 4, data, 6); }
		...
		public void ar_i32_SET(int[] src, int pos)  //Value array
		{
			for (int BYTE = 19, src_max = pos + 2; pos < src_max; pos++, BYTE += 4)
				set_bytes((int) (src[pos]) & -1L, 4, data, BYTE);
		}

		public void ar_i16_SET(short[] src, int pos)  //Value array
		{
		...
		public void ar_d_SET(double[] src, int pos)  //Value array
		{
			for (int BYTE = 35, src_max = pos + 2; pos < src_max; pos++, BYTE += 8)
				set_bytes(Double.doubleToLongBits(src[pos]), 8, data, BYTE);
		}

		public void ar_f_SET(float[] src, int pos)  //Value array
		{
			for (int BYTE = 51, src_max = pos + 2; pos < src_max; pos++, BYTE += 4)
				set_bytes(Float.floatToIntBits(src[pos]) & -1L, 4, data, BYTE);
		}

		public void ar_c_SET(String src, Bounds.Inside ph)//Value array
		{ar_c_SET(src.toCharArray(), 0, src.length(), ph);}

		public void ar_c_SET(char[] src, int pos, int items, Bounds.Inside ph) //Value array
		{
		...
		static final Meta meta = new Meta(156, 3, 3, 0, 60, 472, 0, _oa);
	}

	/**
	 * Array test #7.
	 */
	public static class ARRAY_TEST_7 extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(157, 2, 2, 0, 53, 416, 0, _Ca);
	}

	/**
	 * Array test #8.
	 */
	public static class ARRAY_TEST_8 extends Pack implements CommunicationChannel.Sendable {
	...
	public static class HOME_POSITION extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(242, 0, 0, 0, 53, 416, 0, _vN);
	}
	...
	public static class SET_HOME_POSITION extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(243, 0, 0, 0, 54, 424, 0, _PE);
	}
	...
	public static class ADSB_VEHICLE extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(246, 3, 1, 0, 28, 210, 0, _CE);
	}
	...
	public static class DEBUG_VECT extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(250, 0, 0, 1, 21, 160, 0, _UE);
	}
	...
	public static class NAMED_VALUE_FLOAT extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(251, 0, 1, 0, 9, 64, 0, _vE);
	}
	...
	public static class NAMED_VALUE_INT extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(252, 0, 1, 0, 9, 64, 0, _FZ);
	}
	...
	public static class STATUSTEXT extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(253, 0, 0, 0, 2, 4, 0, _XZ);
	}
	...
	public static class PLAY_TUNE extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(258, 0, 0, 0, 3, 16, 0, _GZ);
	}
	...
	public static class CAMERA_INFORMATION extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(259, 3, 2, 0, 93, 731, 0, _lZ);
	}
	...
	public static class CAMERA_IMAGE_CAPTURED extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(263, 0, 1, 1, 51, 402, 2, _fT);
	}
	...
	public static class VIDEO_STREAM_INFORMATION extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(269, 3, 1, 0, 17, 130, 2, _bT);
	}
	...
	public static class SET_VIDEO_STREAM_SETTINGS extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(270, 3, 1, 0, 18, 138, 2, _cT);
	}
	...
	public static class WIFI_CONFIG_AP extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(299, 0, 0, 0, 1, 2, 2, _RT, _zT);
	}
	...
	public static class UAVCAN_NODE_INFO extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(311, 0, 2, 1, 37, 288, 0, _PC);
	}
	...
	public static class PARAM_EXT_REQUEST_READ extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(320, 0, 0, 0, 5, 32, 0, _NC);
	}
	...
	public static class PARAM_EXT_VALUE extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(322, 2, 0, 0, 5, 38, 2, _CC, _aC);
	}
	...
	public static class PARAM_EXT_SET extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(323, 0, 0, 0, 3, 22, 2, _lC, _uC);
	}
	...
	public static class PARAM_EXT_ACK extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(324, 0, 0, 0, 2, 9, 2, _YC, _yC);
	}
	...
	private static final Field _og = new Field(0, true, 1, 4, 1, 0, 0, 0);
	private static final Field _Kg = new Field(0, true, 1, 4, 1, 0, 0, 0);
	private static final Field _Sg = new Field(0, true, 1, 4, 1, 0, 0, 0);
	private static final Field _jg = new Field(0, true, 1, 4, 1, 0, 0, 0);
	private static final Field _PX = new Field(0, true, 1, 2, 1, 0, 0, 0);
	private static final Field _pX = new Field(0, true, 1, 2, 1, 0, 0, 0);
	private static final Field _oX = new Field(0, true, 1, 2, 1, 0, 0, 0);
	private static final Field _KX = new Field(0, true, 1, 2, 1, 0, 0, 0);
	private static final Field _SX = new Field(0, true, 1, 2, 1, 0, 0, 0);
	private static final Field _jX = new Field(0, true, 1, 2, 1, 0, 0, 0);
	private static final Field _QX = new Field(0, true, 1, 2, 1, 0, 0, 0);
	private static final Field _GX = new Field(0, true, 1, 2, 1, 0, 0, 0);
	private static final Field _Bs = new Field(0, true, 1, 8, 1, 0, 0, 0);
	private static final Field _Ts = new Field(0, true, 1, 8, 1, 0, 0, 0);
	private static final Field _xs = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
	private static final Field _ak = new Field(0, false, 1, 1, 1, 0, 0, 0);
	private static final Field _xk = new Field(0, false, 1, 4, 1, 0, 0, 0);
	private static final Field _Ik = new Field(0, false, 1, 1, 1, 0, 0, 0);
	private static final Field _hk = new Field(0, false, 1, 1, 1, 0, 0, 0);
	private static final Field _jp = new Field(0, false, 1, 4, 1, 0, 0, 0);
	private static final Field _Qp = new Field(0, false, 1, 4, 1, 0, 0, 0);
	private static final Field _fB = new Field(0, false, 18, 1, 1, 0, 0, 0);
	private static final Field _jB = new Field(0, false, 1, 4, 1, 0, 0, 0);
	private static final Field _QB = new Field(0, false, 1, 4, 1, 0, 0, 0);
	private static final Field _GB = new Field(0, false, 1, 4, 1, 0, 0, 0);
	private static final Field _BB = new Field(0, false, 4, 4, 1, 0, 0, 0);
	private static final Field _EB = new Field(0, false, 1, 1, 1, 0, 0, 0);
	private static final Field _vN = new Field(0, true, 1, 8, 1, 0, 0, 0);
	private static final Field _PE = new Field(0, true, 1, 8, 1, 0, 0, 0);
	private static final Field _CE = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
	private static final Field _UE = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
	private static final Field _vE = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
	private static final Field _FZ = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
	private static final Field _XZ = new Field(5, true, -6, 2, 1, 0, 0, 0, 1);
	private static final Field _GZ = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
	...
	private static final Field _bT = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
	private static final Field _cT = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
	private static final Field _RT = new Field(5, true, -6, 2, 1, 0, 0, 0, 1);
	private static final Field _zT = new Field(5, true, -7, 2, 1, 0, 0, 0, 1);
	private static final Field _PC = new Field(5, true, -7, 2, 1, 0, 0, 0, 1);
	private static final Field _NC = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
	private static final Field _CC = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
	private static final Field _aC = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
	private static final Field _lC = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
	private static final Field _uC = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
	private static final Field _YC = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
	private static final Field _yC = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
	private static final Field _Fa = new Field(5, true, -3, 2, 1, 0, 0, 0, 1);
	private static final Field _ga = new Field(5, true, -3, 2, 1, 0, 0, 0, 1);
	private static final Field _oa = new Field(5, true, -6, 2, 1, 0, 0, 0, 1);
	private static final Field _Ca = new Field(5, true, -6, 2, 1, 0, 0, 0, 1);
