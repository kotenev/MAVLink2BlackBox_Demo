...
namespace org.noname
{
    public class DemoDevice : Host
    {
        ...
        } public class CHANGE_OPERATOR_CONTROL : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            } static readonly Meta meta5 = new Meta(5, 0, 0, 0, 4, 24, 0, _H);
        ...
        } public class AUTH_KEY : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {key_SET(src.ToCharArray(), 0, src.Length, ph);} public void key_SET(char[] src, int pos, int items, Inside ph) //ke
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta7 = new Meta(7, 0, 0, 0, 1, 0, 0, _S);
        ...
        } public class PARAM_REQUEST_READ : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            } public void param_id_SET(string src, Inside ph) {param_id_SET(src.ToCharArray(), 0, src.Length, ph);} public void param_id_SET(char[] src, int pos, int items, Inside ph)
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta20 = new Meta(20, 0, 0, 0, 5, 32, 0, _k);
        ...
        } public class PARAM_SET : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            } public void param_id_SET(string src, Inside ph) {param_id_SET(src.ToCharArray(), 0, src.Length, ph);} public void param_id_SET(char[] src, int pos, int items, Inside ph)
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta23 = new Meta(23, 0, 0, 0, 8, 52, 0, _I);
        } public class GPS_RAW_INT : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            public void hdg_acc_SET(uint src, Inside ph)//Heading / track uncertainty in degrees * 1e5
            {
                ...
                BitUtils.set_bytes((ulong)(src), 4, data,  ph.BYTE);
            } static readonly Meta meta24 = new Meta(24, 4, 0, 1, 31, 236, 0, _Lp, _up, _Wp, _Mp, _ep);
        ...
        } public class SERVO_OUTPUT_RAW : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            public void servo16_raw_SET(ushort src, Inside ph)//Servo output 16 value, in microsecond
            {
                ...
                BitUtils.set_bytes((ulong)(src), 2, data,  ph.BYTE);
            } static readonly Meta meta36 = new Meta(36, 8, 1, 0, 22, 168, 0, _Yt, _Lt, _ut, _Wt, _Mt, _et, _yt, _Kt);
        ...
        } public class SET_GPS_GLOBAL_ORIGIN : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            } static readonly Meta meta48 = new Meta(48, 0, 0, 0, 14, 104, 0, _Bq);
        ...
        } public class PARAM_MAP_RC : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            } public void param_id_SET(string src, Inside ph) {param_id_SET(src.ToCharArray(), 0, src.Length, ph);} public void param_id_SET(char[] src, int pos, int items, Inside ph)
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta50 = new Meta(50, 0, 0, 0, 22, 168, 0, _Uq);
        ...
        } public class COMMAND_ACK : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            public void target_component_SET(byte src, Inside ph)//WIP: Component which requested the command to be execute
            {
                ...
                BitUtils.set_bytes((ulong)(src), 1, data,  ph.BYTE);
            } static readonly Meta meta77 = new Meta(77, 0, 0, 0, 3, 10, 0, _XN, _UN, _vN, _oN);
        ...
        } public class OPTICAL_FLOW : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            public void flow_rate_y_SET(float src, Inside ph)//Flow rate in radians/second about Y axi
            {
                ...
                BitUtils.set_bytes(BitUtils.FloatToInt32Bits(src), 4, data, ph.BYTE);
            } static readonly Meta meta100 = new Meta(100, 0, 0, 1, 27, 208, 0, _eL, _yL);
        ...
        } public class AUTOPILOT_VERSION : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            } public void uid2_SET(byte[] src, int pos, Inside ph)
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + 18; pos < src_max; pos++, BYTE += 1)
                    BitUtils.set_bytes((ulong)(src[pos]), 1, data,  BYTE);
            } static readonly Meta meta148 = new Meta(148, 2, 4, 1, 54, 421, 0, _lB);
        } public class LANDING_TARGET : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            public void position_valid_SET(byte src, Inside ph)
            {
                ...
                BitUtils.set_bytes((ulong)(src), 1, data,  ph.BYTE);
            } static readonly Meta meta149 = new Meta(149, 0, 0, 1, 31, 239, 0, _eB, _yB, _KB, _BB, _AB);
        } public class ARRAY_TEST_0 : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal ARRAY_TEST_0() : base(meta150, 0) { }
            internal ARRAY_TEST_0(int bytes) : base(meta150, bytes) { }
            public ushort[] ar_u16 //Value arra
            {
                get {return ar_u16_GET(new ushort[4], 0);}
                set {ar_u16_SET(value, 0)  ;}
            }
            public ushort[]ar_u16_GET(ushort[] dst_ch, int pos)  //Value arra
            {
            ...
            public void ar_u16_SET(ushort[] src, int pos)  //Value arra
            {
            ...
            public uint[] ar_u32 //Value arra
            {
                get {return ar_u32_GET(new uint[4], 0);}
                set {ar_u32_SET(value, 0)  ;}
            }
            public uint[]ar_u32_GET(uint[] dst_ch, int pos)  //Value arra
            {
                for(int BYTE = 8, dst_max = pos + 4; pos < dst_max ; pos++,  BYTE += 4)
            ...
            public void ar_u32_SET(uint[] src, int pos)  //Value arra
            {
                for(int BYTE =  8, src_max = pos + 4; pos < src_max; pos++, BYTE += 4)
            ...
            public byte v1 //Stub fiel
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  24, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  24);}
            }

            public sbyte[] ar_i8 //Value arra
            {
                get {return ar_i8_GET(new sbyte[4], 0);}
                set {ar_i8_SET(value, 0)  ;}
            }
            public sbyte[]ar_i8_GET(sbyte[] dst_ch, int pos)  //Value arra
            {
            ...
            public void ar_i8_SET(sbyte[] src, int pos)  //Value arra
            {
            ...
            public byte[] ar_u8 //Value arra
            {
                get {return ar_u8_GET(new byte[4], 0);}
                set {ar_u8_SET(value, 0)  ;}
            }
            public byte[]ar_u8_GET(byte[] dst_ch, int pos)  //Value arra
            {
            ...
            public void ar_u8_SET(byte[] src, int pos)  //Value arra
            {
                for(int BYTE =  29, src_max = pos + 4; pos < src_max; pos++, BYTE += 1)
                    BitUtils.set_bytes((ulong)(src[pos]), 1, data,  BYTE);
            }

            static readonly Meta meta150 = new Meta(150, 4, 4, 0, 33, 264);
        } public class ARRAY_TEST_1 : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal ARRAY_TEST_1() : base(meta151, 0) { }
            internal ARRAY_TEST_1(int bytes) : base(meta151, bytes) { }
            public uint[] ar_u32 //Value arra
            {
                get {return ar_u32_GET(new uint[4], 0);}
                set {ar_u32_SET(value, 0)  ;}
            ...
            static readonly Meta meta151 = new Meta(151, 0, 4, 0, 16, 128);
        } public class ARRAY_TEST_3 : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal ARRAY_TEST_3() : base(meta153, 0) { }
            internal ARRAY_TEST_3(int bytes) : base(meta153, bytes) { }
            public uint[] ar_u32 //Value arra
            {
                get {return ar_u32_GET(new uint[4], 0);}
                set {ar_u32_SET(value, 0)  ;}
            ...
            public byte v //Stub fiel
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  16, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  16);}
            }
            static readonly Meta meta153 = new Meta(153, 0, 4, 0, 17, 136);
        } public class ARRAY_TEST_4 : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal ARRAY_TEST_4() : base(meta154, 0) { }
            internal ARRAY_TEST_4(int bytes) : base(meta154, bytes) { }
            public uint[] ar_u32 //Value arra
            {
                get {return ar_u32_GET(new uint[4], 0);}
                set {ar_u32_SET(value, 0)  ;}
            ...
            static readonly Meta meta154 = new Meta(154, 0, 4, 0, 17, 136);
        } public class ARRAY_TEST_5 : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal ARRAY_TEST_5() : base(meta155, 0) { }
            internal ARRAY_TEST_5(int bytes) : base(meta155, bytes) { }  public string c1_TRY(Inside ph)//Value arra
            {
                if(ph.field_bit !=  0 && !try_visit_field(ph, 0)  ||  !try_visit_item(ph, 0)) return null;
                return new string(c1_GET(ph, new char[ph.items], 0));
            }
            public char[]c1_GET(Inside ph, char[] dst_ch, int pos) //Value arra
            {
                for(int BYTE = ph.BYTE, dst_max = pos + ph.items; pos < dst_max ; pos++,  BYTE += 2)
                    dst_ch[pos] = (char)((char) BitUtils.get_bytes(data,  BYTE, 2));
                return dst_ch;
            ...
            {
                return (ph.field_bit !=  0 && !try_visit_field(ph, 0)  ||  !try_visit_item(ph, 0)) ? 0 : ph.items;
            } public void c1_SET(string src, Inside ph) //Value arra
            {c1_SET(src.ToCharArray(), 0, src.Length, ph);} public void c1_SET(char[] src, int pos, int items, Inside ph) //Value arra
            {
                if(ph.field_bit != 0 && insert_field(ph, 0, items) ||
                        ! try_visit_item(ph, 0)) insert_item(ph, 0, items);
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } public string c2_TRY(Inside ph)//Value arra
            {
                if(ph.field_bit !=  1 && !try_visit_field(ph, 1)  ||  !try_visit_item(ph, 0)) return null;
                return new string(c2_GET(ph, new char[ph.items], 0));
            }
            public char[]c2_GET(Inside ph, char[] dst_ch, int pos) //Value arra
            {
                for(int BYTE = ph.BYTE, dst_max = pos + ph.items; pos < dst_max ; pos++,  BYTE += 2)
                    dst_ch[pos] = (char)((char) BitUtils.get_bytes(data,  BYTE, 2));
                return dst_ch;
            ...
            } public void c2_SET(string src, Inside ph) //Value arra
            {c2_SET(src.ToCharArray(), 0, src.Length, ph);} public void c2_SET(char[] src, int pos, int items, Inside ph) //Value arra
            {
                if(ph.field_bit != 1 && insert_field(ph, 1, items) ||
                        ! try_visit_item(ph, 0)) insert_item(ph, 0, items);
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta155 = new Meta(155, 0, 0, 0, 1, 0, 0, _iX, _pX);
        } public class ARRAY_TEST_6 : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal ARRAY_TEST_6() : base(meta156, 0) { }
            internal ARRAY_TEST_6(int bytes) : base(meta156, bytes) { }
            public ushort v2 //Stub fiel
            {
                get {  return (ushort)((ushort) BitUtils.get_bytes(data,  0, 2));}
                set {  BitUtils.set_bytes((ulong)(value), 2, data,  0);}
            }
            ...
            public int[] ar_i32 //Value arra
            {
                get {return ar_i32_GET(new int[2], 0);}
                set {ar_i32_SET(value, 0)  ;}
            }
            ...
            public void ar_i32_SET(int[] src, int pos)  //Value arra
            {
            ...
            public short[] ar_i16 //Value arra
            {
                get {return ar_i16_GET(new short[2], 0);}
                set {ar_i16_SET(value, 0)  ;}
            }
            ...
            public void ar_i16_SET(short[] src, int pos)  //Value arra
            {
            ...
            public double[] ar_d //Value arra
            {
                get {return ar_d_GET(new double[2], 0);}
                set {ar_d_SET(value, 0)  ;}
            }
            ...
            public void ar_d_SET(double[] src, int pos)  //Value arra
            {
            ...
            public float[] ar_f //Value arra
            {
                get {return ar_f_GET(new float[2], 0);}
                set {ar_f_SET(value, 0)  ;}
            }
            ...
            public void ar_f_SET(float[] src, int pos)  //Value arra
            {
                for(int BYTE =  51, src_max = pos + 2; pos < src_max; pos++, BYTE += 4)
                    BitUtils.set_bytes(BitUtils.FloatToInt32Bits(src[pos]), 4, data, BYTE);
            }

            public string ar_c_TRY(Inside ph)//Value arra
            {
            ...
            public char[]ar_c_GET(Inside ph, char[] dst_ch, int pos) //Value arra
            {
                for(int BYTE = ph.BYTE, dst_max = pos + ph.items; pos < dst_max ; pos++,  BYTE += 2)
                    dst_ch[pos] = (char)((char) BitUtils.get_bytes(data,  BYTE, 2));
                return dst_ch;
            ...
            } public void ar_c_SET(string src, Inside ph) //Value arra
            {ar_c_SET(src.ToCharArray(), 0, src.Length, ph);} public void ar_c_SET(char[] src, int pos, int items, Inside ph) //Value arra
            {
                if(ph.field_bit != 472 && insert_field(ph, 472, items) ||
                        ! try_visit_item(ph, 0)) insert_item(ph, 0, items);
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta156 = new Meta(156, 3, 3, 0, 60, 472, 0, _uX);
        } public class ARRAY_TEST_7 : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal ARRAY_TEST_7() : base(meta157, 0) { }
            internal ARRAY_TEST_7(int bytes) : base(meta157, bytes) { }
            public ushort[] ar_u16 //Value arra
            {
                get {return ar_u16_GET(new ushort[2], 0);}
                set {ar_u16_SET(value, 0)  ;}
            ...
            {ar_c_SET(src.ToCharArray(), 0, src.Length, ph);} public void ar_c_SET(char[] src, int pos, int items, Inside ph) //Value arra
            {
                if(ph.field_bit != 416 && insert_field(ph, 416, items) ||
                        ! try_visit_item(ph, 0)) insert_item(ph, 0, items);
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta157 = new Meta(157, 2, 2, 0, 53, 416, 0, _rX);
        } public class ARRAY_TEST_8 : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal ARRAY_TEST_8() : base(meta158, 0) { }
            internal ARRAY_TEST_8(int bytes) : base(meta158, bytes) { }
            public ushort[] ar_u16 //Value arra
            {
                get {return ar_u16_GET(new ushort[2], 0);}
                set {ar_u16_SET(value, 0)  ;}
            ...
            static readonly Meta meta158 = new Meta(158, 2, 1, 0, 24, 192);
        ...
        } public class HOME_POSITION : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            public void time_usec_SET(ulong src, Inside ph)//Timestamp (microseconds since UNIX epoch or microseconds since system boot
            {
                ...
                BitUtils.set_bytes((ulong)(src), 8, data,  ph.BYTE);
            } static readonly Meta meta242 = new Meta(242, 0, 0, 0, 53, 416, 0, _IO);
        } public class SET_HOME_POSITION : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            public void time_usec_SET(ulong src, Inside ph)//Timestamp (microseconds since UNIX epoch or microseconds since system boot
            {
                ...
                BitUtils.set_bytes((ulong)(src), 8, data,  ph.BYTE);
            } static readonly Meta meta243 = new Meta(243, 0, 0, 0, 54, 424, 0, _YA);
        ...
        } public class ADSB_VEHICLE : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {callsign_SET(src.ToCharArray(), 0, src.Length, ph);} public void callsign_SET(char[] src, int pos, int items, Inside ph) //The callsign, 8+nul
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta246 = new Meta(246, 3, 1, 0, 28, 210, 0, _rA);
        ...
        } public class DEBUG_VECT : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {name_SET(src.ToCharArray(), 0, src.Length, ph);} public void name_SET(char[] src, int pos, int items, Inside ph) //Nam
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta250 = new Meta(250, 0, 0, 1, 21, 160, 0, _FA);
        } public class NAMED_VALUE_FLOAT : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {name_SET(src.ToCharArray(), 0, src.Length, ph);} public void name_SET(char[] src, int pos, int items, Inside ph) //Name of the debug variabl
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta251 = new Meta(251, 0, 1, 0, 9, 64, 0, _IA);
        } public class NAMED_VALUE_INT : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {name_SET(src.ToCharArray(), 0, src.Length, ph);} public void name_SET(char[] src, int pos, int items, Inside ph) //Name of the debug variabl
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta252 = new Meta(252, 0, 1, 0, 9, 64, 0, _ij);
        } public class STATUSTEXT : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {text_SET(src.ToCharArray(), 0, src.Length, ph);} public void text_SET(char[] src, int pos, int items, Inside ph) //Status text message, without null termination characte
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta253 = new Meta(253, 0, 0, 0, 2, 4, 0, _tj);
        ...
        } public class PLAY_TUNE : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {tune_SET(src.ToCharArray(), 0, src.Length, ph);} public void tune_SET(char[] src, int pos, int items, Inside ph) //tune in board specific forma
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta258 = new Meta(258, 0, 0, 0, 3, 16, 0, _Kj);
        } public class CAMERA_INFORMATION : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {cam_definition_uri_SET(src.ToCharArray(), 0, src.Length, ph);} public void cam_definition_uri_SET(char[] src, int pos, int items, Inside ph) //Camera definition URI (if any, otherwise only basic functions will be available)
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta259 = new Meta(259, 3, 2, 0, 93, 731, 0, _Gj);
        ...
        } public class CAMERA_IMAGE_CAPTURED : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {file_url_SET(src.ToCharArray(), 0, src.Length, ph);} public void file_url_SET(char[] src, int pos, int items, Inside ph) //foo.jpg if camera provides an HTTP interface
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta263 = new Meta(263, 0, 1, 1, 51, 402, 2, _lT);
        ...
        } public class VIDEO_STREAM_INFORMATION : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {uri_SET(src.ToCharArray(), 0, src.Length, ph);} public void uri_SET(char[] src, int pos, int items, Inside ph) //Video stream UR
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta269 = new Meta(269, 3, 1, 0, 17, 130, 2, _fT);
        } public class SET_VIDEO_STREAM_SETTINGS : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {uri_SET(src.ToCharArray(), 0, src.Length, ph);} public void uri_SET(char[] src, int pos, int items, Inside ph) //Video stream UR
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta270 = new Meta(270, 3, 1, 0, 18, 138, 2, _CT);
        } public class WIFI_CONFIG_AP : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {password_SET(src.ToCharArray(), 0, src.Length, ph);} public void password_SET(char[] src, int pos, int items, Inside ph) //Password. Leave it blank for an open AP
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta299 = new Meta(299, 0, 0, 0, 1, 2, 2, _JT, _dT);
        ...
        } public class UAVCAN_NODE_INFO : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {name_SET(src.ToCharArray(), 0, src.Length, ph);} public void name_SET(char[] src, int pos, int items, Inside ph) //Node name string. For example, "sapog.px4.io"
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta311 = new Meta(311, 0, 2, 1, 37, 288, 0, _Yr);
        } public class PARAM_EXT_REQUEST_READ : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            } public void param_id_SET(string src, Inside ph) {param_id_SET(src.ToCharArray(), 0, src.Length, ph);} public void param_id_SET(char[] src, int pos, int items, Inside ph)
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta320 = new Meta(320, 0, 0, 0, 5, 32, 0, _Or);
        ...
        } public class PARAM_EXT_VALUE : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {param_value_SET(src.ToCharArray(), 0, src.Length, ph);} public void param_value_SET(char[] src, int pos, int items, Inside ph) //Parameter valu
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta322 = new Meta(322, 2, 0, 0, 5, 38, 2, _rr, _Xr);
        } public class PARAM_EXT_SET : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {param_value_SET(src.ToCharArray(), 0, src.Length, ph);} public void param_value_SET(char[] src, int pos, int items, Inside ph) //Parameter valu
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta323 = new Meta(323, 0, 0, 0, 3, 22, 2, _Gr, _zr);
        } public class PARAM_EXT_ACK : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {param_value_SET(src.ToCharArray(), 0, src.Length, ph);} public void param_value_SET(char[] src, int pos, int items, Inside ph) //Parameter value (new value if PARAM_ACK_ACCEPTED, current value otherwise
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta324 = new Meta(324, 0, 0, 0, 2, 9, 2, _Sr, _Vr);
                ...
                for(bool LOOP = false; ;)
                {
                    switch(id)
                    {
                        ...
                        case 150:
                            ...
                            if(OnARRAY_TEST_0Receive == null) return null;
                            ph.setPack(pack);
                            OnARRAY_TEST_0Receive(this, ph, (ARRAY_TEST_0) pack);
                            if(LOOP) break;
                            return null;
                        case 151:
                            if(pack == null) return new ARRAY_TEST_1();
                            if(OnARRAY_TEST_1Receive == null) return null;
                            ph.setPack(pack);
                            OnARRAY_TEST_1Receive(this, ph, (ARRAY_TEST_1) pack);
                            if(LOOP) break;
                            return null;
                        case 153:
                            if(pack == null) return new ARRAY_TEST_3();
                            if(OnARRAY_TEST_3Receive == null) return null;
                            ph.setPack(pack);
                            OnARRAY_TEST_3Receive(this, ph, (ARRAY_TEST_3) pack);
                            if(LOOP) break;
                            return null;
                        case 154:
                            if(pack == null) return new ARRAY_TEST_4();
                            if(OnARRAY_TEST_4Receive == null) return null;
                            ph.setPack(pack);
                            OnARRAY_TEST_4Receive(this, ph, (ARRAY_TEST_4) pack);
                            if(LOOP) break;
                            return null;
                        case 155:
                            if(pack == null) return new ARRAY_TEST_5(-1);
                            if(OnARRAY_TEST_5Receive == null) return null;
                            ph.setPack(pack);
                            OnARRAY_TEST_5Receive(this, ph, (ARRAY_TEST_5) pack);
                            if(LOOP) break;
                            return null;
                        case 156:
                            if(pack == null) return new ARRAY_TEST_6(-1);
                            if(OnARRAY_TEST_6Receive == null) return null;
                            ph.setPack(pack);
                            OnARRAY_TEST_6Receive(this, ph, (ARRAY_TEST_6) pack);
                            if(LOOP) break;
                            return null;
                        case 157:
                            if(pack == null) return new ARRAY_TEST_7(-1);
                            if(OnARRAY_TEST_7Receive == null) return null;
                            ph.setPack(pack);
                            OnARRAY_TEST_7Receive(this, ph, (ARRAY_TEST_7) pack);
                            if(LOOP) break;
                            return null;
                        case 158:
                            if(pack == null) return new ARRAY_TEST_8();
                            if(OnARRAY_TEST_8Receive == null) return null;
                            ph.setPack(pack);
                            OnARRAY_TEST_8Receive(this, ph, (ARRAY_TEST_8) pack);
                            if(LOOP) break;
                            return null;
                        case 230:
        ...
        static readonly Field _S = new Field(5, true, -6, 2, 1, 0, 0, 0, 1);
        ...
        static readonly Field _Lp = new Field(0, false, 1, 4, 1, 0, 0, 0);
        static readonly Field _up = new Field(0, true, 1, 4, 1, 0, 0, 0);
        static readonly Field _Wp = new Field(0, true, 1, 4, 1, 0, 0, 0);
        static readonly Field _Mp = new Field(0, true, 1, 4, 1, 0, 0, 0);
        static readonly Field _ep = new Field(0, true, 1, 4, 1, 0, 0, 0);
        static readonly Field _Yt = new Field(0, true, 1, 2, 1, 0, 0, 0);
        static readonly Field _Lt = new Field(0, true, 1, 2, 1, 0, 0, 0);
        static readonly Field _ut = new Field(0, true, 1, 2, 1, 0, 0, 0);
        static readonly Field _Wt = new Field(0, true, 1, 2, 1, 0, 0, 0);
        static readonly Field _Mt = new Field(0, true, 1, 2, 1, 0, 0, 0);
        static readonly Field _et = new Field(0, true, 1, 2, 1, 0, 0, 0);
        static readonly Field _yt = new Field(0, true, 1, 2, 1, 0, 0, 0);
        static readonly Field _Kt = new Field(0, true, 1, 2, 1, 0, 0, 0);
        static readonly Field _Bq = new Field(0, true, 1, 8, 1, 0, 0, 0);
        static readonly Field _Tq = new Field(0, true, 1, 8, 1, 0, 0, 0);
        static readonly Field _Uq = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
        static readonly Field _XN = new Field(0, false, 1, 1, 1, 0, 0, 0);
        static readonly Field _UN = new Field(0, false, 1, 4, 1, 0, 0, 0);
        static readonly Field _vN = new Field(0, false, 1, 1, 1, 0, 0, 0);
        static readonly Field _oN = new Field(0, false, 1, 1, 1, 0, 0, 0);
        static readonly Field _eL = new Field(0, false, 1, 4, 1, 0, 0, 0);
        static readonly Field _yL = new Field(0, false, 1, 4, 1, 0, 0, 0);
        static readonly Field _lB = new Field(0, false, 18, 1, 1, 0, 0, 0);
        static readonly Field _eB = new Field(0, false, 1, 4, 1, 0, 0, 0);
        static readonly Field _yB = new Field(0, false, 1, 4, 1, 0, 0, 0);
        static readonly Field _KB = new Field(0, false, 1, 4, 1, 0, 0, 0);
        static readonly Field _BB = new Field(0, false, 4, 4, 1, 0, 0, 0);
        static readonly Field _AB = new Field(0, false, 1, 1, 1, 0, 0, 0);
        static readonly Field _IO = new Field(0, true, 1, 8, 1, 0, 0, 0);
        static readonly Field _YA = new Field(0, true, 1, 8, 1, 0, 0, 0);
        static readonly Field _rA = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
        static readonly Field _FA = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
        static readonly Field _IA = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
        static readonly Field _ij = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
        static readonly Field _tj = new Field(5, true, -6, 2, 1, 0, 0, 0, 1);
        static readonly Field _Kj = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
        static readonly Field _Gj = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
        static readonly Field _lT = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
        static readonly Field _fT = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
        static readonly Field _CT = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
        static readonly Field _JT = new Field(5, true, -6, 2, 1, 0, 0, 0, 1);
        static readonly Field _dT = new Field(5, true, -7, 2, 1, 0, 0, 0, 1);
        static readonly Field _Yr = new Field(5, true, -7, 2, 1, 0, 0, 0, 1);
        static readonly Field _Or = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
        static readonly Field _rr = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
        static readonly Field _Xr = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
        static readonly Field _Gr = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
        static readonly Field _zr = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
        static readonly Field _Sr = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
        static readonly Field _Vr = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
        static readonly Field _iX = new Field(5, true, -3, 2, 1, 0, 0, 0, 1);
        static readonly Field _pX = new Field(5, true, -3, 2, 1, 0, 0, 0, 1);
        static readonly Field _uX = new Field(5, true, -6, 2, 1, 0, 0, 0, 1);
        static readonly Field _rX = new Field(5, true, -6, 2, 1, 0, 0, 0, 1);
