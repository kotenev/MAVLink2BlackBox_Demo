...
*	so transmitting the key requires an encrypted channel for true safety*/
        public class AUTH_KEY : Pack
        {
            ...
            } static readonly Meta meta7 = new Meta(7, 0, 0, 0, 1, 0, 0, _j);
        }/**
...
*	a loss or timeout*/
        public class PARAM_VALUE : Pack
        {
            ...
            *	storage if the ID is stored as strin*/
            ...
            } static readonly Meta meta22 = new Meta(22, 2, 0, 0, 10, 68, 0, _X);
        }/**
...
*	NOT the global position estimate of the system, but rather a RAW sensor value. See message GLOBAL_POSITION for the global position estimate. Coordinate frame is right-handed, Z-axis up (GPS frame).*/
        public class GPS_RAW_INT : Pack
        {
            ...
            *	the AMSL altitude in addition to the WGS84 altitude*/
            ...
            static readonly Meta meta24 = new Meta(24, 4, 0, 1, 31, 236, 0, _Al, _tl, _el, _il, _Gl);
        }/**
...
*	standard PPM modulation is as follows: 1000 microseconds: 0%, 2000 microseconds: 100%*/
        public class SERVO_OUTPUT_RAW : Pack
        {
            ...
            *	more than 8 servos*/
            ...
            static readonly Meta meta36 = new Meta(36, 8, 1, 0, 22, 168, 0, _Dr, _Ar, _tr, _er, _ir, _Gr, _Tr, _zr);
        }/**
...
*	are connected and the MAV should move from in- to outdoor*/
        public class SET_GPS_GLOBAL_ORIGIN : Pack
        {
            ...
            static readonly Meta meta48 = new Meta(48, 0, 0, 0, 14, 104, 0, _Lw);
        }/**
*Once the MAV sets a new GPS-Local correspondence, this message announces the origin (0,0,0) positio*/
        public class GPS_GLOBAL_ORIGIN : Pack
        {
            ...
            static readonly Meta meta49 = new Meta(49, 0, 0, 0, 13, 96, 0, _Jw);
        }/**
*Bind a RC channel to a parameter. The parameter should change accoding to the RC channel value.*/
        public class PARAM_MAP_RC : Pack
        {
            ...
            *	storage if the ID is stored as strin*/
            ...
            } static readonly Meta meta50 = new Meta(50, 0, 0, 0, 22, 168, 0, _xw);
        }/**
*Request the information of the mission item with the sequence number seq. The response of the system to
...
*	be denied*/
            ...
            *	be denied*/
            ...
            public void target_component_SET(byte src, Inside ph)//WIP: Component which requested the command to be executed
            {
                ...
                BitUtils.set_bytes((ulong)(src), 1, data,  ph.BYTE);
            } static readonly Meta meta77 = new Meta(77, 0, 0, 0, 3, 10, 0, _Qn, _xn, _Kn, _hn);
        }/**
...
*Optical flow from a flow sensor (e.g. optical mouse sensor)*/
        public class OPTICAL_FLOW : Pack, CommunicationChannel.Sendable
        {
            ...
            public void flow_rate_y_SET(float src, Inside ph)//Flow rate in radians/second about Y axis
            {
                ...
                BitUtils.set_bytes(BitUtils.FloatToInt32Bits(src), 4, data, ph.BYTE);
            } static readonly Meta meta100 = new Meta(100, 0, 0, 1, 27, 208, 0, _GA, _TA);
            ...
            *	use uid*/
            public void uid2_SET(byte[] src, int pos, Inside ph)
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + 18; pos < src_max; pos++, BYTE += 1)
                    BitUtils.set_bytes((ulong)(src[pos]), 1, data,  BYTE);
            } static readonly Meta meta148 = new Meta(148, 2, 4, 1, 54, 421, 0, _IL);
        }/**
...
*	the landing targe*/
            public void position_valid_SET(byte src, Inside ph)
            {
                ...
                BitUtils.set_bytes((ulong)(src), 1, data,  ph.BYTE);
            } static readonly Meta meta149 = new Meta(149, 0, 0, 1, 31, 239, 0, _GL, _TL, _zL, _LL, _NL);
        }/**
*Array test #0.*/
...
*Array test #5.*/
        public class ARRAY_TEST_5 : Pack, CommunicationChannel.Sendable
        {
            ...
            {c2_SET(src.ToCharArray(), 0, src.Length, ph);} public void c2_SET(char[] src, int pos, int items, Inside ph) //Value array
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta155 = new Meta(155, 0, 0, 0, 1, 0, 0, _CQ, _lQ);
        }/**
*Array test #6.*/
        public class ARRAY_TEST_6 : Pack, CommunicationChannel.Sendable
        {
            ...
            {ar_c_SET(src.ToCharArray(), 0, src.Length, ph);} public void ar_c_SET(char[] src, int pos, int items, Inside ph) //Value array
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta156 = new Meta(156, 3, 3, 0, 60, 472, 0, _tQ);
        }/**
*Array test #7.*/
        public class ARRAY_TEST_7 : Pack, CommunicationChannel.Sendable
        {
            ...
            {ar_c_SET(src.ToCharArray(), 0, src.Length, ph);} public void ar_c_SET(char[] src, int pos, int items, Inside ph) //Value array
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta157 = new Meta(157, 2, 2, 0, 53, 416, 0, _gQ);
        }/**
*Array test #8.*/
...
*	the vector*/
        public class HOME_POSITION : Pack, CommunicationChannel.Sendable
        {
            ...
            *	from the threshold / touchdown zone*/
            ...
            } static readonly Meta meta242 = new Meta(242, 0, 0, 0, 53, 416, 0, _ZE);
        }/**
        ...
        public class SET_HOME_POSITION : Pack, CommunicationChannel.Sendable
        {
            ...
            *	from the threshold / touchdown zone*/
            ...
            public void time_usec_SET(ulong src, Inside ph)//Timestamp (microseconds since UNIX epoch or microseconds since system boot)
            {
                ...
                BitUtils.set_bytes((ulong)(src), 8, data,  ph.BYTE);
            } static readonly Meta meta243 = new Meta(243, 0, 0, 0, 54, 424, 0, _DN);
        }/**
...
*The location and information of an ADSB vehicle*/
        public class ADSB_VEHICLE : Pack, CommunicationChannel.Sendable
        {
            ...
            {callsign_SET(src.ToCharArray(), 0, src.Length, ph);} public void callsign_SET(char[] src, int pos, int items, Inside ph) //The callsign, 8+null
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta246 = new Meta(246, 3, 1, 0, 28, 210, 0, _gN);
        }/**
...
*	way for testing new messages and getting experimental debug output*/
        ...
        } public class DEBUG_VECT : Pack, CommunicationChannel.Sendable
        {
            ...
            {name_SET(src.ToCharArray(), 0, src.Length, ph);} public void name_SET(char[] src, int pos, int items, Inside ph) //Name
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta250 = new Meta(250, 0, 0, 1, 21, 160, 0, _RN);
        }/**
...
*	efficient way for testing new messages and getting experimental debug output*/
        public class NAMED_VALUE_FLOAT : Pack, CommunicationChannel.Sendable
        {
            ...
            {name_SET(src.ToCharArray(), 0, src.Length, ph);} public void name_SET(char[] src, int pos, int items, Inside ph) //Name of the debug variable
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta251 = new Meta(251, 0, 1, 0, 9, 64, 0, _ZN);
        }/**
...
*	efficient way for testing new messages and getting experimental debug output*/
        public class NAMED_VALUE_INT : Pack, CommunicationChannel.Sendable
        {
            ...
            {name_SET(src.ToCharArray(), 0, src.Length, ph);} public void name_SET(char[] src, int pos, int items, Inside ph) //Name of the debug variable
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta252 = new Meta(252, 0, 1, 0, 9, 64, 0, _Cc);
        }/**
...
*	wisely, these messages are buffered on the MCU and sent only at a limited rate (e.g. 10 Hz)*/
        public class STATUSTEXT : Pack, CommunicationChannel.Sendable
        {
            ...
            {text_SET(src.ToCharArray(), 0, src.Length, ph);} public void text_SET(char[] src, int pos, int items, Inside ph) //Status text message, without null termination character
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta253 = new Meta(253, 0, 0, 0, 2, 4, 0, _rc);
        }/**
...
*Control vehicle tone generation (buzzer)*/
        public class PLAY_TUNE : Pack, CommunicationChannel.Sendable
        {
            ...
            {tune_SET(src.ToCharArray(), 0, src.Length, ph);} public void tune_SET(char[] src, int pos, int items, Inside ph) //tune in board specific format
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta258 = new Meta(258, 0, 0, 0, 3, 16, 0, _zc);
        }/**
*WIP: Information about a camera*/
        public class CAMERA_INFORMATION : Pack, CommunicationChannel.Sendable
        {
            ...
            {cam_definition_uri_SET(src.ToCharArray(), 0, src.Length, ph);} public void cam_definition_uri_SET(char[] src, int pos, int items, Inside ph) //Camera definition URI (if any, otherwise only basic functions will be available).
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta259 = new Meta(259, 3, 2, 0, 93, 731, 0, _Sc);
        }/**
...
*Information about a captured image*/
        public class CAMERA_IMAGE_CAPTURED : Pack, CommunicationChannel.Sendable
        {
            ...
            {file_url_SET(src.ToCharArray(), 0, src.Length, ph);} public void file_url_SET(char[] src, int pos, int items, Inside ph) //URL of image taken. Either local storage or http:foo.jpg if camera provides an HTTP interface.
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta263 = new Meta(263, 0, 1, 1, 51, 402, 2, _IJ);
        }/**
...
*WIP: Information about video stream*/
        public class VIDEO_STREAM_INFORMATION : Pack, CommunicationChannel.Sendable
        {
            ...
            {uri_SET(src.ToCharArray(), 0, src.Length, ph);} public void uri_SET(char[] src, int pos, int items, Inside ph) //Video stream URI
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta269 = new Meta(269, 3, 1, 0, 17, 130, 2, _UJ);
        }/**
*WIP: Message that sets video stream settings*/
        public class SET_VIDEO_STREAM_SETTINGS : Pack, CommunicationChannel.Sendable
        {
            ...
            {uri_SET(src.ToCharArray(), 0, src.Length, ph);} public void uri_SET(char[] src, int pos, int items, Inside ph) //Video stream URI
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta270 = new Meta(270, 3, 1, 0, 18, 138, 2, _dJ);
        }/**
*Configure AP SSID and Password.*/
        public class WIFI_CONFIG_AP : Pack, CommunicationChannel.Sendable
        {
            ...
            {password_SET(src.ToCharArray(), 0, src.Length, ph);} public void password_SET(char[] src, int pos, int items, Inside ph) //Password. Leave it blank for an open AP.
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta299 = new Meta(299, 0, 0, 0, 1, 2, 2, _WJ, _kJ);
        }/**
...
*	is available at http:uavcan.org*/
        public class UAVCAN_NODE_INFO : Pack, CommunicationChannel.Sendable
        {
            ...
            {name_SET(src.ToCharArray(), 0, src.Length, ph);} public void name_SET(char[] src, int pos, int items, Inside ph) //Node name string. For example, "sapog.px4.io".
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta311 = new Meta(311, 0, 2, 1, 37, 288, 0, _Dg);
        }/**
...
*	ID is stored as strin*/
            public void param_id_SET(char[] src, int pos, int items, Inside ph)
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta320 = new Meta(320, 0, 0, 0, 5, 32, 0, _Eg);
        }/**
*Request all parameters of this component. After this request, all parameters are emitted.*/
...
*	ID is stored as strin*/
            ...
            {param_value_SET(src.ToCharArray(), 0, src.Length, ph);} public void param_value_SET(char[] src, int pos, int items, Inside ph) //Parameter value
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta322 = new Meta(322, 2, 0, 0, 5, 38, 2, _gg, _Qg);
        }/**
...
*	ID is stored as strin*/
            ...
            {param_value_SET(src.ToCharArray(), 0, src.Length, ph);} public void param_value_SET(char[] src, int pos, int items, Inside ph) //Parameter value
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta323 = new Meta(323, 0, 0, 0, 3, 22, 2, _Sg, _Vg);
        }/**
...
*	ID is stored as strin*/
            ...
            {param_value_SET(src.ToCharArray(), 0, src.Length, ph);} public void param_value_SET(char[] src, int pos, int items, Inside ph) //Parameter value (new value if PARAM_ACK_ACCEPTED, current value otherwise)
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta324 = new Meta(324, 0, 0, 0, 2, 9, 2, _jg, _ug);
        }/**
*Obstacle distances in front of the sensor, starting from the left in increment degrees to the right*/
        ...
        *Result from a PARAM_EXT_SET message.*/
        ...
        static readonly Field _j = new Field(5, true, -6, 2, 1, 0, 0, 0, 1);
        ...
        static readonly Field _Al = new Field(0, false, 1, 4, 1, 0, 0, 0);
        static readonly Field _tl = new Field(0, true, 1, 4, 1, 0, 0, 0);
        static readonly Field _el = new Field(0, true, 1, 4, 1, 0, 0, 0);
        static readonly Field _il = new Field(0, true, 1, 4, 1, 0, 0, 0);
        static readonly Field _Gl = new Field(0, true, 1, 4, 1, 0, 0, 0);
        static readonly Field _Dr = new Field(0, true, 1, 2, 1, 0, 0, 0);
        static readonly Field _Ar = new Field(0, true, 1, 2, 1, 0, 0, 0);
        static readonly Field _tr = new Field(0, true, 1, 2, 1, 0, 0, 0);
        static readonly Field _er = new Field(0, true, 1, 2, 1, 0, 0, 0);
        static readonly Field _ir = new Field(0, true, 1, 2, 1, 0, 0, 0);
        static readonly Field _Gr = new Field(0, true, 1, 2, 1, 0, 0, 0);
        static readonly Field _Tr = new Field(0, true, 1, 2, 1, 0, 0, 0);
        static readonly Field _zr = new Field(0, true, 1, 2, 1, 0, 0, 0);
        static readonly Field _Lw = new Field(0, true, 1, 8, 1, 0, 0, 0);
        static readonly Field _Jw = new Field(0, true, 1, 8, 1, 0, 0, 0);
        static readonly Field _xw = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
        static readonly Field _Qn = new Field(0, false, 1, 1, 1, 0, 0, 0);
        static readonly Field _xn = new Field(0, false, 1, 4, 1, 0, 0, 0);
        static readonly Field _Kn = new Field(0, false, 1, 1, 1, 0, 0, 0);
        static readonly Field _hn = new Field(0, false, 1, 1, 1, 0, 0, 0);
        static readonly Field _GA = new Field(0, false, 1, 4, 1, 0, 0, 0);
        static readonly Field _TA = new Field(0, false, 1, 4, 1, 0, 0, 0);
        static readonly Field _IL = new Field(0, false, 18, 1, 1, 0, 0, 0);
        static readonly Field _GL = new Field(0, false, 1, 4, 1, 0, 0, 0);
        static readonly Field _TL = new Field(0, false, 1, 4, 1, 0, 0, 0);
        static readonly Field _zL = new Field(0, false, 1, 4, 1, 0, 0, 0);
        static readonly Field _LL = new Field(0, false, 4, 4, 1, 0, 0, 0);
        static readonly Field _NL = new Field(0, false, 1, 1, 1, 0, 0, 0);
        static readonly Field _ZE = new Field(0, true, 1, 8, 1, 0, 0, 0);
        static readonly Field _DN = new Field(0, true, 1, 8, 1, 0, 0, 0);
        static readonly Field _gN = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
        static readonly Field _RN = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
        static readonly Field _ZN = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
        static readonly Field _Cc = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
        static readonly Field _rc = new Field(5, true, -6, 2, 1, 0, 0, 0, 1);
        static readonly Field _zc = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
        static readonly Field _Sc = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
        static readonly Field _IJ = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
        static readonly Field _UJ = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
        static readonly Field _dJ = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
        static readonly Field _WJ = new Field(5, true, -6, 2, 1, 0, 0, 0, 1);
        static readonly Field _kJ = new Field(5, true, -7, 2, 1, 0, 0, 0, 1);
        static readonly Field _Dg = new Field(5, true, -7, 2, 1, 0, 0, 0, 1);
        static readonly Field _Eg = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
        static readonly Field _gg = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
        static readonly Field _Qg = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
        static readonly Field _Sg = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
        static readonly Field _Vg = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
        static readonly Field _jg = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
        static readonly Field _ug = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
        static readonly Field _CQ = new Field(5, true, -3, 2, 1, 0, 0, 0, 1);
        static readonly Field _lQ = new Field(5, true, -3, 2, 1, 0, 0, 0, 1);
        static readonly Field _tQ = new Field(5, true, -6, 2, 1, 0, 0, 0, 1);
        static readonly Field _gQ = new Field(5, true, -6, 2, 1, 0, 0, 0, 1);
