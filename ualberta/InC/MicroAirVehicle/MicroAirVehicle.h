...
inline static e_MAV_MODE _en__h(UMAX id)
{
    switch(id)
    {
        case 0:
...
inline static UMAX _id__h(e_MAV_MODE en)
{
    switch(en)
    {
...
inline static UMAX _id__T(e_MAV_MISSION_TYPE en)
{
    switch(en)
    {
...
inline static e_MAV_CMD _en__W(UMAX id)
{
    switch(id)
    {
        case 0:
...
{
    uint8_t * data = src->data;
    return  _en__W(get_bits(data, 248, 7));
}
...
{
    uint8_t * data = src->data;
    return  _en__W(get_bits(data, 0, 7));
}
...
{
    uint8_t * data = src->data;
    return  _en__h(get_bits(data, 328, 4));
}
...
{
    uint8_t * data = src->data;
    return  _en__h(get_bits(data, 640, 4));
}
