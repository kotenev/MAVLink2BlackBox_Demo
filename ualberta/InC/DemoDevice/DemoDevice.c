...
static const Field _z = {5, true, -5, 2, 1, 0, 0, 0, 1, 1 };
static const Field _U = {5, true, -6, 2, 1, 0, 0, 0, 1, 1 };
...
static const Field _Me = {0, false, 1, 4, 1, 0, 0, 0, 0   };
static const Field _Ke = {0, true, 1, 4, 1, 0, 0, 0, 0   };
static const Field _le = {0, true, 1, 4, 1, 0, 0, 0, 0   };
static const Field _te = {0, true, 1, 4, 1, 0, 0, 0, 0   };
static const Field _ne = {0, true, 1, 4, 1, 0, 0, 0, 0   };
static const Field _NY = {0, true, 1, 2, 1, 0, 0, 0, 0   };
static const Field _MY = {0, true, 1, 2, 1, 0, 0, 0, 0   };
static const Field _KY = {0, true, 1, 2, 1, 0, 0, 0, 0   };
static const Field _lY = {0, true, 1, 2, 1, 0, 0, 0, 0   };
static const Field _tY = {0, true, 1, 2, 1, 0, 0, 0, 0   };
static const Field _nY = {0, true, 1, 2, 1, 0, 0, 0, 0   };
static const Field _mY = {0, true, 1, 2, 1, 0, 0, 0, 0   };
static const Field _DY = {0, true, 1, 2, 1, 0, 0, 0, 0   };
static const Field _uq = {0, true, 1, 8, 1, 0, 0, 0, 0   };
static const Field _bq = {0, true, 1, 8, 1, 0, 0, 0, 0   };
static const Field _Gq = {5, true, -5, 2, 1, 0, 0, 0, 1, 1 };
static const Field _hA = {0, false, 1, 1, 1, 0, 0, 0, 0   };
static const Field _GA = {0, false, 1, 4, 1, 0, 0, 0, 0   };
static const Field _cA = {0, false, 1, 1, 1, 0, 0, 0, 0   };
static const Field _TA = {0, false, 1, 1, 1, 0, 0, 0, 0   };
static const Field _nM = {0, false, 1, 4, 1, 0, 0, 0, 0   };
static const Field _mM = {0, false, 1, 4, 1, 0, 0, 0, 0   };
static const Field _iu = {0, false, 18, 1, 1, 0, 0, 0, 0   };
static const Field _nu = {0, false, 1, 4, 1, 0, 0, 0, 0   };
static const Field _mu = {0, false, 1, 4, 1, 0, 0, 0, 0   };
static const Field _Du = {0, false, 1, 4, 1, 0, 0, 0, 0   };
static const Field _uu = {0, false, 4, 4, 1, 0, 0, 0, 0   };
static const Field _Pu = {0, false, 1, 1, 1, 0, 0, 0, 0   };
static const Field _rO = {0, true, 1, 8, 1, 0, 0, 0, 0   };
static const Field _NP = {0, true, 1, 8, 1, 0, 0, 0, 0   };
static const Field _RP = {5, true, -4, 2, 1, 0, 0, 0, 1, 1 };
static const Field _jP = {5, true, -4, 2, 1, 0, 0, 0, 1, 1 };
static const Field _rP = {5, true, -4, 2, 1, 0, 0, 0, 1, 1 };
static const Field _gL = {5, true, -4, 2, 1, 0, 0, 0, 1, 1 };
static const Field _YL = {5, true, -6, 2, 1, 0, 0, 0, 1, 1 };
static const Field _DL = {5, true, -5, 2, 1, 0, 0, 0, 1, 1 };
static const Field _QL = {5, true, -8, 2, 1, 0, 0, 0, 1, 1 };
static const Field _ib = {5, true, -8, 2, 1, 0, 0, 0, 1, 1 };
static const Field _ob = {5, true, -8, 2, 1, 0, 0, 0, 1, 1 };
static const Field _Hb = {5, true, -8, 2, 1, 0, 0, 0, 1, 1 };
static const Field _db = {5, true, -6, 2, 1, 0, 0, 0, 1, 1 };
static const Field _sb = {5, true, -7, 2, 1, 0, 0, 0, 1, 1 };
static const Field _NR = {5, true, -7, 2, 1, 0, 0, 0, 1, 1 };
static const Field _OR = {5, true, -5, 2, 1, 0, 0, 0, 1, 1 };
static const Field _RR = {5, true, -5, 2, 1, 0, 0, 0, 1, 1 };
static const Field _hR = {5, true, -8, 2, 1, 0, 0, 0, 1, 1 };
static const Field _QR = {5, true, -5, 2, 1, 0, 0, 0, 1, 1 };
static const Field _wR = {5, true, -8, 2, 1, 0, 0, 0, 1, 1 };
static const Field _UR = {5, true, -5, 2, 1, 0, 0, 0, 1, 1 };
static const Field _IR = {5, true, -8, 2, 1, 0, 0, 0, 1, 1 };
...
static const Field * meta5fields[] = {&_z};
...
static const Field * meta7fields[] = {&_U};
...
static const Field * meta22fields[] = {&_y};
...
static const Field * meta23fields[] = {&_r};
...
static const Field * meta24fields[] = {&_Me, &_Ke, &_le, &_te, &_ne};
...
static const Field * meta36fields[] = {&_NY, &_MY, &_KY, &_lY, &_tY, &_nY, &_mY, &_DY};
...
static const Field * meta48fields[] = {&_uq};
...
static const Field * meta49fields[] = {&_bq};
...
static const Field * meta50fields[] = {&_Gq};
...
static const Field * meta77fields[] = {&_hA, &_GA, &_cA, &_TA};
...
static const Field * meta100fields[] = {&_nM, &_mM};
...
static const Field * meta148fields[] = {&_iu};
...
static const Field * meta149fields[] = {&_nu, &_mu, &_Du, &_uu, &_Pu};
...
Pack * c_LoopBackDemoChannel_new_NAV_FILTER_BIAS_220()
{
    Pack * pack = calloc(sizeof(Pack) + meta220.packMinBytes, 1);
    pack->meta = (Meta *)&meta220;
    return pack;
};
Pack * c_LoopBackDemoChannel_ADV_new_NAV_FILTER_BIAS_220()
{
    Pack * pack = calloc(sizeof(Pack) + meta220.packMinBytes, 1);
    pack->meta = (Meta *)&meta220;
    return pack;
...
Pack * c_LoopBackDemoChannel_new_RADIO_CALIBRATION_221()
{
    Pack * pack = calloc(sizeof(Pack) + meta221.packMinBytes, 1);
    pack->meta = (Meta *)&meta221;
    return pack;
};
Pack * c_LoopBackDemoChannel_ADV_new_RADIO_CALIBRATION_221()
{
    Pack * pack = calloc(sizeof(Pack) + meta221.packMinBytes, 1);
    pack->meta = (Meta *)&meta221;
    return pack;
...
Pack * c_LoopBackDemoChannel_new_UALBERTA_SYS_STATUS_222()
{
    Pack * pack = calloc(sizeof(Pack) + meta222.packMinBytes, 1);
    pack->meta = (Meta *)&meta222;
    return pack;
};
Pack * c_LoopBackDemoChannel_ADV_new_UALBERTA_SYS_STATUS_222()
{
    Pack * pack = calloc(sizeof(Pack) + meta222.packMinBytes, 1);
    pack->meta = (Meta *)&meta222;
    return pack;
...
static const Field * meta242fields[] = {&_rO};
...
static const Field * meta243fields[] = {&_NP};
...
static const Field * meta246fields[] = {&_RP};
...
static const Field * meta250fields[] = {&_jP};
...
static const Field * meta251fields[] = {&_rP};
...
static const Field * meta252fields[] = {&_gL};
...
static const Field * meta253fields[] = {&_YL};
...
static const Field * meta258fields[] = {&_DL};
...
static const Field * meta259fields[] = {&_QL};
...
static const Field * meta263fields[] = {&_ib};
...
static const Field * meta269fields[] = {&_ob};
...
static const Field * meta270fields[] = {&_Hb};
...
static const Field * meta299fields[] = {&_db, &_sb};
...
static const Field * meta311fields[] = {&_NR};
...
static const Field * meta320fields[] = {&_OR};
...
static const Field * meta322fields[] = {&_RR, &_hR};
...
static const Field * meta323fields[] = {&_QR, &_wR};
...
static const Field * meta324fields[] = {&_UR, &_IR};
...
Channel c_LoopBackDemoChannel = {.process =  x__g }; //initialized channel instance
    ...
    for(bool LOOP = false;;)
    {
        switch(id)
        {
            ...
            case 220:
                ...
                c_LoopBackDemoChannel_on_NAV_FILTER_BIAS_220(&ph, pack); //handle received pack
                break;
            case 221:
                if(pack == NULL) //request to create new empty pack
                {
                ...
                c_LoopBackDemoChannel_on_RADIO_CALIBRATION_221(&ph, pack); //handle received pack
                break;
            case 222:
                if(pack == NULL) //request to create new empty pack
                {
                ...
                c_LoopBackDemoChannel_on_UALBERTA_SYS_STATUS_222(&ph, pack); //handle received pack
                break;
            case 230:
                if(pack == NULL) //request to create new empty pack
                {
...
Channel c_LoopBackDemoChannel_ADV = {.process =  x__e }; //initialized channel instance
