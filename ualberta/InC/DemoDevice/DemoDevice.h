...
extern void c_LoopBackDemoChannel_on_NAV_FILTER_BIAS_220(Bounds_Inside * bi, Pack * pack);
Pack * c_LoopBackDemoChannel_new_RADIO_CALIBRATION_221();
Pack * c_LoopBackDemoChannel_ADV_new_RADIO_CALIBRATION_221();
extern void c_LoopBackDemoChannel_on_RADIO_CALIBRATION_221(Bounds_Inside * bi, Pack * pack);
Pack * c_LoopBackDemoChannel_new_UALBERTA_SYS_STATUS_222();
Pack * c_LoopBackDemoChannel_ADV_new_UALBERTA_SYS_STATUS_222();
extern void c_LoopBackDemoChannel_on_UALBERTA_SYS_STATUS_222(Bounds_Inside * bi, Pack * pack);
...
INLINER uint16_t* p221_aileron_GET(Pack * src, uint16_t*  dst, int32_t pos) //Aileron setpoints: left, center, righ
{
    uint8_t * data = src->data;
...
INLINER void p221_aileron_SET(uint16_t*  src, int32_t pos, Pack * dst) //Aileron setpoints: left, center, righ
{
    uint8_t * data = dst->data;
    for(int32_t BYTE =  0, src_max = pos + 3; pos < src_max; pos++, BYTE += 2)
        set_bytes((src[pos]), 2, data,  BYTE);
}
INLINER uint16_t* p221_elevator_GET(Pack * src, uint16_t*  dst, int32_t pos) //Elevator setpoints: nose down, center, nose u
{
    uint8_t * data = src->data;
...
INLINER void p221_elevator_SET(uint16_t*  src, int32_t pos, Pack * dst) //Elevator setpoints: nose down, center, nose u
{
    uint8_t * data = dst->data;
    for(int32_t BYTE =  6, src_max = pos + 3; pos < src_max; pos++, BYTE += 2)
        set_bytes((src[pos]), 2, data,  BYTE);
}
INLINER uint16_t* p221_rudder_GET(Pack * src, uint16_t*  dst, int32_t pos) //Rudder setpoints: nose left, center, nose righ
{
    uint8_t * data = src->data;
...
INLINER void p221_rudder_SET(uint16_t*  src, int32_t pos, Pack * dst) //Rudder setpoints: nose left, center, nose righ
{
    uint8_t * data = dst->data;
    for(int32_t BYTE =  12, src_max = pos + 3; pos < src_max; pos++, BYTE += 2)
        set_bytes((src[pos]), 2, data,  BYTE);
}
INLINER uint16_t* p221_gyro_GET(Pack * src, uint16_t*  dst, int32_t pos) //Tail gyro mode/gain setpoints: heading hold, rate mod
{
    uint8_t * data = src->data;
...
INLINER void p221_gyro_SET(uint16_t*  src, int32_t pos, Pack * dst) //Tail gyro mode/gain setpoints: heading hold, rate mod
{
    uint8_t * data = dst->data;
...
INLINER uint8_t p222_mode_GET(Pack * src)//System mode, see UALBERTA_AUTOPILOT_MODE ENU
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  0, 1)));
}
INLINER void p222_mode_SET(uint8_t  src, Pack * dst)//System mode, see UALBERTA_AUTOPILOT_MODE ENU
{
    uint8_t * data = dst->data;
    set_bytes((src), 1, data,  0);
}
INLINER uint8_t p222_nav_mode_GET(Pack * src)//Navigation mode, see UALBERTA_NAV_MODE ENU
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  1, 1)));
}
INLINER void p222_nav_mode_SET(uint8_t  src, Pack * dst)//Navigation mode, see UALBERTA_NAV_MODE ENU
{
    uint8_t * data = dst->data;
    set_bytes((src), 1, data,  1);
}
INLINER uint8_t p222_pilot_GET(Pack * src)//Pilot mode, see UALBERTA_PILOT_MOD
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  2, 1)));
}
INLINER void p222_pilot_SET(uint8_t  src, Pack * dst)//Pilot mode, see UALBERTA_PILOT_MOD
{
    uint8_t * data = dst->data;
    set_bytes((src), 1, data,  2);
}
