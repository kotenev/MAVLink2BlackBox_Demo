    ...
    public class DemoDevice : Host
    {
        ...
        } public class AUTH_KEY : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {key_SET(src.ToCharArray(), 0, src.Length, ph);} public void key_SET(char[] src, int pos, int items, Inside ph) //ke
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta7 = new Meta(7, 0, 0, 0, 1, 0, 0, _Z);
        ...
        } public class GPS_RAW_INT : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            public void hdg_acc_SET(uint src, Inside ph)//Heading / track uncertainty in degrees * 1e5
            {
                ...
                BitUtils.set_bytes((ulong)(src), 4, data,  ph.BYTE);
            } static readonly Meta meta24 = new Meta(24, 4, 0, 1, 31, 236, 0, _lw, _dw, _cw, _jw, _Bw);
        ...
        } public class SERVO_OUTPUT_RAW : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            public void servo16_raw_SET(ushort src, Inside ph)//Servo output 16 value, in microsecond
            {
                ...
                BitUtils.set_bytes((ulong)(src), 2, data,  ph.BYTE);
            } static readonly Meta meta36 = new Meta(36, 8, 1, 0, 22, 168, 0, _UD, _lD, _dD, _cD, _jD, _BD, _nD, _oD);
        ...
        } public class SET_GPS_GLOBAL_ORIGIN : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            } static readonly Meta meta48 = new Meta(48, 0, 0, 0, 14, 104, 0, _TO);
        } public class GPS_GLOBAL_ORIGIN : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            public void time_usec_SET(ulong src, Inside ph)//Timestamp (microseconds since UNIX epoch or microseconds since system boot
            {
                ...
                BitUtils.set_bytes((ulong)(src), 8, data,  ph.BYTE);
            } static readonly Meta meta49 = new Meta(49, 0, 0, 0, 13, 96, 0, _PO);
        } public class PARAM_MAP_RC : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            } public void param_id_SET(string src, Inside ph) {param_id_SET(src.ToCharArray(), 0, src.Length, ph);} public void param_id_SET(char[] src, int pos, int items, Inside ph)
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta50 = new Meta(50, 0, 0, 0, 22, 168, 0, _aO);
        ...
        } public class COMMAND_ACK : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            public void target_component_SET(byte src, Inside ph)//WIP: Component which requested the command to be execute
            {
                ...
                BitUtils.set_bytes((ulong)(src), 1, data,  ph.BYTE);
            } static readonly Meta meta77 = new Meta(77, 0, 0, 0, 3, 10, 0, _rX, _aX, _JX, _vX);
        ...
        } public class OPTICAL_FLOW : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            public void flow_rate_y_SET(float src, Inside ph)//Flow rate in radians/second about Y axi
            {
                ...
                BitUtils.set_bytes(BitUtils.FloatToInt32Bits(src), 4, data, ph.BYTE);
            } static readonly Meta meta100 = new Meta(100, 0, 0, 1, 27, 208, 0, _Bl, _nl);
        ...
        } public class AUTOPILOT_VERSION : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            } public void uid2_SET(byte[] src, int pos, Inside ph)
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + 18; pos < src_max; pos++, BYTE += 1)
                    BitUtils.set_bytes((ulong)(src[pos]), 1, data,  BYTE);
            } static readonly Meta meta148 = new Meta(148, 2, 4, 1, 54, 421, 0, _NT);
        } public class LANDING_TARGET : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            public void position_valid_SET(byte src, Inside ph)
            {
                ...
                BitUtils.set_bytes((ulong)(src), 1, data,  ph.BYTE);
            } static readonly Meta meta149 = new Meta(149, 0, 0, 1, 31, 239, 0, _BT, _nT, _oT, _TT, _tT);
        } public class NAV_FILTER_BIAS : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal NAV_FILTER_BIAS() : base(meta220, 0) { }
            internal NAV_FILTER_BIAS(int bytes) : base(meta220, bytes) { }
            ...
            static readonly Meta meta220 = new Meta(220, 0, 0, 1, 32, 256);
        } public class RADIO_CALIBRATION : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal RADIO_CALIBRATION() : base(meta221, 0) { }
            internal RADIO_CALIBRATION(int bytes) : base(meta221, bytes) { }
            public ushort[] aileron //Aileron setpoints: left, center, righ
            {
                get {return aileron_GET(new ushort[3], 0);}
                set {aileron_SET(value, 0)  ;}
            }
            public ushort[]aileron_GET(ushort[] dst_ch, int pos)  //Aileron setpoints: left, center, righ
            {
            ...
            public void aileron_SET(ushort[] src, int pos)  //Aileron setpoints: left, center, righ
            {
            ...
            public ushort[] elevator //Elevator setpoints: nose down, center, nose u
            {
                get {return elevator_GET(new ushort[3], 0);}
                set {elevator_SET(value, 0)  ;}
            }
            public ushort[]elevator_GET(ushort[] dst_ch, int pos)  //Elevator setpoints: nose down, center, nose u
            {
            ...
            public void elevator_SET(ushort[] src, int pos)  //Elevator setpoints: nose down, center, nose u
            {
            ...
            public ushort[] rudder //Rudder setpoints: nose left, center, nose righ
            {
                get {return rudder_GET(new ushort[3], 0);}
                set {rudder_SET(value, 0)  ;}
            }
            public ushort[]rudder_GET(ushort[] dst_ch, int pos)  //Rudder setpoints: nose left, center, nose righ
            {
            ...
            public void rudder_SET(ushort[] src, int pos)  //Rudder setpoints: nose left, center, nose righ
            {
            ...
            public ushort[] gyro //Tail gyro mode/gain setpoints: heading hold, rate mod
            {
                get {return gyro_GET(new ushort[2], 0);}
                set {gyro_SET(value, 0)  ;}
            }
            public ushort[]gyro_GET(ushort[] dst_ch, int pos)  //Tail gyro mode/gain setpoints: heading hold, rate mod
            {
            ...
            public void gyro_SET(ushort[] src, int pos)  //Tail gyro mode/gain setpoints: heading hold, rate mod
            {
            ...
            public void pitch_SET(ushort[] src, int pos)  //Pitch curve setpoints (every 25%
            {
            ...
            public void throttle_SET(ushort[] src, int pos)  //Throttle curve setpoints (every 25%
            {
                for(int BYTE =  32, src_max = pos + 5; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ulong)(src[pos]), 2, data,  BYTE);
            }

            static readonly Meta meta221 = new Meta(221, 21, 0, 0, 42, 336);
        } public class UALBERTA_SYS_STATUS : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal UALBERTA_SYS_STATUS() : base(meta222, 0) { }
            internal UALBERTA_SYS_STATUS(int bytes) : base(meta222, bytes) { }
            public byte mode //System mode, see UALBERTA_AUTOPILOT_MODE ENU
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  0, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  0);}
            }

            public byte nav_mode //Navigation mode, see UALBERTA_NAV_MODE ENU
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  1, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  1);}
            }

            public byte pilot //Pilot mode, see UALBERTA_PILOT_MOD
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  2, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  2);}
            }
            static readonly Meta meta222 = new Meta(222, 0, 0, 0, 3, 24);
        ...
        } public class HOME_POSITION : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            public void time_usec_SET(ulong src, Inside ph)//Timestamp (microseconds since UNIX epoch or microseconds since system boot
            {
                ...
                BitUtils.set_bytes((ulong)(src), 8, data,  ph.BYTE);
            } static readonly Meta meta242 = new Meta(242, 0, 0, 0, 53, 416, 0, _pi);
        } public class SET_HOME_POSITION : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            public void time_usec_SET(ulong src, Inside ph)//Timestamp (microseconds since UNIX epoch or microseconds since system boot
            {
                ...
                BitUtils.set_bytes((ulong)(src), 8, data,  ph.BYTE);
            } static readonly Meta meta243 = new Meta(243, 0, 0, 0, 54, 424, 0, _Ut);
        ...
        } public class ADSB_VEHICLE : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {callsign_SET(src.ToCharArray(), 0, src.Length, ph);} public void callsign_SET(char[] src, int pos, int items, Inside ph) //The callsign, 8+nul
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta246 = new Meta(246, 3, 1, 0, 28, 210, 0, _ft);
        ...
        } public class DEBUG_VECT : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {name_SET(src.ToCharArray(), 0, src.Length, ph);} public void name_SET(char[] src, int pos, int items, Inside ph) //Nam
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta250 = new Meta(250, 0, 0, 1, 21, 160, 0, _It);
        } public class NAMED_VALUE_FLOAT : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {name_SET(src.ToCharArray(), 0, src.Length, ph);} public void name_SET(char[] src, int pos, int items, Inside ph) //Name of the debug variabl
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta251 = new Meta(251, 0, 1, 0, 9, 64, 0, _pt);
        } public class NAMED_VALUE_INT : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {name_SET(src.ToCharArray(), 0, src.Length, ph);} public void name_SET(char[] src, int pos, int items, Inside ph) //Name of the debug variabl
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta252 = new Meta(252, 0, 1, 0, 9, 64, 0, _SC);
        } public class STATUSTEXT : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {text_SET(src.ToCharArray(), 0, src.Length, ph);} public void text_SET(char[] src, int pos, int items, Inside ph) //Status text message, without null termination characte
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta253 = new Meta(253, 0, 0, 0, 2, 4, 0, _DC);
        ...
        } public class PLAY_TUNE : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {tune_SET(src.ToCharArray(), 0, src.Length, ph);} public void tune_SET(char[] src, int pos, int items, Inside ph) //tune in board specific forma
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta258 = new Meta(258, 0, 0, 0, 3, 16, 0, _oC);
        } public class CAMERA_INFORMATION : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {cam_definition_uri_SET(src.ToCharArray(), 0, src.Length, ph);} public void cam_definition_uri_SET(char[] src, int pos, int items, Inside ph) //Camera definition URI (if any, otherwise only basic functions will be available)
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta259 = new Meta(259, 3, 2, 0, 93, 731, 0, _qC);
        ...
        } public class CAMERA_IMAGE_CAPTURED : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {file_url_SET(src.ToCharArray(), 0, src.Length, ph);} public void file_url_SET(char[] src, int pos, int items, Inside ph) //foo.jpg if camera provides an HTTP interface
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta263 = new Meta(263, 0, 1, 1, 51, 402, 2, _NP);
        ...
        } public class VIDEO_STREAM_INFORMATION : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {uri_SET(src.ToCharArray(), 0, src.Length, ph);} public void uri_SET(char[] src, int pos, int items, Inside ph) //Video stream UR
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta269 = new Meta(269, 3, 1, 0, 17, 130, 2, _zP);
        } public class SET_VIDEO_STREAM_SETTINGS : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {uri_SET(src.ToCharArray(), 0, src.Length, ph);} public void uri_SET(char[] src, int pos, int items, Inside ph) //Video stream UR
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta270 = new Meta(270, 3, 1, 0, 18, 138, 2, _eP);
        } public class WIFI_CONFIG_AP : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {password_SET(src.ToCharArray(), 0, src.Length, ph);} public void password_SET(char[] src, int pos, int items, Inside ph) //Password. Leave it blank for an open AP
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta299 = new Meta(299, 0, 0, 0, 1, 2, 2, _VP, _LP);
        ...
        } public class UAVCAN_NODE_INFO : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {name_SET(src.ToCharArray(), 0, src.Length, ph);} public void name_SET(char[] src, int pos, int items, Inside ph) //Node name string. For example, "sapog.px4.io"
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta311 = new Meta(311, 0, 2, 1, 37, 288, 0, _Uf);
        } public class PARAM_EXT_REQUEST_READ : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            } public void param_id_SET(string src, Inside ph) {param_id_SET(src.ToCharArray(), 0, src.Length, ph);} public void param_id_SET(char[] src, int pos, int items, Inside ph)
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta320 = new Meta(320, 0, 0, 0, 5, 32, 0, _if);
        ...
        } public class PARAM_EXT_VALUE : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {param_value_SET(src.ToCharArray(), 0, src.Length, ph);} public void param_value_SET(char[] src, int pos, int items, Inside ph) //Parameter valu
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta322 = new Meta(322, 2, 0, 0, 5, 38, 2, _ff, _rf);
        } public class PARAM_EXT_SET : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {param_value_SET(src.ToCharArray(), 0, src.Length, ph);} public void param_value_SET(char[] src, int pos, int items, Inside ph) //Parameter valu
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta323 = new Meta(323, 0, 0, 0, 3, 22, 2, _qf, _uf);
        } public class PARAM_EXT_ACK : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {param_value_SET(src.ToCharArray(), 0, src.Length, ph);} public void param_value_SET(char[] src, int pos, int items, Inside ph) //Parameter value (new value if PARAM_ACK_ACCEPTED, current value otherwise
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta324 = new Meta(324, 0, 0, 0, 2, 9, 2, _Zf, _Ef);
                ...
                for(bool LOOP = false; ;)
                {
                    switch(id)
                    {
                        ...
                        case 220:
                            ...
                            if(OnNAV_FILTER_BIASReceive == null) return null;
                            ph.setPack(pack);
                            OnNAV_FILTER_BIASReceive(this, ph, (NAV_FILTER_BIAS) pack);
                            if(LOOP) break;
                            return null;
                        case 221:
                            if(pack == null) return new RADIO_CALIBRATION();
                            if(OnRADIO_CALIBRATIONReceive == null) return null;
                            ph.setPack(pack);
                            OnRADIO_CALIBRATIONReceive(this, ph, (RADIO_CALIBRATION) pack);
                            if(LOOP) break;
                            return null;
                        case 222:
                            if(pack == null) return new UALBERTA_SYS_STATUS();
                            if(OnUALBERTA_SYS_STATUSReceive == null) return null;
                            ph.setPack(pack);
                            OnUALBERTA_SYS_STATUSReceive(this, ph, (UALBERTA_SYS_STATUS) pack);
                            if(LOOP) break;
                            return null;
                        case 230:
        ...
        static readonly Field _Z = new Field(5, true, -6, 2, 1, 0, 0, 0, 1);
        ...
        static readonly Field _lw = new Field(0, false, 1, 4, 1, 0, 0, 0);
        static readonly Field _dw = new Field(0, true, 1, 4, 1, 0, 0, 0);
        static readonly Field _cw = new Field(0, true, 1, 4, 1, 0, 0, 0);
        static readonly Field _jw = new Field(0, true, 1, 4, 1, 0, 0, 0);
        static readonly Field _Bw = new Field(0, true, 1, 4, 1, 0, 0, 0);
        static readonly Field _UD = new Field(0, true, 1, 2, 1, 0, 0, 0);
        static readonly Field _lD = new Field(0, true, 1, 2, 1, 0, 0, 0);
        static readonly Field _dD = new Field(0, true, 1, 2, 1, 0, 0, 0);
        static readonly Field _cD = new Field(0, true, 1, 2, 1, 0, 0, 0);
        static readonly Field _jD = new Field(0, true, 1, 2, 1, 0, 0, 0);
        static readonly Field _BD = new Field(0, true, 1, 2, 1, 0, 0, 0);
        static readonly Field _nD = new Field(0, true, 1, 2, 1, 0, 0, 0);
        static readonly Field _oD = new Field(0, true, 1, 2, 1, 0, 0, 0);
        static readonly Field _TO = new Field(0, true, 1, 8, 1, 0, 0, 0);
        static readonly Field _PO = new Field(0, true, 1, 8, 1, 0, 0, 0);
        static readonly Field _aO = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
        static readonly Field _rX = new Field(0, false, 1, 1, 1, 0, 0, 0);
        static readonly Field _aX = new Field(0, false, 1, 4, 1, 0, 0, 0);
        static readonly Field _JX = new Field(0, false, 1, 1, 1, 0, 0, 0);
        static readonly Field _vX = new Field(0, false, 1, 1, 1, 0, 0, 0);
        static readonly Field _Bl = new Field(0, false, 1, 4, 1, 0, 0, 0);
        static readonly Field _nl = new Field(0, false, 1, 4, 1, 0, 0, 0);
        static readonly Field _NT = new Field(0, false, 18, 1, 1, 0, 0, 0);
        static readonly Field _BT = new Field(0, false, 1, 4, 1, 0, 0, 0);
        static readonly Field _nT = new Field(0, false, 1, 4, 1, 0, 0, 0);
        static readonly Field _oT = new Field(0, false, 1, 4, 1, 0, 0, 0);
        static readonly Field _TT = new Field(0, false, 4, 4, 1, 0, 0, 0);
        static readonly Field _tT = new Field(0, false, 1, 1, 1, 0, 0, 0);
        static readonly Field _pi = new Field(0, true, 1, 8, 1, 0, 0, 0);
        static readonly Field _Ut = new Field(0, true, 1, 8, 1, 0, 0, 0);
        static readonly Field _ft = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
        static readonly Field _It = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
        static readonly Field _pt = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
        static readonly Field _SC = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
        static readonly Field _DC = new Field(5, true, -6, 2, 1, 0, 0, 0, 1);
        static readonly Field _oC = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
        static readonly Field _qC = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
        static readonly Field _NP = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
        static readonly Field _zP = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
        static readonly Field _eP = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
        static readonly Field _VP = new Field(5, true, -6, 2, 1, 0, 0, 0, 1);
        static readonly Field _LP = new Field(5, true, -7, 2, 1, 0, 0, 0, 1);
        static readonly Field _Uf = new Field(5, true, -7, 2, 1, 0, 0, 0, 1);
        static readonly Field _if = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
        static readonly Field _ff = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
        static readonly Field _rf = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
        static readonly Field _qf = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
        static readonly Field _uf = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
        static readonly Field _Zf = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
        static readonly Field _Ef = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
