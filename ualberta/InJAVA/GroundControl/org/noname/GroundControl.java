...
public class GroundControl extends Host {
	...
	public static class GPS_RAW_INT extends Pack {
		...
		static final Meta meta = new Meta(24, 4, 0, 1, 31, 236, 0, _Vh, _Oh, _Th, _Dh, _zh);
	}
	...
	public static class SERVO_OUTPUT_RAW extends Pack {
		...
		static final Meta meta = new Meta(36, 8, 1, 0, 22, 168, 0, _et, _Vt, _Ot, _Tt, _Dt, _zt, _Ut, _Ht);
	}
	...
	public static class SET_GPS_GLOBAL_ORIGIN extends Pack {
		...
		static final Meta meta = new Meta(48, 0, 0, 0, 14, 104, 0, _kb);
	}
	...
	public static class GPS_GLOBAL_ORIGIN extends Pack {
		...
		static final Meta meta = new Meta(49, 0, 0, 0, 13, 96, 0, _gb);
	}
	...
	public static class PARAM_MAP_RC extends Pack {
		...
		static final Meta meta = new Meta(50, 0, 0, 0, 22, 168, 0, _vb);
	}
	...
	public static class COMMAND_ACK extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(77, 0, 0, 0, 3, 10, 0, _qi, _vi, _Ci, _li);
	}
	...
	public static class OPTICAL_FLOW extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(100, 0, 0, 1, 27, 208, 0, _zV, _UV);
	}
	...
	public static class AUTOPILOT_VERSION extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(148, 2, 4, 1, 54, 421, 0, _Bk);
	}
	...
	public static class LANDING_TARGET extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(149, 0, 0, 1, 31, 239, 0, _zk, _Uk, _Hk, _kk, _ck);
	}

	/**
	 * Accelerometer and Gyro biases from the navigation filter
	 */
	public static class NAV_FILTER_BIAS extends Pack implements CommunicationChannel.Sendable {
	 ...
	 */
	public static class RADIO_CALIBRATION extends Pack implements CommunicationChannel.Sendable {

		RADIO_CALIBRATION() { super(meta, 0); }

		public void aileron_SET(char[] src, int pos)  //Aileron setpoints: left, center, right
		{
			for (int BYTE = 0, src_max = pos + 3; pos < src_max; pos++, BYTE += 2)
				set_bytes((char) (src[pos]) & -1L, 2, data, BYTE);
		}

		public void elevator_SET(char[] src, int pos)  //Elevator setpoints: nose down, center, nose up
		{
			for (int BYTE = 6, src_max = pos + 3; pos < src_max; pos++, BYTE += 2)
				set_bytes((char) (src[pos]) & -1L, 2, data, BYTE);
		}

		public void rudder_SET(char[] src, int pos)  //Rudder setpoints: nose left, center, nose right
		{
			for (int BYTE = 12, src_max = pos + 3; pos < src_max; pos++, BYTE += 2)
				set_bytes((char) (src[pos]) & -1L, 2, data, BYTE);
		}

		public void gyro_SET(char[] src, int pos)  //Tail gyro mode/gain setpoints: heading hold, rate mode
		{
			for (int BYTE = 18, src_max = pos + 2; pos < src_max; pos++, BYTE += 2)
				set_bytes((char) (src[pos]) & -1L, 2, data, BYTE);
		}

		public void pitch_SET(char[] src, int pos)  //Pitch curve setpoints (every 25%)
		{
			for (int BYTE = 22, src_max = pos + 5; pos < src_max; pos++, BYTE += 2)
				set_bytes((char) (src[pos]) & -1L, 2, data, BYTE);
		}

		public void throttle_SET(char[] src, int pos)  //Throttle curve setpoints (every 25%)
		{
	 ...
	 */
	public static class UALBERTA_SYS_STATUS extends Pack implements CommunicationChannel.Sendable {

		UALBERTA_SYS_STATUS() { super(meta, 0); }

		public void mode_SET(char src) //System mode, see UALBERTA_AUTOPILOT_MODE ENUM
		{ set_bytes((char) (src) & -1L, 1, data, 0); }

		public void nav_mode_SET(char src) //Navigation mode, see UALBERTA_NAV_MODE ENUM
		{ set_bytes((char) (src) & -1L, 1, data, 1); }

		public void pilot_SET(char src) //Pilot mode, see UALBERTA_PILOT_MODE
		{ set_bytes((char) (src) & -1L, 1, data, 2); }
	...
	public static class HOME_POSITION extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(242, 0, 0, 0, 53, 416, 0, _Gu);
	}
	...
	public static class SET_HOME_POSITION extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(243, 0, 0, 0, 54, 424, 0, _ec);
	}
	...
	public static class ADSB_VEHICLE extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(246, 3, 1, 0, 28, 210, 0, _Ac);
	}
	...
	public static class DEBUG_VECT extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(250, 0, 0, 1, 21, 160, 0, _ac);
	}
	...
	public static class NAMED_VALUE_FLOAT extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(251, 0, 1, 0, 9, 64, 0, _Gc);
	}
	...
	public static class NAMED_VALUE_INT extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(252, 0, 1, 0, 9, 64, 0, _yW);
	}
	...
	public static class STATUSTEXT extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(253, 0, 0, 0, 2, 4, 0, _tW);
	}
	...
	public static class PLAY_TUNE extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(258, 0, 0, 0, 3, 16, 0, _HW);
	}
	...
	public static class CAMERA_INFORMATION extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(259, 3, 2, 0, 93, 731, 0, _FW);
	}
	...
	public static class CAMERA_IMAGE_CAPTURED extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(263, 0, 1, 1, 51, 402, 2, _Bg);
	}
	...
	public static class VIDEO_STREAM_INFORMATION extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(269, 3, 1, 0, 17, 130, 2, _Yg);
	}
	...
	public static class SET_VIDEO_STREAM_SETTINGS extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(270, 3, 1, 0, 18, 138, 2, _Ig);
	}
	...
	public static class WIFI_CONFIG_AP extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(299, 0, 0, 0, 1, 2, 2, _rg, _Zg);
	}
	...
	public static class UAVCAN_NODE_INFO extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(311, 0, 2, 1, 37, 288, 0, _eA);
	}
	...
	public static class PARAM_EXT_REQUEST_READ extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(320, 0, 0, 0, 5, 32, 0, _uA);
	}
	...
	public static class PARAM_EXT_VALUE extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(322, 2, 0, 0, 5, 38, 2, _AA, _qA);
	}
	...
	public static class PARAM_EXT_SET extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(323, 0, 0, 0, 3, 22, 2, _FA, _jA);
	}
	...
	public static class PARAM_EXT_ACK extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(324, 0, 0, 0, 2, 9, 2, _MA, _NA);
	}
	...
	private static final Field _Vh = new Field(0, false, 1, 4, 1, 0, 0, 0);
	private static final Field _Oh = new Field(0, true, 1, 4, 1, 0, 0, 0);
	private static final Field _Th = new Field(0, true, 1, 4, 1, 0, 0, 0);
	private static final Field _Dh = new Field(0, true, 1, 4, 1, 0, 0, 0);
	private static final Field _zh = new Field(0, true, 1, 4, 1, 0, 0, 0);
	private static final Field _et = new Field(0, true, 1, 2, 1, 0, 0, 0);
	private static final Field _Vt = new Field(0, true, 1, 2, 1, 0, 0, 0);
	private static final Field _Ot = new Field(0, true, 1, 2, 1, 0, 0, 0);
	private static final Field _Tt = new Field(0, true, 1, 2, 1, 0, 0, 0);
	private static final Field _Dt = new Field(0, true, 1, 2, 1, 0, 0, 0);
	private static final Field _zt = new Field(0, true, 1, 2, 1, 0, 0, 0);
	private static final Field _Ut = new Field(0, true, 1, 2, 1, 0, 0, 0);
	private static final Field _Ht = new Field(0, true, 1, 2, 1, 0, 0, 0);
	private static final Field _kb = new Field(0, true, 1, 8, 1, 0, 0, 0);
	private static final Field _gb = new Field(0, true, 1, 8, 1, 0, 0, 0);
	private static final Field _vb = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
	private static final Field _qi = new Field(0, false, 1, 1, 1, 0, 0, 0);
	private static final Field _vi = new Field(0, false, 1, 4, 1, 0, 0, 0);
	private static final Field _Ci = new Field(0, false, 1, 1, 1, 0, 0, 0);
	private static final Field _li = new Field(0, false, 1, 1, 1, 0, 0, 0);
	private static final Field _zV = new Field(0, false, 1, 4, 1, 0, 0, 0);
	private static final Field _UV = new Field(0, false, 1, 4, 1, 0, 0, 0);
	private static final Field _Bk = new Field(0, false, 18, 1, 1, 0, 0, 0);
	private static final Field _zk = new Field(0, false, 1, 4, 1, 0, 0, 0);
	private static final Field _Uk = new Field(0, false, 1, 4, 1, 0, 0, 0);
	private static final Field _Hk = new Field(0, false, 1, 4, 1, 0, 0, 0);
	private static final Field _kk = new Field(0, false, 4, 4, 1, 0, 0, 0);
	private static final Field _ck = new Field(0, false, 1, 1, 1, 0, 0, 0);
	private static final Field _Gu = new Field(0, true, 1, 8, 1, 0, 0, 0);
	private static final Field _ec = new Field(0, true, 1, 8, 1, 0, 0, 0);
	private static final Field _Ac = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
	private static final Field _ac = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
	private static final Field _Gc = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
	private static final Field _yW = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
	private static final Field _tW = new Field(5, true, -6, 2, 1, 0, 0, 0, 1);
	private static final Field _HW = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
	private static final Field _FW = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
	private static final Field _Bg = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
	private static final Field _Yg = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
	private static final Field _Ig = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
	private static final Field _rg = new Field(5, true, -6, 2, 1, 0, 0, 0, 1);
	private static final Field _Zg = new Field(5, true, -7, 2, 1, 0, 0, 0, 1);
	private static final Field _eA = new Field(5, true, -7, 2, 1, 0, 0, 0, 1);
	private static final Field _uA = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
	private static final Field _AA = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
	private static final Field _qA = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
	private static final Field _FA = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
	private static final Field _jA = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
	private static final Field _MA = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
	private static final Field _NA = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
