...
extern void c_CommunicationChannel_on_CPU_LOAD_170(Bounds_Inside * bi, Pack * pack);
/**
*Accelerometer and gyro biases.*/
extern void c_CommunicationChannel_on_SENSOR_BIAS_172(Bounds_Inside * bi, Pack * pack);
/**
*Configurable diagnostic messages.*/
extern void c_CommunicationChannel_on_DIAGNOSTIC_173(Bounds_Inside * bi, Pack * pack);
/**
*Data used in the navigation algorithm.*/
extern void c_CommunicationChannel_on_SLUGS_NAVIGATION_176(Bounds_Inside * bi, Pack * pack);
/**
*Configurable data log probes to be used inside Simulink*/
extern void c_CommunicationChannel_on_DATA_LOG_177(Bounds_Inside * bi, Pack * pack);
/**
*Pilot console PWM messges.*/
extern void c_CommunicationChannel_on_GPS_DATE_TIME_179(Bounds_Inside * bi, Pack * pack);
/**
...
extern void c_CommunicationChannel_on_MID_LVL_CMDS_180(Bounds_Inside * bi, Pack * pack);
/**
*This message sets the control surfaces for selective passthrough mode.*/
extern void c_CommunicationChannel_on_CTRL_SRFC_PT_181(Bounds_Inside * bi, Pack * pack);
/**
*Orders generated to the SLUGS camera mount.*/
extern void c_CommunicationChannel_on_SLUGS_CAMERA_ORDER_184(Bounds_Inside * bi, Pack * pack);
/**
*Control for surface; pending and order to origin.*/
extern void c_CommunicationChannel_on_CONTROL_SURFACE_185(Bounds_Inside * bi, Pack * pack);
/**
*Transmits the last known position of the mobile GS to the UAV. Very relevant when Track Mobile is enable*/
extern void c_CommunicationChannel_on_SLUGS_MOBILE_LOCATION_186(Bounds_Inside * bi, Pack * pack);
/**
*Control for camara.*/
extern void c_CommunicationChannel_on_SLUGS_CONFIGURATION_CAMERA_188(Bounds_Inside * bi, Pack * pack);
/**
*Transmits the position of watch*/
extern void c_CommunicationChannel_on_ISR_LOCATION_189(Bounds_Inside * bi, Pack * pack);
/**
*Transmits the readings from the voltage and current sensors*/
extern void c_CommunicationChannel_on_VOLT_SENSOR_191(Bounds_Inside * bi, Pack * pack);
/**
*Transmits the actual Pan, Tilt and Zoom values of the camera unit*/
extern void c_CommunicationChannel_on_PTZ_STATUS_192(Bounds_Inside * bi, Pack * pack);
/**
*Transmits the actual status values UAV in flight*/
extern void c_CommunicationChannel_on_UAV_STATUS_193(Bounds_Inside * bi, Pack * pack);
/**
*This contains the status of the GPS readings*/
extern void c_CommunicationChannel_on_STATUS_GPS_194(Bounds_Inside * bi, Pack * pack);
/**
*Transmits the diagnostics data from the Novatel OEMStar GPS*/
extern void c_CommunicationChannel_on_NOVATEL_DIAG_195(Bounds_Inside * bi, Pack * pack);
/**
*Diagnostic data Sensor MCU*/
extern void c_CommunicationChannel_on_SENSOR_DIAG_196(Bounds_Inside * bi, Pack * pack);
/**
...
*	 numbers on startup*/
extern void c_CommunicationChannel_on_BOOT_197(Bounds_Inside * bi, Pack * pack);
/**
...
inline static e_MAV_MODE _en__u(UMAX id)
{
    switch(id)
    {
        case 0:
...
inline static UMAX _id__u(e_MAV_MODE en)
{
    switch(en)
    {
...
inline static UMAX _id__M(e_MAV_MISSION_TYPE en)
{
    switch(en)
    {
...
typedef  enum
{
    ...
    *		 * 1	0: return to base, 1: track mobile base*/
    ...
    e_MAV_CMD_MAV_CMD_STOP_RETURN_TO_BASE = 10012, //Stops the vehicle from returning to base and resumes flight.
    /**
    ...
    *		 * 2	0: turn on, 1: turn off*/
    ...
    e_MAV_CMD_MAV_CMD_GET_MID_LEVEL_COMMANDS = 10014, //Requests vehicle to send current mid-level commands to ground station.
    /**
...
inline static UMAX _id__B(e_MAV_CMD en)
{
    switch(en)
    {
...
{
    uint8_t * data = src->data;
    return  _en__u(get_bits(data, 328, 4));
}
...
{
    uint8_t * data = src->data;
    return  _en__u(get_bits(data, 640, 4));
}
...
INLINER uint16_t p170_batVolt_GET(Pack * src)//Battery Voltage in millivolts
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  0, 2)));
}
INLINER uint8_t p170_sensLoad_GET(Pack * src)//Sensor DSC Load
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  2, 1)));
}
INLINER uint8_t p170_ctrlLoad_GET(Pack * src)//Control DSC Load
{
    uint8_t * data = src->data;
...
INLINER float p173_diagFl1_GET(Pack * src)//Diagnostic float 1
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  0, 4)));
}
INLINER float p173_diagFl2_GET(Pack * src)//Diagnostic float 2
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  4, 4)));
}
INLINER float p173_diagFl3_GET(Pack * src)//Diagnostic float 3
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  8, 4)));
}
INLINER int16_t p173_diagSh1_GET(Pack * src)//Diagnostic short 1
{
    uint8_t * data = src->data;
    return ((int16_t)(get_bytes(data,  12, 2)));
}
INLINER int16_t p173_diagSh2_GET(Pack * src)//Diagnostic short 2
{
    uint8_t * data = src->data;
    return ((int16_t)(get_bytes(data,  14, 2)));
}
INLINER int16_t p173_diagSh3_GET(Pack * src)//Diagnostic short 3
{
    uint8_t * data = src->data;
    return ((int16_t)(get_bytes(data,  16, 2)));
}
INLINER uint16_t p176_h_c_GET(Pack * src)//Commanded altitude in 0.1 m
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  0, 2)));
}
INLINER float p176_u_m_GET(Pack * src)//Measured Airspeed prior to the nav filter in m/s
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  2, 4)));
}
INLINER float p176_phi_c_GET(Pack * src)//Commanded Roll
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  6, 4)));
}
INLINER float p176_theta_c_GET(Pack * src)//Commanded Pitch
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  10, 4)));
}
INLINER float p176_psiDot_c_GET(Pack * src)//Commanded Turn rate
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  14, 4)));
}
INLINER float p176_ay_body_GET(Pack * src)//Y component of the body acceleration
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  18, 4)));
}
INLINER float p176_totalDist_GET(Pack * src)//Total Distance to Run on this leg of Navigation
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  22, 4)));
}
INLINER float p176_dist2Go_GET(Pack * src)//Remaining distance to Run on this leg of Navigation
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  26, 4)));
}
INLINER uint8_t p176_fromWP_GET(Pack * src)//Origin WP
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  30, 1)));
}
INLINER uint8_t p176_toWP_GET(Pack * src)//Destination WP
{
    uint8_t * data = src->data;
...
INLINER uint8_t p179_percentUsed_GET(Pack * src)//Percent used GPS
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  11, 1)));
}
INLINER uint8_t p180_target_GET(Pack * src)//The system setting the commands
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  0, 1)));
}
INLINER float p180_hCommand_GET(Pack * src)//Commanded Altitude in meters
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  1, 4)));
}
INLINER float p180_uCommand_GET(Pack * src)//Commanded Airspeed in m/s
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  5, 4)));
}
INLINER float p180_rCommand_GET(Pack * src)//Commanded Turnrate in rad/s
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  9, 4)));
}
...
INLINER uint8_t p181_target_GET(Pack * src)//The system setting the commands
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  2, 1)));
}
INLINER uint8_t p184_target_GET(Pack * src)//The system reporting the action
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  0, 1)));
}
INLINER int8_t p184_pan_GET(Pack * src)//Order the mount to pan: -1 left, 0 No pan motion, +1 right
{
    uint8_t * data = src->data;
    return ((int8_t)(get_bytes(data,  1, 1)));
}
INLINER int8_t p184_tilt_GET(Pack * src)//Order the mount to tilt: -1 down, 0 No tilt motion, +1 up
{
    uint8_t * data = src->data;
    return ((int8_t)(get_bytes(data,  2, 1)));
}
INLINER int8_t p184_zoom_GET(Pack * src)//Order the zoom values 0 to 10
{
    uint8_t * data = src->data;
...
INLINER uint8_t p185_target_GET(Pack * src)//The system setting the commands
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  0, 1)));
}
INLINER uint8_t p185_idSurface_GET(Pack * src)//ID control surface send 0: throttle 1: aileron 2: elevator 3: rudder
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  1, 1)));
}
INLINER float p185_mControl_GET(Pack * src)//Pending
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  2, 4)));
}
INLINER float p185_bControl_GET(Pack * src)//Order to origin
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  6, 4)));
}
INLINER uint8_t p186_target_GET(Pack * src)//The system reporting the action
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  0, 1)));
}
INLINER float p186_latitude_GET(Pack * src)//Mobile Latitude
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  1, 4)));
}
INLINER float p186_longitude_GET(Pack * src)//Mobile Longitude
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  5, 4)));
}
INLINER uint8_t p188_target_GET(Pack * src)//The system setting the commands
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  0, 1)));
}
INLINER uint8_t p188_idOrder_GET(Pack * src)//ID 0: brightness 1: aperture 2: iris 3: ICR 4: backlight
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  1, 1)));
}
INLINER uint8_t p188_order_GET(Pack * src)//1: up/on 2: down/off 3: auto/reset/no action
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  2, 1)));
}
INLINER uint8_t p189_target_GET(Pack * src)//The system reporting the action
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  0, 1)));
}
INLINER float p189_latitude_GET(Pack * src)//ISR Latitude
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  1, 4)));
}
INLINER float p189_longitude_GET(Pack * src)//ISR Longitude
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  5, 4)));
}
INLINER float p189_height_GET(Pack * src)//ISR Height
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  9, 4)));
}
INLINER uint8_t p189_option1_GET(Pack * src)//Option 1
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  13, 1)));
}
INLINER uint8_t p189_option2_GET(Pack * src)//Option 2
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  14, 1)));
}
INLINER uint8_t p189_option3_GET(Pack * src)//Option 3
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  15, 1)));
}
...
INLINER uint8_t p191_r2Type_GET(Pack * src)//It is the value of reading 2: 0 - Current, 1 - Foreward Sonar, 2 - Back Sonar, 3 - RPM
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  4, 1)));
}
INLINER uint8_t p192_zoom_GET(Pack * src)//The actual Zoom Value
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  0, 1)));
}
INLINER int16_t p192_pan_GET(Pack * src)//The Pan value in 10ths of degree
{
    uint8_t * data = src->data;
    return ((int16_t)(get_bytes(data,  1, 2)));
}
INLINER int16_t p192_tilt_GET(Pack * src)//The Tilt value in 10ths of degree
{
    uint8_t * data = src->data;
    return ((int16_t)(get_bytes(data,  3, 2)));
}
INLINER uint8_t p193_target_GET(Pack * src)//The ID system reporting the action
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  0, 1)));
}
INLINER float p193_latitude_GET(Pack * src)//Latitude UAV
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  1, 4)));
}
INLINER float p193_longitude_GET(Pack * src)//Longitude UAV
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  5, 4)));
}
INLINER float p193_altitude_GET(Pack * src)//Altitude UAV
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  9, 4)));
}
INLINER float p193_speed_GET(Pack * src)//Speed UAV
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  13, 4)));
}
INLINER float p193_course_GET(Pack * src)//Course UAV
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  17, 4)));
}
INLINER uint16_t p194_csFails_GET(Pack * src)//Number of times checksum has failed
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  0, 2)));
}
...
INLINER uint8_t p194_msgsType_GET(Pack * src)//Indicates if GN, GL or GP messages are being received
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  3, 1)));
}
INLINER uint8_t p194_posStatus_GET(Pack * src)//A = data valid, V = data invalid
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  4, 1)));
}
...
INLINER uint16_t p195_csFails_GET(Pack * src)//Times the CRC has failed since boot
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  0, 2)));
}
INLINER uint32_t p195_receiverStatus_GET(Pack * src)//Status Bitfield. See table 69 page 350 Novatel OEMstar Manual
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  2, 4)));
}
INLINER uint8_t p195_timeStatus_GET(Pack * src)//The Time Status. See Table 8 page 27 Novatel OEMStar Manual
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  6, 1)));
}
INLINER uint8_t p195_solStatus_GET(Pack * src)//solution Status. See table 44 page 197
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  7, 1)));
}
INLINER uint8_t p195_posType_GET(Pack * src)//position type. See table 43 page 196
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  8, 1)));
}
INLINER uint8_t p195_velType_GET(Pack * src)//velocity type. See table 43 page 196
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  9, 1)));
}
INLINER float p195_posSolAge_GET(Pack * src)//Age of the position solution in seconds
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  10, 4)));
}
INLINER float p196_float1_GET(Pack * src)//Float field 1
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  0, 4)));
}
INLINER float p196_float2_GET(Pack * src)//Float field 2
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  4, 4)));
}
INLINER int16_t p196_int1_GET(Pack * src)//Int 16 field 1
{
    uint8_t * data = src->data;
    return ((int16_t)(get_bytes(data,  8, 2)));
}
INLINER int8_t p196_char1_GET(Pack * src)//Int 8 field 1
{
    uint8_t * data = src->data;
    return ((int8_t)(get_bytes(data,  10, 1)));
}
INLINER uint32_t p197_version_GET(Pack * src)//The onboard software version
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  0, 4)));
}
