...
inline static e_MAV_MODE _en__P(UMAX id)
{
    switch(id)
    {
        case 0:
...
inline static UMAX _id__P(e_MAV_MODE en)
{
    switch(en)
    {
...
inline static UMAX _id__h(e_MAV_CMD en)
{
    switch(en)
    {
...
{
    uint8_t * data = src->data;
    return  _en__P(get_bits(data, 328, 4));
}
...
{
    uint8_t * data = src->data;
    return  _en__P(get_bits(data, 640, 4));
}
