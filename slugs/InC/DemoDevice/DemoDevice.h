...
typedef  enum
{
    ...
    e_MAV_CMD_MAV_CMD_DO_NOTHING = 10001,
    e_MAV_CMD_MAV_CMD_RETURN_TO_BASE = 10011,
    e_MAV_CMD_MAV_CMD_STOP_RETURN_TO_BASE = 10012,
    e_MAV_CMD_MAV_CMD_TURN_LIGHT = 10013,
    e_MAV_CMD_MAV_CMD_GET_MID_LEVEL_COMMANDS = 10014,
    e_MAV_CMD_MAV_CMD_MIDLEVEL_STORAGE = 10015,
...
INLINER void p39_command_SET(e_MAV_CMD  src, Pack * dst)//The scheduled action for the waypoint. see MAV_CMD in common.xml MAVLink spec
{
    ...
    switch(src)
    {
        ...
        case e_MAV_CMD_MAV_CMD_UAVCAN_GET_NODE_INFO:
            id = 109;
            break;
        case e_MAV_CMD_MAV_CMD_DO_NOTHING:
            id = 110;
            break;
        case e_MAV_CMD_MAV_CMD_RETURN_TO_BASE:
            id = 111;
            break;
        case e_MAV_CMD_MAV_CMD_STOP_RETURN_TO_BASE:
            id = 112;
            break;
        case e_MAV_CMD_MAV_CMD_TURN_LIGHT:
            id = 113;
            break;
        case e_MAV_CMD_MAV_CMD_GET_MID_LEVEL_COMMANDS:
            id = 114;
            break;
        case e_MAV_CMD_MAV_CMD_MIDLEVEL_STORAGE:
            id = 115;
            break;
...
INLINER uint16_t p170_batVolt_GET(Pack * src)//Battery Voltage in millivolt
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  0, 2)));
}
INLINER void p170_batVolt_SET(uint16_t  src, Pack * dst)//Battery Voltage in millivolt
{
    uint8_t * data = dst->data;
    set_bytes((src), 2, data,  0);
}
INLINER uint8_t p170_sensLoad_GET(Pack * src)//Sensor DSC Loa
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  2, 1)));
}
INLINER void p170_sensLoad_SET(uint8_t  src, Pack * dst)//Sensor DSC Loa
{
    uint8_t * data = dst->data;
    set_bytes((src), 1, data,  2);
}
INLINER uint8_t p170_ctrlLoad_GET(Pack * src)//Control DSC Loa
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  3, 1)));
}
INLINER void p170_ctrlLoad_SET(uint8_t  src, Pack * dst)//Control DSC Loa
{
    uint8_t * data = dst->data;
    set_bytes((src), 1, data,  3);
}
INLINER float p172_axBias_GET(Pack * src)//Accelerometer X bias (m/s
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  0, 4)));
}
...
INLINER float p172_ayBias_GET(Pack * src)//Accelerometer Y bias (m/s
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  4, 4)));
}
...
INLINER float p172_azBias_GET(Pack * src)//Accelerometer Z bias (m/s
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  8, 4)));
}
...
INLINER float p172_gxBias_GET(Pack * src)//Gyro X bias (rad/s
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  12, 4)));
}
...
INLINER float p172_gyBias_GET(Pack * src)//Gyro Y bias (rad/s
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  16, 4)));
}
...
INLINER float p172_gzBias_GET(Pack * src)//Gyro Z bias (rad/s
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  20, 4)));
}
...
INLINER float p173_diagFl1_GET(Pack * src)//Diagnostic float
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  0, 4)));
}
INLINER void p173_diagFl1_SET(float  src, Pack * dst)//Diagnostic float
{
    uint8_t * data = dst->data;
    set_bytes(floatToIntBits(src), 4, data,  0);
}
INLINER float p173_diagFl2_GET(Pack * src)//Diagnostic float
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  4, 4)));
}
INLINER void p173_diagFl2_SET(float  src, Pack * dst)//Diagnostic float
{
    uint8_t * data = dst->data;
    set_bytes(floatToIntBits(src), 4, data,  4);
}
INLINER float p173_diagFl3_GET(Pack * src)//Diagnostic float
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  8, 4)));
}
INLINER void p173_diagFl3_SET(float  src, Pack * dst)//Diagnostic float
{
    uint8_t * data = dst->data;
    set_bytes(floatToIntBits(src), 4, data,  8);
}
INLINER int16_t p173_diagSh1_GET(Pack * src)//Diagnostic short
{
    uint8_t * data = src->data;
    return ((int16_t)(get_bytes(data,  12, 2)));
}
INLINER void p173_diagSh1_SET(int16_t  src, Pack * dst)//Diagnostic short
{
    uint8_t * data = dst->data;
    set_bytes((uint16_t)(src), 2, data,  12);
}
INLINER int16_t p173_diagSh2_GET(Pack * src)//Diagnostic short
{
    uint8_t * data = src->data;
    return ((int16_t)(get_bytes(data,  14, 2)));
}
INLINER void p173_diagSh2_SET(int16_t  src, Pack * dst)//Diagnostic short
{
    uint8_t * data = dst->data;
    set_bytes((uint16_t)(src), 2, data,  14);
}
INLINER int16_t p173_diagSh3_GET(Pack * src)//Diagnostic short
{
    uint8_t * data = src->data;
    return ((int16_t)(get_bytes(data,  16, 2)));
}
INLINER void p173_diagSh3_SET(int16_t  src, Pack * dst)//Diagnostic short
{
    uint8_t * data = dst->data;
    set_bytes((uint16_t)(src), 2, data,  16);
}
INLINER uint16_t p176_h_c_GET(Pack * src)//Commanded altitude in 0.1
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  0, 2)));
}
INLINER void p176_h_c_SET(uint16_t  src, Pack * dst)//Commanded altitude in 0.1
{
    uint8_t * data = dst->data;
    set_bytes((src), 2, data,  0);
}
INLINER float p176_u_m_GET(Pack * src)//Measured Airspeed prior to the nav filter in m/
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  2, 4)));
}
INLINER void p176_u_m_SET(float  src, Pack * dst)//Measured Airspeed prior to the nav filter in m/
{
    uint8_t * data = dst->data;
    set_bytes(floatToIntBits(src), 4, data,  2);
}
INLINER float p176_phi_c_GET(Pack * src)//Commanded Rol
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  6, 4)));
}
INLINER void p176_phi_c_SET(float  src, Pack * dst)//Commanded Rol
{
    uint8_t * data = dst->data;
    set_bytes(floatToIntBits(src), 4, data,  6);
}
INLINER float p176_theta_c_GET(Pack * src)//Commanded Pitc
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  10, 4)));
}
INLINER void p176_theta_c_SET(float  src, Pack * dst)//Commanded Pitc
{
    uint8_t * data = dst->data;
    set_bytes(floatToIntBits(src), 4, data,  10);
}
INLINER float p176_psiDot_c_GET(Pack * src)//Commanded Turn rat
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  14, 4)));
}
INLINER void p176_psiDot_c_SET(float  src, Pack * dst)//Commanded Turn rat
{
    uint8_t * data = dst->data;
    set_bytes(floatToIntBits(src), 4, data,  14);
}
INLINER float p176_ay_body_GET(Pack * src)//Y component of the body acceleratio
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  18, 4)));
}
INLINER void p176_ay_body_SET(float  src, Pack * dst)//Y component of the body acceleratio
{
    uint8_t * data = dst->data;
    set_bytes(floatToIntBits(src), 4, data,  18);
}
INLINER float p176_totalDist_GET(Pack * src)//Total Distance to Run on this leg of Navigatio
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  22, 4)));
}
INLINER void p176_totalDist_SET(float  src, Pack * dst)//Total Distance to Run on this leg of Navigatio
{
    uint8_t * data = dst->data;
    set_bytes(floatToIntBits(src), 4, data,  22);
}
INLINER float p176_dist2Go_GET(Pack * src)//Remaining distance to Run on this leg of Navigatio
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  26, 4)));
}
INLINER void p176_dist2Go_SET(float  src, Pack * dst)//Remaining distance to Run on this leg of Navigatio
{
    uint8_t * data = dst->data;
    set_bytes(floatToIntBits(src), 4, data,  26);
}
INLINER uint8_t p176_fromWP_GET(Pack * src)//Origin W
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  30, 1)));
}
INLINER void p176_fromWP_SET(uint8_t  src, Pack * dst)//Origin W
{
    uint8_t * data = dst->data;
    set_bytes((src), 1, data,  30);
}
INLINER uint8_t p176_toWP_GET(Pack * src)//Destination W
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  31, 1)));
}
INLINER void p176_toWP_SET(uint8_t  src, Pack * dst)//Destination W
{
    uint8_t * data = dst->data;
    set_bytes((src), 1, data,  31);
}
INLINER float p177_fl_1_GET(Pack * src)//Log value 1
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  0, 4)));
}
...
INLINER float p177_fl_2_GET(Pack * src)//Log value 2
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  4, 4)));
}
...
INLINER float p177_fl_3_GET(Pack * src)//Log value 3
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  8, 4)));
}
...
INLINER float p177_fl_4_GET(Pack * src)//Log value 4
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  12, 4)));
}
...
INLINER float p177_fl_5_GET(Pack * src)//Log value 5
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  16, 4)));
}
...
INLINER float p177_fl_6_GET(Pack * src)//Log value 6
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  20, 4)));
}
...
INLINER uint8_t p179_year_GET(Pack * src)//Year reported by Gps
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  0, 1)));
}
...
INLINER uint8_t p179_month_GET(Pack * src)//Month reported by Gps
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  1, 1)));
}
...
INLINER uint8_t p179_day_GET(Pack * src)//Day reported by Gps
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  2, 1)));
}
...
INLINER uint8_t p179_hour_GET(Pack * src)//Hour reported by Gps
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  3, 1)));
}
...
INLINER uint8_t p179_min_GET(Pack * src)//Min reported by Gps
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  4, 1)));
}
...
INLINER uint8_t p179_sec_GET(Pack * src)//Sec reported by Gps
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  5, 1)));
}
...
INLINER uint8_t p179_clockStat_GET(Pack * src)//Clock Status. See table 47 page 211 OEMStar Manual
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  6, 1)));
}
...
INLINER uint8_t p179_visSat_GET(Pack * src)//Visible satellites reported by Gps
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  7, 1)));
}
...
INLINER uint8_t p179_useSat_GET(Pack * src)//Used satellites in Solution
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  8, 1)));
}
...
INLINER uint8_t p179_GppGl_GET(Pack * src)//GPS+GLONASS satellites in Solution
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  9, 1)));
}
...
INLINER uint8_t p179_sigUsedMask_GET(Pack * src)//GPS and GLONASS usage mask (bit 0 GPS_used? bit_4 GLONASS_used?
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  10, 1)));
}
...
INLINER uint8_t p179_percentUsed_GET(Pack * src)//Percent used GP
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  11, 1)));
}
INLINER void p179_percentUsed_SET(uint8_t  src, Pack * dst)//Percent used GP
{
    uint8_t * data = dst->data;
    set_bytes((src), 1, data,  11);
}
INLINER uint8_t p180_target_GET(Pack * src)//The system setting the command
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  0, 1)));
}
INLINER void p180_target_SET(uint8_t  src, Pack * dst)//The system setting the command
{
    uint8_t * data = dst->data;
    set_bytes((src), 1, data,  0);
}
INLINER float p180_hCommand_GET(Pack * src)//Commanded Altitude in meter
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  1, 4)));
}
INLINER void p180_hCommand_SET(float  src, Pack * dst)//Commanded Altitude in meter
{
    uint8_t * data = dst->data;
    set_bytes(floatToIntBits(src), 4, data,  1);
}
INLINER float p180_uCommand_GET(Pack * src)//Commanded Airspeed in m/
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  5, 4)));
}
INLINER void p180_uCommand_SET(float  src, Pack * dst)//Commanded Airspeed in m/
{
    uint8_t * data = dst->data;
    set_bytes(floatToIntBits(src), 4, data,  5);
}
INLINER float p180_rCommand_GET(Pack * src)//Commanded Turnrate in rad/
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  9, 4)));
}
INLINER void p180_rCommand_SET(float  src, Pack * dst)//Commanded Turnrate in rad/
{
    uint8_t * data = dst->data;
    set_bytes(floatToIntBits(src), 4, data,  9);
}
INLINER uint16_t p181_bitfieldPt_GET(Pack * src)//Bitfield containing the passthrough configuration, see CONTROL_SURFACE_FLAG ENUM
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  0, 2)));
}
...
INLINER uint8_t p181_target_GET(Pack * src)//The system setting the command
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  2, 1)));
}
INLINER void p181_target_SET(uint8_t  src, Pack * dst)//The system setting the command
{
    uint8_t * data = dst->data;
    set_bytes((src), 1, data,  2);
}
INLINER uint8_t p184_target_GET(Pack * src)//The system reporting the actio
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  0, 1)));
}
INLINER void p184_target_SET(uint8_t  src, Pack * dst)//The system reporting the actio
{
    uint8_t * data = dst->data;
    set_bytes((src), 1, data,  0);
}
INLINER int8_t p184_pan_GET(Pack * src)//Order the mount to pan: -1 left, 0 No pan motion, +1 righ
{
    uint8_t * data = src->data;
    return ((int8_t)(get_bytes(data,  1, 1)));
}
INLINER void p184_pan_SET(int8_t  src, Pack * dst)//Order the mount to pan: -1 left, 0 No pan motion, +1 righ
{
    uint8_t * data = dst->data;
    set_bytes((uint8_t)(src), 1, data,  1);
}
INLINER int8_t p184_tilt_GET(Pack * src)//Order the mount to tilt: -1 down, 0 No tilt motion, +1 u
{
    uint8_t * data = src->data;
    return ((int8_t)(get_bytes(data,  2, 1)));
}
INLINER void p184_tilt_SET(int8_t  src, Pack * dst)//Order the mount to tilt: -1 down, 0 No tilt motion, +1 u
{
    uint8_t * data = dst->data;
    set_bytes((uint8_t)(src), 1, data,  2);
}
INLINER int8_t p184_zoom_GET(Pack * src)//Order the zoom values 0 to 1
{
    uint8_t * data = src->data;
    return ((int8_t)(get_bytes(data,  3, 1)));
}
INLINER void p184_zoom_SET(int8_t  src, Pack * dst)//Order the zoom values 0 to 1
{
    uint8_t * data = dst->data;
    set_bytes((uint8_t)(src), 1, data,  3);
}
INLINER int8_t p184_moveHome_GET(Pack * src)
{
    uint8_t * data = src->data;
...
INLINER uint8_t p185_target_GET(Pack * src)//The system setting the command
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  0, 1)));
}
INLINER void p185_target_SET(uint8_t  src, Pack * dst)//The system setting the command
{
    uint8_t * data = dst->data;
    set_bytes((src), 1, data,  0);
}
INLINER uint8_t p185_idSurface_GET(Pack * src)//ID control surface send 0: throttle 1: aileron 2: elevator 3: rudde
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  1, 1)));
}
INLINER void p185_idSurface_SET(uint8_t  src, Pack * dst)//ID control surface send 0: throttle 1: aileron 2: elevator 3: rudde
{
    uint8_t * data = dst->data;
    set_bytes((src), 1, data,  1);
}
INLINER float p185_mControl_GET(Pack * src)//Pendin
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  2, 4)));
}
INLINER void p185_mControl_SET(float  src, Pack * dst)//Pendin
{
    uint8_t * data = dst->data;
    set_bytes(floatToIntBits(src), 4, data,  2);
}
INLINER float p185_bControl_GET(Pack * src)//Order to origi
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  6, 4)));
}
INLINER void p185_bControl_SET(float  src, Pack * dst)//Order to origi
{
    uint8_t * data = dst->data;
    set_bytes(floatToIntBits(src), 4, data,  6);
}
INLINER uint8_t p186_target_GET(Pack * src)//The system reporting the actio
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  0, 1)));
}
INLINER void p186_target_SET(uint8_t  src, Pack * dst)//The system reporting the actio
{
    uint8_t * data = dst->data;
    set_bytes((src), 1, data,  0);
}
INLINER float p186_latitude_GET(Pack * src)//Mobile Latitud
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  1, 4)));
}
INLINER void p186_latitude_SET(float  src, Pack * dst)//Mobile Latitud
{
    uint8_t * data = dst->data;
    set_bytes(floatToIntBits(src), 4, data,  1);
}
INLINER float p186_longitude_GET(Pack * src)//Mobile Longitud
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  5, 4)));
}
INLINER void p186_longitude_SET(float  src, Pack * dst)//Mobile Longitud
{
    uint8_t * data = dst->data;
    set_bytes(floatToIntBits(src), 4, data,  5);
}
INLINER uint8_t p188_target_GET(Pack * src)//The system setting the command
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  0, 1)));
}
INLINER void p188_target_SET(uint8_t  src, Pack * dst)//The system setting the command
{
    uint8_t * data = dst->data;
    set_bytes((src), 1, data,  0);
}
INLINER uint8_t p188_idOrder_GET(Pack * src)//ID 0: brightness 1: aperture 2: iris 3: ICR 4: backligh
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  1, 1)));
}
INLINER void p188_idOrder_SET(uint8_t  src, Pack * dst)//ID 0: brightness 1: aperture 2: iris 3: ICR 4: backligh
{
    uint8_t * data = dst->data;
    set_bytes((src), 1, data,  1);
}
INLINER uint8_t p188_order_GET(Pack * src)//1: up/on 2: down/off 3: auto/reset/no actio
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  2, 1)));
}
INLINER void p188_order_SET(uint8_t  src, Pack * dst)//1: up/on 2: down/off 3: auto/reset/no actio
{
    uint8_t * data = dst->data;
    set_bytes((src), 1, data,  2);
}
INLINER uint8_t p189_target_GET(Pack * src)//The system reporting the actio
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  0, 1)));
}
INLINER void p189_target_SET(uint8_t  src, Pack * dst)//The system reporting the actio
{
    uint8_t * data = dst->data;
    set_bytes((src), 1, data,  0);
}
INLINER float p189_latitude_GET(Pack * src)//ISR Latitud
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  1, 4)));
}
INLINER void p189_latitude_SET(float  src, Pack * dst)//ISR Latitud
{
    uint8_t * data = dst->data;
    set_bytes(floatToIntBits(src), 4, data,  1);
}
INLINER float p189_longitude_GET(Pack * src)//ISR Longitud
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  5, 4)));
}
INLINER void p189_longitude_SET(float  src, Pack * dst)//ISR Longitud
{
    uint8_t * data = dst->data;
    set_bytes(floatToIntBits(src), 4, data,  5);
}
INLINER float p189_height_GET(Pack * src)//ISR Heigh
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  9, 4)));
}
INLINER void p189_height_SET(float  src, Pack * dst)//ISR Heigh
{
    uint8_t * data = dst->data;
    set_bytes(floatToIntBits(src), 4, data,  9);
}
INLINER uint8_t p189_option1_GET(Pack * src)//Option
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  13, 1)));
}
INLINER void p189_option1_SET(uint8_t  src, Pack * dst)//Option
{
    uint8_t * data = dst->data;
    set_bytes((src), 1, data,  13);
}
INLINER uint8_t p189_option2_GET(Pack * src)//Option
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  14, 1)));
}
INLINER void p189_option2_SET(uint8_t  src, Pack * dst)//Option
{
    uint8_t * data = dst->data;
    set_bytes((src), 1, data,  14);
}
INLINER uint8_t p189_option3_GET(Pack * src)//Option
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  15, 1)));
}
INLINER void p189_option3_SET(uint8_t  src, Pack * dst)//Option
{
    uint8_t * data = dst->data;
    set_bytes((src), 1, data,  15);
}
INLINER uint16_t p191_voltage_GET(Pack * src)//Voltage in uS of PWM. 0 uS = 0V, 20 uS = 21.5V
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  0, 2)));
}
...
INLINER uint16_t p191_reading2_GET(Pack * src)
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  2, 2)));
}
...
INLINER uint8_t p191_r2Type_GET(Pack * src)//It is the value of reading 2: 0 - Current, 1 - Foreward Sonar, 2 - Back Sonar, 3 - RP
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  4, 1)));
}
INLINER void p191_r2Type_SET(uint8_t  src, Pack * dst)//It is the value of reading 2: 0 - Current, 1 - Foreward Sonar, 2 - Back Sonar, 3 - RP
{
    uint8_t * data = dst->data;
    set_bytes((src), 1, data,  4);
}
INLINER uint8_t p192_zoom_GET(Pack * src)//The actual Zoom Valu
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  0, 1)));
}
INLINER void p192_zoom_SET(uint8_t  src, Pack * dst)//The actual Zoom Valu
{
    uint8_t * data = dst->data;
    set_bytes((src), 1, data,  0);
}
INLINER int16_t p192_pan_GET(Pack * src)//The Pan value in 10ths of degre
{
    uint8_t * data = src->data;
    return ((int16_t)(get_bytes(data,  1, 2)));
}
INLINER void p192_pan_SET(int16_t  src, Pack * dst)//The Pan value in 10ths of degre
{
    uint8_t * data = dst->data;
    set_bytes((uint16_t)(src), 2, data,  1);
}
INLINER int16_t p192_tilt_GET(Pack * src)//The Tilt value in 10ths of degre
{
    uint8_t * data = src->data;
    return ((int16_t)(get_bytes(data,  3, 2)));
}
INLINER void p192_tilt_SET(int16_t  src, Pack * dst)//The Tilt value in 10ths of degre
{
    uint8_t * data = dst->data;
    set_bytes((uint16_t)(src), 2, data,  3);
}
INLINER uint8_t p193_target_GET(Pack * src)//The ID system reporting the actio
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  0, 1)));
}
INLINER void p193_target_SET(uint8_t  src, Pack * dst)//The ID system reporting the actio
{
    uint8_t * data = dst->data;
    set_bytes((src), 1, data,  0);
}
INLINER float p193_latitude_GET(Pack * src)//Latitude UA
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  1, 4)));
}
INLINER void p193_latitude_SET(float  src, Pack * dst)//Latitude UA
{
    uint8_t * data = dst->data;
    set_bytes(floatToIntBits(src), 4, data,  1);
}
INLINER float p193_longitude_GET(Pack * src)//Longitude UA
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  5, 4)));
}
INLINER void p193_longitude_SET(float  src, Pack * dst)//Longitude UA
{
    uint8_t * data = dst->data;
    set_bytes(floatToIntBits(src), 4, data,  5);
}
INLINER float p193_altitude_GET(Pack * src)//Altitude UA
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  9, 4)));
}
INLINER void p193_altitude_SET(float  src, Pack * dst)//Altitude UA
{
    uint8_t * data = dst->data;
    set_bytes(floatToIntBits(src), 4, data,  9);
}
INLINER float p193_speed_GET(Pack * src)//Speed UA
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  13, 4)));
}
INLINER void p193_speed_SET(float  src, Pack * dst)//Speed UA
{
    uint8_t * data = dst->data;
    set_bytes(floatToIntBits(src), 4, data,  13);
}
INLINER float p193_course_GET(Pack * src)//Course UA
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  17, 4)));
}
INLINER void p193_course_SET(float  src, Pack * dst)//Course UA
{
    uint8_t * data = dst->data;
    set_bytes(floatToIntBits(src), 4, data,  17);
}
INLINER uint16_t p194_csFails_GET(Pack * src)//Number of times checksum has faile
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  0, 2)));
}
INLINER void p194_csFails_SET(uint16_t  src, Pack * dst)//Number of times checksum has faile
{
    uint8_t * data = dst->data;
    set_bytes((src), 2, data,  0);
}
INLINER uint8_t p194_gpsQuality_GET(Pack * src)
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  2, 1)));
}
...
INLINER uint8_t p194_msgsType_GET(Pack * src)//Indicates if GN, GL or GP messages are being receive
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  3, 1)));
}
INLINER void p194_msgsType_SET(uint8_t  src, Pack * dst)//Indicates if GN, GL or GP messages are being receive
{
    uint8_t * data = dst->data;
    set_bytes((src), 1, data,  3);
}
INLINER uint8_t p194_posStatus_GET(Pack * src)//A = data valid, V = data invali
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  4, 1)));
}
INLINER void p194_posStatus_SET(uint8_t  src, Pack * dst)//A = data valid, V = data invali
{
    uint8_t * data = dst->data;
    set_bytes((src), 1, data,  4);
}
INLINER float p194_magVar_GET(Pack * src)//Magnetic variation, degrees
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  5, 4)));
}
...
INLINER int8_t p194_magDir_GET(Pack * src)
{
    uint8_t * data = src->data;
    return ((int8_t)(get_bytes(data,  9, 1)));
}
...
INLINER uint8_t p194_modeInd_GET(Pack * src)
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  10, 1)));
}
...
INLINER uint16_t p195_csFails_GET(Pack * src)//Times the CRC has failed since boo
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  0, 2)));
}
INLINER void p195_csFails_SET(uint16_t  src, Pack * dst)//Times the CRC has failed since boo
{
    uint8_t * data = dst->data;
    set_bytes((src), 2, data,  0);
}
INLINER uint32_t p195_receiverStatus_GET(Pack * src)//Status Bitfield. See table 69 page 350 Novatel OEMstar Manua
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  2, 4)));
}
INLINER void p195_receiverStatus_SET(uint32_t  src, Pack * dst)//Status Bitfield. See table 69 page 350 Novatel OEMstar Manua
{
    uint8_t * data = dst->data;
    set_bytes((src), 4, data,  2);
}
INLINER uint8_t p195_timeStatus_GET(Pack * src)//The Time Status. See Table 8 page 27 Novatel OEMStar Manua
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  6, 1)));
}
INLINER void p195_timeStatus_SET(uint8_t  src, Pack * dst)//The Time Status. See Table 8 page 27 Novatel OEMStar Manua
{
    uint8_t * data = dst->data;
    set_bytes((src), 1, data,  6);
}
INLINER uint8_t p195_solStatus_GET(Pack * src)//solution Status. See table 44 page 19
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  7, 1)));
}
INLINER void p195_solStatus_SET(uint8_t  src, Pack * dst)//solution Status. See table 44 page 19
{
    uint8_t * data = dst->data;
    set_bytes((src), 1, data,  7);
}
INLINER uint8_t p195_posType_GET(Pack * src)//position type. See table 43 page 19
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  8, 1)));
}
INLINER void p195_posType_SET(uint8_t  src, Pack * dst)//position type. See table 43 page 19
{
    uint8_t * data = dst->data;
    set_bytes((src), 1, data,  8);
}
INLINER uint8_t p195_velType_GET(Pack * src)//velocity type. See table 43 page 19
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  9, 1)));
}
INLINER void p195_velType_SET(uint8_t  src, Pack * dst)//velocity type. See table 43 page 19
{
    uint8_t * data = dst->data;
    set_bytes((src), 1, data,  9);
}
INLINER float p195_posSolAge_GET(Pack * src)//Age of the position solution in second
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  10, 4)));
}
INLINER void p195_posSolAge_SET(float  src, Pack * dst)//Age of the position solution in second
{
    uint8_t * data = dst->data;
    set_bytes(floatToIntBits(src), 4, data,  10);
}
INLINER float p196_float1_GET(Pack * src)//Float field
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  0, 4)));
}
INLINER void p196_float1_SET(float  src, Pack * dst)//Float field
{
    uint8_t * data = dst->data;
    set_bytes(floatToIntBits(src), 4, data,  0);
}
INLINER float p196_float2_GET(Pack * src)//Float field
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  4, 4)));
}
INLINER void p196_float2_SET(float  src, Pack * dst)//Float field
{
    uint8_t * data = dst->data;
    set_bytes(floatToIntBits(src), 4, data,  4);
}
INLINER int16_t p196_int1_GET(Pack * src)//Int 16 field
{
    uint8_t * data = src->data;
    return ((int16_t)(get_bytes(data,  8, 2)));
}
INLINER void p196_int1_SET(int16_t  src, Pack * dst)//Int 16 field
{
    uint8_t * data = dst->data;
    set_bytes((uint16_t)(src), 2, data,  8);
}
INLINER int8_t p196_char1_GET(Pack * src)//Int 8 field
{
    uint8_t * data = src->data;
    return ((int8_t)(get_bytes(data,  10, 1)));
}
INLINER void p196_char1_SET(int8_t  src, Pack * dst)//Int 8 field
{
    uint8_t * data = dst->data;
    set_bytes((uint8_t)(src), 1, data,  10);
}
INLINER uint32_t p197_version_GET(Pack * src)//The onboard software versio
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  0, 4)));
}
INLINER void p197_version_SET(uint32_t  src, Pack * dst)//The onboard software versio
{
    uint8_t * data = dst->data;
    set_bytes((src), 4, data,  0);
}
