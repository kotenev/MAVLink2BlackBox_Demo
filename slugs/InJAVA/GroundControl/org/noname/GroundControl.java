...
public class GroundControl extends Host {
	...
	public static class CHANGE_OPERATOR_CONTROL extends Pack {
		...
		static final Meta meta = new Meta(5, 0, 0, 0, 4, 24, 0, _d);
	}
	...
	public static class PARAM_VALUE extends Pack {
		...
		static final Meta meta = new Meta(22, 2, 0, 0, 10, 68, 0, _E);
	}
	...
	public static class GPS_RAW_INT extends Pack {
		...
		static final Meta meta = new Meta(24, 4, 0, 1, 31, 236, 0, _nr, _Ar, _Lr, _mr, _wr);
	}
	...
	public static class SERVO_OUTPUT_RAW extends Pack {
		...
		static final Meta meta = new Meta(36, 8, 1, 0, 22, 168, 0, _Us, _ns, _As, _Ls, _ms, _ws, _Ks, _es);
	}
	...
	public static class SET_GPS_GLOBAL_ORIGIN extends Pack {
		...
		static final Meta meta = new Meta(48, 0, 0, 0, 14, 104, 0, _Pb);
	}
	...
	public static class GPS_GLOBAL_ORIGIN extends Pack {
		...
		static final Meta meta = new Meta(49, 0, 0, 0, 13, 96, 0, _Cb);
	}
	...
	public static class PARAM_MAP_RC extends Pack {
		...
		static final Meta meta = new Meta(50, 0, 0, 0, 22, 168, 0, _yb);
	}
	...
	public static class COMMAND_ACK extends Pack {
		...
		static final Meta meta = new Meta(77, 0, 0, 0, 3, 11, 0, _Fk, _yk, _qk, _Dk);
	}
	...
	public static class OPTICAL_FLOW extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(100, 0, 0, 1, 27, 208, 0, _wn, _Kn);
	}
	...
	public static class AUTOPILOT_VERSION extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(148, 2, 4, 1, 54, 421, 0, _iP);
	}
	...
	public static class LANDING_TARGET extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(149, 0, 0, 1, 31, 239, 0, _wP, _KP, _eP, _PP, _aP);
	}

	/**
	 * Sensor and DSC control loads.
	 */
	public static class CPU_LOAD extends Pack implements CommunicationChannel.Sendable {

		CPU_LOAD() { super(meta, 0); }

		public void batVolt_SET(char src) //Battery Voltage in millivolts
		{ set_bytes((char) (src) & -1L, 2, data, 0); }

		public void sensLoad_SET(char src) //Sensor DSC Load
		{ set_bytes((char) (src) & -1L, 1, data, 2); }

		public void ctrlLoad_SET(char src) //Control DSC Load
	 ...
	 */
	public static class SENSOR_BIAS extends Pack implements CommunicationChannel.Sendable {
	 ...
	 */
	public static class DIAGNOSTIC extends Pack implements CommunicationChannel.Sendable {

		DIAGNOSTIC() { super(meta, 0); }

		public void diagFl1_SET(float src) //Diagnostic float 1
		{ set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 0); }

		public void diagFl2_SET(float src) //Diagnostic float 2
		{ set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 4); }

		public void diagFl3_SET(float src) //Diagnostic float 3
		{ set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 8); }

		public void diagSh1_SET(short src) //Diagnostic short 1
		{ set_bytes((short) (src) & -1L, 2, data, 12); }

		public void diagSh2_SET(short src) //Diagnostic short 2
		{ set_bytes((short) (src) & -1L, 2, data, 14); }

		public void diagSh3_SET(short src) //Diagnostic short 3
		{ set_bytes((short) (src) & -1L, 2, data, 16); }
	 ...
	 */
	public static class SLUGS_NAVIGATION extends Pack implements CommunicationChannel.Sendable {

		SLUGS_NAVIGATION() { super(meta, 0); }

		public void h_c_SET(char src) //Commanded altitude in 0.1 m
		{ set_bytes((char) (src) & -1L, 2, data, 0); }

		public void u_m_SET(float src) //Measured Airspeed prior to the nav filter in m/s
		{ set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 2); }

		public void phi_c_SET(float src) //Commanded Roll
		{ set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 6); }

		public void theta_c_SET(float src) //Commanded Pitch
		{ set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 10); }

		public void psiDot_c_SET(float src) //Commanded Turn rate
		{ set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 14); }

		public void ay_body_SET(float src) //Y component of the body acceleration
		{ set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 18); }

		public void totalDist_SET(float src) //Total Distance to Run on this leg of Navigation
		{ set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 22); }

		public void dist2Go_SET(float src) //Remaining distance to Run on this leg of Navigation
		{ set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 26); }

		public void fromWP_SET(char src) //Origin WP
		{ set_bytes((char) (src) & -1L, 1, data, 30); }

		public void toWP_SET(char src) //Destination WP
	 ...
	 */
	public static class DATA_LOG extends Pack implements CommunicationChannel.Sendable {
	 ...
	 */
	public static class GPS_DATE_TIME extends Pack implements CommunicationChannel.Sendable {
		...
		public void percentUsed_SET(char src) //Percent used GPS
		{ set_bytes((char) (src) & -1L, 1, data, 11); }
	 ...
	 */
	public static class MID_LVL_CMDS extends Pack implements CommunicationChannel.Sendable {

		MID_LVL_CMDS() { super(meta, 0); }

		public void target_SET(char src) //The system setting the commands
		{ set_bytes((char) (src) & -1L, 1, data, 0); }

		public void hCommand_SET(float src) //Commanded Altitude in meters
		{ set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 1); }

		public void uCommand_SET(float src) //Commanded Airspeed in m/s
		{ set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 5); }

		public void rCommand_SET(float src) //Commanded Turnrate in rad/s
		{ set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 9); }
	 ...
	 */
	public static class CTRL_SRFC_PT extends Pack implements CommunicationChannel.Sendable {
	 ...
	 */
	public static class SLUGS_CAMERA_ORDER extends Pack implements CommunicationChannel.Sendable {

		SLUGS_CAMERA_ORDER() { super(meta, 0); }

		public void target_SET(char src) //The system reporting the action
		{ set_bytes((char) (src) & -1L, 1, data, 0); }

		public void pan_SET(byte src) //Order the mount to pan: -1 left, 0 No pan motion, +1 right
		{ set_bytes((byte) (src) & -1L, 1, data, 1); }

		public void tilt_SET(byte src) //Order the mount to tilt: -1 down, 0 No tilt motion, +1 up
		{ set_bytes((byte) (src) & -1L, 1, data, 2); }

		public void zoom_SET(byte src) //Order the zoom values 0 to 10
	 ...
	 */
	public static class CONTROL_SURFACE extends Pack implements CommunicationChannel.Sendable {
		...
		public void idSurface_SET(char src) //ID control surface send 0: throttle 1: aileron 2: elevator 3: rudder
		{ set_bytes((char) (src) & -1L, 1, data, 1); }

		public void mControl_SET(float src) //Pending
		{ set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 2); }

		public void bControl_SET(float src) //Order to origin
		{ set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 6); }
	 ...
	 */
	public static class SLUGS_MOBILE_LOCATION extends Pack implements CommunicationChannel.Sendable {
		...
		public void latitude_SET(float src) //Mobile Latitude
		{ set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 1); }

		public void longitude_SET(float src) //Mobile Longitude
		{ set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 5); }
	 ...
	 * Control for camara.
	 */
	public static class SLUGS_CONFIGURATION_CAMERA extends Pack implements CommunicationChannel.Sendable {
		...
		public void idOrder_SET(char src) //ID 0: brightness 1: aperture 2: iris 3: ICR 4: backlight
		{ set_bytes((char) (src) & -1L, 1, data, 1); }

		public void order_SET(char src) //1: up/on 2: down/off 3: auto/reset/no action
		{ set_bytes((char) (src) & -1L, 1, data, 2); }
	 ...
	 */
	public static class ISR_LOCATION extends Pack implements CommunicationChannel.Sendable {
		...
		public void latitude_SET(float src) //ISR Latitude
		{ set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 1); }

		public void longitude_SET(float src) //ISR Longitude
		{ set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 5); }

		public void height_SET(float src) //ISR Height
		{ set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 9); }

		public void option1_SET(char src) //Option 1
		{ set_bytes((char) (src) & -1L, 1, data, 13); }

		public void option2_SET(char src) //Option 2
		{ set_bytes((char) (src) & -1L, 1, data, 14); }

		public void option3_SET(char src) //Option 3
		{ set_bytes((char) (src) & -1L, 1, data, 15); }
	 ...
	 */
	public static class VOLT_SENSOR extends Pack implements CommunicationChannel.Sendable {
		...
		public void r2Type_SET(char src) //It is the value of reading 2: 0 - Current, 1 - Foreward Sonar, 2 - Back Sonar, 3 - RPM
		{ set_bytes((char) (src) & -1L, 1, data, 4); }
	 ...
	 */
	public static class PTZ_STATUS extends Pack implements CommunicationChannel.Sendable {

		PTZ_STATUS() { super(meta, 0); }

		public void zoom_SET(char src) //The actual Zoom Value
		{ set_bytes((char) (src) & -1L, 1, data, 0); }

		public void pan_SET(short src) //The Pan value in 10ths of degree
		{ set_bytes((short) (src) & -1L, 2, data, 1); }

		public void tilt_SET(short src) //The Tilt value in 10ths of degree
	 ...
	 */
	public static class UAV_STATUS extends Pack implements CommunicationChannel.Sendable {

		UAV_STATUS() { super(meta, 0); }

		public void target_SET(char src) //The ID system reporting the action
		{ set_bytes((char) (src) & -1L, 1, data, 0); }

		public void latitude_SET(float src) //Latitude UAV
		{ set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 1); }

		public void longitude_SET(float src) //Longitude UAV
		{ set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 5); }

		public void altitude_SET(float src) //Altitude UAV
		{ set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 9); }

		public void speed_SET(float src) //Speed UAV
		{ set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 13); }

		public void course_SET(float src) //Course UAV
		{ set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 17); }
	 ...
	 */
	public static class STATUS_GPS extends Pack implements CommunicationChannel.Sendable {

		STATUS_GPS() { super(meta, 0); }

		public void csFails_SET(char src) //Number of times checksum has failed
		{ set_bytes((char) (src) & -1L, 2, data, 0); }
		...
		public void msgsType_SET(char src) //Indicates if GN, GL or GP messages are being received
		{ set_bytes((char) (src) & -1L, 1, data, 3); }

		public void posStatus_SET(char src) //A = data valid, V = data invalid
		{ set_bytes((char) (src) & -1L, 1, data, 4); }
	 ...
	 */
	public static class NOVATEL_DIAG extends Pack implements CommunicationChannel.Sendable {

		NOVATEL_DIAG() { super(meta, 0); }

		public void csFails_SET(char src) //Times the CRC has failed since boot
		{ set_bytes((char) (src) & -1L, 2, data, 0); }

		public void receiverStatus_SET(long src) //Status Bitfield. See table 69 page 350 Novatel OEMstar Manual
		{ set_bytes((src) & -1L, 4, data, 2); }

		public void timeStatus_SET(char src) //The Time Status. See Table 8 page 27 Novatel OEMStar Manual
		{ set_bytes((char) (src) & -1L, 1, data, 6); }

		public void solStatus_SET(char src) //solution Status. See table 44 page 197
		{ set_bytes((char) (src) & -1L, 1, data, 7); }

		public void posType_SET(char src) //position type. See table 43 page 196
		{ set_bytes((char) (src) & -1L, 1, data, 8); }

		public void velType_SET(char src) //velocity type. See table 43 page 196
		{ set_bytes((char) (src) & -1L, 1, data, 9); }

		public void posSolAge_SET(float src) //Age of the position solution in seconds
		{ set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 10); }
	 ...
	 */
	public static class SENSOR_DIAG extends Pack implements CommunicationChannel.Sendable {

		SENSOR_DIAG() { super(meta, 0); }

		public void float1_SET(float src) //Float field 1
		{ set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 0); }

		public void float2_SET(float src) //Float field 2
		{ set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 4); }

		public void int1_SET(short src) //Int 16 field 1
		{ set_bytes((short) (src) & -1L, 2, data, 8); }

		public void char1_SET(byte src) //Int 8 field 1
	 ...
	 * numbers on startup
	 */
	public static class BOOT extends Pack implements CommunicationChannel.Sendable {

		BOOT() { super(meta, 0); }

		public void version_SET(long src) //The onboard software version
		{ set_bytes((src) & -1L, 4, data, 0); }
	...
	public static class HOME_POSITION extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(242, 0, 0, 0, 53, 416, 0, _uW);
	}
	...
	public static class SET_HOME_POSITION extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(243, 0, 0, 0, 54, 424, 0, _Ua);
	}
	...
	public static class ADSB_VEHICLE extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(246, 3, 1, 0, 28, 210, 0, _oa);
	}
	...
	public static class DEBUG_VECT extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(250, 0, 0, 1, 21, 160, 0, _Ba);
	}
	...
	public static class NAMED_VALUE_FLOAT extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(251, 0, 1, 0, 9, 64, 0, _ua);
	}
	...
	public static class NAMED_VALUE_INT extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(252, 0, 1, 0, 9, 64, 0, _tV);
	}
	...
	public static class STATUSTEXT extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(253, 0, 0, 0, 2, 4, 0, _sV);
	}
	...
	public static class PLAY_TUNE extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(258, 0, 0, 0, 3, 16, 0, _eV);
	}
	...
	public static class CAMERA_INFORMATION extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(259, 3, 2, 0, 93, 731, 0, _OV);
	}
	...
	public static class CAMERA_IMAGE_CAPTURED extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(263, 0, 1, 1, 51, 402, 2, _iC);
	}
	...
	public static class VIDEO_STREAM_INFORMATION extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(269, 3, 1, 0, 17, 130, 2, _MC);
	}
	...
	public static class SET_VIDEO_STREAM_SETTINGS extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(270, 3, 1, 0, 18, 138, 2, _pC);
	}
	...
	public static class WIFI_CONFIG_AP extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(299, 0, 0, 0, 1, 2, 2, _zC, _XC);
	}
	...
	public static class UAVCAN_NODE_INFO extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(311, 0, 2, 1, 37, 288, 0, _Uo);
	}
	...
	public static class PARAM_EXT_REQUEST_READ extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(320, 0, 0, 0, 5, 32, 0, _Wo);
	}
	...
	public static class PARAM_EXT_VALUE extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(322, 2, 0, 0, 5, 38, 2, _oo, _Fo);
	}
	...
	public static class PARAM_EXT_SET extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(323, 0, 0, 0, 3, 22, 2, _Oo, _No);
	}
	...
	public static class PARAM_EXT_ACK extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(324, 0, 0, 0, 2, 9, 2, _Ho, _Jo);
	}
	...
	private static final Field _nr = new Field(0, false, 1, 4, 1, 0, 0, 0);
	private static final Field _Ar = new Field(0, true, 1, 4, 1, 0, 0, 0);
	private static final Field _Lr = new Field(0, true, 1, 4, 1, 0, 0, 0);
	private static final Field _mr = new Field(0, true, 1, 4, 1, 0, 0, 0);
	private static final Field _wr = new Field(0, true, 1, 4, 1, 0, 0, 0);
	private static final Field _Us = new Field(0, true, 1, 2, 1, 0, 0, 0);
	private static final Field _ns = new Field(0, true, 1, 2, 1, 0, 0, 0);
	private static final Field _As = new Field(0, true, 1, 2, 1, 0, 0, 0);
	private static final Field _Ls = new Field(0, true, 1, 2, 1, 0, 0, 0);
	private static final Field _ms = new Field(0, true, 1, 2, 1, 0, 0, 0);
	private static final Field _ws = new Field(0, true, 1, 2, 1, 0, 0, 0);
	private static final Field _Ks = new Field(0, true, 1, 2, 1, 0, 0, 0);
	private static final Field _es = new Field(0, true, 1, 2, 1, 0, 0, 0);
	private static final Field _Pb = new Field(0, true, 1, 8, 1, 0, 0, 0);
	private static final Field _Cb = new Field(0, true, 1, 8, 1, 0, 0, 0);
	private static final Field _yb = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
	private static final Field _Fk = new Field(0, false, 1, 1, 1, 0, 0, 0);
	private static final Field _yk = new Field(0, false, 1, 4, 1, 0, 0, 0);
	private static final Field _qk = new Field(0, false, 1, 1, 1, 0, 0, 0);
	private static final Field _Dk = new Field(0, false, 1, 1, 1, 0, 0, 0);
	private static final Field _wn = new Field(0, false, 1, 4, 1, 0, 0, 0);
	private static final Field _Kn = new Field(0, false, 1, 4, 1, 0, 0, 0);
	private static final Field _iP = new Field(0, false, 18, 1, 1, 0, 0, 0);
	private static final Field _wP = new Field(0, false, 1, 4, 1, 0, 0, 0);
	private static final Field _KP = new Field(0, false, 1, 4, 1, 0, 0, 0);
	private static final Field _eP = new Field(0, false, 1, 4, 1, 0, 0, 0);
	private static final Field _PP = new Field(0, false, 4, 4, 1, 0, 0, 0);
	private static final Field _aP = new Field(0, false, 1, 1, 1, 0, 0, 0);
	private static final Field _uW = new Field(0, true, 1, 8, 1, 0, 0, 0);
	private static final Field _Ua = new Field(0, true, 1, 8, 1, 0, 0, 0);
	private static final Field _oa = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
	private static final Field _Ba = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
	private static final Field _ua = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
	private static final Field _tV = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
	private static final Field _sV = new Field(5, true, -6, 2, 1, 0, 0, 0, 1);
	private static final Field _eV = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
	private static final Field _OV = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
	private static final Field _iC = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
	private static final Field _MC = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
	private static final Field _pC = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
	private static final Field _zC = new Field(5, true, -6, 2, 1, 0, 0, 0, 1);
	private static final Field _XC = new Field(5, true, -7, 2, 1, 0, 0, 0, 1);
	private static final Field _Uo = new Field(5, true, -7, 2, 1, 0, 0, 0, 1);
	...
	private static final Field _Fo = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
	private static final Field _Oo = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
	private static final Field _No = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
	private static final Field _Ho = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
	private static final Field _Jo = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
