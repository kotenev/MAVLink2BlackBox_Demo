...
public class DemoDevice extends Host
{
    ...
    } public static class CHANGE_OPERATOR_CONTROL extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        ...
        } static final Meta meta = new Meta(5, 0, 0, 0, 4, 24, 0, _M);
...
//ke
        ...
        {key_SET(src.toCharArray(), 0, src.length(), ph);} public void key_SET(char[]  src, int pos, int items, Bounds.Inside ph) //ke
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(7, 0, 0, 0, 1, 0, 0, _a);
...
//Heading / track uncertainty in degrees * 1e5
        ...
        public void hdg_acc_SET(long  src, Bounds.Inside ph)//Heading / track uncertainty in degrees * 1e5
        {
            ...
            set_bytes((src) & -1L, 4, data,  ph.BYTE);
        } static final Meta meta = new Meta(24, 4, 0, 1, 31, 236, 0, _Dc, _Bc, _nc, _bc, _Fc);
...
//Servo output 16 value, in microsecond
        ...
        public void servo16_raw_SET(char  src, Bounds.Inside ph)//Servo output 16 value, in microsecond
        {
            ...
            set_bytes((char)(src) & -1L, 2, data,  ph.BYTE);
        } static final Meta meta = new Meta(36, 8, 1, 0, 22, 168, 0, _xz, _Dz, _Bz, _nz, _bz, _Fz, _dz, _yz);
    ...
    } public static class MISSION_ITEM extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        ...
        public @MAV_CMD int command_GET()//The scheduled action for the waypoint. see MAV_CMD in common.xml MAVLink spec
        {
            switch((int)get_bits(data, 276, 8))
            {
                ...
                case 110:
                    return MAV_CMD.MAV_CMD_DO_NOTHING;
                case 111:
                    return MAV_CMD.MAV_CMD_RETURN_TO_BASE;
                case 112:
                    return MAV_CMD.MAV_CMD_STOP_RETURN_TO_BASE;
                case 113:
                    return MAV_CMD.MAV_CMD_TURN_LIGHT;
                case 114:
                    return MAV_CMD.MAV_CMD_GET_MID_LEVEL_COMMANDS;
                case 115:
                    return MAV_CMD.MAV_CMD_MIDLEVEL_STORAGE;
                case 116:
...
//Timestamp (microseconds since UNIX epoch or microseconds since system boot
        ...
        } static final Meta meta = new Meta(48, 0, 0, 0, 14, 104, 0, _kY);
...
//Timestamp (microseconds since UNIX epoch or microseconds since system boot
        ...
        public void time_usec_SET(long  src, Bounds.Inside ph)//Timestamp (microseconds since UNIX epoch or microseconds since system boot
        {
            ...
            set_bytes((src) & -1L, 8, data,  ph.BYTE);
        } static final Meta meta = new Meta(49, 0, 0, 0, 13, 96, 0, _AY);
    } public static class PARAM_MAP_RC extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        ...
        } public void param_id_SET(String src, Bounds.Inside ph) {param_id_SET(src.toCharArray(), 0, src.length(), ph);} public void param_id_SET(char[]  src, int pos, int items, Bounds.Inside ph)
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(50, 0, 0, 0, 22, 168, 0, _oY);
...
//WIP: Component which requested the command to be execute
        ...
        public void target_component_SET(char  src, Bounds.Inside ph)//WIP: Component which requested the command to be execute
        {
            ...
            set_bytes((char)(src) & -1L, 1, data,  ph.BYTE);
        } static final Meta meta = new Meta(77, 0, 0, 0, 3, 11, 0, _ZE, _oE, _gE, _SE);
...
//Flow rate in radians/second about Y axi
        ...
        public void flow_rate_y_SET(float  src, Bounds.Inside ph)//Flow rate in radians/second about Y axi
        {
            ...
            set_bytes(Float.floatToIntBits(src) & -1L, 4, data, ph.BYTE);
        } static final Meta meta = new Meta(100, 0, 0, 1, 27, 208, 0, _FD, _dD);
    ...
    } public static class AUTOPILOT_VERSION extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        ...
        } public void uid2_SET(char[]  src, int pos, Bounds.Inside ph)
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + 18; pos < src_max; pos++, BYTE += 1)
                set_bytes((char)(src[pos]) & -1L, 1, data,  BYTE);
        } static final Meta meta = new Meta(148, 2, 4, 1, 54, 421, 0, _ik);
...
//Quaternion of landing target orientation (w, x, y, z order, zero-rotation is 1, 0, 0, 0
        ...
        public void position_valid_SET(char  src, Bounds.Inside ph)
        {
            ...
            set_bytes((char)(src) & -1L, 1, data,  ph.BYTE);
        } static final Meta meta = new Meta(149, 0, 0, 1, 31, 239, 0, _Fk, _dk, _yk, _kk, _tk);
    } public static class CPU_LOAD extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        CPU_LOAD() { super(meta, 0); }
        CPU_LOAD(int bytes) { super(meta, bytes); }
        public char batVolt_GET()//Battery Voltage in millivolt
        {  return (char)((char) get_bytes(data,  0, 2)); }
        public void batVolt_SET(char  src) //Battery Voltage in millivolt
        {  set_bytes((char)(src) & -1L, 2, data,  0); }
        public char sensLoad_GET()//Sensor DSC Loa
        {  return (char)((char) get_bytes(data,  2, 1)); }
        public void sensLoad_SET(char  src) //Sensor DSC Loa
        {  set_bytes((char)(src) & -1L, 1, data,  2); }
        public char ctrlLoad_GET()//Control DSC Loa
        {  return (char)((char) get_bytes(data,  3, 1)); }
        public void ctrlLoad_SET(char  src) //Control DSC Loa
        {  set_bytes((char)(src) & -1L, 1, data,  3); }
        static final Meta meta = new Meta(170, 1, 0, 0, 4, 32);
    } public static class SENSOR_BIAS extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        SENSOR_BIAS() { super(meta, 0); }
        SENSOR_BIAS(int bytes) { super(meta, bytes); }
        public float axBias_GET()//Accelerometer X bias (m/s
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  0, 4))); }
        public void axBias_SET(float  src) //Accelerometer X bias (m/s
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 0); }
        public float ayBias_GET()//Accelerometer Y bias (m/s
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  4, 4))); }
        public void ayBias_SET(float  src) //Accelerometer Y bias (m/s
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 4); }
        public float azBias_GET()//Accelerometer Z bias (m/s
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  8, 4))); }
        public void azBias_SET(float  src) //Accelerometer Z bias (m/s
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 8); }
        public float gxBias_GET()//Gyro X bias (rad/s
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  12, 4))); }
        public void gxBias_SET(float  src) //Gyro X bias (rad/s
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 12); }
        public float gyBias_GET()//Gyro Y bias (rad/s
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  16, 4))); }
        public void gyBias_SET(float  src) //Gyro Y bias (rad/s
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 16); }
        public float gzBias_GET()//Gyro Z bias (rad/s
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  20, 4))); }
        public void gzBias_SET(float  src) //Gyro Z bias (rad/s
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 20); }
        static final Meta meta = new Meta(172, 0, 0, 0, 24, 192);
    } public static class DIAGNOSTIC extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        DIAGNOSTIC() { super(meta, 0); }
        DIAGNOSTIC(int bytes) { super(meta, bytes); }
        public float diagFl1_GET()//Diagnostic float
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  0, 4))); }
        public void diagFl1_SET(float  src) //Diagnostic float
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 0); }
        public float diagFl2_GET()//Diagnostic float
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  4, 4))); }
        public void diagFl2_SET(float  src) //Diagnostic float
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 4); }
        public float diagFl3_GET()//Diagnostic float
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  8, 4))); }
        public void diagFl3_SET(float  src) //Diagnostic float
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 8); }
        public short diagSh1_GET()//Diagnostic short
        {  return (short)((short) get_bytes(data,  12, 2)); }
        public void diagSh1_SET(short  src) //Diagnostic short
        {  set_bytes((short)(src) & -1L, 2, data,  12); }
        public short diagSh2_GET()//Diagnostic short
        {  return (short)((short) get_bytes(data,  14, 2)); }
        public void diagSh2_SET(short  src) //Diagnostic short
        {  set_bytes((short)(src) & -1L, 2, data,  14); }
        public short diagSh3_GET()//Diagnostic short
        {  return (short)((short) get_bytes(data,  16, 2)); }
        public void diagSh3_SET(short  src) //Diagnostic short
        {  set_bytes((short)(src) & -1L, 2, data,  16); }
        static final Meta meta = new Meta(173, 0, 0, 0, 18, 144);
    } public static class SLUGS_NAVIGATION extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        SLUGS_NAVIGATION() { super(meta, 0); }
        SLUGS_NAVIGATION(int bytes) { super(meta, bytes); }
        public char h_c_GET()//Commanded altitude in 0.1
        {  return (char)((char) get_bytes(data,  0, 2)); }
        public void h_c_SET(char  src) //Commanded altitude in 0.1
        {  set_bytes((char)(src) & -1L, 2, data,  0); }
        public float u_m_GET()//Measured Airspeed prior to the nav filter in m/
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  2, 4))); }
        public void u_m_SET(float  src) //Measured Airspeed prior to the nav filter in m/
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 2); }
        public float phi_c_GET()//Commanded Rol
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  6, 4))); }
        public void phi_c_SET(float  src) //Commanded Rol
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 6); }
        public float theta_c_GET()//Commanded Pitc
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  10, 4))); }
        public void theta_c_SET(float  src) //Commanded Pitc
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 10); }
        public float psiDot_c_GET()//Commanded Turn rat
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  14, 4))); }
        public void psiDot_c_SET(float  src) //Commanded Turn rat
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 14); }
        public float ay_body_GET()//Y component of the body acceleratio
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  18, 4))); }
        public void ay_body_SET(float  src) //Y component of the body acceleratio
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 18); }
        public float totalDist_GET()//Total Distance to Run on this leg of Navigatio
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  22, 4))); }
        public void totalDist_SET(float  src) //Total Distance to Run on this leg of Navigatio
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 22); }
        public float dist2Go_GET()//Remaining distance to Run on this leg of Navigatio
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  26, 4))); }
        public void dist2Go_SET(float  src) //Remaining distance to Run on this leg of Navigatio
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 26); }
        public char fromWP_GET()//Origin W
        {  return (char)((char) get_bytes(data,  30, 1)); }
        public void fromWP_SET(char  src) //Origin W
        {  set_bytes((char)(src) & -1L, 1, data,  30); }
        public char toWP_GET()//Destination W
        {  return (char)((char) get_bytes(data,  31, 1)); }
        public void toWP_SET(char  src) //Destination W
        {  set_bytes((char)(src) & -1L, 1, data,  31); }
        static final Meta meta = new Meta(176, 1, 0, 0, 32, 256);
    } public static class DATA_LOG extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        DATA_LOG() { super(meta, 0); }
        DATA_LOG(int bytes) { super(meta, bytes); }
        public float fl_1_GET()//Log value 1
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  0, 4))); }
        public void fl_1_SET(float  src) //Log value 1
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 0); }
        public float fl_2_GET()//Log value 2
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  4, 4))); }
        public void fl_2_SET(float  src) //Log value 2
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 4); }
        public float fl_3_GET()//Log value 3
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  8, 4))); }
        public void fl_3_SET(float  src) //Log value 3
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 8); }
        public float fl_4_GET()//Log value 4
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  12, 4))); }
        public void fl_4_SET(float  src) //Log value 4
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 12); }
        public float fl_5_GET()//Log value 5
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  16, 4))); }
        public void fl_5_SET(float  src) //Log value 5
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 16); }
        public float fl_6_GET()//Log value 6
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  20, 4))); }
        public void fl_6_SET(float  src) //Log value 6
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 20); }
        static final Meta meta = new Meta(177, 0, 0, 0, 24, 192);
    } public static class GPS_DATE_TIME extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        GPS_DATE_TIME() { super(meta, 0); }
        GPS_DATE_TIME(int bytes) { super(meta, bytes); }
        public char year_GET()//Year reported by Gps
        {  return (char)((char) get_bytes(data,  0, 1)); }
        public void year_SET(char  src) //Year reported by Gps
        {  set_bytes((char)(src) & -1L, 1, data,  0); }
        public char month_GET()//Month reported by Gps
        {  return (char)((char) get_bytes(data,  1, 1)); }
        public void month_SET(char  src) //Month reported by Gps
        {  set_bytes((char)(src) & -1L, 1, data,  1); }
        public char day_GET()//Day reported by Gps
        {  return (char)((char) get_bytes(data,  2, 1)); }
        public void day_SET(char  src) //Day reported by Gps
        {  set_bytes((char)(src) & -1L, 1, data,  2); }
        public char hour_GET()//Hour reported by Gps
        {  return (char)((char) get_bytes(data,  3, 1)); }
        public void hour_SET(char  src) //Hour reported by Gps
        {  set_bytes((char)(src) & -1L, 1, data,  3); }
        public char min_GET()//Min reported by Gps
        {  return (char)((char) get_bytes(data,  4, 1)); }
        public void min_SET(char  src) //Min reported by Gps
        {  set_bytes((char)(src) & -1L, 1, data,  4); }
        public char sec_GET()//Sec reported by Gps
        {  return (char)((char) get_bytes(data,  5, 1)); }
        public void sec_SET(char  src) //Sec reported by Gps
        {  set_bytes((char)(src) & -1L, 1, data,  5); }
        public char clockStat_GET()//Clock Status. See table 47 page 211 OEMStar Manual
        {  return (char)((char) get_bytes(data,  6, 1)); }
        public void clockStat_SET(char  src) //Clock Status. See table 47 page 211 OEMStar Manual
        {  set_bytes((char)(src) & -1L, 1, data,  6); }
        public char visSat_GET()//Visible satellites reported by Gps
        {  return (char)((char) get_bytes(data,  7, 1)); }
        public void visSat_SET(char  src) //Visible satellites reported by Gps
        {  set_bytes((char)(src) & -1L, 1, data,  7); }
        public char useSat_GET()//Used satellites in Solution
        {  return (char)((char) get_bytes(data,  8, 1)); }
        public void useSat_SET(char  src) //Used satellites in Solution
        {  set_bytes((char)(src) & -1L, 1, data,  8); }
        public char GppGl_GET()//GPS+GLONASS satellites in Solution
        {  return (char)((char) get_bytes(data,  9, 1)); }
        public void GppGl_SET(char  src) //GPS+GLONASS satellites in Solution
        {  set_bytes((char)(src) & -1L, 1, data,  9); }
        public char sigUsedMask_GET()//GPS and GLONASS usage mask (bit 0 GPS_used? bit_4 GLONASS_used?
        {  return (char)((char) get_bytes(data,  10, 1)); }
        public void sigUsedMask_SET(char  src) //GPS and GLONASS usage mask (bit 0 GPS_used? bit_4 GLONASS_used?
        {  set_bytes((char)(src) & -1L, 1, data,  10); }
        public char percentUsed_GET()//Percent used GP
        {  return (char)((char) get_bytes(data,  11, 1)); }
        public void percentUsed_SET(char  src) //Percent used GP
        {  set_bytes((char)(src) & -1L, 1, data,  11); }
        static final Meta meta = new Meta(179, 0, 0, 0, 12, 96);
    } public static class MID_LVL_CMDS extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        MID_LVL_CMDS() { super(meta, 0); }
        MID_LVL_CMDS(int bytes) { super(meta, bytes); }
        public char target_GET()//The system setting the command
        {  return (char)((char) get_bytes(data,  0, 1)); }
        public void target_SET(char  src) //The system setting the command
        {  set_bytes((char)(src) & -1L, 1, data,  0); }
        public float hCommand_GET()//Commanded Altitude in meter
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  1, 4))); }
        public void hCommand_SET(float  src) //Commanded Altitude in meter
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 1); }
        public float uCommand_GET()//Commanded Airspeed in m/
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  5, 4))); }
        public void uCommand_SET(float  src) //Commanded Airspeed in m/
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 5); }
        public float rCommand_GET()//Commanded Turnrate in rad/
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  9, 4))); }
        public void rCommand_SET(float  src) //Commanded Turnrate in rad/
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 9); }
        static final Meta meta = new Meta(180, 0, 0, 0, 13, 104);
    } public static class CTRL_SRFC_PT extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        CTRL_SRFC_PT() { super(meta, 0); }
        CTRL_SRFC_PT(int bytes) { super(meta, bytes); }
        public char bitfieldPt_GET()//Bitfield containing the passthrough configuration, see CONTROL_SURFACE_FLAG ENUM
        {  return (char)((char) get_bytes(data,  0, 2)); }
        public void bitfieldPt_SET(char  src) //Bitfield containing the passthrough configuration, see CONTROL_SURFACE_FLAG ENUM
        {  set_bytes((char)(src) & -1L, 2, data,  0); }
        public char target_GET()//The system setting the command
        {  return (char)((char) get_bytes(data,  2, 1)); }
        public void target_SET(char  src) //The system setting the command
        {  set_bytes((char)(src) & -1L, 1, data,  2); }
        static final Meta meta = new Meta(181, 1, 0, 0, 3, 24);
    } public static class SLUGS_CAMERA_ORDER extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        SLUGS_CAMERA_ORDER() { super(meta, 0); }
        SLUGS_CAMERA_ORDER(int bytes) { super(meta, bytes); }
        public char target_GET()//The system reporting the actio
        {  return (char)((char) get_bytes(data,  0, 1)); }
        public void target_SET(char  src) //The system reporting the actio
        {  set_bytes((char)(src) & -1L, 1, data,  0); }
        public byte pan_GET()//Order the mount to pan: -1 left, 0 No pan motion, +1 righ
        {  return (byte)((byte) get_bytes(data,  1, 1)); }
        public void pan_SET(byte  src) //Order the mount to pan: -1 left, 0 No pan motion, +1 righ
        {  set_bytes((byte)(src) & -1L, 1, data,  1); }
        public byte tilt_GET()//Order the mount to tilt: -1 down, 0 No tilt motion, +1 u
        {  return (byte)((byte) get_bytes(data,  2, 1)); }
        public void tilt_SET(byte  src) //Order the mount to tilt: -1 down, 0 No tilt motion, +1 u
        {  set_bytes((byte)(src) & -1L, 1, data,  2); }
        public byte zoom_GET()//Order the zoom values 0 to 1
        {  return (byte)((byte) get_bytes(data,  3, 1)); }
        public void zoom_SET(byte  src) //Order the zoom values 0 to 1
        {  set_bytes((byte)(src) & -1L, 1, data,  3); }
        public byte moveHome_GET() {  return (byte)((byte) get_bytes(data,  4, 1)); }
        public void moveHome_SET(byte  src) {  set_bytes((byte)(src) & -1L, 1, data,  4); }
        static final Meta meta = new Meta(184, 0, 0, 0, 5, 40);
    } public static class CONTROL_SURFACE extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        CONTROL_SURFACE() { super(meta, 0); }
        CONTROL_SURFACE(int bytes) { super(meta, bytes); }
        public char target_GET()//The system setting the command
        {  return (char)((char) get_bytes(data,  0, 1)); }
        public void target_SET(char  src) //The system setting the command
        {  set_bytes((char)(src) & -1L, 1, data,  0); }
        public char idSurface_GET()//ID control surface send 0: throttle 1: aileron 2: elevator 3: rudde
        {  return (char)((char) get_bytes(data,  1, 1)); }
        public void idSurface_SET(char  src) //ID control surface send 0: throttle 1: aileron 2: elevator 3: rudde
        {  set_bytes((char)(src) & -1L, 1, data,  1); }
        public float mControl_GET()//Pendin
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  2, 4))); }
        public void mControl_SET(float  src) //Pendin
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 2); }
        public float bControl_GET()//Order to origi
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  6, 4))); }
        public void bControl_SET(float  src) //Order to origi
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 6); }
        static final Meta meta = new Meta(185, 0, 0, 0, 10, 80);
    } public static class SLUGS_MOBILE_LOCATION extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        SLUGS_MOBILE_LOCATION() { super(meta, 0); }
        SLUGS_MOBILE_LOCATION(int bytes) { super(meta, bytes); }
        public char target_GET()//The system reporting the actio
        {  return (char)((char) get_bytes(data,  0, 1)); }
        public void target_SET(char  src) //The system reporting the actio
        {  set_bytes((char)(src) & -1L, 1, data,  0); }
        public float latitude_GET()//Mobile Latitud
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  1, 4))); }
        public void latitude_SET(float  src) //Mobile Latitud
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 1); }
        public float longitude_GET()//Mobile Longitud
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  5, 4))); }
        public void longitude_SET(float  src) //Mobile Longitud
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 5); }
        static final Meta meta = new Meta(186, 0, 0, 0, 9, 72);
    } public static class SLUGS_CONFIGURATION_CAMERA extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        SLUGS_CONFIGURATION_CAMERA() { super(meta, 0); }
        SLUGS_CONFIGURATION_CAMERA(int bytes) { super(meta, bytes); }
        public char target_GET()//The system setting the command
        {  return (char)((char) get_bytes(data,  0, 1)); }
        public void target_SET(char  src) //The system setting the command
        {  set_bytes((char)(src) & -1L, 1, data,  0); }
        public char idOrder_GET()//ID 0: brightness 1: aperture 2: iris 3: ICR 4: backligh
        {  return (char)((char) get_bytes(data,  1, 1)); }
        public void idOrder_SET(char  src) //ID 0: brightness 1: aperture 2: iris 3: ICR 4: backligh
        {  set_bytes((char)(src) & -1L, 1, data,  1); }
        public char order_GET()//1: up/on 2: down/off 3: auto/reset/no actio
        {  return (char)((char) get_bytes(data,  2, 1)); }
        public void order_SET(char  src) //1: up/on 2: down/off 3: auto/reset/no actio
        {  set_bytes((char)(src) & -1L, 1, data,  2); }
        static final Meta meta = new Meta(188, 0, 0, 0, 3, 24);
    } public static class ISR_LOCATION extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        ISR_LOCATION() { super(meta, 0); }
        ISR_LOCATION(int bytes) { super(meta, bytes); }
        public char target_GET()//The system reporting the actio
        {  return (char)((char) get_bytes(data,  0, 1)); }
        public void target_SET(char  src) //The system reporting the actio
        {  set_bytes((char)(src) & -1L, 1, data,  0); }
        public float latitude_GET()//ISR Latitud
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  1, 4))); }
        public void latitude_SET(float  src) //ISR Latitud
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 1); }
        public float longitude_GET()//ISR Longitud
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  5, 4))); }
        public void longitude_SET(float  src) //ISR Longitud
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 5); }
        public float height_GET()//ISR Heigh
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  9, 4))); }
        public void height_SET(float  src) //ISR Heigh
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 9); }
        public char option1_GET()//Option
        {  return (char)((char) get_bytes(data,  13, 1)); }
        public void option1_SET(char  src) //Option
        {  set_bytes((char)(src) & -1L, 1, data,  13); }
        public char option2_GET()//Option
        {  return (char)((char) get_bytes(data,  14, 1)); }
        public void option2_SET(char  src) //Option
        {  set_bytes((char)(src) & -1L, 1, data,  14); }
        public char option3_GET()//Option
        {  return (char)((char) get_bytes(data,  15, 1)); }
        public void option3_SET(char  src) //Option
        {  set_bytes((char)(src) & -1L, 1, data,  15); }
        static final Meta meta = new Meta(189, 0, 0, 0, 16, 128);
    } public static class VOLT_SENSOR extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        VOLT_SENSOR() { super(meta, 0); }
        VOLT_SENSOR(int bytes) { super(meta, bytes); }
        public char voltage_GET()//Voltage in uS of PWM. 0 uS = 0V, 20 uS = 21.5V
        {  return (char)((char) get_bytes(data,  0, 2)); }
        public void voltage_SET(char  src) //Voltage in uS of PWM. 0 uS = 0V, 20 uS = 21.5V
        {  set_bytes((char)(src) & -1L, 2, data,  0); }
        public char reading2_GET() {  return (char)((char) get_bytes(data,  2, 2)); }
        public void reading2_SET(char  src) {  set_bytes((char)(src) & -1L, 2, data,  2); }
        public char r2Type_GET()//It is the value of reading 2: 0 - Current, 1 - Foreward Sonar, 2 - Back Sonar, 3 - RP
        {  return (char)((char) get_bytes(data,  4, 1)); }
        public void r2Type_SET(char  src) //It is the value of reading 2: 0 - Current, 1 - Foreward Sonar, 2 - Back Sonar, 3 - RP
        {  set_bytes((char)(src) & -1L, 1, data,  4); }
        static final Meta meta = new Meta(191, 2, 0, 0, 5, 40);
    } public static class PTZ_STATUS extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        PTZ_STATUS() { super(meta, 0); }
        PTZ_STATUS(int bytes) { super(meta, bytes); }
        public char zoom_GET()//The actual Zoom Valu
        {  return (char)((char) get_bytes(data,  0, 1)); }
        public void zoom_SET(char  src) //The actual Zoom Valu
        {  set_bytes((char)(src) & -1L, 1, data,  0); }
        public short pan_GET()//The Pan value in 10ths of degre
        {  return (short)((short) get_bytes(data,  1, 2)); }
        public void pan_SET(short  src) //The Pan value in 10ths of degre
        {  set_bytes((short)(src) & -1L, 2, data,  1); }
        public short tilt_GET()//The Tilt value in 10ths of degre
        {  return (short)((short) get_bytes(data,  3, 2)); }
        public void tilt_SET(short  src) //The Tilt value in 10ths of degre
        {  set_bytes((short)(src) & -1L, 2, data,  3); }
        static final Meta meta = new Meta(192, 0, 0, 0, 5, 40);
    } public static class UAV_STATUS extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        UAV_STATUS() { super(meta, 0); }
        UAV_STATUS(int bytes) { super(meta, bytes); }
        public char target_GET()//The ID system reporting the actio
        {  return (char)((char) get_bytes(data,  0, 1)); }
        public void target_SET(char  src) //The ID system reporting the actio
        {  set_bytes((char)(src) & -1L, 1, data,  0); }
        public float latitude_GET()//Latitude UA
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  1, 4))); }
        public void latitude_SET(float  src) //Latitude UA
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 1); }
        public float longitude_GET()//Longitude UA
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  5, 4))); }
        public void longitude_SET(float  src) //Longitude UA
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 5); }
        public float altitude_GET()//Altitude UA
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  9, 4))); }
        public void altitude_SET(float  src) //Altitude UA
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 9); }
        public float speed_GET()//Speed UA
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  13, 4))); }
        public void speed_SET(float  src) //Speed UA
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 13); }
        public float course_GET()//Course UA
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  17, 4))); }
        public void course_SET(float  src) //Course UA
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 17); }
        static final Meta meta = new Meta(193, 0, 0, 0, 21, 168);
    } public static class STATUS_GPS extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        STATUS_GPS() { super(meta, 0); }
        STATUS_GPS(int bytes) { super(meta, bytes); }
        public char csFails_GET()//Number of times checksum has faile
        {  return (char)((char) get_bytes(data,  0, 2)); }
        public void csFails_SET(char  src) //Number of times checksum has faile
        {  set_bytes((char)(src) & -1L, 2, data,  0); }
        public char gpsQuality_GET() {  return (char)((char) get_bytes(data,  2, 1)); }
        public void gpsQuality_SET(char  src) {  set_bytes((char)(src) & -1L, 1, data,  2); }
        public char msgsType_GET()//Indicates if GN, GL or GP messages are being receive
        {  return (char)((char) get_bytes(data,  3, 1)); }
        public void msgsType_SET(char  src) //Indicates if GN, GL or GP messages are being receive
        {  set_bytes((char)(src) & -1L, 1, data,  3); }
        public char posStatus_GET()//A = data valid, V = data invali
        {  return (char)((char) get_bytes(data,  4, 1)); }
        public void posStatus_SET(char  src) //A = data valid, V = data invali
        {  set_bytes((char)(src) & -1L, 1, data,  4); }
        public float magVar_GET()//Magnetic variation, degrees
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  5, 4))); }
        public void magVar_SET(float  src) //Magnetic variation, degrees
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 5); }
        public byte magDir_GET() {  return (byte)((byte) get_bytes(data,  9, 1)); }
        public void magDir_SET(byte  src) {  set_bytes((byte)(src) & -1L, 1, data,  9); }
        public char modeInd_GET() {  return (char)((char) get_bytes(data,  10, 1)); }
        public void modeInd_SET(char  src) {  set_bytes((char)(src) & -1L, 1, data,  10); }
        static final Meta meta = new Meta(194, 1, 0, 0, 11, 88);
    } public static class NOVATEL_DIAG extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        NOVATEL_DIAG() { super(meta, 0); }
        NOVATEL_DIAG(int bytes) { super(meta, bytes); }
        public char csFails_GET()//Times the CRC has failed since boo
        {  return (char)((char) get_bytes(data,  0, 2)); }
        public void csFails_SET(char  src) //Times the CRC has failed since boo
        {  set_bytes((char)(src) & -1L, 2, data,  0); }
        public long receiverStatus_GET()//Status Bitfield. See table 69 page 350 Novatel OEMstar Manua
        {  return (get_bytes(data,  2, 4)); }
        public void receiverStatus_SET(long  src) //Status Bitfield. See table 69 page 350 Novatel OEMstar Manua
        {  set_bytes((src) & -1L, 4, data,  2); }
        public char timeStatus_GET()//The Time Status. See Table 8 page 27 Novatel OEMStar Manua
        {  return (char)((char) get_bytes(data,  6, 1)); }
        public void timeStatus_SET(char  src) //The Time Status. See Table 8 page 27 Novatel OEMStar Manua
        {  set_bytes((char)(src) & -1L, 1, data,  6); }
        public char solStatus_GET()//solution Status. See table 44 page 19
        {  return (char)((char) get_bytes(data,  7, 1)); }
        public void solStatus_SET(char  src) //solution Status. See table 44 page 19
        {  set_bytes((char)(src) & -1L, 1, data,  7); }
        public char posType_GET()//position type. See table 43 page 19
        {  return (char)((char) get_bytes(data,  8, 1)); }
        public void posType_SET(char  src) //position type. See table 43 page 19
        {  set_bytes((char)(src) & -1L, 1, data,  8); }
        public char velType_GET()//velocity type. See table 43 page 19
        {  return (char)((char) get_bytes(data,  9, 1)); }
        public void velType_SET(char  src) //velocity type. See table 43 page 19
        {  set_bytes((char)(src) & -1L, 1, data,  9); }
        public float posSolAge_GET()//Age of the position solution in second
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  10, 4))); }
        public void posSolAge_SET(float  src) //Age of the position solution in second
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 10); }
        static final Meta meta = new Meta(195, 1, 1, 0, 14, 112);
    } public static class SENSOR_DIAG extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        SENSOR_DIAG() { super(meta, 0); }
        SENSOR_DIAG(int bytes) { super(meta, bytes); }
        public float float1_GET()//Float field
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  0, 4))); }
        public void float1_SET(float  src) //Float field
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 0); }
        public float float2_GET()//Float field
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  4, 4))); }
        public void float2_SET(float  src) //Float field
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 4); }
        public short int1_GET()//Int 16 field
        {  return (short)((short) get_bytes(data,  8, 2)); }
        public void int1_SET(short  src) //Int 16 field
        {  set_bytes((short)(src) & -1L, 2, data,  8); }
        public byte char1_GET()//Int 8 field
        {  return (byte)((byte) get_bytes(data,  10, 1)); }
        public void char1_SET(byte  src) //Int 8 field
        {  set_bytes((byte)(src) & -1L, 1, data,  10); }
        static final Meta meta = new Meta(196, 0, 0, 0, 11, 88);
    } public static class BOOT extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        BOOT() { super(meta, 0); }
        BOOT(int bytes) { super(meta, bytes); }
        public long version_GET()//The onboard software versio
        {  return (get_bytes(data,  0, 4)); }
        public void version_SET(long  src) //The onboard software versio
        {  set_bytes((src) & -1L, 4, data,  0); }
        static final Meta meta = new Meta(197, 0, 1, 0, 4, 32);
...
//Timestamp (microseconds since UNIX epoch or microseconds since system boot
        ...
        public void time_usec_SET(long  src, Bounds.Inside ph)//Timestamp (microseconds since UNIX epoch or microseconds since system boot
        {
            ...
            set_bytes((src) & -1L, 8, data,  ph.BYTE);
        } static final Meta meta = new Meta(242, 0, 0, 0, 53, 416, 0, _VJ);
...
//Timestamp (microseconds since UNIX epoch or microseconds since system boot
        ...
        public void time_usec_SET(long  src, Bounds.Inside ph)//Timestamp (microseconds since UNIX epoch or microseconds since system boot
        {
            ...
            set_bytes((src) & -1L, 8, data,  ph.BYTE);
        } static final Meta meta = new Meta(243, 0, 0, 0, 54, 424, 0, _xt);
...
//The callsign, 8+nul
        ...
        {callsign_SET(src.toCharArray(), 0, src.length(), ph);} public void callsign_SET(char[]  src, int pos, int items, Bounds.Inside ph) //The callsign, 8+nul
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(246, 3, 1, 0, 28, 210, 0, _Nt);
...
//Nam
        ...
        {name_SET(src.toCharArray(), 0, src.length(), ph);} public void name_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Nam
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(250, 0, 0, 1, 21, 160, 0, _vt);
...
//Name of the debug variabl
        ...
        {name_SET(src.toCharArray(), 0, src.length(), ph);} public void name_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Name of the debug variabl
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(251, 0, 1, 0, 9, 64, 0, _Vt);
...
//Name of the debug variabl
        ...
        {name_SET(src.toCharArray(), 0, src.length(), ph);} public void name_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Name of the debug variabl
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(252, 0, 1, 0, 9, 64, 0, _XK);
...
//Status text message, without null termination characte
        ...
        {text_SET(src.toCharArray(), 0, src.length(), ph);} public void text_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Status text message, without null termination characte
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(253, 0, 0, 0, 2, 4, 0, _zK);
...
//tune in board specific forma
        ...
        {tune_SET(src.toCharArray(), 0, src.length(), ph);} public void tune_SET(char[]  src, int pos, int items, Bounds.Inside ph) //tune in board specific forma
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(258, 0, 0, 0, 3, 16, 0, _yK);
...
//Camera definition URI (if any, otherwise only basic functions will be available)
        ...
        {cam_definition_uri_SET(src.toCharArray(), 0, src.length(), ph);} public void cam_definition_uri_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Camera definition URI (if any, otherwise only basic functions will be available)
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(259, 3, 2, 0, 93, 731, 0, _PK);
...
//foo.jpg if camera provides an HTTP interface
        ...
        {file_url_SET(src.toCharArray(), 0, src.length(), ph);} public void file_url_SET(char[]  src, int pos, int items, Bounds.Inside ph) //foo.jpg if camera provides an HTTP interface
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(263, 0, 1, 1, 51, 402, 2, _iA);
...
//Video stream UR
        ...
        {uri_SET(src.toCharArray(), 0, src.length(), ph);} public void uri_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Video stream UR
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(269, 3, 1, 0, 17, 130, 2, _LA);
...
//Video stream UR
        ...
        {uri_SET(src.toCharArray(), 0, src.length(), ph);} public void uri_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Video stream UR
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(270, 3, 1, 0, 18, 138, 2, _OA);
...
//Password. Leave it blank for an open AP
        ...
        {password_SET(src.toCharArray(), 0, src.length(), ph);} public void password_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Password. Leave it blank for an open AP
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(299, 0, 0, 0, 1, 2, 2, _rA, _TA);
...
//Node name string. For example, "sapog.px4.io"
        ...
        {name_SET(src.toCharArray(), 0, src.length(), ph);} public void name_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Node name string. For example, "sapog.px4.io"
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(311, 0, 2, 1, 37, 288, 0, _xN);
    } public static class PARAM_EXT_REQUEST_READ extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        ...
        } public void param_id_SET(String src, Bounds.Inside ph) {param_id_SET(src.toCharArray(), 0, src.length(), ph);} public void param_id_SET(char[]  src, int pos, int items, Bounds.Inside ph)
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(320, 0, 0, 0, 5, 32, 0, _JN);
...
//Parameter valu
        ...
        {param_value_SET(src.toCharArray(), 0, src.length(), ph);} public void param_value_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Parameter valu
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(322, 2, 0, 0, 5, 38, 2, _NN, _ZN);
...
//Parameter valu
        ...
        {param_value_SET(src.toCharArray(), 0, src.length(), ph);} public void param_value_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Parameter valu
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(323, 0, 0, 0, 3, 22, 2, _PN, _GN);
...
//Parameter value (new value if PARAM_ACK_ACCEPTED, current value otherwise
        ...
        {param_value_SET(src.toCharArray(), 0, src.length(), ph);} public void param_value_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Parameter value (new value if PARAM_ACK_ACCEPTED, current value otherwise
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(324, 0, 0, 0, 2, 9, 2, _aN, _WN);
    ...
    public static class LoopBackDemoChannel  extends Channel
    {
        ...
        public static CPU_LOAD new_CPU_LOAD() {return new  CPU_LOAD();}
        public static SENSOR_BIAS new_SENSOR_BIAS() {return new  SENSOR_BIAS();}
        public static DIAGNOSTIC new_DIAGNOSTIC() {return new  DIAGNOSTIC();}
        public static SLUGS_NAVIGATION new_SLUGS_NAVIGATION() {return new  SLUGS_NAVIGATION();}
        public static DATA_LOG new_DATA_LOG() {return new  DATA_LOG();}
        public static GPS_DATE_TIME new_GPS_DATE_TIME() {return new  GPS_DATE_TIME();}
        public static MID_LVL_CMDS new_MID_LVL_CMDS() {return new  MID_LVL_CMDS();}
        public static CTRL_SRFC_PT new_CTRL_SRFC_PT() {return new  CTRL_SRFC_PT();}
        public static SLUGS_CAMERA_ORDER new_SLUGS_CAMERA_ORDER() {return new  SLUGS_CAMERA_ORDER();}
        public static CONTROL_SURFACE new_CONTROL_SURFACE() {return new  CONTROL_SURFACE();}
        public static SLUGS_MOBILE_LOCATION new_SLUGS_MOBILE_LOCATION() {return new  SLUGS_MOBILE_LOCATION();}
        public static SLUGS_CONFIGURATION_CAMERA new_SLUGS_CONFIGURATION_CAMERA() {return new  SLUGS_CONFIGURATION_CAMERA();}
        public static ISR_LOCATION new_ISR_LOCATION() {return new  ISR_LOCATION();}
        public static VOLT_SENSOR new_VOLT_SENSOR() {return new  VOLT_SENSOR();}
        public static PTZ_STATUS new_PTZ_STATUS() {return new  PTZ_STATUS();}
        public static UAV_STATUS new_UAV_STATUS() {return new  UAV_STATUS();}
        public static STATUS_GPS new_STATUS_GPS() {return new  STATUS_GPS();}
        public static NOVATEL_DIAG new_NOVATEL_DIAG() {return new  NOVATEL_DIAG();}
        public static SENSOR_DIAG new_SENSOR_DIAG() {return new  SENSOR_DIAG();}
        public static BOOT new_BOOT() {return new  BOOT();}
            ...
            for(boolean LOOP = false; ;)
            {
                switch(id)
                {
                    ...
                    case 170:
                        ...
                        final CPU_LOAD pi170 = (CPU_LOAD) pack;
                        ph.setPack(pi170);
                        on_CPU_LOAD.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi170));
                        if(LOOP) break;
                        return null;
                    case 172:
                        if(pack == null) return new SENSOR_BIAS();
                        final SENSOR_BIAS pi172 = (SENSOR_BIAS) pack;
                        ph.setPack(pi172);
                        on_SENSOR_BIAS.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi172));
                        if(LOOP) break;
                        return null;
                    case 173:
                        if(pack == null) return new DIAGNOSTIC();
                        final DIAGNOSTIC pi173 = (DIAGNOSTIC) pack;
                        ph.setPack(pi173);
                        on_DIAGNOSTIC.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi173));
                        if(LOOP) break;
                        return null;
                    case 176:
                        if(pack == null) return new SLUGS_NAVIGATION();
                        final SLUGS_NAVIGATION pi176 = (SLUGS_NAVIGATION) pack;
                        ph.setPack(pi176);
                        on_SLUGS_NAVIGATION.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi176));
                        if(LOOP) break;
                        return null;
                    case 177:
                        if(pack == null) return new DATA_LOG();
                        final DATA_LOG pi177 = (DATA_LOG) pack;
                        ph.setPack(pi177);
                        on_DATA_LOG.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi177));
                        if(LOOP) break;
                        return null;
                    case 179:
                        if(pack == null) return new GPS_DATE_TIME();
                        final GPS_DATE_TIME pi179 = (GPS_DATE_TIME) pack;
                        ph.setPack(pi179);
                        on_GPS_DATE_TIME.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi179));
                        if(LOOP) break;
                        return null;
                    case 180:
                        if(pack == null) return new MID_LVL_CMDS();
                        final MID_LVL_CMDS pi180 = (MID_LVL_CMDS) pack;
                        ph.setPack(pi180);
                        on_MID_LVL_CMDS.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi180));
                        if(LOOP) break;
                        return null;
                    case 181:
                        if(pack == null) return new CTRL_SRFC_PT();
                        final CTRL_SRFC_PT pi181 = (CTRL_SRFC_PT) pack;
                        ph.setPack(pi181);
                        on_CTRL_SRFC_PT.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi181));
                        if(LOOP) break;
                        return null;
                    case 184:
                        if(pack == null) return new SLUGS_CAMERA_ORDER();
                        final SLUGS_CAMERA_ORDER pi184 = (SLUGS_CAMERA_ORDER) pack;
                        ph.setPack(pi184);
                        on_SLUGS_CAMERA_ORDER.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi184));
                        if(LOOP) break;
                        return null;
                    case 185:
                        if(pack == null) return new CONTROL_SURFACE();
                        final CONTROL_SURFACE pi185 = (CONTROL_SURFACE) pack;
                        ph.setPack(pi185);
                        on_CONTROL_SURFACE.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi185));
                        if(LOOP) break;
                        return null;
                    case 186:
                        if(pack == null) return new SLUGS_MOBILE_LOCATION();
                        final SLUGS_MOBILE_LOCATION pi186 = (SLUGS_MOBILE_LOCATION) pack;
                        ph.setPack(pi186);
                        on_SLUGS_MOBILE_LOCATION.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi186));
                        if(LOOP) break;
                        return null;
                    case 188:
                        if(pack == null) return new SLUGS_CONFIGURATION_CAMERA();
                        final SLUGS_CONFIGURATION_CAMERA pi188 = (SLUGS_CONFIGURATION_CAMERA) pack;
                        ph.setPack(pi188);
                        on_SLUGS_CONFIGURATION_CAMERA.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi188));
                        if(LOOP) break;
                        return null;
                    case 189:
                        if(pack == null) return new ISR_LOCATION();
                        final ISR_LOCATION pi189 = (ISR_LOCATION) pack;
                        ph.setPack(pi189);
                        on_ISR_LOCATION.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi189));
                        if(LOOP) break;
                        return null;
                    case 191:
                        if(pack == null) return new VOLT_SENSOR();
                        final VOLT_SENSOR pi191 = (VOLT_SENSOR) pack;
                        ph.setPack(pi191);
                        on_VOLT_SENSOR.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi191));
                        if(LOOP) break;
                        return null;
                    case 192:
                        if(pack == null) return new PTZ_STATUS();
                        final PTZ_STATUS pi192 = (PTZ_STATUS) pack;
                        ph.setPack(pi192);
                        on_PTZ_STATUS.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi192));
                        if(LOOP) break;
                        return null;
                    case 193:
                        if(pack == null) return new UAV_STATUS();
                        final UAV_STATUS pi193 = (UAV_STATUS) pack;
                        ph.setPack(pi193);
                        on_UAV_STATUS.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi193));
                        if(LOOP) break;
                        return null;
                    case 194:
                        if(pack == null) return new STATUS_GPS();
                        final STATUS_GPS pi194 = (STATUS_GPS) pack;
                        ph.setPack(pi194);
                        on_STATUS_GPS.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi194));
                        if(LOOP) break;
                        return null;
                    case 195:
                        if(pack == null) return new NOVATEL_DIAG();
                        final NOVATEL_DIAG pi195 = (NOVATEL_DIAG) pack;
                        ph.setPack(pi195);
                        on_NOVATEL_DIAG.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi195));
                        if(LOOP) break;
                        return null;
                    case 196:
                        if(pack == null) return new SENSOR_DIAG();
                        final SENSOR_DIAG pi196 = (SENSOR_DIAG) pack;
                        ph.setPack(pi196);
                        on_SENSOR_DIAG.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi196));
                        if(LOOP) break;
                        return null;
                    case 197:
                        if(pack == null) return new BOOT();
                        final BOOT pi197 = (BOOT) pack;
                        ph.setPack(pi197);
                        on_BOOT.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi197));
                        if(LOOP) break;
                        return null;
                    case 230:
        ...
        public final Collection<OnReceive.Handler<CPU_LOAD, LoopBackDemoChannel>> on_CPU_LOAD = new OnReceive<>();
        public final Collection<OnReceive.Handler<SENSOR_BIAS, LoopBackDemoChannel>> on_SENSOR_BIAS = new OnReceive<>();
        public final Collection<OnReceive.Handler<DIAGNOSTIC, LoopBackDemoChannel>> on_DIAGNOSTIC = new OnReceive<>();
        public final Collection<OnReceive.Handler<SLUGS_NAVIGATION, LoopBackDemoChannel>> on_SLUGS_NAVIGATION = new OnReceive<>();
        public final Collection<OnReceive.Handler<DATA_LOG, LoopBackDemoChannel>> on_DATA_LOG = new OnReceive<>();
        public final Collection<OnReceive.Handler<GPS_DATE_TIME, LoopBackDemoChannel>> on_GPS_DATE_TIME = new OnReceive<>();
        public final Collection<OnReceive.Handler<MID_LVL_CMDS, LoopBackDemoChannel>> on_MID_LVL_CMDS = new OnReceive<>();
        public final Collection<OnReceive.Handler<CTRL_SRFC_PT, LoopBackDemoChannel>> on_CTRL_SRFC_PT = new OnReceive<>();
        public final Collection<OnReceive.Handler<SLUGS_CAMERA_ORDER, LoopBackDemoChannel>> on_SLUGS_CAMERA_ORDER = new OnReceive<>();
        public final Collection<OnReceive.Handler<CONTROL_SURFACE, LoopBackDemoChannel>> on_CONTROL_SURFACE = new OnReceive<>();
        public final Collection<OnReceive.Handler<SLUGS_MOBILE_LOCATION, LoopBackDemoChannel>> on_SLUGS_MOBILE_LOCATION = new OnReceive<>();
        public final Collection<OnReceive.Handler<SLUGS_CONFIGURATION_CAMERA, LoopBackDemoChannel>> on_SLUGS_CONFIGURATION_CAMERA = new OnReceive<>();
        public final Collection<OnReceive.Handler<ISR_LOCATION, LoopBackDemoChannel>> on_ISR_LOCATION = new OnReceive<>();
        public final Collection<OnReceive.Handler<VOLT_SENSOR, LoopBackDemoChannel>> on_VOLT_SENSOR = new OnReceive<>();
        public final Collection<OnReceive.Handler<PTZ_STATUS, LoopBackDemoChannel>> on_PTZ_STATUS = new OnReceive<>();
        public final Collection<OnReceive.Handler<UAV_STATUS, LoopBackDemoChannel>> on_UAV_STATUS = new OnReceive<>();
        public final Collection<OnReceive.Handler<STATUS_GPS, LoopBackDemoChannel>> on_STATUS_GPS = new OnReceive<>();
        public final Collection<OnReceive.Handler<NOVATEL_DIAG, LoopBackDemoChannel>> on_NOVATEL_DIAG = new OnReceive<>();
        public final Collection<OnReceive.Handler<SENSOR_DIAG, LoopBackDemoChannel>> on_SENSOR_DIAG = new OnReceive<>();
        public final Collection<OnReceive.Handler<BOOT, LoopBackDemoChannel>> on_BOOT = new OnReceive<>();
    ...
    private static final Field _M = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
    private static final Field _a = new Field(5, true, -6, 2, 1, 0, 0, 0, 1);
    ...
    private static final Field _Dc = new Field(0, false, 1, 4, 1, 0, 0, 0);
    private static final Field _Bc = new Field(0, true, 1, 4, 1, 0, 0, 0);
    private static final Field _nc = new Field(0, true, 1, 4, 1, 0, 0, 0);
    private static final Field _bc = new Field(0, true, 1, 4, 1, 0, 0, 0);
    private static final Field _Fc = new Field(0, true, 1, 4, 1, 0, 0, 0);
    private static final Field _xz = new Field(0, true, 1, 2, 1, 0, 0, 0);
    private static final Field _Dz = new Field(0, true, 1, 2, 1, 0, 0, 0);
    private static final Field _Bz = new Field(0, true, 1, 2, 1, 0, 0, 0);
    private static final Field _nz = new Field(0, true, 1, 2, 1, 0, 0, 0);
    private static final Field _bz = new Field(0, true, 1, 2, 1, 0, 0, 0);
    private static final Field _Fz = new Field(0, true, 1, 2, 1, 0, 0, 0);
    private static final Field _dz = new Field(0, true, 1, 2, 1, 0, 0, 0);
    private static final Field _yz = new Field(0, true, 1, 2, 1, 0, 0, 0);
    private static final Field _kY = new Field(0, true, 1, 8, 1, 0, 0, 0);
    private static final Field _AY = new Field(0, true, 1, 8, 1, 0, 0, 0);
    private static final Field _oY = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
    private static final Field _ZE = new Field(0, false, 1, 1, 1, 0, 0, 0);
    private static final Field _oE = new Field(0, false, 1, 4, 1, 0, 0, 0);
    private static final Field _gE = new Field(0, false, 1, 1, 1, 0, 0, 0);
    private static final Field _SE = new Field(0, false, 1, 1, 1, 0, 0, 0);
    private static final Field _FD = new Field(0, false, 1, 4, 1, 0, 0, 0);
    private static final Field _dD = new Field(0, false, 1, 4, 1, 0, 0, 0);
    private static final Field _ik = new Field(0, false, 18, 1, 1, 0, 0, 0);
    private static final Field _Fk = new Field(0, false, 1, 4, 1, 0, 0, 0);
    private static final Field _dk = new Field(0, false, 1, 4, 1, 0, 0, 0);
    private static final Field _yk = new Field(0, false, 1, 4, 1, 0, 0, 0);
    private static final Field _kk = new Field(0, false, 4, 4, 1, 0, 0, 0);
    private static final Field _tk = new Field(0, false, 1, 1, 1, 0, 0, 0);
    private static final Field _VJ = new Field(0, true, 1, 8, 1, 0, 0, 0);
    private static final Field _xt = new Field(0, true, 1, 8, 1, 0, 0, 0);
    private static final Field _Nt = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
    private static final Field _vt = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
    private static final Field _Vt = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
    private static final Field _XK = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
    private static final Field _zK = new Field(5, true, -6, 2, 1, 0, 0, 0, 1);
    private static final Field _yK = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
    private static final Field _PK = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
    private static final Field _iA = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
    private static final Field _LA = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
    private static final Field _OA = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
    private static final Field _rA = new Field(5, true, -6, 2, 1, 0, 0, 0, 1);
    private static final Field _TA = new Field(5, true, -7, 2, 1, 0, 0, 0, 1);
    private static final Field _xN = new Field(5, true, -7, 2, 1, 0, 0, 0, 1);
    private static final Field _JN = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
    private static final Field _NN = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
    private static final Field _ZN = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
    private static final Field _PN = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
    private static final Field _GN = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
    private static final Field _aN = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
    private static final Field _WN = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
