...
namespace org.noname
{
    public class DemoDevice : Host
    {
        ...
        } public class CHANGE_OPERATOR_CONTROL : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            } static readonly Meta meta5 = new Meta(5, 0, 0, 0, 4, 24, 0, _f);
        ...
        } public class AUTH_KEY : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {key_SET(src.ToCharArray(), 0, src.Length, ph);} public void key_SET(char[] src, int pos, int items, Inside ph) //ke
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta7 = new Meta(7, 0, 0, 0, 1, 0, 0, _a);
        ...
        } public class GPS_RAW_INT : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            public void hdg_acc_SET(uint src, Inside ph)//Heading / track uncertainty in degrees * 1e5
            {
                ...
                BitUtils.set_bytes((ulong)(src), 4, data,  ph.BYTE);
            } static readonly Meta meta24 = new Meta(24, 4, 0, 1, 31, 236, 0, _kC, _WC, _FC, _NC, _pC);
        ...
        } public class SERVO_OUTPUT_RAW : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            public void servo16_raw_SET(ushort src, Inside ph)//Servo output 16 value, in microsecond
            {
                ...
                BitUtils.set_bytes((ulong)(src), 2, data,  ph.BYTE);
            } static readonly Meta meta36 = new Meta(36, 8, 1, 0, 22, 168, 0, _uc, _kc, _Wc, _Fc, _Nc, _pc, _Xc, _Ic);
        ...
        } public class SET_GPS_GLOBAL_ORIGIN : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            } static readonly Meta meta48 = new Meta(48, 0, 0, 0, 14, 104, 0, _Ss);
        } public class GPS_GLOBAL_ORIGIN : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            public void time_usec_SET(ulong src, Inside ph)//Timestamp (microseconds since UNIX epoch or microseconds since system boot
            {
                ...
                BitUtils.set_bytes((ulong)(src), 8, data,  ph.BYTE);
            } static readonly Meta meta49 = new Meta(49, 0, 0, 0, 13, 96, 0, _Js);
        } public class PARAM_MAP_RC : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            } public void param_id_SET(string src, Inside ph) {param_id_SET(src.ToCharArray(), 0, src.Length, ph);} public void param_id_SET(char[] src, int pos, int items, Inside ph)
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta50 = new Meta(50, 0, 0, 0, 22, 168, 0, _Ks);
        ...
        } public class COMMAND_ACK : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            public void target_component_SET(byte src, Inside ph)//WIP: Component which requested the command to be execute
            {
                ...
                BitUtils.set_bytes((ulong)(src), 1, data,  ph.BYTE);
            } static readonly Meta meta77 = new Meta(77, 0, 0, 0, 3, 11, 0, _Py, _Ky, _jy, _ey);
        ...
        } public class OPTICAL_FLOW : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            public void flow_rate_y_SET(float src, Inside ph)//Flow rate in radians/second about Y axi
            {
                ...
                BitUtils.set_bytes(BitUtils.FloatToInt32Bits(src), 4, data, ph.BYTE);
            } static readonly Meta meta100 = new Meta(100, 0, 0, 1, 27, 208, 0, _pk, _Xk);
        ...
        } public class AUTOPILOT_VERSION : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            } public void uid2_SET(byte[] src, int pos, Inside ph)
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + 18; pos < src_max; pos++, BYTE += 1)
                    BitUtils.set_bytes((ulong)(src[pos]), 1, data,  BYTE);
            } static readonly Meta meta148 = new Meta(148, 2, 4, 1, 54, 421, 0, _mS);
        } public class LANDING_TARGET : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            public void position_valid_SET(byte src, Inside ph)
            {
                ...
                BitUtils.set_bytes((ulong)(src), 1, data,  ph.BYTE);
            } static readonly Meta meta149 = new Meta(149, 0, 0, 1, 31, 239, 0, _pS, _XS, _IS, _SS, _iS);
        } public class CPU_LOAD : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal CPU_LOAD() : base(meta170, 0) { }
            internal CPU_LOAD(int bytes) : base(meta170, bytes) { }
            public ushort batVolt //Battery Voltage in millivolt
            {
                get {  return (ushort)((ushort) BitUtils.get_bytes(data,  0, 2));}
                set {  BitUtils.set_bytes((ulong)(value), 2, data,  0);}
            }

            public byte sensLoad //Sensor DSC Loa
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  2, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  2);}
            }

            public byte ctrlLoad //Control DSC Loa
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  3, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  3);}
            }
            static readonly Meta meta170 = new Meta(170, 1, 0, 0, 4, 32);
        } public class SENSOR_BIAS : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal SENSOR_BIAS() : base(meta172, 0) { }
            internal SENSOR_BIAS(int bytes) : base(meta172, bytes) { }
            ...
            static readonly Meta meta172 = new Meta(172, 0, 0, 0, 24, 192);
        } public class DIAGNOSTIC : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal DIAGNOSTIC() : base(meta173, 0) { }
            internal DIAGNOSTIC(int bytes) : base(meta173, bytes) { }
            public float diagFl1 //Diagnostic float
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  0, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 0);}
            }

            public float diagFl2 //Diagnostic float
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  4, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 4);}
            }

            public float diagFl3 //Diagnostic float
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  8, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 8);}
            }

            public short diagSh1 //Diagnostic short
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  12, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  12);}
            }

            public short diagSh2 //Diagnostic short
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  14, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  14);}
            }

            public short diagSh3 //Diagnostic short
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  16, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  16);}
            }
            static readonly Meta meta173 = new Meta(173, 0, 0, 0, 18, 144);
        } public class SLUGS_NAVIGATION : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal SLUGS_NAVIGATION() : base(meta176, 0) { }
            internal SLUGS_NAVIGATION(int bytes) : base(meta176, bytes) { }
            public ushort h_c //Commanded altitude in 0.1
            {
                get {  return (ushort)((ushort) BitUtils.get_bytes(data,  0, 2));}
                set {  BitUtils.set_bytes((ulong)(value), 2, data,  0);}
            }

            public float u_m //Measured Airspeed prior to the nav filter in m/
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  2, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 2);}
            }

            public float phi_c //Commanded Rol
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  6, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 6);}
            }

            public float theta_c //Commanded Pitc
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  10, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 10);}
            }

            public float psiDot_c //Commanded Turn rat
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  14, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 14);}
            }

            public float ay_body //Y component of the body acceleratio
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  18, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 18);}
            }

            public float totalDist //Total Distance to Run on this leg of Navigatio
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  22, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 22);}
            }

            public float dist2Go //Remaining distance to Run on this leg of Navigatio
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  26, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 26);}
            }

            public byte fromWP //Origin W
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  30, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  30);}
            }

            public byte toWP //Destination W
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  31, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  31);}
            }
            static readonly Meta meta176 = new Meta(176, 1, 0, 0, 32, 256);
        } public class DATA_LOG : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal DATA_LOG() : base(meta177, 0) { }
            internal DATA_LOG(int bytes) : base(meta177, bytes) { }
            ...
            static readonly Meta meta177 = new Meta(177, 0, 0, 0, 24, 192);
        } public class GPS_DATE_TIME : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal GPS_DATE_TIME() : base(meta179, 0) { }
            internal GPS_DATE_TIME(int bytes) : base(meta179, bytes) { }
            ...
            public byte percentUsed //Percent used GP
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  11, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  11);}
            }
            static readonly Meta meta179 = new Meta(179, 0, 0, 0, 12, 96);
        } public class MID_LVL_CMDS : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal MID_LVL_CMDS() : base(meta180, 0) { }
            internal MID_LVL_CMDS(int bytes) : base(meta180, bytes) { }
            public byte target //The system setting the command
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  0, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  0);}
            }

            public float hCommand //Commanded Altitude in meter
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  1, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 1);}
            }

            public float uCommand //Commanded Airspeed in m/
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  5, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 5);}
            }

            public float rCommand //Commanded Turnrate in rad/
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  9, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 9);}
            }
            static readonly Meta meta180 = new Meta(180, 0, 0, 0, 13, 104);
        } public class CTRL_SRFC_PT : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal CTRL_SRFC_PT() : base(meta181, 0) { }
            internal CTRL_SRFC_PT(int bytes) : base(meta181, bytes) { }
            ...
            static readonly Meta meta181 = new Meta(181, 1, 0, 0, 3, 24);
        } public class SLUGS_CAMERA_ORDER : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal SLUGS_CAMERA_ORDER() : base(meta184, 0) { }
            internal SLUGS_CAMERA_ORDER(int bytes) : base(meta184, bytes) { }
            public byte target //The system reporting the actio
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  0, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  0);}
            }

            public sbyte pan //Order the mount to pan: -1 left, 0 No pan motion, +1 righ
            {
                get {  return (sbyte)((sbyte) BitUtils.get_bytes(data,  1, 1));}
                set {  BitUtils.set_bytes((byte)(value), 1, data,  1);}
            }

            public sbyte tilt //Order the mount to tilt: -1 down, 0 No tilt motion, +1 u
            {
                get {  return (sbyte)((sbyte) BitUtils.get_bytes(data,  2, 1));}
                set {  BitUtils.set_bytes((byte)(value), 1, data,  2);}
            }

            public sbyte zoom //Order the zoom values 0 to 1
            {
                get {  return (sbyte)((sbyte) BitUtils.get_bytes(data,  3, 1));}
                set {  BitUtils.set_bytes((byte)(value), 1, data,  3);}
            }
            ...
            static readonly Meta meta184 = new Meta(184, 0, 0, 0, 5, 40);
        } public class CONTROL_SURFACE : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal CONTROL_SURFACE() : base(meta185, 0) { }
            internal CONTROL_SURFACE(int bytes) : base(meta185, bytes) { }
            public byte target //The system setting the command
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  0, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  0);}
            ...
            public byte idSurface //ID control surface send 0: throttle 1: aileron 2: elevator 3: rudde
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  1, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  1);}
            }

            public float mControl //Pendin
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  2, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 2);}
            }

            public float bControl //Order to origi
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  6, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 6);}
            }
            static readonly Meta meta185 = new Meta(185, 0, 0, 0, 10, 80);
        } public class SLUGS_MOBILE_LOCATION : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal SLUGS_MOBILE_LOCATION() : base(meta186, 0) { }
            internal SLUGS_MOBILE_LOCATION(int bytes) : base(meta186, bytes) { }
            public byte target //The system reporting the actio
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  0, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  0);}
            ...
            public float latitude //Mobile Latitud
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  1, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 1);}
            }

            public float longitude //Mobile Longitud
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  5, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 5);}
            }
            static readonly Meta meta186 = new Meta(186, 0, 0, 0, 9, 72);
        } public class SLUGS_CONFIGURATION_CAMERA : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal SLUGS_CONFIGURATION_CAMERA() : base(meta188, 0) { }
            internal SLUGS_CONFIGURATION_CAMERA(int bytes) : base(meta188, bytes) { }
            public byte target //The system setting the command
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  0, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  0);}
            ...
            public byte idOrder //ID 0: brightness 1: aperture 2: iris 3: ICR 4: backligh
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  1, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  1);}
            }

            public byte order //1: up/on 2: down/off 3: auto/reset/no actio
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  2, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  2);}
            }
            static readonly Meta meta188 = new Meta(188, 0, 0, 0, 3, 24);
        } public class ISR_LOCATION : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal ISR_LOCATION() : base(meta189, 0) { }
            internal ISR_LOCATION(int bytes) : base(meta189, bytes) { }
            public byte target //The system reporting the actio
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  0, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  0);}
            ...
            public float latitude //ISR Latitud
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  1, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 1);}
            }

            public float longitude //ISR Longitud
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  5, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 5);}
            }

            public float height //ISR Heigh
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  9, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 9);}
            }

            public byte option1 //Option
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  13, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  13);}
            }

            public byte option2 //Option
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  14, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  14);}
            }

            public byte option3 //Option
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  15, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  15);}
            }
            static readonly Meta meta189 = new Meta(189, 0, 0, 0, 16, 128);
        } public class VOLT_SENSOR : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal VOLT_SENSOR() : base(meta191, 0) { }
            internal VOLT_SENSOR(int bytes) : base(meta191, bytes) { }
            ...
            public byte r2Type //It is the value of reading 2: 0 - Current, 1 - Foreward Sonar, 2 - Back Sonar, 3 - RP
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  4, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  4);}
            }
            static readonly Meta meta191 = new Meta(191, 2, 0, 0, 5, 40);
        } public class PTZ_STATUS : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal PTZ_STATUS() : base(meta192, 0) { }
            internal PTZ_STATUS(int bytes) : base(meta192, bytes) { }
            public byte zoom //The actual Zoom Valu
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  0, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  0);}
            }

            public short pan //The Pan value in 10ths of degre
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  1, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  1);}
            }

            public short tilt //The Tilt value in 10ths of degre
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  3, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  3);}
            }
            static readonly Meta meta192 = new Meta(192, 0, 0, 0, 5, 40);
        } public class UAV_STATUS : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal UAV_STATUS() : base(meta193, 0) { }
            internal UAV_STATUS(int bytes) : base(meta193, bytes) { }
            public byte target //The ID system reporting the actio
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  0, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  0);}
            }

            public float latitude //Latitude UA
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  1, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 1);}
            }

            public float longitude //Longitude UA
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  5, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 5);}
            }

            public float altitude //Altitude UA
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  9, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 9);}
            }

            public float speed //Speed UA
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  13, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 13);}
            }

            public float course //Course UA
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  17, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 17);}
            }
            static readonly Meta meta193 = new Meta(193, 0, 0, 0, 21, 168);
        } public class STATUS_GPS : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal STATUS_GPS() : base(meta194, 0) { }
            internal STATUS_GPS(int bytes) : base(meta194, bytes) { }
            public ushort csFails //Number of times checksum has faile
            {
                get {  return (ushort)((ushort) BitUtils.get_bytes(data,  0, 2));}
                set {  BitUtils.set_bytes((ulong)(value), 2, data,  0);}
            }
            ...
            public byte msgsType //Indicates if GN, GL or GP messages are being receive
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  3, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  3);}
            }

            public byte posStatus //A = data valid, V = data invali
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  4, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  4);}
            }
            ...
            public sbyte magDir
            {
                ...
                set {  BitUtils.set_bytes((byte)(value), 1, data,  9);}
            }
            ...
            static readonly Meta meta194 = new Meta(194, 1, 0, 0, 11, 88);
        } public class NOVATEL_DIAG : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal NOVATEL_DIAG() : base(meta195, 0) { }
            internal NOVATEL_DIAG(int bytes) : base(meta195, bytes) { }
            public ushort csFails //Times the CRC has failed since boo
            {
                get {  return (ushort)((ushort) BitUtils.get_bytes(data,  0, 2));}
                set {  BitUtils.set_bytes((ulong)(value), 2, data,  0);}
            }

            public uint receiverStatus //Status Bitfield. See table 69 page 350 Novatel OEMstar Manua
            {
                get {  return (uint)((uint) BitUtils.get_bytes(data,  2, 4));}
                set {  BitUtils.set_bytes((ulong)(value), 4, data,  2);}
            }

            public byte timeStatus //The Time Status. See Table 8 page 27 Novatel OEMStar Manua
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  6, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  6);}
            }

            public byte solStatus //solution Status. See table 44 page 19
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  7, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  7);}
            }

            public byte posType //position type. See table 43 page 19
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  8, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  8);}
            }

            public byte velType //velocity type. See table 43 page 19
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  9, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  9);}
            }

            public float posSolAge //Age of the position solution in second
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  10, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 10);}
            }
            static readonly Meta meta195 = new Meta(195, 1, 1, 0, 14, 112);
        } public class SENSOR_DIAG : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal SENSOR_DIAG() : base(meta196, 0) { }
            internal SENSOR_DIAG(int bytes) : base(meta196, bytes) { }
            public float float1 //Float field
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  0, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 0);}
            }

            public float float2 //Float field
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  4, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 4);}
            }

            public short int1 //Int 16 field
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  8, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  8);}
            }

            public sbyte char1 //Int 8 field
            {
                get {  return (sbyte)((sbyte) BitUtils.get_bytes(data,  10, 1));}
                set {  BitUtils.set_bytes((byte)(value), 1, data,  10);}
            }
            static readonly Meta meta196 = new Meta(196, 0, 0, 0, 11, 88);
        } public class BOOT : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal BOOT() : base(meta197, 0) { }
            internal BOOT(int bytes) : base(meta197, bytes) { }
            public uint version //The onboard software versio
            {
                get {  return (uint)((uint) BitUtils.get_bytes(data,  0, 4));}
                set {  BitUtils.set_bytes((ulong)(value), 4, data,  0);}
            }
            static readonly Meta meta197 = new Meta(197, 0, 1, 0, 4, 32);
        ...
        } public class HOME_POSITION : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            public void time_usec_SET(ulong src, Inside ph)//Timestamp (microseconds since UNIX epoch or microseconds since system boot
            {
                ...
                BitUtils.set_bytes((ulong)(src), 8, data,  ph.BYTE);
            } static readonly Meta meta242 = new Meta(242, 0, 0, 0, 53, 416, 0, _GU);
        } public class SET_HOME_POSITION : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            public void time_usec_SET(ulong src, Inside ph)//Timestamp (microseconds since UNIX epoch or microseconds since system boot
            {
                ...
                BitUtils.set_bytes((ulong)(src), 8, data,  ph.BYTE);
            } static readonly Meta meta243 = new Meta(243, 0, 0, 0, 54, 424, 0, _ui);
        ...
        } public class ADSB_VEHICLE : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {callsign_SET(src.ToCharArray(), 0, src.Length, ph);} public void callsign_SET(char[] src, int pos, int items, Inside ph) //The callsign, 8+nul
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta246 = new Meta(246, 3, 1, 0, 28, 210, 0, _Ti);
        ...
        } public class DEBUG_VECT : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {name_SET(src.ToCharArray(), 0, src.Length, ph);} public void name_SET(char[] src, int pos, int items, Inside ph) //Nam
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta250 = new Meta(250, 0, 0, 1, 21, 160, 0, _zi);
        } public class NAMED_VALUE_FLOAT : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {name_SET(src.ToCharArray(), 0, src.Length, ph);} public void name_SET(char[] src, int pos, int items, Inside ph) //Name of the debug variabl
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta251 = new Meta(251, 0, 1, 0, 9, 64, 0, _Gi);
        } public class NAMED_VALUE_INT : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {name_SET(src.ToCharArray(), 0, src.Length, ph);} public void name_SET(char[] src, int pos, int items, Inside ph) //Name of the debug variabl
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta252 = new Meta(252, 0, 1, 0, 9, 64, 0, _qr);
        } public class STATUSTEXT : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {text_SET(src.ToCharArray(), 0, src.Length, ph);} public void text_SET(char[] src, int pos, int items, Inside ph) //Status text message, without null termination characte
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta253 = new Meta(253, 0, 0, 0, 2, 4, 0, _cr);
        ...
        } public class PLAY_TUNE : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {tune_SET(src.ToCharArray(), 0, src.Length, ph);} public void tune_SET(char[] src, int pos, int items, Inside ph) //tune in board specific forma
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta258 = new Meta(258, 0, 0, 0, 3, 16, 0, _Ir);
        } public class CAMERA_INFORMATION : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {cam_definition_uri_SET(src.ToCharArray(), 0, src.Length, ph);} public void cam_definition_uri_SET(char[] src, int pos, int items, Inside ph) //Camera definition URI (if any, otherwise only basic functions will be available)
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta259 = new Meta(259, 3, 2, 0, 93, 731, 0, _Lr);
        ...
        } public class CAMERA_IMAGE_CAPTURED : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {file_url_SET(src.ToCharArray(), 0, src.Length, ph);} public void file_url_SET(char[] src, int pos, int items, Inside ph) //foo.jpg if camera provides an HTTP interface
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta263 = new Meta(263, 0, 1, 1, 51, 402, 2, _mJ);
        ...
        } public class VIDEO_STREAM_INFORMATION : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {uri_SET(src.ToCharArray(), 0, src.Length, ph);} public void uri_SET(char[] src, int pos, int items, Inside ph) //Video stream UR
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta269 = new Meta(269, 3, 1, 0, 17, 130, 2, _vJ);
        } public class SET_VIDEO_STREAM_SETTINGS : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {uri_SET(src.ToCharArray(), 0, src.Length, ph);} public void uri_SET(char[] src, int pos, int items, Inside ph) //Video stream UR
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta270 = new Meta(270, 3, 1, 0, 18, 138, 2, _MJ);
        } public class WIFI_CONFIG_AP : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {password_SET(src.ToCharArray(), 0, src.Length, ph);} public void password_SET(char[] src, int pos, int items, Inside ph) //Password. Leave it blank for an open AP
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta299 = new Meta(299, 0, 0, 0, 1, 2, 2, _bJ, _lJ);
        ...
        } public class UAVCAN_NODE_INFO : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {name_SET(src.ToCharArray(), 0, src.Length, ph);} public void name_SET(char[] src, int pos, int items, Inside ph) //Node name string. For example, "sapog.px4.io"
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta311 = new Meta(311, 0, 2, 1, 37, 288, 0, _uT);
        } public class PARAM_EXT_REQUEST_READ : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            } public void param_id_SET(string src, Inside ph) {param_id_SET(src.ToCharArray(), 0, src.Length, ph);} public void param_id_SET(char[] src, int pos, int items, Inside ph)
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta320 = new Meta(320, 0, 0, 0, 5, 32, 0, _UT);
        ...
        } public class PARAM_EXT_VALUE : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {param_value_SET(src.ToCharArray(), 0, src.Length, ph);} public void param_value_SET(char[] src, int pos, int items, Inside ph) //Parameter valu
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta322 = new Meta(322, 2, 0, 0, 5, 38, 2, _TT, _PT);
        } public class PARAM_EXT_SET : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {param_value_SET(src.ToCharArray(), 0, src.Length, ph);} public void param_value_SET(char[] src, int pos, int items, Inside ph) //Parameter valu
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta323 = new Meta(323, 0, 0, 0, 3, 22, 2, _LT, _HT);
        } public class PARAM_EXT_ACK : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {param_value_SET(src.ToCharArray(), 0, src.Length, ph);} public void param_value_SET(char[] src, int pos, int items, Inside ph) //Parameter value (new value if PARAM_ACK_ACCEPTED, current value otherwise
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta324 = new Meta(324, 0, 0, 0, 2, 9, 2, _aT, _OT);
                ...
                for(bool LOOP = false; ;)
                {
                    switch(id)
                    {
                        ...
                        case 170:
                            ...
                            if(OnCPU_LOADReceive == null) return null;
                            ph.setPack(pack);
                            OnCPU_LOADReceive(this, ph, (CPU_LOAD) pack);
                            if(LOOP) break;
                            return null;
                        case 172:
                            if(pack == null) return new SENSOR_BIAS();
                            if(OnSENSOR_BIASReceive == null) return null;
                            ph.setPack(pack);
                            OnSENSOR_BIASReceive(this, ph, (SENSOR_BIAS) pack);
                            if(LOOP) break;
                            return null;
                        case 173:
                            if(pack == null) return new DIAGNOSTIC();
                            if(OnDIAGNOSTICReceive == null) return null;
                            ph.setPack(pack);
                            OnDIAGNOSTICReceive(this, ph, (DIAGNOSTIC) pack);
                            if(LOOP) break;
                            return null;
                        case 176:
                            if(pack == null) return new SLUGS_NAVIGATION();
                            if(OnSLUGS_NAVIGATIONReceive == null) return null;
                            ph.setPack(pack);
                            OnSLUGS_NAVIGATIONReceive(this, ph, (SLUGS_NAVIGATION) pack);
                            if(LOOP) break;
                            return null;
                        case 177:
                            if(pack == null) return new DATA_LOG();
                            if(OnDATA_LOGReceive == null) return null;
                            ph.setPack(pack);
                            OnDATA_LOGReceive(this, ph, (DATA_LOG) pack);
                            if(LOOP) break;
                            return null;
                        case 179:
                            if(pack == null) return new GPS_DATE_TIME();
                            if(OnGPS_DATE_TIMEReceive == null) return null;
                            ph.setPack(pack);
                            OnGPS_DATE_TIMEReceive(this, ph, (GPS_DATE_TIME) pack);
                            if(LOOP) break;
                            return null;
                        case 180:
                            if(pack == null) return new MID_LVL_CMDS();
                            if(OnMID_LVL_CMDSReceive == null) return null;
                            ph.setPack(pack);
                            OnMID_LVL_CMDSReceive(this, ph, (MID_LVL_CMDS) pack);
                            if(LOOP) break;
                            return null;
                        case 181:
                            if(pack == null) return new CTRL_SRFC_PT();
                            if(OnCTRL_SRFC_PTReceive == null) return null;
                            ph.setPack(pack);
                            OnCTRL_SRFC_PTReceive(this, ph, (CTRL_SRFC_PT) pack);
                            if(LOOP) break;
                            return null;
                        case 184:
                            if(pack == null) return new SLUGS_CAMERA_ORDER();
                            if(OnSLUGS_CAMERA_ORDERReceive == null) return null;
                            ph.setPack(pack);
                            OnSLUGS_CAMERA_ORDERReceive(this, ph, (SLUGS_CAMERA_ORDER) pack);
                            if(LOOP) break;
                            return null;
                        case 185:
                            if(pack == null) return new CONTROL_SURFACE();
                            if(OnCONTROL_SURFACEReceive == null) return null;
                            ph.setPack(pack);
                            OnCONTROL_SURFACEReceive(this, ph, (CONTROL_SURFACE) pack);
                            if(LOOP) break;
                            return null;
                        case 186:
                            if(pack == null) return new SLUGS_MOBILE_LOCATION();
                            if(OnSLUGS_MOBILE_LOCATIONReceive == null) return null;
                            ph.setPack(pack);
                            OnSLUGS_MOBILE_LOCATIONReceive(this, ph, (SLUGS_MOBILE_LOCATION) pack);
                            if(LOOP) break;
                            return null;
                        case 188:
                            if(pack == null) return new SLUGS_CONFIGURATION_CAMERA();
                            if(OnSLUGS_CONFIGURATION_CAMERAReceive == null) return null;
                            ph.setPack(pack);
                            OnSLUGS_CONFIGURATION_CAMERAReceive(this, ph, (SLUGS_CONFIGURATION_CAMERA) pack);
                            if(LOOP) break;
                            return null;
                        case 189:
                            if(pack == null) return new ISR_LOCATION();
                            if(OnISR_LOCATIONReceive == null) return null;
                            ph.setPack(pack);
                            OnISR_LOCATIONReceive(this, ph, (ISR_LOCATION) pack);
                            if(LOOP) break;
                            return null;
                        case 191:
                            if(pack == null) return new VOLT_SENSOR();
                            if(OnVOLT_SENSORReceive == null) return null;
                            ph.setPack(pack);
                            OnVOLT_SENSORReceive(this, ph, (VOLT_SENSOR) pack);
                            if(LOOP) break;
                            return null;
                        case 192:
                            if(pack == null) return new PTZ_STATUS();
                            if(OnPTZ_STATUSReceive == null) return null;
                            ph.setPack(pack);
                            OnPTZ_STATUSReceive(this, ph, (PTZ_STATUS) pack);
                            if(LOOP) break;
                            return null;
                        case 193:
                            if(pack == null) return new UAV_STATUS();
                            if(OnUAV_STATUSReceive == null) return null;
                            ph.setPack(pack);
                            OnUAV_STATUSReceive(this, ph, (UAV_STATUS) pack);
                            if(LOOP) break;
                            return null;
                        case 194:
                            if(pack == null) return new STATUS_GPS();
                            if(OnSTATUS_GPSReceive == null) return null;
                            ph.setPack(pack);
                            OnSTATUS_GPSReceive(this, ph, (STATUS_GPS) pack);
                            if(LOOP) break;
                            return null;
                        case 195:
                            if(pack == null) return new NOVATEL_DIAG();
                            if(OnNOVATEL_DIAGReceive == null) return null;
                            ph.setPack(pack);
                            OnNOVATEL_DIAGReceive(this, ph, (NOVATEL_DIAG) pack);
                            if(LOOP) break;
                            return null;
                        case 196:
                            if(pack == null) return new SENSOR_DIAG();
                            if(OnSENSOR_DIAGReceive == null) return null;
                            ph.setPack(pack);
                            OnSENSOR_DIAGReceive(this, ph, (SENSOR_DIAG) pack);
                            if(LOOP) break;
                            return null;
                        case 197:
                            if(pack == null) return new BOOT();
                            if(OnBOOTReceive == null) return null;
                            ph.setPack(pack);
                            OnBOOTReceive(this, ph, (BOOT) pack);
                            if(LOOP) break;
                            return null;
                        case 230:
        ...
        static readonly Field _a = new Field(5, true, -6, 2, 1, 0, 0, 0, 1);
        ...
        static readonly Field _kC = new Field(0, false, 1, 4, 1, 0, 0, 0);
        static readonly Field _WC = new Field(0, true, 1, 4, 1, 0, 0, 0);
        static readonly Field _FC = new Field(0, true, 1, 4, 1, 0, 0, 0);
        static readonly Field _NC = new Field(0, true, 1, 4, 1, 0, 0, 0);
        static readonly Field _pC = new Field(0, true, 1, 4, 1, 0, 0, 0);
        static readonly Field _uc = new Field(0, true, 1, 2, 1, 0, 0, 0);
        static readonly Field _kc = new Field(0, true, 1, 2, 1, 0, 0, 0);
        static readonly Field _Wc = new Field(0, true, 1, 2, 1, 0, 0, 0);
        static readonly Field _Fc = new Field(0, true, 1, 2, 1, 0, 0, 0);
        static readonly Field _Nc = new Field(0, true, 1, 2, 1, 0, 0, 0);
        static readonly Field _pc = new Field(0, true, 1, 2, 1, 0, 0, 0);
        static readonly Field _Xc = new Field(0, true, 1, 2, 1, 0, 0, 0);
        static readonly Field _Ic = new Field(0, true, 1, 2, 1, 0, 0, 0);
        static readonly Field _Ss = new Field(0, true, 1, 8, 1, 0, 0, 0);
        static readonly Field _Js = new Field(0, true, 1, 8, 1, 0, 0, 0);
        static readonly Field _Ks = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
        static readonly Field _Py = new Field(0, false, 1, 1, 1, 0, 0, 0);
        static readonly Field _Ky = new Field(0, false, 1, 4, 1, 0, 0, 0);
        static readonly Field _jy = new Field(0, false, 1, 1, 1, 0, 0, 0);
        static readonly Field _ey = new Field(0, false, 1, 1, 1, 0, 0, 0);
        static readonly Field _pk = new Field(0, false, 1, 4, 1, 0, 0, 0);
        static readonly Field _Xk = new Field(0, false, 1, 4, 1, 0, 0, 0);
        static readonly Field _mS = new Field(0, false, 18, 1, 1, 0, 0, 0);
        static readonly Field _pS = new Field(0, false, 1, 4, 1, 0, 0, 0);
        static readonly Field _XS = new Field(0, false, 1, 4, 1, 0, 0, 0);
        static readonly Field _IS = new Field(0, false, 1, 4, 1, 0, 0, 0);
        static readonly Field _SS = new Field(0, false, 4, 4, 1, 0, 0, 0);
        static readonly Field _iS = new Field(0, false, 1, 1, 1, 0, 0, 0);
        static readonly Field _GU = new Field(0, true, 1, 8, 1, 0, 0, 0);
        static readonly Field _ui = new Field(0, true, 1, 8, 1, 0, 0, 0);
        static readonly Field _Ti = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
        static readonly Field _zi = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
        static readonly Field _Gi = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
        static readonly Field _qr = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
        static readonly Field _cr = new Field(5, true, -6, 2, 1, 0, 0, 0, 1);
        static readonly Field _Ir = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
        static readonly Field _Lr = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
        static readonly Field _mJ = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
        static readonly Field _vJ = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
        static readonly Field _MJ = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
        static readonly Field _bJ = new Field(5, true, -6, 2, 1, 0, 0, 0, 1);
        static readonly Field _lJ = new Field(5, true, -7, 2, 1, 0, 0, 0, 1);
        static readonly Field _uT = new Field(5, true, -7, 2, 1, 0, 0, 0, 1);
        static readonly Field _UT = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
        static readonly Field _TT = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
        static readonly Field _PT = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
        static readonly Field _LT = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
        static readonly Field _HT = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
        static readonly Field _aT = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
        static readonly Field _OT = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
