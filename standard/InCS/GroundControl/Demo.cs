...
namespace org.noname
{
    public class Demo :  GroundControl
    {
        static void Main_(string[] args)
        {
            ...
            PH.setPack(p3);
            p3.time_boot_ms = (uint)2290536064U;
            p3.coordinate_frame = (MAV_FRAME)MAV_FRAME.MAV_FRAME_GLOBAL_TERRAIN_ALT;
            p3.type_mask = (ushort)(ushort)52638;
            p3.x = (float) -7.341696E37F;
            p3.y = (float) -2.8233554E38F;
            p3.z = (float)3.363943E38F;
            p3.vx = (float)7.134002E37F;
            p3.vy = (float)4.2342375E37F;
            p3.vz = (float)6.5444896E37F;
            p3.afx = (float)2.3324071E38F;
            p3.afy = (float)9.117519E37F;
            p3.afz = (float) -8.76323E37F;
            p3.yaw = (float) -2.1676123E37F;
            p3.yaw_rate = (float)2.857486E38F;
            CommunicationChannel.instance.send(p3); //===============================
            VFR_HUD p74 = CommunicationChannel.new_VFR_HUD();
            PH.setPack(p74);
            p74.airspeed = (float) -2.9851344E38F;
            p74.groundspeed = (float) -1.0349406E38F;
            p74.heading = (short)(short)29487;
            p74.throttle = (ushort)(ushort)44117;
            p74.alt = (float) -3.143282E38F;
            p74.climb = (float)3.1662369E38F;
            CommunicationChannel.instance.send(p74); //===============================
            COMMAND_INT p75 = CommunicationChannel.new_COMMAND_INT();
            PH.setPack(p75);
            p75.target_system = (byte)(byte)95;
            p75.target_component = (byte)(byte)94;
            p75.frame = (MAV_FRAME)MAV_FRAME.MAV_FRAME_BODY_NED;
            p75.command = (MAV_CMD)MAV_CMD.MAV_CMD_PREFLIGHT_SET_SENSOR_OFFSETS;
            p75.current = (byte)(byte)65;
            p75.autocontinue = (byte)(byte)168;
            p75.param1 = (float) -2.6426907E38F;
            p75.param2 = (float) -2.8226303E38F;
            p75.param3 = (float)6.168576E37F;
            p75.param4 = (float) -1.9827978E38F;
            p75.x = (int)434582719;
            p75.y = (int) -634553041;
            p75.z = (float)7.5106655E37F;
            CommunicationChannel.instance.send(p75); //===============================
            COMMAND_LONG p76 = CommunicationChannel.new_COMMAND_LONG();
            PH.setPack(p76);
            p76.target_system = (byte)(byte)84;
            p76.target_component = (byte)(byte)17;
            p76.command = (MAV_CMD)MAV_CMD.MAV_CMD_WAYPOINT_USER_2;
            p76.confirmation = (byte)(byte)255;
            p76.param1 = (float) -1.3752767E38F;
            p76.param2 = (float) -7.9234384E37F;
            p76.param3 = (float)3.0075063E38F;
            p76.param4 = (float)3.270161E38F;
            p76.param5 = (float)1.4961702E38F;
            p76.param6 = (float)1.0175516E38F;
            p76.param7 = (float)3.3493067E38F;
            CommunicationChannel.instance.send(p76); //===============================
            COMMAND_ACK p77 = CommunicationChannel.new_COMMAND_ACK();
            PH.setPack(p77);
            p77.command = (MAV_CMD)MAV_CMD.MAV_CMD_USER_3;
            p77.result = (MAV_RESULT)MAV_RESULT.MAV_RESULT_FAILED;
            p77.progress_SET((byte)(byte)4, PH);
            p77.result_param2_SET((int)823524168, PH);
            p77.target_system_SET((byte)(byte)189, PH);
            ...
            PH.setPack(p81);
            p81.time_boot_ms = (uint)2151210915U;
            p81.roll = (float)3.1273756E38F;
            p81.pitch = (float)1.2499802E38F;
            p81.yaw = (float)2.2364152E38F;
            p81.thrust = (float) -6.20639E37F;
            p81.mode_switch = (byte)(byte)176;
            p81.manual_override_switch = (byte)(byte)182;
            CommunicationChannel.instance.send(p81); //===============================
            SET_ATTITUDE_TARGET p82 = CommunicationChannel.new_SET_ATTITUDE_TARGET();
            PH.setPack(p82);
            p82.time_boot_ms = (uint)2275266204U;
            p82.target_system = (byte)(byte)101;
            p82.target_component = (byte)(byte)218;
            p82.type_mask = (byte)(byte)54;
            p82.q_SET(new float[4], 0);
            p82.body_roll_rate = (float) -2.6376533E37F;
            p82.body_pitch_rate = (float)2.9900085E38F;
            p82.body_yaw_rate = (float) -2.9292187E38F;
            p82.thrust = (float) -2.226178E38F;
            CommunicationChannel.instance.send(p82); //===============================
            ATTITUDE_TARGET p83 = CommunicationChannel.new_ATTITUDE_TARGET();
            PH.setPack(p83);
            p83.time_boot_ms = (uint)8025780U;
            p83.type_mask = (byte)(byte)162;
            p83.q_SET(new float[4], 0);
            p83.body_roll_rate = (float) -1.8012734E37F;
            p83.body_pitch_rate = (float)3.0824476E38F;
            p83.body_yaw_rate = (float) -3.3544467E38F;
            p83.thrust = (float) -2.9635823E38F;
            ...
            PH.setPack(p84);
            p84.time_boot_ms = (uint)3063405728U;
            p84.target_system = (byte)(byte)19;
            p84.target_component = (byte)(byte)19;
            p84.coordinate_frame = (MAV_FRAME)MAV_FRAME.MAV_FRAME_GLOBAL_RELATIVE_ALT_INT;
            p84.type_mask = (ushort)(ushort)10403;
            p84.x = (float) -2.5288978E38F;
            p84.y = (float) -1.8865865E37F;
            p84.z = (float) -9.520659E37F;
            p84.vx = (float) -3.0542009E38F;
            p84.vy = (float) -2.2964276E38F;
            p84.vz = (float)1.7799037E38F;
            p84.afx = (float) -2.264694E38F;
            p84.afy = (float) -1.6757851E38F;
            p84.afz = (float)1.7152183E38F;
            p84.yaw = (float) -2.1915933E38F;
            p84.yaw_rate = (float)2.4404114E38F;
            ...
            PH.setPack(p86);
            p86.time_boot_ms = (uint)640292163U;
            p86.target_system = (byte)(byte)91;
            p86.target_component = (byte)(byte)210;
            p86.coordinate_frame = (MAV_FRAME)MAV_FRAME.MAV_FRAME_LOCAL_ENU;
            p86.type_mask = (ushort)(ushort)522;
            p86.lat_int = (int) -2052543512;
            p86.lon_int = (int)1857755503;
            p86.alt = (float)8.976096E37F;
            p86.vx = (float)1.8499207E38F;
            p86.vy = (float) -2.02329E38F;
            p86.vz = (float)1.8144796E38F;
            p86.afx = (float) -3.1602552E38F;
            p86.afy = (float) -4.2474905E37F;
            p86.afz = (float)2.2015557E37F;
            p86.yaw = (float) -9.4714E37F;
            p86.yaw_rate = (float) -7.97783E36F;
            CommunicationChannel.instance.send(p86); //===============================
            POSITION_TARGET_GLOBAL_INT p87 = CommunicationChannel.new_POSITION_TARGET_GLOBAL_INT();
            PH.setPack(p87);
            p87.time_boot_ms = (uint)3005082728U;
            p87.coordinate_frame = (MAV_FRAME)MAV_FRAME.MAV_FRAME_GLOBAL_TERRAIN_ALT;
            p87.type_mask = (ushort)(ushort)7668;
            p87.lat_int = (int) -723680747;
            p87.lon_int = (int)931505937;
            p87.alt = (float) -3.7526185E37F;
            p87.vx = (float) -1.6292687E38F;
            p87.vy = (float) -2.8847547E38F;
            p87.vz = (float)1.4915748E38F;
            p87.afx = (float) -2.3788536E38F;
            p87.afy = (float) -1.2523041E38F;
            p87.afz = (float) -2.5327746E38F;
            p87.yaw = (float) -1.2492296E38F;
            p87.yaw_rate = (float) -2.2757482E38F;
            ...
            PH.setPack(p89);
            p89.time_boot_ms = (uint)1223305237U;
            p89.x = (float)5.8862595E37F;
            p89.y = (float)2.6095545E38F;
            p89.z = (float) -1.2974751E38F;
            p89.roll = (float) -2.230494E38F;
            p89.pitch = (float)2.8140683E38F;
            p89.yaw = (float)8.547087E37F;
            CommunicationChannel.instance.send(p89); //===============================
            HIL_STATE p90 = CommunicationChannel.new_HIL_STATE();
            PH.setPack(p90);
            p90.time_usec = (ulong)4758194931171060435L;
            p90.roll = (float) -1.1006491E38F;
            p90.pitch = (float) -5.8438885E37F;
            p90.yaw = (float)1.4023889E38F;
            p90.rollspeed = (float)2.3605396E38F;
            p90.pitchspeed = (float) -1.2865738E38F;
            p90.yawspeed = (float)2.0434952E37F;
            p90.lat = (int) -1198787965;
            p90.lon = (int)2112507796;
            p90.alt = (int)1368059669;
            p90.vx = (short)(short) -23139;
            p90.vy = (short)(short)9723;
            p90.vz = (short)(short) -7400;
            p90.xacc = (short)(short)24378;
            p90.yacc = (short)(short)11028;
            p90.zacc = (short)(short) -10808;
            CommunicationChannel.instance.send(p90); //===============================
            HIL_CONTROLS p91 = CommunicationChannel.new_HIL_CONTROLS();
            PH.setPack(p91);
            p91.time_usec = (ulong)6742161334281251453L;
            p91.roll_ailerons = (float)3.371811E38F;
            p91.pitch_elevator = (float) -2.1261287E38F;
            p91.yaw_rudder = (float) -2.9517672E38F;
            p91.throttle = (float)6.491877E37F;
            p91.aux1 = (float)1.2972696E38F;
            p91.aux2 = (float) -1.0888315E38F;
            p91.aux3 = (float)1.1739792E38F;
            p91.aux4 = (float)2.5789569E38F;
            p91.mode = (MAV_MODE)MAV_MODE.MAV_MODE_AUTO_DISARMED;
            p91.nav_mode = (byte)(byte)207;
            CommunicationChannel.instance.send(p91); //===============================
            HIL_RC_INPUTS_RAW p92 = CommunicationChannel.new_HIL_RC_INPUTS_RAW();
            PH.setPack(p92);
            p92.time_usec = (ulong)8245023950677260912L;
            p92.chan1_raw = (ushort)(ushort)23319;
            p92.chan2_raw = (ushort)(ushort)11000;
            p92.chan3_raw = (ushort)(ushort)7752;
            p92.chan4_raw = (ushort)(ushort)22105;
            p92.chan5_raw = (ushort)(ushort)60626;
            p92.chan6_raw = (ushort)(ushort)32570;
            p92.chan7_raw = (ushort)(ushort)46606;
            p92.chan8_raw = (ushort)(ushort)16234;
            p92.chan9_raw = (ushort)(ushort)18505;
            p92.chan10_raw = (ushort)(ushort)30458;
            p92.chan11_raw = (ushort)(ushort)27469;
            p92.chan12_raw = (ushort)(ushort)42975;
            ...
            PH.setPack(p93);
            p93.time_usec = (ulong)3429366567484822442L;
            p93.controls_SET(new float[16], 0);
            p93.mode = (MAV_MODE)MAV_MODE.MAV_MODE_GUIDED_DISARMED;
            p93.flags = (ulong)7026110073677705058L;
            CommunicationChannel.instance.send(p93); //===============================
            OPTICAL_FLOW p100 = CommunicationChannel.new_OPTICAL_FLOW();
            PH.setPack(p100);
            p100.time_usec = (ulong)933394004219727560L;
            p100.sensor_id = (byte)(byte)102;
            p100.flow_x = (short)(short) -13620;
            p100.flow_y = (short)(short)20400;
            p100.flow_comp_m_x = (float)8.937002E37F;
            p100.flow_comp_m_y = (float) -2.1021073E38F;
            p100.quality = (byte)(byte)23;
            p100.ground_distance = (float)1.7261834E37F;
            p100.flow_rate_x_SET((float)2.7609602E38F, PH);
            p100.flow_rate_y_SET((float)1.0662296E38F, PH);
            ...
            PH.setPack(p101);
            p101.usec = (ulong)1534781390671984066L;
            p101.x = (float) -2.0892145E38F;
            p101.y = (float)3.0217354E38F;
            p101.z = (float)4.835643E37F;
            p101.roll = (float) -3.247181E38F;
            p101.pitch = (float) -5.592084E37F;
            p101.yaw = (float) -1.4351305E38F;
            CommunicationChannel.instance.send(p101); //===============================
            VISION_POSITION_ESTIMATE p102 = CommunicationChannel.new_VISION_POSITION_ESTIMATE();
            PH.setPack(p102);
            p102.usec = (ulong)7238991188038850602L;
            p102.x = (float)1.3965421E38F;
            p102.y = (float) -5.1388395E37F;
            p102.z = (float) -3.2914915E38F;
            p102.roll = (float) -1.9127884E38F;
            p102.pitch = (float)6.818451E37F;
            p102.yaw = (float) -1.5942779E38F;
            CommunicationChannel.instance.send(p102); //===============================
            VISION_SPEED_ESTIMATE p103 = CommunicationChannel.new_VISION_SPEED_ESTIMATE();
            PH.setPack(p103);
            p103.usec = (ulong)3994372631353173791L;
            p103.x = (float)2.824217E38F;
            p103.y = (float)3.3566502E38F;
            p103.z = (float) -1.0021993E38F;
            CommunicationChannel.instance.send(p103); //===============================
            VICON_POSITION_ESTIMATE p104 = CommunicationChannel.new_VICON_POSITION_ESTIMATE();
            PH.setPack(p104);
            p104.usec = (ulong)6187378486358923872L;
            p104.x = (float) -2.2583788E38F;
            p104.y = (float)5.672177E37F;
            p104.z = (float)2.826638E38F;
            p104.roll = (float) -1.2772528E38F;
            p104.pitch = (float) -1.9258079E38F;
            p104.yaw = (float)3.1698853E38F;
            CommunicationChannel.instance.send(p104); //===============================
            HIGHRES_IMU p105 = CommunicationChannel.new_HIGHRES_IMU();
            PH.setPack(p105);
            p105.time_usec = (ulong)3196840608618006082L;
            p105.xacc = (float)9.644348E37F;
            p105.yacc = (float) -1.1307561E38F;
            p105.zacc = (float) -8.017126E37F;
            p105.xgyro = (float) -2.1869025E38F;
            p105.ygyro = (float) -2.508746E38F;
            p105.zgyro = (float) -1.8645306E37F;
            p105.xmag = (float) -4.2393322E37F;
            p105.ymag = (float)1.00658406E36F;
            p105.zmag = (float) -1.8289375E38F;
            p105.abs_pressure = (float)1.3040763E38F;
            p105.diff_pressure = (float)7.7224347E37F;
            p105.pressure_alt = (float)2.5521689E38F;
            p105.temperature = (float) -6.631252E37F;
            p105.fields_updated = (ushort)(ushort)12737;
            CommunicationChannel.instance.send(p105); //===============================
            OPTICAL_FLOW_RAD p106 = CommunicationChannel.new_OPTICAL_FLOW_RAD();
            PH.setPack(p106);
            p106.time_usec = (ulong)9150894145202667183L;
            p106.sensor_id = (byte)(byte)56;
            p106.integration_time_us = (uint)3163655614U;
            p106.integrated_x = (float) -2.6856715E38F;
            p106.integrated_y = (float) -1.6624532E38F;
            p106.integrated_xgyro = (float) -3.3646708E38F;
            p106.integrated_ygyro = (float)5.1567437E36F;
            p106.integrated_zgyro = (float) -1.5331614E38F;
            p106.temperature = (short)(short)20434;
            p106.quality = (byte)(byte)27;
            p106.time_delta_distance_us = (uint)3980117877U;
            p106.distance = (float) -1.3262055E38F;
            CommunicationChannel.instance.send(p106); //===============================
            HIL_SENSOR p107 = CommunicationChannel.new_HIL_SENSOR();
            PH.setPack(p107);
            p107.time_usec = (ulong)3420088775680719422L;
            p107.xacc = (float) -3.8292758E37F;
            p107.yacc = (float) -3.3241993E38F;
            p107.zacc = (float) -3.3347155E38F;
            p107.xgyro = (float)7.882447E37F;
            p107.ygyro = (float) -2.172886E38F;
            p107.zgyro = (float)2.9757946E38F;
            p107.xmag = (float) -3.2317369E38F;
            p107.ymag = (float)5.543084E37F;
            p107.zmag = (float)1.603196E38F;
            p107.abs_pressure = (float) -2.2204657E38F;
            p107.diff_pressure = (float)1.2457774E38F;
            p107.pressure_alt = (float) -9.145938E37F;
            p107.temperature = (float) -4.3133586E37F;
            p107.fields_updated = (uint)536264321U;
            CommunicationChannel.instance.send(p107); //===============================
            SIM_STATE p108 = CommunicationChannel.new_SIM_STATE();
            PH.setPack(p108);
            p108.q1 = (float)3.3622371E38F;
            p108.q2 = (float)3.2278806E38F;
            p108.q3 = (float)9.730657E37F;
            p108.q4 = (float)3.2969864E38F;
            p108.roll = (float) -2.6452931E38F;
            p108.pitch = (float) -6.3034763E37F;
            p108.yaw = (float) -3.1499625E38F;
            p108.xacc = (float) -5.290373E37F;
            p108.yacc = (float)2.0338209E38F;
            p108.zacc = (float) -4.3437006E37F;
            p108.xgyro = (float)1.6409928E38F;
            p108.ygyro = (float) -6.633402E37F;
            p108.zgyro = (float)4.4698466E37F;
            p108.lat = (float) -1.8345904E38F;
            p108.lon = (float)3.2146565E38F;
            p108.alt = (float) -1.6879001E38F;
            p108.std_dev_horz = (float)1.8663338E38F;
            p108.std_dev_vert = (float)5.5015164E37F;
            p108.vn = (float)3.3168114E38F;
            p108.ve = (float) -2.6858897E37F;
            p108.vd = (float) -9.959481E36F;
            CommunicationChannel.instance.send(p108); //===============================
            RADIO_STATUS p109 = CommunicationChannel.new_RADIO_STATUS();
            PH.setPack(p109);
            p109.rssi = (byte)(byte)163;
            p109.remrssi = (byte)(byte)107;
            p109.txbuf = (byte)(byte)8;
            p109.noise = (byte)(byte)191;
            p109.remnoise = (byte)(byte)221;
            p109.rxerrors = (ushort)(ushort)43822;
            p109.fixed_ = (ushort)(ushort)24882;
            CommunicationChannel.instance.send(p109); //===============================
            FILE_TRANSFER_PROTOCOL p110 = CommunicationChannel.new_FILE_TRANSFER_PROTOCOL();
            PH.setPack(p110);
            p110.target_network = (byte)(byte)164;
            p110.target_system = (byte)(byte)67;
            p110.target_component = (byte)(byte)245;
            p110.payload_SET(new byte[251], 0);
            CommunicationChannel.instance.send(p110); //===============================
            TIMESYNC p111 = CommunicationChannel.new_TIMESYNC();
            PH.setPack(p111);
            p111.tc1 = (long) -3789646570619407700L;
            p111.ts1 = (long)6831352105711082733L;
            CommunicationChannel.instance.send(p111); //===============================
            CAMERA_TRIGGER p112 = CommunicationChannel.new_CAMERA_TRIGGER();
            PH.setPack(p112);
            p112.time_usec = (ulong)1845098147546807330L;
            p112.seq = (uint)2896093688U;
            CommunicationChannel.instance.send(p112); //===============================
            HIL_GPS p113 = CommunicationChannel.new_HIL_GPS();
            PH.setPack(p113);
            p113.time_usec = (ulong)6150530479915104743L;
            p113.fix_type = (byte)(byte)2;
            p113.lat = (int)420452992;
            p113.lon = (int) -438517996;
            p113.alt = (int)1402612111;
            p113.eph = (ushort)(ushort)39255;
            p113.epv = (ushort)(ushort)28759;
            p113.vel = (ushort)(ushort)16245;
            p113.vn = (short)(short)22633;
            p113.ve = (short)(short)4611;
            p113.vd = (short)(short) -9015;
            p113.cog = (ushort)(ushort)24598;
            p113.satellites_visible = (byte)(byte)222;
            CommunicationChannel.instance.send(p113); //===============================
            HIL_OPTICAL_FLOW p114 = CommunicationChannel.new_HIL_OPTICAL_FLOW();
            PH.setPack(p114);
            p114.time_usec = (ulong)127736947760747314L;
            p114.sensor_id = (byte)(byte)136;
            p114.integration_time_us = (uint)1089312077U;
            p114.integrated_x = (float) -6.6026585E37F;
            p114.integrated_y = (float)4.910725E37F;
            p114.integrated_xgyro = (float)2.1083768E38F;
            p114.integrated_ygyro = (float) -1.0758197E38F;
            p114.integrated_zgyro = (float) -2.9339455E38F;
            p114.temperature = (short)(short) -1133;
            p114.quality = (byte)(byte)153;
            p114.time_delta_distance_us = (uint)2326578219U;
            p114.distance = (float)3.4493346E37F;
            CommunicationChannel.instance.send(p114); //===============================
            HIL_STATE_QUATERNION p115 = CommunicationChannel.new_HIL_STATE_QUATERNION();
            PH.setPack(p115);
            p115.time_usec = (ulong)6809384645785337622L;
            p115.attitude_quaternion_SET(new float[4], 0);
            p115.rollspeed = (float)5.0892156E37F;
            p115.pitchspeed = (float) -1.2910272E38F;
            p115.yawspeed = (float) -1.0709512E38F;
            p115.lat = (int)1148490415;
            p115.lon = (int)1725155817;
            p115.alt = (int)1939242774;
            p115.vx = (short)(short) -11862;
            p115.vy = (short)(short) -21512;
            p115.vz = (short)(short) -5718;
            p115.ind_airspeed = (ushort)(ushort)3439;
            p115.true_airspeed = (ushort)(ushort)23041;
            p115.xacc = (short)(short)26658;
            p115.yacc = (short)(short) -29915;
            p115.zacc = (short)(short)31744;
            CommunicationChannel.instance.send(p115); //===============================
            SCALED_IMU2 p116 = CommunicationChannel.new_SCALED_IMU2();
            PH.setPack(p116);
            p116.time_boot_ms = (uint)2151051931U;
            p116.xacc = (short)(short) -10163;
            p116.yacc = (short)(short) -5118;
            p116.zacc = (short)(short) -22876;
            p116.xgyro = (short)(short)10093;
            p116.ygyro = (short)(short) -30168;
            p116.zgyro = (short)(short) -4623;
            p116.xmag = (short)(short)24959;
            p116.ymag = (short)(short)30059;
            p116.zmag = (short)(short)6216;
            ...
            p117.start = (ushort)(ushort)28477;
            p117.end = (ushort)(ushort)8940;
            CommunicationChannel.instance.send(p117); //===============================
            LOG_ENTRY p118 = CommunicationChannel.new_LOG_ENTRY();
            PH.setPack(p118);
            p118.id = (ushort)(ushort)42884;
            p118.num_logs = (ushort)(ushort)48625;
            p118.last_log_num = (ushort)(ushort)57077;
            p118.time_utc = (uint)1998561217U;
            p118.size = (uint)819823543U;
            CommunicationChannel.instance.send(p118); //===============================
            LOG_REQUEST_DATA p119 = CommunicationChannel.new_LOG_REQUEST_DATA();
            PH.setPack(p119);
            p119.target_system = (byte)(byte)11;
            p119.target_component = (byte)(byte)14;
            p119.id = (ushort)(ushort)53658;
            p119.ofs = (uint)3966236709U;
            p119.count = (uint)3389925768U;
            CommunicationChannel.instance.send(p119); //===============================
            LOG_DATA p120 = CommunicationChannel.new_LOG_DATA();
            PH.setPack(p120);
            p120.id = (ushort)(ushort)64603;
            p120.ofs = (uint)1947922600U;
            p120.count = (byte)(byte)38;
            p120.data__SET(new byte[90], 0);
            CommunicationChannel.instance.send(p120); //===============================
            LOG_ERASE p121 = CommunicationChannel.new_LOG_ERASE();
            PH.setPack(p121);
            p121.target_system = (byte)(byte)77;
            p121.target_component = (byte)(byte)103;
            CommunicationChannel.instance.send(p121); //===============================
            LOG_REQUEST_END p122 = CommunicationChannel.new_LOG_REQUEST_END();
            PH.setPack(p122);
            p122.target_system = (byte)(byte)205;
            p122.target_component = (byte)(byte)209;
            CommunicationChannel.instance.send(p122); //===============================
            GPS_INJECT_DATA p123 = CommunicationChannel.new_GPS_INJECT_DATA();
            PH.setPack(p123);
            p123.target_system = (byte)(byte)178;
            p123.target_component = (byte)(byte)214;
            p123.len = (byte)(byte)231;
            p123.data__SET(new byte[110], 0);
            CommunicationChannel.instance.send(p123); //===============================
            GPS2_RAW p124 = CommunicationChannel.new_GPS2_RAW();
            PH.setPack(p124);
            p124.time_usec = (ulong)6232377125208259237L;
            p124.fix_type = (GPS_FIX_TYPE)GPS_FIX_TYPE.GPS_FIX_TYPE_RTK_FIXED;
            p124.lat = (int) -153249856;
            p124.lon = (int)1968356171;
            p124.alt = (int)272053522;
            p124.eph = (ushort)(ushort)57199;
            p124.epv = (ushort)(ushort)33925;
            p124.vel = (ushort)(ushort)26711;
            p124.cog = (ushort)(ushort)17891;
            p124.satellites_visible = (byte)(byte)250;
            p124.dgps_numch = (byte)(byte)227;
            p124.dgps_age = (uint)2047175813U;
            CommunicationChannel.instance.send(p124); //===============================
            POWER_STATUS p125 = CommunicationChannel.new_POWER_STATUS();
            PH.setPack(p125);
            p125.Vcc = (ushort)(ushort)1038;
            p125.Vservo = (ushort)(ushort)6274;
            ...
            p126.timeout = (ushort)(ushort)21135;
            p126.baudrate = (uint)1663903093U;
            p126.count = (byte)(byte)72;
            p126.data__SET(new byte[70], 0);
            CommunicationChannel.instance.send(p126); //===============================
            GPS_RTK p127 = CommunicationChannel.new_GPS_RTK();
            PH.setPack(p127);
            p127.time_last_baseline_ms = (uint)3381289872U;
            p127.rtk_receiver_id = (byte)(byte)190;
            p127.wn = (ushort)(ushort)18047;
            p127.tow = (uint)3006981880U;
            p127.rtk_health = (byte)(byte)29;
            p127.rtk_rate = (byte)(byte)184;
            p127.nsats = (byte)(byte)33;
            p127.baseline_coords_type = (byte)(byte)193;
            p127.baseline_a_mm = (int) -460095431;
            p127.baseline_b_mm = (int) -1924442180;
            p127.baseline_c_mm = (int)1066970515;
            p127.accuracy = (uint)3645763445U;
            p127.iar_num_hypotheses = (int) -1312997484;
            CommunicationChannel.instance.send(p127); //===============================
            GPS2_RTK p128 = CommunicationChannel.new_GPS2_RTK();
            PH.setPack(p128);
            p128.time_last_baseline_ms = (uint)2528686907U;
            p128.rtk_receiver_id = (byte)(byte)117;
            p128.wn = (ushort)(ushort)42099;
            p128.tow = (uint)3124283662U;
            p128.rtk_health = (byte)(byte)56;
            p128.rtk_rate = (byte)(byte)176;
            p128.nsats = (byte)(byte)212;
            p128.baseline_coords_type = (byte)(byte)55;
            p128.baseline_a_mm = (int) -1802562851;
            p128.baseline_b_mm = (int) -1319329587;
            p128.baseline_c_mm = (int) -662092905;
            p128.accuracy = (uint)1534362163U;
            p128.iar_num_hypotheses = (int) -314228877;
            CommunicationChannel.instance.send(p128); //===============================
            SCALED_IMU3 p129 = CommunicationChannel.new_SCALED_IMU3();
            PH.setPack(p129);
            p129.time_boot_ms = (uint)845123714U;
            p129.xacc = (short)(short)11425;
            p129.yacc = (short)(short) -10287;
            p129.zacc = (short)(short) -2517;
            p129.xgyro = (short)(short)18277;
            p129.ygyro = (short)(short) -20857;
            p129.zgyro = (short)(short)14765;
            p129.xmag = (short)(short)15298;
            p129.ymag = (short)(short)6632;
            p129.zmag = (short)(short)6196;
            CommunicationChannel.instance.send(p129); //===============================
            DATA_TRANSMISSION_HANDSHAKE p130 = CommunicationChannel.new_DATA_TRANSMISSION_HANDSHAKE();
            PH.setPack(p130);
            p130.type = (byte)(byte)153;
            p130.size = (uint)2791443579U;
            p130.width = (ushort)(ushort)18635;
            p130.height = (ushort)(ushort)33721;
            p130.packets = (ushort)(ushort)26845;
            p130.payload = (byte)(byte)140;
            p130.jpg_quality = (byte)(byte)105;
            CommunicationChannel.instance.send(p130); //===============================
            ENCAPSULATED_DATA p131 = CommunicationChannel.new_ENCAPSULATED_DATA();
            PH.setPack(p131);
            p131.seqnr = (ushort)(ushort)64710;
            p131.data__SET(new byte[253], 0);
            CommunicationChannel.instance.send(p131); //===============================
            DISTANCE_SENSOR p132 = CommunicationChannel.new_DISTANCE_SENSOR();
            PH.setPack(p132);
            p132.time_boot_ms = (uint)1895022955U;
            p132.min_distance = (ushort)(ushort)5738;
            p132.max_distance = (ushort)(ushort)35791;
            p132.current_distance = (ushort)(ushort)9985;
            p132.type = (MAV_DISTANCE_SENSOR)MAV_DISTANCE_SENSOR.MAV_DISTANCE_SENSOR_RADAR;
            p132.id = (byte)(byte)170;
            p132.orientation = (MAV_SENSOR_ORIENTATION)MAV_SENSOR_ORIENTATION.MAV_SENSOR_ROTATION_PITCH_180_YAW_90;
            p132.covariance = (byte)(byte)72;
            CommunicationChannel.instance.send(p132); //===============================
            TERRAIN_REQUEST p133 = CommunicationChannel.new_TERRAIN_REQUEST();
            PH.setPack(p133);
            p133.lat = (int)846461362;
            p133.lon = (int) -164842711;
            p133.grid_spacing = (ushort)(ushort)21943;
            p133.mask = (ulong)8217565185481518863L;
            CommunicationChannel.instance.send(p133); //===============================
            TERRAIN_DATA p134 = CommunicationChannel.new_TERRAIN_DATA();
            PH.setPack(p134);
            p134.lat = (int)433080966;
            p134.lon = (int)664016312;
            p134.grid_spacing = (ushort)(ushort)60483;
            p134.gridbit = (byte)(byte)203;
            p134.data__SET(new short[16], 0);
            CommunicationChannel.instance.send(p134); //===============================
            TERRAIN_CHECK p135 = CommunicationChannel.new_TERRAIN_CHECK();
            PH.setPack(p135);
            p135.lat = (int) -708851266;
            p135.lon = (int) -600486054;
            CommunicationChannel.instance.send(p135); //===============================
            TERRAIN_REPORT p136 = CommunicationChannel.new_TERRAIN_REPORT();
            PH.setPack(p136);
            p136.lat = (int)1217134445;
            p136.lon = (int) -959594809;
            p136.spacing = (ushort)(ushort)29760;
            p136.terrain_height = (float) -1.681712E38F;
            p136.current_height = (float)7.5633896E37F;
            p136.pending = (ushort)(ushort)59219;
            p136.loaded = (ushort)(ushort)15321;
            CommunicationChannel.instance.send(p136); //===============================
            SCALED_PRESSURE2 p137 = CommunicationChannel.new_SCALED_PRESSURE2();
            PH.setPack(p137);
            p137.time_boot_ms = (uint)3705075683U;
            p137.press_abs = (float)2.7795235E38F;
            p137.press_diff = (float)2.1992077E38F;
            p137.temperature = (short)(short) -21058;
            CommunicationChannel.instance.send(p137); //===============================
            ATT_POS_MOCAP p138 = CommunicationChannel.new_ATT_POS_MOCAP();
            PH.setPack(p138);
            p138.time_usec = (ulong)5967199407992864093L;
            p138.q_SET(new float[4], 0);
            p138.x = (float) -3.5720056E37F;
            p138.y = (float) -3.0028763E38F;
            p138.z = (float) -5.3169155E37F;
            CommunicationChannel.instance.send(p138); //===============================
            SET_ACTUATOR_CONTROL_TARGET p139 = CommunicationChannel.new_SET_ACTUATOR_CONTROL_TARGET();
            PH.setPack(p139);
            p139.time_usec = (ulong)3141604062869566810L;
            p139.group_mlx = (byte)(byte)40;
            p139.target_system = (byte)(byte)222;
            p139.target_component = (byte)(byte)131;
            p139.controls_SET(new float[8], 0);
            CommunicationChannel.instance.send(p139); //===============================
            ACTUATOR_CONTROL_TARGET p140 = CommunicationChannel.new_ACTUATOR_CONTROL_TARGET();
            PH.setPack(p140);
            p140.time_usec = (ulong)2873022351282820464L;
            p140.group_mlx = (byte)(byte)57;
            p140.controls_SET(new float[8], 0);
            CommunicationChannel.instance.send(p140); //===============================
            ALTITUDE p141 = CommunicationChannel.new_ALTITUDE();
            PH.setPack(p141);
            p141.time_usec = (ulong)4883913382498560499L;
            p141.altitude_monotonic = (float) -2.5659603E38F;
            p141.altitude_amsl = (float)1.5089057E38F;
            p141.altitude_local = (float)2.3871926E38F;
            p141.altitude_relative = (float)2.9563742E38F;
            p141.altitude_terrain = (float) -1.3076972E38F;
            p141.bottom_clearance = (float) -3.362867E38F;
            ...
            PH.setPack(p143);
            p143.time_boot_ms = (uint)3681215948U;
            p143.press_abs = (float) -1.2523784E38F;
            p143.press_diff = (float)2.5258983E38F;
            p143.temperature = (short)(short) -16568;
            CommunicationChannel.instance.send(p143); //===============================
            FOLLOW_TARGET p144 = CommunicationChannel.new_FOLLOW_TARGET();
            PH.setPack(p144);
            p144.timestamp = (ulong)5732781965965530947L;
            p144.est_capabilities = (byte)(byte)140;
            p144.lat = (int)617774060;
            p144.lon = (int)1872557296;
            p144.alt = (float)1.6446595E38F;
            p144.vel_SET(new float[3], 0);
            p144.acc_SET(new float[3], 0);
            p144.attitude_q_SET(new float[4], 0);
            p144.rates_SET(new float[3], 0);
            p144.position_cov_SET(new float[3], 0);
            p144.custom_state = (ulong)4311650900394946744L;
            CommunicationChannel.instance.send(p144); //===============================
            CONTROL_SYSTEM_STATE p146 = CommunicationChannel.new_CONTROL_SYSTEM_STATE();
            PH.setPack(p146);
            p146.time_usec = (ulong)8650461925175632626L;
            p146.x_acc = (float)2.7959973E38F;
            p146.y_acc = (float)4.088404E37F;
            p146.z_acc = (float)1.7109507E38F;
            p146.x_vel = (float) -2.4522784E38F;
            p146.y_vel = (float) -2.7759656E38F;
            p146.z_vel = (float)3.1595362E38F;
            p146.x_pos = (float)3.217743E38F;
            p146.y_pos = (float)2.0485714E38F;
            p146.z_pos = (float)3.1241766E38F;
            p146.airspeed = (float)1.4135722E38F;
            p146.vel_variance_SET(new float[3], 0);
            p146.pos_variance_SET(new float[3], 0);
            p146.q_SET(new float[4], 0);
            p146.roll_rate = (float) -1.4467021E38F;
            p146.pitch_rate = (float)2.1188597E38F;
            p146.yaw_rate = (float)1.8498148E38F;
            CommunicationChannel.instance.send(p146); //===============================
            BATTERY_STATUS p147 = CommunicationChannel.new_BATTERY_STATUS();
            PH.setPack(p147);
            p147.id = (byte)(byte)227;
            ...
            p147.temperature = (short)(short)17061;
            p147.voltages_SET(new ushort[10], 0);
            p147.current_battery = (short)(short) -30740;
            p147.current_consumed = (int)1142578483;
            p147.energy_consumed = (int)1970492960;
            p147.battery_remaining = (sbyte)(sbyte) - 104;
            ...
            p148.flight_sw_version = (uint)2011260883U;
            p148.middleware_sw_version = (uint)1306402565U;
            p148.os_sw_version = (uint)3939938821U;
            p148.board_version = (uint)4094970418U;
            ...
            p148.vendor_id = (ushort)(ushort)43248;
            p148.product_id = (ushort)(ushort)58697;
            p148.uid = (ulong)5753814862357673619L;
            p148.uid2_SET(new byte[18], 0, PH);
            CommunicationChannel.instance.send(p148); //===============================
            LANDING_TARGET p149 = CommunicationChannel.new_LANDING_TARGET();
            PH.setPack(p149);
            p149.time_usec = (ulong)8845146094474058117L;
            p149.target_num = (byte)(byte)68;
            p149.frame = (MAV_FRAME)MAV_FRAME.MAV_FRAME_LOCAL_NED;
            p149.angle_x = (float)3.036724E38F;
            p149.angle_y = (float) -2.4993865E38F;
            p149.distance = (float)2.8595358E38F;
            p149.size_x = (float) -1.2006605E38F;
            p149.size_y = (float) -2.6865887E38F;
            p149.x_SET((float) -2.2374859E38F, PH);
            p149.y_SET((float)2.9319184E38F, PH);
            p149.z_SET((float) -3.3684038E38F, PH);
            p149.q_SET(new float[4], 0, PH);
            p149.type = (LANDING_TARGET_TYPE)LANDING_TARGET_TYPE.LANDING_TARGET_TYPE_RADIO_BEACON;
            p149.position_valid_SET((byte)(byte)84, PH);
            CommunicationChannel.instance.send(p149); //===============================
            ESTIMATOR_STATUS p230 = CommunicationChannel.new_ESTIMATOR_STATUS();
            PH.setPack(p230);
            p230.time_usec = (ulong)6352590170482807128L;
            p230.flags = (ESTIMATOR_STATUS_FLAGS)ESTIMATOR_STATUS_FLAGS.ESTIMATOR_CONST_POS_MODE;
            p230.vel_ratio = (float)2.3026688E37F;
            p230.pos_horiz_ratio = (float) -1.0638777E38F;
            p230.pos_vert_ratio = (float) -1.7132089E38F;
            p230.mag_ratio = (float)1.5813112E38F;
            p230.hagl_ratio = (float)2.6990936E38F;
            p230.tas_ratio = (float)1.5408476E38F;
            p230.pos_horiz_accuracy = (float)1.7900399E38F;
            p230.pos_vert_accuracy = (float) -2.3227223E38F;
            CommunicationChannel.instance.send(p230); //===============================
            WIND_COV p231 = CommunicationChannel.new_WIND_COV();
            PH.setPack(p231);
            p231.time_usec = (ulong)3380621244720319164L;
            p231.wind_x = (float) -3.9922597E37F;
            p231.wind_y = (float)3.3645203E38F;
            p231.wind_z = (float)2.1932816E38F;
            p231.var_horiz = (float) -1.2736937E38F;
            p231.var_vert = (float)4.2994677E37F;
            p231.wind_alt = (float) -1.1134502E38F;
            p231.horiz_accuracy = (float)1.1527987E38F;
            p231.vert_accuracy = (float) -2.6762562E38F;
            CommunicationChannel.instance.send(p231); //===============================
            GPS_INPUT p232 = CommunicationChannel.new_GPS_INPUT();
            PH.setPack(p232);
            p232.time_usec = (ulong)176534208480249183L;
            p232.gps_id = (byte)(byte)81;
            p232.ignore_flags = (GPS_INPUT_IGNORE_FLAGS)GPS_INPUT_IGNORE_FLAGS.GPS_INPUT_IGNORE_FLAG_VEL_VERT;
            p232.time_week_ms = (uint)2477695664U;
            p232.time_week = (ushort)(ushort)30485;
            p232.fix_type = (byte)(byte)183;
            p232.lat = (int) -88203098;
            p232.lon = (int)107284338;
            p232.alt = (float)2.0843802E38F;
            p232.hdop = (float)2.4924556E37F;
            p232.vdop = (float) -2.3559493E38F;
            p232.vn = (float)9.109783E37F;
            p232.ve = (float)1.2388603E38F;
            p232.vd = (float)2.6705798E37F;
            p232.speed_accuracy = (float)1.823891E38F;
            p232.horiz_accuracy = (float)2.6565117E38F;
            p232.vert_accuracy = (float) -2.9226886E37F;
            p232.satellites_visible = (byte)(byte)246;
            CommunicationChannel.instance.send(p232); //===============================
            GPS_RTCM_DATA p233 = CommunicationChannel.new_GPS_RTCM_DATA();
            PH.setPack(p233);
            p233.flags = (byte)(byte)202;
            ...
            p234.custom_mode = (uint)4097292121U;
            p234.landed_state = (MAV_LANDED_STATE)MAV_LANDED_STATE.MAV_LANDED_STATE_UNDEFINED;
            p234.roll = (short)(short)13073;
            p234.pitch = (short)(short) -23478;
            p234.heading = (ushort)(ushort)25629;
            p234.throttle = (sbyte)(sbyte)48;
            p234.heading_sp = (short)(short) -31276;
            p234.latitude = (int) -1952100649;
            p234.longitude = (int)2107691337;
            p234.altitude_amsl = (short)(short) -5638;
            p234.altitude_sp = (short)(short)6325;
            p234.airspeed = (byte)(byte)104;
            p234.airspeed_sp = (byte)(byte)91;
            p234.groundspeed = (byte)(byte)86;
            p234.climb_rate = (sbyte)(sbyte)36;
            p234.gps_nsat = (byte)(byte)240;
            p234.gps_fix_type = (GPS_FIX_TYPE)GPS_FIX_TYPE.GPS_FIX_TYPE_3D_FIX;
            p234.battery_remaining = (byte)(byte)16;
            p234.temperature = (sbyte)(sbyte)11;
            p234.temperature_air = (sbyte)(sbyte)31;
            p234.failsafe = (byte)(byte)21;
            p234.wp_num = (byte)(byte)79;
            p234.wp_distance = (ushort)(ushort)47029;
            CommunicationChannel.instance.send(p234); //===============================
            VIBRATION p241 = CommunicationChannel.new_VIBRATION();
            PH.setPack(p241);
            p241.time_usec = (ulong)1963339040836334592L;
            p241.vibration_x = (float) -2.033109E38F;
            p241.vibration_y = (float) -2.1594101E38F;
            p241.vibration_z = (float)3.3079637E38F;
            p241.clipping_0 = (uint)3031546035U;
            p241.clipping_1 = (uint)3529254144U;
            p241.clipping_2 = (uint)3950664711U;
            CommunicationChannel.instance.send(p241); //===============================
            HOME_POSITION p242 = CommunicationChannel.new_HOME_POSITION();
            PH.setPack(p242);
            p242.latitude = (int) -116797783;
            p242.longitude = (int)1763010490;
            p242.altitude = (int)1349084556;
            p242.x = (float) -2.4684062E38F;
            p242.y = (float) -1.5432431E38F;
            p242.z = (float) -1.033834E38F;
            p242.q_SET(new float[4], 0);
            p242.approach_x = (float) -1.6145726E38F;
            p242.approach_y = (float) -2.9927273E38F;
            p242.approach_z = (float)1.7469055E38F;
            p242.time_usec_SET((ulong)920920809481912991L, PH);
            CommunicationChannel.instance.send(p242); //===============================
            SET_HOME_POSITION p243 = CommunicationChannel.new_SET_HOME_POSITION();
            PH.setPack(p243);
            p243.target_system = (byte)(byte)241;
            p243.latitude = (int)1174977266;
            p243.longitude = (int) -1261003589;
            p243.altitude = (int) -1188629744;
            p243.x = (float)3.0677392E38F;
            p243.y = (float)2.7027197E38F;
            p243.z = (float) -2.766145E38F;
            p243.q_SET(new float[4], 0);
            p243.approach_x = (float)1.6765569E37F;
            p243.approach_y = (float)1.5875361E38F;
            p243.approach_z = (float)1.9392474E38F;
            p243.time_usec_SET((ulong)8582468219582408840L, PH);
            CommunicationChannel.instance.send(p243); //===============================
            MESSAGE_INTERVAL p244 = CommunicationChannel.new_MESSAGE_INTERVAL();
            PH.setPack(p244);
            p244.message_id = (ushort)(ushort)4094;
            p244.interval_us = (int) -450680522;
            ...
            PH.setPack(p246);
            p246.ICAO_address = (uint)2448256486U;
            p246.lat = (int) -399948364;
            p246.lon = (int) -224631516;
            p246.altitude_type = (ADSB_ALTITUDE_TYPE)ADSB_ALTITUDE_TYPE.ADSB_ALTITUDE_TYPE_PRESSURE_QNH;
            p246.altitude = (int) -1602684282;
            p246.heading = (ushort)(ushort)25337;
            p246.hor_velocity = (ushort)(ushort)11675;
            p246.ver_velocity = (short)(short) -32706;
            p246.callsign_SET("DEMO", PH);
            p246.emitter_type = (ADSB_EMITTER_TYPE)ADSB_EMITTER_TYPE.ADSB_EMITTER_TYPE_LIGHTER_AIR;
            p246.tslc = (byte)(byte)182;
            p246.flags = (ADSB_FLAGS)ADSB_FLAGS.ADSB_FLAGS_VALID_CALLSIGN;
            p246.squawk = (ushort)(ushort)37989;
            ...
            p247.time_to_minimum_delta = (float)3.803681E37F;
            p247.altitude_minimum_delta = (float)1.2876563E38F;
            p247.horizontal_minimum_delta = (float) -2.1640763E37F;
            CommunicationChannel.instance.send(p247); //===============================
            V2_EXTENSION p248 = CommunicationChannel.new_V2_EXTENSION();
            PH.setPack(p248);
            p248.target_network = (byte)(byte)97;
            p248.target_system = (byte)(byte)169;
            p248.target_component = (byte)(byte)152;
            p248.message_type = (ushort)(ushort)61000;
            p248.payload_SET(new byte[249], 0);
            CommunicationChannel.instance.send(p248); //===============================
            MEMORY_VECT p249 = CommunicationChannel.new_MEMORY_VECT();
            PH.setPack(p249);
            p249.address = (ushort)(ushort)14078;
            p249.ver = (byte)(byte)61;
            p249.type = (byte)(byte)131;
            p249.value_SET(new sbyte[32], 0);
            CommunicationChannel.instance.send(p249); //===============================
            DEBUG_VECT p250 = CommunicationChannel.new_DEBUG_VECT();
            PH.setPack(p250);
            p250.name_SET("DEMO", PH);
            p250.time_usec = (ulong)9204893503631241923L;
            p250.x = (float) -1.3058155E38F;
            p250.y = (float) -5.0202097E37F;
            p250.z = (float)2.357012E38F;
            CommunicationChannel.instance.send(p250); //===============================
            NAMED_VALUE_FLOAT p251 = CommunicationChannel.new_NAMED_VALUE_FLOAT();
            PH.setPack(p251);
            p251.time_boot_ms = (uint)584246841U;
            p251.name_SET("DEMO", PH);
            p251.value = (float) -5.9800885E37F;
            CommunicationChannel.instance.send(p251); //===============================
            NAMED_VALUE_INT p252 = CommunicationChannel.new_NAMED_VALUE_INT();
            PH.setPack(p252);
            p252.time_boot_ms = (uint)3568959690U;
            p252.name_SET("DEMO", PH);
            p252.value = (int) -272136536;
            ...
            PH.setPack(p254);
            p254.time_boot_ms = (uint)78891526U;
            p254.ind = (byte)(byte)140;
            p254.value = (float) -1.4061851E38F;
            ...
            p256.initial_timestamp = (ulong)3590349464335788841L;
            CommunicationChannel.instance.send(p256); //===============================
            BUTTON_CHANGE p257 = CommunicationChannel.new_BUTTON_CHANGE();
            PH.setPack(p257);
            p257.time_boot_ms = (uint)3163667154U;
            p257.last_change_ms = (uint)2105026387U;
            p257.state = (byte)(byte)74;
            CommunicationChannel.instance.send(p257); //===============================
            PLAY_TUNE p258 = CommunicationChannel.new_PLAY_TUNE();
            PH.setPack(p258);
            p258.target_system = (byte)(byte)173;
            p258.target_component = (byte)(byte)194;
            p258.tune_SET("DEMO", PH);
            CommunicationChannel.instance.send(p258); //===============================
            CAMERA_INFORMATION p259 = CommunicationChannel.new_CAMERA_INFORMATION();
            PH.setPack(p259);
            p259.time_boot_ms = (uint)4176832657U;
            p259.vendor_name_SET(new byte[32], 0);
            p259.model_name_SET(new byte[32], 0);
            p259.firmware_version = (uint)3678651246U;
            p259.focal_length = (float)2.6841579E38F;
            p259.sensor_size_h = (float) -1.6220002E38F;
            p259.sensor_size_v = (float) -4.9067165E37F;
            p259.resolution_h = (ushort)(ushort)57303;
            p259.resolution_v = (ushort)(ushort)14926;
            p259.lens_id = (byte)(byte)253;
            p259.flags = (CAMERA_CAP_FLAGS)CAMERA_CAP_FLAGS.CAMERA_CAP_FLAGS_CAN_CAPTURE_VIDEO_IN_IMAGE_MODE;
            p259.cam_definition_version = (ushort)(ushort)41663;
            p259.cam_definition_uri_SET("DEMO", PH);
            CommunicationChannel.instance.send(p259); //===============================
            CAMERA_SETTINGS p260 = CommunicationChannel.new_CAMERA_SETTINGS();
            PH.setPack(p260);
            p260.time_boot_ms = (uint)4160863354U;
            ...
            PH.setPack(p261);
            p261.time_boot_ms = (uint)3472797561U;
            p261.storage_id = (byte)(byte)197;
            p261.storage_count = (byte)(byte)232;
            p261.status = (byte)(byte)122;
            p261.total_capacity = (float)1.8641559E38F;
            p261.used_capacity = (float)9.360382E37F;
            p261.available_capacity = (float) -2.3782853E38F;
            p261.read_speed = (float)1.402459E38F;
            p261.write_speed = (float)2.7481677E38F;
            CommunicationChannel.instance.send(p261); //===============================
            CAMERA_CAPTURE_STATUS p262 = CommunicationChannel.new_CAMERA_CAPTURE_STATUS();
            PH.setPack(p262);
            p262.time_boot_ms = (uint)2761150406U;
            p262.image_status = (byte)(byte)157;
            p262.video_status = (byte)(byte)33;
            p262.image_interval = (float)1.1628498E38F;
            p262.recording_time_ms = (uint)2691651946U;
            p262.available_capacity = (float)1.1147341E38F;
            CommunicationChannel.instance.send(p262); //===============================
            CAMERA_IMAGE_CAPTURED p263 = CommunicationChannel.new_CAMERA_IMAGE_CAPTURED();
            PH.setPack(p263);
            p263.time_boot_ms = (uint)2648878851U;
            p263.time_utc = (ulong)6841796547921708741L;
            p263.camera_id = (byte)(byte)189;
            p263.lat = (int)365009463;
            p263.lon = (int)2088027644;
            p263.alt = (int) -1461649471;
            p263.relative_alt = (int)1420768104;
            p263.q_SET(new float[4], 0);
            p263.image_index = (int)2069388811;
            p263.capture_result = (sbyte)(sbyte)20;
            p263.file_url_SET("DEMO", PH);
            CommunicationChannel.instance.send(p263); //===============================
            FLIGHT_INFORMATION p264 = CommunicationChannel.new_FLIGHT_INFORMATION();
            PH.setPack(p264);
            p264.time_boot_ms = (uint)3367116435U;
            p264.arming_time_utc = (ulong)8596695961010512064L;
            p264.takeoff_time_utc = (ulong)5560054046033958727L;
            p264.flight_uuid = (ulong)1138137800890123844L;
            CommunicationChannel.instance.send(p264); //===============================
            MOUNT_ORIENTATION p265 = CommunicationChannel.new_MOUNT_ORIENTATION();
            PH.setPack(p265);
            p265.time_boot_ms = (uint)3912779949U;
            p265.roll = (float)2.3037801E38F;
            p265.pitch = (float) -6.7428095E37F;
            p265.yaw = (float)2.7144206E38F;
            CommunicationChannel.instance.send(p265); //===============================
            LOGGING_DATA p266 = CommunicationChannel.new_LOGGING_DATA();
            PH.setPack(p266);
            p266.target_system = (byte)(byte)217;
            p266.target_component = (byte)(byte)123;
            p266.sequence = (ushort)(ushort)36402;
            p266.length = (byte)(byte)6;
            p266.first_message_offset = (byte)(byte)53;
            p266.data__SET(new byte[249], 0);
            CommunicationChannel.instance.send(p266); //===============================
            LOGGING_DATA_ACKED p267 = CommunicationChannel.new_LOGGING_DATA_ACKED();
            PH.setPack(p267);
            p267.target_system = (byte)(byte)248;
            p267.target_component = (byte)(byte)167;
            p267.sequence = (ushort)(ushort)11562;
            ...
            PH.setPack(p268);
            p268.target_system = (byte)(byte)12;
            p268.target_component = (byte)(byte)226;
            p268.sequence = (ushort)(ushort)30616;
            CommunicationChannel.instance.send(p268); //===============================
            VIDEO_STREAM_INFORMATION p269 = CommunicationChannel.new_VIDEO_STREAM_INFORMATION();
            PH.setPack(p269);
            p269.camera_id = (byte)(byte)2;
            p269.status = (byte)(byte)199;
            p269.framerate = (float) -3.14091E38F;
            p269.resolution_h = (ushort)(ushort)52568;
            p269.resolution_v = (ushort)(ushort)3633;
            p269.bitrate = (uint)585119740U;
            p269.rotation = (ushort)(ushort)63311;
            ...
            p270.target_component = (byte)(byte)225;
            p270.camera_id = (byte)(byte)111;
            p270.framerate = (float) -9.229643E35F;
            p270.resolution_h = (ushort)(ushort)4802;
            p270.resolution_v = (ushort)(ushort)27397;
            p270.bitrate = (uint)2129184722U;
            p270.rotation = (ushort)(ushort)26805;
            ...
            PH.setPack(p300);
            p300.version = (ushort)(ushort)22384;
            p300.min_version = (ushort)(ushort)2879;
            p300.max_version = (ushort)(ushort)10813;
            ...
            PH.setPack(p310);
            p310.time_usec = (ulong)7711422906095198953L;
            p310.uptime_sec = (uint)329638629U;
            ...
            p310.vendor_specific_status_code = (ushort)(ushort)48949;
            CommunicationChannel.instance.send(p310); //===============================
            UAVCAN_NODE_INFO p311 = CommunicationChannel.new_UAVCAN_NODE_INFO();
            PH.setPack(p311);
            p311.time_usec = (ulong)5702667554469579714L;
            p311.uptime_sec = (uint)4035645041U;
            p311.name_SET("DEMO", PH);
            p311.hw_version_major = (byte)(byte)184;
            p311.hw_version_minor = (byte)(byte)8;
            p311.hw_unique_id_SET(new byte[16], 0);
            p311.sw_version_major = (byte)(byte)51;
            p311.sw_version_minor = (byte)(byte)61;
            p311.sw_vcs_commit = (uint)3558191414U;
            CommunicationChannel.instance.send(p311); //===============================
            PARAM_EXT_REQUEST_READ p320 = CommunicationChannel.new_PARAM_EXT_REQUEST_READ();
            PH.setPack(p320);
            p320.target_system = (byte)(byte)248;
            p320.target_component = (byte)(byte)202;
            p320.param_id_SET("DEMO", PH);
            p320.param_index = (short)(short)6978;
            ...
            p322.param_count = (ushort)(ushort)50821;
            p322.param_index = (ushort)(ushort)16826;
            CommunicationChannel.instance.send(p322); //===============================
            PARAM_EXT_SET p323 = CommunicationChannel.new_PARAM_EXT_SET();
            PH.setPack(p323);
            p323.target_system = (byte)(byte)40;
            p323.target_component = (byte)(byte)47;
            ...
            PH.setPack(p330);
            p330.time_usec = (ulong)286157162239702646L;
            p330.sensor_type = (MAV_DISTANCE_SENSOR)MAV_DISTANCE_SENSOR.MAV_DISTANCE_SENSOR_UNKNOWN;
            p330.distances_SET(new ushort[72], 0);
            p330.increment = (byte)(byte)255;
            p330.min_distance = (ushort)(ushort)21002;
            p330.max_distance = (ushort)(ushort)38614;
