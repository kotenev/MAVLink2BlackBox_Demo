...
public class Test extends GroundControl {
	...
	public static class REMOTE_LOG_DATA_BLOCK extends GroundControl.REMOTE_LOG_DATA_BLOCK {
		...
		{return data__GET(new char[200], 0);}

		public @MAV_REMOTE_LOG_DATA_BLOCK_COMMANDS int seqno_GET()//log data block sequence number
	...
	public static class MAG_CAL_PROGRESS extends GroundControl.MAG_CAL_PROGRESS {
		...
		{return completion_mask_GET(new char[10], 0);}

		public float direction_x_GET()//Body frame direction vector for display
	...
	public static class VISION_POSITION_DELTA extends GroundControl.VISION_POSITION_DELTA {
		 ...
		 * 2=down
		 */
		public float[] position_delta_GET() {return position_delta_GET(new float[3], 0);}

		public float confidence_GET()//normalised confidence value from 0 to 100
		{ return (float) (Float.intBitsToFloat((int) get_bytes(data, 40, 4))); }
	}
