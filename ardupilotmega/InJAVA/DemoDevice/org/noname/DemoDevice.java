...
public class DemoDevice extends Host
{
    ...
    } public static class CHANGE_OPERATOR_CONTROL extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        ...
        } static final Meta meta = new Meta(5, 0, 0, 0, 4, 24, 0, _Z);
...
//ke
        ...
        {key_SET(src.toCharArray(), 0, src.length(), ph);} public void key_SET(char[]  src, int pos, int items, Bounds.Inside ph) //ke
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(7, 0, 0, 0, 1, 0, 0, _B);
    ...
    } public static class PARAM_REQUEST_READ extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        ...
        } public void param_id_SET(String src, Bounds.Inside ph) {param_id_SET(src.toCharArray(), 0, src.length(), ph);} public void param_id_SET(char[]  src, int pos, int items, Bounds.Inside ph)
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(20, 0, 0, 0, 5, 32, 0, _V);
    ...
    } public static class PARAM_VALUE extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        ...
        } public void param_id_SET(String src, Bounds.Inside ph) {param_id_SET(src.toCharArray(), 0, src.length(), ph);} public void param_id_SET(char[]  src, int pos, int items, Bounds.Inside ph)
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(22, 2, 0, 0, 10, 68, 0, _G);
...
//Heading / track uncertainty in degrees * 1e5
        ...
        public void hdg_acc_SET(long  src, Bounds.Inside ph)//Heading / track uncertainty in degrees * 1e5
        {
            ...
            set_bytes((src) & -1L, 4, data,  ph.BYTE);
        } static final Meta meta = new Meta(24, 4, 0, 1, 31, 236, 0, _Up, _Hp, _lp, _Ip, _cp);
...
//Servo output 16 value, in microsecond
        ...
        public void servo16_raw_SET(char  src, Bounds.Inside ph)//Servo output 16 value, in microsecond
        {
            ...
            set_bytes((char)(src) & -1L, 2, data,  ph.BYTE);
        } static final Meta meta = new Meta(36, 8, 1, 0, 22, 168, 0, _Nu, _Uu, _Hu, _lu, _Iu, _cu, _Fu, _xu);
...
//Timestamp (microseconds since UNIX epoch or microseconds since system boot
        ...
        } static final Meta meta = new Meta(48, 0, 0, 0, 14, 104, 0, _aO);
...
//Timestamp (microseconds since UNIX epoch or microseconds since system boot
        ...
        public void time_usec_SET(long  src, Bounds.Inside ph)//Timestamp (microseconds since UNIX epoch or microseconds since system boot
        {
            ...
            set_bytes((src) & -1L, 8, data,  ph.BYTE);
        } static final Meta meta = new Meta(49, 0, 0, 0, 13, 96, 0, _nO);
    } public static class PARAM_MAP_RC extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        ...
        } public void param_id_SET(String src, Bounds.Inside ph) {param_id_SET(src.toCharArray(), 0, src.length(), ph);} public void param_id_SET(char[]  src, int pos, int items, Bounds.Inside ph)
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(50, 0, 0, 0, 22, 168, 0, _YO);
...
//WIP: Component which requested the command to be execute
        ...
        public void target_component_SET(char  src, Bounds.Inside ph)//WIP: Component which requested the command to be execute
        {
            ...
            set_bytes((char)(src) & -1L, 1, data,  ph.BYTE);
        } static final Meta meta = new Meta(77, 0, 0, 0, 3, 11, 0, _by, _Yy, _Sy, _jy);
...
//Flow rate in radians/second about Y axi
        ...
        public void flow_rate_y_SET(float  src, Bounds.Inside ph)//Flow rate in radians/second about Y axi
        {
            ...
            set_bytes(Float.floatToIntBits(src) & -1L, 4, data, ph.BYTE);
        } static final Meta meta = new Meta(100, 0, 0, 1, 27, 208, 0, _cU, _FU);
    ...
    } public static class AUTOPILOT_VERSION extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        ...
        } public void uid2_SET(char[]  src, int pos, Bounds.Inside ph)
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + 18; pos < src_max; pos++, BYTE += 1)
                set_bytes((char)(src[pos]) & -1L, 1, data,  BYTE);
        } static final Meta meta = new Meta(148, 2, 4, 1, 54, 421, 0, _ma);
...
//Quaternion of landing target orientation (w, x, y, z order, zero-rotation is 1, 0, 0, 0
        ...
        public void position_valid_SET(char  src, Bounds.Inside ph)
        {
            ...
            set_bytes((char)(src) & -1L, 1, data,  ph.BYTE);
        } static final Meta meta = new Meta(149, 0, 0, 1, 31, 239, 0, _ca, _Fa, _xa, _aa, _za);
    } public static class SENSOR_OFFSETS extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        SENSOR_OFFSETS() { super(meta, 0); }
        SENSOR_OFFSETS(int bytes) { super(meta, bytes); }
        public short mag_ofs_x_GET()//magnetometer X offse
        {  return (short)((short) get_bytes(data,  0, 2)); }
        public void mag_ofs_x_SET(short  src) //magnetometer X offse
        {  set_bytes((short)(src) & -1L, 2, data,  0); }
        public short mag_ofs_y_GET()//magnetometer Y offse
        {  return (short)((short) get_bytes(data,  2, 2)); }
        public void mag_ofs_y_SET(short  src) //magnetometer Y offse
        {  set_bytes((short)(src) & -1L, 2, data,  2); }
        public short mag_ofs_z_GET()//magnetometer Z offse
        {  return (short)((short) get_bytes(data,  4, 2)); }
        public void mag_ofs_z_SET(short  src) //magnetometer Z offse
        {  set_bytes((short)(src) & -1L, 2, data,  4); }
        ...
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 6); }
        public int raw_press_GET()//raw pressure from baromete
        {  return (int)((int) get_bytes(data,  10, 4)); }
        public void raw_press_SET(int  src) //raw pressure from baromete
        {  set_bytes((int)(src) & -1L, 4, data,  10); }
        public int raw_temp_GET()//raw temperature from baromete
        {  return (int)((int) get_bytes(data,  14, 4)); }
        public void raw_temp_SET(int  src) //raw temperature from baromete
        {  set_bytes((int)(src) & -1L, 4, data,  14); }
        public float gyro_cal_x_GET()//gyro X calibratio
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  18, 4))); }
        public void gyro_cal_x_SET(float  src) //gyro X calibratio
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 18); }
        public float gyro_cal_y_GET()//gyro Y calibratio
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  22, 4))); }
        public void gyro_cal_y_SET(float  src) //gyro Y calibratio
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 22); }
        public float gyro_cal_z_GET()//gyro Z calibratio
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  26, 4))); }
        public void gyro_cal_z_SET(float  src) //gyro Z calibratio
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 26); }
        public float accel_cal_x_GET()//accel X calibratio
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  30, 4))); }
        public void accel_cal_x_SET(float  src) //accel X calibratio
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 30); }
        public float accel_cal_y_GET()//accel Y calibratio
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  34, 4))); }
        public void accel_cal_y_SET(float  src) //accel Y calibratio
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 34); }
        public float accel_cal_z_GET()//accel Z calibratio
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  38, 4))); }
        public void accel_cal_z_SET(float  src) //accel Z calibratio
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 38); }
        static final Meta meta = new Meta(150, 0, 0, 0, 42, 336);
    } public static class SET_MAG_OFFSETS extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        SET_MAG_OFFSETS() { super(meta, 0); }
        SET_MAG_OFFSETS(int bytes) { super(meta, bytes); }
        public char target_system_GET()//System I
        {  return (char)((char) get_bytes(data,  0, 1)); }
        public void target_system_SET(char  src) //System I
        {  set_bytes((char)(src) & -1L, 1, data,  0); }
    ...
    } public static class MEMINFO extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        MEMINFO() { super(meta, 0); }
        MEMINFO(int bytes) { super(meta, bytes); }
        public char brkval_GET()//heap to
        {  return (char)((char) get_bytes(data,  0, 2)); }
        public void brkval_SET(char  src) //heap to
        {  set_bytes((char)(src) & -1L, 2, data,  0); }
        public char freemem_GET()//free memor
        {  return (char)((char) get_bytes(data,  2, 2)); }
        public void freemem_SET(char  src) //free memor
        {  set_bytes((char)(src) & -1L, 2, data,  2); }
...
//free memory (32 bit
        ...
        public void freemem32_SET(long  src, Bounds.Inside ph)//free memory (32 bit
        {
            ...
            set_bytes((src) & -1L, 4, data,  ph.BYTE);
        } static final Meta meta = new Meta(152, 2, 0, 0, 5, 32, 0, _eb);
    } public static class AP_ADC extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        AP_ADC() { super(meta, 0); }
        AP_ADC(int bytes) { super(meta, bytes); }
        public char adc1_GET()//ADC output
        {  return (char)((char) get_bytes(data,  0, 2)); }
        public void adc1_SET(char  src) //ADC output
        {  set_bytes((char)(src) & -1L, 2, data,  0); }
        public char adc2_GET()//ADC output
        {  return (char)((char) get_bytes(data,  2, 2)); }
        public void adc2_SET(char  src) //ADC output
        {  set_bytes((char)(src) & -1L, 2, data,  2); }
        public char adc3_GET()//ADC output
        {  return (char)((char) get_bytes(data,  4, 2)); }
        public void adc3_SET(char  src) //ADC output
        {  set_bytes((char)(src) & -1L, 2, data,  4); }
        public char adc4_GET()//ADC output
        {  return (char)((char) get_bytes(data,  6, 2)); }
        public void adc4_SET(char  src) //ADC output
        {  set_bytes((char)(src) & -1L, 2, data,  6); }
        public char adc5_GET()//ADC output
        {  return (char)((char) get_bytes(data,  8, 2)); }
        public void adc5_SET(char  src) //ADC output
        {  set_bytes((char)(src) & -1L, 2, data,  8); }
        public char adc6_GET()//ADC output
        {  return (char)((char) get_bytes(data,  10, 2)); }
        public void adc6_SET(char  src) //ADC output
        {  set_bytes((char)(src) & -1L, 2, data,  10); }
        static final Meta meta = new Meta(153, 6, 0, 0, 12, 96);
    } public static class DIGICAM_CONFIGURE extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        DIGICAM_CONFIGURE() { super(meta, 0); }
        DIGICAM_CONFIGURE(int bytes) { super(meta, bytes); }
        public char shutter_speed_GET()//e.g. 1000 means 1/1000 (0 means ignore
        {  return (char)((char) get_bytes(data,  0, 2)); }
        public void shutter_speed_SET(char  src) //e.g. 1000 means 1/1000 (0 means ignore
        {  set_bytes((char)(src) & -1L, 2, data,  0); }
        public char target_system_GET()//System I
        {  return (char)((char) get_bytes(data,  2, 1)); }
        public void target_system_SET(char  src) //System I
        ...
        public void target_component_SET(char  src) //Component I
        {  set_bytes((char)(src) & -1L, 1, data,  3); }
        public char mode_GET()//P, TV, AV, M, Etc (0 means ignore
        {  return (char)((char) get_bytes(data,  4, 1)); }
        public void mode_SET(char  src) //P, TV, AV, M, Etc (0 means ignore
        {  set_bytes((char)(src) & -1L, 1, data,  4); }
        public char aperture_GET()//e.g. 28 means 2.8 (0 means ignore
        {  return (char)((char) get_bytes(data,  5, 1)); }
        public void aperture_SET(char  src) //e.g. 28 means 2.8 (0 means ignore
        {  set_bytes((char)(src) & -1L, 1, data,  5); }
        public char iso_GET()//e.g. 80, 100, 200, Etc (0 means ignore
        {  return (char)((char) get_bytes(data,  6, 1)); }
        public void iso_SET(char  src) //e.g. 80, 100, 200, Etc (0 means ignore
        {  set_bytes((char)(src) & -1L, 1, data,  6); }
        ...
        {  set_bytes((char)(src) & -1L, 1, data,  7); }
        public char command_id_GET() {  return (char)((char) get_bytes(data,  8, 1)); }
        public void command_id_SET(char  src) {  set_bytes((char)(src) & -1L, 1, data,  8); }
        ...
        {  set_bytes((char)(src) & -1L, 1, data,  10); }
        public float extra_value_GET()//Correspondent value to given extra_para
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  11, 4))); }
        public void extra_value_SET(float  src) //Correspondent value to given extra_para
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 11); }
        static final Meta meta = new Meta(154, 1, 0, 0, 15, 120);
    } public static class DIGICAM_CONTROL extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        DIGICAM_CONTROL() { super(meta, 0); }
        DIGICAM_CONTROL(int bytes) { super(meta, bytes); }
        public char target_system_GET()//System I
        {  return (char)((char) get_bytes(data,  0, 1)); }
        public void target_system_SET(char  src) //System I
        {  set_bytes((char)(src) & -1L, 1, data,  0); }
        ...
        public void target_component_SET(char  src) //Component I
        {  set_bytes((char)(src) & -1L, 1, data,  1); }
        public char session_GET()//Session control e.g. show/hide len
        {  return (char)((char) get_bytes(data,  2, 1)); }
        public void session_SET(char  src) //Session control e.g. show/hide len
        {  set_bytes((char)(src) & -1L, 1, data,  2); }
        public char zoom_pos_GET()//Zoom's absolute position (0 means ignore
        {  return (char)((char) get_bytes(data,  3, 1)); }
        public void zoom_pos_SET(char  src) //Zoom's absolute position (0 means ignore
        {  set_bytes((char)(src) & -1L, 1, data,  3); }
        public byte zoom_step_GET()//Zooming step value to offset zoom from the current positio
        {  return (byte)((byte) get_bytes(data,  4, 1)); }
        public void zoom_step_SET(byte  src) //Zooming step value to offset zoom from the current positio
        {  set_bytes((byte)(src) & -1L, 1, data,  4); }
        public char focus_lock_GET()//0: unlock focus or keep unlocked, 1: lock focus or keep locked, 3: re-lock focu
        {  return (char)((char) get_bytes(data,  5, 1)); }
        public void focus_lock_SET(char  src) //0: unlock focus or keep unlocked, 1: lock focus or keep locked, 3: re-lock focu
        {  set_bytes((char)(src) & -1L, 1, data,  5); }
        public char shot_GET()//0: ignore, 1: shot or start filmin
        {  return (char)((char) get_bytes(data,  6, 1)); }
        public void shot_SET(char  src) //0: ignore, 1: shot or start filmin
        {  set_bytes((char)(src) & -1L, 1, data,  6); }
        public char command_id_GET() {  return (char)((char) get_bytes(data,  7, 1)); }
        public void command_id_SET(char  src) {  set_bytes((char)(src) & -1L, 1, data,  7); }
        public char extra_param_GET()//Extra parameters enumeration (0 means ignore
        {  return (char)((char) get_bytes(data,  8, 1)); }
        public void extra_param_SET(char  src) //Extra parameters enumeration (0 means ignore
        {  set_bytes((char)(src) & -1L, 1, data,  8); }
    ...
    } public static class MOUNT_CONFIGURE extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        MOUNT_CONFIGURE() { super(meta, 0); }
        MOUNT_CONFIGURE(int bytes) { super(meta, bytes); }
        public char target_system_GET()//System I
        {  return (char)((char) get_bytes(data,  0, 1)); }
        public void target_system_SET(char  src) //System I
        {  set_bytes((char)(src) & -1L, 1, data,  0); }
    ...
    } public static class MOUNT_CONTROL extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        MOUNT_CONTROL() { super(meta, 0); }
        MOUNT_CONTROL(int bytes) { super(meta, bytes); }
        public char target_system_GET()//System I
        {  return (char)((char) get_bytes(data,  0, 1)); }
        public void target_system_SET(char  src) //System I
        {  set_bytes((char)(src) & -1L, 1, data,  0); }
        ...
        public void target_component_SET(char  src) //Component I
        {  set_bytes((char)(src) & -1L, 1, data,  1); }
        public int input_a_GET()//pitch(deg*100) or lat, depending on mount mod
        {  return (int)((int) get_bytes(data,  2, 4)); }
        public void input_a_SET(int  src) //pitch(deg*100) or lat, depending on mount mod
        {  set_bytes((int)(src) & -1L, 4, data,  2); }
        public int input_b_GET()//roll(deg*100) or lon depending on mount mod
        {  return (int)((int) get_bytes(data,  6, 4)); }
        public void input_b_SET(int  src) //roll(deg*100) or lon depending on mount mod
        {  set_bytes((int)(src) & -1L, 4, data,  6); }
        public int input_c_GET()//yaw(deg*100) or alt (in cm) depending on mount mod
        {  return (int)((int) get_bytes(data,  10, 4)); }
        public void input_c_SET(int  src) //yaw(deg*100) or alt (in cm) depending on mount mod
        {  set_bytes((int)(src) & -1L, 4, data,  10); }
    ...
    } public static class MOUNT_STATUS extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        MOUNT_STATUS() { super(meta, 0); }
        MOUNT_STATUS(int bytes) { super(meta, bytes); }
        public char target_system_GET()//System I
        {  return (char)((char) get_bytes(data,  0, 1)); }
        public void target_system_SET(char  src) //System I
        {  set_bytes((char)(src) & -1L, 1, data,  0); }
    ...
    } public static class FENCE_POINT extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        FENCE_POINT() { super(meta, 0); }
        FENCE_POINT(int bytes) { super(meta, bytes); }
        public char target_system_GET()//System I
        {  return (char)((char) get_bytes(data,  0, 1)); }
        public void target_system_SET(char  src) //System I
        {  set_bytes((char)(src) & -1L, 1, data,  0); }
        ...
        {  set_bytes((char)(src) & -1L, 1, data,  3); }
        public float lat_GET()//Latitude of poin
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  4, 4))); }
        public void lat_SET(float  src) //Latitude of poin
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 4); }
        public float lng_GET()//Longitude of poin
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  8, 4))); }
        public void lng_SET(float  src) //Longitude of poin
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 8); }
        static final Meta meta = new Meta(160, 0, 0, 0, 12, 96);
    } public static class FENCE_FETCH_POINT extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        FENCE_FETCH_POINT() { super(meta, 0); }
        FENCE_FETCH_POINT(int bytes) { super(meta, bytes); }
        public char target_system_GET()//System I
        {  return (char)((char) get_bytes(data,  0, 1)); }
        public void target_system_SET(char  src) //System I
        {  set_bytes((char)(src) & -1L, 1, data,  0); }
    ...
    } public static class FENCE_STATUS extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        FENCE_STATUS() { super(meta, 0); }
        FENCE_STATUS(int bytes) { super(meta, bytes); }
        public char breach_count_GET()//number of fence breache
        {  return (char)((char) get_bytes(data,  0, 2)); }
        public void breach_count_SET(char  src) //number of fence breache
        {  set_bytes((char)(src) & -1L, 2, data,  0); }
        public long breach_time_GET()//time of last breach in milliseconds since boo
        {  return (get_bytes(data,  2, 4)); }
        public void breach_time_SET(long  src) //time of last breach in milliseconds since boo
        {  set_bytes((src) & -1L, 4, data,  2); }
        public char breach_status_GET()//0 if currently inside fence, 1 if outsid
        {  return (char)((char) get_bytes(data,  6, 1)); }
        public void breach_status_SET(char  src) //0 if currently inside fence, 1 if outsid
        {  set_bytes((char)(src) & -1L, 1, data,  6); }
        ...
        static final Meta meta = new Meta(162, 1, 1, 0, 8, 59);
    } public static class AHRS extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        AHRS() { super(meta, 0); }
        AHRS(int bytes) { super(meta, bytes); }
        public float omegaIx_GET()//X gyro drift estimate rad/
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  0, 4))); }
        public void omegaIx_SET(float  src) //X gyro drift estimate rad/
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 0); }
        public float omegaIy_GET()//Y gyro drift estimate rad/
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  4, 4))); }
        public void omegaIy_SET(float  src) //Y gyro drift estimate rad/
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 4); }
        public float omegaIz_GET()//Z gyro drift estimate rad/
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  8, 4))); }
        public void omegaIz_SET(float  src) //Z gyro drift estimate rad/
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 8); }
        public float accel_weight_GET()//average accel_weigh
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  12, 4))); }
        public void accel_weight_SET(float  src) //average accel_weigh
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 12); }
        public float renorm_val_GET()//average renormalisation valu
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  16, 4))); }
        public void renorm_val_SET(float  src) //average renormalisation valu
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 16); }
        public float error_rp_GET()//average error_roll_pitch valu
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  20, 4))); }
        public void error_rp_SET(float  src) //average error_roll_pitch valu
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 20); }
        public float error_yaw_GET()//average error_yaw valu
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  24, 4))); }
        public void error_yaw_SET(float  src) //average error_yaw valu
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 24); }
        static final Meta meta = new Meta(163, 0, 0, 0, 28, 224);
    } public static class SIMSTATE extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        SIMSTATE() { super(meta, 0); }
        SIMSTATE(int bytes) { super(meta, bytes); }
        public float roll_GET()//Roll angle (rad
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  0, 4))); }
        public void roll_SET(float  src) //Roll angle (rad
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 0); }
        ...
        public void zgyro_SET(float  src) //Angular speed around Z axis rad/
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 32); }
        public int lat_GET()//Latitude in degrees * 1E
        {  return (int)((int) get_bytes(data,  36, 4)); }
        public void lat_SET(int  src) //Latitude in degrees * 1E
        {  set_bytes((int)(src) & -1L, 4, data,  36); }
        public int lng_GET()//Longitude in degrees * 1E
        {  return (int)((int) get_bytes(data,  40, 4)); }
        public void lng_SET(int  src) //Longitude in degrees * 1E
        {  set_bytes((int)(src) & -1L, 4, data,  40); }
        static final Meta meta = new Meta(164, 0, 0, 0, 44, 352);
    } public static class HWSTATUS extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        HWSTATUS() { super(meta, 0); }
        HWSTATUS(int bytes) { super(meta, bytes); }
        public char Vcc_GET()//board voltage (mV
        {  return (char)((char) get_bytes(data,  0, 2)); }
        public void Vcc_SET(char  src) //board voltage (mV
        {  set_bytes((char)(src) & -1L, 2, data,  0); }
        public char I2Cerr_GET()//I2C error coun
        {  return (char)((char) get_bytes(data,  2, 1)); }
        public void I2Cerr_SET(char  src) //I2C error coun
        {  set_bytes((char)(src) & -1L, 1, data,  2); }
        static final Meta meta = new Meta(165, 1, 0, 0, 3, 24);
    } public static class RADIO extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        RADIO() { super(meta, 0); }
        RADIO(int bytes) { super(meta, bytes); }
        public char rxerrors_GET()//receive error
        {  return (char)((char) get_bytes(data,  0, 2)); }
        public void rxerrors_SET(char  src) //receive error
        {  set_bytes((char)(src) & -1L, 2, data,  0); }
        ...
        public void remrssi_SET(char  src) //remote signal strengt
        {  set_bytes((char)(src) & -1L, 1, data,  5); }
        public char txbuf_GET()//how full the tx buffer is as a percentag
        {  return (char)((char) get_bytes(data,  6, 1)); }
        public void txbuf_SET(char  src) //how full the tx buffer is as a percentag
        {  set_bytes((char)(src) & -1L, 1, data,  6); }
        public char noise_GET()//background noise leve
        {  return (char)((char) get_bytes(data,  7, 1)); }
        public void noise_SET(char  src) //background noise leve
    ...
    } public static class LIMITS_STATUS extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        LIMITS_STATUS() { super(meta, 0); }
        LIMITS_STATUS(int bytes) { super(meta, bytes); }
        public char breach_count_GET()//number of fence breache
        {  return (char)((char) get_bytes(data,  0, 2)); }
        public void breach_count_SET(char  src) //number of fence breache
        {  set_bytes((char)(src) & -1L, 2, data,  0); }
        public long last_trigger_GET()//time of last breach in milliseconds since boo
        {  return (get_bytes(data,  2, 4)); }
        public void last_trigger_SET(long  src) //time of last breach in milliseconds since boo
        {  set_bytes((src) & -1L, 4, data,  2); }
        public long last_action_GET()//time of last recovery action in milliseconds since boo
        {  return (get_bytes(data,  6, 4)); }
        public void last_action_SET(long  src) //time of last recovery action in milliseconds since boo
        {  set_bytes((src) & -1L, 4, data,  6); }
        public long last_recovery_GET()//time of last successful recovery in milliseconds since boo
        {  return (get_bytes(data,  10, 4)); }
        public void last_recovery_SET(long  src) //time of last successful recovery in milliseconds since boo
        {  set_bytes((src) & -1L, 4, data,  10); }
        public long last_clear_GET()//time of last all-clear in milliseconds since boo
        {  return (get_bytes(data,  14, 4)); }
        public void last_clear_SET(long  src) //time of last all-clear in milliseconds since boo
        ...
        static final Meta meta = new Meta(167, 1, 4, 0, 20, 153);
    } public static class WIND extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        WIND() { super(meta, 0); }
        WIND(int bytes) { super(meta, bytes); }
    ...
    } public static class DATA16 extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        DATA16() { super(meta, 0); }
        DATA16(int bytes) { super(meta, bytes); }
        public char type_GET()//data typ
        {  return (char)((char) get_bytes(data,  0, 1)); }
        public void type_SET(char  src) //data typ
        {  set_bytes((char)(src) & -1L, 1, data,  0); }
        public char len_GET()//data lengt
        {  return (char)((char) get_bytes(data,  1, 1)); }
        public void len_SET(char  src) //data lengt
        {  set_bytes((char)(src) & -1L, 1, data,  1); }
        public char[] data__GET(char[]  dst_ch, int pos)  //raw dat
        {
            for(int BYTE = 2, dst_max = pos + 16; pos < dst_max ; pos++,  BYTE += 1)
                dst_ch[pos] = (char)((char) get_bytes(data,  BYTE, 1));
            return dst_ch;
        }
        public char[] data__GET()//raw dat
        {return data__GET(new char[16], 0);} public void data__SET(char[]  src, int pos)  //raw dat
        {
            for(int BYTE =  2, src_max = pos + 16; pos < src_max; pos++, BYTE += 1)
                set_bytes((char)(src[pos]) & -1L, 1, data,  BYTE);
        }
        static final Meta meta = new Meta(169, 0, 0, 0, 18, 144);
    } public static class DATA32 extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        DATA32() { super(meta, 0); }
        DATA32(int bytes) { super(meta, bytes); }
        public char type_GET()//data typ
        {  return (char)((char) get_bytes(data,  0, 1)); }
        public void type_SET(char  src) //data typ
        {  set_bytes((char)(src) & -1L, 1, data,  0); }
        ...
        public char[] data__GET()//raw dat
        {return data__GET(new char[32], 0);} public void data__SET(char[]  src, int pos)  //raw dat
        {
            for(int BYTE =  2, src_max = pos + 32; pos < src_max; pos++, BYTE += 1)
                set_bytes((char)(src[pos]) & -1L, 1, data,  BYTE);
        }
        static final Meta meta = new Meta(170, 0, 0, 0, 34, 272);
    } public static class DATA64 extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        DATA64() { super(meta, 0); }
        DATA64(int bytes) { super(meta, bytes); }
        public char type_GET()//data typ
        {  return (char)((char) get_bytes(data,  0, 1)); }
        public void type_SET(char  src) //data typ
        {  set_bytes((char)(src) & -1L, 1, data,  0); }
        ...
        public char[] data__GET()//raw dat
        {return data__GET(new char[64], 0);} public void data__SET(char[]  src, int pos)  //raw dat
        {
            for(int BYTE =  2, src_max = pos + 64; pos < src_max; pos++, BYTE += 1)
                set_bytes((char)(src[pos]) & -1L, 1, data,  BYTE);
        }
        static final Meta meta = new Meta(171, 0, 0, 0, 66, 528);
    } public static class DATA96 extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        DATA96() { super(meta, 0); }
        DATA96(int bytes) { super(meta, bytes); }
        public char type_GET()//data typ
        {  return (char)((char) get_bytes(data,  0, 1)); }
        public void type_SET(char  src) //data typ
        {  set_bytes((char)(src) & -1L, 1, data,  0); }
        ...
        public char[] data__GET()//raw dat
        {return data__GET(new char[96], 0);} public void data__SET(char[]  src, int pos)  //raw dat
        {
            for(int BYTE =  2, src_max = pos + 96; pos < src_max; pos++, BYTE += 1)
                set_bytes((char)(src[pos]) & -1L, 1, data,  BYTE);
        }
        static final Meta meta = new Meta(172, 0, 0, 0, 98, 784);
    } public static class RANGEFINDER extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        RANGEFINDER() { super(meta, 0); }
        RANGEFINDER(int bytes) { super(meta, bytes); }
        public float distance_GET()//distance in meter
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  0, 4))); }
        public void distance_SET(float  src) //distance in meter
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 0); }
        public float voltage_GET()//raw voltage if available, zero otherwis
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  4, 4))); }
        public void voltage_SET(float  src) //raw voltage if available, zero otherwis
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 4); }
        static final Meta meta = new Meta(173, 0, 0, 0, 8, 64);
    } public static class AIRSPEED_AUTOCAL extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        AIRSPEED_AUTOCAL() { super(meta, 0); }
        AIRSPEED_AUTOCAL(int bytes) { super(meta, bytes); }
        public float vx_GET()//GPS velocity north m/
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  0, 4))); }
        public void vx_SET(float  src) //GPS velocity north m/
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 0); }
        public float vy_GET()//GPS velocity east m/
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  4, 4))); }
        public void vy_SET(float  src) //GPS velocity east m/
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 4); }
        public float vz_GET()//GPS velocity down m/
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  8, 4))); }
        public void vz_SET(float  src) //GPS velocity down m/
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 8); }
        public float diff_pressure_GET()//Differential pressure pascal
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  12, 4))); }
        public void diff_pressure_SET(float  src) //Differential pressure pascal
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 12); }
        public float EAS2TAS_GET()//Estimated to true airspeed rati
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  16, 4))); }
        public void EAS2TAS_SET(float  src) //Estimated to true airspeed rati
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 16); }
        public float ratio_GET()//Airspeed rati
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  20, 4))); }
        public void ratio_SET(float  src) //Airspeed rati
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 20); }
        public float state_x_GET()//EKF state
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  24, 4))); }
        public void state_x_SET(float  src) //EKF state
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 24); }
        public float state_y_GET()//EKF state
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  28, 4))); }
        public void state_y_SET(float  src) //EKF state
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 28); }
        public float state_z_GET()//EKF state
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  32, 4))); }
        public void state_z_SET(float  src) //EKF state
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 32); }
        public float Pax_GET()//EKF Pa
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  36, 4))); }
        public void Pax_SET(float  src) //EKF Pa
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 36); }
        public float Pby_GET()//EKF Pb
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  40, 4))); }
        public void Pby_SET(float  src) //EKF Pb
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 40); }
        public float Pcz_GET()//EKF Pc
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  44, 4))); }
        public void Pcz_SET(float  src) //EKF Pc
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 44); }
        static final Meta meta = new Meta(174, 0, 0, 0, 48, 384);
    } public static class RALLY_POINT extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        RALLY_POINT() { super(meta, 0); }
        RALLY_POINT(int bytes) { super(meta, bytes); }
        ...
        public void count_SET(char  src) //total number of points (for sanity checking
        {  set_bytes((char)(src) & -1L, 1, data,  5); }
        public int lat_GET()//Latitude of point in degrees * 1E
        {  return (int)((int) get_bytes(data,  6, 4)); }
        public void lat_SET(int  src) //Latitude of point in degrees * 1E
        {  set_bytes((int)(src) & -1L, 4, data,  6); }
        public int lng_GET()//Longitude of point in degrees * 1E
        {  return (int)((int) get_bytes(data,  10, 4)); }
        public void lng_SET(int  src) //Longitude of point in degrees * 1E
        {  set_bytes((int)(src) & -1L, 4, data,  10); }
        public short alt_GET()//Transit / loiter altitude in meters relative to hom
        {  return (short)((short) get_bytes(data,  14, 2)); }
        public void alt_SET(short  src) //Transit / loiter altitude in meters relative to hom
        {  set_bytes((short)(src) & -1L, 2, data,  14); }
        public short break_alt_GET()//Break altitude in meters relative to hom
        {  return (short)((short) get_bytes(data,  16, 2)); }
        public void break_alt_SET(short  src) //Break altitude in meters relative to hom
        {  set_bytes((short)(src) & -1L, 2, data,  16); }
        ...
        static final Meta meta = new Meta(175, 1, 0, 0, 19, 146);
    } public static class RALLY_FETCH_POINT extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        RALLY_FETCH_POINT() { super(meta, 0); }
        RALLY_FETCH_POINT(int bytes) { super(meta, bytes); }
        public char target_system_GET()//System I
        {  return (char)((char) get_bytes(data,  0, 1)); }
        public void target_system_SET(char  src) //System I
        {  set_bytes((char)(src) & -1L, 1, data,  0); }
    ...
    } public static class COMPASSMOT_STATUS extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        COMPASSMOT_STATUS() { super(meta, 0); }
        COMPASSMOT_STATUS(int bytes) { super(meta, bytes); }
        ...
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 4); }
        public float CompensationX_GET()//Motor Compensation
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  8, 4))); }
        public void CompensationX_SET(float  src) //Motor Compensation
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 8); }
        public float CompensationY_GET()//Motor Compensation
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  12, 4))); }
        public void CompensationY_SET(float  src) //Motor Compensation
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 12); }
        public float CompensationZ_GET()//Motor Compensation
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  16, 4))); }
        public void CompensationZ_SET(float  src) //Motor Compensation
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 16); }
        static final Meta meta = new Meta(177, 2, 0, 0, 20, 160);
    } public static class AHRS2 extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        AHRS2() { super(meta, 0); }
        AHRS2(int bytes) { super(meta, bytes); }
        public float roll_GET()//Roll angle (rad
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  0, 4))); }
        public void roll_SET(float  src) //Roll angle (rad
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 0); }
    ...
    } public static class CAMERA_STATUS extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        CAMERA_STATUS() { super(meta, 0); }
        CAMERA_STATUS(int bytes) { super(meta, bytes); }
        public char img_idx_GET()//Image inde
        {  return (char)((char) get_bytes(data,  0, 2)); }
        public void img_idx_SET(char  src) //Image inde
        {  set_bytes((char)(src) & -1L, 2, data,  0); }
        ...
        public void target_system_SET(char  src) //System I
        {  set_bytes((char)(src) & -1L, 1, data,  10); }
        public char cam_idx_GET()//Camera I
        {  return (char)((char) get_bytes(data,  11, 1)); }
        public void cam_idx_SET(char  src) //Camera I
        {  set_bytes((char)(src) & -1L, 1, data,  11); }
        ...
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 24); }
        public @CAMERA_STATUS_TYPES int event_id_GET()//See CAMERA_STATUS_TYPES enum for definition of the bitmas
        {  return  0 + (int)get_bits(data, 224, 3); }
        public void event_id_SET(@CAMERA_STATUS_TYPES int  src) //See CAMERA_STATUS_TYPES enum for definition of the bitmas
        {  set_bits(- 0 +   src, 3, data, 224); }
        static final Meta meta = new Meta(179, 1, 0, 1, 29, 227);
    } public static class CAMERA_FEEDBACK extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        CAMERA_FEEDBACK() { super(meta, 0); }
        CAMERA_FEEDBACK(int bytes) { super(meta, bytes); }
        public char img_idx_GET()//Image inde
        {  return (char)((char) get_bytes(data,  0, 2)); }
        public void img_idx_SET(char  src) //Image inde
        {  set_bytes((char)(src) & -1L, 2, data,  0); }
        public long time_usec_GET() {  return (get_bytes(data,  2, 8)); }
        public void time_usec_SET(long  src) {  set_bytes((src) & -1L, 8, data,  2); }
        public char target_system_GET()//System I
        {  return (char)((char) get_bytes(data,  10, 1)); }
        public void target_system_SET(char  src) //System I
        {  set_bytes((char)(src) & -1L, 1, data,  10); }
        ...
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 40); }
        public @CAMERA_FEEDBACK_FLAGS int flags_GET()//See CAMERA_FEEDBACK_FLAGS enum for definition of the bitmas
        {  return  0 + (int)get_bits(data, 352, 3); }
        public void flags_SET(@CAMERA_FEEDBACK_FLAGS int  src) //See CAMERA_FEEDBACK_FLAGS enum for definition of the bitmas
        {  set_bits(- 0 +   src, 3, data, 352); }
        static final Meta meta = new Meta(180, 1, 0, 1, 45, 355);
    } public static class BATTERY2 extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        BATTERY2() { super(meta, 0); }
        BATTERY2(int bytes) { super(meta, bytes); }
        public char voltage_GET()//voltage in millivolt
        {  return (char)((char) get_bytes(data,  0, 2)); }
        public void voltage_SET(char  src) //voltage in millivolt
        {  set_bytes((char)(src) & -1L, 2, data,  0); }
        public short current_battery_GET()//Battery current, in 10*milliamperes (1 = 10 milliampere), -1: autopilot does not measure the curre
        {  return (short)((short) get_bytes(data,  2, 2)); }
        public void current_battery_SET(short  src) //Battery current, in 10*milliamperes (1 = 10 milliampere), -1: autopilot does not measure the curre
    ...
    } public static class AHRS3 extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        AHRS3() { super(meta, 0); }
        AHRS3(int bytes) { super(meta, bytes); }
        public float roll_GET()//Roll angle (rad
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  0, 4))); }
        public void roll_SET(float  src) //Roll angle (rad
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 0); }
        ...
        public void lng_SET(int  src) //Longitude in degrees * 1E
        {  set_bytes((int)(src) & -1L, 4, data,  20); }
        public float v1_GET()//test variable
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  24, 4))); }
        public void v1_SET(float  src) //test variable
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 24); }
        public float v2_GET()//test variable
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  28, 4))); }
        public void v2_SET(float  src) //test variable
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 28); }
        public float v3_GET()//test variable
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  32, 4))); }
        public void v3_SET(float  src) //test variable
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 32); }
        public float v4_GET()//test variable
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  36, 4))); }
        public void v4_SET(float  src) //test variable
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 36); }
        static final Meta meta = new Meta(182, 0, 0, 0, 40, 320);
    } public static class AUTOPILOT_VERSION_REQUEST extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        AUTOPILOT_VERSION_REQUEST() { super(meta, 0); }
        AUTOPILOT_VERSION_REQUEST(int bytes) { super(meta, bytes); }
        public char target_system_GET()//System I
        {  return (char)((char) get_bytes(data,  0, 1)); }
        public void target_system_SET(char  src) //System I
        {  set_bytes((char)(src) & -1L, 1, data,  0); }
    ...
    } public static class REMOTE_LOG_DATA_BLOCK extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        REMOTE_LOG_DATA_BLOCK() { super(meta, 0); }
        REMOTE_LOG_DATA_BLOCK(int bytes) { super(meta, bytes); }
        public char target_system_GET()//System I
        {  return (char)((char) get_bytes(data,  0, 1)); }
        public void target_system_SET(char  src) //System I
        {  set_bytes((char)(src) & -1L, 1, data,  0); }
        ...
        public void target_component_SET(char  src) //Component I
        {  set_bytes((char)(src) & -1L, 1, data,  1); }
        public char[] data__GET(char[]  dst_ch, int pos)  //log data bloc
        {
            for(int BYTE = 2, dst_max = pos + 200; pos < dst_max ; pos++,  BYTE += 1)
                dst_ch[pos] = (char)((char) get_bytes(data,  BYTE, 1));
            return dst_ch;
        }
        public char[] data__GET()//log data bloc
        {return data__GET(new char[200], 0);} public void data__SET(char[]  src, int pos)  //log data bloc
        {
            for(int BYTE =  2, src_max = pos + 200; pos < src_max; pos++, BYTE += 1)
                set_bytes((char)(src[pos]) & -1L, 1, data,  BYTE);
        }
        public @MAV_REMOTE_LOG_DATA_BLOCK_COMMANDS int seqno_GET()//log data block sequence numbe
        {  return  2147483645 + (int)get_bits(data, 1616, 2); }
        public void seqno_SET(@MAV_REMOTE_LOG_DATA_BLOCK_COMMANDS int  src) //log data block sequence numbe
        {  set_bits(- 2147483645 +   src, 2, data, 1616); }
        static final Meta meta = new Meta(184, 0, 0, 0, 203, 1618);
    } public static class REMOTE_LOG_BLOCK_STATUS extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        REMOTE_LOG_BLOCK_STATUS() { super(meta, 0); }
        REMOTE_LOG_BLOCK_STATUS(int bytes) { super(meta, bytes); }
        public long seqno_GET()//log data block sequence numbe
        {  return (get_bytes(data,  0, 4)); }
        public void seqno_SET(long  src) //log data block sequence numbe
        {  set_bytes((src) & -1L, 4, data,  0); }
        public char target_system_GET()//System I
        {  return (char)((char) get_bytes(data,  4, 1)); }
        public void target_system_SET(char  src) //System I
        ...
        public void target_component_SET(char  src) //Component I
        {  set_bytes((char)(src) & -1L, 1, data,  5); }
        public @MAV_REMOTE_LOG_DATA_BLOCK_STATUSES int status_GET()//log data block statu
        {  return  0 + (int)get_bits(data, 48, 2); }
        public void status_SET(@MAV_REMOTE_LOG_DATA_BLOCK_STATUSES int  src) //log data block statu
        {  set_bits(- 0 +   src, 2, data, 48); }
        static final Meta meta = new Meta(185, 0, 1, 0, 7, 50);
    } public static class LED_CONTROL extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        LED_CONTROL() { super(meta, 0); }
        LED_CONTROL(int bytes) { super(meta, bytes); }
        public char target_system_GET()//System I
        {  return (char)((char) get_bytes(data,  0, 1)); }
        public void target_system_SET(char  src) //System I
        {  set_bytes((char)(src) & -1L, 1, data,  0); }
        ...
        {  set_bytes((char)(src) & -1L, 1, data,  3); }
        public char custom_len_GET()//Custom Byte Lengt
        {  return (char)((char) get_bytes(data,  4, 1)); }
        public void custom_len_SET(char  src) //Custom Byte Lengt
        {  set_bytes((char)(src) & -1L, 1, data,  4); }
        public char[] custom_bytes_GET(char[]  dst_ch, int pos)  //Custom Byte
        {
            for(int BYTE = 5, dst_max = pos + 24; pos < dst_max ; pos++,  BYTE += 1)
                dst_ch[pos] = (char)((char) get_bytes(data,  BYTE, 1));
            return dst_ch;
        }
        public char[] custom_bytes_GET()//Custom Byte
        {return custom_bytes_GET(new char[24], 0);} public void custom_bytes_SET(char[]  src, int pos)  //Custom Byte
        {
            for(int BYTE =  5, src_max = pos + 24; pos < src_max; pos++, BYTE += 1)
                set_bytes((char)(src[pos]) & -1L, 1, data,  BYTE);
        }
        static final Meta meta = new Meta(186, 0, 0, 0, 29, 232);
    } public static class MAG_CAL_PROGRESS extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        MAG_CAL_PROGRESS() { super(meta, 0); }
        MAG_CAL_PROGRESS(int bytes) { super(meta, bytes); }
        public char compass_id_GET()//Compass being calibrate
        {  return (char)((char) get_bytes(data,  0, 1)); }
        public void compass_id_SET(char  src) //Compass being calibrate
        {  set_bytes((char)(src) & -1L, 1, data,  0); }
        public char cal_mask_GET()//Bitmask of compasses being calibrate
        {  return (char)((char) get_bytes(data,  1, 1)); }
        public void cal_mask_SET(char  src) //Bitmask of compasses being calibrate
        {  set_bytes((char)(src) & -1L, 1, data,  1); }
        public char attempt_GET()//Attempt numbe
        {  return (char)((char) get_bytes(data,  2, 1)); }
        public void attempt_SET(char  src) //Attempt numbe
        {  set_bytes((char)(src) & -1L, 1, data,  2); }
        public char completion_pct_GET()//Completion percentag
        {  return (char)((char) get_bytes(data,  3, 1)); }
        public void completion_pct_SET(char  src) //Completion percentag
        {  set_bytes((char)(src) & -1L, 1, data,  3); }
        public char[] completion_mask_GET(char[]  dst_ch, int pos)  //en.wikipedia.org/wiki/Geodesic_grid
        {
            for(int BYTE = 4, dst_max = pos + 10; pos < dst_max ; pos++,  BYTE += 1)
                dst_ch[pos] = (char)((char) get_bytes(data,  BYTE, 1));
            return dst_ch;
        }
        public char[] completion_mask_GET()//en.wikipedia.org/wiki/Geodesic_grid
        {return completion_mask_GET(new char[10], 0);} public void completion_mask_SET(char[]  src, int pos)  //en.wikipedia.org/wiki/Geodesic_grid
        {
            for(int BYTE =  4, src_max = pos + 10; pos < src_max; pos++, BYTE += 1)
                set_bytes((char)(src[pos]) & -1L, 1, data,  BYTE);
        }
        public float direction_x_GET()//Body frame direction vector for displa
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  14, 4))); }
        public void direction_x_SET(float  src) //Body frame direction vector for displa
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 14); }
        public float direction_y_GET()//Body frame direction vector for displa
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  18, 4))); }
        public void direction_y_SET(float  src) //Body frame direction vector for displa
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 18); }
        public float direction_z_GET()//Body frame direction vector for displa
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  22, 4))); }
        public void direction_z_SET(float  src) //Body frame direction vector for displa
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 22); }
    ...
    } public static class MAG_CAL_REPORT extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        MAG_CAL_REPORT() { super(meta, 0); }
        MAG_CAL_REPORT(int bytes) { super(meta, bytes); }
        public char compass_id_GET()//Compass being calibrate
        {  return (char)((char) get_bytes(data,  0, 1)); }
        public void compass_id_SET(char  src) //Compass being calibrate
        {  set_bytes((char)(src) & -1L, 1, data,  0); }
        ...
        public void cal_mask_SET(char  src) //Bitmask of compasses being calibrate
        {  set_bytes((char)(src) & -1L, 1, data,  1); }
        public char autosaved_GET()//0=requires a MAV_CMD_DO_ACCEPT_MAG_CAL, 1=saved to parameter
        {  return (char)((char) get_bytes(data,  2, 1)); }
        public void autosaved_SET(char  src) //0=requires a MAV_CMD_DO_ACCEPT_MAG_CAL, 1=saved to parameter
        {  set_bytes((char)(src) & -1L, 1, data,  2); }
        public float fitness_GET()//RMS milligauss residual
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  3, 4))); }
        public void fitness_SET(float  src) //RMS milligauss residual
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 3); }
        public float ofs_x_GET()//X offse
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  7, 4))); }
        public void ofs_x_SET(float  src) //X offse
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 7); }
        public float ofs_y_GET()//Y offse
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  11, 4))); }
        public void ofs_y_SET(float  src) //Y offse
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 11); }
        public float ofs_z_GET()//Z offse
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  15, 4))); }
        public void ofs_z_SET(float  src) //Z offse
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 15); }
    ...
    } public static class EKF_STATUS_REPORT extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        EKF_STATUS_REPORT() { super(meta, 0); }
        EKF_STATUS_REPORT(int bytes) { super(meta, bytes); }
        public float velocity_variance_GET()//Velocity varianc
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  0, 4))); }
        public void velocity_variance_SET(float  src) //Velocity varianc
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 0); }
        public float pos_horiz_variance_GET()//Horizontal Position varianc
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  4, 4))); }
        public void pos_horiz_variance_SET(float  src) //Horizontal Position varianc
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 4); }
        public float pos_vert_variance_GET()//Vertical Position varianc
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  8, 4))); }
        public void pos_vert_variance_SET(float  src) //Vertical Position varianc
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 8); }
        public float compass_variance_GET()//Compass varianc
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  12, 4))); }
        public void compass_variance_SET(float  src) //Compass varianc
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 12); }
        public float terrain_alt_variance_GET()//Terrain Altitude varianc
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  16, 4))); }
        public void terrain_alt_variance_SET(float  src) //Terrain Altitude varianc
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 16); }
        public @EKF_STATUS_FLAGS int flags_GET()//Flag
        {
        ...
        public void flags_SET(@EKF_STATUS_FLAGS int  src) //Flag
        {
            long id = 0;
            switch(src)
            {
        ...
        static final Meta meta = new Meta(193, 0, 0, 0, 21, 164);
    } public static class PID_TUNING extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        PID_TUNING() { super(meta, 0); }
        PID_TUNING(int bytes) { super(meta, bytes); }
        ...
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 4); }
        public float FF_GET()//FF componen
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  8, 4))); }
        public void FF_SET(float  src) //FF componen
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 8); }
        public float P_GET()//P componen
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  12, 4))); }
        public void P_SET(float  src) //P componen
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 12); }
        public float I_GET()//I componen
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  16, 4))); }
        public void I_SET(float  src) //I componen
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 16); }
        public float D_GET()//D componen
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  20, 4))); }
        public void D_SET(float  src) //D componen
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 20); }
        public @PID_TUNING_AXIS int axis_GET()//axi
        {  return  1 + (int)get_bits(data, 192, 3); }
        public void axis_SET(@PID_TUNING_AXIS int  src) //axi
        {  set_bits(- 1 +   src, 3, data, 192); }
        static final Meta meta = new Meta(194, 0, 0, 0, 25, 195);
    } public static class GIMBAL_REPORT extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        GIMBAL_REPORT() { super(meta, 0); }
        GIMBAL_REPORT(int bytes) { super(meta, bytes); }
        public char target_system_GET()//System I
        {  return (char)((char) get_bytes(data,  0, 1)); }
        public void target_system_SET(char  src) //System I
        {  set_bytes((char)(src) & -1L, 1, data,  0); }
    ...
    } public static class GIMBAL_CONTROL extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        GIMBAL_CONTROL() { super(meta, 0); }
        GIMBAL_CONTROL(int bytes) { super(meta, bytes); }
        public char target_system_GET()//System I
        {  return (char)((char) get_bytes(data,  0, 1)); }
        public void target_system_SET(char  src) //System I
        {  set_bytes((char)(src) & -1L, 1, data,  0); }
    ...
    } public static class GIMBAL_TORQUE_CMD_REPORT extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        GIMBAL_TORQUE_CMD_REPORT() { super(meta, 0); }
        GIMBAL_TORQUE_CMD_REPORT(int bytes) { super(meta, bytes); }
        public char target_system_GET()//System I
        {  return (char)((char) get_bytes(data,  0, 1)); }
        public void target_system_SET(char  src) //System I
        {  set_bytes((char)(src) & -1L, 1, data,  0); }
        ...
        public void target_component_SET(char  src) //Component I
        {  set_bytes((char)(src) & -1L, 1, data,  1); }
        public short rl_torque_cmd_GET()//Roll Torque Comman
        {  return (short)((short) get_bytes(data,  2, 2)); }
        public void rl_torque_cmd_SET(short  src) //Roll Torque Comman
        {  set_bytes((short)(src) & -1L, 2, data,  2); }
        public short el_torque_cmd_GET()//Elevation Torque Comman
        {  return (short)((short) get_bytes(data,  4, 2)); }
        public void el_torque_cmd_SET(short  src) //Elevation Torque Comman
        {  set_bytes((short)(src) & -1L, 2, data,  4); }
        public short az_torque_cmd_GET()//Azimuth Torque Comman
        {  return (short)((short) get_bytes(data,  6, 2)); }
        public void az_torque_cmd_SET(short  src) //Azimuth Torque Comman
        {  set_bytes((short)(src) & -1L, 2, data,  6); }
        static final Meta meta = new Meta(214, 0, 0, 0, 8, 64);
    } public static class GOPRO_HEARTBEAT extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        GOPRO_HEARTBEAT() { super(meta, 0); }
        GOPRO_HEARTBEAT(int bytes) { super(meta, bytes); }
        public @GOPRO_HEARTBEAT_STATUS int status_GET()//Statu
        {  return  0 + (int)get_bits(data, 0, 3); }
        public void status_SET(@GOPRO_HEARTBEAT_STATUS int  src) //Statu
        {  set_bits(- 0 +   src, 3, data, 0); }
        public @GOPRO_CAPTURE_MODE int capture_mode_GET()//Current capture mod
        {
        ...
        public void capture_mode_SET(@GOPRO_CAPTURE_MODE int  src) //Current capture mod
        {
            long id = 0;
            switch(src)
            {
        ...
        public @GOPRO_HEARTBEAT_FLAGS int flags_GET()//additional status bit
        {  return  1 + (int)get_bits(data, 7, 1); }
        public void flags_SET(@GOPRO_HEARTBEAT_FLAGS int  src) //additional status bit
        {  set_bits(- 1 +   src, 1, data, 7); }
        static final Meta meta = new Meta(215, 0, 0, 0, 1, 8);
    } public static class GOPRO_GET_REQUEST extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        GOPRO_GET_REQUEST() { super(meta, 0); }
        GOPRO_GET_REQUEST(int bytes) { super(meta, bytes); }
        public char target_system_GET()//System I
        {  return (char)((char) get_bytes(data,  0, 1)); }
        public void target_system_SET(char  src) //System I
        {  set_bytes((char)(src) & -1L, 1, data,  0); }
        ...
        public void target_component_SET(char  src) //Component I
        {  set_bytes((char)(src) & -1L, 1, data,  1); }
        public @GOPRO_COMMAND int cmd_id_GET()//Command I
        {  return  0 + (int)get_bits(data, 16, 5); }
        public void cmd_id_SET(@GOPRO_COMMAND int  src) //Command I
        {  set_bits(- 0 +   src, 5, data, 16); }
        static final Meta meta = new Meta(216, 0, 0, 0, 3, 21);
    } public static class GOPRO_GET_RESPONSE extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        GOPRO_GET_RESPONSE() { super(meta, 0); }
        GOPRO_GET_RESPONSE(int bytes) { super(meta, bytes); }
        public char[] value_GET(char[]  dst_ch, int pos)  //Valu
        {
            for(int BYTE = 0, dst_max = pos + 4; pos < dst_max ; pos++,  BYTE += 1)
                dst_ch[pos] = (char)((char) get_bytes(data,  BYTE, 1));
            return dst_ch;
        }
        public char[] value_GET()//Valu
        {return value_GET(new char[4], 0);} public void value_SET(char[]  src, int pos)  //Valu
        {
        ...
        public @GOPRO_REQUEST_STATUS int status_GET()//Statu
        {  return  0 + (int)get_bits(data, 37, 2); }
        public void status_SET(@GOPRO_REQUEST_STATUS int  src) //Statu
        {  set_bits(- 0 +   src, 2, data, 37); }
        static final Meta meta = new Meta(217, 0, 0, 0, 5, 39);
    } public static class GOPRO_SET_REQUEST extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        GOPRO_SET_REQUEST() { super(meta, 0); }
        GOPRO_SET_REQUEST(int bytes) { super(meta, bytes); }
        public char target_system_GET()//System I
        {  return (char)((char) get_bytes(data,  0, 1)); }
        public void target_system_SET(char  src) //System I
        {  set_bytes((char)(src) & -1L, 1, data,  0); }
    ...
    } public static class GOPRO_SET_RESPONSE extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        GOPRO_SET_RESPONSE() { super(meta, 0); }
        GOPRO_SET_RESPONSE(int bytes) { super(meta, bytes); }
        public @GOPRO_COMMAND int cmd_id_GET()//Command I
        ...
        static final Meta meta = new Meta(219, 0, 0, 0, 1, 7);
    } public static class RPM extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        RPM() { super(meta, 0); }
        RPM(int bytes) { super(meta, bytes); }
        public float rpm1_GET()//RPM Sensor
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  0, 4))); }
        public void rpm1_SET(float  src) //RPM Sensor
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 0); }
        public float rpm2_GET()//RPM Sensor
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  4, 4))); }
        public void rpm2_SET(float  src) //RPM Sensor
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 4); }
...
//Timestamp (microseconds since UNIX epoch or microseconds since system boot
        ...
        public void time_usec_SET(long  src, Bounds.Inside ph)//Timestamp (microseconds since UNIX epoch or microseconds since system boot
        {
            ...
            set_bytes((src) & -1L, 8, data,  ph.BYTE);
        } static final Meta meta = new Meta(242, 0, 0, 0, 53, 416, 0, _Tk);
...
//Timestamp (microseconds since UNIX epoch or microseconds since system boot
        ...
        public void time_usec_SET(long  src, Bounds.Inside ph)//Timestamp (microseconds since UNIX epoch or microseconds since system boot
        {
            ...
            set_bytes((src) & -1L, 8, data,  ph.BYTE);
        } static final Meta meta = new Meta(243, 0, 0, 0, 54, 424, 0, _Nz);
...
//The callsign, 8+nul
        ...
        {callsign_SET(src.toCharArray(), 0, src.length(), ph);} public void callsign_SET(char[]  src, int pos, int items, Bounds.Inside ph) //The callsign, 8+nul
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(246, 3, 1, 0, 28, 210, 0, _dz);
...
//Nam
        ...
        {name_SET(src.toCharArray(), 0, src.length(), ph);} public void name_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Nam
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(250, 0, 0, 1, 21, 160, 0, _sz);
...
//Name of the debug variabl
        ...
        {name_SET(src.toCharArray(), 0, src.length(), ph);} public void name_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Name of the debug variabl
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(251, 0, 1, 0, 9, 64, 0, _Tz);
...
//Name of the debug variabl
        ...
        {name_SET(src.toCharArray(), 0, src.length(), ph);} public void name_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Name of the debug variabl
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(252, 0, 1, 0, 9, 64, 0, _Wh);
...
//Status text message, without null termination characte
        ...
        {text_SET(src.toCharArray(), 0, src.length(), ph);} public void text_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Status text message, without null termination characte
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(253, 0, 0, 0, 2, 4, 0, _uh);
...
//tune in board specific forma
        ...
        {tune_SET(src.toCharArray(), 0, src.length(), ph);} public void tune_SET(char[]  src, int pos, int items, Bounds.Inside ph) //tune in board specific forma
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(258, 0, 0, 0, 3, 16, 0, _xh);
...
//Camera definition URI (if any, otherwise only basic functions will be available)
        ...
        {cam_definition_uri_SET(src.toCharArray(), 0, src.length(), ph);} public void cam_definition_uri_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Camera definition URI (if any, otherwise only basic functions will be available)
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(259, 3, 2, 0, 93, 731, 0, _Lh);
...
//foo.jpg if camera provides an HTTP interface
        ...
        {file_url_SET(src.toCharArray(), 0, src.length(), ph);} public void file_url_SET(char[]  src, int pos, int items, Bounds.Inside ph) //foo.jpg if camera provides an HTTP interface
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(263, 0, 1, 1, 51, 402, 2, _mn);
...
//Video stream UR
        ...
        {uri_SET(src.toCharArray(), 0, src.length(), ph);} public void uri_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Video stream UR
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(269, 3, 1, 0, 17, 130, 2, _An);
...
//Video stream UR
        ...
        {uri_SET(src.toCharArray(), 0, src.length(), ph);} public void uri_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Video stream UR
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(270, 3, 1, 0, 18, 138, 2, _rn);
...
//Password. Leave it blank for an open AP
        ...
        {password_SET(src.toCharArray(), 0, src.length(), ph);} public void password_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Password. Leave it blank for an open AP
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(299, 0, 0, 0, 1, 2, 2, _Cn, _Qn);
...
//Node name string. For example, "sapog.px4.io"
        ...
        {name_SET(src.toCharArray(), 0, src.length(), ph);} public void name_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Node name string. For example, "sapog.px4.io"
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(311, 0, 2, 1, 37, 288, 0, _Nd);
    } public static class PARAM_EXT_REQUEST_READ extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        ...
        } public void param_id_SET(String src, Bounds.Inside ph) {param_id_SET(src.toCharArray(), 0, src.length(), ph);} public void param_id_SET(char[]  src, int pos, int items, Bounds.Inside ph)
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(320, 0, 0, 0, 5, 32, 0, _kd);
...
//Parameter valu
        ...
        {param_value_SET(src.toCharArray(), 0, src.length(), ph);} public void param_value_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Parameter valu
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(322, 2, 0, 0, 5, 38, 2, _dd, _bd);
...
//Parameter valu
        ...
        {param_value_SET(src.toCharArray(), 0, src.length(), ph);} public void param_value_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Parameter valu
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(323, 0, 0, 0, 3, 22, 2, _Ld, _Jd);
...
//Parameter value (new value if PARAM_ACK_ACCEPTED, current value otherwise
        ...
        {param_value_SET(src.toCharArray(), 0, src.length(), ph);} public void param_value_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Parameter value (new value if PARAM_ACK_ACCEPTED, current value otherwise
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(324, 0, 0, 0, 2, 9, 2, _Bd, _Dd);
    ...
    } public static class UAVIONIX_ADSB_OUT_CFG extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        UAVIONIX_ADSB_OUT_CFG() { super(meta, 0); }
        UAVIONIX_ADSB_OUT_CFG(int bytes) { super(meta, bytes); }
        public char stallSpeed_GET()//Aircraft stall speed in cm/
        {  return (char)((char) get_bytes(data,  0, 2)); }
        public void stallSpeed_SET(char  src) //Aircraft stall speed in cm/
        {  set_bytes((char)(src) & -1L, 2, data,  0); }
        public long ICAO_GET()//Vehicle address (24 bit
        {  return (get_bytes(data,  2, 4)); }
        public void ICAO_SET(long  src) //Vehicle address (24 bit
        {  set_bytes((src) & -1L, 4, data,  2); }
        public @ADSB_EMITTER_TYPE int emitterType_GET()//Transmitting vehicle type. See ADSB_EMITTER_TYPE enu
        {  return  0 + (int)get_bits(data, 48, 5); }
        public void emitterType_SET(@ADSB_EMITTER_TYPE int  src) //Transmitting vehicle type. See ADSB_EMITTER_TYPE enu
        {  set_bits(- 0 +   src, 5, data, 48); }
        ...
        public @UAVIONIX_ADSB_OUT_CFG_GPS_OFFSET_LON int gpsOffsetLon_GET() {  return  0 + (int)get_bits(data, 62, 2); }
        public void gpsOffsetLon_SET(@UAVIONIX_ADSB_OUT_CFG_GPS_OFFSET_LON int  src) {  set_bits(- 0 +   src, 2, data, 62); }
        public @UAVIONIX_ADSB_OUT_RF_SELECT int rfSelect_GET()//ADS-B transponder reciever and transmit enable flag
        {  return  0 + (int)get_bits(data, 64, 2); }
        public void rfSelect_SET(@UAVIONIX_ADSB_OUT_RF_SELECT int  src) //ADS-B transponder reciever and transmit enable flag
...
//Vehicle identifier (8 characters, null terminated, valid characters are A-Z, 0-9, " " only
        ...
        {
            if(ph.field_bit != 66 && insert_field(ph, 66, items) || ! try_visit_item(ph, 0))
                insert_item(ph, 0, items);
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(10001, 1, 1, 0, 10, 66, 0, _sd);
    } public static class UAVIONIX_ADSB_OUT_DYNAMIC extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        UAVIONIX_ADSB_OUT_DYNAMIC() { super(meta, 0); }
        UAVIONIX_ADSB_OUT_DYNAMIC(int bytes) { super(meta, bytes); }
        public char accuracyVert_GET()//Vertical accuracy in cm. If unknown set to UINT16_MA
        {  return (char)((char) get_bytes(data,  0, 2)); }
        public void accuracyVert_SET(char  src) //Vertical accuracy in cm. If unknown set to UINT16_MA
        {  set_bytes((char)(src) & -1L, 2, data,  0); }
        public char accuracyVel_GET()//Velocity accuracy in mm/s (m * 1E-3). If unknown set to UINT16_MA
        {  return (char)((char) get_bytes(data,  2, 2)); }
        public void accuracyVel_SET(char  src) //Velocity accuracy in mm/s (m * 1E-3). If unknown set to UINT16_MA
        {  set_bytes((char)(src) & -1L, 2, data,  2); }
        ...
        {  set_bytes((char)(src) & -1L, 2, data,  4); }
        public long utcTime_GET()//UTC time in seconds since GPS epoch (Jan 6, 1980). If unknown set to UINT32_MA
        {  return (get_bytes(data,  6, 4)); }
        public void utcTime_SET(long  src) //UTC time in seconds since GPS epoch (Jan 6, 1980). If unknown set to UINT32_MA
        {  set_bytes((src) & -1L, 4, data,  6); }
        public long accuracyHor_GET()//Horizontal accuracy in mm (m * 1E-3). If unknown set to UINT32_MA
        {  return (get_bytes(data,  10, 4)); }
        public void accuracyHor_SET(long  src) //Horizontal accuracy in mm (m * 1E-3). If unknown set to UINT32_MA
        {  set_bytes((src) & -1L, 4, data,  10); }
        public int gpsLat_GET()//Latitude WGS84 (deg * 1E7). If unknown set to INT32_MA
        {  return (int)((int) get_bytes(data,  14, 4)); }
        public void gpsLat_SET(int  src) //Latitude WGS84 (deg * 1E7). If unknown set to INT32_MA
        {  set_bytes((int)(src) & -1L, 4, data,  14); }
        public int gpsLon_GET()//Longitude WGS84 (deg * 1E7). If unknown set to INT32_MA
        {  return (int)((int) get_bytes(data,  18, 4)); }
        public void gpsLon_SET(int  src) //Longitude WGS84 (deg * 1E7). If unknown set to INT32_MA
        {  set_bytes((int)(src) & -1L, 4, data,  18); }
        public int gpsAlt_GET()//Altitude in mm (m * 1E-3) UP +ve. WGS84 altitude. If unknown set to INT32_MA
        {  return (int)((int) get_bytes(data,  22, 4)); }
        public void gpsAlt_SET(int  src) //Altitude in mm (m * 1E-3) UP +ve. WGS84 altitude. If unknown set to INT32_MA
        {  set_bytes((int)(src) & -1L, 4, data,  22); }
        public char numSats_GET()//Number of satellites visible. If unknown set to UINT8_MA
        {  return (char)((char) get_bytes(data,  26, 1)); }
        public void numSats_SET(char  src) //Number of satellites visible. If unknown set to UINT8_MA
        {  set_bytes((char)(src) & -1L, 1, data,  26); }
        public int baroAltMSL_GET() {  return (int)((int) get_bytes(data,  27, 4)); }
        public void baroAltMSL_SET(int  src) {  set_bytes((int)(src) & -1L, 4, data,  27); }
        public short velVert_GET()//GPS vertical speed in cm/s. If unknown set to INT16_MA
        {  return (short)((short) get_bytes(data,  31, 2)); }
        public void velVert_SET(short  src) //GPS vertical speed in cm/s. If unknown set to INT16_MA
        {  set_bytes((short)(src) & -1L, 2, data,  31); }
        public short velNS_GET()//North-South velocity over ground in cm/s North +ve. If unknown set to INT16_MA
        {  return (short)((short) get_bytes(data,  33, 2)); }
        public void velNS_SET(short  src) //North-South velocity over ground in cm/s North +ve. If unknown set to INT16_MA
        {  set_bytes((short)(src) & -1L, 2, data,  33); }
        public short VelEW_GET()//East-West velocity over ground in cm/s East +ve. If unknown set to INT16_MA
        {  return (short)((short) get_bytes(data,  35, 2)); }
        public void VelEW_SET(short  src) //East-West velocity over ground in cm/s East +ve. If unknown set to INT16_MA
        {  set_bytes((short)(src) & -1L, 2, data,  35); }
        public @UAVIONIX_ADSB_OUT_DYNAMIC_GPS_FIX int gpsFix_GET()//0-1: no fix, 2: 2D fix, 3: 3D fix, 4: DGPS, 5: RT
        {  return  0 + (int)get_bits(data, 296, 3); }
        public void gpsFix_SET(@UAVIONIX_ADSB_OUT_DYNAMIC_GPS_FIX int  src) //0-1: no fix, 2: 2D fix, 3: 3D fix, 4: DGPS, 5: RT
        {  set_bits(- 0 +   src, 3, data, 296); }
        public @UAVIONIX_ADSB_EMERGENCY_STATUS int emergencyStatus_GET()//Emergency statu
        {  return  0 + (int)get_bits(data, 299, 4); }
        public void emergencyStatus_SET(@UAVIONIX_ADSB_EMERGENCY_STATUS int  src) //Emergency statu
        {  set_bits(- 0 +   src, 4, data, 299); }
        public @UAVIONIX_ADSB_OUT_DYNAMIC_STATE int state_GET()//ADS-B transponder dynamic input state flag
        {
        ...
        public void state_SET(@UAVIONIX_ADSB_OUT_DYNAMIC_STATE int  src) //ADS-B transponder dynamic input state flag
        {
            long id = 0;
            switch(src)
            {
        ...
        static final Meta meta = new Meta(10002, 3, 2, 0, 39, 306);
    } public static class UAVIONIX_ADSB_TRANSCEIVER_HEALTH_REPORT extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        UAVIONIX_ADSB_TRANSCEIVER_HEALTH_REPORT() { super(meta, 0); }
        UAVIONIX_ADSB_TRANSCEIVER_HEALTH_REPORT(int bytes) { super(meta, bytes); }
        public @UAVIONIX_ADSB_RF_HEALTH int rfHealth_GET()//ADS-B transponder message
        {
        ...
        public void rfHealth_SET(@UAVIONIX_ADSB_RF_HEALTH int  src) //ADS-B transponder message
        {
            long id = 0;
            switch(src)
            {
        ...
        static final Meta meta = new Meta(10003, 0, 0, 0, 1, 3);
    } public static class DEVICE_OP_READ extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        DEVICE_OP_READ() { super(meta, 0); }
        DEVICE_OP_READ(int bytes) { super(meta, bytes); }
        public long request_id_GET()//request ID - copied to repl
        {  return (get_bytes(data,  0, 4)); }
        public void request_id_SET(long  src) //request ID - copied to repl
        {  set_bytes((src) & -1L, 4, data,  0); }
        public char target_system_GET()//System I
        {  return (char)((char) get_bytes(data,  4, 1)); }
        public void target_system_SET(char  src) //System I
        ...
        public void target_component_SET(char  src) //Component I
        {  set_bytes((char)(src) & -1L, 1, data,  5); }
        public char bus_GET()//Bus numbe
        {  return (char)((char) get_bytes(data,  6, 1)); }
        public void bus_SET(char  src) //Bus numbe
        {  set_bytes((char)(src) & -1L, 1, data,  6); }
        public char address_GET()//Bus addres
        {  return (char)((char) get_bytes(data,  7, 1)); }
        public void address_SET(char  src) //Bus addres
        {  set_bytes((char)(src) & -1L, 1, data,  7); }
        public char regstart_GET()//First register to rea
        {  return (char)((char) get_bytes(data,  8, 1)); }
        public void regstart_SET(char  src) //First register to rea
        {  set_bytes((char)(src) & -1L, 1, data,  8); }
        public char count_GET()//count of registers to rea
        {  return (char)((char) get_bytes(data,  9, 1)); }
        public void count_SET(char  src) //count of registers to rea
        {  set_bytes((char)(src) & -1L, 1, data,  9); }
        public @DEVICE_OP_BUSTYPE int bustype_GET()//The bus typ
        {  return  0 + (int)get_bits(data, 80, 2); }
        public void bustype_SET(@DEVICE_OP_BUSTYPE int  src) //The bus typ
...
//Name of device on bus (for SPI
        ...
        {
            if(ph.field_bit != 82 && insert_field(ph, 82, items) || ! try_visit_item(ph, 0))
                insert_item(ph, 0, items);
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(11000, 0, 1, 0, 12, 82, 0, _pL);
    } public static class DEVICE_OP_READ_REPLY extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        DEVICE_OP_READ_REPLY() { super(meta, 0); }
        DEVICE_OP_READ_REPLY(int bytes) { super(meta, bytes); }
        public long request_id_GET()//request ID - copied from reques
        {  return (get_bytes(data,  0, 4)); }
        public void request_id_SET(long  src) //request ID - copied from reques
        {  set_bytes((src) & -1L, 4, data,  0); }
        public char result_GET()//0 for success, anything else is failure cod
        {  return (char)((char) get_bytes(data,  4, 1)); }
        public void result_SET(char  src) //0 for success, anything else is failure cod
        {  set_bytes((char)(src) & -1L, 1, data,  4); }
        public char regstart_GET()//starting registe
        {  return (char)((char) get_bytes(data,  5, 1)); }
        public void regstart_SET(char  src) //starting registe
        {  set_bytes((char)(src) & -1L, 1, data,  5); }
        public char count_GET()//count of bytes rea
        {  return (char)((char) get_bytes(data,  6, 1)); }
        public void count_SET(char  src) //count of bytes rea
        {  set_bytes((char)(src) & -1L, 1, data,  6); }
        public char[] data__GET(char[]  dst_ch, int pos)  //reply dat
        {
            for(int BYTE = 7, dst_max = pos + 128; pos < dst_max ; pos++,  BYTE += 1)
                dst_ch[pos] = (char)((char) get_bytes(data,  BYTE, 1));
            return dst_ch;
        }
        public char[] data__GET()//reply dat
        {return data__GET(new char[128], 0);} public void data__SET(char[]  src, int pos)  //reply dat
        {
            for(int BYTE =  7, src_max = pos + 128; pos < src_max; pos++, BYTE += 1)
                set_bytes((char)(src[pos]) & -1L, 1, data,  BYTE);
        }
        static final Meta meta = new Meta(11001, 0, 1, 0, 135, 1080);
    } public static class DEVICE_OP_WRITE extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        DEVICE_OP_WRITE() { super(meta, 0); }
        DEVICE_OP_WRITE(int bytes) { super(meta, bytes); }
        public long request_id_GET()//request ID - copied to repl
        {  return (get_bytes(data,  0, 4)); }
        public void request_id_SET(long  src) //request ID - copied to repl
        {  set_bytes((src) & -1L, 4, data,  0); }
        ...
        public void address_SET(char  src) //Bus addres
        {  set_bytes((char)(src) & -1L, 1, data,  7); }
        public char regstart_GET()//First register to writ
        {  return (char)((char) get_bytes(data,  8, 1)); }
        public void regstart_SET(char  src) //First register to writ
        {  set_bytes((char)(src) & -1L, 1, data,  8); }
        public char count_GET()//count of registers to writ
        {  return (char)((char) get_bytes(data,  9, 1)); }
        public void count_SET(char  src) //count of registers to writ
        {  set_bytes((char)(src) & -1L, 1, data,  9); }
        public char[] data__GET(char[]  dst_ch, int pos)  //write dat
        {
            for(int BYTE = 10, dst_max = pos + 128; pos < dst_max ; pos++,  BYTE += 1)
                dst_ch[pos] = (char)((char) get_bytes(data,  BYTE, 1));
            return dst_ch;
        }
        public char[] data__GET()//write dat
        {return data__GET(new char[128], 0);} public void data__SET(char[]  src, int pos)  //write dat
        {
...
//Name of device on bus (for SPI
        ...
        {busname_SET(src.toCharArray(), 0, src.length(), ph);} public void busname_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Name of device on bus (for SPI
        {
            if(ph.field_bit != 1106 && insert_field(ph, 1106, items) || ! try_visit_item(ph, 0))
                insert_item(ph, 0, items);
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(11002, 0, 1, 0, 140, 1106, 0, _FL);
    } public static class DEVICE_OP_WRITE_REPLY extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        DEVICE_OP_WRITE_REPLY() { super(meta, 0); }
        DEVICE_OP_WRITE_REPLY(int bytes) { super(meta, bytes); }
        public long request_id_GET()//request ID - copied from reques
        {  return (get_bytes(data,  0, 4)); }
        public void request_id_SET(long  src) //request ID - copied from reques
        {  set_bytes((src) & -1L, 4, data,  0); }
    ...
    } public static class ADAP_TUNING extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        ADAP_TUNING() { super(meta, 0); }
        ADAP_TUNING(int bytes) { super(meta, bytes); }
        public float desired_GET()//desired rate (degrees/s
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  0, 4))); }
        public void desired_SET(float  src) //desired rate (degrees/s
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 0); }
        ...
        public void achieved_SET(float  src) //achieved rate (degrees/s
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 4); }
        public float error_GET()//error between model and vehicl
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  8, 4))); }
        public void error_SET(float  src) //error between model and vehicl
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 8); }
        public float theta_GET()//theta estimated state predicto
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  12, 4))); }
        public void theta_SET(float  src) //theta estimated state predicto
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 12); }
        public float omega_GET()//omega estimated state predicto
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  16, 4))); }
        public void omega_SET(float  src) //omega estimated state predicto
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 16); }
        public float sigma_GET()//sigma estimated state predicto
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  20, 4))); }
        public void sigma_SET(float  src) //sigma estimated state predicto
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 20); }
        public float theta_dot_GET()//theta derivativ
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  24, 4))); }
        public void theta_dot_SET(float  src) //theta derivativ
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 24); }
        public float omega_dot_GET()//omega derivativ
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  28, 4))); }
        public void omega_dot_SET(float  src) //omega derivativ
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 28); }
        public float sigma_dot_GET()//sigma derivativ
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  32, 4))); }
        public void sigma_dot_SET(float  src) //sigma derivativ
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 32); }
        public float f_GET()//projection operator valu
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  36, 4))); }
        public void f_SET(float  src) //projection operator valu
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 36); }
        public float f_dot_GET()//projection operator derivativ
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  40, 4))); }
        public void f_dot_SET(float  src) //projection operator derivativ
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 40); }
        public float u_GET()//u adaptive controlled output comman
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  44, 4))); }
        public void u_SET(float  src) //u adaptive controlled output comman
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 44); }
        public @PID_TUNING_AXIS int axis_GET()//axi
    ...
    } public static class VISION_POSITION_DELTA extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        VISION_POSITION_DELTA() { super(meta, 0); }
        VISION_POSITION_DELTA(int bytes) { super(meta, bytes); }
        public long time_usec_GET()//Timestamp (microseconds, synced to UNIX time or since system boot
        {  return (get_bytes(data,  0, 8)); }
        public void time_usec_SET(long  src) //Timestamp (microseconds, synced to UNIX time or since system boot
        {  set_bytes((src) & -1L, 8, data,  0); }
        public long time_delta_usec_GET()//Time in microseconds since the last reported camera fram
        {  return (get_bytes(data,  8, 8)); }
        public void time_delta_usec_SET(long  src) //Time in microseconds since the last reported camera fram
        {  set_bytes((src) & -1L, 8, data,  8); }
        public float[] angle_delta_GET(float[]  dst_ch, int pos)  //Defines a rotation vector in body frame that rotates the vehicle from the previous to the current orientati
        {
            for(int BYTE = 16, dst_max = pos + 3; pos < dst_max ; pos++,  BYTE += 4)
                dst_ch[pos] = (float)(Float.intBitsToFloat((int) get_bytes(data,  BYTE, 4)));
            return dst_ch;
        }
        public float[] angle_delta_GET()//Defines a rotation vector in body frame that rotates the vehicle from the previous to the current orientati
        {return angle_delta_GET(new float[3], 0);} public void angle_delta_SET(float[]  src, int pos)  //Defines a rotation vector in body frame that rotates the vehicle from the previous to the current orientati
        {
        ...
        public float[] position_delta_GET() {return position_delta_GET(new float[3], 0);} public void position_delta_SET(float[]  src, int pos)
        {
            for(int BYTE =  28, src_max = pos + 3; pos < src_max; pos++, BYTE += 4)
                set_bytes(Float.floatToIntBits(src[pos]) & -1L, 4, data, BYTE);
        }
        public float confidence_GET()//normalised confidence value from 0 to 10
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  40, 4))); }
        public void confidence_SET(float  src) //normalised confidence value from 0 to 10
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 40); }
    ...
    public static class LoopBackDemoChannel  extends Channel
    {
            ...
            for(boolean LOOP = false; ;)
            {
                switch(id)
                {
                    ...
                    case 150:
                        ...
                        final SENSOR_OFFSETS pi150 = (SENSOR_OFFSETS) pack;
                        ph.setPack(pi150);
                        on_SENSOR_OFFSETS.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi150));
                        if(LOOP) break;
                        return null;
                    case 151:
                        if(pack == null) return new SET_MAG_OFFSETS();
                        final SET_MAG_OFFSETS pi151 = (SET_MAG_OFFSETS) pack;
                        ph.setPack(pi151);
                        on_SET_MAG_OFFSETS.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi151));
                        if(LOOP) break;
                        return null;
                    case 152:
                        if(pack == null) return new MEMINFO(-1);
                        final MEMINFO pi152 = (MEMINFO) pack;
                        ph.setPack(pi152);
                        on_MEMINFO.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi152));
                        if(LOOP) break;
                        return null;
                    case 153:
                        if(pack == null) return new AP_ADC();
                        final AP_ADC pi153 = (AP_ADC) pack;
                        ph.setPack(pi153);
                        on_AP_ADC.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi153));
                        if(LOOP) break;
                        return null;
                    case 154:
                        if(pack == null) return new DIGICAM_CONFIGURE();
                        final DIGICAM_CONFIGURE pi154 = (DIGICAM_CONFIGURE) pack;
                        ph.setPack(pi154);
                        on_DIGICAM_CONFIGURE.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi154));
                        if(LOOP) break;
                        return null;
                    case 155:
                        if(pack == null) return new DIGICAM_CONTROL();
                        final DIGICAM_CONTROL pi155 = (DIGICAM_CONTROL) pack;
                        ph.setPack(pi155);
                        on_DIGICAM_CONTROL.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi155));
                        if(LOOP) break;
                        return null;
                    case 156:
                        if(pack == null) return new MOUNT_CONFIGURE();
                        final MOUNT_CONFIGURE pi156 = (MOUNT_CONFIGURE) pack;
                        ph.setPack(pi156);
                        on_MOUNT_CONFIGURE.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi156));
                        if(LOOP) break;
                        return null;
                    case 157:
                        if(pack == null) return new MOUNT_CONTROL();
                        final MOUNT_CONTROL pi157 = (MOUNT_CONTROL) pack;
                        ph.setPack(pi157);
                        on_MOUNT_CONTROL.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi157));
                        if(LOOP) break;
                        return null;
                    case 158:
                        if(pack == null) return new MOUNT_STATUS();
                        final MOUNT_STATUS pi158 = (MOUNT_STATUS) pack;
                        ph.setPack(pi158);
                        on_MOUNT_STATUS.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi158));
                        if(LOOP) break;
                        return null;
                    case 160:
                        if(pack == null) return new FENCE_POINT();
                        final FENCE_POINT pi160 = (FENCE_POINT) pack;
                        ph.setPack(pi160);
                        on_FENCE_POINT.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi160));
                        if(LOOP) break;
                        return null;
                    case 161:
                        if(pack == null) return new FENCE_FETCH_POINT();
                        final FENCE_FETCH_POINT pi161 = (FENCE_FETCH_POINT) pack;
                        ph.setPack(pi161);
                        on_FENCE_FETCH_POINT.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi161));
                        if(LOOP) break;
                        return null;
                    case 162:
                        if(pack == null) return new FENCE_STATUS();
                        final FENCE_STATUS pi162 = (FENCE_STATUS) pack;
                        ph.setPack(pi162);
                        on_FENCE_STATUS.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi162));
                        if(LOOP) break;
                        return null;
                    case 163:
                        if(pack == null) return new AHRS();
                        final AHRS pi163 = (AHRS) pack;
                        ph.setPack(pi163);
                        on_AHRS.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi163));
                        if(LOOP) break;
                        return null;
                    case 164:
                        if(pack == null) return new SIMSTATE();
                        final SIMSTATE pi164 = (SIMSTATE) pack;
                        ph.setPack(pi164);
                        on_SIMSTATE.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi164));
                        if(LOOP) break;
                        return null;
                    case 165:
                        if(pack == null) return new HWSTATUS();
                        final HWSTATUS pi165 = (HWSTATUS) pack;
                        ph.setPack(pi165);
                        on_HWSTATUS.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi165));
                        if(LOOP) break;
                        return null;
                    case 166:
                        if(pack == null) return new RADIO();
                        final RADIO pi166 = (RADIO) pack;
                        ph.setPack(pi166);
                        on_RADIO.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi166));
                        if(LOOP) break;
                        return null;
                    case 167:
                        if(pack == null) return new LIMITS_STATUS();
                        final LIMITS_STATUS pi167 = (LIMITS_STATUS) pack;
                        ph.setPack(pi167);
                        on_LIMITS_STATUS.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi167));
                        if(LOOP) break;
                        return null;
                    case 168:
                        if(pack == null) return new WIND();
                        final WIND pi168 = (WIND) pack;
                        ph.setPack(pi168);
                        on_WIND.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi168));
                        if(LOOP) break;
                        return null;
                    case 169:
                        if(pack == null) return new DATA16();
                        final DATA16 pi169 = (DATA16) pack;
                        ph.setPack(pi169);
                        on_DATA16.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi169));
                        if(LOOP) break;
                        return null;
                    case 170:
                        if(pack == null) return new DATA32();
                        final DATA32 pi170 = (DATA32) pack;
                        ph.setPack(pi170);
                        on_DATA32.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi170));
                        if(LOOP) break;
                        return null;
                    case 171:
                        if(pack == null) return new DATA64();
                        final DATA64 pi171 = (DATA64) pack;
                        ph.setPack(pi171);
                        on_DATA64.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi171));
                        if(LOOP) break;
                        return null;
                    case 172:
                        if(pack == null) return new DATA96();
                        final DATA96 pi172 = (DATA96) pack;
                        ph.setPack(pi172);
                        on_DATA96.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi172));
                        if(LOOP) break;
                        return null;
                    case 173:
                        if(pack == null) return new RANGEFINDER();
                        final RANGEFINDER pi173 = (RANGEFINDER) pack;
                        ph.setPack(pi173);
                        on_RANGEFINDER.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi173));
                        if(LOOP) break;
                        return null;
                    case 174:
                        if(pack == null) return new AIRSPEED_AUTOCAL();
                        final AIRSPEED_AUTOCAL pi174 = (AIRSPEED_AUTOCAL) pack;
                        ph.setPack(pi174);
                        on_AIRSPEED_AUTOCAL.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi174));
                        if(LOOP) break;
                        return null;
                    case 175:
                        if(pack == null) return new RALLY_POINT();
                        final RALLY_POINT pi175 = (RALLY_POINT) pack;
                        ph.setPack(pi175);
                        on_RALLY_POINT.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi175));
                        if(LOOP) break;
                        return null;
                    case 176:
                        if(pack == null) return new RALLY_FETCH_POINT();
                        final RALLY_FETCH_POINT pi176 = (RALLY_FETCH_POINT) pack;
                        ph.setPack(pi176);
                        on_RALLY_FETCH_POINT.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi176));
                        if(LOOP) break;
                        return null;
                    case 177:
                        if(pack == null) return new COMPASSMOT_STATUS();
                        final COMPASSMOT_STATUS pi177 = (COMPASSMOT_STATUS) pack;
                        ph.setPack(pi177);
                        on_COMPASSMOT_STATUS.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi177));
                        if(LOOP) break;
                        return null;
                    case 178:
                        if(pack == null) return new AHRS2();
                        final AHRS2 pi178 = (AHRS2) pack;
                        ph.setPack(pi178);
                        on_AHRS2.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi178));
                        if(LOOP) break;
                        return null;
                    case 179:
                        if(pack == null) return new CAMERA_STATUS();
                        final CAMERA_STATUS pi179 = (CAMERA_STATUS) pack;
                        ph.setPack(pi179);
                        on_CAMERA_STATUS.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi179));
                        if(LOOP) break;
                        return null;
                    case 180:
                        if(pack == null) return new CAMERA_FEEDBACK();
                        final CAMERA_FEEDBACK pi180 = (CAMERA_FEEDBACK) pack;
                        ph.setPack(pi180);
                        on_CAMERA_FEEDBACK.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi180));
                        if(LOOP) break;
                        return null;
                    case 181:
                        if(pack == null) return new BATTERY2();
                        final BATTERY2 pi181 = (BATTERY2) pack;
                        ph.setPack(pi181);
                        on_BATTERY2.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi181));
                        if(LOOP) break;
                        return null;
                    case 182:
                        if(pack == null) return new AHRS3();
                        final AHRS3 pi182 = (AHRS3) pack;
                        ph.setPack(pi182);
                        on_AHRS3.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi182));
                        if(LOOP) break;
                        return null;
                    case 183:
                        if(pack == null) return new AUTOPILOT_VERSION_REQUEST();
                        final AUTOPILOT_VERSION_REQUEST pi183 = (AUTOPILOT_VERSION_REQUEST) pack;
                        ph.setPack(pi183);
                        on_AUTOPILOT_VERSION_REQUEST.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi183));
                        if(LOOP) break;
                        return null;
                    case 184:
                        if(pack == null) return new REMOTE_LOG_DATA_BLOCK();
                        final REMOTE_LOG_DATA_BLOCK pi184 = (REMOTE_LOG_DATA_BLOCK) pack;
                        ph.setPack(pi184);
                        on_REMOTE_LOG_DATA_BLOCK.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi184));
                        if(LOOP) break;
                        return null;
                    case 185:
                        if(pack == null) return new REMOTE_LOG_BLOCK_STATUS();
                        final REMOTE_LOG_BLOCK_STATUS pi185 = (REMOTE_LOG_BLOCK_STATUS) pack;
                        ph.setPack(pi185);
                        on_REMOTE_LOG_BLOCK_STATUS.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi185));
                        if(LOOP) break;
                        return null;
                    case 186:
                        if(pack == null) return new LED_CONTROL();
                        final LED_CONTROL pi186 = (LED_CONTROL) pack;
                        ph.setPack(pi186);
                        on_LED_CONTROL.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi186));
                        if(LOOP) break;
                        return null;
                    case 191:
                        if(pack == null) return new MAG_CAL_PROGRESS();
                        final MAG_CAL_PROGRESS pi191 = (MAG_CAL_PROGRESS) pack;
                        ph.setPack(pi191);
                        on_MAG_CAL_PROGRESS.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi191));
                        if(LOOP) break;
                        return null;
                    case 192:
                        if(pack == null) return new MAG_CAL_REPORT();
                        final MAG_CAL_REPORT pi192 = (MAG_CAL_REPORT) pack;
                        ph.setPack(pi192);
                        on_MAG_CAL_REPORT.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi192));
                        if(LOOP) break;
                        return null;
                    case 193:
                        if(pack == null) return new EKF_STATUS_REPORT();
                        final EKF_STATUS_REPORT pi193 = (EKF_STATUS_REPORT) pack;
                        ph.setPack(pi193);
                        on_EKF_STATUS_REPORT.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi193));
                        if(LOOP) break;
                        return null;
                    case 194:
                        if(pack == null) return new PID_TUNING();
                        final PID_TUNING pi194 = (PID_TUNING) pack;
                        ph.setPack(pi194);
                        on_PID_TUNING.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi194));
                        if(LOOP) break;
                        return null;
                    case 200:
                        if(pack == null) return new GIMBAL_REPORT();
                        final GIMBAL_REPORT pi200 = (GIMBAL_REPORT) pack;
                        ph.setPack(pi200);
                        on_GIMBAL_REPORT.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi200));
                        if(LOOP) break;
                        return null;
                    case 201:
                        if(pack == null) return new GIMBAL_CONTROL();
                        final GIMBAL_CONTROL pi201 = (GIMBAL_CONTROL) pack;
                        ph.setPack(pi201);
                        on_GIMBAL_CONTROL.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi201));
                        if(LOOP) break;
                        return null;
                    case 214:
                        if(pack == null) return new GIMBAL_TORQUE_CMD_REPORT();
                        final GIMBAL_TORQUE_CMD_REPORT pi214 = (GIMBAL_TORQUE_CMD_REPORT) pack;
                        ph.setPack(pi214);
                        on_GIMBAL_TORQUE_CMD_REPORT.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi214));
                        if(LOOP) break;
                        return null;
                    case 215:
                        if(pack == null) return new GOPRO_HEARTBEAT();
                        final GOPRO_HEARTBEAT pi215 = (GOPRO_HEARTBEAT) pack;
                        ph.setPack(pi215);
                        on_GOPRO_HEARTBEAT.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi215));
                        if(LOOP) break;
                        return null;
                    case 216:
                        if(pack == null) return new GOPRO_GET_REQUEST();
                        final GOPRO_GET_REQUEST pi216 = (GOPRO_GET_REQUEST) pack;
                        ph.setPack(pi216);
                        on_GOPRO_GET_REQUEST.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi216));
                        if(LOOP) break;
                        return null;
                    case 217:
                        if(pack == null) return new GOPRO_GET_RESPONSE();
                        final GOPRO_GET_RESPONSE pi217 = (GOPRO_GET_RESPONSE) pack;
                        ph.setPack(pi217);
                        on_GOPRO_GET_RESPONSE.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi217));
                        if(LOOP) break;
                        return null;
                    case 218:
                        if(pack == null) return new GOPRO_SET_REQUEST();
                        final GOPRO_SET_REQUEST pi218 = (GOPRO_SET_REQUEST) pack;
                        ph.setPack(pi218);
                        on_GOPRO_SET_REQUEST.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi218));
                        if(LOOP) break;
                        return null;
                    case 219:
                        if(pack == null) return new GOPRO_SET_RESPONSE();
                        final GOPRO_SET_RESPONSE pi219 = (GOPRO_SET_RESPONSE) pack;
                        ph.setPack(pi219);
                        on_GOPRO_SET_RESPONSE.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi219));
                        if(LOOP) break;
                        return null;
                    case 226:
                        if(pack == null) return new RPM();
                        final RPM pi226 = (RPM) pack;
                        ph.setPack(pi226);
                        on_RPM.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi226));
                        if(LOOP) break;
                        return null;
                    case 230:
                    ...
                    case 10001:
                        ...
                        final UAVIONIX_ADSB_OUT_CFG pi10001 = (UAVIONIX_ADSB_OUT_CFG) pack;
                        ph.setPack(pi10001);
                        on_UAVIONIX_ADSB_OUT_CFG.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi10001));
                        if(LOOP) break;
                        return null;
                    case 10002:
                        if(pack == null) return new UAVIONIX_ADSB_OUT_DYNAMIC();
                        final UAVIONIX_ADSB_OUT_DYNAMIC pi10002 = (UAVIONIX_ADSB_OUT_DYNAMIC) pack;
                        ph.setPack(pi10002);
                        on_UAVIONIX_ADSB_OUT_DYNAMIC.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi10002));
                        if(LOOP) break;
                        return null;
                    case 10003:
                        if(pack == null) return new UAVIONIX_ADSB_TRANSCEIVER_HEALTH_REPORT();
                        final UAVIONIX_ADSB_TRANSCEIVER_HEALTH_REPORT pi10003 = (UAVIONIX_ADSB_TRANSCEIVER_HEALTH_REPORT) pack;
                        ph.setPack(pi10003);
                        on_UAVIONIX_ADSB_TRANSCEIVER_HEALTH_REPORT.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi10003));
                        if(LOOP) break;
                        return null;
                    case 11000:
                        if(pack == null) return new DEVICE_OP_READ(-1);
                        final DEVICE_OP_READ pi11000 = (DEVICE_OP_READ) pack;
                        ph.setPack(pi11000);
                        on_DEVICE_OP_READ.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi11000));
                        if(LOOP) break;
                        return null;
                    case 11001:
                        if(pack == null) return new DEVICE_OP_READ_REPLY();
                        final DEVICE_OP_READ_REPLY pi11001 = (DEVICE_OP_READ_REPLY) pack;
                        ph.setPack(pi11001);
                        on_DEVICE_OP_READ_REPLY.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi11001));
                        if(LOOP) break;
                        return null;
                    case 11002:
                        if(pack == null) return new DEVICE_OP_WRITE(-1);
                        final DEVICE_OP_WRITE pi11002 = (DEVICE_OP_WRITE) pack;
                        ph.setPack(pi11002);
                        on_DEVICE_OP_WRITE.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi11002));
                        if(LOOP) break;
                        return null;
                    case 11003:
                        if(pack == null) return new DEVICE_OP_WRITE_REPLY();
                        final DEVICE_OP_WRITE_REPLY pi11003 = (DEVICE_OP_WRITE_REPLY) pack;
                        ph.setPack(pi11003);
                        on_DEVICE_OP_WRITE_REPLY.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi11003));
                        if(LOOP) break;
                        return null;
                    case 11010:
                        if(pack == null) return new ADAP_TUNING();
                        final ADAP_TUNING pi11010 = (ADAP_TUNING) pack;
                        ph.setPack(pi11010);
                        on_ADAP_TUNING.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi11010));
                        if(LOOP) break;
                        return null;
                    case 11011:
                        if(pack == null) return new VISION_POSITION_DELTA();
                        final VISION_POSITION_DELTA pi11011 = (VISION_POSITION_DELTA) pack;
                        ph.setPack(pi11011);
                        on_VISION_POSITION_DELTA.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi11011));
                        if(LOOP) break;
                        return null;
        ...
        public final Collection<OnReceive.Handler<SENSOR_OFFSETS, LoopBackDemoChannel>> on_SENSOR_OFFSETS = new OnReceive<>();
        public final Collection<OnReceive.Handler<SET_MAG_OFFSETS, LoopBackDemoChannel>> on_SET_MAG_OFFSETS = new OnReceive<>();
        public final Collection<OnReceive.Handler<MEMINFO, LoopBackDemoChannel>> on_MEMINFO = new OnReceive<>();
        public final Collection<OnReceive.Handler<AP_ADC, LoopBackDemoChannel>> on_AP_ADC = new OnReceive<>();
        public final Collection<OnReceive.Handler<DIGICAM_CONFIGURE, LoopBackDemoChannel>> on_DIGICAM_CONFIGURE = new OnReceive<>();
        public final Collection<OnReceive.Handler<DIGICAM_CONTROL, LoopBackDemoChannel>> on_DIGICAM_CONTROL = new OnReceive<>();
        public final Collection<OnReceive.Handler<MOUNT_CONFIGURE, LoopBackDemoChannel>> on_MOUNT_CONFIGURE = new OnReceive<>();
        public final Collection<OnReceive.Handler<MOUNT_CONTROL, LoopBackDemoChannel>> on_MOUNT_CONTROL = new OnReceive<>();
        public final Collection<OnReceive.Handler<MOUNT_STATUS, LoopBackDemoChannel>> on_MOUNT_STATUS = new OnReceive<>();
        public final Collection<OnReceive.Handler<FENCE_POINT, LoopBackDemoChannel>> on_FENCE_POINT = new OnReceive<>();
        public final Collection<OnReceive.Handler<FENCE_FETCH_POINT, LoopBackDemoChannel>> on_FENCE_FETCH_POINT = new OnReceive<>();
        public final Collection<OnReceive.Handler<FENCE_STATUS, LoopBackDemoChannel>> on_FENCE_STATUS = new OnReceive<>();
        public final Collection<OnReceive.Handler<AHRS, LoopBackDemoChannel>> on_AHRS = new OnReceive<>();
        public final Collection<OnReceive.Handler<SIMSTATE, LoopBackDemoChannel>> on_SIMSTATE = new OnReceive<>();
        public final Collection<OnReceive.Handler<HWSTATUS, LoopBackDemoChannel>> on_HWSTATUS = new OnReceive<>();
        public final Collection<OnReceive.Handler<RADIO, LoopBackDemoChannel>> on_RADIO = new OnReceive<>();
        public final Collection<OnReceive.Handler<LIMITS_STATUS, LoopBackDemoChannel>> on_LIMITS_STATUS = new OnReceive<>();
        public final Collection<OnReceive.Handler<WIND, LoopBackDemoChannel>> on_WIND = new OnReceive<>();
        public final Collection<OnReceive.Handler<DATA16, LoopBackDemoChannel>> on_DATA16 = new OnReceive<>();
        public final Collection<OnReceive.Handler<DATA32, LoopBackDemoChannel>> on_DATA32 = new OnReceive<>();
        public final Collection<OnReceive.Handler<DATA64, LoopBackDemoChannel>> on_DATA64 = new OnReceive<>();
        public final Collection<OnReceive.Handler<DATA96, LoopBackDemoChannel>> on_DATA96 = new OnReceive<>();
        public final Collection<OnReceive.Handler<RANGEFINDER, LoopBackDemoChannel>> on_RANGEFINDER = new OnReceive<>();
        public final Collection<OnReceive.Handler<AIRSPEED_AUTOCAL, LoopBackDemoChannel>> on_AIRSPEED_AUTOCAL = new OnReceive<>();
        public final Collection<OnReceive.Handler<RALLY_POINT, LoopBackDemoChannel>> on_RALLY_POINT = new OnReceive<>();
        public final Collection<OnReceive.Handler<RALLY_FETCH_POINT, LoopBackDemoChannel>> on_RALLY_FETCH_POINT = new OnReceive<>();
        public final Collection<OnReceive.Handler<COMPASSMOT_STATUS, LoopBackDemoChannel>> on_COMPASSMOT_STATUS = new OnReceive<>();
        public final Collection<OnReceive.Handler<AHRS2, LoopBackDemoChannel>> on_AHRS2 = new OnReceive<>();
        public final Collection<OnReceive.Handler<CAMERA_STATUS, LoopBackDemoChannel>> on_CAMERA_STATUS = new OnReceive<>();
        public final Collection<OnReceive.Handler<CAMERA_FEEDBACK, LoopBackDemoChannel>> on_CAMERA_FEEDBACK = new OnReceive<>();
        public final Collection<OnReceive.Handler<BATTERY2, LoopBackDemoChannel>> on_BATTERY2 = new OnReceive<>();
        public final Collection<OnReceive.Handler<AHRS3, LoopBackDemoChannel>> on_AHRS3 = new OnReceive<>();
        public final Collection<OnReceive.Handler<AUTOPILOT_VERSION_REQUEST, LoopBackDemoChannel>> on_AUTOPILOT_VERSION_REQUEST = new OnReceive<>();
        public final Collection<OnReceive.Handler<REMOTE_LOG_DATA_BLOCK, LoopBackDemoChannel>> on_REMOTE_LOG_DATA_BLOCK = new OnReceive<>();
        public final Collection<OnReceive.Handler<REMOTE_LOG_BLOCK_STATUS, LoopBackDemoChannel>> on_REMOTE_LOG_BLOCK_STATUS = new OnReceive<>();
        public final Collection<OnReceive.Handler<LED_CONTROL, LoopBackDemoChannel>> on_LED_CONTROL = new OnReceive<>();
        public final Collection<OnReceive.Handler<MAG_CAL_PROGRESS, LoopBackDemoChannel>> on_MAG_CAL_PROGRESS = new OnReceive<>();
        public final Collection<OnReceive.Handler<MAG_CAL_REPORT, LoopBackDemoChannel>> on_MAG_CAL_REPORT = new OnReceive<>();
        public final Collection<OnReceive.Handler<EKF_STATUS_REPORT, LoopBackDemoChannel>> on_EKF_STATUS_REPORT = new OnReceive<>();
        public final Collection<OnReceive.Handler<PID_TUNING, LoopBackDemoChannel>> on_PID_TUNING = new OnReceive<>();
        public final Collection<OnReceive.Handler<GIMBAL_REPORT, LoopBackDemoChannel>> on_GIMBAL_REPORT = new OnReceive<>();
        public final Collection<OnReceive.Handler<GIMBAL_CONTROL, LoopBackDemoChannel>> on_GIMBAL_CONTROL = new OnReceive<>();
        public final Collection<OnReceive.Handler<GIMBAL_TORQUE_CMD_REPORT, LoopBackDemoChannel>> on_GIMBAL_TORQUE_CMD_REPORT = new OnReceive<>();
        public final Collection<OnReceive.Handler<GOPRO_HEARTBEAT, LoopBackDemoChannel>> on_GOPRO_HEARTBEAT = new OnReceive<>();
        public final Collection<OnReceive.Handler<GOPRO_GET_REQUEST, LoopBackDemoChannel>> on_GOPRO_GET_REQUEST = new OnReceive<>();
        public final Collection<OnReceive.Handler<GOPRO_GET_RESPONSE, LoopBackDemoChannel>> on_GOPRO_GET_RESPONSE = new OnReceive<>();
        public final Collection<OnReceive.Handler<GOPRO_SET_REQUEST, LoopBackDemoChannel>> on_GOPRO_SET_REQUEST = new OnReceive<>();
        public final Collection<OnReceive.Handler<GOPRO_SET_RESPONSE, LoopBackDemoChannel>> on_GOPRO_SET_RESPONSE = new OnReceive<>();
        public final Collection<OnReceive.Handler<RPM, LoopBackDemoChannel>> on_RPM = new OnReceive<>();
        ...
        public final Collection<OnReceive.Handler<UAVIONIX_ADSB_OUT_CFG, LoopBackDemoChannel>> on_UAVIONIX_ADSB_OUT_CFG = new OnReceive<>();
        public final Collection<OnReceive.Handler<UAVIONIX_ADSB_OUT_DYNAMIC, LoopBackDemoChannel>> on_UAVIONIX_ADSB_OUT_DYNAMIC = new OnReceive<>();
        public final Collection<OnReceive.Handler<UAVIONIX_ADSB_TRANSCEIVER_HEALTH_REPORT, LoopBackDemoChannel>> on_UAVIONIX_ADSB_TRANSCEIVER_HEALTH_REPORT = new OnReceive<>();
        public final Collection<OnReceive.Handler<DEVICE_OP_READ, LoopBackDemoChannel>> on_DEVICE_OP_READ = new OnReceive<>();
        public final Collection<OnReceive.Handler<DEVICE_OP_READ_REPLY, LoopBackDemoChannel>> on_DEVICE_OP_READ_REPLY = new OnReceive<>();
        public final Collection<OnReceive.Handler<DEVICE_OP_WRITE, LoopBackDemoChannel>> on_DEVICE_OP_WRITE = new OnReceive<>();
        public final Collection<OnReceive.Handler<DEVICE_OP_WRITE_REPLY, LoopBackDemoChannel>> on_DEVICE_OP_WRITE_REPLY = new OnReceive<>();
        public final Collection<OnReceive.Handler<ADAP_TUNING, LoopBackDemoChannel>> on_ADAP_TUNING = new OnReceive<>();
        public final Collection<OnReceive.Handler<VISION_POSITION_DELTA, LoopBackDemoChannel>> on_VISION_POSITION_DELTA = new OnReceive<>();
    }
    ...
    private static final Field _Z = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
    private static final Field _B = new Field(5, true, -6, 2, 1, 0, 0, 0, 1);
    private static final Field _V = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
    private static final Field _G = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
    private static final Field _T = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
    private static final Field _Up = new Field(0, false, 1, 4, 1, 0, 0, 0);
    private static final Field _Hp = new Field(0, true, 1, 4, 1, 0, 0, 0);
    private static final Field _lp = new Field(0, true, 1, 4, 1, 0, 0, 0);
    private static final Field _Ip = new Field(0, true, 1, 4, 1, 0, 0, 0);
    private static final Field _cp = new Field(0, true, 1, 4, 1, 0, 0, 0);
    private static final Field _Nu = new Field(0, true, 1, 2, 1, 0, 0, 0);
    private static final Field _Uu = new Field(0, true, 1, 2, 1, 0, 0, 0);
    private static final Field _Hu = new Field(0, true, 1, 2, 1, 0, 0, 0);
    private static final Field _lu = new Field(0, true, 1, 2, 1, 0, 0, 0);
    private static final Field _Iu = new Field(0, true, 1, 2, 1, 0, 0, 0);
    private static final Field _cu = new Field(0, true, 1, 2, 1, 0, 0, 0);
    private static final Field _Fu = new Field(0, true, 1, 2, 1, 0, 0, 0);
    private static final Field _xu = new Field(0, true, 1, 2, 1, 0, 0, 0);
    private static final Field _aO = new Field(0, true, 1, 8, 1, 0, 0, 0);
    private static final Field _nO = new Field(0, true, 1, 8, 1, 0, 0, 0);
    private static final Field _YO = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
    private static final Field _by = new Field(0, false, 1, 1, 1, 0, 0, 0);
    private static final Field _Yy = new Field(0, false, 1, 4, 1, 0, 0, 0);
    private static final Field _Sy = new Field(0, false, 1, 1, 1, 0, 0, 0);
    private static final Field _jy = new Field(0, false, 1, 1, 1, 0, 0, 0);
    private static final Field _cU = new Field(0, false, 1, 4, 1, 0, 0, 0);
    private static final Field _FU = new Field(0, false, 1, 4, 1, 0, 0, 0);
    private static final Field _ma = new Field(0, false, 18, 1, 1, 0, 0, 0);
    private static final Field _ca = new Field(0, false, 1, 4, 1, 0, 0, 0);
    private static final Field _Fa = new Field(0, false, 1, 4, 1, 0, 0, 0);
    private static final Field _xa = new Field(0, false, 1, 4, 1, 0, 0, 0);
    private static final Field _aa = new Field(0, false, 4, 4, 1, 0, 0, 0);
    private static final Field _za = new Field(0, false, 1, 1, 1, 0, 0, 0);
    private static final Field _Tk = new Field(0, true, 1, 8, 1, 0, 0, 0);
    private static final Field _Nz = new Field(0, true, 1, 8, 1, 0, 0, 0);
    private static final Field _dz = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
    private static final Field _sz = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
    private static final Field _Tz = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
    private static final Field _Wh = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
    private static final Field _uh = new Field(5, true, -6, 2, 1, 0, 0, 0, 1);
    private static final Field _xh = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
    private static final Field _Lh = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
    private static final Field _mn = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
    private static final Field _An = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
    private static final Field _rn = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
    private static final Field _Cn = new Field(5, true, -6, 2, 1, 0, 0, 0, 1);
    private static final Field _Qn = new Field(5, true, -7, 2, 1, 0, 0, 0, 1);
    private static final Field _Nd = new Field(5, true, -7, 2, 1, 0, 0, 0, 1);
    private static final Field _kd = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
    private static final Field _dd = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
    private static final Field _bd = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
    private static final Field _Ld = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
    private static final Field _Jd = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
    private static final Field _Bd = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
    private static final Field _Dd = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
    private static final Field _sd = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
    private static final Field _eb = new Field(0, true, 1, 4, 1, 0, 0, 0);
    private static final Field _pL = new Field(5, true, -6, 2, 1, 0, 0, 0, 1);
    private static final Field _FL = new Field(5, true, -6, 2, 1, 0, 0, 0, 1);
