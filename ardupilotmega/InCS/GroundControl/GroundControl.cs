...
*	 this way*/
        public class POSITION_TARGET_LOCAL_NED : Pack
        {
...
*Request to control this MAV*/
        public class CHANGE_OPERATOR_CONTROL : Pack
        {
            ...
            *	 characters may involve A-Z, a-z, 0-9, and "!?,.-*/
            ...
            } static readonly Meta meta5 = new Meta(5, 0, 0, 0, 4, 24, 0, _N);
        }/**
...
*	 so transmitting the key requires an encrypted channel for true safety*/
        public class AUTH_KEY : Pack
        {
            ...
            } static readonly Meta meta7 = new Meta(7, 0, 0, 0, 1, 0, 0, _W);
        }/**
...
*	 of QGroundControl and IMU code*/
        public class PARAM_REQUEST_READ : Pack
        {
            ...
            *	 storage if the ID is stored as strin*/
            ...
            } static readonly Meta meta20 = new Meta(20, 0, 0, 0, 5, 32, 0, _T);
        }/**
...
*	 a loss or timeout*/
        public class PARAM_VALUE : Pack
        {
            ...
            *	 storage if the ID is stored as strin*/
            ...
            } static readonly Meta meta22 = new Meta(22, 2, 0, 0, 10, 68, 0, _r);
        }/**
...
*	 NOT the global position estimate of the system, but rather a RAW sensor value. See message GLOBAL_POSITION for the global position estimate. Coordinate frame is right-handed, Z-axis up (GPS frame).*/
        public class GPS_RAW_INT : Pack
        {
            ...
            *	 the AMSL altitude in addition to the WGS84 altitude*/
            ...
            static readonly Meta meta24 = new Meta(24, 4, 0, 1, 31, 236, 0, _DQ, _dQ, _PQ, _VQ, _tQ);
        }/**
...
*	 standard PPM modulation is as follows: 1000 microseconds: 0%, 2000 microseconds: 100%*/
        public class SERVO_OUTPUT_RAW : Pack
        {
            ...
            *	 more than 8 servos*/
            ...
            static readonly Meta meta36 = new Meta(36, 8, 1, 0, 22, 168, 0, _oH, _DH, _dH, _PH, _VH, _tH, _xH, _cH);
        }/**
...
*	 If start and end index are the same, just send one waypoint*/
        public class MISSION_REQUEST_PARTIAL_LIST : Pack
        {
            ...
            {
                get {  return  en__W(BitUtils.get_bits(data, 48, 3));}
            }
...
*	 the presence of a mission item and to set a mission item on the system. The mission item can be either in x, y, z meters (type: LOCAL) or x:lat, y:lon, z:altitude. Local frame is Z-down, right handed (NED), global frame is Z-up, right handed (ENU). See also http:qgroundcontrol.org/mavlink/waypoint_protocol.*/
        public class MISSION_ITEM : Pack
        {
            ...
            {
                get {  return  en__f(BitUtils.get_bits(data, 276, 8));}
            }

            public MAV_MISSION_TYPE mission_type //Mission type, see MAV_MISSION_TYPE
            {
                get {  return  en__W(BitUtils.get_bits(data, 284, 3));}
            }
...
*	 this message should be a MISSION_ITEM message. http:qgroundcontrol.org/mavlink/waypoint_protoco*/
        public class MISSION_REQUEST : Pack
        {
            ...
            public MAV_MISSION_TYPE mission_type //Mission type, see MAV_MISSION_TYPE
            {
                get {  return  en__W(BitUtils.get_bits(data, 32, 3));}
            }
...
*Request the overall list of mission items from the system/component.*/
        public class MISSION_REQUEST_LIST : Pack
        {
            ...
            public MAV_MISSION_TYPE mission_type //Mission type, see MAV_MISSION_TYPE
            {
                get {  return  en__W(BitUtils.get_bits(data, 16, 3));}
            }
...
*	 or if an error happened (type=non-zero)*/
        public class MISSION_ACK : Pack
        {
            ...
            public MAV_MISSION_TYPE mission_type //Mission type, see MAV_MISSION_TYPE
            {
                get {  return  en__W(BitUtils.get_bits(data, 20, 3));}
            }
...
*	 are connected and the MAV should move from in- to outdoor*/
        public class SET_GPS_GLOBAL_ORIGIN : Pack
        {
            ...
            static readonly Meta meta48 = new Meta(48, 0, 0, 0, 14, 104, 0, _IM);
        }/**
*Once the MAV sets a new GPS-Local correspondence, this message announces the origin (0,0,0) positio*/
        public class GPS_GLOBAL_ORIGIN : Pack
        {
            ...
            static readonly Meta meta49 = new Meta(49, 0, 0, 0, 13, 96, 0, _CM);
        }/**
*Bind a RC channel to a parameter. The parameter should change accoding to the RC channel value.*/
        public class PARAM_MAP_RC : Pack
        {
            ...
            *	 storage if the ID is stored as strin*/
            ...
            } static readonly Meta meta50 = new Meta(50, 0, 0, 0, 22, 168, 0, _kM);
        }/**
*Request the information of the mission item with the sequence number seq. The response of the system to
...
*Message encoding a command with parameters as scaled integers. Scaling depends on the actual command value*/
        public class COMMAND_INT : Pack
        {
            ...
            {
                get {  return  en__f(BitUtils.get_bits(data, 260, 8));}
            }
...
*Send a command with up to seven parameters to the MAV*/
        public class COMMAND_LONG : Pack
        {
            ...
            {
                get {  return  en__f(BitUtils.get_bits(data, 248, 8));}
            }
...
*Report status of a command. Includes feedback whether the command was executed.*/
        public class COMMAND_ACK : Pack
        {
            ...
            public MAV_CMD command //Command ID, as defined by MAV_CMD enum.
            {
                get {  return  en__f(BitUtils.get_bits(data, 0, 8));}
            }
            ...
            *	 be denied*/
            ...
            static readonly Meta meta77 = new Meta(77, 0, 0, 0, 3, 11, 0, _GO, _kO, _RO, _aO);
        }/**
...
*	 or other system)*/
        public class SET_ATTITUDE_TARGET : Pack
        {
...
*	 the commands sent in a SET_ATTITUDE_TARGET message if the vehicle is being controlled this way*/
        public class ATTITUDE_TARGET : Pack
        {
...
*	 to command the vehicle (manual controller or other system)*/
        public class SET_POSITION_TARGET_LOCAL_NED : Pack
        {
...
*	 this way*/
        public class POSITION_TARGET_GLOBAL_INT : Pack
        {
...
*	 convention*/
        public class LOCAL_POSITION_NED_SYSTEM_GLOBAL_OFFSET : Pack
        {
...
*Sent from autopilot to simulation. Hardware in the loop control outputs*/
        public class HIL_CONTROLS : Pack
        {
...
*	 violate this specification*/
        public class HIL_RC_INPUTS_RAW : Pack
        {
...
*Sent from autopilot to simulation. Hardware in the loop control outputs (replacement for HIL_CONTROLS*/
        public class HIL_ACTUATOR_CONTROLS : Pack
        {
...
*Optical flow from a flow sensor (e.g. optical mouse sensor)*/
        public class OPTICAL_FLOW : Pack
        {
            ...
            static readonly Meta meta100 = new Meta(100, 0, 0, 1, 27, 208, 0, _tD, _xD);
        ...
        } public class VISION_POSITION_ESTIMATE : Pack
        {
...
*	 use uid*/
            public void uid2_SET(byte[] src, int pos, Inside ph)
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + 18; pos < src_max; pos++, BYTE += 1)
                    BitUtils.set_bytes((ulong)(src[pos]), 1, data,  BYTE);
            } static readonly Meta meta148 = new Meta(148, 2, 4, 1, 56, 433, 0, _wI);
        }/**
...
*	 the landing targe*/
            ...
            *	 the landing targe*/
            ...
            } static readonly Meta meta149 = new Meta(149, 0, 0, 1, 31, 238, 0, _tI, _xI, _cI, _II, _FI);
        }/**
*Offsets and calibrations values for hardware sensors. This makes it easier to debug the calibration process*/
        public class SENSOR_OFFSETS : Pack, CommunicationChannel.Sendable
        {
            internal SENSOR_OFFSETS() : base(meta150, 0) { }
            ...
            static readonly Meta meta150 = new Meta(150, 0, 0, 0, 42, 336);
        }/**
*Deprecated. Use MAV_CMD_PREFLIGHT_SET_SENSOR_OFFSETS instead. Set the magnetometer offsets*/
        public class SET_MAG_OFFSETS : Pack, CommunicationChannel.Sendable
        {
            internal SET_MAG_OFFSETS() : base(meta151, 0) { }
            ...
            static readonly Meta meta151 = new Meta(151, 0, 0, 0, 8, 64);
        }/**
*state of APM memory*/
        public class MEMINFO : Pack, CommunicationChannel.Sendable
        {
            internal MEMINFO() : base(meta152, 0) { }
            ...
            public void freemem32_SET(uint src, Inside ph)//free memory (32 bit)
            {
                if(ph.field_bit != 32)insert_field(ph, 32, 0);
                BitUtils.set_bytes((ulong)(src), 4, data,  ph.BYTE);
            } static readonly Meta meta152 = new Meta(152, 2, 0, 0, 5, 32, 0, _YG);
        }/**
*raw ADC output*/
        public class AP_ADC : Pack, CommunicationChannel.Sendable
        {
            internal AP_ADC() : base(meta153, 0) { }
            ...
            static readonly Meta meta153 = new Meta(153, 6, 0, 0, 12, 96);
        }/**
*Configure on-board Camera Control System.*/
        public class DIGICAM_CONFIGURE : Pack, CommunicationChannel.Sendable
        {
            internal DIGICAM_CONFIGURE() : base(meta154, 0) { }
            ...
            *	 just onc*/
            ...
            static readonly Meta meta154 = new Meta(154, 1, 0, 0, 15, 120);
        }/**
*Control on-board Camera Control System to take shots.*/
        public class DIGICAM_CONTROL : Pack, CommunicationChannel.Sendable
        {
            internal DIGICAM_CONTROL() : base(meta155, 0) { }
            ...
            {
                set {  BitUtils.set_bytes((byte)(value), 1, data,  4);}
            }
            ...
            *	 just onc*/
            ...
            static readonly Meta meta155 = new Meta(155, 0, 0, 0, 13, 104);
        }/**
*Message to configure a camera mount, directional antenna, etc.*/
        public class MOUNT_CONFIGURE : Pack, CommunicationChannel.Sendable
        {
            internal MOUNT_CONFIGURE() : base(meta156, 0) { }
            ...
            {
                set {  BitUtils.set_bits((ulong)(- 0 +   value), 3, data, 40);}
            }
            static readonly Meta meta156 = new Meta(156, 0, 0, 0, 6, 43);
        }/**
*Message to control a camera mount, directional antenna, etc.*/
        public class MOUNT_CONTROL : Pack, CommunicationChannel.Sendable
        {
            internal MOUNT_CONTROL() : base(meta157, 0) { }
            ...
            static readonly Meta meta157 = new Meta(157, 0, 0, 0, 15, 120);
        }/**
*Message with some status from APM to GCS about camera or antenna mount*/
        public class MOUNT_STATUS : Pack, CommunicationChannel.Sendable
        {
            internal MOUNT_STATUS() : base(meta158, 0) { }
            ...
            static readonly Meta meta158 = new Meta(158, 0, 0, 0, 14, 112);
        }/**
*GCS*/
        public class FENCE_POINT : Pack, CommunicationChannel.Sendable
        {
            internal FENCE_POINT() : base(meta160, 0) { }
            ...
            static readonly Meta meta160 = new Meta(160, 0, 0, 0, 12, 96);
        }/**
*Request a current fence point from MAV*/
        public class FENCE_FETCH_POINT : Pack, CommunicationChannel.Sendable
        {
            internal FENCE_FETCH_POINT() : base(meta161, 0) { }
            ...
            static readonly Meta meta161 = new Meta(161, 0, 0, 0, 3, 24);
        }/**
*Status of geo-fencing. Sent in extended status stream when fencing enabled*/
        public class FENCE_STATUS : Pack, CommunicationChannel.Sendable
        {
            internal FENCE_STATUS() : base(meta162, 0) { }
            ...
            {
                set {  BitUtils.set_bits((ulong)(- 0 +   value), 2, data, 56);}
            }
            static readonly Meta meta162 = new Meta(162, 1, 1, 0, 8, 58);
        }/**
*Status of DCM attitude estimator*/
        public class AHRS : Pack, CommunicationChannel.Sendable
        {
            internal AHRS() : base(meta163, 0) { }
            ...
            static readonly Meta meta163 = new Meta(163, 0, 0, 0, 28, 224);
        }/**
*Status of simulation environment, if used*/
        public class SIMSTATE : Pack, CommunicationChannel.Sendable
        {
            internal SIMSTATE() : base(meta164, 0) { }
            ...
            static readonly Meta meta164 = new Meta(164, 0, 0, 0, 44, 352);
        }/**
*Status of key hardware*/
        public class HWSTATUS : Pack, CommunicationChannel.Sendable
        {
            internal HWSTATUS() : base(meta165, 0) { }
            ...
            static readonly Meta meta165 = new Meta(165, 1, 0, 0, 3, 24);
        }/**
*Status generated by radio*/
        public class RADIO : Pack, CommunicationChannel.Sendable
        {
            internal RADIO() : base(meta166, 0) { }
            ...
            static readonly Meta meta166 = new Meta(166, 2, 0, 0, 9, 72);
        }/**
*Status of AP_Limits. Sent in extended status stream when AP_Limits is enabled*/
        public class LIMITS_STATUS : Pack, CommunicationChannel.Sendable
        {
            internal LIMITS_STATUS() : base(meta167, 0) { }
...
*Wind estimation*/
        public class WIND : Pack, CommunicationChannel.Sendable
        {
            ...
            static readonly Meta meta168 = new Meta(168, 0, 0, 0, 12, 96);
        }/**
*Data packet, size 16*/
        public class DATA16 : Pack, CommunicationChannel.Sendable
        {
            internal DATA16() : base(meta169, 0) { }
            ...
            public void data__SET(byte[] src, int pos)  //raw data
            {
                for(int BYTE =  2, src_max = pos + 16; pos < src_max; pos++, BYTE += 1)
                    BitUtils.set_bytes((ulong)(src[pos]), 1, data,  BYTE);
            }
            static readonly Meta meta169 = new Meta(169, 0, 0, 0, 18, 144);
        }/**
*Data packet, size 32*/
        public class DATA32 : Pack, CommunicationChannel.Sendable
        {
            internal DATA32() : base(meta170, 0) { }
            ...
            static readonly Meta meta170 = new Meta(170, 0, 0, 0, 34, 272);
        }/**
*Data packet, size 64*/
        public class DATA64 : Pack, CommunicationChannel.Sendable
        {
            internal DATA64() : base(meta171, 0) { }
            ...
            static readonly Meta meta171 = new Meta(171, 0, 0, 0, 66, 528);
        }/**
*Data packet, size 96*/
        public class DATA96 : Pack, CommunicationChannel.Sendable
        {
            internal DATA96() : base(meta172, 0) { }
            ...
            static readonly Meta meta172 = new Meta(172, 0, 0, 0, 98, 784);
        }/**
*Rangefinder reporting*/
        public class RANGEFINDER : Pack, CommunicationChannel.Sendable
        {
            internal RANGEFINDER() : base(meta173, 0) { }
            ...
            static readonly Meta meta173 = new Meta(173, 0, 0, 0, 8, 64);
        }/**
*Airspeed auto-calibration*/
        public class AIRSPEED_AUTOCAL : Pack, CommunicationChannel.Sendable
        {
            internal AIRSPEED_AUTOCAL() : base(meta174, 0) { }
            ...
            static readonly Meta meta174 = new Meta(174, 0, 0, 0, 48, 384);
        }/**
*GCS*/
        public class RALLY_POINT : Pack, CommunicationChannel.Sendable
        {
            internal RALLY_POINT() : base(meta175, 0) { }
            ...
            {
                set {  BitUtils.set_bits((ulong)(- 1 +   value), 1, data, 144);}
            }
            static readonly Meta meta175 = new Meta(175, 1, 0, 0, 19, 145);
        }/**
...
*	 respond if the request is invalid*/
        public class RALLY_FETCH_POINT : Pack, CommunicationChannel.Sendable
        {
            internal RALLY_FETCH_POINT() : base(meta176, 0) { }
            ...
            static readonly Meta meta176 = new Meta(176, 0, 0, 0, 3, 24);
        }/**
*Status of compassmot calibration*/
        public class COMPASSMOT_STATUS : Pack, CommunicationChannel.Sendable
        {
            internal COMPASSMOT_STATUS() : base(meta177, 0) { }
            ...
            static readonly Meta meta177 = new Meta(177, 2, 0, 0, 20, 160);
        }/**
*Status of secondary AHRS filter if available*/
        public class AHRS2 : Pack, CommunicationChannel.Sendable
        {
            internal AHRS2() : base(meta178, 0) { }
            ...
            static readonly Meta meta178 = new Meta(178, 0, 0, 0, 24, 192);
        }/**
*Camera Event*/
        public class CAMERA_STATUS : Pack, CommunicationChannel.Sendable
        {
            internal CAMERA_STATUS() : base(meta179, 0) { }
            ...
            {
                set {  BitUtils.set_bits((ulong)(- 0 +   value), 3, data, 224);}
            }
            static readonly Meta meta179 = new Meta(179, 1, 0, 1, 29, 227);
        }/**
*Camera Capture Feedback*/
        public class CAMERA_FEEDBACK : Pack, CommunicationChannel.Sendable
        {
            internal CAMERA_FEEDBACK() : base(meta180, 0) { }
            ...
            *	 no CCB*/
            ...
            {
                set {  BitUtils.set_bits((ulong)(- 0 +   value), 3, data, 352);}
            }
            static readonly Meta meta180 = new Meta(180, 1, 0, 1, 45, 355);
        }/**
*2nd Battery status*/
        public class BATTERY2 : Pack, CommunicationChannel.Sendable
        {
            internal BATTERY2() : base(meta181, 0) { }
            ...
            static readonly Meta meta181 = new Meta(181, 1, 0, 0, 4, 32);
        }/**
*Status of third AHRS filter if available. This is for ANU research group (Ali and Sean)*/
        public class AHRS3 : Pack, CommunicationChannel.Sendable
        {
            internal AHRS3() : base(meta182, 0) { }
            ...
            static readonly Meta meta182 = new Meta(182, 0, 0, 0, 40, 320);
        }/**
*Request the autopilot version from the system/component.*/
        public class AUTOPILOT_VERSION_REQUEST : Pack, CommunicationChannel.Sendable
        {
            internal AUTOPILOT_VERSION_REQUEST() : base(meta183, 0) { }
            ...
            static readonly Meta meta183 = new Meta(183, 0, 0, 0, 2, 16);
        }/**
*Send a block of log data to remote location*/
        public class REMOTE_LOG_DATA_BLOCK : Pack, CommunicationChannel.Sendable
        {
            internal REMOTE_LOG_DATA_BLOCK() : base(meta184, 0) { }
            ...
            public void data__SET(byte[] src, int pos)  //log data block
            {
            ...
            {
                set {  BitUtils.set_bits((ulong)(- 2147483645 +   value), 1, data, 1616);}
            }
            static readonly Meta meta184 = new Meta(184, 0, 0, 0, 203, 1617);
        }/**
*Send Status of each log block that autopilot board might have sent*/
        public class REMOTE_LOG_BLOCK_STATUS : Pack, CommunicationChannel.Sendable
        {
            internal REMOTE_LOG_BLOCK_STATUS() : base(meta185, 0) { }
            ...
            {
                set {  BitUtils.set_bits((ulong)(- 0 +   value), 1, data, 48);}
            }
            static readonly Meta meta185 = new Meta(185, 0, 1, 0, 7, 49);
        }/**
*Control vehicle LEDs*/
        public class LED_CONTROL : Pack, CommunicationChannel.Sendable
        {
            internal LED_CONTROL() : base(meta186, 0) { }
            ...
            {
                set {custom_bytes_SET(value, 0)  ;}
            }
            public void custom_bytes_SET(byte[] src, int pos)  //Custom Bytes
            {
                for(int BYTE =  5, src_max = pos + 24; pos < src_max; pos++, BYTE += 1)
                    BitUtils.set_bytes((ulong)(src[pos]), 1, data,  BYTE);
            }
            static readonly Meta meta186 = new Meta(186, 0, 0, 0, 29, 232);
        }/**
*Reports progress of compass calibration.*/
        public class MAG_CAL_PROGRESS : Pack, CommunicationChannel.Sendable
        {
            internal MAG_CAL_PROGRESS() : base(meta191, 0) { }
            ...
            {
                set {completion_mask_SET(value, 0)  ;}
            }
            public void completion_mask_SET(byte[] src, int pos)  //Bitmask of sphere sections (see http:en.wikipedia.org/wiki/Geodesic_grid)
            {
            ...
            {
                set {  BitUtils.set_bits((ulong)(- 0 +   value), 3, data, 208);}
            }
            static readonly Meta meta191 = new Meta(191, 0, 0, 0, 27, 211);
        }/**
*Reports results of completed compass calibration. Sent until MAG_CAL_ACK received.*/
        public class MAG_CAL_REPORT : Pack, CommunicationChannel.Sendable
        {
            internal MAG_CAL_REPORT() : base(meta192, 0) { }
            ...
            {
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 39);}
            }

            public MAG_CAL_STATUS cal_status //Status (see MAG_CAL_STATUS enum)
            {
                set {  BitUtils.set_bits((ulong)(- 0 +   value), 3, data, 344);}
            }
            static readonly Meta meta192 = new Meta(192, 0, 0, 0, 44, 347);
        }/**
*EKF Status message including flags and variances*/
        public class EKF_STATUS_REPORT : Pack, CommunicationChannel.Sendable
        {
            internal EKF_STATUS_REPORT() : base(meta193, 0) { }
            ...
            {
                set {  BitUtils.set_bits((ulong)(- 1 +   value), 10, data, 160);}
            }
            static readonly Meta meta193 = new Meta(193, 0, 0, 0, 22, 170);
        }/**
*PID tuning information*/
        public class PID_TUNING : Pack, CommunicationChannel.Sendable
        {
            internal PID_TUNING() : base(meta194, 0) { }
            ...
            {
                set {  BitUtils.set_bits((ulong)(- 1 +   value), 3, data, 192);}
            }
            static readonly Meta meta194 = new Meta(194, 0, 0, 0, 25, 195);
        }/**
*3 axis gimbal mesuraments*/
        public class GIMBAL_REPORT : Pack, CommunicationChannel.Sendable
        {
            internal GIMBAL_REPORT() : base(meta200, 0) { }
            ...
            static readonly Meta meta200 = new Meta(200, 0, 0, 0, 42, 336);
        }/**
*Control message for rate gimbal*/
        public class GIMBAL_CONTROL : Pack, CommunicationChannel.Sendable
        {
            internal GIMBAL_CONTROL() : base(meta201, 0) { }
            ...
            static readonly Meta meta201 = new Meta(201, 0, 0, 0, 14, 112);
        }/**
*100 Hz gimbal torque command telemetry*/
        public class GIMBAL_TORQUE_CMD_REPORT : Pack, CommunicationChannel.Sendable
        {
            internal GIMBAL_TORQUE_CMD_REPORT() : base(meta214, 0) { }
            ...
            static readonly Meta meta214 = new Meta(214, 0, 0, 0, 8, 64);
        }/**
*Heartbeat from a HeroBus attached GoPro*/
        public class GOPRO_HEARTBEAT : Pack, CommunicationChannel.Sendable
        {
            internal GOPRO_HEARTBEAT() : base(meta215, 0) { }

            public GOPRO_HEARTBEAT_STATUS status //Status
            {
                set {  BitUtils.set_bits((ulong)(- 0 +   value), 2, data, 0);}
            }
            ...
            public GOPRO_CAPTURE_MODE capture_mode //Current capture mode
            {
                set
                {
                    ...
                    BitUtils.set_bits(id, 4, data, 2);
                }
            }

            public GOPRO_HEARTBEAT_FLAGS flags //additional status bits
            {
                set {  BitUtils.set_bits((ulong)(- 1 +   value), 1, data, 6);}
            }
            static readonly Meta meta215 = new Meta(215, 0, 0, 0, 1, 7);
        }/**
*Request a GOPRO_COMMAND response from the GoPro*/
        public class GOPRO_GET_REQUEST : Pack, CommunicationChannel.Sendable
        {
            internal GOPRO_GET_REQUEST() : base(meta216, 0) { }
            ...
            {
                set {  BitUtils.set_bits((ulong)(- 0 +   value), 5, data, 16);}
            }
            static readonly Meta meta216 = new Meta(216, 0, 0, 0, 3, 21);
        }/**
*Response from a GOPRO_COMMAND get request*/
        public class GOPRO_GET_RESPONSE : Pack, CommunicationChannel.Sendable
        {
            internal GOPRO_GET_RESPONSE() : base(meta217, 0) { }

            public byte[] value //Value
            {
                set {value_SET(value, 0)  ;}
            }
            public void value_SET(byte[] src, int pos)  //Value
            {
            ...
            public GOPRO_COMMAND cmd_id //Command ID
            {
                set {  BitUtils.set_bits((ulong)(- 0 +   value), 5, data, 32);}
            }

            public GOPRO_REQUEST_STATUS status //Status
            {
                set {  BitUtils.set_bits((ulong)(- 0 +   value), 1, data, 37);}
            }
            static readonly Meta meta217 = new Meta(217, 0, 0, 0, 5, 38);
        }/**
*Request to set a GOPRO_COMMAND with a desired*/
        public class GOPRO_SET_REQUEST : Pack, CommunicationChannel.Sendable
        {
            internal GOPRO_SET_REQUEST() : base(meta218, 0) { }
            ...
            static readonly Meta meta218 = new Meta(218, 0, 0, 0, 7, 53);
        }/**
*Response from a GOPRO_COMMAND set request*/
        public class GOPRO_SET_RESPONSE : Pack, CommunicationChannel.Sendable
        {
            internal GOPRO_SET_RESPONSE() : base(meta219, 0) { }

            public GOPRO_COMMAND cmd_id //Command ID
            {
                set {  BitUtils.set_bits((ulong)(- 0 +   value), 5, data, 0);}
            }

            public GOPRO_REQUEST_STATUS status //Status
            {
                set {  BitUtils.set_bits((ulong)(- 0 +   value), 1, data, 5);}
            }
            static readonly Meta meta219 = new Meta(219, 0, 0, 0, 1, 6);
        }/**
*RPM sensor output*/
        public class RPM : Pack, CommunicationChannel.Sendable
        {
            internal RPM() : base(meta226, 0) { }
            ...
            static readonly Meta meta226 = new Meta(226, 0, 0, 0, 8, 64);
        }/**
...
*	 the vector*/
        public class HOME_POSITION : Pack, CommunicationChannel.Sendable
        {
            ...
            *	 from the threshold / touchdown zone*/
            ...
            } static readonly Meta meta242 = new Meta(242, 0, 0, 0, 53, 416, 0, _uS);
        }/**
        ...
        public class SET_HOME_POSITION : Pack, CommunicationChannel.Sendable
        {
            ...
            *	 from the threshold / touchdown zone*/
            ...
            public void time_usec_SET(ulong src, Inside ph)//Timestamp (microseconds since UNIX epoch or microseconds since system boot)
            {
                ...
                BitUtils.set_bytes((ulong)(src), 8, data,  ph.BYTE);
            } static readonly Meta meta243 = new Meta(243, 0, 0, 0, 54, 424, 0, _oF);
        }/**
        ...
        public class ADSB_VEHICLE : Pack, CommunicationChannel.Sendable
        {
            ...
            {callsign_SET(src.ToCharArray(), 0, src.Length, ph);} public void callsign_SET(char[] src, int pos, int items, Inside ph) //The callsign, 8+null
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta246 = new Meta(246, 3, 1, 0, 28, 213, 0, _ZF);
        }/**
...
*	 way for testing new messages and getting experimental debug output*/
        ...
        } public class DEBUG_VECT : Pack, CommunicationChannel.Sendable
        {
            ...
            {name_SET(src.ToCharArray(), 0, src.Length, ph);} public void name_SET(char[] src, int pos, int items, Inside ph) //Name
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta250 = new Meta(250, 0, 0, 1, 21, 160, 0, _BF);
        }/**
...
*	 efficient way for testing new messages and getting experimental debug output*/
        public class NAMED_VALUE_FLOAT : Pack, CommunicationChannel.Sendable
        {
            ...
            {name_SET(src.ToCharArray(), 0, src.Length, ph);} public void name_SET(char[] src, int pos, int items, Inside ph) //Name of the debug variable
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta251 = new Meta(251, 0, 1, 0, 9, 64, 0, _uF);
        }/**
...
*	 efficient way for testing new messages and getting experimental debug output*/
        public class NAMED_VALUE_INT : Pack, CommunicationChannel.Sendable
        {
            ...
            {name_SET(src.ToCharArray(), 0, src.Length, ph);} public void name_SET(char[] src, int pos, int items, Inside ph) //Name of the debug variable
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta252 = new Meta(252, 0, 1, 0, 9, 64, 0, _fz);
        }/**
...
*	 wisely, these messages are buffered on the MCU and sent only at a limited rate (e.g. 10 Hz)*/
        public class STATUSTEXT : Pack, CommunicationChannel.Sendable
        {
            ...
            {text_SET(src.ToCharArray(), 0, src.Length, ph);} public void text_SET(char[] src, int pos, int items, Inside ph) //Status text message, without null termination character
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta253 = new Meta(253, 0, 0, 0, 2, 3, 0, _Hz);
        }/**
...
*Control vehicle tone generation (buzzer)*/
        public class PLAY_TUNE : Pack, CommunicationChannel.Sendable
        {
            ...
            {tune_SET(src.ToCharArray(), 0, src.Length, ph);} public void tune_SET(char[] src, int pos, int items, Inside ph) //tune in board specific format
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta258 = new Meta(258, 0, 0, 0, 3, 16, 0, _cz);
        }/**
*WIP: Information about a camera*/
        public class CAMERA_INFORMATION : Pack, CommunicationChannel.Sendable
        {
            ...
            {cam_definition_uri_SET(src.ToCharArray(), 0, src.Length, ph);} public void cam_definition_uri_SET(char[] src, int pos, int items, Inside ph) //Camera definition URI (if any, otherwise only basic functions will be available).
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta259 = new Meta(259, 3, 2, 0, 93, 734, 0, _iz);
        }/**
...
*Information about a captured image*/
        public class CAMERA_IMAGE_CAPTURED : Pack, CommunicationChannel.Sendable
        {
            ...
            {file_url_SET(src.ToCharArray(), 0, src.Length, ph);} public void file_url_SET(char[] src, int pos, int items, Inside ph) //URL of image taken. Either local storage or http:foo.jpg if camera provides an HTTP interface.
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta263 = new Meta(263, 0, 1, 1, 51, 402, 2, _wC);
        }/**
...
*WIP: Information about video stream*/
        public class VIDEO_STREAM_INFORMATION : Pack, CommunicationChannel.Sendable
        {
            ...
            {uri_SET(src.ToCharArray(), 0, src.Length, ph);} public void uri_SET(char[] src, int pos, int items, Inside ph) //Video stream URI
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta269 = new Meta(269, 3, 1, 0, 17, 130, 2, _gC);
        }/**
*WIP: Message that sets video stream settings*/
        public class SET_VIDEO_STREAM_SETTINGS : Pack, CommunicationChannel.Sendable
        {
            ...
            {uri_SET(src.ToCharArray(), 0, src.Length, ph);} public void uri_SET(char[] src, int pos, int items, Inside ph) //Video stream URI
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta270 = new Meta(270, 3, 1, 0, 18, 138, 2, _nC);
        }/**
*Configure AP SSID and Password.*/
        public class WIFI_CONFIG_AP : Pack, CommunicationChannel.Sendable
        {
            ...
            {password_SET(src.ToCharArray(), 0, src.Length, ph);} public void password_SET(char[] src, int pos, int items, Inside ph) //Password. Leave it blank for an open AP.
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta299 = new Meta(299, 0, 0, 0, 1, 2, 2, _bC, _jC);
        }/**
...
*	 is available at http:uavcan.org*/
        public class UAVCAN_NODE_INFO : Pack, CommunicationChannel.Sendable
        {
            ...
            {name_SET(src.ToCharArray(), 0, src.Length, ph);} public void name_SET(char[] src, int pos, int items, Inside ph) //Node name string. For example, "sapog.px4.io".
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta311 = new Meta(311, 0, 2, 1, 37, 288, 0, _oZ);
        }/**
...
*	 ID is stored as strin*/
            public void param_id_SET(char[] src, int pos, int items, Inside ph)
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta320 = new Meta(320, 0, 0, 0, 5, 32, 0, _SZ);
        }/**
*Request all parameters of this component. After this request, all parameters are emitted.*/
...
*	 ID is stored as strin*/
            ...
            {param_value_SET(src.ToCharArray(), 0, src.Length, ph);} public void param_value_SET(char[] src, int pos, int items, Inside ph) //Parameter value
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta322 = new Meta(322, 2, 0, 0, 5, 38, 2, _ZZ, _GZ);
        }/**
...
*	 ID is stored as strin*/
            ...
            {param_value_SET(src.ToCharArray(), 0, src.Length, ph);} public void param_value_SET(char[] src, int pos, int items, Inside ph) //Parameter value
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta323 = new Meta(323, 0, 0, 0, 3, 22, 2, _iZ, _yZ);
        }/**
...
*	 ID is stored as strin*/
            ...
            {param_value_SET(src.ToCharArray(), 0, src.Length, ph);} public void param_value_SET(char[] src, int pos, int items, Inside ph) //Parameter value (new value if PARAM_ACK_ACCEPTED, current value otherwise)
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta324 = new Meta(324, 0, 0, 0, 1, 8, 2, _WZ, _XZ);
        }/**
...
*Static data to configure the ADS-B transponder (send within 10 sec of a POR and every 10 sec thereafter*/
        public class UAVIONIX_ADSB_OUT_CFG : Pack, CommunicationChannel.Sendable
        {
            ...
            {
                set {  BitUtils.set_bits((ulong)(- 0 +   value), 3, data, 57);}
            }
            ...
            *	 one] (table 2-37 DO-282B*/
            ...
            {callsign_SET(src.ToCharArray(), 0, src.Length, ph);} public void callsign_SET(char[] src, int pos, int items, Inside ph) //Vehicle identifier (8 characters, null terminated, valid characters are A-Z, 0-9, " " only)
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta10001 = new Meta(10001, 1, 1, 0, 9, 64, 0, _BZ);
        }/**
*Dynamic data used to generate ADS-B out transponder data (send at 5Hz)*/
        public class UAVIONIX_ADSB_OUT_DYNAMIC : Pack, CommunicationChannel.Sendable
        {
            ...
            *	 (m * 1E-3). (up +ve). If unknown set to INT32_MA*/
            ...
            {
                set {  BitUtils.set_bits((ulong)(- 0 +   value), 3, data, 299);}
            }

            public UAVIONIX_ADSB_OUT_DYNAMIC_STATE state //ADS-B transponder dynamic input state flags
            {
                set {  BitUtils.set_bits((ulong)(- 1 +   value), 5, data, 302);}
            }
            static readonly Meta meta10002 = new Meta(10002, 3, 2, 0, 39, 307);
        }/**
*Transceiver heartbeat with health report (updated every 10s)*/
        public class UAVIONIX_ADSB_TRANSCEIVER_HEALTH_REPORT : Pack, CommunicationChannel.Sendable
        {
            ...
            {
                set {  BitUtils.set_bits((ulong)(- 0 +   value), 6, data, 0);}
            }
            static readonly Meta meta10003 = new Meta(10003, 0, 0, 0, 1, 6);
        }/**
*Read registers for a device*/
        public class DEVICE_OP_READ : Pack, CommunicationChannel.Sendable
        {
            internal DEVICE_OP_READ() : base(meta11000, 0) { }
            ...
            {
                set {  BitUtils.set_bits((ulong)(- 0 +   value), 1, data, 80);}
            }
            public void busname_SET(string src, Inside ph)//Name of device on bus (for SPI)
            {busname_SET(src.ToCharArray(), 0, src.Length, ph);} public void busname_SET(char[] src, int pos, int items, Inside ph) //Name of device on bus (for SPI)
            {
                if(ph.field_bit != 81 && insert_field(ph, 81, items) ||
                        ! try_visit_item(ph, 0)) insert_item(ph, 0, items);
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta11000 = new Meta(11000, 0, 1, 0, 12, 81, 0, _Qi);
        }/**
*Read registers reply*/
        public class DEVICE_OP_READ_REPLY : Pack, CommunicationChannel.Sendable
        {
            internal DEVICE_OP_READ_REPLY() : base(meta11001, 0) { }
            ...
            public void data__SET(byte[] src, int pos)  //reply data
            {
                for(int BYTE =  7, src_max = pos + 128; pos < src_max; pos++, BYTE += 1)
                    BitUtils.set_bytes((ulong)(src[pos]), 1, data,  BYTE);
            }
            static readonly Meta meta11001 = new Meta(11001, 0, 1, 0, 135, 1080);
        }/**
*Write registers for a device*/
        public class DEVICE_OP_WRITE : Pack, CommunicationChannel.Sendable
        {
            internal DEVICE_OP_WRITE() : base(meta11002, 0) { }
            ...
            public void data__SET(byte[] src, int pos)  //write data
            {
            ...
            public DEVICE_OP_BUSTYPE bustype //The bus type
            {
                set {  BitUtils.set_bits((ulong)(- 0 +   value), 1, data, 1104);}
            }
            public void busname_SET(string src, Inside ph)//Name of device on bus (for SPI)
            {busname_SET(src.ToCharArray(), 0, src.Length, ph);} public void busname_SET(char[] src, int pos, int items, Inside ph) //Name of device on bus (for SPI)
            {
                if(ph.field_bit != 1105 && insert_field(ph, 1105, items) ||
                        ! try_visit_item(ph, 0)) insert_item(ph, 0, items);
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta11002 = new Meta(11002, 0, 1, 0, 140, 1105, 0, _xi);
        }/**
*Write registers reply*/
        public class DEVICE_OP_WRITE_REPLY : Pack, CommunicationChannel.Sendable
        {
            internal DEVICE_OP_WRITE_REPLY() : base(meta11003, 0) { }
            ...
            static readonly Meta meta11003 = new Meta(11003, 0, 1, 0, 5, 40);
        }/**
*Adaptive Controller tuning information*/
        public class ADAP_TUNING : Pack, CommunicationChannel.Sendable
        {
            internal ADAP_TUNING() : base(meta11010, 0) { }
            ...
            public PID_TUNING_AXIS axis //axis
            {
                set {  BitUtils.set_bits((ulong)(- 1 +   value), 3, data, 384);}
            }
            static readonly Meta meta11010 = new Meta(11010, 0, 0, 0, 49, 387);
        }/**
*camera vision based attitude and position deltas*/
        public class VISION_POSITION_DELTA : Pack, CommunicationChannel.Sendable
        {
            internal VISION_POSITION_DELTA() : base(meta11011, 0) { }
            ...
            *	 2=down*/
            ...
            {
                set {position_delta_SET(value, 0)  ;}
            }
            /**
            *Change in position in meters from previous to current frame rotated into body frame (0=forward, 1=right,
            *	 2=down*/
            ...
            static readonly Meta meta11011 = new Meta(11011, 0, 0, 2, 44, 352);
        }

        public class CommunicationChannel : Channel
        {
        ...
        *Type of mission items being requested/sent in mission protocol.*/
        ...
        internal static MAV_MISSION_TYPE en__W(ulong id)
        {
            switch(id)
            {
                case 0:
        ...
        *	 ARINC 424 is for commercial aircraft: A data format how to interpret waypoint/mission data*/
        ...
        public enum MAV_CMD
        {
            ...
            *		 * 1	byte bitmask of magnetometers (0 means all)
        ...
        internal static MAV_CMD en__f(ulong id)
        {
            switch(id)
            {
                case 0:
        ...
        *Bus types for device operations*/
        ...
        static readonly Field _W = new Field(5, true, -6, 2, 1, 0, 0, 0, 1);
        static readonly Field _T = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
        static readonly Field _r = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
        static readonly Field _u = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
        static readonly Field _DQ = new Field(0, false, 1, 4, 1, 0, 0, 0);
        static readonly Field _dQ = new Field(0, true, 1, 4, 1, 0, 0, 0);
        static readonly Field _PQ = new Field(0, true, 1, 4, 1, 0, 0, 0);
        static readonly Field _VQ = new Field(0, true, 1, 4, 1, 0, 0, 0);
        static readonly Field _tQ = new Field(0, true, 1, 4, 1, 0, 0, 0);
        static readonly Field _oH = new Field(0, true, 1, 2, 1, 0, 0, 0);
        static readonly Field _DH = new Field(0, true, 1, 2, 1, 0, 0, 0);
        static readonly Field _dH = new Field(0, true, 1, 2, 1, 0, 0, 0);
        static readonly Field _PH = new Field(0, true, 1, 2, 1, 0, 0, 0);
        static readonly Field _VH = new Field(0, true, 1, 2, 1, 0, 0, 0);
        static readonly Field _tH = new Field(0, true, 1, 2, 1, 0, 0, 0);
        static readonly Field _xH = new Field(0, true, 1, 2, 1, 0, 0, 0);
        static readonly Field _cH = new Field(0, true, 1, 2, 1, 0, 0, 0);
        static readonly Field _IM = new Field(0, true, 1, 8, 1, 0, 0, 0);
        static readonly Field _CM = new Field(0, true, 1, 8, 1, 0, 0, 0);
        static readonly Field _kM = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
        static readonly Field _GO = new Field(0, false, 1, 1, 1, 0, 0, 0);
        static readonly Field _kO = new Field(0, false, 1, 4, 1, 0, 0, 0);
        static readonly Field _RO = new Field(0, false, 1, 1, 1, 0, 0, 0);
        static readonly Field _aO = new Field(0, false, 1, 1, 1, 0, 0, 0);
        static readonly Field _tD = new Field(0, false, 1, 4, 1, 0, 0, 0);
        static readonly Field _xD = new Field(0, false, 1, 4, 1, 0, 0, 0);
        static readonly Field _wI = new Field(0, false, 18, 1, 1, 0, 0, 0);
        static readonly Field _tI = new Field(0, false, 1, 4, 1, 0, 0, 0);
        static readonly Field _xI = new Field(0, false, 1, 4, 1, 0, 0, 0);
        static readonly Field _cI = new Field(0, false, 1, 4, 1, 0, 0, 0);
        static readonly Field _II = new Field(0, false, 4, 4, 1, 0, 0, 0);
        static readonly Field _FI = new Field(0, false, 1, 1, 1, 0, 0, 0);
        static readonly Field _uS = new Field(0, true, 1, 8, 1, 0, 0, 0);
        static readonly Field _oF = new Field(0, true, 1, 8, 1, 0, 0, 0);
        static readonly Field _ZF = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
        static readonly Field _BF = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
        static readonly Field _uF = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
        static readonly Field _fz = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
        static readonly Field _Hz = new Field(5, true, -6, 2, 1, 0, 0, 0, 1);
        static readonly Field _cz = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
        static readonly Field _iz = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
        static readonly Field _wC = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
        static readonly Field _gC = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
        static readonly Field _nC = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
        static readonly Field _bC = new Field(5, true, -6, 2, 1, 0, 0, 0, 1);
        static readonly Field _jC = new Field(5, true, -7, 2, 1, 0, 0, 0, 1);
        static readonly Field _oZ = new Field(5, true, -7, 2, 1, 0, 0, 0, 1);
        static readonly Field _SZ = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
        static readonly Field _ZZ = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
        static readonly Field _GZ = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
        static readonly Field _iZ = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
        static readonly Field _yZ = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
        static readonly Field _WZ = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
        static readonly Field _XZ = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
        static readonly Field _BZ = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
        static readonly Field _YG = new Field(0, true, 1, 4, 1, 0, 0, 0);
        static readonly Field _Qi = new Field(5, true, -6, 2, 1, 0, 0, 0, 1);
        static readonly Field _xi = new Field(5, true, -6, 2, 1, 0, 0, 0, 1);
