...
INLINER uint16_t p180_seq_GET(Pack * src)//Sequenc
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  0, 2)));
}
INLINER void p180_seq_SET(uint16_t  src, Pack * dst)//Sequenc
{
    uint8_t * data = dst->data;
    set_bytes((src), 2, data,  0);
}
...
INLINER uint8_t p180_target_component_GET(Pack * src)//Component I
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  3, 1)));
}
INLINER void p180_target_component_SET(uint8_t  src, Pack * dst)//Component I
{
    uint8_t * data = dst->data;
    set_bytes((src), 1, data,  3);
}
...
INLINER uint16_t p181_seq_GET(Pack * src)//Sequenc
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  0, 2)));
}
INLINER void p181_seq_SET(uint16_t  src, Pack * dst)//Sequenc
{
    uint8_t * data = dst->data;
    set_bytes((src), 2, data,  0);
}
INLINER uint8_t p181_target_system_GET(Pack * src)//System I
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  2, 1)));
}
INLINER void p181_target_system_SET(uint8_t  src, Pack * dst)//System I
{
    uint8_t * data = dst->data;
    set_bytes((src), 1, data,  2);
}
INLINER uint8_t p181_target_component_GET(Pack * src)//Component I
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  3, 1)));
}
INLINER void p181_target_component_SET(uint8_t  src, Pack * dst)//Component I
{
    uint8_t * data = dst->data;
    set_bytes((src), 1, data,  3);
}
INLINER uint8_t p182_target_system_GET(Pack * src)//System I
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  0, 1)));
}
INLINER void p182_target_system_SET(uint8_t  src, Pack * dst)//System I
{
    uint8_t * data = dst->data;
    set_bytes((src), 1, data,  0);
}
INLINER uint8_t p182_target_component_GET(Pack * src)//Component I
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  1, 1)));
}
INLINER void p182_target_component_SET(uint8_t  src, Pack * dst)//Component I
{
    uint8_t * data = dst->data;
    set_bytes((src), 1, data,  1);
}
INLINER uint16_t p183_count_GET(Pack * src)//Number of script items in the sequenc
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  0, 2)));
}
INLINER void p183_count_SET(uint16_t  src, Pack * dst)//Number of script items in the sequenc
{
    uint8_t * data = dst->data;
    set_bytes((src), 2, data,  0);
}
...
INLINER uint16_t p184_seq_GET(Pack * src)//Active Sequenc
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  0, 2)));
}
INLINER void p184_seq_SET(uint16_t  src, Pack * dst)//Active Sequenc
{
    uint8_t * data = dst->data;
    set_bytes((src), 2, data,  0);
}
