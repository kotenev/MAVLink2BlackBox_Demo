...
inline static UMAX _id__n(e_MAV_MISSION_TYPE en)
{
    switch(en)
    {
...
inline static e_MAV_CMD _en__U(UMAX id)
{
    switch(id)
    {
        case 0:
...
inline static UMAX _id__U(e_MAV_CMD en)
{
    switch(en)
    {
...
{
    uint8_t * data = src->data;
    return  _en__U(get_bits(data, 248, 7));
}
...
{
    uint8_t * data = src->data;
    return  _en__U(get_bits(data, 0, 7));
}
