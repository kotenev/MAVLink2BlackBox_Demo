    ...
    public class DemoDevice : Host
    {
        ...
        } public class GPS_RAW_INT : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            public void hdg_acc_SET(uint src, Inside ph)//Heading / track uncertainty in degrees * 1e5
            {
                ...
                BitUtils.set_bytes((ulong)(src), 4, data,  ph.BYTE);
            } static readonly Meta meta24 = new Meta(24, 4, 0, 1, 31, 236, 0, _Oy, _Iy, _Ky, _zy, _ly);
        ...
        } public class SERVO_OUTPUT_RAW : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            public void servo16_raw_SET(ushort src, Inside ph)//Servo output 16 value, in microsecond
            {
                ...
                BitUtils.set_bytes((ulong)(src), 2, data,  ph.BYTE);
            } static readonly Meta meta36 = new Meta(36, 8, 1, 0, 22, 168, 0, _vi, _Oi, _Ii, _Ki, _zi, _li, _Ei, _Ti);
        ...
        } public class SET_GPS_GLOBAL_ORIGIN : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            } static readonly Meta meta48 = new Meta(48, 0, 0, 0, 14, 104, 0, _Su);
        } public class GPS_GLOBAL_ORIGIN : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            public void time_usec_SET(ulong src, Inside ph)//Timestamp (microseconds since UNIX epoch or microseconds since system boot
            {
                ...
                BitUtils.set_bytes((ulong)(src), 8, data,  ph.BYTE);
            } static readonly Meta meta49 = new Meta(49, 0, 0, 0, 13, 96, 0, _Gu);
        } public class PARAM_MAP_RC : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            } public void param_id_SET(string src, Inside ph) {param_id_SET(src.ToCharArray(), 0, src.Length, ph);} public void param_id_SET(char[] src, int pos, int items, Inside ph)
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta50 = new Meta(50, 0, 0, 0, 22, 168, 0, _Pu);
        ...
        } public class COMMAND_ACK : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            public void target_component_SET(byte src, Inside ph)//WIP: Component which requested the command to be execute
            {
                ...
                BitUtils.set_bytes((ulong)(src), 1, data,  ph.BYTE);
            } static readonly Meta meta77 = new Meta(77, 0, 0, 0, 3, 10, 0, _Ns, _Ps, _Hs, _Us);
        ...
        } public class OPTICAL_FLOW : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            public void flow_rate_y_SET(float src, Inside ph)//Flow rate in radians/second about Y axi
            {
                ...
                BitUtils.set_bytes(BitUtils.FloatToInt32Bits(src), 4, data, ph.BYTE);
            } static readonly Meta meta100 = new Meta(100, 0, 0, 1, 27, 208, 0, _lO, _EO);
        ...
        } public class AUTOPILOT_VERSION : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            } public void uid2_SET(byte[] src, int pos, Inside ph)
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + 18; pos < src_max; pos++, BYTE += 1)
                    BitUtils.set_bytes((ulong)(src[pos]), 1, data,  BYTE);
            } static readonly Meta meta148 = new Meta(148, 2, 4, 1, 54, 421, 0, _xS);
        } public class LANDING_TARGET : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            public void position_valid_SET(byte src, Inside ph)
            {
                ...
                BitUtils.set_bytes((ulong)(src), 1, data,  ph.BYTE);
            } static readonly Meta meta149 = new Meta(149, 0, 0, 1, 31, 239, 0, _lS, _ES, _TS, _SS, _DS);
        } public class SCRIPT_ITEM : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal SCRIPT_ITEM() : base(meta180, 0) { }
            internal SCRIPT_ITEM(int bytes) : base(meta180, bytes) { }
            public ushort seq //Sequenc
            {
                get {  return (ushort)((ushort) BitUtils.get_bytes(data,  0, 2));}
                set {  BitUtils.set_bytes((ulong)(value), 2, data,  0);}
            ...
            {
                return (ph.field_bit !=  32 && !try_visit_field(ph, 32)  ||  !try_visit_item(ph, 0)) ? 0 : ph.items;
            } public void name_SET(string src, Inside ph) //The name of the mission script, NULL terminated
            {name_SET(src.ToCharArray(), 0, src.Length, ph);} public void name_SET(char[] src, int pos, int items, Inside ph) //The name of the mission script, NULL terminated
            {
                if(ph.field_bit != 32 && insert_field(ph, 32, items) ||
                        ! try_visit_item(ph, 0)) insert_item(ph, 0, items);
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta180 = new Meta(180, 1, 0, 0, 5, 32, 0, _cj);
        } public class SCRIPT_REQUEST : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal SCRIPT_REQUEST() : base(meta181, 0) { }
            internal SCRIPT_REQUEST(int bytes) : base(meta181, bytes) { }
            public ushort seq //Sequenc
            {
                get {  return (ushort)((ushort) BitUtils.get_bytes(data,  0, 2));}
                set {  BitUtils.set_bytes((ulong)(value), 2, data,  0);}
        ...
        } public class SCRIPT_REQUEST_LIST : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal SCRIPT_REQUEST_LIST() : base(meta182, 0) { }
            internal SCRIPT_REQUEST_LIST(int bytes) : base(meta182, bytes) { }
            public byte target_system //System I
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  0, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  0);}
            ...
            static readonly Meta meta182 = new Meta(182, 0, 0, 0, 2, 16);
        } public class SCRIPT_COUNT : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal SCRIPT_COUNT() : base(meta183, 0) { }
            internal SCRIPT_COUNT(int bytes) : base(meta183, bytes) { }
            public ushort count //Number of script items in the sequenc
            {
                get {  return (ushort)((ushort) BitUtils.get_bytes(data,  0, 2));}
                set {  BitUtils.set_bytes((ulong)(value), 2, data,  0);}
            }
            ...
            static readonly Meta meta183 = new Meta(183, 1, 0, 0, 4, 32);
        } public class SCRIPT_CURRENT : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal SCRIPT_CURRENT() : base(meta184, 0) { }
            internal SCRIPT_CURRENT(int bytes) : base(meta184, bytes) { }
            public ushort seq //Active Sequenc
            {
                get {  return (ushort)((ushort) BitUtils.get_bytes(data,  0, 2));}
                set {  BitUtils.set_bytes((ulong)(value), 2, data,  0);}
            }
            static readonly Meta meta184 = new Meta(184, 1, 0, 0, 2, 16);
        ...
        } public class HOME_POSITION : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            public void time_usec_SET(ulong src, Inside ph)//Timestamp (microseconds since UNIX epoch or microseconds since system boot
            {
                ...
                BitUtils.set_bytes((ulong)(src), 8, data,  ph.BYTE);
            } static readonly Meta meta242 = new Meta(242, 0, 0, 0, 53, 416, 0, _aZ);
        } public class SET_HOME_POSITION : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            public void time_usec_SET(ulong src, Inside ph)//Timestamp (microseconds since UNIX epoch or microseconds since system boot
            {
                ...
                BitUtils.set_bytes((ulong)(src), 8, data,  ph.BYTE);
            } static readonly Meta meta243 = new Meta(243, 0, 0, 0, 54, 424, 0, _vD);
        ...
        } public class ADSB_VEHICLE : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {callsign_SET(src.ToCharArray(), 0, src.Length, ph);} public void callsign_SET(char[] src, int pos, int items, Inside ph) //The callsign, 8+nul
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta246 = new Meta(246, 3, 1, 0, 28, 210, 0, _jD);
        ...
        } public class DEBUG_VECT : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {name_SET(src.ToCharArray(), 0, src.Length, ph);} public void name_SET(char[] src, int pos, int items, Inside ph) //Nam
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta250 = new Meta(250, 0, 0, 1, 21, 160, 0, _bD);
        } public class NAMED_VALUE_FLOAT : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {name_SET(src.ToCharArray(), 0, src.Length, ph);} public void name_SET(char[] src, int pos, int items, Inside ph) //Name of the debug variabl
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta251 = new Meta(251, 0, 1, 0, 9, 64, 0, _aD);
        } public class NAMED_VALUE_INT : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {name_SET(src.ToCharArray(), 0, src.Length, ph);} public void name_SET(char[] src, int pos, int items, Inside ph) //Name of the debug variabl
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta252 = new Meta(252, 0, 1, 0, 9, 64, 0, _Qt);
        } public class STATUSTEXT : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {text_SET(src.ToCharArray(), 0, src.Length, ph);} public void text_SET(char[] src, int pos, int items, Inside ph) //Status text message, without null termination characte
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta253 = new Meta(253, 0, 0, 0, 2, 4, 0, _it);
        ...
        } public class PLAY_TUNE : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {tune_SET(src.ToCharArray(), 0, src.Length, ph);} public void tune_SET(char[] src, int pos, int items, Inside ph) //tune in board specific forma
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta258 = new Meta(258, 0, 0, 0, 3, 16, 0, _Tt);
        } public class CAMERA_INFORMATION : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {cam_definition_uri_SET(src.ToCharArray(), 0, src.Length, ph);} public void cam_definition_uri_SET(char[] src, int pos, int items, Inside ph) //Camera definition URI (if any, otherwise only basic functions will be available)
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta259 = new Meta(259, 3, 2, 0, 93, 731, 0, _Xt);
        ...
        } public class CAMERA_IMAGE_CAPTURED : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {file_url_SET(src.ToCharArray(), 0, src.Length, ph);} public void file_url_SET(char[] src, int pos, int items, Inside ph) //foo.jpg if camera provides an HTTP interface
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta263 = new Meta(263, 0, 1, 1, 51, 402, 2, _xG);
        ...
        } public class VIDEO_STREAM_INFORMATION : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {uri_SET(src.ToCharArray(), 0, src.Length, ph);} public void uri_SET(char[] src, int pos, int items, Inside ph) //Video stream UR
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta269 = new Meta(269, 3, 1, 0, 17, 130, 2, _VG);
        } public class SET_VIDEO_STREAM_SETTINGS : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {uri_SET(src.ToCharArray(), 0, src.Length, ph);} public void uri_SET(char[] src, int pos, int items, Inside ph) //Video stream UR
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta270 = new Meta(270, 3, 1, 0, 18, 138, 2, _cG);
        } public class WIFI_CONFIG_AP : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {password_SET(src.ToCharArray(), 0, src.Length, ph);} public void password_SET(char[] src, int pos, int items, Inside ph) //Password. Leave it blank for an open AP
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta299 = new Meta(299, 0, 0, 0, 1, 2, 2, _LG, _WG);
        ...
        } public class UAVCAN_NODE_INFO : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {name_SET(src.ToCharArray(), 0, src.Length, ph);} public void name_SET(char[] src, int pos, int items, Inside ph) //Node name string. For example, "sapog.px4.io"
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta311 = new Meta(311, 0, 2, 1, 37, 288, 0, _vj);
        } public class PARAM_EXT_REQUEST_READ : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            } public void param_id_SET(string src, Inside ph) {param_id_SET(src.ToCharArray(), 0, src.Length, ph);} public void param_id_SET(char[] src, int pos, int items, Inside ph)
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta320 = new Meta(320, 0, 0, 0, 5, 32, 0, _Zj);
        ...
        } public class PARAM_EXT_VALUE : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {param_value_SET(src.ToCharArray(), 0, src.Length, ph);} public void param_value_SET(char[] src, int pos, int items, Inside ph) //Parameter valu
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta322 = new Meta(322, 2, 0, 0, 5, 38, 2, _jj, _Nj);
        } public class PARAM_EXT_SET : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {param_value_SET(src.ToCharArray(), 0, src.Length, ph);} public void param_value_SET(char[] src, int pos, int items, Inside ph) //Parameter valu
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta323 = new Meta(323, 0, 0, 0, 3, 22, 2, _Xj, _kj);
        } public class PARAM_EXT_ACK : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {param_value_SET(src.ToCharArray(), 0, src.Length, ph);} public void param_value_SET(char[] src, int pos, int items, Inside ph) //Parameter value (new value if PARAM_ACK_ACCEPTED, current value otherwise
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta324 = new Meta(324, 0, 0, 0, 2, 9, 2, _hj, _Mj);
                ...
                for(bool LOOP = false; ;)
                {
                    switch(id)
                    {
                        ...
                        case 180:
                            ...
                            if(OnSCRIPT_ITEMReceive == null) return null;
                            ph.setPack(pack);
                            OnSCRIPT_ITEMReceive(this, ph, (SCRIPT_ITEM) pack);
                            if(LOOP) break;
                            return null;
                        case 181:
                            if(pack == null) return new SCRIPT_REQUEST();
                            if(OnSCRIPT_REQUESTReceive == null) return null;
                            ph.setPack(pack);
                            OnSCRIPT_REQUESTReceive(this, ph, (SCRIPT_REQUEST) pack);
                            if(LOOP) break;
                            return null;
                        case 182:
                            if(pack == null) return new SCRIPT_REQUEST_LIST();
                            if(OnSCRIPT_REQUEST_LISTReceive == null) return null;
                            ph.setPack(pack);
                            OnSCRIPT_REQUEST_LISTReceive(this, ph, (SCRIPT_REQUEST_LIST) pack);
                            if(LOOP) break;
                            return null;
                        case 183:
                            if(pack == null) return new SCRIPT_COUNT();
                            if(OnSCRIPT_COUNTReceive == null) return null;
                            ph.setPack(pack);
                            OnSCRIPT_COUNTReceive(this, ph, (SCRIPT_COUNT) pack);
                            if(LOOP) break;
                            return null;
                        case 184:
                            if(pack == null) return new SCRIPT_CURRENT();
                            if(OnSCRIPT_CURRENTReceive == null) return null;
                            ph.setPack(pack);
                            OnSCRIPT_CURRENTReceive(this, ph, (SCRIPT_CURRENT) pack);
                            if(LOOP) break;
                            return null;
                        case 230:
        ...
        static readonly Field _Iy = new Field(0, true, 1, 4, 1, 0, 0, 0);
        static readonly Field _Ky = new Field(0, true, 1, 4, 1, 0, 0, 0);
        static readonly Field _zy = new Field(0, true, 1, 4, 1, 0, 0, 0);
        static readonly Field _ly = new Field(0, true, 1, 4, 1, 0, 0, 0);
        static readonly Field _vi = new Field(0, true, 1, 2, 1, 0, 0, 0);
        static readonly Field _Oi = new Field(0, true, 1, 2, 1, 0, 0, 0);
        static readonly Field _Ii = new Field(0, true, 1, 2, 1, 0, 0, 0);
        static readonly Field _Ki = new Field(0, true, 1, 2, 1, 0, 0, 0);
        static readonly Field _zi = new Field(0, true, 1, 2, 1, 0, 0, 0);
        static readonly Field _li = new Field(0, true, 1, 2, 1, 0, 0, 0);
        static readonly Field _Ei = new Field(0, true, 1, 2, 1, 0, 0, 0);
        static readonly Field _Ti = new Field(0, true, 1, 2, 1, 0, 0, 0);
        static readonly Field _Su = new Field(0, true, 1, 8, 1, 0, 0, 0);
        static readonly Field _Gu = new Field(0, true, 1, 8, 1, 0, 0, 0);
        static readonly Field _Pu = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
        static readonly Field _Ns = new Field(0, false, 1, 1, 1, 0, 0, 0);
        static readonly Field _Ps = new Field(0, false, 1, 4, 1, 0, 0, 0);
        static readonly Field _Hs = new Field(0, false, 1, 1, 1, 0, 0, 0);
        static readonly Field _Us = new Field(0, false, 1, 1, 1, 0, 0, 0);
        static readonly Field _lO = new Field(0, false, 1, 4, 1, 0, 0, 0);
        static readonly Field _EO = new Field(0, false, 1, 4, 1, 0, 0, 0);
        static readonly Field _xS = new Field(0, false, 18, 1, 1, 0, 0, 0);
        static readonly Field _lS = new Field(0, false, 1, 4, 1, 0, 0, 0);
        static readonly Field _ES = new Field(0, false, 1, 4, 1, 0, 0, 0);
        static readonly Field _TS = new Field(0, false, 1, 4, 1, 0, 0, 0);
        static readonly Field _SS = new Field(0, false, 4, 4, 1, 0, 0, 0);
        static readonly Field _DS = new Field(0, false, 1, 1, 1, 0, 0, 0);
        static readonly Field _aZ = new Field(0, true, 1, 8, 1, 0, 0, 0);
        static readonly Field _vD = new Field(0, true, 1, 8, 1, 0, 0, 0);
        static readonly Field _jD = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
        static readonly Field _bD = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
        static readonly Field _aD = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
        static readonly Field _Qt = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
        static readonly Field _it = new Field(5, true, -6, 2, 1, 0, 0, 0, 1);
        static readonly Field _Tt = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
        static readonly Field _Xt = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
        static readonly Field _xG = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
        static readonly Field _VG = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
        static readonly Field _cG = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
        static readonly Field _LG = new Field(5, true, -6, 2, 1, 0, 0, 0, 1);
        static readonly Field _WG = new Field(5, true, -7, 2, 1, 0, 0, 0, 1);
        static readonly Field _vj = new Field(5, true, -7, 2, 1, 0, 0, 0, 1);
        static readonly Field _Zj = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
        static readonly Field _jj = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
        static readonly Field _Nj = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
        static readonly Field _Xj = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
        static readonly Field _kj = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
        static readonly Field _hj = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
        static readonly Field _Mj = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
        static readonly Field _cj = new Field(5, true, -6, 2, 1, 0, 0, 0, 1);
