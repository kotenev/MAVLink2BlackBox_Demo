...
public class DemoDevice extends Host
{
    ...
    } public static class CHANGE_OPERATOR_CONTROL extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        ...
        } static final Meta meta = new Meta(5, 0, 0, 0, 4, 24, 0, _O);
...
//Heading / track uncertainty in degrees * 1e5
        ...
        public void hdg_acc_SET(long  src, Bounds.Inside ph)//Heading / track uncertainty in degrees * 1e5
        {
            ...
            set_bytes((src) & -1L, 4, data,  ph.BYTE);
        } static final Meta meta = new Meta(24, 4, 0, 1, 31, 236, 0, _MP, _KP, _ZP, _VP, _iP);
...
//Servo output 16 value, in microsecond
        ...
        public void servo16_raw_SET(char  src, Bounds.Inside ph)//Servo output 16 value, in microsecond
        {
            ...
            set_bytes((char)(src) & -1L, 2, data,  ph.BYTE);
        } static final Meta meta = new Meta(36, 8, 1, 0, 22, 168, 0, _ET, _MT, _KT, _ZT, _VT, _iT, _sT, _XT);
...
//Timestamp (microseconds since UNIX epoch or microseconds since system boot
        ...
        } static final Meta meta = new Meta(48, 0, 0, 0, 14, 104, 0, _LD);
...
//Timestamp (microseconds since UNIX epoch or microseconds since system boot
        ...
        public void time_usec_SET(long  src, Bounds.Inside ph)//Timestamp (microseconds since UNIX epoch or microseconds since system boot
        {
            ...
            set_bytes((src) & -1L, 8, data,  ph.BYTE);
        } static final Meta meta = new Meta(49, 0, 0, 0, 13, 96, 0, _dD);
    } public static class PARAM_MAP_RC extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        ...
        } public void param_id_SET(String src, Bounds.Inside ph) {param_id_SET(src.toCharArray(), 0, src.length(), ph);} public void param_id_SET(char[]  src, int pos, int items, Bounds.Inside ph)
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(50, 0, 0, 0, 22, 168, 0, _QD);
...
//WIP: Component which requested the command to be execute
        ...
        public void target_component_SET(char  src, Bounds.Inside ph)//WIP: Component which requested the command to be execute
        {
            ...
            set_bytes((char)(src) & -1L, 1, data,  ph.BYTE);
        } static final Meta meta = new Meta(77, 0, 0, 0, 3, 10, 0, _xj, _Qj, _oj, _pj);
...
//Flow rate in radians/second about Y axi
        ...
        public void flow_rate_y_SET(float  src, Bounds.Inside ph)//Flow rate in radians/second about Y axi
        {
            ...
            set_bytes(Float.floatToIntBits(src) & -1L, 4, data, ph.BYTE);
        } static final Meta meta = new Meta(100, 0, 0, 1, 27, 208, 0, _iM, _sM);
    ...
    } public static class AUTOPILOT_VERSION extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        ...
        } public void uid2_SET(char[]  src, int pos, Bounds.Inside ph)
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + 18; pos < src_max; pos++, BYTE += 1)
                set_bytes((char)(src[pos]) & -1L, 1, data,  BYTE);
        } static final Meta meta = new Meta(148, 2, 4, 1, 54, 421, 0, _CL);
...
//Quaternion of landing target orientation (w, x, y, z order, zero-rotation is 1, 0, 0, 0
        ...
        public void position_valid_SET(char  src, Bounds.Inside ph)
        {
            ...
            set_bytes((char)(src) & -1L, 1, data,  ph.BYTE);
        } static final Meta meta = new Meta(149, 0, 0, 1, 31, 239, 0, _iL, _sL, _XL, _LL, _qL);
    } public static class SCRIPT_ITEM extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        SCRIPT_ITEM() { super(meta, 0); }
        SCRIPT_ITEM(int bytes) { super(meta, bytes); }
        public char seq_GET()//Sequenc
        {  return (char)((char) get_bytes(data,  0, 2)); }
        public void seq_SET(char  src) //Sequenc
        {  set_bytes((char)(src) & -1L, 2, data,  0); }
...
//The name of the mission script, NULL terminated
        ...
        {name_SET(src.toCharArray(), 0, src.length(), ph);} public void name_SET(char[]  src, int pos, int items, Bounds.Inside ph) //The name of the mission script, NULL terminated
        {
            if(ph.field_bit != 32 && insert_field(ph, 32, items) || ! try_visit_item(ph, 0))
                insert_item(ph, 0, items);
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(180, 1, 0, 0, 5, 32, 0, _RW);
    } public static class SCRIPT_REQUEST extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        SCRIPT_REQUEST() { super(meta, 0); }
        SCRIPT_REQUEST(int bytes) { super(meta, bytes); }
        public char seq_GET()//Sequenc
        {  return (char)((char) get_bytes(data,  0, 2)); }
        public void seq_SET(char  src) //Sequenc
        {  set_bytes((char)(src) & -1L, 2, data,  0); }
    ...
    } public static class SCRIPT_REQUEST_LIST extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        SCRIPT_REQUEST_LIST() { super(meta, 0); }
        SCRIPT_REQUEST_LIST(int bytes) { super(meta, bytes); }
        public char target_system_GET()//System I
        {  return (char)((char) get_bytes(data,  0, 1)); }
        public void target_system_SET(char  src) //System I
        {  set_bytes((char)(src) & -1L, 1, data,  0); }
    ...
    } public static class SCRIPT_COUNT extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        SCRIPT_COUNT() { super(meta, 0); }
        SCRIPT_COUNT(int bytes) { super(meta, bytes); }
        public char count_GET()//Number of script items in the sequenc
        {  return (char)((char) get_bytes(data,  0, 2)); }
        public void count_SET(char  src) //Number of script items in the sequenc
        {  set_bytes((char)(src) & -1L, 2, data,  0); }
        public char target_system_GET()//System I
        {  return (char)((char) get_bytes(data,  2, 1)); }
        public void target_system_SET(char  src) //System I
    ...
    } public static class SCRIPT_CURRENT extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        SCRIPT_CURRENT() { super(meta, 0); }
        SCRIPT_CURRENT(int bytes) { super(meta, bytes); }
        public char seq_GET()//Active Sequenc
        {  return (char)((char) get_bytes(data,  0, 2)); }
        public void seq_SET(char  src) //Active Sequenc
        {  set_bytes((char)(src) & -1L, 2, data,  0); }
...
//Timestamp (microseconds since UNIX epoch or microseconds since system boot
        ...
        public void time_usec_SET(long  src, Bounds.Inside ph)//Timestamp (microseconds since UNIX epoch or microseconds since system boot
        {
            ...
            set_bytes((src) & -1L, 8, data,  ph.BYTE);
        } static final Meta meta = new Meta(242, 0, 0, 0, 53, 416, 0, _vt);
...
//Timestamp (microseconds since UNIX epoch or microseconds since system boot
        ...
        public void time_usec_SET(long  src, Bounds.Inside ph)//Timestamp (microseconds since UNIX epoch or microseconds since system boot
        {
            ...
            set_bytes((src) & -1L, 8, data,  ph.BYTE);
        } static final Meta meta = new Meta(243, 0, 0, 0, 54, 424, 0, _Eq);
...
//The callsign, 8+nul
        ...
        {callsign_SET(src.toCharArray(), 0, src.length(), ph);} public void callsign_SET(char[]  src, int pos, int items, Bounds.Inside ph) //The callsign, 8+nul
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(246, 3, 1, 0, 28, 210, 0, _Wq);
...
//Nam
        ...
        {name_SET(src.toCharArray(), 0, src.length(), ph);} public void name_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Nam
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(250, 0, 0, 1, 21, 160, 0, _eq);
...
//Name of the debug variabl
        ...
        {name_SET(src.toCharArray(), 0, src.length(), ph);} public void name_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Name of the debug variabl
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(251, 0, 1, 0, 9, 64, 0, _vq);
...
//Name of the debug variabl
        ...
        {name_SET(src.toCharArray(), 0, src.length(), ph);} public void name_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Name of the debug variabl
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(252, 0, 1, 0, 9, 64, 0, _BI);
...
//Status text message, without null termination characte
        ...
        {text_SET(src.toCharArray(), 0, src.length(), ph);} public void text_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Status text message, without null termination characte
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(253, 0, 0, 0, 2, 4, 0, _TI);
...
//tune in board specific forma
        ...
        {tune_SET(src.toCharArray(), 0, src.length(), ph);} public void tune_SET(char[]  src, int pos, int items, Bounds.Inside ph) //tune in board specific forma
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(258, 0, 0, 0, 3, 16, 0, _XI);
...
//Camera definition URI (if any, otherwise only basic functions will be available)
        ...
        {cam_definition_uri_SET(src.toCharArray(), 0, src.length(), ph);} public void cam_definition_uri_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Camera definition URI (if any, otherwise only basic functions will be available)
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(259, 3, 2, 0, 93, 731, 0, _NI);
...
//foo.jpg if camera provides an HTTP interface
        ...
        {file_url_SET(src.toCharArray(), 0, src.length(), ph);} public void file_url_SET(char[]  src, int pos, int items, Bounds.Inside ph) //foo.jpg if camera provides an HTTP interface
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(263, 0, 1, 1, 51, 402, 2, _Cd);
...
//Video stream UR
        ...
        {uri_SET(src.toCharArray(), 0, src.length(), ph);} public void uri_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Video stream UR
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(269, 3, 1, 0, 17, 130, 2, _Jd);
...
//Video stream UR
        ...
        {uri_SET(src.toCharArray(), 0, src.length(), ph);} public void uri_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Video stream UR
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(270, 3, 1, 0, 18, 138, 2, _Rd);
...
//Password. Leave it blank for an open AP
        ...
        {password_SET(src.toCharArray(), 0, src.length(), ph);} public void password_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Password. Leave it blank for an open AP
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(299, 0, 0, 0, 1, 2, 2, _Sd, _fd);
...
//Node name string. For example, "sapog.px4.io"
        ...
        {name_SET(src.toCharArray(), 0, src.length(), ph);} public void name_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Node name string. For example, "sapog.px4.io"
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(311, 0, 2, 1, 37, 288, 0, _EW);
    } public static class PARAM_EXT_REQUEST_READ extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        ...
        } public void param_id_SET(String src, Bounds.Inside ph) {param_id_SET(src.toCharArray(), 0, src.length(), ph);} public void param_id_SET(char[]  src, int pos, int items, Bounds.Inside ph)
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(320, 0, 0, 0, 5, 32, 0, _tW);
...
//Parameter valu
        ...
        {param_value_SET(src.toCharArray(), 0, src.length(), ph);} public void param_value_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Parameter valu
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(322, 2, 0, 0, 5, 38, 2, _WW, _xW);
...
//Parameter valu
        ...
        {param_value_SET(src.toCharArray(), 0, src.length(), ph);} public void param_value_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Parameter valu
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(323, 0, 0, 0, 3, 22, 2, _NW, _lW);
...
//Parameter value (new value if PARAM_ACK_ACCEPTED, current value otherwise
        ...
        {param_value_SET(src.toCharArray(), 0, src.length(), ph);} public void param_value_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Parameter value (new value if PARAM_ACK_ACCEPTED, current value otherwise
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(324, 0, 0, 0, 2, 9, 2, _yW, _YW);
    ...
    public static class LoopBackDemoChannel  extends Channel
    {
            ...
            for(boolean LOOP = false; ;)
            {
                switch(id)
                {
                    ...
                    case 149:
                        ...
                        return null;
                    case 180:
                        if(pack == null) return new SCRIPT_ITEM(-1);
                        final SCRIPT_ITEM pi180 = (SCRIPT_ITEM) pack;
                        ph.setPack(pi180);
                        on_SCRIPT_ITEM.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi180));
                        if(LOOP) break;
                        return null;
                    case 181:
                        if(pack == null) return new SCRIPT_REQUEST();
                        final SCRIPT_REQUEST pi181 = (SCRIPT_REQUEST) pack;
                        ph.setPack(pi181);
                        on_SCRIPT_REQUEST.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi181));
                        if(LOOP) break;
                        return null;
                    case 182:
                        if(pack == null) return new SCRIPT_REQUEST_LIST();
                        final SCRIPT_REQUEST_LIST pi182 = (SCRIPT_REQUEST_LIST) pack;
                        ph.setPack(pi182);
                        on_SCRIPT_REQUEST_LIST.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi182));
                        if(LOOP) break;
                        return null;
                    case 183:
                        if(pack == null) return new SCRIPT_COUNT();
                        final SCRIPT_COUNT pi183 = (SCRIPT_COUNT) pack;
                        ph.setPack(pi183);
                        on_SCRIPT_COUNT.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi183));
                        if(LOOP) break;
                        return null;
                    case 184:
                        if(pack == null) return new SCRIPT_CURRENT();
                        final SCRIPT_CURRENT pi184 = (SCRIPT_CURRENT) pack;
                        ph.setPack(pi184);
                        on_SCRIPT_CURRENT.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi184));
                        if(LOOP) break;
                        return null;
                    case 230:
        ...
        public final Collection<OnReceive.Handler<SCRIPT_ITEM, LoopBackDemoChannel>> on_SCRIPT_ITEM = new OnReceive<>();
        public final Collection<OnReceive.Handler<SCRIPT_REQUEST, LoopBackDemoChannel>> on_SCRIPT_REQUEST = new OnReceive<>();
        public final Collection<OnReceive.Handler<SCRIPT_REQUEST_LIST, LoopBackDemoChannel>> on_SCRIPT_REQUEST_LIST = new OnReceive<>();
        public final Collection<OnReceive.Handler<SCRIPT_COUNT, LoopBackDemoChannel>> on_SCRIPT_COUNT = new OnReceive<>();
        public final Collection<OnReceive.Handler<SCRIPT_CURRENT, LoopBackDemoChannel>> on_SCRIPT_CURRENT = new OnReceive<>();
    ...
    private static final Field _MP = new Field(0, false, 1, 4, 1, 0, 0, 0);
    private static final Field _KP = new Field(0, true, 1, 4, 1, 0, 0, 0);
    private static final Field _ZP = new Field(0, true, 1, 4, 1, 0, 0, 0);
    private static final Field _VP = new Field(0, true, 1, 4, 1, 0, 0, 0);
    ...
    private static final Field _KT = new Field(0, true, 1, 2, 1, 0, 0, 0);
    ...
    private static final Field _XT = new Field(0, true, 1, 2, 1, 0, 0, 0);
    private static final Field _LD = new Field(0, true, 1, 8, 1, 0, 0, 0);
    private static final Field _dD = new Field(0, true, 1, 8, 1, 0, 0, 0);
    private static final Field _QD = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
    private static final Field _xj = new Field(0, false, 1, 1, 1, 0, 0, 0);
    private static final Field _Qj = new Field(0, false, 1, 4, 1, 0, 0, 0);
    private static final Field _oj = new Field(0, false, 1, 1, 1, 0, 0, 0);
    private static final Field _pj = new Field(0, false, 1, 1, 1, 0, 0, 0);
    private static final Field _iM = new Field(0, false, 1, 4, 1, 0, 0, 0);
    private static final Field _sM = new Field(0, false, 1, 4, 1, 0, 0, 0);
    private static final Field _CL = new Field(0, false, 18, 1, 1, 0, 0, 0);
    private static final Field _iL = new Field(0, false, 1, 4, 1, 0, 0, 0);
    private static final Field _sL = new Field(0, false, 1, 4, 1, 0, 0, 0);
    private static final Field _XL = new Field(0, false, 1, 4, 1, 0, 0, 0);
    private static final Field _LL = new Field(0, false, 4, 4, 1, 0, 0, 0);
    private static final Field _qL = new Field(0, false, 1, 1, 1, 0, 0, 0);
    private static final Field _vt = new Field(0, true, 1, 8, 1, 0, 0, 0);
    private static final Field _Eq = new Field(0, true, 1, 8, 1, 0, 0, 0);
    private static final Field _Wq = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
    private static final Field _eq = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
    private static final Field _vq = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
    private static final Field _BI = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
    private static final Field _TI = new Field(5, true, -6, 2, 1, 0, 0, 0, 1);
    private static final Field _XI = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
    private static final Field _NI = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
    private static final Field _Cd = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
    private static final Field _Jd = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
    private static final Field _Rd = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
    private static final Field _Sd = new Field(5, true, -6, 2, 1, 0, 0, 0, 1);
    private static final Field _fd = new Field(5, true, -7, 2, 1, 0, 0, 0, 1);
    private static final Field _EW = new Field(5, true, -7, 2, 1, 0, 0, 0, 1);
    private static final Field _tW = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
    private static final Field _WW = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
    private static final Field _xW = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
    private static final Field _NW = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
    private static final Field _lW = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
    private static final Field _yW = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
    private static final Field _YW = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
    private static final Field _RW = new Field(5, true, -6, 2, 1, 0, 0, 0, 1);
