...
public class GroundControl extends Host {
	...
	public static class AUTH_KEY extends Pack {
		...
		static final Meta meta = new Meta(7, 0, 0, 0, 1, 0, 0, _j);
	}
	...
	public static class PARAM_VALUE extends Pack {
		...
		static final Meta meta = new Meta(22, 2, 0, 0, 10, 68, 0, _f);
	}
	...
	public static class GPS_RAW_INT extends Pack {
		...
		static final Meta meta = new Meta(24, 4, 0, 1, 31, 236, 0, _dq, _Aq, _gq, _sq, _Nq);
	}
	...
	public static class SERVO_OUTPUT_RAW extends Pack {
		...
		static final Meta meta = new Meta(36, 8, 1, 0, 22, 168, 0, _an, _dn, _An, _gn, _sn, _Nn, _Yn, _yn);
	}
	...
	public static class SET_GPS_GLOBAL_ORIGIN extends Pack {
		...
		static final Meta meta = new Meta(48, 0, 0, 0, 14, 104, 0, _JO);
	}
	...
	public static class GPS_GLOBAL_ORIGIN extends Pack {
		...
		static final Meta meta = new Meta(49, 0, 0, 0, 13, 96, 0, _GO);
	}
	...
	public static class PARAM_MAP_RC extends Pack {
		...
		static final Meta meta = new Meta(50, 0, 0, 0, 22, 168, 0, _wO);
	}
	...
	public static class COMMAND_ACK extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(77, 0, 0, 0, 3, 10, 0, _pb, _wb, _Vb, _Zb);
	}
	...
	public static class OPTICAL_FLOW extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(100, 0, 0, 1, 27, 208, 0, _Nd, _Yd);
	}
	...
	public static class AUTOPILOT_VERSION extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(148, 2, 4, 1, 54, 421, 0, _UJ);
	}
	...
	public static class LANDING_TARGET extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(149, 0, 0, 1, 31, 239, 0, _NJ, _YJ, _yJ, _JJ, _EJ);
	}

	/**
	 * Message encoding a mission script item. This message is emitted upon a request for the next script item
	 */
	public static class SCRIPT_ITEM extends Pack implements CommunicationChannel.Sendable {

		SCRIPT_ITEM() { super(meta, 0); }
		...
		public void name_SET(String src, Bounds.Inside ph)//The name of the mission script, NULL terminated.
		{name_SET(src.toCharArray(), 0, src.length(), ph);}

		public void name_SET(char[] src, int pos, int items, Bounds.Inside ph) //The name of the mission script, NULL terminated.
		{
		...
		static final Meta meta = new Meta(180, 1, 0, 0, 5, 32, 0, _kX);
	}
	 ...
	 */
	public static class SCRIPT_REQUEST extends Pack implements CommunicationChannel.Sendable {

		SCRIPT_REQUEST() { super(meta, 0); }
	 ...
	 * Request the overall list of mission items from the system/component.
	 */
	public static class SCRIPT_REQUEST_LIST extends Pack implements CommunicationChannel.Sendable {

		SCRIPT_REQUEST_LIST() { super(meta, 0); }
		...
		static final Meta meta = new Meta(182, 0, 0, 0, 2, 16);
	}

	/**
	 * This message is emitted as response to SCRIPT_REQUEST_LIST by the MAV to get the number of mission scripts
	 */
	public static class SCRIPT_COUNT extends Pack implements CommunicationChannel.Sendable {

		SCRIPT_COUNT() { super(meta, 0); }

		public void count_SET(char src) //Number of script items in the sequence
		{ set_bytes((char) (src) & -1L, 2, data, 0); }
		...
		static final Meta meta = new Meta(183, 1, 0, 0, 4, 32);
	}

	/**
	 * This message informs about the currently active SCRIPT.
	 */
	public static class SCRIPT_CURRENT extends Pack implements CommunicationChannel.Sendable {

		SCRIPT_CURRENT() { super(meta, 0); }

		public void seq_SET(char src) //Active Sequence
		{ set_bytes((char) (src) & -1L, 2, data, 0); }

		static final Meta meta = new Meta(184, 1, 0, 0, 2, 16);
	}
	...
	public static class HOME_POSITION extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(242, 0, 0, 0, 53, 416, 0, _eS);
	}
	...
	public static class SET_HOME_POSITION extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(243, 0, 0, 0, 54, 424, 0, _aE);
	}
	...
	public static class ADSB_VEHICLE extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(246, 3, 1, 0, 28, 210, 0, _XE);
	}
	...
	public static class DEBUG_VECT extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(250, 0, 0, 1, 21, 160, 0, _ME);
	}
	...
	public static class NAMED_VALUE_FLOAT extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(251, 0, 1, 0, 9, 64, 0, _eE);
	}
	...
	public static class NAMED_VALUE_INT extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(252, 0, 1, 0, 9, 64, 0, _vR);
	}
	...
	public static class STATUSTEXT extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(253, 0, 0, 0, 2, 4, 0, _nR);
	}
	...
	public static class PLAY_TUNE extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(258, 0, 0, 0, 3, 16, 0, _yR);
	}
	...
	public static class CAMERA_INFORMATION extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(259, 3, 2, 0, 93, 731, 0, _zR);
	}
	...
	public static class CAMERA_IMAGE_CAPTURED extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(263, 0, 1, 1, 51, 402, 2, _UG);
	}
	...
	public static class VIDEO_STREAM_INFORMATION extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(269, 3, 1, 0, 17, 130, 2, _tG);
	}
	...
	public static class SET_VIDEO_STREAM_SETTINGS extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(270, 3, 1, 0, 18, 138, 2, _kG);
	}
	...
	public static class WIFI_CONFIG_AP extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(299, 0, 0, 0, 1, 2, 2, _mG, _uG);
	}
	...
	public static class PARAM_EXT_REQUEST_READ extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(320, 0, 0, 0, 5, 32, 0, _SX);
	}
	...
	public static class PARAM_EXT_VALUE extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(322, 2, 0, 0, 5, 38, 2, _XX, _pX);
	}
	...
	public static class PARAM_EXT_SET extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(323, 0, 0, 0, 3, 22, 2, _zX, _DX);
	}
	...
	public static class PARAM_EXT_ACK extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(324, 0, 0, 0, 2, 9, 2, _jX, _HX);
	}
	...
	public static class CommunicationChannel extends Channel {
		 ...
		 * Message encoding a mission script item. This message is emitted upon a request for the next script item
		 */
		public static SCRIPT_ITEM new_SCRIPT_ITEM() {return new SCRIPT_ITEM();}

		/**
		 * Request script item with the sequence number seq. The response of the system to this message should be
		 * a SCRIPT_ITEM message
		 */
		public static SCRIPT_REQUEST new_SCRIPT_REQUEST() {return new SCRIPT_REQUEST();}

		/**
		 * Request the overall list of mission items from the system/component.
		 */
		public static SCRIPT_REQUEST_LIST new_SCRIPT_REQUEST_LIST() {return new SCRIPT_REQUEST_LIST();}

		/**
		 * This message is emitted as response to SCRIPT_REQUEST_LIST by the MAV to get the number of mission scripts
		 */
		public static SCRIPT_COUNT new_SCRIPT_COUNT() {return new SCRIPT_COUNT();}

		/**
		 * This message informs about the currently active SCRIPT.
		 */
		public static SCRIPT_CURRENT new_SCRIPT_CURRENT() {return new SCRIPT_CURRENT();}
	...
	private static final Field _j  = new Field(5, true, -6, 2, 1, 0, 0, 0, 1);
	...
	private static final Field _dq = new Field(0, false, 1, 4, 1, 0, 0, 0);
	private static final Field _Aq = new Field(0, true, 1, 4, 1, 0, 0, 0);
	private static final Field _gq = new Field(0, true, 1, 4, 1, 0, 0, 0);
	private static final Field _sq = new Field(0, true, 1, 4, 1, 0, 0, 0);
	private static final Field _Nq = new Field(0, true, 1, 4, 1, 0, 0, 0);
	private static final Field _an = new Field(0, true, 1, 2, 1, 0, 0, 0);
	private static final Field _dn = new Field(0, true, 1, 2, 1, 0, 0, 0);
	private static final Field _An = new Field(0, true, 1, 2, 1, 0, 0, 0);
	private static final Field _gn = new Field(0, true, 1, 2, 1, 0, 0, 0);
	private static final Field _sn = new Field(0, true, 1, 2, 1, 0, 0, 0);
	private static final Field _Nn = new Field(0, true, 1, 2, 1, 0, 0, 0);
	private static final Field _Yn = new Field(0, true, 1, 2, 1, 0, 0, 0);
	private static final Field _yn = new Field(0, true, 1, 2, 1, 0, 0, 0);
	private static final Field _JO = new Field(0, true, 1, 8, 1, 0, 0, 0);
	private static final Field _GO = new Field(0, true, 1, 8, 1, 0, 0, 0);
	private static final Field _wO = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
	private static final Field _pb = new Field(0, false, 1, 1, 1, 0, 0, 0);
	private static final Field _wb = new Field(0, false, 1, 4, 1, 0, 0, 0);
	private static final Field _Vb = new Field(0, false, 1, 1, 1, 0, 0, 0);
	private static final Field _Zb = new Field(0, false, 1, 1, 1, 0, 0, 0);
	private static final Field _Nd = new Field(0, false, 1, 4, 1, 0, 0, 0);
	private static final Field _Yd = new Field(0, false, 1, 4, 1, 0, 0, 0);
	private static final Field _UJ = new Field(0, false, 18, 1, 1, 0, 0, 0);
	private static final Field _NJ = new Field(0, false, 1, 4, 1, 0, 0, 0);
	private static final Field _YJ = new Field(0, false, 1, 4, 1, 0, 0, 0);
	private static final Field _yJ = new Field(0, false, 1, 4, 1, 0, 0, 0);
	private static final Field _JJ = new Field(0, false, 4, 4, 1, 0, 0, 0);
	private static final Field _EJ = new Field(0, false, 1, 1, 1, 0, 0, 0);
	private static final Field _eS = new Field(0, true, 1, 8, 1, 0, 0, 0);
	private static final Field _aE = new Field(0, true, 1, 8, 1, 0, 0, 0);
	private static final Field _XE = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
	private static final Field _ME = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
	private static final Field _eE = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
	private static final Field _vR = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
	private static final Field _nR = new Field(5, true, -6, 2, 1, 0, 0, 0, 1);
	...
	private static final Field _UG = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
	private static final Field _tG = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
	private static final Field _kG = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
	private static final Field _mG = new Field(5, true, -6, 2, 1, 0, 0, 0, 1);
	private static final Field _uG = new Field(5, true, -7, 2, 1, 0, 0, 0, 1);
	...
	private static final Field _pX = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
	private static final Field _zX = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
	private static final Field _DX = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
	private static final Field _jX = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
	private static final Field _HX = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
	private static final Field _kX = new Field(5, true, -6, 2, 1, 0, 0, 0, 1);
