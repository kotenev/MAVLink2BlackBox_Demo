...
extern void c_CommunicationChannel_on_COMMAND_INT_75(Bounds_Inside * bi, Pack * pack);
/**
...
extern void c_CommunicationChannel_on_AQ_TELEMETRY_F_150(Bounds_Inside * bi, Pack * pack);
/**
...
extern void c_CommunicationChannel_on_AQ_ESC_TELEMETRY_152(Bounds_Inside * bi, Pack * pack);
/**
...
inline static e_MAV_MODE _en__b(UMAX id)
{
    switch(id)
    {
        case 0:
...
inline static UMAX _id__b(e_MAV_MODE en)
{
    switch(en)
    {
...
inline static e_MAV_MISSION_TYPE _en__z(UMAX id)
{
    switch(id)
    {
        case 0:
...
inline static UMAX _id__z(e_MAV_MISSION_TYPE en)
{
    switch(en)
    {
...
inline static e_MAV_CMD _en__T(UMAX id)
{
    switch(id)
    {
        case 0:
...
{
    uint8_t * data = src->data;
    return  _en__T(get_bits(data, 260, 8));
}
...
{
    uint8_t * data = src->data;
    return  _en__T(get_bits(data, 248, 8));
}
...
{
    uint8_t * data = src->data;
    return  _en__T(get_bits(data, 0, 8));
}
...
{
    uint8_t * data = src->data;
    return  _en__b(get_bits(data, 328, 4));
}
...
{
    uint8_t * data = src->data;
    return  _en__b(get_bits(data, 640, 4));
}
...
INLINER uint16_t p150_Index_GET(Pack * src)//Index of message
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  0, 2)));
}
INLINER float p150_value1_GET(Pack * src)//value1
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  2, 4)));
}
INLINER float p150_value2_GET(Pack * src)//value2
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  6, 4)));
}
INLINER float p150_value3_GET(Pack * src)//value3
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  10, 4)));
}
INLINER float p150_value4_GET(Pack * src)//value4
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  14, 4)));
}
INLINER float p150_value5_GET(Pack * src)//value5
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  18, 4)));
}
INLINER float p150_value6_GET(Pack * src)//value6
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  22, 4)));
}
INLINER float p150_value7_GET(Pack * src)//value7
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  26, 4)));
}
INLINER float p150_value8_GET(Pack * src)//value8
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  30, 4)));
}
INLINER float p150_value9_GET(Pack * src)//value9
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  34, 4)));
}
INLINER float p150_value10_GET(Pack * src)//value10
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  38, 4)));
}
INLINER float p150_value11_GET(Pack * src)//value11
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  42, 4)));
}
INLINER float p150_value12_GET(Pack * src)//value12
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  46, 4)));
}
INLINER float p150_value13_GET(Pack * src)//value13
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  50, 4)));
}
INLINER float p150_value14_GET(Pack * src)//value14
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  54, 4)));
}
INLINER float p150_value15_GET(Pack * src)//value15
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  58, 4)));
}
INLINER float p150_value16_GET(Pack * src)//value16
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  62, 4)));
}
INLINER float p150_value17_GET(Pack * src)//value17
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  66, 4)));
}
INLINER float p150_value18_GET(Pack * src)//value18
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  70, 4)));
}
INLINER float p150_value19_GET(Pack * src)//value19
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  74, 4)));
}
INLINER float p150_value20_GET(Pack * src)//value20
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  78, 4)));
}
INLINER uint16_t* p152_status_age_GET(Pack * src, uint16_t*  dst, int32_t pos) //Age of each ESC telemetry reading in ms compared to boot time. A value of 0xFFFF means timeout/no data
{
    uint8_t * data = src->data;
...
INLINER uint8_t p152_num_in_seq_GET(Pack * src)//Number of active ESCs in this sequence (1 through this many array members will be populated with data
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  46, 1)));
}
INLINER uint8_t* p152_escid_GET(Pack * src, uint8_t*  dst, int32_t pos) //ESC/Motor ID
{
    uint8_t * data = src->data;
