...
static const Field _x = {5, true, -6, 2, 1, 0, 0, 0, 1, 1 };
...
static const Field _vM = {0, true, 1, 4, 1, 0, 0, 0, 0   };
static const Field _XM = {0, true, 1, 4, 1, 0, 0, 0, 0   };
static const Field _nM = {0, true, 1, 4, 1, 0, 0, 0, 0   };
static const Field _CM = {0, true, 1, 4, 1, 0, 0, 0, 0   };
static const Field _wc = {0, true, 1, 2, 1, 0, 0, 0, 0   };
static const Field _Fc = {0, true, 1, 2, 1, 0, 0, 0, 0   };
static const Field _vc = {0, true, 1, 2, 1, 0, 0, 0, 0   };
static const Field _Xc = {0, true, 1, 2, 1, 0, 0, 0, 0   };
static const Field _nc = {0, true, 1, 2, 1, 0, 0, 0, 0   };
static const Field _Cc = {0, true, 1, 2, 1, 0, 0, 0, 0   };
static const Field _Kc = {0, true, 1, 2, 1, 0, 0, 0, 0   };
static const Field _Sc = {0, true, 1, 2, 1, 0, 0, 0, 0   };
static const Field _Jb = {0, true, 1, 8, 1, 0, 0, 0, 0   };
static const Field _Bb = {0, true, 1, 8, 1, 0, 0, 0, 0   };
static const Field _Hb = {5, true, -5, 2, 1, 0, 0, 0, 1, 1 };
static const Field _RV = {0, false, 1, 1, 1, 0, 0, 0, 0   };
static const Field _HV = {0, false, 1, 4, 1, 0, 0, 0, 0   };
static const Field _NV = {0, false, 1, 1, 1, 0, 0, 0, 0   };
static const Field _OV = {0, false, 1, 1, 1, 0, 0, 0, 0   };
static const Field _CF = {0, false, 1, 4, 1, 0, 0, 0, 0   };
static const Field _KF = {0, false, 1, 4, 1, 0, 0, 0, 0   };
static const Field _QJ = {0, false, 18, 1, 1, 0, 0, 0, 0   };
static const Field _CJ = {0, false, 1, 4, 1, 0, 0, 0, 0   };
static const Field _KJ = {0, false, 1, 4, 1, 0, 0, 0, 0   };
static const Field _SJ = {0, false, 1, 4, 1, 0, 0, 0, 0   };
static const Field _JJ = {0, false, 4, 4, 1, 0, 0, 0, 0   };
static const Field _kJ = {0, false, 1, 1, 1, 0, 0, 0, 0   };
static const Field _WE = {0, true, 1, 8, 1, 0, 0, 0, 0   };
static const Field _wk = {0, true, 1, 8, 1, 0, 0, 0, 0   };
static const Field _Ik = {5, true, -4, 2, 1, 0, 0, 0, 1, 1 };
static const Field _ak = {5, true, -4, 2, 1, 0, 0, 0, 1, 1 };
static const Field _Wk = {5, true, -4, 2, 1, 0, 0, 0, 1, 1 };
static const Field _sh = {5, true, -4, 2, 1, 0, 0, 0, 1, 1 };
static const Field _ch = {5, true, -6, 2, 1, 0, 0, 0, 1, 1 };
static const Field _Sh = {5, true, -5, 2, 1, 0, 0, 0, 1, 1 };
static const Field _lh = {5, true, -8, 2, 1, 0, 0, 0, 1, 1 };
static const Field _QB = {5, true, -8, 2, 1, 0, 0, 0, 1, 1 };
static const Field _dB = {5, true, -8, 2, 1, 0, 0, 0, 1, 1 };
static const Field _pB = {5, true, -8, 2, 1, 0, 0, 0, 1, 1 };
static const Field _YB = {5, true, -6, 2, 1, 0, 0, 0, 1, 1 };
static const Field _GB = {5, true, -7, 2, 1, 0, 0, 0, 1, 1 };
static const Field _wI = {5, true, -7, 2, 1, 0, 0, 0, 1, 1 };
static const Field _EI = {5, true, -5, 2, 1, 0, 0, 0, 1, 1 };
static const Field _II = {5, true, -5, 2, 1, 0, 0, 0, 1, 1 };
static const Field _RI = {5, true, -8, 2, 1, 0, 0, 0, 1, 1 };
static const Field _lI = {5, true, -5, 2, 1, 0, 0, 0, 1, 1 };
static const Field _rI = {5, true, -8, 2, 1, 0, 0, 0, 1, 1 };
static const Field _xI = {5, true, -5, 2, 1, 0, 0, 0, 1, 1 };
static const Field _LI = {5, true, -8, 2, 1, 0, 0, 0, 1, 1 };
...
static const Field * meta7fields[] = {&_x};
...
static const Field * meta24fields[] = {&_FM, &_vM, &_XM, &_nM, &_CM};
...
static const Field * meta36fields[] = {&_wc, &_Fc, &_vc, &_Xc, &_nc, &_Cc, &_Kc, &_Sc};
...
static const Field * meta48fields[] = {&_Jb};
...
static const Field * meta49fields[] = {&_Bb};
...
static const Field * meta50fields[] = {&_Hb};
...
static const Field * meta77fields[] = {&_RV, &_HV, &_NV, &_OV};
...
static const Field * meta100fields[] = {&_CF, &_KF};
...
static const Field * meta148fields[] = {&_QJ};
static const Meta meta148 = {148, 2, 4, 1, 0, 421,  54, 1, (Field**)&meta148fields};
static const Field * meta149fields[] = {&_CJ, &_KJ, &_SJ, &_JJ, &_kJ};
...
static const Field * meta242fields[] = {&_WE};
static const Meta meta242 = {242, 0, 0, 0, 0, 416,  53, 1, (Field**)&meta242fields};
static const Field * meta243fields[] = {&_wk};
...
static const Field * meta246fields[] = {&_Ik};
...
static const Field * meta258fields[] = {&_Sh};
static const Meta meta258 = {258, 0, 0, 0, 0, 16,  3, 1, (Field**)&meta258fields};
static const Field * meta259fields[] = {&_lh};
...
static const Field * meta263fields[] = {&_QB};
...
Channel c_CommunicationChannel = {.process =  x__s }; //initialized channel instance
    ...
    for(bool LOOP = false;;)
    {
        switch(id)
        {
            ...
            case 74:
                ...
                c_CommunicationChannel_on_VFR_HUD_74(&ph, pack); //handle received pack
                break;
            case 75:
                if(pack == NULL) //request to create new empty pack
                {
            ...
            case 150:
                ...
                c_CommunicationChannel_on_AQ_TELEMETRY_F_150(&ph, pack); //handle received pack
                break;
            case 152:
                if(pack == NULL) //request to create new empty pack
                {
                ...
                c_CommunicationChannel_on_AQ_ESC_TELEMETRY_152(&ph, pack); //handle received pack
                break;
            case 230:
                if(pack == NULL) //request to create new empty pack
                {
