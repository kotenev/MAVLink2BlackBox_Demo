...
extern void c_LoopBackDemoChannel_on_AQ_TELEMETRY_F_150(Bounds_Inside * bi, Pack * pack);
Pack * c_LoopBackDemoChannel_new_AQ_ESC_TELEMETRY_152();
Pack * c_LoopBackDemoChannel_ADV_new_AQ_ESC_TELEMETRY_152();
extern void c_LoopBackDemoChannel_on_AQ_ESC_TELEMETRY_152(Bounds_Inside * bi, Pack * pack);
...
typedef  enum
{
    e_MAV_CMD_MAV_CMD_AQ_NAV_LEG_ORBIT = 1,
    e_MAV_CMD_MAV_CMD_AQ_TELEMETRY = 2,
    e_MAV_CMD_MAV_CMD_AQ_REQUEST_VERSION = 4,
...
INLINER void p39_command_SET(e_MAV_CMD  src, Pack * dst)//The scheduled action for the waypoint. see MAV_CMD in common.xml MAVLink spec
{
    ...
    switch(src)
    {
        case e_MAV_CMD_MAV_CMD_AQ_NAV_LEG_ORBIT:
            id = 0;
            break;
        case e_MAV_CMD_MAV_CMD_AQ_TELEMETRY:
            id = 1;
            break;
        case e_MAV_CMD_MAV_CMD_AQ_REQUEST_VERSION:
            id = 2;
            break;
...
INLINER uint16_t p150_Index_GET(Pack * src)//Index of messag
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  0, 2)));
}
INLINER void p150_Index_SET(uint16_t  src, Pack * dst)//Index of messag
{
    uint8_t * data = dst->data;
    set_bytes((src), 2, data,  0);
}
INLINER float p150_value1_GET(Pack * src)//value
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  2, 4)));
}
INLINER void p150_value1_SET(float  src, Pack * dst)//value
{
    uint8_t * data = dst->data;
    set_bytes(floatToIntBits(src), 4, data,  2);
}
INLINER float p150_value2_GET(Pack * src)//value
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  6, 4)));
}
INLINER void p150_value2_SET(float  src, Pack * dst)//value
{
    uint8_t * data = dst->data;
    set_bytes(floatToIntBits(src), 4, data,  6);
}
INLINER float p150_value3_GET(Pack * src)//value
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  10, 4)));
}
INLINER void p150_value3_SET(float  src, Pack * dst)//value
{
    uint8_t * data = dst->data;
    set_bytes(floatToIntBits(src), 4, data,  10);
}
INLINER float p150_value4_GET(Pack * src)//value
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  14, 4)));
}
INLINER void p150_value4_SET(float  src, Pack * dst)//value
{
    uint8_t * data = dst->data;
    set_bytes(floatToIntBits(src), 4, data,  14);
}
INLINER float p150_value5_GET(Pack * src)//value
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  18, 4)));
}
INLINER void p150_value5_SET(float  src, Pack * dst)//value
{
    uint8_t * data = dst->data;
    set_bytes(floatToIntBits(src), 4, data,  18);
}
INLINER float p150_value6_GET(Pack * src)//value
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  22, 4)));
}
INLINER void p150_value6_SET(float  src, Pack * dst)//value
{
    uint8_t * data = dst->data;
    set_bytes(floatToIntBits(src), 4, data,  22);
}
INLINER float p150_value7_GET(Pack * src)//value
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  26, 4)));
}
INLINER void p150_value7_SET(float  src, Pack * dst)//value
{
    uint8_t * data = dst->data;
    set_bytes(floatToIntBits(src), 4, data,  26);
}
INLINER float p150_value8_GET(Pack * src)//value
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  30, 4)));
}
INLINER void p150_value8_SET(float  src, Pack * dst)//value
{
    uint8_t * data = dst->data;
    set_bytes(floatToIntBits(src), 4, data,  30);
}
INLINER float p150_value9_GET(Pack * src)//value
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  34, 4)));
}
INLINER void p150_value9_SET(float  src, Pack * dst)//value
{
    uint8_t * data = dst->data;
    set_bytes(floatToIntBits(src), 4, data,  34);
}
INLINER float p150_value10_GET(Pack * src)//value1
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  38, 4)));
}
INLINER void p150_value10_SET(float  src, Pack * dst)//value1
{
    uint8_t * data = dst->data;
    set_bytes(floatToIntBits(src), 4, data,  38);
}
INLINER float p150_value11_GET(Pack * src)//value1
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  42, 4)));
}
INLINER void p150_value11_SET(float  src, Pack * dst)//value1
{
    uint8_t * data = dst->data;
    set_bytes(floatToIntBits(src), 4, data,  42);
}
INLINER float p150_value12_GET(Pack * src)//value1
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  46, 4)));
}
INLINER void p150_value12_SET(float  src, Pack * dst)//value1
{
    uint8_t * data = dst->data;
    set_bytes(floatToIntBits(src), 4, data,  46);
}
INLINER float p150_value13_GET(Pack * src)//value1
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  50, 4)));
}
INLINER void p150_value13_SET(float  src, Pack * dst)//value1
{
    uint8_t * data = dst->data;
    set_bytes(floatToIntBits(src), 4, data,  50);
}
INLINER float p150_value14_GET(Pack * src)//value1
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  54, 4)));
}
INLINER void p150_value14_SET(float  src, Pack * dst)//value1
{
    uint8_t * data = dst->data;
    set_bytes(floatToIntBits(src), 4, data,  54);
}
INLINER float p150_value15_GET(Pack * src)//value1
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  58, 4)));
}
INLINER void p150_value15_SET(float  src, Pack * dst)//value1
{
    uint8_t * data = dst->data;
    set_bytes(floatToIntBits(src), 4, data,  58);
}
INLINER float p150_value16_GET(Pack * src)//value1
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  62, 4)));
}
INLINER void p150_value16_SET(float  src, Pack * dst)//value1
{
    uint8_t * data = dst->data;
    set_bytes(floatToIntBits(src), 4, data,  62);
}
INLINER float p150_value17_GET(Pack * src)//value1
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  66, 4)));
}
INLINER void p150_value17_SET(float  src, Pack * dst)//value1
{
    uint8_t * data = dst->data;
    set_bytes(floatToIntBits(src), 4, data,  66);
}
INLINER float p150_value18_GET(Pack * src)//value1
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  70, 4)));
}
INLINER void p150_value18_SET(float  src, Pack * dst)//value1
{
    uint8_t * data = dst->data;
    set_bytes(floatToIntBits(src), 4, data,  70);
}
INLINER float p150_value19_GET(Pack * src)//value1
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  74, 4)));
}
INLINER void p150_value19_SET(float  src, Pack * dst)//value1
{
    uint8_t * data = dst->data;
    set_bytes(floatToIntBits(src), 4, data,  74);
}
INLINER float p150_value20_GET(Pack * src)//value2
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  78, 4)));
}
INLINER void p150_value20_SET(float  src, Pack * dst)//value2
{
    uint8_t * data = dst->data;
    set_bytes(floatToIntBits(src), 4, data,  78);
}
INLINER uint16_t* p152_status_age_GET(Pack * src, uint16_t*  dst, int32_t pos) //Age of each ESC telemetry reading in ms compared to boot time. A value of 0xFFFF means timeout/no dat
{
    uint8_t * data = src->data;
...
static const  uint32_t p152_status_age_LEN = 4; //return array length

INLINER  uint16_t*  p152_status_age_GET_(Pack * src) {return p152_status_age_GET(src, malloc(4 * sizeof(uint16_t)), 0);}
INLINER void p152_status_age_SET(uint16_t*  src, int32_t pos, Pack * dst) //Age of each ESC telemetry reading in ms compared to boot time. A value of 0xFFFF means timeout/no dat
{
    uint8_t * data = dst->data;
    for(int32_t BYTE =  0, src_max = pos + 4; pos < src_max; pos++, BYTE += 2)
        set_bytes((src[pos]), 2, data,  BYTE);
}
INLINER uint32_t p152_time_boot_ms_GET(Pack * src)//Timestamp of the component clock since boot time in ms
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  8, 4)));
}
...
INLINER uint32_t* p152_data0_GET(Pack * src, uint32_t*  dst, int32_t pos) //Data bits 1-32 for each ESC
{
    uint8_t * data = src->data;
    for(int32_t BYTE = 12, dst_max = pos + 4; pos < dst_max ; pos++,  BYTE += 4)
...
static const  uint32_t p152_data0_LEN = 4; //return array length

INLINER  uint32_t*  p152_data0_GET_(Pack * src) {return p152_data0_GET(src, malloc(4 * sizeof(uint32_t)), 0);}
...
INLINER uint32_t* p152_data1_GET(Pack * src, uint32_t*  dst, int32_t pos) //Data bits 33-64 for each ESC
{
    uint8_t * data = src->data;
    for(int32_t BYTE = 28, dst_max = pos + 4; pos < dst_max ; pos++,  BYTE += 4)
        dst[pos] = ((get_bytes(data,  BYTE, 4)));
    return dst;
}

static const  uint32_t p152_data1_LEN = 4; //return array length

INLINER  uint32_t*  p152_data1_GET_(Pack * src) {return p152_data1_GET(src, malloc(4 * sizeof(uint32_t)), 0);}
...
INLINER uint8_t p152_seq_GET(Pack * src)//Sequence number of message (first set of 4 motors is #1, next 4 is #2, etc)
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  44, 1)));
}
...
INLINER uint8_t p152_num_motors_GET(Pack * src)//Total number of active ESCs/motors on the system
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  45, 1)));
}
...
INLINER uint8_t p152_num_in_seq_GET(Pack * src)//Number of active ESCs in this sequence (1 through this many array members will be populated with dat
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  46, 1)));
}
INLINER void p152_num_in_seq_SET(uint8_t  src, Pack * dst)//Number of active ESCs in this sequence (1 through this many array members will be populated with dat
{
    uint8_t * data = dst->data;
    set_bytes((src), 1, data,  46);
}
INLINER uint8_t* p152_escid_GET(Pack * src, uint8_t*  dst, int32_t pos) //ESC/Motor I
{
    uint8_t * data = src->data;
    for(int32_t BYTE = 47, dst_max = pos + 4; pos < dst_max ; pos++,  BYTE += 1)
        dst[pos] = ((get_bytes(data,  BYTE, 1)));
    return dst;
}

static const  uint32_t p152_escid_LEN = 4; //return array length

INLINER  uint8_t*  p152_escid_GET_(Pack * src) {return p152_escid_GET(src, malloc(4 * sizeof(uint8_t)), 0);}
INLINER void p152_escid_SET(uint8_t*  src, int32_t pos, Pack * dst) //ESC/Motor I
{
    uint8_t * data = dst->data;
    for(int32_t BYTE =  47, src_max = pos + 4; pos < src_max; pos++, BYTE += 1)
        set_bytes((src[pos]), 1, data,  BYTE);
}
INLINER uint8_t* p152_data_version_GET(Pack * src, uint8_t*  dst, int32_t pos) //Version of data structure (determines contents)
{
    uint8_t * data = src->data;
    for(int32_t BYTE = 51, dst_max = pos + 4; pos < dst_max ; pos++,  BYTE += 1)
        dst[pos] = ((get_bytes(data,  BYTE, 1)));
    return dst;
}

static const  uint32_t p152_data_version_LEN = 4; //return array length

INLINER  uint8_t*  p152_data_version_GET_(Pack * src) {return p152_data_version_GET(src, malloc(4 * sizeof(uint8_t)), 0);}
