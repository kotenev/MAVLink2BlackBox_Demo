...
@A short  Index;//Index of message
float  value1;//value1
float  value2;//value2
float  value3;//value3
float  value4;//value4
...
@A int  time_boot_ms;//Timestamp of the component clock since boot time in ms.
@A byte  seq;//Sequence number of message (first set of 4 motors is #1, next 4 is #2, etc).
@A byte  num_motors;//Total number of active ESCs/motors on the system.
@A byte  num_in_seq;//Number of active ESCs in this sequence (1 through this many array members will be populated with data
@D (4)@A byte []  escid;//ESC/Motor ID
@D (4)@A short []  status_age;//Age of each ESC telemetry reading in ms compared to boot time. A value of 0xFFFF means timeout/no data
@D (4)@A byte []  data_version;//Version of data structure (determines contents).
@D (4)@A int []  data0;//Data bits 1-32 for each ESC.
@D (4)@A int []  data1;//Data bits 33-64 for each ESC.
}
}}
