...
//ke
        ...
        {key_SET(src.toCharArray(), 0, src.length(), ph);} public void key_SET(char[]  src, int pos, int items, Bounds.Inside ph) //ke
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(7, 0, 0, 0, 1, 0, 0, _d);
    ...
    } public static class PARAM_REQUEST_READ extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        ...
        } public void param_id_SET(String src, Bounds.Inside ph) {param_id_SET(src.toCharArray(), 0, src.length(), ph);} public void param_id_SET(char[]  src, int pos, int items, Bounds.Inside ph)
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(20, 0, 0, 0, 5, 32, 0, _k);
...
//Heading / track uncertainty in degrees * 1e5
        ...
        public void hdg_acc_SET(long  src, Bounds.Inside ph)//Heading / track uncertainty in degrees * 1e5
        {
            ...
            set_bytes((src) & -1L, 4, data,  ph.BYTE);
        } static final Meta meta = new Meta(24, 4, 0, 1, 31, 236, 0, _jH, _gH, _SH, _XH, _qH);
...
//Servo output 16 value, in microsecond
        ...
        public void servo16_raw_SET(char  src, Bounds.Inside ph)//Servo output 16 value, in microsecond
        {
            ...
            set_bytes((char)(src) & -1L, 2, data,  ph.BYTE);
        } static final Meta meta = new Meta(36, 8, 1, 0, 22, 168, 0, _Oz, _jz, _gz, _Sz, _Xz, _qz, _sz, _fz);
...
//Timestamp (microseconds since UNIX epoch or microseconds since system boot
        ...
        } static final Meta meta = new Meta(48, 0, 0, 0, 14, 104, 0, _BF);
...
//Timestamp (microseconds since UNIX epoch or microseconds since system boot
        ...
        public void time_usec_SET(long  src, Bounds.Inside ph)//Timestamp (microseconds since UNIX epoch or microseconds since system boot
        {
            ...
            set_bytes((src) & -1L, 8, data,  ph.BYTE);
        } static final Meta meta = new Meta(49, 0, 0, 0, 13, 96, 0, _wF);
    } public static class PARAM_MAP_RC extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        ...
        } public void param_id_SET(String src, Bounds.Inside ph) {param_id_SET(src.toCharArray(), 0, src.length(), ph);} public void param_id_SET(char[]  src, int pos, int items, Bounds.Inside ph)
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(50, 0, 0, 0, 22, 168, 0, _PF);
...
//WIP: Component which requested the command to be execute
        ...
        public void target_component_SET(char  src, Bounds.Inside ph)//WIP: Component which requested the command to be execute
        {
            ...
            set_bytes((char)(src) & -1L, 1, data,  ph.BYTE);
        } static final Meta meta = new Meta(77, 0, 0, 0, 3, 11, 0, _Yi, _Pi, _Ai, _vi);
...
//Flow rate in radians/second about Y axi
        ...
        public void flow_rate_y_SET(float  src, Bounds.Inside ph)//Flow rate in radians/second about Y axi
        {
            ...
            set_bytes(Float.floatToIntBits(src) & -1L, 4, data, ph.BYTE);
        } static final Meta meta = new Meta(100, 0, 0, 1, 27, 208, 0, _qj, _sj);
    ...
    } public static class AUTOPILOT_VERSION extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        ...
        } public void uid2_SET(char[]  src, int pos, Bounds.Inside ph)
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + 18; pos < src_max; pos++, BYTE += 1)
                set_bytes((char)(src[pos]) & -1L, 1, data,  BYTE);
        } static final Meta meta = new Meta(148, 2, 4, 1, 54, 421, 0, _JB);
...
//Quaternion of landing target orientation (w, x, y, z order, zero-rotation is 1, 0, 0, 0
        ...
        public void position_valid_SET(char  src, Bounds.Inside ph)
        {
            ...
            set_bytes((char)(src) & -1L, 1, data,  ph.BYTE);
        } static final Meta meta = new Meta(149, 0, 0, 1, 31, 239, 0, _qB, _sB, _fB, _BB, _KB);
    } public static class AQ_TELEMETRY_F extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        AQ_TELEMETRY_F() { super(meta, 0); }
        AQ_TELEMETRY_F(int bytes) { super(meta, bytes); }
        public char Index_GET()//Index of messag
        {  return (char)((char) get_bytes(data,  0, 2)); }
        public void Index_SET(char  src) //Index of messag
        {  set_bytes((char)(src) & -1L, 2, data,  0); }
        public float value1_GET()//value
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  2, 4))); }
        public void value1_SET(float  src) //value
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 2); }
        public float value2_GET()//value
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  6, 4))); }
        public void value2_SET(float  src) //value
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 6); }
        public float value3_GET()//value
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  10, 4))); }
        public void value3_SET(float  src) //value
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 10); }
        public float value4_GET()//value
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  14, 4))); }
        public void value4_SET(float  src) //value
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 14); }
        public float value5_GET()//value
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  18, 4))); }
        public void value5_SET(float  src) //value
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 18); }
        public float value6_GET()//value
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  22, 4))); }
        public void value6_SET(float  src) //value
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 22); }
        public float value7_GET()//value
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  26, 4))); }
        public void value7_SET(float  src) //value
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 26); }
        public float value8_GET()//value
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  30, 4))); }
        public void value8_SET(float  src) //value
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 30); }
        public float value9_GET()//value
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  34, 4))); }
        public void value9_SET(float  src) //value
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 34); }
        public float value10_GET()//value1
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  38, 4))); }
        public void value10_SET(float  src) //value1
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 38); }
        public float value11_GET()//value1
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  42, 4))); }
        public void value11_SET(float  src) //value1
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 42); }
        public float value12_GET()//value1
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  46, 4))); }
        public void value12_SET(float  src) //value1
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 46); }
        public float value13_GET()//value1
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  50, 4))); }
        public void value13_SET(float  src) //value1
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 50); }
        public float value14_GET()//value1
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  54, 4))); }
        public void value14_SET(float  src) //value1
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 54); }
        public float value15_GET()//value1
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  58, 4))); }
        public void value15_SET(float  src) //value1
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 58); }
        public float value16_GET()//value1
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  62, 4))); }
        public void value16_SET(float  src) //value1
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 62); }
        public float value17_GET()//value1
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  66, 4))); }
        public void value17_SET(float  src) //value1
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 66); }
        public float value18_GET()//value1
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  70, 4))); }
        public void value18_SET(float  src) //value1
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 70); }
        public float value19_GET()//value1
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  74, 4))); }
        public void value19_SET(float  src) //value1
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 74); }
        public float value20_GET()//value2
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  78, 4))); }
        public void value20_SET(float  src) //value2
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 78); }
        static final Meta meta = new Meta(150, 1, 0, 0, 82, 656);
    } public static class AQ_ESC_TELEMETRY extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        AQ_ESC_TELEMETRY() { super(meta, 0); }
        AQ_ESC_TELEMETRY(int bytes) { super(meta, bytes); }
        public char[] status_age_GET(char[]  dst_ch, int pos)  //Age of each ESC telemetry reading in ms compared to boot time. A value of 0xFFFF means timeout/no dat
        {
            for(int BYTE = 0, dst_max = pos + 4; pos < dst_max ; pos++,  BYTE += 2)
                dst_ch[pos] = (char)((char) get_bytes(data,  BYTE, 2));
            return dst_ch;
        }
        public char[] status_age_GET()//Age of each ESC telemetry reading in ms compared to boot time. A value of 0xFFFF means timeout/no dat
        {return status_age_GET(new char[4], 0);} public void status_age_SET(char[]  src, int pos)  //Age of each ESC telemetry reading in ms compared to boot time. A value of 0xFFFF means timeout/no dat
        {
            for(int BYTE =  0, src_max = pos + 4; pos < src_max; pos++, BYTE += 2)
                set_bytes((char)(src[pos]) & -1L, 2, data,  BYTE);
        }
        public long time_boot_ms_GET()//Timestamp of the component clock since boot time in ms
        {  return (get_bytes(data,  8, 4)); }
        ...
        {return data0_GET(new long[4], 0);} public void data0_SET(long[]  src, int pos)  //Data bits 1-32 for each ESC
        {
            for(int BYTE =  12, src_max = pos + 4; pos < src_max; pos++, BYTE += 4)
                set_bytes((src[pos]) & -1L, 4, data,  BYTE);
        }
        public long[] data1_GET(long[]  dst_ch, int pos)  //Data bits 33-64 for each ESC
        {
        ...
        {return data1_GET(new long[4], 0);} public void data1_SET(long[]  src, int pos)  //Data bits 33-64 for each ESC
        {
            for(int BYTE =  28, src_max = pos + 4; pos < src_max; pos++, BYTE += 4)
                set_bytes((src[pos]) & -1L, 4, data,  BYTE);
        }
        public char seq_GET()//Sequence number of message (first set of 4 motors is #1, next 4 is #2, etc)
        ...
        public char num_in_seq_GET()//Number of active ESCs in this sequence (1 through this many array members will be populated with dat
        {  return (char)((char) get_bytes(data,  46, 1)); }
        public void num_in_seq_SET(char  src) //Number of active ESCs in this sequence (1 through this many array members will be populated with dat
        {  set_bytes((char)(src) & -1L, 1, data,  46); }
        public char[] escid_GET(char[]  dst_ch, int pos)  //ESC/Motor I
        {
            for(int BYTE = 47, dst_max = pos + 4; pos < dst_max ; pos++,  BYTE += 1)
                dst_ch[pos] = (char)((char) get_bytes(data,  BYTE, 1));
            return dst_ch;
        }
        public char[] escid_GET()//ESC/Motor I
        {return escid_GET(new char[4], 0);} public void escid_SET(char[]  src, int pos)  //ESC/Motor I
        {
            for(int BYTE =  47, src_max = pos + 4; pos < src_max; pos++, BYTE += 1)
                set_bytes((char)(src[pos]) & -1L, 1, data,  BYTE);
        }
        public char[] data_version_GET(char[]  dst_ch, int pos)  //Version of data structure (determines contents)
        {
        ...
        {return data_version_GET(new char[4], 0);} public void data_version_SET(char[]  src, int pos)  //Version of data structure (determines contents)
        {
...
//Timestamp (microseconds since UNIX epoch or microseconds since system boot
        ...
        public void time_usec_SET(long  src, Bounds.Inside ph)//Timestamp (microseconds since UNIX epoch or microseconds since system boot
        {
            ...
            set_bytes((src) & -1L, 8, data,  ph.BYTE);
        } static final Meta meta = new Meta(242, 0, 0, 0, 53, 416, 0, _ZU);
...
//Timestamp (microseconds since UNIX epoch or microseconds since system boot
        ...
        public void time_usec_SET(long  src, Bounds.Inside ph)//Timestamp (microseconds since UNIX epoch or microseconds since system boot
        {
            ...
            set_bytes((src) & -1L, 8, data,  ph.BYTE);
        } static final Meta meta = new Meta(243, 0, 0, 0, 54, 424, 0, _OK);
...
//The callsign, 8+nul
        ...
        {callsign_SET(src.toCharArray(), 0, src.length(), ph);} public void callsign_SET(char[]  src, int pos, int items, Bounds.Inside ph) //The callsign, 8+nul
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(246, 3, 1, 0, 28, 210, 0, _LK);
...
//Nam
        ...
        {name_SET(src.toCharArray(), 0, src.length(), ph);} public void name_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Nam
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(250, 0, 0, 1, 21, 160, 0, _mK);
...
//Name of the debug variabl
        ...
        {name_SET(src.toCharArray(), 0, src.length(), ph);} public void name_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Name of the debug variabl
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(251, 0, 1, 0, 9, 64, 0, _ZK);
...
//Name of the debug variabl
        ...
        {name_SET(src.toCharArray(), 0, src.length(), ph);} public void name_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Name of the debug variabl
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(252, 0, 1, 0, 9, 64, 0, _tM);
...
//Status text message, without null termination characte
        ...
        {text_SET(src.toCharArray(), 0, src.length(), ph);} public void text_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Status text message, without null termination characte
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(253, 0, 0, 0, 2, 4, 0, _zM);
...
//tune in board specific forma
        ...
        {tune_SET(src.toCharArray(), 0, src.length(), ph);} public void tune_SET(char[]  src, int pos, int items, Bounds.Inside ph) //tune in board specific forma
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(258, 0, 0, 0, 3, 16, 0, _fM);
...
//Camera definition URI (if any, otherwise only basic functions will be available)
        ...
        {cam_definition_uri_SET(src.toCharArray(), 0, src.length(), ph);} public void cam_definition_uri_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Camera definition URI (if any, otherwise only basic functions will be available)
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(259, 3, 2, 0, 93, 731, 0, _NM);
...
//foo.jpg if camera provides an HTTP interface
        ...
        {file_url_SET(src.toCharArray(), 0, src.length(), ph);} public void file_url_SET(char[]  src, int pos, int items, Bounds.Inside ph) //foo.jpg if camera provides an HTTP interface
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(263, 0, 1, 1, 51, 402, 2, _Jw);
...
//Video stream UR
        ...
        {uri_SET(src.toCharArray(), 0, src.length(), ph);} public void uri_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Video stream UR
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(269, 3, 1, 0, 17, 130, 2, _Rw);
...
//Video stream UR
        ...
        {uri_SET(src.toCharArray(), 0, src.length(), ph);} public void uri_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Video stream UR
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(270, 3, 1, 0, 18, 138, 2, _Qw);
...
//Password. Leave it blank for an open AP
        ...
        {password_SET(src.toCharArray(), 0, src.length(), ph);} public void password_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Password. Leave it blank for an open AP
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(299, 0, 0, 0, 1, 2, 2, _bw, _cw);
...
//Node name string. For example, "sapog.px4.io"
        ...
        {name_SET(src.toCharArray(), 0, src.length(), ph);} public void name_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Node name string. For example, "sapog.px4.io"
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(311, 0, 2, 1, 37, 288, 0, _OL);
    } public static class PARAM_EXT_REQUEST_READ extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        ...
        } public void param_id_SET(String src, Bounds.Inside ph) {param_id_SET(src.toCharArray(), 0, src.length(), ph);} public void param_id_SET(char[]  src, int pos, int items, Bounds.Inside ph)
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(320, 0, 0, 0, 5, 32, 0, _UL);
...
//Parameter valu
        ...
        {param_value_SET(src.toCharArray(), 0, src.length(), ph);} public void param_value_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Parameter valu
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(322, 2, 0, 0, 5, 38, 2, _LL, _YL);
...
//Parameter valu
        ...
        {param_value_SET(src.toCharArray(), 0, src.length(), ph);} public void param_value_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Parameter valu
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(323, 0, 0, 0, 3, 22, 2, _NL, _IL);
...
//Parameter value (new value if PARAM_ACK_ACCEPTED, current value otherwise
        ...
        {param_value_SET(src.toCharArray(), 0, src.length(), ph);} public void param_value_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Parameter value (new value if PARAM_ACK_ACCEPTED, current value otherwise
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(324, 0, 0, 0, 2, 9, 2, _dL, _oL);
    ...
    public static class LoopBackDemoChannel  extends Channel
    {
            ...
            for(boolean LOOP = false; ;)
            {
                switch(id)
                {
                    ...
                    case 150:
                        ...
                        final AQ_TELEMETRY_F pi150 = (AQ_TELEMETRY_F) pack;
                        ph.setPack(pi150);
                        on_AQ_TELEMETRY_F.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi150));
                        if(LOOP) break;
                        return null;
                    case 152:
                        if(pack == null) return new AQ_ESC_TELEMETRY();
                        final AQ_ESC_TELEMETRY pi152 = (AQ_ESC_TELEMETRY) pack;
                        ph.setPack(pi152);
                        on_AQ_ESC_TELEMETRY.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi152));
                        if(LOOP) break;
                        return null;
                    case 230:
        ...
        public final Collection<OnReceive.Handler<AQ_TELEMETRY_F, LoopBackDemoChannel>> on_AQ_TELEMETRY_F = new OnReceive<>();
        public final Collection<OnReceive.Handler<AQ_ESC_TELEMETRY, LoopBackDemoChannel>> on_AQ_ESC_TELEMETRY = new OnReceive<>();
    ...
    private static final Field _d = new Field(5, true, -6, 2, 1, 0, 0, 0, 1);
    ...
    private static final Field _jH = new Field(0, false, 1, 4, 1, 0, 0, 0);
    private static final Field _gH = new Field(0, true, 1, 4, 1, 0, 0, 0);
    private static final Field _SH = new Field(0, true, 1, 4, 1, 0, 0, 0);
    private static final Field _XH = new Field(0, true, 1, 4, 1, 0, 0, 0);
    private static final Field _qH = new Field(0, true, 1, 4, 1, 0, 0, 0);
    private static final Field _Oz = new Field(0, true, 1, 2, 1, 0, 0, 0);
    private static final Field _jz = new Field(0, true, 1, 2, 1, 0, 0, 0);
    private static final Field _gz = new Field(0, true, 1, 2, 1, 0, 0, 0);
    private static final Field _Sz = new Field(0, true, 1, 2, 1, 0, 0, 0);
    ...
    private static final Field _BF = new Field(0, true, 1, 8, 1, 0, 0, 0);
    private static final Field _wF = new Field(0, true, 1, 8, 1, 0, 0, 0);
    private static final Field _PF = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
    private static final Field _Yi = new Field(0, false, 1, 1, 1, 0, 0, 0);
    private static final Field _Pi = new Field(0, false, 1, 4, 1, 0, 0, 0);
    private static final Field _Ai = new Field(0, false, 1, 1, 1, 0, 0, 0);
    private static final Field _vi = new Field(0, false, 1, 1, 1, 0, 0, 0);
    private static final Field _qj = new Field(0, false, 1, 4, 1, 0, 0, 0);
    private static final Field _sj = new Field(0, false, 1, 4, 1, 0, 0, 0);
    private static final Field _JB = new Field(0, false, 18, 1, 1, 0, 0, 0);
    private static final Field _qB = new Field(0, false, 1, 4, 1, 0, 0, 0);
    private static final Field _sB = new Field(0, false, 1, 4, 1, 0, 0, 0);
    private static final Field _fB = new Field(0, false, 1, 4, 1, 0, 0, 0);
    private static final Field _BB = new Field(0, false, 4, 4, 1, 0, 0, 0);
    private static final Field _KB = new Field(0, false, 1, 1, 1, 0, 0, 0);
    private static final Field _ZU = new Field(0, true, 1, 8, 1, 0, 0, 0);
    private static final Field _OK = new Field(0, true, 1, 8, 1, 0, 0, 0);
    private static final Field _LK = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
    private static final Field _mK = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
    private static final Field _ZK = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
    private static final Field _tM = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
    private static final Field _zM = new Field(5, true, -6, 2, 1, 0, 0, 0, 1);
    private static final Field _fM = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
    private static final Field _NM = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
    private static final Field _Jw = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
    private static final Field _Rw = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
    private static final Field _Qw = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
    private static final Field _bw = new Field(5, true, -6, 2, 1, 0, 0, 0, 1);
    private static final Field _cw = new Field(5, true, -7, 2, 1, 0, 0, 0, 1);
    private static final Field _OL = new Field(5, true, -7, 2, 1, 0, 0, 0, 1);
    private static final Field _UL = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
    private static final Field _LL = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
    private static final Field _YL = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
    private static final Field _NL = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
    private static final Field _IL = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
    private static final Field _dL = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
    private static final Field _oL = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
