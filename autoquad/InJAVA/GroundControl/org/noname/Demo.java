...
public class Demo extends  GroundControl
{
    public static void main(String[] args)
    {
        ...
        PH.setPack(p3);
        p3.time_boot_ms_SET(3997155900L);
        p3.coordinate_frame_SET(MAV_FRAME.MAV_FRAME_GLOBAL_TERRAIN_ALT_INT);
        p3.type_mask_SET((char)38944);
        p3.x_SET(-3.151696E38F);
        p3.y_SET(8.1911234E36F);
        p3.z_SET(-3.0888414E38F);
        p3.vx_SET(-1.163635E38F);
        p3.vy_SET(-2.668612E37F);
        p3.vz_SET(-2.1672763E38F);
        p3.afx_SET(7.4418296E37F);
        p3.afy_SET(1.8058851E38F);
        p3.afz_SET(-2.5899294E38F);
        p3.yaw_SET(1.6897807E38F);
        p3.yaw_rate_SET(3.0246237E38F);
        CommunicationChannel.instance.send(p3); //===============================
        COMMAND_INT p75 = CommunicationChannel.instance.new_COMMAND_INT();
        PH.setPack(p75);
        p75.target_system_SET((char)191);
        p75.target_component_SET((char)142);
        p75.frame_SET(MAV_FRAME.MAV_FRAME_GLOBAL_TERRAIN_ALT);
        p75.command_SET(MAV_CMD.MAV_CMD_DO_INVERTED_FLIGHT);
        p75.current_SET((char)197);
        p75.autocontinue_SET((char)183);
        p75.param1_SET(-2.073016E38F);
        p75.param2_SET(-2.5859249E38F);
        p75.param3_SET(-2.8427065E38F);
        p75.param4_SET(-3.246629E38F);
        p75.x_SET(-1423752736);
        p75.y_SET(-477799005);
        p75.z_SET(-9.813527E37F);
        CommunicationChannel.instance.send(p75); //===============================
        COMMAND_LONG p76 = CommunicationChannel.instance.new_COMMAND_LONG();
        PH.setPack(p76);
        p76.target_system_SET((char)212);
        p76.target_component_SET((char)194);
        p76.command_SET(MAV_CMD.MAV_CMD_REQUEST_CAMERA_IMAGE_CAPTURE);
        p76.confirmation_SET((char)7);
        p76.param1_SET(-9.751712E37F);
        p76.param2_SET(1.7233097E38F);
        p76.param3_SET(-7.512007E37F);
        p76.param4_SET(-2.8964259E38F);
        p76.param5_SET(-2.763685E38F);
        p76.param6_SET(1.7151795E38F);
        p76.param7_SET(2.293644E38F);
        ...
        p77.result_param2_SET(1302847472, PH);
        p77.target_system_SET((char)250, PH);
        p77.target_component_SET((char)2, PH);
        CommunicationChannel.instance.send(p77); //===============================
        MANUAL_SETPOINT p81 = CommunicationChannel.instance.new_MANUAL_SETPOINT();
        PH.setPack(p81);
        p81.time_boot_ms_SET(1885387477L);
        p81.roll_SET(1.0063663E36F);
        p81.pitch_SET(-3.0281145E38F);
        p81.yaw_SET(-2.899682E38F);
        p81.thrust_SET(-3.0476645E38F);
        p81.mode_switch_SET((char)115);
        p81.manual_override_switch_SET((char)208);
        CommunicationChannel.instance.send(p81); //===============================
        SET_ATTITUDE_TARGET p82 = CommunicationChannel.instance.new_SET_ATTITUDE_TARGET();
        PH.setPack(p82);
        p82.time_boot_ms_SET(2864585531L);
        p82.target_system_SET((char)115);
        p82.target_component_SET((char)174);
        p82.type_mask_SET((char)75);
        p82.q_SET(new float[4], 0);
        p82.body_roll_rate_SET(2.0542248E38F);
        p82.body_pitch_rate_SET(4.286342E37F);
        p82.body_yaw_rate_SET(3.5234288E37F);
        p82.thrust_SET(1.7780986E38F);
        CommunicationChannel.instance.send(p82); //===============================
        ATTITUDE_TARGET p83 = CommunicationChannel.instance.new_ATTITUDE_TARGET();
        PH.setPack(p83);
        p83.time_boot_ms_SET(1176208261L);
        p83.type_mask_SET((char)105);
        p83.q_SET(new float[4], 0);
        p83.body_roll_rate_SET(-9.761497E37F);
        p83.body_pitch_rate_SET(-2.8680447E38F);
        p83.body_yaw_rate_SET(1.6829413E38F);
        p83.thrust_SET(-2.6420467E38F);
        ...
        PH.setPack(p84);
        p84.time_boot_ms_SET(4116559889L);
        ...
        p84.type_mask_SET((char)32290);
        p84.x_SET(-9.652919E37F);
        p84.y_SET(3.1264582E38F);
        p84.z_SET(-2.2470689E38F);
        p84.vx_SET(-2.1629488E38F);
        p84.vy_SET(2.4664371E38F);
        p84.vz_SET(-3.0997448E38F);
        p84.afx_SET(1.4929276E38F);
        p84.afy_SET(1.8997888E38F);
        p84.afz_SET(3.1405553E38F);
        p84.yaw_SET(-2.7967812E38F);
        p84.yaw_rate_SET(3.1299182E38F);
        ...
        PH.setPack(p86);
        p86.time_boot_ms_SET(1769974317L);
        p86.target_system_SET((char)23);
        p86.target_component_SET((char)137);
        p86.coordinate_frame_SET(MAV_FRAME.MAV_FRAME_LOCAL_OFFSET_NED);
        p86.type_mask_SET((char)11757);
        p86.lat_int_SET(-112388222);
        p86.lon_int_SET(-1801389622);
        p86.alt_SET(-4.6042226E37F);
        p86.vx_SET(8.5661E37F);
        p86.vy_SET(-3.531669E37F);
        p86.vz_SET(2.857146E37F);
        p86.afx_SET(-8.811328E37F);
        p86.afy_SET(1.048681E38F);
        p86.afz_SET(-1.028304E38F);
        p86.yaw_SET(5.3877397E37F);
        p86.yaw_rate_SET(-1.5476903E38F);
        ...
        PH.setPack(p87);
        p87.time_boot_ms_SET(82699113L);
        p87.coordinate_frame_SET(MAV_FRAME.MAV_FRAME_GLOBAL_INT);
        p87.type_mask_SET((char)22596);
        p87.lat_int_SET(1604635192);
        p87.lon_int_SET(1128525249);
        p87.alt_SET(2.5937427E38F);
        p87.vx_SET(1.0759179E38F);
        p87.vy_SET(-1.8798901E38F);
        p87.vz_SET(1.4605634E37F);
        p87.afx_SET(-7.718389E37F);
        p87.afy_SET(-2.088802E38F);
        p87.afz_SET(1.7348143E38F);
        p87.yaw_SET(-9.997384E37F);
        p87.yaw_rate_SET(-2.4544509E38F);
        ...
        PH.setPack(p89);
        p89.time_boot_ms_SET(1822322981L);
        p89.x_SET(-3.269553E38F);
        p89.y_SET(3.2427379E38F);
        p89.z_SET(-1.4656045E38F);
        p89.roll_SET(7.0934046E37F);
        p89.pitch_SET(-2.3030565E38F);
        p89.yaw_SET(1.2955588E38F);
        CommunicationChannel.instance.send(p89); //===============================
        HIL_STATE p90 = CommunicationChannel.instance.new_HIL_STATE();
        PH.setPack(p90);
        p90.time_usec_SET(6423558189350657772L);
        p90.roll_SET(8.914381E37F);
        p90.pitch_SET(-1.5365822E37F);
        p90.yaw_SET(-3.2761075E38F);
        p90.rollspeed_SET(-6.0047407E37F);
        p90.pitchspeed_SET(-1.8463477E38F);
        p90.yawspeed_SET(1.6549229E38F);
        p90.lat_SET(-557697381);
        p90.lon_SET(-1262296448);
        p90.alt_SET(1044823367);
        p90.vx_SET((short)4276);
        p90.vy_SET((short)17644);
        p90.vz_SET((short)23921);
        p90.xacc_SET((short)25766);
        p90.yacc_SET((short) -3704);
        p90.zacc_SET((short)12010);
        CommunicationChannel.instance.send(p90); //===============================
        HIL_CONTROLS p91 = CommunicationChannel.instance.new_HIL_CONTROLS();
        PH.setPack(p91);
        p91.time_usec_SET(6723486476648530038L);
        p91.roll_ailerons_SET(-3.029454E38F);
        p91.pitch_elevator_SET(2.0714334E38F);
        p91.yaw_rudder_SET(3.0018052E37F);
        p91.throttle_SET(-4.196461E37F);
        p91.aux1_SET(5.2613604E36F);
        p91.aux2_SET(1.5214205E38F);
        p91.aux3_SET(2.1164106E38F);
        p91.aux4_SET(1.5228291E38F);
        p91.mode_SET(MAV_MODE.MAV_MODE_STABILIZE_ARMED);
        p91.nav_mode_SET((char)71);
        CommunicationChannel.instance.send(p91); //===============================
        HIL_RC_INPUTS_RAW p92 = CommunicationChannel.instance.new_HIL_RC_INPUTS_RAW();
        PH.setPack(p92);
        p92.time_usec_SET(4339574286582119418L);
        p92.chan1_raw_SET((char)33382);
        p92.chan2_raw_SET((char)41222);
        p92.chan3_raw_SET((char)3740);
        p92.chan4_raw_SET((char)62054);
        p92.chan5_raw_SET((char)45590);
        p92.chan6_raw_SET((char)59579);
        p92.chan7_raw_SET((char)17910);
        p92.chan8_raw_SET((char)34506);
        p92.chan9_raw_SET((char)6204);
        p92.chan10_raw_SET((char)59041);
        p92.chan11_raw_SET((char)28138);
        p92.chan12_raw_SET((char)50010);
        ...
        PH.setPack(p93);
        p93.time_usec_SET(1710802132113749037L);
        p93.controls_SET(new float[16], 0);
        p93.mode_SET(MAV_MODE.MAV_MODE_PREFLIGHT);
        p93.flags_SET(1242639571842156270L);
        CommunicationChannel.instance.send(p93); //===============================
        OPTICAL_FLOW p100 = CommunicationChannel.instance.new_OPTICAL_FLOW();
        PH.setPack(p100);
        p100.time_usec_SET(8908138059362051903L);
        p100.sensor_id_SET((char)206);
        p100.flow_x_SET((short)24438);
        p100.flow_y_SET((short)31882);
        p100.flow_comp_m_x_SET(5.353896E37F);
        p100.flow_comp_m_y_SET(-3.1723021E38F);
        p100.quality_SET((char)192);
        p100.ground_distance_SET(-1.04289425E37F);
        p100.flow_rate_x_SET(6.9494426E37F, PH);
        p100.flow_rate_y_SET(1.7663172E38F, PH);
        ...
        PH.setPack(p101);
        p101.usec_SET(515360583514859623L);
        p101.x_SET(1.944651E38F);
        p101.y_SET(-5.3038613E37F);
        p101.z_SET(-2.2282653E38F);
        p101.roll_SET(-5.6565105E37F);
        p101.pitch_SET(2.3738135E38F);
        p101.yaw_SET(3.605428E37F);
        ...
        PH.setPack(p102);
        p102.usec_SET(7787308801016654641L);
        p102.x_SET(2.8646798E38F);
        p102.y_SET(1.0390815E38F);
        p102.z_SET(1.935689E38F);
        p102.roll_SET(-1.8405605E38F);
        p102.pitch_SET(-2.322143E38F);
        p102.yaw_SET(-4.324241E37F);
        ...
        PH.setPack(p103);
        p103.usec_SET(1184679760047665310L);
        p103.x_SET(-1.1611359E38F);
        p103.y_SET(-1.0147418E38F);
        p103.z_SET(1.5108812E38F);
        CommunicationChannel.instance.send(p103); //===============================
        VICON_POSITION_ESTIMATE p104 = CommunicationChannel.instance.new_VICON_POSITION_ESTIMATE();
        PH.setPack(p104);
        p104.usec_SET(6533187489540188644L);
        p104.x_SET(-1.653063E38F);
        p104.y_SET(1.4750871E38F);
        p104.z_SET(2.3531392E38F);
        p104.roll_SET(-2.059454E38F);
        p104.pitch_SET(-2.8925272E38F);
        p104.yaw_SET(-5.5210904E37F);
        CommunicationChannel.instance.send(p104); //===============================
        HIGHRES_IMU p105 = CommunicationChannel.instance.new_HIGHRES_IMU();
        PH.setPack(p105);
        p105.time_usec_SET(5460803137261809752L);
        p105.xacc_SET(-8.1493307E37F);
        p105.yacc_SET(1.4273746E38F);
        p105.zacc_SET(1.6294098E38F);
        p105.xgyro_SET(-1.0798535E38F);
        p105.ygyro_SET(3.7559937E37F);
        p105.zgyro_SET(1.3469997E37F);
        p105.xmag_SET(-3.2569927E38F);
        p105.ymag_SET(-2.3255474E38F);
        p105.zmag_SET(5.07101E37F);
        p105.abs_pressure_SET(1.1032219E38F);
        p105.diff_pressure_SET(2.474181E38F);
        p105.pressure_alt_SET(3.3989206E37F);
        p105.temperature_SET(3.0374146E38F);
        p105.fields_updated_SET((char)57570);
        CommunicationChannel.instance.send(p105); //===============================
        OPTICAL_FLOW_RAD p106 = CommunicationChannel.instance.new_OPTICAL_FLOW_RAD();
        PH.setPack(p106);
        p106.time_usec_SET(1852341488789743788L);
        p106.sensor_id_SET((char)37);
        p106.integration_time_us_SET(2059268238L);
        p106.integrated_x_SET(3.8009342E37F);
        p106.integrated_y_SET(4.2193765E37F);
        p106.integrated_xgyro_SET(1.6814389E38F);
        p106.integrated_ygyro_SET(2.6431097E38F);
        p106.integrated_zgyro_SET(1.6848047E38F);
        p106.temperature_SET((short) -22099);
        p106.quality_SET((char)90);
        p106.time_delta_distance_us_SET(991866623L);
        p106.distance_SET(-3.0458662E38F);
        CommunicationChannel.instance.send(p106); //===============================
        HIL_SENSOR p107 = CommunicationChannel.instance.new_HIL_SENSOR();
        PH.setPack(p107);
        p107.time_usec_SET(7073770254678818072L);
        p107.xacc_SET(1.723315E38F);
        p107.yacc_SET(2.4903294E38F);
        p107.zacc_SET(-8.582776E37F);
        p107.xgyro_SET(-1.7852027E38F);
        p107.ygyro_SET(4.4116213E37F);
        p107.zgyro_SET(-2.0328337E38F);
        p107.xmag_SET(8.551583E37F);
        p107.ymag_SET(-1.0574984E38F);
        p107.zmag_SET(-8.952107E37F);
        p107.abs_pressure_SET(-6.2570605E37F);
        p107.diff_pressure_SET(1.381515E38F);
        p107.pressure_alt_SET(-9.4367935E35F);
        p107.temperature_SET(-4.1608065E37F);
        p107.fields_updated_SET(3556866290L);
        CommunicationChannel.instance.send(p107); //===============================
        SIM_STATE p108 = CommunicationChannel.instance.new_SIM_STATE();
        PH.setPack(p108);
        p108.q1_SET(-1.7132245E38F);
        p108.q2_SET(-1.7169074E38F);
        p108.q3_SET(2.2941947E38F);
        p108.q4_SET(-2.1785653E38F);
        p108.roll_SET(3.0755422E38F);
        p108.pitch_SET(-1.2032322E38F);
        p108.yaw_SET(-5.541111E37F);
        p108.xacc_SET(1.1728587E38F);
        p108.yacc_SET(1.5444293E38F);
        p108.zacc_SET(-1.6980343E38F);
        p108.xgyro_SET(3.1789746E38F);
        p108.ygyro_SET(1.9162393E38F);
        p108.zgyro_SET(-2.4395751E38F);
        p108.lat_SET(2.114381E38F);
        p108.lon_SET(-2.6768392E37F);
        p108.alt_SET(1.5835067E38F);
        p108.std_dev_horz_SET(-1.883404E38F);
        p108.std_dev_vert_SET(4.7190773E37F);
        p108.vn_SET(2.9040056E38F);
        p108.ve_SET(1.642163E38F);
        p108.vd_SET(-2.2411702E38F);
        CommunicationChannel.instance.send(p108); //===============================
        RADIO_STATUS p109 = CommunicationChannel.instance.new_RADIO_STATUS();
        PH.setPack(p109);
        p109.rssi_SET((char)198);
        p109.remrssi_SET((char)63);
        p109.txbuf_SET((char)209);
        p109.noise_SET((char)123);
        p109.remnoise_SET((char)205);
        p109.rxerrors_SET((char)54215);
        p109.fixed__SET((char)54029);
        CommunicationChannel.instance.send(p109); //===============================
        FILE_TRANSFER_PROTOCOL p110 = CommunicationChannel.instance.new_FILE_TRANSFER_PROTOCOL();
        PH.setPack(p110);
        p110.target_network_SET((char)13);
        p110.target_system_SET((char)190);
        ...
        PH.setPack(p111);
        p111.tc1_SET(-8108389614231398283L);
        p111.ts1_SET(4685401373581873657L);
        CommunicationChannel.instance.send(p111); //===============================
        CAMERA_TRIGGER p112 = CommunicationChannel.instance.new_CAMERA_TRIGGER();
        PH.setPack(p112);
        p112.time_usec_SET(6851994671114411020L);
        p112.seq_SET(3838882127L);
        CommunicationChannel.instance.send(p112); //===============================
        HIL_GPS p113 = CommunicationChannel.instance.new_HIL_GPS();
        PH.setPack(p113);
        p113.time_usec_SET(484263289686069574L);
        p113.fix_type_SET((char)33);
        p113.lat_SET(-381360667);
        p113.lon_SET(-721693000);
        p113.alt_SET(2104529375);
        p113.eph_SET((char)24233);
        p113.epv_SET((char)12439);
        p113.vel_SET((char)10691);
        p113.vn_SET((short) -28247);
        p113.ve_SET((short)26428);
        p113.vd_SET((short)30001);
        p113.cog_SET((char)12335);
        p113.satellites_visible_SET((char)171);
        CommunicationChannel.instance.send(p113); //===============================
        HIL_OPTICAL_FLOW p114 = CommunicationChannel.instance.new_HIL_OPTICAL_FLOW();
        PH.setPack(p114);
        p114.time_usec_SET(3423830276520493127L);
        p114.sensor_id_SET((char)201);
        p114.integration_time_us_SET(1966573887L);
        p114.integrated_x_SET(-2.1139536E38F);
        p114.integrated_y_SET(1.5857529E38F);
        p114.integrated_xgyro_SET(-5.9723386E37F);
        p114.integrated_ygyro_SET(7.638245E37F);
        p114.integrated_zgyro_SET(2.0953972E38F);
        p114.temperature_SET((short) -4010);
        p114.quality_SET((char)226);
        p114.time_delta_distance_us_SET(251452051L);
        p114.distance_SET(3.3867887E37F);
        CommunicationChannel.instance.send(p114); //===============================
        HIL_STATE_QUATERNION p115 = CommunicationChannel.instance.new_HIL_STATE_QUATERNION();
        PH.setPack(p115);
        p115.time_usec_SET(2047148393201054414L);
        p115.attitude_quaternion_SET(new float[4], 0);
        p115.rollspeed_SET(6.236828E37F);
        p115.pitchspeed_SET(2.5366463E38F);
        p115.yawspeed_SET(-3.1359309E38F);
        p115.lat_SET(693419891);
        p115.lon_SET(-1679514340);
        p115.alt_SET(1104715860);
        p115.vx_SET((short) -17877);
        p115.vy_SET((short)21067);
        p115.vz_SET((short)1589);
        p115.ind_airspeed_SET((char)8317);
        p115.true_airspeed_SET((char)64145);
        p115.xacc_SET((short) -16833);
        p115.yacc_SET((short) -30605);
        p115.zacc_SET((short) -22437);
        CommunicationChannel.instance.send(p115); //===============================
        SCALED_IMU2 p116 = CommunicationChannel.instance.new_SCALED_IMU2();
        PH.setPack(p116);
        p116.time_boot_ms_SET(1891056890L);
        p116.xacc_SET((short)22611);
        p116.yacc_SET((short) -4038);
        p116.zacc_SET((short) -22051);
        p116.xgyro_SET((short) -11156);
        p116.ygyro_SET((short)3426);
        p116.zgyro_SET((short)2310);
        p116.xmag_SET((short)31069);
        p116.ymag_SET((short) -7478);
        p116.zmag_SET((short) -12125);
        CommunicationChannel.instance.send(p116); //===============================
        LOG_REQUEST_LIST p117 = CommunicationChannel.instance.new_LOG_REQUEST_LIST();
        PH.setPack(p117);
        p117.target_system_SET((char)171);
        p117.target_component_SET((char)54);
        p117.start_SET((char)991);
        p117.end_SET((char)60898);
        CommunicationChannel.instance.send(p117); //===============================
        LOG_ENTRY p118 = CommunicationChannel.instance.new_LOG_ENTRY();
        PH.setPack(p118);
        p118.id_SET((char)61863);
        p118.num_logs_SET((char)52948);
        p118.last_log_num_SET((char)20104);
        p118.time_utc_SET(1263102463L);
        p118.size_SET(2815564897L);
        CommunicationChannel.instance.send(p118); //===============================
        LOG_REQUEST_DATA p119 = CommunicationChannel.instance.new_LOG_REQUEST_DATA();
        PH.setPack(p119);
        p119.target_system_SET((char)38);
        p119.target_component_SET((char)70);
        p119.id_SET((char)19641);
        p119.ofs_SET(1029082365L);
        p119.count_SET(439077602L);
        CommunicationChannel.instance.send(p119); //===============================
        LOG_DATA p120 = CommunicationChannel.instance.new_LOG_DATA();
        PH.setPack(p120);
        p120.id_SET((char)34543);
        p120.ofs_SET(1350950103L);
        p120.count_SET((char)202);
        p120.data__SET(new char[90], 0);
        CommunicationChannel.instance.send(p120); //===============================
        LOG_ERASE p121 = CommunicationChannel.instance.new_LOG_ERASE();
        PH.setPack(p121);
        p121.target_system_SET((char)35);
        p121.target_component_SET((char)78);
        CommunicationChannel.instance.send(p121); //===============================
        LOG_REQUEST_END p122 = CommunicationChannel.instance.new_LOG_REQUEST_END();
        PH.setPack(p122);
        p122.target_system_SET((char)128);
        p122.target_component_SET((char)168);
        CommunicationChannel.instance.send(p122); //===============================
        GPS_INJECT_DATA p123 = CommunicationChannel.instance.new_GPS_INJECT_DATA();
        PH.setPack(p123);
        p123.target_system_SET((char)175);
        p123.target_component_SET((char)125);
        p123.len_SET((char)123);
        p123.data__SET(new char[110], 0);
        CommunicationChannel.instance.send(p123); //===============================
        GPS2_RAW p124 = CommunicationChannel.instance.new_GPS2_RAW();
        PH.setPack(p124);
        p124.time_usec_SET(1513094225264216817L);
        p124.fix_type_SET(GPS_FIX_TYPE.GPS_FIX_TYPE_RTK_FIXED);
        p124.lat_SET(490830408);
        p124.lon_SET(-255009114);
        p124.alt_SET(1547938476);
        p124.eph_SET((char)65161);
        p124.epv_SET((char)39102);
        p124.vel_SET((char)48835);
        p124.cog_SET((char)26134);
        p124.satellites_visible_SET((char)5);
        p124.dgps_numch_SET((char)46);
        p124.dgps_age_SET(42962971L);
        CommunicationChannel.instance.send(p124); //===============================
        POWER_STATUS p125 = CommunicationChannel.instance.new_POWER_STATUS();
        PH.setPack(p125);
        p125.Vcc_SET((char)43865);
        p125.Vservo_SET((char)15838);
        ...
        p126.timeout_SET((char)64151);
        p126.baudrate_SET(3463129757L);
        p126.count_SET((char)153);
        p126.data__SET(new char[70], 0);
        CommunicationChannel.instance.send(p126); //===============================
        GPS_RTK p127 = CommunicationChannel.instance.new_GPS_RTK();
        PH.setPack(p127);
        p127.time_last_baseline_ms_SET(4249856795L);
        p127.rtk_receiver_id_SET((char)94);
        p127.wn_SET((char)31685);
        p127.tow_SET(2228741508L);
        p127.rtk_health_SET((char)83);
        p127.rtk_rate_SET((char)49);
        p127.nsats_SET((char)30);
        p127.baseline_coords_type_SET((char)99);
        p127.baseline_a_mm_SET(2043106288);
        p127.baseline_b_mm_SET(-1845113454);
        p127.baseline_c_mm_SET(-1467189479);
        p127.accuracy_SET(3458944416L);
        p127.iar_num_hypotheses_SET(-526273484);
        CommunicationChannel.instance.send(p127); //===============================
        GPS2_RTK p128 = CommunicationChannel.instance.new_GPS2_RTK();
        PH.setPack(p128);
        p128.time_last_baseline_ms_SET(3603535000L);
        p128.rtk_receiver_id_SET((char)61);
        p128.wn_SET((char)29811);
        p128.tow_SET(3421609322L);
        p128.rtk_health_SET((char)65);
        p128.rtk_rate_SET((char)115);
        p128.nsats_SET((char)123);
        p128.baseline_coords_type_SET((char)14);
        p128.baseline_a_mm_SET(679828663);
        p128.baseline_b_mm_SET(-2088494921);
        p128.baseline_c_mm_SET(220841396);
        p128.accuracy_SET(3279357779L);
        p128.iar_num_hypotheses_SET(810191294);
        CommunicationChannel.instance.send(p128); //===============================
        SCALED_IMU3 p129 = CommunicationChannel.instance.new_SCALED_IMU3();
        PH.setPack(p129);
        p129.time_boot_ms_SET(973208773L);
        p129.xacc_SET((short)7055);
        p129.yacc_SET((short) -27010);
        p129.zacc_SET((short) -20757);
        p129.xgyro_SET((short) -5135);
        p129.ygyro_SET((short)23092);
        p129.zgyro_SET((short) -1356);
        p129.xmag_SET((short) -1182);
        p129.ymag_SET((short)14984);
        p129.zmag_SET((short)1554);
        CommunicationChannel.instance.send(p129); //===============================
        DATA_TRANSMISSION_HANDSHAKE p130 = CommunicationChannel.instance.new_DATA_TRANSMISSION_HANDSHAKE();
        PH.setPack(p130);
        p130.type_SET((char)155);
        p130.size_SET(2127545334L);
        p130.width_SET((char)5556);
        p130.height_SET((char)22986);
        p130.packets_SET((char)30683);
        p130.payload_SET((char)233);
        p130.jpg_quality_SET((char)73);
        CommunicationChannel.instance.send(p130); //===============================
        ENCAPSULATED_DATA p131 = CommunicationChannel.instance.new_ENCAPSULATED_DATA();
        PH.setPack(p131);
        p131.seqnr_SET((char)11669);
        p131.data__SET(new char[253], 0);
        CommunicationChannel.instance.send(p131); //===============================
        DISTANCE_SENSOR p132 = CommunicationChannel.instance.new_DISTANCE_SENSOR();
        PH.setPack(p132);
        p132.time_boot_ms_SET(697230383L);
        p132.min_distance_SET((char)32270);
        p132.max_distance_SET((char)4095);
        p132.current_distance_SET((char)13691);
        p132.type_SET(MAV_DISTANCE_SENSOR.MAV_DISTANCE_SENSOR_LASER);
        p132.id_SET((char)148);
        p132.orientation_SET(MAV_SENSOR_ORIENTATION.MAV_SENSOR_ROTATION_YAW_180);
        p132.covariance_SET((char)113);
        CommunicationChannel.instance.send(p132); //===============================
        TERRAIN_REQUEST p133 = CommunicationChannel.instance.new_TERRAIN_REQUEST();
        PH.setPack(p133);
        p133.lat_SET(1678697830);
        p133.lon_SET(-691682852);
        p133.grid_spacing_SET((char)41036);
        p133.mask_SET(2722988603539676181L);
        CommunicationChannel.instance.send(p133); //===============================
        TERRAIN_DATA p134 = CommunicationChannel.instance.new_TERRAIN_DATA();
        PH.setPack(p134);
        p134.lat_SET(-2135480001);
        p134.lon_SET(-86478367);
        p134.grid_spacing_SET((char)53987);
        p134.gridbit_SET((char)170);
        p134.data__SET(new short[16], 0);
        CommunicationChannel.instance.send(p134); //===============================
        TERRAIN_CHECK p135 = CommunicationChannel.instance.new_TERRAIN_CHECK();
        PH.setPack(p135);
        p135.lat_SET(-907082057);
        p135.lon_SET(75618681);
        CommunicationChannel.instance.send(p135); //===============================
        TERRAIN_REPORT p136 = CommunicationChannel.instance.new_TERRAIN_REPORT();
        PH.setPack(p136);
        p136.lat_SET(-1859714583);
        p136.lon_SET(-1588697493);
        p136.spacing_SET((char)47512);
        p136.terrain_height_SET(2.6508951E38F);
        p136.current_height_SET(-2.218282E38F);
        p136.pending_SET((char)41980);
        p136.loaded_SET((char)47968);
        CommunicationChannel.instance.send(p136); //===============================
        SCALED_PRESSURE2 p137 = CommunicationChannel.instance.new_SCALED_PRESSURE2();
        PH.setPack(p137);
        p137.time_boot_ms_SET(1262132851L);
        p137.press_abs_SET(-1.445859E38F);
        p137.press_diff_SET(-1.7736799E38F);
        p137.temperature_SET((short) -15828);
        CommunicationChannel.instance.send(p137); //===============================
        ATT_POS_MOCAP p138 = CommunicationChannel.instance.new_ATT_POS_MOCAP();
        PH.setPack(p138);
        p138.time_usec_SET(6571428600302706079L);
        p138.q_SET(new float[4], 0);
        p138.x_SET(2.9916114E38F);
        p138.y_SET(2.0442393E38F);
        p138.z_SET(-2.1777702E38F);
        CommunicationChannel.instance.send(p138); //===============================
        SET_ACTUATOR_CONTROL_TARGET p139 = CommunicationChannel.instance.new_SET_ACTUATOR_CONTROL_TARGET();
        PH.setPack(p139);
        p139.time_usec_SET(5161681224458362123L);
        p139.group_mlx_SET((char)57);
        p139.target_system_SET((char)110);
        ...
        PH.setPack(p140);
        p140.time_usec_SET(8822823139390563349L);
        p140.group_mlx_SET((char)156);
        p140.controls_SET(new float[8], 0);
        CommunicationChannel.instance.send(p140); //===============================
        ALTITUDE p141 = CommunicationChannel.instance.new_ALTITUDE();
        PH.setPack(p141);
        p141.time_usec_SET(5003664735814435548L);
        p141.altitude_monotonic_SET(2.4893446E37F);
        p141.altitude_amsl_SET(3.048371E38F);
        p141.altitude_local_SET(2.273975E38F);
        p141.altitude_relative_SET(2.3725296E38F);
        p141.altitude_terrain_SET(-2.6315483E38F);
        p141.bottom_clearance_SET(5.289803E37F);
        CommunicationChannel.instance.send(p141); //===============================
        RESOURCE_REQUEST p142 = CommunicationChannel.instance.new_RESOURCE_REQUEST();
        PH.setPack(p142);
        p142.request_id_SET((char)135);
        p142.uri_type_SET((char)137);
        p142.uri_SET(new char[120], 0);
        p142.transfer_type_SET((char)134);
        p142.storage_SET(new char[120], 0);
        CommunicationChannel.instance.send(p142); //===============================
        SCALED_PRESSURE3 p143 = CommunicationChannel.instance.new_SCALED_PRESSURE3();
        PH.setPack(p143);
        p143.time_boot_ms_SET(672198418L);
        p143.press_abs_SET(-1.7879615E38F);
        p143.press_diff_SET(-3.1459113E38F);
        p143.temperature_SET((short) -17059);
        CommunicationChannel.instance.send(p143); //===============================
        FOLLOW_TARGET p144 = CommunicationChannel.instance.new_FOLLOW_TARGET();
        PH.setPack(p144);
        p144.timestamp_SET(5716942697372666771L);
        p144.est_capabilities_SET((char)120);
        p144.lat_SET(543851194);
        p144.lon_SET(-1401495440);
        p144.alt_SET(-1.2878498E38F);
        p144.vel_SET(new float[3], 0);
        p144.acc_SET(new float[3], 0);
        p144.attitude_q_SET(new float[4], 0);
        p144.rates_SET(new float[3], 0);
        p144.position_cov_SET(new float[3], 0);
        p144.custom_state_SET(386395022180759549L);
        CommunicationChannel.instance.send(p144); //===============================
        CONTROL_SYSTEM_STATE p146 = CommunicationChannel.instance.new_CONTROL_SYSTEM_STATE();
        PH.setPack(p146);
        p146.time_usec_SET(3623735472400569972L);
        p146.x_acc_SET(-3.2091948E38F);
        p146.y_acc_SET(2.0601977E38F);
        p146.z_acc_SET(1.8794285E38F);
        p146.x_vel_SET(-2.4595456E38F);
        p146.y_vel_SET(-1.3532849E38F);
        p146.z_vel_SET(-5.871246E37F);
        p146.x_pos_SET(1.720707E38F);
        p146.y_pos_SET(2.324E38F);
        p146.z_pos_SET(2.9004578E37F);
        p146.airspeed_SET(7.1917946E37F);
        p146.vel_variance_SET(new float[3], 0);
        p146.pos_variance_SET(new float[3], 0);
        p146.q_SET(new float[4], 0);
        p146.roll_rate_SET(2.2717366E37F);
        p146.pitch_rate_SET(3.2414651E38F);
        p146.yaw_rate_SET(-2.9121682E38F);
        CommunicationChannel.instance.send(p146); //===============================
        BATTERY_STATUS p147 = CommunicationChannel.instance.new_BATTERY_STATUS();
        PH.setPack(p147);
        p147.id_SET((char)183);
        ...
        p147.temperature_SET((short) -5612);
        p147.voltages_SET(new char[10], 0);
        p147.current_battery_SET((short)19554);
        p147.current_consumed_SET(471632103);
        p147.energy_consumed_SET(-1195159510);
        p147.battery_remaining_SET((byte)91);
        ...
        p148.flight_sw_version_SET(1794007197L);
        p148.middleware_sw_version_SET(965268961L);
        p148.os_sw_version_SET(2680034191L);
        p148.board_version_SET(3220084655L);
        ...
        p148.vendor_id_SET((char)4732);
        p148.product_id_SET((char)22751);
        p148.uid_SET(3368018823439607913L);
        p148.uid2_SET(new char[18], 0, PH);
        CommunicationChannel.instance.send(p148); //===============================
        LANDING_TARGET p149 = CommunicationChannel.instance.new_LANDING_TARGET();
        PH.setPack(p149);
        p149.time_usec_SET(7330246020816210820L);
        p149.target_num_SET((char)252);
        p149.frame_SET(MAV_FRAME.MAV_FRAME_LOCAL_NED);
        p149.angle_x_SET(-3.0980464E38F);
        p149.angle_y_SET(1.2470374E38F);
        p149.distance_SET(-3.0586993E38F);
        p149.size_x_SET(-1.5573894E38F);
        p149.size_y_SET(2.9048077E36F);
        p149.x_SET(-1.0533023E38F, PH);
        p149.y_SET(7.8846437E37F, PH);
        p149.z_SET(-4.156002E37F, PH);
        ...
        PH.setPack(p150);
        p150.Index_SET((char)39051);
        p150.value1_SET(1.5720036E38F);
        p150.value2_SET(1.9351157E38F);
        p150.value3_SET(3.4016126E38F);
        p150.value4_SET(-3.355245E38F);
        p150.value5_SET(-1.5662221E38F);
        p150.value6_SET(1.4479217E38F);
        p150.value7_SET(3.361134E38F);
        p150.value8_SET(-2.1998713E38F);
        p150.value9_SET(1.7532407E38F);
        p150.value10_SET(-1.9622742E38F);
        p150.value11_SET(6.984369E37F);
        p150.value12_SET(1.4762142E38F);
        p150.value13_SET(-2.7459154E38F);
        p150.value14_SET(3.348693E38F);
        p150.value15_SET(-2.7349982E38F);
        p150.value16_SET(2.349315E38F);
        p150.value17_SET(1.3627216E38F);
        p150.value18_SET(-1.7553013E37F);
        p150.value19_SET(-2.7168482E38F);
        p150.value20_SET(-2.0956238E38F);
        CommunicationChannel.instance.send(p150); //===============================
        AQ_ESC_TELEMETRY p152 = CommunicationChannel.instance.new_AQ_ESC_TELEMETRY();
        PH.setPack(p152);
        p152.time_boot_ms_SET(741266837L);
        p152.seq_SET((char)93);
        p152.num_motors_SET((char)53);
        p152.num_in_seq_SET((char)60);
        ...
        PH.setPack(p230);
        p230.time_usec_SET(4674404030092117404L);
        p230.flags_SET((ESTIMATOR_STATUS_FLAGS.ESTIMATOR_PRED_POS_HORIZ_REL));
        p230.vel_ratio_SET(2.2776503E38F);
        p230.pos_horiz_ratio_SET(1.367276E38F);
        p230.pos_vert_ratio_SET(9.925854E37F);
        p230.mag_ratio_SET(-1.7019838E38F);
        p230.hagl_ratio_SET(-2.609359E38F);
        p230.tas_ratio_SET(-1.7273794E38F);
        p230.pos_horiz_accuracy_SET(-1.309827E38F);
        p230.pos_vert_accuracy_SET(3.2932307E38F);
        CommunicationChannel.instance.send(p230); //===============================
        WIND_COV p231 = CommunicationChannel.instance.new_WIND_COV();
        PH.setPack(p231);
        p231.time_usec_SET(789660721705890703L);
        p231.wind_x_SET(1.8493408E38F);
        p231.wind_y_SET(1.5408225E38F);
        p231.wind_z_SET(-2.2359207E38F);
        p231.var_horiz_SET(1.9984954E38F);
        p231.var_vert_SET(-3.1971864E38F);
        p231.wind_alt_SET(2.6976692E38F);
        p231.horiz_accuracy_SET(3.398394E37F);
        p231.vert_accuracy_SET(-1.7277723E38F);
        CommunicationChannel.instance.send(p231); //===============================
        GPS_INPUT p232 = CommunicationChannel.instance.new_GPS_INPUT();
        PH.setPack(p232);
        p232.time_usec_SET(9010553864956063135L);
        ...
        p232.time_week_ms_SET(1964939565L);
        p232.time_week_SET((char)48985);
        p232.fix_type_SET((char)76);
        p232.lat_SET(-1168450021);
        p232.lon_SET(-1336996775);
        p232.alt_SET(9.629644E37F);
        p232.hdop_SET(-4.7012237E37F);
        p232.vdop_SET(-3.1998663E38F);
        p232.vn_SET(2.234851E38F);
        p232.ve_SET(2.3822818E38F);
        p232.vd_SET(-1.1344012E38F);
        p232.speed_accuracy_SET(-2.0477153E38F);
        p232.horiz_accuracy_SET(2.1350213E37F);
        p232.vert_accuracy_SET(-2.1208634E38F);
        p232.satellites_visible_SET((char)114);
        CommunicationChannel.instance.send(p232); //===============================
        GPS_RTCM_DATA p233 = CommunicationChannel.instance.new_GPS_RTCM_DATA();
        PH.setPack(p233);
        p233.flags_SET((char)247);
        p233.len_SET((char)225);
        ...
        p234.custom_mode_SET(1517855225L);
        p234.landed_state_SET(MAV_LANDED_STATE.MAV_LANDED_STATE_UNDEFINED);
        p234.roll_SET((short) -31362);
        p234.pitch_SET((short)3194);
        p234.heading_SET((char)64883);
        p234.throttle_SET((byte) - 57);
        p234.heading_sp_SET((short) -13530);
        p234.latitude_SET(1156350553);
        p234.longitude_SET(1947743201);
        p234.altitude_amsl_SET((short) -17616);
        p234.altitude_sp_SET((short) -25835);
        p234.airspeed_SET((char)94);
        p234.airspeed_sp_SET((char)47);
        p234.groundspeed_SET((char)154);
        p234.climb_rate_SET((byte) - 43);
        p234.gps_nsat_SET((char)195);
        p234.gps_fix_type_SET(GPS_FIX_TYPE.GPS_FIX_TYPE_STATIC);
        p234.battery_remaining_SET((char)41);
        p234.temperature_SET((byte) - 78);
        p234.temperature_air_SET((byte) - 94);
        p234.failsafe_SET((char)123);
        p234.wp_num_SET((char)7);
        p234.wp_distance_SET((char)18897);
        CommunicationChannel.instance.send(p234); //===============================
        VIBRATION p241 = CommunicationChannel.instance.new_VIBRATION();
        PH.setPack(p241);
        p241.time_usec_SET(860547499841126637L);
        p241.vibration_x_SET(1.2687187E38F);
        p241.vibration_y_SET(-5.7436493E37F);
        p241.vibration_z_SET(-9.03821E37F);
        p241.clipping_0_SET(66104000L);
        p241.clipping_1_SET(2052809411L);
        p241.clipping_2_SET(739754066L);
        CommunicationChannel.instance.send(p241); //===============================
        HOME_POSITION p242 = CommunicationChannel.instance.new_HOME_POSITION();
        PH.setPack(p242);
        p242.latitude_SET(1291095140);
        p242.longitude_SET(-11277697);
        p242.altitude_SET(1908574543);
        p242.x_SET(-3.396177E38F);
        p242.y_SET(-3.161917E38F);
        p242.z_SET(-2.5825326E38F);
        p242.q_SET(new float[4], 0);
        p242.approach_x_SET(1.3253436E38F);
        p242.approach_y_SET(1.6284051E38F);
        p242.approach_z_SET(2.0100091E36F);
        p242.time_usec_SET(1090952131590493952L, PH);
        CommunicationChannel.instance.send(p242); //===============================
        SET_HOME_POSITION p243 = CommunicationChannel.instance.new_SET_HOME_POSITION();
        PH.setPack(p243);
        p243.target_system_SET((char)251);
        p243.latitude_SET(-517744113);
        p243.longitude_SET(-604461643);
        p243.altitude_SET(-1341933750);
        p243.x_SET(-1.1819973E38F);
        p243.y_SET(1.8936142E38F);
        p243.z_SET(-3.047893E38F);
        p243.q_SET(new float[4], 0);
        p243.approach_x_SET(3.6660678E37F);
        p243.approach_y_SET(-6.9199084E37F);
        p243.approach_z_SET(-3.0070374E38F);
        p243.time_usec_SET(6828574748059040981L, PH);
        CommunicationChannel.instance.send(p243); //===============================
        MESSAGE_INTERVAL p244 = CommunicationChannel.instance.new_MESSAGE_INTERVAL();
        PH.setPack(p244);
        p244.message_id_SET((char)57839);
        p244.interval_us_SET(1973785978);
        ...
        PH.setPack(p246);
        p246.ICAO_address_SET(179044706L);
        p246.lat_SET(993000364);
        p246.lon_SET(1395920860);
        p246.altitude_type_SET(ADSB_ALTITUDE_TYPE.ADSB_ALTITUDE_TYPE_PRESSURE_QNH);
        p246.altitude_SET(-1711353954);
        p246.heading_SET((char)40967);
        p246.hor_velocity_SET((char)33369);
        p246.ver_velocity_SET((short) -15057);
        p246.callsign_SET("DEMO", PH);
        p246.emitter_type_SET(ADSB_EMITTER_TYPE.ADSB_EMITTER_TYPE_ULTRA_LIGHT);
        p246.tslc_SET((char)30);
        ...
        p247.time_to_minimum_delta_SET(6.1952904E37F);
        p247.altitude_minimum_delta_SET(-1.8199106E38F);
        p247.horizontal_minimum_delta_SET(-1.1212414E38F);
        CommunicationChannel.instance.send(p247); //===============================
        V2_EXTENSION p248 = CommunicationChannel.instance.new_V2_EXTENSION();
        PH.setPack(p248);
        p248.target_network_SET((char)125);
        p248.target_system_SET((char)200);
        p248.target_component_SET((char)190);
        p248.message_type_SET((char)56631);
        p248.payload_SET(new char[249], 0);
        CommunicationChannel.instance.send(p248); //===============================
        MEMORY_VECT p249 = CommunicationChannel.instance.new_MEMORY_VECT();
        PH.setPack(p249);
        p249.address_SET((char)17000);
        p249.ver_SET((char)129);
        ...
        p250.time_usec_SET(8509439967389618195L);
        p250.x_SET(-1.5035158E38F);
        p250.y_SET(-3.0546144E38F);
        p250.z_SET(-3.0576708E38F);
        CommunicationChannel.instance.send(p250); //===============================
        NAMED_VALUE_FLOAT p251 = CommunicationChannel.instance.new_NAMED_VALUE_FLOAT();
        PH.setPack(p251);
        p251.time_boot_ms_SET(1068756309L);
        p251.name_SET("DEMO", PH);
        p251.value_SET(2.6462387E38F);
        CommunicationChannel.instance.send(p251); //===============================
        NAMED_VALUE_INT p252 = CommunicationChannel.instance.new_NAMED_VALUE_INT();
        PH.setPack(p252);
        p252.time_boot_ms_SET(2413653724L);
        p252.name_SET("DEMO", PH);
        p252.value_SET(1928748878);
        ...
        PH.setPack(p254);
        p254.time_boot_ms_SET(34864029L);
        p254.ind_SET((char)171);
        p254.value_SET(1.4816285E38F);
        CommunicationChannel.instance.send(p254); //===============================
        SETUP_SIGNING p256 = CommunicationChannel.instance.new_SETUP_SIGNING();
        PH.setPack(p256);
        p256.target_system_SET((char)120);
        p256.target_component_SET((char)71);
        p256.secret_key_SET(new char[32], 0);
        p256.initial_timestamp_SET(7027461099121309689L);
        CommunicationChannel.instance.send(p256); //===============================
        BUTTON_CHANGE p257 = CommunicationChannel.instance.new_BUTTON_CHANGE();
        PH.setPack(p257);
        p257.time_boot_ms_SET(164240311L);
        p257.last_change_ms_SET(565601232L);
        p257.state_SET((char)67);
        CommunicationChannel.instance.send(p257); //===============================
        PLAY_TUNE p258 = CommunicationChannel.instance.new_PLAY_TUNE();
        PH.setPack(p258);
        p258.target_system_SET((char)168);
        p258.target_component_SET((char)190);
        p258.tune_SET("DEMO", PH);
        CommunicationChannel.instance.send(p258); //===============================
        CAMERA_INFORMATION p259 = CommunicationChannel.instance.new_CAMERA_INFORMATION();
        PH.setPack(p259);
        p259.time_boot_ms_SET(192770247L);
        p259.vendor_name_SET(new char[32], 0);
        p259.model_name_SET(new char[32], 0);
        p259.firmware_version_SET(1466381345L);
        p259.focal_length_SET(3.621418E36F);
        p259.sensor_size_h_SET(1.1712809E38F);
        p259.sensor_size_v_SET(2.58604E37F);
        p259.resolution_h_SET((char)54648);
        p259.resolution_v_SET((char)49909);
        p259.lens_id_SET((char)7);
        ...
        PH.setPack(p261);
        p261.time_boot_ms_SET(2177106248L);
        p261.storage_id_SET((char)147);
        p261.storage_count_SET((char)86);
        p261.status_SET((char)75);
        p261.total_capacity_SET(-1.871374E38F);
        p261.used_capacity_SET(-5.097535E37F);
        p261.available_capacity_SET(2.5853874E38F);
        p261.read_speed_SET(3.1391365E38F);
        p261.write_speed_SET(1.1920472E38F);
        CommunicationChannel.instance.send(p261); //===============================
        CAMERA_CAPTURE_STATUS p262 = CommunicationChannel.instance.new_CAMERA_CAPTURE_STATUS();
        PH.setPack(p262);
        p262.time_boot_ms_SET(959169496L);
        p262.image_status_SET((char)246);
        p262.video_status_SET((char)226);
        p262.image_interval_SET(-8.57784E37F);
        p262.recording_time_ms_SET(3490228784L);
        p262.available_capacity_SET(7.217459E37F);
        CommunicationChannel.instance.send(p262); //===============================
        CAMERA_IMAGE_CAPTURED p263 = CommunicationChannel.instance.new_CAMERA_IMAGE_CAPTURED();
        PH.setPack(p263);
        p263.time_boot_ms_SET(1486379717L);
        p263.time_utc_SET(2043276223729435752L);
        p263.camera_id_SET((char)37);
        p263.lat_SET(1552928518);
        p263.lon_SET(-1541589592);
        p263.alt_SET(-1554584297);
        p263.relative_alt_SET(-1494923695);
        p263.q_SET(new float[4], 0);
        p263.image_index_SET(-929017717);
        p263.capture_result_SET((byte)11);
        p263.file_url_SET("DEMO", PH);
        CommunicationChannel.instance.send(p263); //===============================
        FLIGHT_INFORMATION p264 = CommunicationChannel.instance.new_FLIGHT_INFORMATION();
        PH.setPack(p264);
        p264.time_boot_ms_SET(1260229676L);
        p264.arming_time_utc_SET(433479775329987305L);
        p264.takeoff_time_utc_SET(2534134099727042153L);
        p264.flight_uuid_SET(4103349398522308947L);
        CommunicationChannel.instance.send(p264); //===============================
        MOUNT_ORIENTATION p265 = CommunicationChannel.instance.new_MOUNT_ORIENTATION();
        PH.setPack(p265);
        p265.time_boot_ms_SET(2161250007L);
        p265.roll_SET(2.4989138E37F);
        p265.pitch_SET(2.8693425E38F);
        p265.yaw_SET(2.1967202E38F);
        CommunicationChannel.instance.send(p265); //===============================
        LOGGING_DATA p266 = CommunicationChannel.instance.new_LOGGING_DATA();
        PH.setPack(p266);
        p266.target_system_SET((char)19);
        p266.target_component_SET((char)48);
        p266.sequence_SET((char)21560);
        p266.length_SET((char)184);
        p266.first_message_offset_SET((char)231);
        p266.data__SET(new char[249], 0);
        CommunicationChannel.instance.send(p266); //===============================
        LOGGING_DATA_ACKED p267 = CommunicationChannel.instance.new_LOGGING_DATA_ACKED();
        PH.setPack(p267);
        p267.target_system_SET((char)170);
        p267.target_component_SET((char)125);
        p267.sequence_SET((char)48427);
        p267.length_SET((char)212);
        p267.first_message_offset_SET((char)205);
        ...
        p268.target_component_SET((char)129);
        p268.sequence_SET((char)26083);
        CommunicationChannel.instance.send(p268); //===============================
        VIDEO_STREAM_INFORMATION p269 = CommunicationChannel.instance.new_VIDEO_STREAM_INFORMATION();
        PH.setPack(p269);
        p269.camera_id_SET((char)234);
        p269.status_SET((char)65);
        p269.framerate_SET(2.6923797E38F);
        p269.resolution_h_SET((char)38750);
        p269.resolution_v_SET((char)40718);
        p269.bitrate_SET(291121641L);
        p269.rotation_SET((char)29347);
        p269.uri_SET("DEMO", PH);
        CommunicationChannel.instance.send(p269); //===============================
        SET_VIDEO_STREAM_SETTINGS p270 = CommunicationChannel.instance.new_SET_VIDEO_STREAM_SETTINGS();
        PH.setPack(p270);
        p270.target_system_SET((char)156);
        p270.target_component_SET((char)208);
        p270.camera_id_SET((char)253);
        p270.framerate_SET(2.0093966E38F);
        p270.resolution_h_SET((char)37018);
        p270.resolution_v_SET((char)37526);
        p270.bitrate_SET(2608714807L);
        p270.rotation_SET((char)33229);
        ...
        PH.setPack(p300);
        p300.version_SET((char)7826);
        p300.min_version_SET((char)6394);
        p300.max_version_SET((char)10723);
        ...
        PH.setPack(p310);
        p310.time_usec_SET(4891868004475670323L);
        p310.uptime_sec_SET(1897478677L);
        p310.health_SET(UAVCAN_NODE_HEALTH.UAVCAN_NODE_HEALTH_WARNING);
        p310.mode_SET(UAVCAN_NODE_MODE.UAVCAN_NODE_MODE_OPERATIONAL);
        p310.sub_mode_SET((char)102);
        p310.vendor_specific_status_code_SET((char)3699);
        CommunicationChannel.instance.send(p310); //===============================
        UAVCAN_NODE_INFO p311 = CommunicationChannel.instance.new_UAVCAN_NODE_INFO();
        PH.setPack(p311);
        p311.time_usec_SET(2169809254305164027L);
        p311.uptime_sec_SET(1632153713L);
        p311.name_SET("DEMO", PH);
        p311.hw_version_major_SET((char)40);
        p311.hw_version_minor_SET((char)252);
        p311.hw_unique_id_SET(new char[16], 0);
        p311.sw_version_major_SET((char)190);
        p311.sw_version_minor_SET((char)219);
        p311.sw_vcs_commit_SET(735422294L);
        CommunicationChannel.instance.send(p311); //===============================
        PARAM_EXT_REQUEST_READ p320 = CommunicationChannel.instance.new_PARAM_EXT_REQUEST_READ();
        PH.setPack(p320);
        p320.target_system_SET((char)246);
        p320.target_component_SET((char)195);
        p320.param_id_SET("DEMO", PH);
        p320.param_index_SET((short)3800);
        CommunicationChannel.instance.send(p320); //===============================
        PARAM_EXT_REQUEST_LIST p321 = CommunicationChannel.instance.new_PARAM_EXT_REQUEST_LIST();
        PH.setPack(p321);
        p321.target_system_SET((char)86);
        ...
        p322.param_count_SET((char)13676);
        p322.param_index_SET((char)45885);
        CommunicationChannel.instance.send(p322); //===============================
        PARAM_EXT_SET p323 = CommunicationChannel.instance.new_PARAM_EXT_SET();
        PH.setPack(p323);
        p323.target_system_SET((char)57);
        p323.target_component_SET((char)37);
        ...
        PH.setPack(p330);
        p330.time_usec_SET(6565461321055938208L);
        p330.sensor_type_SET(MAV_DISTANCE_SENSOR.MAV_DISTANCE_SENSOR_UNKNOWN);
        p330.distances_SET(new char[72], 0);
        p330.increment_SET((char)67);
        p330.min_distance_SET((char)398);
        p330.max_distance_SET((char)2113);
