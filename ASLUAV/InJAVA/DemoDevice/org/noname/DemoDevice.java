...
public class DemoDevice extends Host
{
    ...
    } public static class CHANGE_OPERATOR_CONTROL extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        ...
        } static final Meta meta = new Meta(5, 0, 0, 0, 4, 24, 0, _c);
...
//ke
        ...
        {key_SET(src.toCharArray(), 0, src.length(), ph);} public void key_SET(char[]  src, int pos, int items, Bounds.Inside ph) //ke
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(7, 0, 0, 0, 1, 0, 0, _P);
    ...
    } public static class PARAM_VALUE extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        ...
        } public void param_id_SET(String src, Bounds.Inside ph) {param_id_SET(src.toCharArray(), 0, src.length(), ph);} public void param_id_SET(char[]  src, int pos, int items, Bounds.Inside ph)
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(22, 2, 0, 0, 10, 68, 0, _r);
    } public static class PARAM_SET extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        ...
        } public void param_id_SET(String src, Bounds.Inside ph) {param_id_SET(src.toCharArray(), 0, src.length(), ph);} public void param_id_SET(char[]  src, int pos, int items, Bounds.Inside ph)
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(23, 0, 0, 0, 8, 52, 0, _z);
...
//Heading / track uncertainty in degrees * 1e5
        ...
        public void hdg_acc_SET(long  src, Bounds.Inside ph)//Heading / track uncertainty in degrees * 1e5
        {
            ...
            set_bytes((src) & -1L, 4, data,  ph.BYTE);
        } static final Meta meta = new Meta(24, 4, 0, 1, 31, 236, 0, _hI, _jI, _UI, _LI, _TI);
...
//Servo output 16 value, in microsecond
        ...
        public void servo16_raw_SET(char  src, Bounds.Inside ph)//Servo output 16 value, in microsecond
        {
            ...
            set_bytes((char)(src) & -1L, 2, data,  ph.BYTE);
        } static final Meta meta = new Meta(36, 8, 1, 0, 22, 168, 0, _DR, _hR, _jR, _UR, _LR, _TR, _ZR, _iR);
...
//Timestamp (microseconds since UNIX epoch or microseconds since system boot
        ...
        } static final Meta meta = new Meta(48, 0, 0, 0, 14, 104, 0, _qV);
...
//Timestamp (microseconds since UNIX epoch or microseconds since system boot
        ...
        public void time_usec_SET(long  src, Bounds.Inside ph)//Timestamp (microseconds since UNIX epoch or microseconds since system boot
        {
            ...
            set_bytes((src) & -1L, 8, data,  ph.BYTE);
        } static final Meta meta = new Meta(49, 0, 0, 0, 13, 96, 0, _wV);
    } public static class PARAM_MAP_RC extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        ...
        } public void param_id_SET(String src, Bounds.Inside ph) {param_id_SET(src.toCharArray(), 0, src.length(), ph);} public void param_id_SET(char[]  src, int pos, int items, Bounds.Inside ph)
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(50, 0, 0, 0, 22, 168, 0, _QV);
...
//WIP: Component which requested the command to be execute
        ...
        public void target_component_SET(char  src, Bounds.Inside ph)//WIP: Component which requested the command to be execute
        {
            ...
            set_bytes((char)(src) & -1L, 1, data,  ph.BYTE);
        } static final Meta meta = new Meta(77, 0, 0, 0, 3, 11, 0, _Gm, _Qm, _fm, _dm);
...
//Flow rate in radians/second about Y axi
        ...
        public void flow_rate_y_SET(float  src, Bounds.Inside ph)//Flow rate in radians/second about Y axi
        {
            ...
            set_bytes(Float.floatToIntBits(src) & -1L, 4, data, ph.BYTE);
        } static final Meta meta = new Meta(100, 0, 0, 1, 27, 208, 0, _Th, _Zh);
    ...
    } public static class AUTOPILOT_VERSION extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        ...
        } public void uid2_SET(char[]  src, int pos, Bounds.Inside ph)
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + 18; pos < src_max; pos++, BYTE += 1)
                set_bytes((char)(src[pos]) & -1L, 1, data,  BYTE);
        } static final Meta meta = new Meta(148, 2, 4, 1, 54, 421, 0, _Bq);
...
//Quaternion of landing target orientation (w, x, y, z order, zero-rotation is 1, 0, 0, 0
        ...
        public void position_valid_SET(char  src, Bounds.Inside ph)
        {
            ...
            set_bytes((char)(src) & -1L, 1, data,  ph.BYTE);
        } static final Meta meta = new Meta(149, 0, 0, 1, 31, 239, 0, _Tq, _Zq, _iq, _qq, _sq);
    } public static class SENS_POWER extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        SENS_POWER() { super(meta, 0); }
        SENS_POWER(int bytes) { super(meta, bytes); }
        public float adc121_vspb_volt_GET()//Power board voltage sensor reading in volt
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  0, 4))); }
        public void adc121_vspb_volt_SET(float  src) //Power board voltage sensor reading in volt
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 0); }
        public float adc121_cspb_amp_GET()//Power board current sensor reading in amp
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  4, 4))); }
        public void adc121_cspb_amp_SET(float  src) //Power board current sensor reading in amp
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 4); }
        public float adc121_cs1_amp_GET()//Board current sensor 1 reading in amp
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  8, 4))); }
        public void adc121_cs1_amp_SET(float  src) //Board current sensor 1 reading in amp
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 8); }
        public float adc121_cs2_amp_GET()//Board current sensor 2 reading in amp
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  12, 4))); }
        public void adc121_cs2_amp_SET(float  src) //Board current sensor 2 reading in amp
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 12); }
        static final Meta meta = new Meta(201, 0, 0, 0, 16, 128);
    } public static class SENS_MPPT extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        SENS_MPPT() { super(meta, 0); }
        SENS_MPPT(int bytes) { super(meta, bytes); }
        public char mppt1_pwm_GET()//MPPT1 pwm
        {  return (char)((char) get_bytes(data,  0, 2)); }
        public void mppt1_pwm_SET(char  src) //MPPT1 pwm
        {  set_bytes((char)(src) & -1L, 2, data,  0); }
        public char mppt2_pwm_GET()//MPPT2 pwm
        {  return (char)((char) get_bytes(data,  2, 2)); }
        public void mppt2_pwm_SET(char  src) //MPPT2 pwm
        {  set_bytes((char)(src) & -1L, 2, data,  2); }
        public char mppt3_pwm_GET()//MPPT3 pwm
        {  return (char)((char) get_bytes(data,  4, 2)); }
        public void mppt3_pwm_SET(char  src) //MPPT3 pwm
        {  set_bytes((char)(src) & -1L, 2, data,  4); }
        public long mppt_timestamp_GET()//MPPT last timestamp
        {  return (get_bytes(data,  6, 8)); }
        public void mppt_timestamp_SET(long  src) //MPPT last timestamp
        {  set_bytes((src) & -1L, 8, data,  6); }
        public float mppt1_volt_GET()//MPPT1 voltage
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  14, 4))); }
        public void mppt1_volt_SET(float  src) //MPPT1 voltage
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 14); }
        public float mppt1_amp_GET()//MPPT1 current
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  18, 4))); }
        public void mppt1_amp_SET(float  src) //MPPT1 current
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 18); }
        public char mppt1_status_GET()//MPPT1 status
        {  return (char)((char) get_bytes(data,  22, 1)); }
        public void mppt1_status_SET(char  src) //MPPT1 status
        {  set_bytes((char)(src) & -1L, 1, data,  22); }
        public float mppt2_volt_GET()//MPPT2 voltage
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  23, 4))); }
        public void mppt2_volt_SET(float  src) //MPPT2 voltage
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 23); }
        public float mppt2_amp_GET()//MPPT2 current
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  27, 4))); }
        public void mppt2_amp_SET(float  src) //MPPT2 current
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 27); }
        public char mppt2_status_GET()//MPPT2 status
        {  return (char)((char) get_bytes(data,  31, 1)); }
        public void mppt2_status_SET(char  src) //MPPT2 status
        {  set_bytes((char)(src) & -1L, 1, data,  31); }
        public float mppt3_volt_GET()//MPPT3 voltage
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  32, 4))); }
        public void mppt3_volt_SET(float  src) //MPPT3 voltage
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 32); }
        public float mppt3_amp_GET()//MPPT3 current
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  36, 4))); }
        public void mppt3_amp_SET(float  src) //MPPT3 current
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 36); }
        public char mppt3_status_GET()//MPPT3 status
        {  return (char)((char) get_bytes(data,  40, 1)); }
        public void mppt3_status_SET(char  src) //MPPT3 status
        {  set_bytes((char)(src) & -1L, 1, data,  40); }
        static final Meta meta = new Meta(202, 3, 0, 1, 41, 328);
    } public static class ASLCTRL_DATA extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        ASLCTRL_DATA() { super(meta, 0); }
        ASLCTRL_DATA(int bytes) { super(meta, bytes); }
        public long timestamp_GET()//Timestam
        {  return (get_bytes(data,  0, 8)); }
        public void timestamp_SET(long  src) //Timestam
        {  set_bytes((src) & -1L, 8, data,  0); }
        public char aslctrl_mode_GET()//ASLCTRL control-mode (manual, stabilized, auto, etc...
        {  return (char)((char) get_bytes(data,  8, 1)); }
        public void aslctrl_mode_SET(char  src) //ASLCTRL control-mode (manual, stabilized, auto, etc...
        {  set_bytes((char)(src) & -1L, 1, data,  8); }
        public float h_GET()//See sourcecode for a description of these values...
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  9, 4))); }
        public void h_SET(float  src) //See sourcecode for a description of these values...
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 9); }
        public float hRef_GET()//nul
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  13, 4))); }
        public void hRef_SET(float  src) //nul
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 13); }
        public float hRef_t_GET()//nul
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  17, 4))); }
        public void hRef_t_SET(float  src) //nul
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 17); }
        public float PitchAngle_GET()//Pitch angle [deg
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  21, 4))); }
        public void PitchAngle_SET(float  src) //Pitch angle [deg
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 21); }
        public float PitchAngleRef_GET()//Pitch angle reference[deg]
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  25, 4))); }
        public void PitchAngleRef_SET(float  src) //Pitch angle reference[deg]
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 25); }
        public float q_GET()//nul
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  29, 4))); }
        public void q_SET(float  src) //nul
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 29); }
        public float qRef_GET()//nul
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  33, 4))); }
        public void qRef_SET(float  src) //nul
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 33); }
        public float uElev_GET()//nul
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  37, 4))); }
        public void uElev_SET(float  src) //nul
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 37); }
        public float uThrot_GET()//nul
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  41, 4))); }
        public void uThrot_SET(float  src) //nul
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 41); }
        public float uThrot2_GET()//nul
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  45, 4))); }
        public void uThrot2_SET(float  src) //nul
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 45); }
        public float nZ_GET()//nul
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  49, 4))); }
        public void nZ_SET(float  src) //nul
        ...
        public void AirspeedRef_SET(float  src) //Airspeed reference [m/s
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 53); }
        public char SpoilersEngaged_GET()//nul
        {  return (char)((char) get_bytes(data,  57, 1)); }
        public void SpoilersEngaged_SET(char  src) //nul
        {  set_bytes((char)(src) & -1L, 1, data,  57); }
        public float YawAngle_GET()//Yaw angle [deg
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  58, 4))); }
        public void YawAngle_SET(float  src) //Yaw angle [deg
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 58); }
        public float YawAngleRef_GET()//Yaw angle reference[deg
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  62, 4))); }
        public void YawAngleRef_SET(float  src) //Yaw angle reference[deg
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 62); }
        public float RollAngle_GET()//Roll angle [deg
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  66, 4))); }
        public void RollAngle_SET(float  src) //Roll angle [deg
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 66); }
        public float RollAngleRef_GET()//Roll angle reference[deg
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  70, 4))); }
        public void RollAngleRef_SET(float  src) //Roll angle reference[deg
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 70); }
        public float p_GET()//nul
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  74, 4))); }
        public void p_SET(float  src) //nul
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 74); }
        public float pRef_GET()//nul
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  78, 4))); }
        public void pRef_SET(float  src) //nul
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 78); }
        public float r_GET()//nul
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  82, 4))); }
        public void r_SET(float  src) //nul
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 82); }
        public float rRef_GET()//nul
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  86, 4))); }
        public void rRef_SET(float  src) //nul
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 86); }
        public float uAil_GET()//nul
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  90, 4))); }
        public void uAil_SET(float  src) //nul
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 90); }
        public float uRud_GET()//nul
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  94, 4))); }
        public void uRud_SET(float  src) //nul
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 94); }
        static final Meta meta = new Meta(203, 0, 0, 1, 98, 784);
    } public static class ASLCTRL_DEBUG extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        ASLCTRL_DEBUG() { super(meta, 0); }
        ASLCTRL_DEBUG(int bytes) { super(meta, bytes); }
        public long i32_1_GET()//Debug dat
        {  return (get_bytes(data,  0, 4)); }
        public void i32_1_SET(long  src) //Debug dat
        {  set_bytes((src) & -1L, 4, data,  0); }
        public char i8_1_GET()//Debug dat
        {  return (char)((char) get_bytes(data,  4, 1)); }
        public void i8_1_SET(char  src) //Debug dat
        {  set_bytes((char)(src) & -1L, 1, data,  4); }
        public char i8_2_GET()//Debug dat
        {  return (char)((char) get_bytes(data,  5, 1)); }
        public void i8_2_SET(char  src) //Debug dat
        {  set_bytes((char)(src) & -1L, 1, data,  5); }
        public float f_1_GET()//Debug data
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  6, 4))); }
        public void f_1_SET(float  src) //Debug data
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 6); }
        public float f_2_GET()//Debug dat
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  10, 4))); }
        public void f_2_SET(float  src) //Debug dat
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 10); }
        public float f_3_GET()//Debug dat
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  14, 4))); }
        public void f_3_SET(float  src) //Debug dat
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 14); }
        public float f_4_GET()//Debug dat
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  18, 4))); }
        public void f_4_SET(float  src) //Debug dat
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 18); }
        public float f_5_GET()//Debug dat
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  22, 4))); }
        public void f_5_SET(float  src) //Debug dat
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 22); }
        public float f_6_GET()//Debug dat
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  26, 4))); }
        public void f_6_SET(float  src) //Debug dat
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 26); }
        public float f_7_GET()//Debug dat
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  30, 4))); }
        public void f_7_SET(float  src) //Debug dat
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 30); }
        public float f_8_GET()//Debug dat
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  34, 4))); }
        public void f_8_SET(float  src) //Debug dat
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 34); }
        static final Meta meta = new Meta(204, 0, 1, 0, 38, 304);
    } public static class ASLUAV_STATUS extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        ASLUAV_STATUS() { super(meta, 0); }
        ASLUAV_STATUS(int bytes) { super(meta, bytes); }
        public char LED_status_GET()//Status of the position-indicator LED
        {  return (char)((char) get_bytes(data,  0, 1)); }
        public void LED_status_SET(char  src) //Status of the position-indicator LED
        {  set_bytes((char)(src) & -1L, 1, data,  0); }
        public char SATCOM_status_GET()//Status of the IRIDIUM satellite communication syste
        {  return (char)((char) get_bytes(data,  1, 1)); }
        public void SATCOM_status_SET(char  src) //Status of the IRIDIUM satellite communication syste
        {  set_bytes((char)(src) & -1L, 1, data,  1); }
        public char[] Servo_status_GET(char[]  dst_ch, int pos)  //Status vector for up to 8 servo
        {
            for(int BYTE = 2, dst_max = pos + 8; pos < dst_max ; pos++,  BYTE += 1)
                dst_ch[pos] = (char)((char) get_bytes(data,  BYTE, 1));
            return dst_ch;
        }
        public char[] Servo_status_GET()//Status vector for up to 8 servo
        {return Servo_status_GET(new char[8], 0);} public void Servo_status_SET(char[]  src, int pos)  //Status vector for up to 8 servo
        {
        ...
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  10, 4))); }
        public void Motor_rpm_SET(float  src) //Motor RPM
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 10); }
        static final Meta meta = new Meta(205, 0, 0, 0, 14, 112);
    } public static class EKF_EXT extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        EKF_EXT() { super(meta, 0); }
        EKF_EXT(int bytes) { super(meta, bytes); }
        public long timestamp_GET()//Time since system start [us
        {  return (get_bytes(data,  0, 8)); }
        public void timestamp_SET(long  src) //Time since system start [us
        {  set_bytes((src) & -1L, 8, data,  0); }
        public float Windspeed_GET()//Magnitude of wind velocity (in lateral inertial plane) [m/s
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  8, 4))); }
        public void Windspeed_SET(float  src) //Magnitude of wind velocity (in lateral inertial plane) [m/s
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 8); }
        public float WindDir_GET()//Wind heading angle from North [rad
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  12, 4))); }
        public void WindDir_SET(float  src) //Wind heading angle from North [rad
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 12); }
        public float WindZ_GET()//Z (Down) component of inertial wind velocity [m/s
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  16, 4))); }
        public void WindZ_SET(float  src) //Z (Down) component of inertial wind velocity [m/s
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 16); }
        public float Airspeed_GET()//Magnitude of air velocity [m/s
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  20, 4))); }
        public void Airspeed_SET(float  src) //Magnitude of air velocity [m/s
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 20); }
        public float beta_GET()//Sideslip angle [rad
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  24, 4))); }
        public void beta_SET(float  src) //Sideslip angle [rad
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 24); }
        public float alpha_GET()//Angle of attack [rad
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  28, 4))); }
        public void alpha_SET(float  src) //Angle of attack [rad
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 28); }
        static final Meta meta = new Meta(206, 0, 0, 1, 32, 256);
    } public static class ASL_OBCTRL extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        ASL_OBCTRL() { super(meta, 0); }
        ASL_OBCTRL(int bytes) { super(meta, bytes); }
        public long timestamp_GET()//Time since system start [us
        {  return (get_bytes(data,  0, 8)); }
        public void timestamp_SET(long  src) //Time since system start [us
        {  set_bytes((src) & -1L, 8, data,  0); }
        ...
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  8, 4))); }
        public void uElev_SET(float  src) //Elevator command [~
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 8); }
        public float uThrot_GET()//Throttle command [~
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  12, 4))); }
        public void uThrot_SET(float  src) //Throttle command [~
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 12); }
        public float uThrot2_GET()//Throttle 2 command [~
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  16, 4))); }
        public void uThrot2_SET(float  src) //Throttle 2 command [~
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 16); }
        public float uAilL_GET()//Left aileron command [~
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  20, 4))); }
        public void uAilL_SET(float  src) //Left aileron command [~
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 20); }
        public float uAilR_GET()//Right aileron command [~
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  24, 4))); }
        public void uAilR_SET(float  src) //Right aileron command [~
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 24); }
        public float uRud_GET()//Rudder command [~
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  28, 4))); }
        public void uRud_SET(float  src) //Rudder command [~
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 28); }
        public char obctrl_status_GET()//Off-board computer statu
        {  return (char)((char) get_bytes(data,  32, 1)); }
        public void obctrl_status_SET(char  src) //Off-board computer statu
        {  set_bytes((char)(src) & -1L, 1, data,  32); }
        static final Meta meta = new Meta(207, 0, 0, 1, 33, 264);
    } public static class SENS_ATMOS extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        SENS_ATMOS() { super(meta, 0); }
        SENS_ATMOS(int bytes) { super(meta, bytes); }
        public float TempAmbient_GET()//Ambient temperature [degrees Celsius
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  0, 4))); }
        public void TempAmbient_SET(float  src) //Ambient temperature [degrees Celsius
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 0); }
        public float Humidity_GET()//Relative humidity [%
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  4, 4))); }
        public void Humidity_SET(float  src) //Relative humidity [%
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 4); }
        static final Meta meta = new Meta(208, 0, 0, 0, 8, 64);
    } public static class SENS_BATMON extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        SENS_BATMON() { super(meta, 0); }
        SENS_BATMON(int bytes) { super(meta, bytes); }
        public char voltage_GET()//Battery pack voltage in [mV
        {  return (char)((char) get_bytes(data,  0, 2)); }
        public void voltage_SET(char  src) //Battery pack voltage in [mV
        {  set_bytes((char)(src) & -1L, 2, data,  0); }
        public char batterystatus_GET()//Battery monitor status report bits in He
        {  return (char)((char) get_bytes(data,  2, 2)); }
        public void batterystatus_SET(char  src) //Battery monitor status report bits in He
        {  set_bytes((char)(src) & -1L, 2, data,  2); }
        public char serialnumber_GET()//Battery monitor serial number in He
        {  return (char)((char) get_bytes(data,  4, 2)); }
        public void serialnumber_SET(char  src) //Battery monitor serial number in He
        {  set_bytes((char)(src) & -1L, 2, data,  4); }
        public char hostfetcontrol_GET()//Battery monitor sensor host FET control in He
        {  return (char)((char) get_bytes(data,  6, 2)); }
        public void hostfetcontrol_SET(char  src) //Battery monitor sensor host FET control in He
        {  set_bytes((char)(src) & -1L, 2, data,  6); }
        public char cellvoltage1_GET()//Battery pack cell 1 voltage in [mV
        {  return (char)((char) get_bytes(data,  8, 2)); }
        public void cellvoltage1_SET(char  src) //Battery pack cell 1 voltage in [mV
        {  set_bytes((char)(src) & -1L, 2, data,  8); }
        public char cellvoltage2_GET()//Battery pack cell 2 voltage in [mV
        {  return (char)((char) get_bytes(data,  10, 2)); }
        public void cellvoltage2_SET(char  src) //Battery pack cell 2 voltage in [mV
        {  set_bytes((char)(src) & -1L, 2, data,  10); }
        public char cellvoltage3_GET()//Battery pack cell 3 voltage in [mV
        {  return (char)((char) get_bytes(data,  12, 2)); }
        public void cellvoltage3_SET(char  src) //Battery pack cell 3 voltage in [mV
        {  set_bytes((char)(src) & -1L, 2, data,  12); }
        public char cellvoltage4_GET()//Battery pack cell 4 voltage in [mV
        {  return (char)((char) get_bytes(data,  14, 2)); }
        public void cellvoltage4_SET(char  src) //Battery pack cell 4 voltage in [mV
        {  set_bytes((char)(src) & -1L, 2, data,  14); }
        public char cellvoltage5_GET()//Battery pack cell 5 voltage in [mV
        {  return (char)((char) get_bytes(data,  16, 2)); }
        public void cellvoltage5_SET(char  src) //Battery pack cell 5 voltage in [mV
        {  set_bytes((char)(src) & -1L, 2, data,  16); }
        public char cellvoltage6_GET()//Battery pack cell 6 voltage in [mV
        {  return (char)((char) get_bytes(data,  18, 2)); }
        public void cellvoltage6_SET(char  src) //Battery pack cell 6 voltage in [mV
        {  set_bytes((char)(src) & -1L, 2, data,  18); }
        public float temperature_GET()//Battery pack temperature in [deg C
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  20, 4))); }
        public void temperature_SET(float  src) //Battery pack temperature in [deg C
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 20); }
        public short current_GET()//Battery pack current in [mA
        {  return (short)((short) get_bytes(data,  24, 2)); }
        public void current_SET(short  src) //Battery pack current in [mA
        {  set_bytes((short)(src) & -1L, 2, data,  24); }
        public char SoC_GET()//Battery pack state-of-charg
        {  return (char)((char) get_bytes(data,  26, 1)); }
        public void SoC_SET(char  src) //Battery pack state-of-charg
        {  set_bytes((char)(src) & -1L, 1, data,  26); }
        static final Meta meta = new Meta(209, 10, 0, 0, 27, 216);
    } public static class FW_SOARING_DATA extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        FW_SOARING_DATA() { super(meta, 0); }
        FW_SOARING_DATA(int bytes) { super(meta, bytes); }
        public long timestamp_GET()//Timestamp [ms
        {  return (get_bytes(data,  0, 8)); }
        public void timestamp_SET(long  src) //Timestamp [ms
        {  set_bytes((src) & -1L, 8, data,  0); }
        public long timestampModeChanged_GET()//Timestamp since last mode change[ms
        {  return (get_bytes(data,  8, 8)); }
        public void timestampModeChanged_SET(long  src) //Timestamp since last mode change[ms
        {  set_bytes((src) & -1L, 8, data,  8); }
        public float xW_GET()//Thermal core updraft strength [m/s
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  16, 4))); }
        public void xW_SET(float  src) //Thermal core updraft strength [m/s
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 16); }
        public float xR_GET()//Thermal radius [m
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  20, 4))); }
        public void xR_SET(float  src) //Thermal radius [m
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 20); }
        public float xLat_GET()//Thermal center latitude [deg
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  24, 4))); }
        public void xLat_SET(float  src) //Thermal center latitude [deg
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 24); }
        public float xLon_GET()//Thermal center longitude [deg
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  28, 4))); }
        public void xLon_SET(float  src) //Thermal center longitude [deg
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 28); }
        public float VarW_GET()//Variance
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  32, 4))); }
        public void VarW_SET(float  src) //Variance
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 32); }
        public float VarR_GET()//Variance
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  36, 4))); }
        public void VarR_SET(float  src) //Variance
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 36); }
        public float VarLat_GET()//Variance La
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  40, 4))); }
        public void VarLat_SET(float  src) //Variance La
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 40); }
        public float VarLon_GET()//Variance Lon
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  44, 4))); }
        public void VarLon_SET(float  src) //Variance Lon
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 44); }
        public float LoiterRadius_GET()//Suggested loiter radius [m
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  48, 4))); }
        public void LoiterRadius_SET(float  src) //Suggested loiter radius [m
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 48); }
        public float LoiterDirection_GET()//Suggested loiter directio
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  52, 4))); }
        public void LoiterDirection_SET(float  src) //Suggested loiter directio
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 52); }
        public float DistToSoarPoint_GET()//Distance to soar point [m
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  56, 4))); }
        public void DistToSoarPoint_SET(float  src) //Distance to soar point [m
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 56); }
        public float vSinkExp_GET()//Expected sink rate at current airspeed, roll and throttle [m/s
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  60, 4))); }
        public void vSinkExp_SET(float  src) //Expected sink rate at current airspeed, roll and throttle [m/s
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 60); }
        public float z1_LocalUpdraftSpeed_GET()//Measurement / updraft speed at current/local airplane position [m/s
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  64, 4))); }
        public void z1_LocalUpdraftSpeed_SET(float  src) //Measurement / updraft speed at current/local airplane position [m/s
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 64); }
        public float z2_DeltaRoll_GET()//Measurement / roll angle tracking error [deg
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  68, 4))); }
        public void z2_DeltaRoll_SET(float  src) //Measurement / roll angle tracking error [deg
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 68); }
        public float z1_exp_GET()//Expected measurement
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  72, 4))); }
        public void z1_exp_SET(float  src) //Expected measurement
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 72); }
        public float z2_exp_GET()//Expected measurement
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  76, 4))); }
        public void z2_exp_SET(float  src) //Expected measurement
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 76); }
        public float ThermalGSNorth_GET()//Thermal drift (from estimator prediction step only) [m/s
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  80, 4))); }
        public void ThermalGSNorth_SET(float  src) //Thermal drift (from estimator prediction step only) [m/s
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 80); }
        ...
        public void ThermalGSEast_SET(float  src) //Thermal drift (from estimator prediction step only) [m/s
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 84); }
        public float TSE_dot_GET()//Total specific energy change (filtered) [m/s
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  88, 4))); }
        public void TSE_dot_SET(float  src) //Total specific energy change (filtered) [m/s
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 88); }
        public float DebugVar1_GET()//Debug variable
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  92, 4))); }
        public void DebugVar1_SET(float  src) //Debug variable
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 92); }
        public float DebugVar2_GET()//Debug variable
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  96, 4))); }
        public void DebugVar2_SET(float  src) //Debug variable
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 96); }
        public char ControlMode_GET()//Control Mode [-
        {  return (char)((char) get_bytes(data,  100, 1)); }
        public void ControlMode_SET(char  src) //Control Mode [-
        {  set_bytes((char)(src) & -1L, 1, data,  100); }
        public char valid_GET()//Data valid [-
        {  return (char)((char) get_bytes(data,  101, 1)); }
        public void valid_SET(char  src) //Data valid [-
        {  set_bytes((char)(src) & -1L, 1, data,  101); }
        static final Meta meta = new Meta(210, 0, 0, 2, 102, 816);
    } public static class SENSORPOD_STATUS extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        SENSORPOD_STATUS() { super(meta, 0); }
        SENSORPOD_STATUS(int bytes) { super(meta, bytes); }
        public char free_space_GET()//Free space available in recordings directory in [Gb] * 1e
        {  return (char)((char) get_bytes(data,  0, 2)); }
        public void free_space_SET(char  src) //Free space available in recordings directory in [Gb] * 1e
        {  set_bytes((char)(src) & -1L, 2, data,  0); }
        public long timestamp_GET()//Timestamp in linuxtime [ms] (since 1.1.1970
        {  return (get_bytes(data,  2, 8)); }
        public void timestamp_SET(long  src) //Timestamp in linuxtime [ms] (since 1.1.1970
        {  set_bytes((src) & -1L, 8, data,  2); }
        public char visensor_rate_1_GET()//Rate of ROS topic
        {  return (char)((char) get_bytes(data,  10, 1)); }
        public void visensor_rate_1_SET(char  src) //Rate of ROS topic
        {  set_bytes((char)(src) & -1L, 1, data,  10); }
        public char visensor_rate_2_GET()//Rate of ROS topic
        {  return (char)((char) get_bytes(data,  11, 1)); }
        public void visensor_rate_2_SET(char  src) //Rate of ROS topic
        {  set_bytes((char)(src) & -1L, 1, data,  11); }
        public char visensor_rate_3_GET()//Rate of ROS topic
        {  return (char)((char) get_bytes(data,  12, 1)); }
        public void visensor_rate_3_SET(char  src) //Rate of ROS topic
        {  set_bytes((char)(src) & -1L, 1, data,  12); }
        public char visensor_rate_4_GET()//Rate of ROS topic
        {  return (char)((char) get_bytes(data,  13, 1)); }
        public void visensor_rate_4_SET(char  src) //Rate of ROS topic
        {  set_bytes((char)(src) & -1L, 1, data,  13); }
        public char recording_nodes_count_GET()//Number of recording node
        {  return (char)((char) get_bytes(data,  14, 1)); }
        public void recording_nodes_count_SET(char  src) //Number of recording node
        {  set_bytes((char)(src) & -1L, 1, data,  14); }
        public char cpu_temp_GET()//Temperature of sensorpod CPU in [deg C
        {  return (char)((char) get_bytes(data,  15, 1)); }
        public void cpu_temp_SET(char  src) //Temperature of sensorpod CPU in [deg C
        {  set_bytes((char)(src) & -1L, 1, data,  15); }
        static final Meta meta = new Meta(211, 1, 0, 1, 16, 128);
    } public static class SENS_POWER_BOARD extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        SENS_POWER_BOARD() { super(meta, 0); }
        SENS_POWER_BOARD(int bytes) { super(meta, bytes); }
        public long timestamp_GET()//Timestam
        {  return (get_bytes(data,  0, 8)); }
        public void timestamp_SET(long  src) //Timestam
        {  set_bytes((src) & -1L, 8, data,  0); }
        public char pwr_brd_status_GET()//Power board status registe
        {  return (char)((char) get_bytes(data,  8, 1)); }
        public void pwr_brd_status_SET(char  src) //Power board status registe
        {  set_bytes((char)(src) & -1L, 1, data,  8); }
        public char pwr_brd_led_status_GET()//Power board leds statu
        {  return (char)((char) get_bytes(data,  9, 1)); }
        public void pwr_brd_led_status_SET(char  src) //Power board leds statu
        {  set_bytes((char)(src) & -1L, 1, data,  9); }
        public float pwr_brd_system_volt_GET()//Power board system voltag
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  10, 4))); }
        public void pwr_brd_system_volt_SET(float  src) //Power board system voltag
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 10); }
        public float pwr_brd_servo_volt_GET()//Power board servo voltag
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  14, 4))); }
        public void pwr_brd_servo_volt_SET(float  src) //Power board servo voltag
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 14); }
        public float pwr_brd_mot_l_amp_GET()//Power board left motor current senso
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  18, 4))); }
        public void pwr_brd_mot_l_amp_SET(float  src) //Power board left motor current senso
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 18); }
        public float pwr_brd_mot_r_amp_GET()//Power board right motor current senso
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  22, 4))); }
        public void pwr_brd_mot_r_amp_SET(float  src) //Power board right motor current senso
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 22); }
        public float pwr_brd_servo_1_amp_GET()//Power board servo1 current senso
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  26, 4))); }
        public void pwr_brd_servo_1_amp_SET(float  src) //Power board servo1 current senso
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 26); }
        public float pwr_brd_servo_2_amp_GET()//Power board servo1 current senso
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  30, 4))); }
        public void pwr_brd_servo_2_amp_SET(float  src) //Power board servo1 current senso
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 30); }
        public float pwr_brd_servo_3_amp_GET()//Power board servo1 current senso
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  34, 4))); }
        public void pwr_brd_servo_3_amp_SET(float  src) //Power board servo1 current senso
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 34); }
        public float pwr_brd_servo_4_amp_GET()//Power board servo1 current senso
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  38, 4))); }
        public void pwr_brd_servo_4_amp_SET(float  src) //Power board servo1 current senso
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 38); }
        public float pwr_brd_aux_amp_GET()//Power board aux current senso
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  42, 4))); }
        public void pwr_brd_aux_amp_SET(float  src) //Power board aux current senso
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 42); }
        static final Meta meta = new Meta(212, 0, 0, 1, 46, 368);
...
//Timestamp (microseconds since UNIX epoch or microseconds since system boot
        ...
        public void time_usec_SET(long  src, Bounds.Inside ph)//Timestamp (microseconds since UNIX epoch or microseconds since system boot
        {
            ...
            set_bytes((src) & -1L, 8, data,  ph.BYTE);
        } static final Meta meta = new Meta(242, 0, 0, 0, 53, 416, 0, _zn);
...
//Timestamp (microseconds since UNIX epoch or microseconds since system boot
        ...
        public void time_usec_SET(long  src, Bounds.Inside ph)//Timestamp (microseconds since UNIX epoch or microseconds since system boot
        {
            ...
            set_bytes((src) & -1L, 8, data,  ph.BYTE);
        } static final Meta meta = new Meta(243, 0, 0, 0, 54, 424, 0, _Ds);
...
//The callsign, 8+nul
        ...
        {callsign_SET(src.toCharArray(), 0, src.length(), ph);} public void callsign_SET(char[]  src, int pos, int items, Bounds.Inside ph) //The callsign, 8+nul
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(246, 3, 1, 0, 28, 210, 0, _Os);
...
//Nam
        ...
        {name_SET(src.toCharArray(), 0, src.length(), ph);} public void name_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Nam
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(250, 0, 0, 1, 21, 160, 0, _Ms);
...
//Name of the debug variabl
        ...
        {name_SET(src.toCharArray(), 0, src.length(), ph);} public void name_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Name of the debug variabl
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(251, 0, 1, 0, 9, 64, 0, _zs);
...
//Name of the debug variabl
        ...
        {name_SET(src.toCharArray(), 0, src.length(), ph);} public void name_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Name of the debug variabl
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(252, 0, 1, 0, 9, 64, 0, _Kt);
...
//Status text message, without null termination characte
        ...
        {text_SET(src.toCharArray(), 0, src.length(), ph);} public void text_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Status text message, without null termination characte
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(253, 0, 0, 0, 2, 4, 0, _Rt);
...
//tune in board specific forma
        ...
        {tune_SET(src.toCharArray(), 0, src.length(), ph);} public void tune_SET(char[]  src, int pos, int items, Bounds.Inside ph) //tune in board specific forma
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(258, 0, 0, 0, 3, 16, 0, _it);
...
//Camera definition URI (if any, otherwise only basic functions will be available)
        ...
        {cam_definition_uri_SET(src.toCharArray(), 0, src.length(), ph);} public void cam_definition_uri_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Camera definition URI (if any, otherwise only basic functions will be available)
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(259, 3, 2, 0, 93, 731, 0, _gt);
...
//foo.jpg if camera provides an HTTP interface
        ...
        {file_url_SET(src.toCharArray(), 0, src.length(), ph);} public void file_url_SET(char[]  src, int pos, int items, Bounds.Inside ph) //foo.jpg if camera provides an HTTP interface
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(263, 0, 1, 1, 51, 402, 2, _Bw);
...
//Video stream UR
        ...
        {uri_SET(src.toCharArray(), 0, src.length(), ph);} public void uri_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Video stream UR
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(269, 3, 1, 0, 17, 130, 2, _ew);
...
//Video stream UR
        ...
        {uri_SET(src.toCharArray(), 0, src.length(), ph);} public void uri_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Video stream UR
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(270, 3, 1, 0, 18, 138, 2, _pw);
...
//Password. Leave it blank for an open AP
        ...
        {password_SET(src.toCharArray(), 0, src.length(), ph);} public void password_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Password. Leave it blank for an open AP
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(299, 0, 0, 0, 1, 2, 2, _Cw, _Fw);
...
//Node name string. For example, "sapog.px4.io"
        ...
        {name_SET(src.toCharArray(), 0, src.length(), ph);} public void name_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Node name string. For example, "sapog.px4.io"
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(311, 0, 2, 1, 37, 288, 0, _DO);
    } public static class PARAM_EXT_REQUEST_READ extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        ...
        } public void param_id_SET(String src, Bounds.Inside ph) {param_id_SET(src.toCharArray(), 0, src.length(), ph);} public void param_id_SET(char[]  src, int pos, int items, Bounds.Inside ph)
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(320, 0, 0, 0, 5, 32, 0, _nO);
...
//Parameter valu
        ...
        {param_value_SET(src.toCharArray(), 0, src.length(), ph);} public void param_value_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Parameter valu
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(322, 2, 0, 0, 5, 38, 2, _OO, _GO);
...
//Parameter valu
        ...
        {param_value_SET(src.toCharArray(), 0, src.length(), ph);} public void param_value_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Parameter valu
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(323, 0, 0, 0, 3, 22, 2, _gO, _uO);
...
//Parameter value (new value if PARAM_ACK_ACCEPTED, current value otherwise
        ...
        {param_value_SET(src.toCharArray(), 0, src.length(), ph);} public void param_value_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Parameter value (new value if PARAM_ACK_ACCEPTED, current value otherwise
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(324, 0, 0, 0, 2, 9, 2, _PO, _lO);
    ...
    public static class LoopBackDemoChannel  extends Channel
    {
            ...
            for(boolean LOOP = false; ;)
            {
                switch(id)
                {
                    ...
                    case 201:
                        ...
                        final SENS_POWER pi201 = (SENS_POWER) pack;
                        ph.setPack(pi201);
                        on_SENS_POWER.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi201));
                        if(LOOP) break;
                        return null;
                    case 202:
                        if(pack == null) return new SENS_MPPT();
                        final SENS_MPPT pi202 = (SENS_MPPT) pack;
                        ph.setPack(pi202);
                        on_SENS_MPPT.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi202));
                        if(LOOP) break;
                        return null;
                    case 203:
                        if(pack == null) return new ASLCTRL_DATA();
                        final ASLCTRL_DATA pi203 = (ASLCTRL_DATA) pack;
                        ph.setPack(pi203);
                        on_ASLCTRL_DATA.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi203));
                        if(LOOP) break;
                        return null;
                    case 204:
                        if(pack == null) return new ASLCTRL_DEBUG();
                        final ASLCTRL_DEBUG pi204 = (ASLCTRL_DEBUG) pack;
                        ph.setPack(pi204);
                        on_ASLCTRL_DEBUG.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi204));
                        if(LOOP) break;
                        return null;
                    case 205:
                        if(pack == null) return new ASLUAV_STATUS();
                        final ASLUAV_STATUS pi205 = (ASLUAV_STATUS) pack;
                        ph.setPack(pi205);
                        on_ASLUAV_STATUS.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi205));
                        if(LOOP) break;
                        return null;
                    case 206:
                        if(pack == null) return new EKF_EXT();
                        final EKF_EXT pi206 = (EKF_EXT) pack;
                        ph.setPack(pi206);
                        on_EKF_EXT.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi206));
                        if(LOOP) break;
                        return null;
                    case 207:
                        if(pack == null) return new ASL_OBCTRL();
                        final ASL_OBCTRL pi207 = (ASL_OBCTRL) pack;
                        ph.setPack(pi207);
                        on_ASL_OBCTRL.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi207));
                        if(LOOP) break;
                        return null;
                    case 208:
                        if(pack == null) return new SENS_ATMOS();
                        final SENS_ATMOS pi208 = (SENS_ATMOS) pack;
                        ph.setPack(pi208);
                        on_SENS_ATMOS.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi208));
                        if(LOOP) break;
                        return null;
                    case 209:
                        if(pack == null) return new SENS_BATMON();
                        final SENS_BATMON pi209 = (SENS_BATMON) pack;
                        ph.setPack(pi209);
                        on_SENS_BATMON.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi209));
                        if(LOOP) break;
                        return null;
                    case 210:
                        if(pack == null) return new FW_SOARING_DATA();
                        final FW_SOARING_DATA pi210 = (FW_SOARING_DATA) pack;
                        ph.setPack(pi210);
                        on_FW_SOARING_DATA.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi210));
                        if(LOOP) break;
                        return null;
                    case 211:
                        if(pack == null) return new SENSORPOD_STATUS();
                        final SENSORPOD_STATUS pi211 = (SENSORPOD_STATUS) pack;
                        ph.setPack(pi211);
                        on_SENSORPOD_STATUS.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi211));
                        if(LOOP) break;
                        return null;
                    case 212:
                        if(pack == null) return new SENS_POWER_BOARD();
                        final SENS_POWER_BOARD pi212 = (SENS_POWER_BOARD) pack;
                        ph.setPack(pi212);
                        on_SENS_POWER_BOARD.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi212));
                        if(LOOP) break;
                        return null;
                    case 230:
        ...
        public final Collection<OnReceive.Handler<SENS_POWER, LoopBackDemoChannel>> on_SENS_POWER = new OnReceive<>();
        public final Collection<OnReceive.Handler<SENS_MPPT, LoopBackDemoChannel>> on_SENS_MPPT = new OnReceive<>();
        public final Collection<OnReceive.Handler<ASLCTRL_DATA, LoopBackDemoChannel>> on_ASLCTRL_DATA = new OnReceive<>();
        public final Collection<OnReceive.Handler<ASLCTRL_DEBUG, LoopBackDemoChannel>> on_ASLCTRL_DEBUG = new OnReceive<>();
        public final Collection<OnReceive.Handler<ASLUAV_STATUS, LoopBackDemoChannel>> on_ASLUAV_STATUS = new OnReceive<>();
        public final Collection<OnReceive.Handler<EKF_EXT, LoopBackDemoChannel>> on_EKF_EXT = new OnReceive<>();
        public final Collection<OnReceive.Handler<ASL_OBCTRL, LoopBackDemoChannel>> on_ASL_OBCTRL = new OnReceive<>();
        public final Collection<OnReceive.Handler<SENS_ATMOS, LoopBackDemoChannel>> on_SENS_ATMOS = new OnReceive<>();
        public final Collection<OnReceive.Handler<SENS_BATMON, LoopBackDemoChannel>> on_SENS_BATMON = new OnReceive<>();
        public final Collection<OnReceive.Handler<FW_SOARING_DATA, LoopBackDemoChannel>> on_FW_SOARING_DATA = new OnReceive<>();
        public final Collection<OnReceive.Handler<SENSORPOD_STATUS, LoopBackDemoChannel>> on_SENSORPOD_STATUS = new OnReceive<>();
        public final Collection<OnReceive.Handler<SENS_POWER_BOARD, LoopBackDemoChannel>> on_SENS_POWER_BOARD = new OnReceive<>();
    ...
    private static final Field _P = new Field(5, true, -6, 2, 1, 0, 0, 0, 1);
    ...
    private static final Field _hI = new Field(0, false, 1, 4, 1, 0, 0, 0);
    private static final Field _jI = new Field(0, true, 1, 4, 1, 0, 0, 0);
    private static final Field _UI = new Field(0, true, 1, 4, 1, 0, 0, 0);
    private static final Field _LI = new Field(0, true, 1, 4, 1, 0, 0, 0);
    private static final Field _TI = new Field(0, true, 1, 4, 1, 0, 0, 0);
    private static final Field _DR = new Field(0, true, 1, 2, 1, 0, 0, 0);
    private static final Field _hR = new Field(0, true, 1, 2, 1, 0, 0, 0);
    private static final Field _jR = new Field(0, true, 1, 2, 1, 0, 0, 0);
    private static final Field _UR = new Field(0, true, 1, 2, 1, 0, 0, 0);
    private static final Field _LR = new Field(0, true, 1, 2, 1, 0, 0, 0);
    private static final Field _TR = new Field(0, true, 1, 2, 1, 0, 0, 0);
    private static final Field _ZR = new Field(0, true, 1, 2, 1, 0, 0, 0);
    private static final Field _iR = new Field(0, true, 1, 2, 1, 0, 0, 0);
    private static final Field _qV = new Field(0, true, 1, 8, 1, 0, 0, 0);
    private static final Field _wV = new Field(0, true, 1, 8, 1, 0, 0, 0);
    private static final Field _QV = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
    private static final Field _Gm = new Field(0, false, 1, 1, 1, 0, 0, 0);
    private static final Field _Qm = new Field(0, false, 1, 4, 1, 0, 0, 0);
    private static final Field _fm = new Field(0, false, 1, 1, 1, 0, 0, 0);
    private static final Field _dm = new Field(0, false, 1, 1, 1, 0, 0, 0);
    private static final Field _Th = new Field(0, false, 1, 4, 1, 0, 0, 0);
    private static final Field _Zh = new Field(0, false, 1, 4, 1, 0, 0, 0);
    private static final Field _Bq = new Field(0, false, 18, 1, 1, 0, 0, 0);
    private static final Field _Tq = new Field(0, false, 1, 4, 1, 0, 0, 0);
    private static final Field _Zq = new Field(0, false, 1, 4, 1, 0, 0, 0);
    private static final Field _iq = new Field(0, false, 1, 4, 1, 0, 0, 0);
    private static final Field _qq = new Field(0, false, 4, 4, 1, 0, 0, 0);
    private static final Field _sq = new Field(0, false, 1, 1, 1, 0, 0, 0);
    private static final Field _zn = new Field(0, true, 1, 8, 1, 0, 0, 0);
    private static final Field _Ds = new Field(0, true, 1, 8, 1, 0, 0, 0);
    private static final Field _Os = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
    private static final Field _Ms = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
    private static final Field _zs = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
    private static final Field _Kt = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
    private static final Field _Rt = new Field(5, true, -6, 2, 1, 0, 0, 0, 1);
    private static final Field _it = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
    private static final Field _gt = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
    private static final Field _Bw = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
    private static final Field _ew = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
    private static final Field _pw = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
    private static final Field _Cw = new Field(5, true, -6, 2, 1, 0, 0, 0, 1);
    private static final Field _Fw = new Field(5, true, -7, 2, 1, 0, 0, 0, 1);
    private static final Field _DO = new Field(5, true, -7, 2, 1, 0, 0, 0, 1);
    private static final Field _nO = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
    private static final Field _OO = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
    private static final Field _GO = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
    private static final Field _gO = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
