...
inline static e_MAV_MODE _en__r(UMAX id)
{
    switch(id)
    {
        case 0:
...
inline static UMAX _id__r(e_MAV_MODE en)
{
    switch(en)
    {
...
inline static UMAX _id__T(e_MAV_CMD en)
{
    switch(en)
    {
...
{
    uint8_t * data = src->data;
    return  _en__r(get_bits(data, 328, 4));
}
...
{
    uint8_t * data = src->data;
    return  _en__r(get_bits(data, 640, 4));
}
