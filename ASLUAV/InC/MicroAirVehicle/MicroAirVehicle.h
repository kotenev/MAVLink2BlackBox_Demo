...
extern void c_CommunicationChannel_on_SENS_POWER_201(Bounds_Inside * bi, Pack * pack);
/**
*Maximum Power Point Tracker (MPPT) sensor data for solar module power performance tracking*/
extern void c_CommunicationChannel_on_SENS_MPPT_202(Bounds_Inside * bi, Pack * pack);
/**
*ASL-fixed-wing controller data*/
extern void c_CommunicationChannel_on_ASLCTRL_DATA_203(Bounds_Inside * bi, Pack * pack);
/**
*ASL-fixed-wing controller debug data*/
extern void c_CommunicationChannel_on_ASLCTRL_DEBUG_204(Bounds_Inside * bi, Pack * pack);
/**
*Extended state information for ASLUAVs*/
extern void c_CommunicationChannel_on_ASLUAV_STATUS_205(Bounds_Inside * bi, Pack * pack);
/**
*Extended EKF state estimates for ASLUAVs*/
extern void c_CommunicationChannel_on_EKF_EXT_206(Bounds_Inside * bi, Pack * pack);
/**
*Off-board controls/commands for ASLUAVs*/
extern void c_CommunicationChannel_on_ASL_OBCTRL_207(Bounds_Inside * bi, Pack * pack);
/**
*Atmospheric sensors (temperature, humidity, ...)*/
extern void c_CommunicationChannel_on_SENS_ATMOS_208(Bounds_Inside * bi, Pack * pack);
/**
*Battery pack monitoring data for Li-Ion batteries*/
extern void c_CommunicationChannel_on_SENS_BATMON_209(Bounds_Inside * bi, Pack * pack);
/**
*Fixed-wing soaring (i.e. thermal seeking) data*/
extern void c_CommunicationChannel_on_FW_SOARING_DATA_210(Bounds_Inside * bi, Pack * pack);
/**
*Monitoring of sensorpod status*/
extern void c_CommunicationChannel_on_SENSORPOD_STATUS_211(Bounds_Inside * bi, Pack * pack);
/**
*Monitoring of power board status*/
extern void c_CommunicationChannel_on_SENS_POWER_BOARD_212(Bounds_Inside * bi, Pack * pack);
/**
...
inline static e_MAV_MODE _en__D(UMAX id)
{
    switch(id)
    {
        case 0:
...
inline static UMAX _id__D(e_MAV_MODE en)
{
    switch(en)
    {
...
inline static e_MAV_MISSION_TYPE _en__g(UMAX id)
{
    switch(id)
    {
        case 0:
...
inline static UMAX _id__g(e_MAV_MISSION_TYPE en)
{
    switch(en)
    {
...
inline static e_MAV_CMD _en__M(UMAX id)
{
    switch(id)
    {
        case 0:
...
inline static UMAX _id__M(e_MAV_CMD en)
{
    switch(en)
    {
...
{
    uint8_t * data = src->data;
    return  _en__D(get_bits(data, 328, 4));
}
...
{
    uint8_t * data = src->data;
    return  _en__D(get_bits(data, 640, 4));
}
...
INLINER float p201_adc121_vspb_volt_GET(Pack * src)//Power board voltage sensor reading in volts
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  0, 4)));
}
INLINER float p201_adc121_cspb_amp_GET(Pack * src)//Power board current sensor reading in amps
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  4, 4)));
}
INLINER float p201_adc121_cs1_amp_GET(Pack * src)//Board current sensor 1 reading in amps
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  8, 4)));
}
INLINER float p201_adc121_cs2_amp_GET(Pack * src)//Board current sensor 2 reading in amps
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  12, 4)));
}
...
INLINER uint64_t p203_timestamp_GET(Pack * src)//Timestamp
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  0, 8)));
}
...
INLINER float p203_hRef_GET(Pack * src)//null
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  13, 4)));
}
INLINER float p203_hRef_t_GET(Pack * src)//null
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  17, 4)));
}
...
INLINER float p203_q_GET(Pack * src)//null
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  29, 4)));
}
INLINER float p203_qRef_GET(Pack * src)//null
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  33, 4)));
}
INLINER float p203_uElev_GET(Pack * src)//null
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  37, 4)));
}
INLINER float p203_uThrot_GET(Pack * src)//null
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  41, 4)));
}
INLINER float p203_uThrot2_GET(Pack * src)//null
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  45, 4)));
}
INLINER float p203_nZ_GET(Pack * src)//null
{
    uint8_t * data = src->data;
...
INLINER uint8_t p203_SpoilersEngaged_GET(Pack * src)//null
{
    uint8_t * data = src->data;
...
INLINER float p203_p_GET(Pack * src)//null
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  74, 4)));
}
INLINER float p203_pRef_GET(Pack * src)//null
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  78, 4)));
}
INLINER float p203_r_GET(Pack * src)//null
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  82, 4)));
}
INLINER float p203_rRef_GET(Pack * src)//null
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  86, 4)));
}
INLINER float p203_uAil_GET(Pack * src)//null
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  90, 4)));
}
INLINER float p203_uRud_GET(Pack * src)//null
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  94, 4)));
}
INLINER uint32_t p204_i32_1_GET(Pack * src)//Debug data
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  0, 4)));
}
INLINER uint8_t p204_i8_1_GET(Pack * src)//Debug data
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  4, 1)));
}
INLINER uint8_t p204_i8_2_GET(Pack * src)//Debug data
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  5, 1)));
}
...
INLINER float p204_f_2_GET(Pack * src)//Debug data
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  10, 4)));
}
INLINER float p204_f_3_GET(Pack * src)//Debug data
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  14, 4)));
}
INLINER float p204_f_4_GET(Pack * src)//Debug data
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  18, 4)));
}
INLINER float p204_f_5_GET(Pack * src)//Debug data
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  22, 4)));
}
INLINER float p204_f_6_GET(Pack * src)//Debug data
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  26, 4)));
}
INLINER float p204_f_7_GET(Pack * src)//Debug data
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  30, 4)));
}
INLINER float p204_f_8_GET(Pack * src)//Debug data
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  34, 4)));
}
INLINER uint8_t p205_LED_status_GET(Pack * src)//Status of the position-indicator LEDs
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  0, 1)));
}
INLINER uint8_t p205_SATCOM_status_GET(Pack * src)//Status of the IRIDIUM satellite communication system
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  1, 1)));
}
INLINER uint8_t* p205_Servo_status_GET(Pack * src, uint8_t*  dst, int32_t pos) //Status vector for up to 8 servos
{
    uint8_t * data = src->data;
...
INLINER uint8_t p207_obctrl_status_GET(Pack * src)//Off-board computer status
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  32, 1)));
}
...
INLINER uint16_t p209_batterystatus_GET(Pack * src)//Battery monitor status report bits in Hex
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  2, 2)));
}
INLINER uint16_t p209_serialnumber_GET(Pack * src)//Battery monitor serial number in Hex
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  4, 2)));
}
INLINER uint16_t p209_hostfetcontrol_GET(Pack * src)//Battery monitor sensor host FET control in Hex
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  6, 2)));
}
...
INLINER uint8_t p209_SoC_GET(Pack * src)//Battery pack state-of-charge
{
    uint8_t * data = src->data;
...
INLINER float p210_VarW_GET(Pack * src)//Variance W
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  32, 4)));
}
INLINER float p210_VarR_GET(Pack * src)//Variance R
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  36, 4)));
}
INLINER float p210_VarLat_GET(Pack * src)//Variance Lat
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  40, 4)));
}
...
INLINER float p210_LoiterDirection_GET(Pack * src)//Suggested loiter direction
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  52, 4)));
}
...
INLINER float p210_z1_exp_GET(Pack * src)//Expected measurement 1
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  72, 4)));
}
INLINER float p210_z2_exp_GET(Pack * src)//Expected measurement 2
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  76, 4)));
}
...
INLINER float p210_DebugVar1_GET(Pack * src)//Debug variable 1
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  92, 4)));
}
INLINER float p210_DebugVar2_GET(Pack * src)//Debug variable 2
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  96, 4)));
}
...
INLINER uint16_t p211_free_space_GET(Pack * src)//Free space available in recordings directory in [Gb] * 1e2
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  0, 2)));
}
...
INLINER uint8_t p211_visensor_rate_1_GET(Pack * src)//Rate of ROS topic 1
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  10, 1)));
}
INLINER uint8_t p211_visensor_rate_2_GET(Pack * src)//Rate of ROS topic 2
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  11, 1)));
}
INLINER uint8_t p211_visensor_rate_3_GET(Pack * src)//Rate of ROS topic 3
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  12, 1)));
}
INLINER uint8_t p211_visensor_rate_4_GET(Pack * src)//Rate of ROS topic 4
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  13, 1)));
}
INLINER uint8_t p211_recording_nodes_count_GET(Pack * src)//Number of recording nodes
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  14, 1)));
}
...
INLINER uint64_t p212_timestamp_GET(Pack * src)//Timestamp
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  0, 8)));
}
INLINER uint8_t p212_pwr_brd_status_GET(Pack * src)//Power board status register
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  8, 1)));
}
INLINER uint8_t p212_pwr_brd_led_status_GET(Pack * src)//Power board leds status
{
    uint8_t * data = src->data;
    return ((get_bytes(data,  9, 1)));
}
INLINER float p212_pwr_brd_system_volt_GET(Pack * src)//Power board system voltage
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  10, 4)));
}
INLINER float p212_pwr_brd_servo_volt_GET(Pack * src)//Power board servo voltage
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  14, 4)));
}
INLINER float p212_pwr_brd_mot_l_amp_GET(Pack * src)//Power board left motor current sensor
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  18, 4)));
}
INLINER float p212_pwr_brd_mot_r_amp_GET(Pack * src)//Power board right motor current sensor
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  22, 4)));
}
INLINER float p212_pwr_brd_servo_1_amp_GET(Pack * src)//Power board servo1 current sensor
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  26, 4)));
}
INLINER float p212_pwr_brd_servo_2_amp_GET(Pack * src)//Power board servo1 current sensor
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  30, 4)));
}
INLINER float p212_pwr_brd_servo_3_amp_GET(Pack * src)//Power board servo1 current sensor
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  34, 4)));
}
INLINER float p212_pwr_brd_servo_4_amp_GET(Pack * src)//Power board servo1 current sensor
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  38, 4)));
}
INLINER float p212_pwr_brd_aux_amp_GET(Pack * src)//Power board aux current sensor
{
    uint8_t * data = src->data;
    return (intBitsToFloat(get_bytes(data,  42, 4)));
}
