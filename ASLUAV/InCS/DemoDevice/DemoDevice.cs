    ...
    public class DemoDevice : Host
    {
        ...
        } public class GPS_RAW_INT : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            public void hdg_acc_SET(uint src, Inside ph)//Heading / track uncertainty in degrees * 1e5
            {
                ...
                BitUtils.set_bytes((ulong)(src), 4, data,  ph.BYTE);
            } static readonly Meta meta24 = new Meta(24, 4, 0, 1, 31, 236, 0, _Jo, _uo, _fo, _vo, _So);
        ...
        } public class SERVO_OUTPUT_RAW : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            public void servo16_raw_SET(ushort src, Inside ph)//Servo output 16 value, in microsecond
            {
                ...
                BitUtils.set_bytes((ulong)(src), 2, data,  ph.BYTE);
            } static readonly Meta meta36 = new Meta(36, 8, 1, 0, 22, 168, 0, _dk, _Jk, _uk, _fk, _vk, _Sk, _wk, _Uk);
        ...
        } public class SET_GPS_GLOBAL_ORIGIN : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            } static readonly Meta meta48 = new Meta(48, 0, 0, 0, 14, 104, 0, _Iy);
        } public class GPS_GLOBAL_ORIGIN : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            public void time_usec_SET(ulong src, Inside ph)//Timestamp (microseconds since UNIX epoch or microseconds since system boot
            {
                ...
                BitUtils.set_bytes((ulong)(src), 8, data,  ph.BYTE);
            } static readonly Meta meta49 = new Meta(49, 0, 0, 0, 13, 96, 0, _sy);
        } public class PARAM_MAP_RC : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            } public void param_id_SET(string src, Inside ph) {param_id_SET(src.ToCharArray(), 0, src.Length, ph);} public void param_id_SET(char[] src, int pos, int items, Inside ph)
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta50 = new Meta(50, 0, 0, 0, 22, 168, 0, _Ky);
        ...
        } public class COMMAND_ACK : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            public void target_component_SET(byte src, Inside ph)//WIP: Component which requested the command to be execute
            {
                ...
                BitUtils.set_bytes((ulong)(src), 1, data,  ph.BYTE);
            } static readonly Meta meta77 = new Meta(77, 0, 0, 0, 3, 11, 0, _ZL, _KL, _NL, _FL);
        ...
        } public class OPTICAL_FLOW : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            public void flow_rate_y_SET(float src, Inside ph)//Flow rate in radians/second about Y axi
            {
                ...
                BitUtils.set_bytes(BitUtils.FloatToInt32Bits(src), 4, data, ph.BYTE);
            } static readonly Meta meta100 = new Meta(100, 0, 0, 1, 27, 208, 0, _SJ, _wJ);
        ...
        } public class AUTOPILOT_VERSION : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            } public void uid2_SET(byte[] src, int pos, Inside ph)
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + 18; pos < src_max; pos++, BYTE += 1)
                    BitUtils.set_bytes((ulong)(src[pos]), 1, data,  BYTE);
            } static readonly Meta meta148 = new Meta(148, 2, 4, 1, 54, 421, 0, _YI);
        } public class LANDING_TARGET : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            public void position_valid_SET(byte src, Inside ph)
            {
                ...
                BitUtils.set_bytes((ulong)(src), 1, data,  ph.BYTE);
            } static readonly Meta meta149 = new Meta(149, 0, 0, 1, 31, 239, 0, _SI, _wI, _UI, _II, _jI);
        } public class SENS_POWER : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal SENS_POWER() : base(meta201, 0) { }
            internal SENS_POWER(int bytes) : base(meta201, bytes) { }
            public float adc121_vspb_volt //Power board voltage sensor reading in volt
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  0, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 0);}
            }

            public float adc121_cspb_amp //Power board current sensor reading in amp
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  4, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 4);}
            }

            public float adc121_cs1_amp //Board current sensor 1 reading in amp
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  8, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 8);}
            }

            public float adc121_cs2_amp //Board current sensor 2 reading in amp
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  12, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 12);}
            }
            static readonly Meta meta201 = new Meta(201, 0, 0, 0, 16, 128);
        } public class SENS_MPPT : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal SENS_MPPT() : base(meta202, 0) { }
            internal SENS_MPPT(int bytes) : base(meta202, bytes) { }
        ...
        } public class ASLCTRL_DATA : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal ASLCTRL_DATA() : base(meta203, 0) { }
            internal ASLCTRL_DATA(int bytes) : base(meta203, bytes) { }
            public ulong timestamp //Timestam
            {
                get {  return (BitUtils.get_bytes(data,  0, 8));}
                set {  BitUtils.set_bytes((ulong)(value), 8, data,  0);}
            }
            ...
            public float hRef //nul
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  13, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 13);}
            }

            public float hRef_t //nul
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  17, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 17);}
            }
            ...
            public float qRef //nul
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  33, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 33);}
            }

            public float uElev //nul
            {
            ...
            public byte SpoilersEngaged //nul
            {
        ...
        } public class ASLCTRL_DEBUG : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal ASLCTRL_DEBUG() : base(meta204, 0) { }
            internal ASLCTRL_DEBUG(int bytes) : base(meta204, bytes) { }
            public uint i32_1 //Debug dat
            {
                get {  return (uint)((uint) BitUtils.get_bytes(data,  0, 4));}
                set {  BitUtils.set_bytes((ulong)(value), 4, data,  0);}
            }

            public byte i8_1 //Debug dat
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  4, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  4);}
            }

            public byte i8_2 //Debug dat
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  5, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  5);}
            }
            ...
            public float f_2 //Debug dat
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  10, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 10);}
            }

            public float f_3 //Debug dat
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  14, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 14);}
            }

            public float f_4 //Debug dat
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  18, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 18);}
            }

            public float f_5 //Debug dat
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  22, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 22);}
            }

            public float f_6 //Debug dat
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  26, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 26);}
            }

            public float f_7 //Debug dat
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  30, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 30);}
            }

            public float f_8 //Debug dat
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  34, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 34);}
            }
            static readonly Meta meta204 = new Meta(204, 0, 1, 0, 38, 304);
        } public class ASLUAV_STATUS : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal ASLUAV_STATUS() : base(meta205, 0) { }
            internal ASLUAV_STATUS(int bytes) : base(meta205, bytes) { }
            public byte LED_status //Status of the position-indicator LED
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  0, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  0);}
            }

            public byte SATCOM_status //Status of the IRIDIUM satellite communication syste
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  1, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  1);}
            }

            public byte[] Servo_status //Status vector for up to 8 servo
            {
                get {return Servo_status_GET(new byte[8], 0);}
                set {Servo_status_SET(value, 0)  ;}
            }
            public byte[]Servo_status_GET(byte[] dst_ch, int pos)  //Status vector for up to 8 servo
            {
            ...
            public void Servo_status_SET(byte[] src, int pos)  //Status vector for up to 8 servo
            {
        ...
        } public class EKF_EXT : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal EKF_EXT() : base(meta206, 0) { }
            internal EKF_EXT(int bytes) : base(meta206, bytes) { }
        ...
        } public class ASL_OBCTRL : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal ASL_OBCTRL() : base(meta207, 0) { }
            internal ASL_OBCTRL(int bytes) : base(meta207, bytes) { }
            public ulong timestamp //Time since system start [us
            {
                get {  return (BitUtils.get_bytes(data,  0, 8));}
                set {  BitUtils.set_bytes((ulong)(value), 8, data,  0);}
            ...
            public byte obctrl_status //Off-board computer statu
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  32, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  32);}
            }
            static readonly Meta meta207 = new Meta(207, 0, 0, 1, 33, 264);
        } public class SENS_ATMOS : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal SENS_ATMOS() : base(meta208, 0) { }
            internal SENS_ATMOS(int bytes) : base(meta208, bytes) { }
        ...
        } public class SENS_BATMON : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal SENS_BATMON() : base(meta209, 0) { }
            internal SENS_BATMON(int bytes) : base(meta209, bytes) { }
            ...
            public ushort batterystatus //Battery monitor status report bits in He
            {
                get {  return (ushort)((ushort) BitUtils.get_bytes(data,  2, 2));}
                set {  BitUtils.set_bytes((ulong)(value), 2, data,  2);}
            }

            public ushort serialnumber //Battery monitor serial number in He
            {
                get {  return (ushort)((ushort) BitUtils.get_bytes(data,  4, 2));}
                set {  BitUtils.set_bytes((ulong)(value), 2, data,  4);}
            }

            public ushort hostfetcontrol //Battery monitor sensor host FET control in He
            {
                get {  return (ushort)((ushort) BitUtils.get_bytes(data,  6, 2));}
                set {  BitUtils.set_bytes((ulong)(value), 2, data,  6);}
            }
            ...
            public byte SoC //Battery pack state-of-charg
            {
        ...
        } public class FW_SOARING_DATA : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal FW_SOARING_DATA() : base(meta210, 0) { }
            internal FW_SOARING_DATA(int bytes) : base(meta210, bytes) { }
            ...
            public float VarW //Variance
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  32, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 32);}
            }

            public float VarR //Variance
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  36, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 36);}
            }

            public float VarLat //Variance La
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  40, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 40);}
            }
            ...
            public float LoiterDirection //Suggested loiter directio
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  52, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 52);}
            }
            ...
            public float z1_exp //Expected measurement
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  72, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 72);}
            }

            public float z2_exp //Expected measurement
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  76, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 76);}
            }
            ...
            public float DebugVar1 //Debug variable
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  92, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 92);}
            }

            public float DebugVar2 //Debug variable
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  96, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 96);}
            }
        ...
        } public class SENSORPOD_STATUS : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal SENSORPOD_STATUS() : base(meta211, 0) { }
            internal SENSORPOD_STATUS(int bytes) : base(meta211, bytes) { }
            public ushort free_space //Free space available in recordings directory in [Gb] * 1e
            {
                get {  return (ushort)((ushort) BitUtils.get_bytes(data,  0, 2));}
                set {  BitUtils.set_bytes((ulong)(value), 2, data,  0);}
            }
            ...
            public byte visensor_rate_1 //Rate of ROS topic
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  10, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  10);}
            }

            public byte visensor_rate_2 //Rate of ROS topic
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  11, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  11);}
            }

            public byte visensor_rate_3 //Rate of ROS topic
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  12, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  12);}
            }

            public byte visensor_rate_4 //Rate of ROS topic
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  13, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  13);}
            }

            public byte recording_nodes_count //Number of recording node
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  14, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  14);}
            }
        ...
        } public class SENS_POWER_BOARD : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal SENS_POWER_BOARD() : base(meta212, 0) { }
            internal SENS_POWER_BOARD(int bytes) : base(meta212, bytes) { }
            public ulong timestamp //Timestam
            {
                get {  return (BitUtils.get_bytes(data,  0, 8));}
                set {  BitUtils.set_bytes((ulong)(value), 8, data,  0);}
            ...
            public byte pwr_brd_status //Power board status registe
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  8, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  8);}
            }

            public byte pwr_brd_led_status //Power board leds statu
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  9, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  9);}
            }

            public float pwr_brd_system_volt //Power board system voltag
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  10, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 10);}
            }

            public float pwr_brd_servo_volt //Power board servo voltag
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  14, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 14);}
            }

            public float pwr_brd_mot_l_amp //Power board left motor current senso
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  18, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 18);}
            }

            public float pwr_brd_mot_r_amp //Power board right motor current senso
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  22, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 22);}
            }

            public float pwr_brd_servo_1_amp //Power board servo1 current senso
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  26, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 26);}
            }

            public float pwr_brd_servo_2_amp //Power board servo1 current senso
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  30, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 30);}
            }

            public float pwr_brd_servo_3_amp //Power board servo1 current senso
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  34, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 34);}
            }

            public float pwr_brd_servo_4_amp //Power board servo1 current senso
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  38, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 38);}
            }

            public float pwr_brd_aux_amp //Power board aux current senso
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  42, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 42);}
            }
        ...
        } public class HOME_POSITION : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            public void time_usec_SET(ulong src, Inside ph)//Timestamp (microseconds since UNIX epoch or microseconds since system boot
            {
                ...
                BitUtils.set_bytes((ulong)(src), 8, data,  ph.BYTE);
            } static readonly Meta meta242 = new Meta(242, 0, 0, 0, 53, 416, 0, _hz);
        } public class SET_HOME_POSITION : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            public void time_usec_SET(ulong src, Inside ph)//Timestamp (microseconds since UNIX epoch or microseconds since system boot
            {
                ...
                BitUtils.set_bytes((ulong)(src), 8, data,  ph.BYTE);
            } static readonly Meta meta243 = new Meta(243, 0, 0, 0, 54, 424, 0, _dj);
        ...
        } public class ADSB_VEHICLE : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {callsign_SET(src.ToCharArray(), 0, src.Length, ph);} public void callsign_SET(char[] src, int pos, int items, Inside ph) //The callsign, 8+nul
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta246 = new Meta(246, 3, 1, 0, 28, 210, 0, _Aj);
        ...
        } public class DEBUG_VECT : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {name_SET(src.ToCharArray(), 0, src.Length, ph);} public void name_SET(char[] src, int pos, int items, Inside ph) //Nam
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta250 = new Meta(250, 0, 0, 1, 21, 160, 0, _pj);
        } public class NAMED_VALUE_FLOAT : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {name_SET(src.ToCharArray(), 0, src.Length, ph);} public void name_SET(char[] src, int pos, int items, Inside ph) //Name of the debug variabl
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta251 = new Meta(251, 0, 1, 0, 9, 64, 0, _hj);
        } public class NAMED_VALUE_INT : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {name_SET(src.ToCharArray(), 0, src.Length, ph);} public void name_SET(char[] src, int pos, int items, Inside ph) //Name of the debug variabl
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta252 = new Meta(252, 0, 1, 0, 9, 64, 0, _Xq);
        } public class STATUSTEXT : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {text_SET(src.ToCharArray(), 0, src.Length, ph);} public void text_SET(char[] src, int pos, int items, Inside ph) //Status text message, without null termination characte
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta253 = new Meta(253, 0, 0, 0, 2, 4, 0, _kq);
        ...
        } public class PLAY_TUNE : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {tune_SET(src.ToCharArray(), 0, src.Length, ph);} public void tune_SET(char[] src, int pos, int items, Inside ph) //tune in board specific forma
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta258 = new Meta(258, 0, 0, 0, 3, 16, 0, _Uq);
        } public class CAMERA_INFORMATION : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {cam_definition_uri_SET(src.ToCharArray(), 0, src.Length, ph);} public void cam_definition_uri_SET(char[] src, int pos, int items, Inside ph) //Camera definition URI (if any, otherwise only basic functions will be available)
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta259 = new Meta(259, 3, 2, 0, 93, 731, 0, _Bq);
        ...
        } public class CAMERA_IMAGE_CAPTURED : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {file_url_SET(src.ToCharArray(), 0, src.Length, ph);} public void file_url_SET(char[] src, int pos, int items, Inside ph) //foo.jpg if camera provides an HTTP interface
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta263 = new Meta(263, 0, 1, 1, 51, 402, 2, _Ys);
        ...
        } public class VIDEO_STREAM_INFORMATION : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {uri_SET(src.ToCharArray(), 0, src.Length, ph);} public void uri_SET(char[] src, int pos, int items, Inside ph) //Video stream UR
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta269 = new Meta(269, 3, 1, 0, 17, 130, 2, _Vs);
        } public class SET_VIDEO_STREAM_SETTINGS : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {uri_SET(src.ToCharArray(), 0, src.Length, ph);} public void uri_SET(char[] src, int pos, int items, Inside ph) //Video stream UR
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta270 = new Meta(270, 3, 1, 0, 18, 138, 2, _Ps);
        } public class WIFI_CONFIG_AP : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {password_SET(src.ToCharArray(), 0, src.Length, ph);} public void password_SET(char[] src, int pos, int items, Inside ph) //Password. Leave it blank for an open AP
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta299 = new Meta(299, 0, 0, 0, 1, 2, 2, _Es, _Os);
        ...
        } public class UAVCAN_NODE_INFO : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {name_SET(src.ToCharArray(), 0, src.Length, ph);} public void name_SET(char[] src, int pos, int items, Inside ph) //Node name string. For example, "sapog.px4.io"
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta311 = new Meta(311, 0, 2, 1, 37, 288, 0, _dA);
        } public class PARAM_EXT_REQUEST_READ : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            } public void param_id_SET(string src, Inside ph) {param_id_SET(src.ToCharArray(), 0, src.Length, ph);} public void param_id_SET(char[] src, int pos, int items, Inside ph)
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta320 = new Meta(320, 0, 0, 0, 5, 32, 0, _zA);
        ...
        } public class PARAM_EXT_VALUE : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {param_value_SET(src.ToCharArray(), 0, src.Length, ph);} public void param_value_SET(char[] src, int pos, int items, Inside ph) //Parameter valu
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta322 = new Meta(322, 2, 0, 0, 5, 38, 2, _AA, _ZA);
        } public class PARAM_EXT_SET : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {param_value_SET(src.ToCharArray(), 0, src.Length, ph);} public void param_value_SET(char[] src, int pos, int items, Inside ph) //Parameter valu
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta323 = new Meta(323, 0, 0, 0, 3, 22, 2, _BA, _aA);
        } public class PARAM_EXT_ACK : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {param_value_SET(src.ToCharArray(), 0, src.Length, ph);} public void param_value_SET(char[] src, int pos, int items, Inside ph) //Parameter value (new value if PARAM_ACK_ACCEPTED, current value otherwise
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta324 = new Meta(324, 0, 0, 0, 2, 9, 2, _xA, _nA);
                ...
                for(bool LOOP = false; ;)
                {
                    switch(id)
                    {
                        ...
                        case 201:
                            ...
                            if(OnSENS_POWERReceive == null) return null;
                            ph.setPack(pack);
                            OnSENS_POWERReceive(this, ph, (SENS_POWER) pack);
                            if(LOOP) break;
                            return null;
                        case 202:
                            if(pack == null) return new SENS_MPPT();
                            if(OnSENS_MPPTReceive == null) return null;
                            ph.setPack(pack);
                            OnSENS_MPPTReceive(this, ph, (SENS_MPPT) pack);
                            if(LOOP) break;
                            return null;
                        case 203:
                            if(pack == null) return new ASLCTRL_DATA();
                            if(OnASLCTRL_DATAReceive == null) return null;
                            ph.setPack(pack);
                            OnASLCTRL_DATAReceive(this, ph, (ASLCTRL_DATA) pack);
                            if(LOOP) break;
                            return null;
                        case 204:
                            if(pack == null) return new ASLCTRL_DEBUG();
                            if(OnASLCTRL_DEBUGReceive == null) return null;
                            ph.setPack(pack);
                            OnASLCTRL_DEBUGReceive(this, ph, (ASLCTRL_DEBUG) pack);
                            if(LOOP) break;
                            return null;
                        case 205:
                            if(pack == null) return new ASLUAV_STATUS();
                            if(OnASLUAV_STATUSReceive == null) return null;
                            ph.setPack(pack);
                            OnASLUAV_STATUSReceive(this, ph, (ASLUAV_STATUS) pack);
                            if(LOOP) break;
                            return null;
                        case 206:
                            if(pack == null) return new EKF_EXT();
                            if(OnEKF_EXTReceive == null) return null;
                            ph.setPack(pack);
                            OnEKF_EXTReceive(this, ph, (EKF_EXT) pack);
                            if(LOOP) break;
                            return null;
                        case 207:
                            if(pack == null) return new ASL_OBCTRL();
                            if(OnASL_OBCTRLReceive == null) return null;
                            ph.setPack(pack);
                            OnASL_OBCTRLReceive(this, ph, (ASL_OBCTRL) pack);
                            if(LOOP) break;
                            return null;
                        case 208:
                            if(pack == null) return new SENS_ATMOS();
                            if(OnSENS_ATMOSReceive == null) return null;
                            ph.setPack(pack);
                            OnSENS_ATMOSReceive(this, ph, (SENS_ATMOS) pack);
                            if(LOOP) break;
                            return null;
                        case 209:
                            if(pack == null) return new SENS_BATMON();
                            if(OnSENS_BATMONReceive == null) return null;
                            ph.setPack(pack);
                            OnSENS_BATMONReceive(this, ph, (SENS_BATMON) pack);
                            if(LOOP) break;
                            return null;
                        case 210:
                            if(pack == null) return new FW_SOARING_DATA();
                            if(OnFW_SOARING_DATAReceive == null) return null;
                            ph.setPack(pack);
                            OnFW_SOARING_DATAReceive(this, ph, (FW_SOARING_DATA) pack);
                            if(LOOP) break;
                            return null;
                        case 211:
                            if(pack == null) return new SENSORPOD_STATUS();
                            if(OnSENSORPOD_STATUSReceive == null) return null;
                            ph.setPack(pack);
                            OnSENSORPOD_STATUSReceive(this, ph, (SENSORPOD_STATUS) pack);
                            if(LOOP) break;
                            return null;
                        case 212:
                            if(pack == null) return new SENS_POWER_BOARD();
                            if(OnSENS_POWER_BOARDReceive == null) return null;
                            ph.setPack(pack);
                            OnSENS_POWER_BOARDReceive(this, ph, (SENS_POWER_BOARD) pack);
                            if(LOOP) break;
                            return null;
                        case 230:
        ...
        static readonly Field _fo = new Field(0, true, 1, 4, 1, 0, 0, 0);
        static readonly Field _vo = new Field(0, true, 1, 4, 1, 0, 0, 0);
        static readonly Field _So = new Field(0, true, 1, 4, 1, 0, 0, 0);
        static readonly Field _dk = new Field(0, true, 1, 2, 1, 0, 0, 0);
        static readonly Field _Jk = new Field(0, true, 1, 2, 1, 0, 0, 0);
        ...
        static readonly Field _Sk = new Field(0, true, 1, 2, 1, 0, 0, 0);
        static readonly Field _wk = new Field(0, true, 1, 2, 1, 0, 0, 0);
        static readonly Field _Uk = new Field(0, true, 1, 2, 1, 0, 0, 0);
        static readonly Field _Iy = new Field(0, true, 1, 8, 1, 0, 0, 0);
        static readonly Field _sy = new Field(0, true, 1, 8, 1, 0, 0, 0);
        static readonly Field _Ky = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
        static readonly Field _ZL = new Field(0, false, 1, 1, 1, 0, 0, 0);
        static readonly Field _KL = new Field(0, false, 1, 4, 1, 0, 0, 0);
        static readonly Field _NL = new Field(0, false, 1, 1, 1, 0, 0, 0);
        static readonly Field _FL = new Field(0, false, 1, 1, 1, 0, 0, 0);
        static readonly Field _SJ = new Field(0, false, 1, 4, 1, 0, 0, 0);
        static readonly Field _wJ = new Field(0, false, 1, 4, 1, 0, 0, 0);
        static readonly Field _YI = new Field(0, false, 18, 1, 1, 0, 0, 0);
        static readonly Field _SI = new Field(0, false, 1, 4, 1, 0, 0, 0);
        static readonly Field _wI = new Field(0, false, 1, 4, 1, 0, 0, 0);
        static readonly Field _UI = new Field(0, false, 1, 4, 1, 0, 0, 0);
        static readonly Field _II = new Field(0, false, 4, 4, 1, 0, 0, 0);
        static readonly Field _jI = new Field(0, false, 1, 1, 1, 0, 0, 0);
        static readonly Field _hz = new Field(0, true, 1, 8, 1, 0, 0, 0);
        static readonly Field _dj = new Field(0, true, 1, 8, 1, 0, 0, 0);
        static readonly Field _Aj = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
        static readonly Field _pj = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
        static readonly Field _hj = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
        static readonly Field _Xq = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
        static readonly Field _kq = new Field(5, true, -6, 2, 1, 0, 0, 0, 1);
        static readonly Field _Uq = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
        static readonly Field _Bq = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
        static readonly Field _Ys = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
        static readonly Field _Vs = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
        static readonly Field _Ps = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
        static readonly Field _Es = new Field(5, true, -6, 2, 1, 0, 0, 0, 1);
        static readonly Field _Os = new Field(5, true, -7, 2, 1, 0, 0, 0, 1);
        static readonly Field _dA = new Field(5, true, -7, 2, 1, 0, 0, 0, 1);
        static readonly Field _zA = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
        static readonly Field _AA = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
        static readonly Field _ZA = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
        static readonly Field _BA = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
        static readonly Field _aA = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
        static readonly Field _xA = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
        static readonly Field _nA = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
