...
@A long  mppt_timestamp;//MPPT last timestamp 
float  mppt1_volt;//MPPT1 voltage 
float  mppt1_amp;//MPPT1 current 
@A short  mppt1_pwm;//MPPT1 pwm 
@A byte  mppt1_status;//MPPT1 status 
float  mppt2_volt;//MPPT2 voltage 
float  mppt2_amp;//MPPT2 current 
@A short  mppt2_pwm;//MPPT2 pwm 
@A byte  mppt2_status;//MPPT2 status 
...
@A long  timestamp;//Timestamp
@A byte  aslctrl_mode;//ASLCTRL control-mode (manual, stabilized, auto, etc...)
...
@A int  i32_1;//Debug data
@A byte  i8_1;//Debug data
@A byte  i8_2;//Debug data
...
@A byte  LED_status;//Status of the position-indicator LEDs
@A byte  SATCOM_status;//Status of the IRIDIUM satellite communication system
...
@A long  timestamp;//Time since system start [us]
...
@A short  voltage;//Battery pack voltage in [mV]
short  current;//Battery pack current in [mA]
@A byte  SoC;//Battery pack state-of-charge
@A short  batterystatus;//Battery monitor status report bits in Hex
@A short  serialnumber;//Battery monitor serial number in Hex
@A short  hostfetcontrol;//Battery monitor sensor host FET control in Hex
@A short  cellvoltage1;//Battery pack cell 1 voltage in [mV]
@A short  cellvoltage2;//Battery pack cell 2 voltage in [mV]
@A short  cellvoltage3;//Battery pack cell 3 voltage in [mV]
@A short  cellvoltage4;//Battery pack cell 4 voltage in [mV]
...
@A long  timestamp;//Timestamp [ms]
@A long  timestampModeChanged;//Timestamp since last mode change[ms]
...
@A long  timestamp;//Timestamp in linuxtime [ms] (since 1.1.1970)
@A byte  visensor_rate_1;//Rate of ROS topic 1
@A byte  visensor_rate_2;//Rate of ROS topic 2
@A byte  visensor_rate_3;//Rate of ROS topic 3
@A byte  visensor_rate_4;//Rate of ROS topic 4
@A byte  recording_nodes_count;//Number of recording nodes
...
@A long  timestamp;//Timestamp
@A byte  pwr_brd_status;//Power board status register
@A byte  pwr_brd_led_status;//Power board leds status
