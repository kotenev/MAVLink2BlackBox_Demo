...
//ke
    ...
    } public static class PARAM_VALUE extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        ...
        } public void param_id_SET(String src, Bounds.Inside ph) {param_id_SET(src.toCharArray(), 0, src.length(), ph);} public void param_id_SET(char[]  src, int pos, int items, Bounds.Inside ph)
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(22, 2, 0, 0, 10, 68, 0, _a);
...
//Heading / track uncertainty in degrees * 1e5
        ...
        public void hdg_acc_SET(long  src, Bounds.Inside ph)//Heading / track uncertainty in degrees * 1e5
        {
            ...
            set_bytes((src) & -1L, 4, data,  ph.BYTE);
        } static final Meta meta = new Meta(24, 4, 0, 1, 31, 236, 0, _Ln, _xn, _Pn, _en, _Fn);
...
//Servo output 16 value, in microsecond
        ...
        public void servo16_raw_SET(char  src, Bounds.Inside ph)//Servo output 16 value, in microsecond
        {
            ...
            set_bytes((char)(src) & -1L, 2, data,  ph.BYTE);
        } static final Meta meta = new Meta(36, 8, 1, 0, 22, 168, 0, _tj, _Lj, _xj, _Pj, _ej, _Fj, _Bj, _Ej);
...
//Timestamp (microseconds since UNIX epoch or microseconds since system boot
        ...
        } static final Meta meta = new Meta(48, 0, 0, 0, 14, 104, 0, _SM);
...
//Timestamp (microseconds since UNIX epoch or microseconds since system boot
        ...
        public void time_usec_SET(long  src, Bounds.Inside ph)//Timestamp (microseconds since UNIX epoch or microseconds since system boot
        {
            ...
            set_bytes((src) & -1L, 8, data,  ph.BYTE);
        } static final Meta meta = new Meta(49, 0, 0, 0, 13, 96, 0, _WM);
    } public static class PARAM_MAP_RC extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        ...
        } public void param_id_SET(String src, Bounds.Inside ph) {param_id_SET(src.toCharArray(), 0, src.length(), ph);} public void param_id_SET(char[]  src, int pos, int items, Bounds.Inside ph)
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(50, 0, 0, 0, 22, 168, 0, _qM);
...
//WIP: Component which requested the command to be execute
        ...
        public void target_component_SET(char  src, Bounds.Inside ph)//WIP: Component which requested the command to be execute
        {
            ...
            set_bytes((char)(src) & -1L, 1, data,  ph.BYTE);
        } static final Meta meta = new Meta(77, 0, 0, 0, 3, 10, 0, _RQ, _qQ, _wQ, _VQ);
...
//Flow rate in radians/second about Y axi
        ...
        public void flow_rate_y_SET(float  src, Bounds.Inside ph)//Flow rate in radians/second about Y axi
        {
            ...
            set_bytes(Float.floatToIntBits(src) & -1L, 4, data, ph.BYTE);
        } static final Meta meta = new Meta(100, 0, 0, 1, 27, 208, 0, _FL, _BL);
    ...
    } public static class AUTOPILOT_VERSION extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        ...
        } public void uid2_SET(char[]  src, int pos, Bounds.Inside ph)
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + 18; pos < src_max; pos++, BYTE += 1)
                set_bytes((char)(src[pos]) & -1L, 1, data,  BYTE);
        } static final Meta meta = new Meta(148, 2, 4, 1, 54, 421, 0, _HS);
...
//Quaternion of landing target orientation (w, x, y, z order, zero-rotation is 1, 0, 0, 0
        ...
        public void position_valid_SET(char  src, Bounds.Inside ph)
        {
            ...
            set_bytes((char)(src) & -1L, 1, data,  ph.BYTE);
        } static final Meta meta = new Meta(149, 0, 0, 1, 31, 239, 0, _FS, _BS, _ES, _SS, _AS);
...
//Timestamp (microseconds since UNIX epoch or microseconds since system boot
        ...
        public void time_usec_SET(long  src, Bounds.Inside ph)//Timestamp (microseconds since UNIX epoch or microseconds since system boot
        {
            ...
            set_bytes((src) & -1L, 8, data,  ph.BYTE);
        } static final Meta meta = new Meta(242, 0, 0, 0, 53, 416, 0, _To);
...
//Timestamp (microseconds since UNIX epoch or microseconds since system boot
        ...
        public void time_usec_SET(long  src, Bounds.Inside ph)//Timestamp (microseconds since UNIX epoch or microseconds since system boot
        {
            ...
            set_bytes((src) & -1L, 8, data,  ph.BYTE);
        } static final Meta meta = new Meta(243, 0, 0, 0, 54, 424, 0, _tA);
...
//The callsign, 8+nul
        ...
        {callsign_SET(src.toCharArray(), 0, src.length(), ph);} public void callsign_SET(char[]  src, int pos, int items, Bounds.Inside ph) //The callsign, 8+nul
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(246, 3, 1, 0, 28, 210, 0, _sA);
...
//Nam
        ...
        {name_SET(src.toCharArray(), 0, src.length(), ph);} public void name_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Nam
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(250, 0, 0, 1, 21, 160, 0, _dA);
...
//Name of the debug variabl
        ...
        {name_SET(src.toCharArray(), 0, src.length(), ph);} public void name_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Name of the debug variabl
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(251, 0, 1, 0, 9, 64, 0, _TA);
...
//Name of the debug variabl
        ...
        {name_SET(src.toCharArray(), 0, src.length(), ph);} public void name_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Name of the debug variabl
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(252, 0, 1, 0, 9, 64, 0, _lu);
...
//Status text message, without null termination characte
        ...
        {text_SET(src.toCharArray(), 0, src.length(), ph);} public void text_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Status text message, without null termination characte
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(253, 0, 0, 0, 2, 4, 0, _ju);
...
//tune in board specific forma
        ...
        {tune_SET(src.toCharArray(), 0, src.length(), ph);} public void tune_SET(char[]  src, int pos, int items, Bounds.Inside ph) //tune in board specific forma
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(258, 0, 0, 0, 3, 16, 0, _Eu);
...
//Camera definition URI (if any, otherwise only basic functions will be available)
        ...
        {cam_definition_uri_SET(src.toCharArray(), 0, src.length(), ph);} public void cam_definition_uri_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Camera definition URI (if any, otherwise only basic functions will be available)
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(259, 3, 2, 0, 93, 731, 0, _cu);
...
//foo.jpg if camera provides an HTTP interface
        ...
        {file_url_SET(src.toCharArray(), 0, src.length(), ph);} public void file_url_SET(char[]  src, int pos, int items, Bounds.Inside ph) //foo.jpg if camera provides an HTTP interface
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(263, 0, 1, 1, 51, 402, 2, _HW);
...
//Video stream UR
        ...
        {uri_SET(src.toCharArray(), 0, src.length(), ph);} public void uri_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Video stream UR
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(270, 3, 1, 0, 18, 138, 2, _OW);
...
//Password. Leave it blank for an open AP
        ...
        {password_SET(src.toCharArray(), 0, src.length(), ph);} public void password_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Password. Leave it blank for an open AP
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(299, 0, 0, 0, 1, 2, 2, _pW, _kW);
...
//Node name string. For example, "sapog.px4.io"
        ...
        {name_SET(src.toCharArray(), 0, src.length(), ph);} public void name_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Node name string. For example, "sapog.px4.io"
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(311, 0, 2, 1, 37, 288, 0, _ts);
    } public static class PARAM_EXT_REQUEST_READ extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        ...
        } public void param_id_SET(String src, Bounds.Inside ph) {param_id_SET(src.toCharArray(), 0, src.length(), ph);} public void param_id_SET(char[]  src, int pos, int items, Bounds.Inside ph)
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(320, 0, 0, 0, 5, 32, 0, _os);
...
//Parameter valu
        ...
        {param_value_SET(src.toCharArray(), 0, src.length(), ph);} public void param_value_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Parameter valu
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(322, 2, 0, 0, 5, 38, 2, _ss, _Rs);
...
//Parameter valu
        ...
        {param_value_SET(src.toCharArray(), 0, src.length(), ph);} public void param_value_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Parameter valu
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(323, 0, 0, 0, 3, 22, 2, _cs, _Us);
...
//Parameter value (new value if PARAM_ACK_ACCEPTED, current value otherwise
        ...
        {param_value_SET(src.toCharArray(), 0, src.length(), ph);} public void param_value_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Parameter value (new value if PARAM_ACK_ACCEPTED, current value otherwise
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(324, 0, 0, 0, 2, 9, 2, _Ks, _Zs);
...
//Vehicle identifier (8 characters, null terminated, valid characters are A-Z, 0-9, " " only
        ...
        {callsign_SET(src.toCharArray(), 0, src.length(), ph);} public void callsign_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Vehicle identifier (8 characters, null terminated, valid characters are A-Z, 0-9, " " only
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(10001, 1, 1, 0, 10, 66, 0, _ds);
    ...
    private static final Field _Ln = new Field(0, false, 1, 4, 1, 0, 0, 0);
    private static final Field _xn = new Field(0, true, 1, 4, 1, 0, 0, 0);
    private static final Field _Pn = new Field(0, true, 1, 4, 1, 0, 0, 0);
    private static final Field _en = new Field(0, true, 1, 4, 1, 0, 0, 0);
    private static final Field _Fn = new Field(0, true, 1, 4, 1, 0, 0, 0);
    private static final Field _tj = new Field(0, true, 1, 2, 1, 0, 0, 0);
    private static final Field _Lj = new Field(0, true, 1, 2, 1, 0, 0, 0);
    private static final Field _xj = new Field(0, true, 1, 2, 1, 0, 0, 0);
    private static final Field _Pj = new Field(0, true, 1, 2, 1, 0, 0, 0);
    private static final Field _ej = new Field(0, true, 1, 2, 1, 0, 0, 0);
    private static final Field _Fj = new Field(0, true, 1, 2, 1, 0, 0, 0);
    private static final Field _Bj = new Field(0, true, 1, 2, 1, 0, 0, 0);
    private static final Field _Ej = new Field(0, true, 1, 2, 1, 0, 0, 0);
    private static final Field _SM = new Field(0, true, 1, 8, 1, 0, 0, 0);
    private static final Field _WM = new Field(0, true, 1, 8, 1, 0, 0, 0);
    private static final Field _qM = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
    private static final Field _RQ = new Field(0, false, 1, 1, 1, 0, 0, 0);
    private static final Field _qQ = new Field(0, false, 1, 4, 1, 0, 0, 0);
    private static final Field _wQ = new Field(0, false, 1, 1, 1, 0, 0, 0);
    private static final Field _VQ = new Field(0, false, 1, 1, 1, 0, 0, 0);
    private static final Field _FL = new Field(0, false, 1, 4, 1, 0, 0, 0);
    private static final Field _BL = new Field(0, false, 1, 4, 1, 0, 0, 0);
    private static final Field _HS = new Field(0, false, 18, 1, 1, 0, 0, 0);
    private static final Field _FS = new Field(0, false, 1, 4, 1, 0, 0, 0);
    private static final Field _BS = new Field(0, false, 1, 4, 1, 0, 0, 0);
    private static final Field _ES = new Field(0, false, 1, 4, 1, 0, 0, 0);
    private static final Field _SS = new Field(0, false, 4, 4, 1, 0, 0, 0);
    private static final Field _AS = new Field(0, false, 1, 1, 1, 0, 0, 0);
    private static final Field _To = new Field(0, true, 1, 8, 1, 0, 0, 0);
    private static final Field _tA = new Field(0, true, 1, 8, 1, 0, 0, 0);
    private static final Field _sA = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
    private static final Field _dA = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
    private static final Field _TA = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
    private static final Field _lu = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
    private static final Field _ju = new Field(5, true, -6, 2, 1, 0, 0, 0, 1);
    private static final Field _Eu = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
    private static final Field _cu = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
    private static final Field _HW = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
    ...
    private static final Field _kW = new Field(5, true, -7, 2, 1, 0, 0, 0, 1);
    private static final Field _ts = new Field(5, true, -7, 2, 1, 0, 0, 0, 1);
    private static final Field _os = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
    private static final Field _ss = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
    private static final Field _Rs = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
    private static final Field _cs = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
    private static final Field _Us = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
    private static final Field _Ks = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
    private static final Field _Zs = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
    private static final Field _ds = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
