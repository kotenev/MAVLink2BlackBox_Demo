...
*Request to control this MAV*/
        public class CHANGE_OPERATOR_CONTROL : Pack
        {
            ...
            *	 characters may involve A-Z, a-z, 0-9, and "!?,.-*/
            ...
            } static readonly Meta meta5 = new Meta(5, 0, 0, 0, 4, 24, 0, _E);
        }/**
...
*	 aircraft, not only for one component*/
        public class SET_MODE : Pack
        {
            ...
            {
                get {  return  en__q(BitUtils.get_bits(data, 40, 4));}
            }
...
*	 of QGroundControl and IMU code*/
        public class PARAM_REQUEST_READ : Pack
        {
            ...
            *	 storage if the ID is stored as strin*/
            ...
            } static readonly Meta meta20 = new Meta(20, 0, 0, 0, 5, 32, 0, _j);
        }/**
...
*	 a loss or timeout*/
        public class PARAM_VALUE : Pack
        {
            ...
            *	 storage if the ID is stored as strin*/
            ...
            } static readonly Meta meta22 = new Meta(22, 2, 0, 0, 10, 68, 0, _z);
        }/**
...
*	 NOT the global position estimate of the system, but rather a RAW sensor value. See message GLOBAL_POSITION for the global position estimate. Coordinate frame is right-handed, Z-axis up (GPS frame).*/
        public class GPS_RAW_INT : Pack
        {
            ...
            *	 the AMSL altitude in addition to the WGS84 altitude*/
            ...
            static readonly Meta meta24 = new Meta(24, 4, 0, 1, 31, 236, 0, _lo, _wo, _uo, _so, _Mo);
        }/**
...
*	 standard PPM modulation is as follows: 1000 microseconds: 0%, 2000 microseconds: 100%*/
        public class SERVO_OUTPUT_RAW : Pack
        {
            ...
            *	 more than 8 servos*/
            ...
            static readonly Meta meta36 = new Meta(36, 8, 1, 0, 22, 168, 0, _bg, _lg, _wg, _ug, _sg, _Mg, _vg, _Lg);
        }/**
...
*	 the presence of a mission item and to set a mission item on the system. The mission item can be either in x, y, z meters (type: LOCAL) or x:lat, y:lon, z:altitude. Local frame is Z-down, right handed (NED), global frame is Z-up, right handed (ENU). See also http:qgroundcontrol.org/mavlink/waypoint_protocol.*/
        public class MISSION_ITEM : Pack
        {
            ...
            {
                get {  return  en__c(BitUtils.get_bits(data, 276, 8));}
            }
...
*	 are connected and the MAV should move from in- to outdoor*/
        public class SET_GPS_GLOBAL_ORIGIN : Pack
        {
            ...
            static readonly Meta meta48 = new Meta(48, 0, 0, 0, 14, 104, 0, _nO);
        }/**
*Once the MAV sets a new GPS-Local correspondence, this message announces the origin (0,0,0) positio*/
        public class GPS_GLOBAL_ORIGIN : Pack
        {
            ...
            static readonly Meta meta49 = new Meta(49, 0, 0, 0, 13, 96, 0, _BO);
        }/**
*Bind a RC channel to a parameter. The parameter should change accoding to the RC channel value.*/
        public class PARAM_MAP_RC : Pack
        {
            ...
            *	 storage if the ID is stored as strin*/
            ...
            } static readonly Meta meta50 = new Meta(50, 0, 0, 0, 22, 168, 0, _IO);
        }/**
*Request the information of the mission item with the sequence number seq. The response of the system to
...
*Message encoding a command with parameters as scaled integers. Scaling depends on the actual command value*/
        public class COMMAND_INT : Pack
        {
            ...
            {
                get {  return  en__c(BitUtils.get_bits(data, 260, 8));}
            }
...
*Send a command with up to seven parameters to the MAV*/
        public class COMMAND_LONG : Pack
        {
            ...
            {
                get {  return  en__c(BitUtils.get_bits(data, 248, 8));}
            }
...
*Report status of a command. Includes feedback whether the command was executed.*/
        public class COMMAND_ACK : Pack
        {
            ...
            public MAV_CMD command //Command ID, as defined by MAV_CMD enum.
            {
                get {  return  en__c(BitUtils.get_bits(data, 0, 8));}
            }
            ...
            *	 be denied*/
            ...
            static readonly Meta meta77 = new Meta(77, 0, 0, 0, 3, 11, 0, _xq, _Iq, _pq, _mq);
        }/**
...
*Sent from autopilot to simulation. Hardware in the loop control outputs*/
        public class HIL_CONTROLS : Pack, CommunicationChannel.Sendable
        {
            ...
            {
                get {  return  en__q(BitUtils.get_bits(data, 328, 4));}
                set
                {
...
*Sent from autopilot to simulation. Hardware in the loop control outputs (replacement for HIL_CONTROLS*/
        public class HIL_ACTUATOR_CONTROLS : Pack, CommunicationChannel.Sendable
        {
            ...
            {
                get {  return  en__q(BitUtils.get_bits(data, 640, 4));}
                set
                {
                    ulong id = id__q(value);
...
*Optical flow from a flow sensor (e.g. optical mouse sensor)*/
        public class OPTICAL_FLOW : Pack, CommunicationChannel.Sendable
        {
            ...
            public void flow_rate_y_SET(float src, Inside ph)//Flow rate in radians/second about Y axis
            {
                ...
                BitUtils.set_bytes(BitUtils.FloatToInt32Bits(src), 4, data, ph.BYTE);
            } static readonly Meta meta100 = new Meta(100, 0, 0, 1, 27, 208, 0, _Ml, _vl);
...
*	 use uid*/
            public void uid2_SET(byte[] src, int pos, Inside ph)
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + 18; pos < src_max; pos++, BYTE += 1)
                    BitUtils.set_bytes((ulong)(src[pos]), 1, data,  BYTE);
            } static readonly Meta meta148 = new Meta(148, 2, 4, 1, 56, 433, 0, _Un);
        }/**
...
*	 the landing targe*/
            ...
            *	 the landing targe*/
            ...
            } static readonly Meta meta149 = new Meta(149, 0, 0, 1, 31, 238, 0, _Mn, _vn, _Ln, _nn, _Vn);
        }/**
...
*Reqest reading of flexifunction data*/
        public class FLEXIFUNCTION_READ_REQ : Pack, CommunicationChannel.Sendable
        {
...
*Flexifunction type and parameters for component at function index from buffer*/
        public class FLEXIFUNCTION_BUFFER_FUNCTION : Pack, CommunicationChannel.Sendable
        {
            ...
            public void data__SET(sbyte[] src, int pos)  //Settings data
            {
...
*Flexifunction type and parameters for component at function index from buffer*/
        public class FLEXIFUNCTION_BUFFER_FUNCTION_ACK : Pack, CommunicationChannel.Sendable
        {
...
*Acknowldge sucess or failure of a flexifunction command*/
        public class FLEXIFUNCTION_DIRECTORY : Pack, CommunicationChannel.Sendable
        {
            ...
            public void directory_data_SET(sbyte[] src, int pos)  //Settings data
            {
...
*Acknowldge sucess or failure of a flexifunction command*/
        public class FLEXIFUNCTION_DIRECTORY_ACK : Pack, CommunicationChannel.Sendable
        {
...
*Acknowldge sucess or failure of a flexifunction command*/
        public class FLEXIFUNCTION_COMMAND : Pack, CommunicationChannel.Sendable
        {
...
*Acknowldge sucess or failure of a flexifunction command*/
        public class FLEXIFUNCTION_COMMAND_ACK : Pack, CommunicationChannel.Sendable
        {
...
*Backwards compatible MAVLink version of SERIAL_UDB_EXTRA - F2: Format Part A*/
        public class SERIAL_UDB_EXTRA_F2_A : Pack, CommunicationChannel.Sendable
        {
...
*Backwards compatible version of SERIAL_UDB_EXTRA - F2: Part B*/
        public class SERIAL_UDB_EXTRA_F2_B : Pack, CommunicationChannel.Sendable
        {
...
*Backwards compatible version of SERIAL_UDB_EXTRA F4: format*/
        public class SERIAL_UDB_EXTRA_F4 : Pack, CommunicationChannel.Sendable
        {
...
*Backwards compatible version of SERIAL_UDB_EXTRA F5: format*/
        public class SERIAL_UDB_EXTRA_F5 : Pack, CommunicationChannel.Sendable
        {
...
*Backwards compatible version of SERIAL_UDB_EXTRA F6: format*/
        public class SERIAL_UDB_EXTRA_F6 : Pack, CommunicationChannel.Sendable
        {
...
*Backwards compatible version of SERIAL_UDB_EXTRA F7: format*/
        public class SERIAL_UDB_EXTRA_F7 : Pack, CommunicationChannel.Sendable
        {
...
*Backwards compatible version of SERIAL_UDB_EXTRA F8: format*/
        public class SERIAL_UDB_EXTRA_F8 : Pack, CommunicationChannel.Sendable
        {
...
*Backwards compatible version of SERIAL_UDB_EXTRA F13: format*/
        public class SERIAL_UDB_EXTRA_F13 : Pack, CommunicationChannel.Sendable
        {
...
*Backwards compatible version of SERIAL_UDB_EXTRA F14: format*/
        public class SERIAL_UDB_EXTRA_F14 : Pack, CommunicationChannel.Sendable
        {
...
*Backwards compatible version of SERIAL_UDB_EXTRA F15 format*/
        public class SERIAL_UDB_EXTRA_F15 : Pack, CommunicationChannel.Sendable
        {
            ...
            public void sue_ID_VEHICLE_MODEL_NAME_SET(byte[] src, int pos)  //Serial UDB Extra Model Name Of Vehicle
            {
            ...
            public void sue_ID_VEHICLE_REGISTRATION_SET(byte[] src, int pos)  //Serial UDB Extra Registraton Number of Vehicle
            {
...
*Backwards compatible version of SERIAL_UDB_EXTRA F16 format*/
        public class SERIAL_UDB_EXTRA_F16 : Pack, CommunicationChannel.Sendable
        {
            ...
            public void sue_ID_LEAD_PILOT_SET(byte[] src, int pos)  //Serial UDB Extra Name of Expected Lead Pilot
            {
                for(int BYTE =  0, src_max = pos + 40; pos < src_max; pos++, BYTE += 1)
                    BitUtils.set_bytes((ulong)(src[pos]), 1, data,  BYTE);
            }
            ...
            public void sue_ID_DIY_DRONES_URL_SET(byte[] src, int pos)  //Serial UDB Extra URL of Lead Pilot or Team
            {
...
*The altitude measured by sensors and IMU*/
        public class ALTITUDES : Pack, CommunicationChannel.Sendable
        {
...
*The airspeed measured by sensors and IMU*/
        public class AIRSPEEDS : Pack, CommunicationChannel.Sendable
        {
...
*Backwards compatible version of SERIAL_UDB_EXTRA F17 format*/
        public class SERIAL_UDB_EXTRA_F17 : Pack, CommunicationChannel.Sendable
        {
...
*Backwards compatible version of SERIAL_UDB_EXTRA F18 format*/
        public class SERIAL_UDB_EXTRA_F18 : Pack, CommunicationChannel.Sendable
        {
...
*Backwards compatible version of SERIAL_UDB_EXTRA F19 format*/
        public class SERIAL_UDB_EXTRA_F19 : Pack, CommunicationChannel.Sendable
        {
...
*Backwards compatible version of SERIAL_UDB_EXTRA F20 format*/
        public class SERIAL_UDB_EXTRA_F20 : Pack, CommunicationChannel.Sendable
        {
...
*Backwards compatible version of SERIAL_UDB_EXTRA F21 format*/
        public class SERIAL_UDB_EXTRA_F21 : Pack, CommunicationChannel.Sendable
        {
...
*Backwards compatible version of SERIAL_UDB_EXTRA F22 format*/
        public class SERIAL_UDB_EXTRA_F22 : Pack, CommunicationChannel.Sendable
        {
...
*	 the vector*/
        public class HOME_POSITION : Pack, CommunicationChannel.Sendable
        {
            ...
            *	 from the threshold / touchdown zone*/
            ...
            } static readonly Meta meta242 = new Meta(242, 0, 0, 0, 53, 416, 0, _CK);
        }/**
        ...
        public class SET_HOME_POSITION : Pack, CommunicationChannel.Sendable
        {
            ...
            *	 from the threshold / touchdown zone*/
            ...
            public void time_usec_SET(ulong src, Inside ph)//Timestamp (microseconds since UNIX epoch or microseconds since system boot)
            {
                ...
                BitUtils.set_bytes((ulong)(src), 8, data,  ph.BYTE);
            } static readonly Meta meta243 = new Meta(243, 0, 0, 0, 54, 424, 0, _bV);
        ...
        public class ADSB_VEHICLE : Pack, CommunicationChannel.Sendable
        {
            ...
            {callsign_SET(src.ToCharArray(), 0, src.Length, ph);} public void callsign_SET(char[] src, int pos, int items, Inside ph) //The callsign, 8+null
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta246 = new Meta(246, 3, 1, 0, 28, 213, 0, _NV);
        }/**
...
*	 way for testing new messages and getting experimental debug output*/
        ...
        } public class DEBUG_VECT : Pack, CommunicationChannel.Sendable
        {
            ...
            {name_SET(src.ToCharArray(), 0, src.Length, ph);} public void name_SET(char[] src, int pos, int items, Inside ph) //Name
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta250 = new Meta(250, 0, 0, 1, 21, 160, 0, _fV);
        }/**
...
*	 efficient way for testing new messages and getting experimental debug output*/
        public class NAMED_VALUE_FLOAT : Pack, CommunicationChannel.Sendable
        {
            ...
            {name_SET(src.ToCharArray(), 0, src.Length, ph);} public void name_SET(char[] src, int pos, int items, Inside ph) //Name of the debug variable
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta251 = new Meta(251, 0, 1, 0, 9, 64, 0, _CV);
        }/**
...
*	 efficient way for testing new messages and getting experimental debug output*/
        public class NAMED_VALUE_INT : Pack, CommunicationChannel.Sendable
        {
            ...
            {name_SET(src.ToCharArray(), 0, src.Length, ph);} public void name_SET(char[] src, int pos, int items, Inside ph) //Name of the debug variable
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta252 = new Meta(252, 0, 1, 0, 9, 64, 0, _cS);
        }/**
...
*	 wisely, these messages are buffered on the MCU and sent only at a limited rate (e.g. 10 Hz)*/
        public class STATUSTEXT : Pack, CommunicationChannel.Sendable
        {
            ...
            {text_SET(src.ToCharArray(), 0, src.Length, ph);} public void text_SET(char[] src, int pos, int items, Inside ph) //Status text message, without null termination character
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta253 = new Meta(253, 0, 0, 0, 2, 3, 0, _gS);
        }/**
...
*Control vehicle tone generation (buzzer)*/
        public class PLAY_TUNE : Pack, CommunicationChannel.Sendable
        {
            ...
            {tune_SET(src.ToCharArray(), 0, src.Length, ph);} public void tune_SET(char[] src, int pos, int items, Inside ph) //tune in board specific format
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta258 = new Meta(258, 0, 0, 0, 3, 16, 0, _LS);
        }/**
*WIP: Information about a camera*/
        public class CAMERA_INFORMATION : Pack, CommunicationChannel.Sendable
        {
            ...
            {cam_definition_uri_SET(src.ToCharArray(), 0, src.Length, ph);} public void cam_definition_uri_SET(char[] src, int pos, int items, Inside ph) //Camera definition URI (if any, otherwise only basic functions will be available).
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta259 = new Meta(259, 3, 2, 0, 93, 734, 0, _FS);
        }/**
...
*Information about a captured image*/
        public class CAMERA_IMAGE_CAPTURED : Pack, CommunicationChannel.Sendable
        {
            ...
            {file_url_SET(src.ToCharArray(), 0, src.Length, ph);} public void file_url_SET(char[] src, int pos, int items, Inside ph) //URL of image taken. Either local storage or http:foo.jpg if camera provides an HTTP interface.
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta263 = new Meta(263, 0, 1, 1, 51, 402, 2, _UB);
        }/**
...
*WIP: Information about video stream*/
        public class VIDEO_STREAM_INFORMATION : Pack, CommunicationChannel.Sendable
        {
            ...
            {uri_SET(src.ToCharArray(), 0, src.Length, ph);} public void uri_SET(char[] src, int pos, int items, Inside ph) //Video stream URI
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta269 = new Meta(269, 3, 1, 0, 17, 130, 2, _RB);
        }/**
*WIP: Message that sets video stream settings*/
        public class SET_VIDEO_STREAM_SETTINGS : Pack, CommunicationChannel.Sendable
        {
            ...
            {uri_SET(src.ToCharArray(), 0, src.Length, ph);} public void uri_SET(char[] src, int pos, int items, Inside ph) //Video stream URI
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta270 = new Meta(270, 3, 1, 0, 18, 138, 2, _kB);
        }/**
*Configure AP SSID and Password.*/
        public class WIFI_CONFIG_AP : Pack, CommunicationChannel.Sendable
        {
            ...
            {password_SET(src.ToCharArray(), 0, src.Length, ph);} public void password_SET(char[] src, int pos, int items, Inside ph) //Password. Leave it blank for an open AP.
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta299 = new Meta(299, 0, 0, 0, 1, 2, 2, _rB, _JB);
        }/**
...
*	 is available at http:uavcan.org*/
        public class UAVCAN_NODE_INFO : Pack, CommunicationChannel.Sendable
        {
            ...
            {name_SET(src.ToCharArray(), 0, src.Length, ph);} public void name_SET(char[] src, int pos, int items, Inside ph) //Node name string. For example, "sapog.px4.io".
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta311 = new Meta(311, 0, 2, 1, 37, 288, 0, _bN);
        }/**
...
*	 ID is stored as strin*/
            public void param_id_SET(char[] src, int pos, int items, Inside ph)
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta320 = new Meta(320, 0, 0, 0, 5, 32, 0, _KN);
        }/**
*Request all parameters of this component. After this request, all parameters are emitted.*/
...
*	 ID is stored as strin*/
            ...
            {param_value_SET(src.ToCharArray(), 0, src.Length, ph);} public void param_value_SET(char[] src, int pos, int items, Inside ph) //Parameter value
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta322 = new Meta(322, 2, 0, 0, 5, 38, 2, _NN, _xN);
        }/**
...
*	 ID is stored as strin*/
            ...
            {param_value_SET(src.ToCharArray(), 0, src.Length, ph);} public void param_value_SET(char[] src, int pos, int items, Inside ph) //Parameter value
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta323 = new Meta(323, 0, 0, 0, 3, 22, 2, _FN, _tN);
        }/**
...
*	 ID is stored as strin*/
            ...
            {param_value_SET(src.ToCharArray(), 0, src.Length, ph);} public void param_value_SET(char[] src, int pos, int items, Inside ph) //Parameter value (new value if PARAM_ACK_ACCEPTED, current value otherwise)
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta324 = new Meta(324, 0, 0, 0, 1, 8, 2, _HN, _WN);
        }/**
*Obstacle distances in front of the sensor, starting from the left in increment degrees to the right*/
        ...
        *	 simplifies the use of the mode flags. Note that manual input is enabled in all modes as a safety override.*/
        ...
        internal static MAV_MODE en__q(ulong id)
        {
            switch(id)
            {
                case 0:
        ...
        internal static uint id__q(MAV_MODE en)
        {
            switch(en)
            {
        ...
        *	 ARINC 424 is for commercial aircraft: A data format how to interpret waypoint/mission data*/
        ...
        internal static MAV_CMD en__c(ulong id)
        {
            switch(id)
            {
                case 0:
        ...
        *Result from a PARAM_EXT_SET message.*/
        ...
        static readonly Field _j = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
        ...
        static readonly Field _wo = new Field(0, true, 1, 4, 1, 0, 0, 0);
        static readonly Field _uo = new Field(0, true, 1, 4, 1, 0, 0, 0);
        static readonly Field _so = new Field(0, true, 1, 4, 1, 0, 0, 0);
        static readonly Field _Mo = new Field(0, true, 1, 4, 1, 0, 0, 0);
        static readonly Field _bg = new Field(0, true, 1, 2, 1, 0, 0, 0);
        static readonly Field _lg = new Field(0, true, 1, 2, 1, 0, 0, 0);
        static readonly Field _wg = new Field(0, true, 1, 2, 1, 0, 0, 0);
        static readonly Field _ug = new Field(0, true, 1, 2, 1, 0, 0, 0);
        static readonly Field _sg = new Field(0, true, 1, 2, 1, 0, 0, 0);
        static readonly Field _Mg = new Field(0, true, 1, 2, 1, 0, 0, 0);
        static readonly Field _vg = new Field(0, true, 1, 2, 1, 0, 0, 0);
        static readonly Field _Lg = new Field(0, true, 1, 2, 1, 0, 0, 0);
        static readonly Field _nO = new Field(0, true, 1, 8, 1, 0, 0, 0);
        static readonly Field _BO = new Field(0, true, 1, 8, 1, 0, 0, 0);
        static readonly Field _IO = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
        static readonly Field _xq = new Field(0, false, 1, 1, 1, 0, 0, 0);
        static readonly Field _Iq = new Field(0, false, 1, 4, 1, 0, 0, 0);
        static readonly Field _pq = new Field(0, false, 1, 1, 1, 0, 0, 0);
        static readonly Field _mq = new Field(0, false, 1, 1, 1, 0, 0, 0);
        static readonly Field _Ml = new Field(0, false, 1, 4, 1, 0, 0, 0);
        static readonly Field _vl = new Field(0, false, 1, 4, 1, 0, 0, 0);
        static readonly Field _Un = new Field(0, false, 18, 1, 1, 0, 0, 0);
        static readonly Field _Mn = new Field(0, false, 1, 4, 1, 0, 0, 0);
        static readonly Field _vn = new Field(0, false, 1, 4, 1, 0, 0, 0);
        static readonly Field _Ln = new Field(0, false, 1, 4, 1, 0, 0, 0);
        static readonly Field _nn = new Field(0, false, 4, 4, 1, 0, 0, 0);
        static readonly Field _Vn = new Field(0, false, 1, 1, 1, 0, 0, 0);
        static readonly Field _CK = new Field(0, true, 1, 8, 1, 0, 0, 0);
        static readonly Field _bV = new Field(0, true, 1, 8, 1, 0, 0, 0);
        static readonly Field _NV = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
        static readonly Field _fV = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
        static readonly Field _CV = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
        static readonly Field _cS = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
        static readonly Field _gS = new Field(5, true, -6, 2, 1, 0, 0, 0, 1);
        static readonly Field _LS = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
        static readonly Field _FS = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
        static readonly Field _UB = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
        static readonly Field _RB = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
        static readonly Field _kB = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
        static readonly Field _rB = new Field(5, true, -6, 2, 1, 0, 0, 0, 1);
        static readonly Field _JB = new Field(5, true, -7, 2, 1, 0, 0, 0, 1);
        static readonly Field _bN = new Field(5, true, -7, 2, 1, 0, 0, 0, 1);
        static readonly Field _KN = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
        static readonly Field _NN = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
        static readonly Field _xN = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
        static readonly Field _FN = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
        static readonly Field _tN = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
        static readonly Field _HN = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
        static readonly Field _WN = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
