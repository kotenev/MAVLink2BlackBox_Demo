...
namespace org.noname
{
    public class DemoDevice : Host
    {
        ...
        } public class CHANGE_OPERATOR_CONTROL : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            } static readonly Meta meta5 = new Meta(5, 0, 0, 0, 4, 24, 0, _p);
        ...
        } public class PARAM_REQUEST_READ : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            } public void param_id_SET(string src, Inside ph) {param_id_SET(src.ToCharArray(), 0, src.Length, ph);} public void param_id_SET(char[] src, int pos, int items, Inside ph)
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta20 = new Meta(20, 0, 0, 0, 5, 32, 0, _q);
        ...
        } public class PARAM_VALUE : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            } public void param_id_SET(string src, Inside ph) {param_id_SET(src.ToCharArray(), 0, src.Length, ph);} public void param_id_SET(char[] src, int pos, int items, Inside ph)
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta22 = new Meta(22, 2, 0, 0, 10, 68, 0, _n);
        } public class PARAM_SET : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            } public void param_id_SET(string src, Inside ph) {param_id_SET(src.ToCharArray(), 0, src.Length, ph);} public void param_id_SET(char[] src, int pos, int items, Inside ph)
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta23 = new Meta(23, 0, 0, 0, 8, 52, 0, _c);
        } public class GPS_RAW_INT : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            public void hdg_acc_SET(uint src, Inside ph)//Heading / track uncertainty in degrees * 1e5
            {
                ...
                BitUtils.set_bytes((ulong)(src), 4, data,  ph.BYTE);
            } static readonly Meta meta24 = new Meta(24, 4, 0, 1, 31, 236, 0, _OY, _bY, _mY, _TY, _lY);
        ...
        } public class SERVO_OUTPUT_RAW : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            public void servo16_raw_SET(ushort src, Inside ph)//Servo output 16 value, in microsecond
            {
                ...
                BitUtils.set_bytes((ulong)(src), 2, data,  ph.BYTE);
            } static readonly Meta meta36 = new Meta(36, 8, 1, 0, 22, 168, 0, _tH, _OH, _bH, _mH, _TH, _lH, _jH, _LH);
        ...
        } public class SET_GPS_GLOBAL_ORIGIN : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            } static readonly Meta meta48 = new Meta(48, 0, 0, 0, 14, 104, 0, _QV);
        } public class GPS_GLOBAL_ORIGIN : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            public void time_usec_SET(ulong src, Inside ph)//Timestamp (microseconds since UNIX epoch or microseconds since system boot
            {
                ...
                BitUtils.set_bytes((ulong)(src), 8, data,  ph.BYTE);
            } static readonly Meta meta49 = new Meta(49, 0, 0, 0, 13, 96, 0, _yV);
        } public class PARAM_MAP_RC : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            } public void param_id_SET(string src, Inside ph) {param_id_SET(src.ToCharArray(), 0, src.Length, ph);} public void param_id_SET(char[] src, int pos, int items, Inside ph)
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta50 = new Meta(50, 0, 0, 0, 22, 168, 0, _FV);
        ...
        } public class COMMAND_ACK : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            public void target_component_SET(byte src, Inside ph)//WIP: Component which requested the command to be execute
            {
                ...
                BitUtils.set_bytes((ulong)(src), 1, data,  ph.BYTE);
            } static readonly Meta meta77 = new Meta(77, 0, 0, 0, 3, 11, 0, _Cd, _Fd, _vd, _Rd);
        ...
        } public class OPTICAL_FLOW : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            public void flow_rate_y_SET(float src, Inside ph)//Flow rate in radians/second about Y axi
            {
                ...
                BitUtils.set_bytes(BitUtils.FloatToInt32Bits(src), 4, data, ph.BYTE);
            } static readonly Meta meta100 = new Meta(100, 0, 0, 1, 27, 208, 0, _lO, _jO);
        ...
        } public class AUTOPILOT_VERSION : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            } public void uid2_SET(byte[] src, int pos, Inside ph)
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + 18; pos < src_max; pos++, BYTE += 1)
                    BitUtils.set_bytes((ulong)(src[pos]), 1, data,  BYTE);
            } static readonly Meta meta148 = new Meta(148, 2, 4, 1, 54, 421, 0, _iQ);
        } public class LANDING_TARGET : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            public void position_valid_SET(byte src, Inside ph)
            {
                ...
                BitUtils.set_bytes((ulong)(src), 1, data,  ph.BYTE);
            } static readonly Meta meta149 = new Meta(149, 0, 0, 1, 31, 239, 0, _lQ, _jQ, _LQ, _QQ, _sQ);
        } public class FLEXIFUNCTION_SET : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal FLEXIFUNCTION_SET() : base(meta150, 0) { }
            internal FLEXIFUNCTION_SET(int bytes) : base(meta150, bytes) { }
            public byte target_system //System I
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  0, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  0);}
            ...
            static readonly Meta meta150 = new Meta(150, 0, 0, 0, 2, 16);
        } public class FLEXIFUNCTION_READ_REQ : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal FLEXIFUNCTION_READ_REQ() : base(meta151, 0) { }
            internal FLEXIFUNCTION_READ_REQ(int bytes) : base(meta151, bytes) { }
            public byte target_system //System I
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  0, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  0);}
            ...
            public short read_req_type //Type of flexifunction data requeste
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  2, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  2);}
            }

            public short data_index //index into data where neede
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  4, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  4);}
            }
            static readonly Meta meta151 = new Meta(151, 0, 0, 0, 6, 48);
        } public class FLEXIFUNCTION_BUFFER_FUNCTION : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal FLEXIFUNCTION_BUFFER_FUNCTION() : base(meta152, 0) { }
            internal FLEXIFUNCTION_BUFFER_FUNCTION(int bytes) : base(meta152, bytes) { }
            public ushort func_index //Function inde
            {
                get {  return (ushort)((ushort) BitUtils.get_bytes(data,  0, 2));}
                set {  BitUtils.set_bytes((ulong)(value), 2, data,  0);}
            }

            public ushort func_count //Total count of function
            {
                get {  return (ushort)((ushort) BitUtils.get_bytes(data,  2, 2));}
                set {  BitUtils.set_bytes((ulong)(value), 2, data,  2);}
            }

            public ushort data_address //Address in the flexifunction data, Set to 0xFFFF to use address in target memor
            {
                get {  return (ushort)((ushort) BitUtils.get_bytes(data,  4, 2));}
                set {  BitUtils.set_bytes((ulong)(value), 2, data,  4);}
            }
            ...
            public sbyte[] data_ //Settings dat
            {
                get {return data__GET(new sbyte[48], 0);}
                set {data__SET(value, 0)  ;}
            }
            public sbyte[]data__GET(sbyte[] dst_ch, int pos)  //Settings dat
            {
            ...
            public void data__SET(sbyte[] src, int pos)  //Settings dat
            {
                for(int BYTE =  10, src_max = pos + 48; pos < src_max; pos++, BYTE += 1)
                    BitUtils.set_bytes((byte)(src[pos]), 1, data,  BYTE);
            }

            static readonly Meta meta152 = new Meta(152, 4, 0, 0, 58, 464);
        } public class FLEXIFUNCTION_BUFFER_FUNCTION_ACK : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal FLEXIFUNCTION_BUFFER_FUNCTION_ACK() : base(meta153, 0) { }
            internal FLEXIFUNCTION_BUFFER_FUNCTION_ACK(int bytes) : base(meta153, bytes) { }
            public ushort func_index //Function inde
            {
                get {  return (ushort)((ushort) BitUtils.get_bytes(data,  0, 2));}
                set {  BitUtils.set_bytes((ulong)(value), 2, data,  0);}
            ...
            public ushort result //result of acknowledge, 0=fail, 1=goo
            {
                get {  return (ushort)((ushort) BitUtils.get_bytes(data,  2, 2));}
                set {  BitUtils.set_bytes((ulong)(value), 2, data,  2);}
            }
            ...
            static readonly Meta meta153 = new Meta(153, 2, 0, 0, 6, 48);
        } public class FLEXIFUNCTION_DIRECTORY : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal FLEXIFUNCTION_DIRECTORY() : base(meta155, 0) { }
            internal FLEXIFUNCTION_DIRECTORY(int bytes) : base(meta155, bytes) { }
            public byte target_system //System I
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  0, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  0);}
            ...
            public byte directory_type //0=inputs, 1=output
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  2, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  2);}
            }

            public byte start_index //index of first directory entry to writ
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  3, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  3);}
            }

            public byte count //count of directory entries to writ
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  4, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  4);}
            }

            public sbyte[] directory_data //Settings dat
            {
                get {return directory_data_GET(new sbyte[48], 0);}
                set {directory_data_SET(value, 0)  ;}
            }
            public sbyte[]directory_data_GET(sbyte[] dst_ch, int pos)  //Settings dat
            {
            ...
            public void directory_data_SET(sbyte[] src, int pos)  //Settings dat
            {
                for(int BYTE =  5, src_max = pos + 48; pos < src_max; pos++, BYTE += 1)
                    BitUtils.set_bytes((byte)(src[pos]), 1, data,  BYTE);
            }

            static readonly Meta meta155 = new Meta(155, 0, 0, 0, 53, 424);
        } public class FLEXIFUNCTION_DIRECTORY_ACK : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal FLEXIFUNCTION_DIRECTORY_ACK() : base(meta156, 0) { }
            internal FLEXIFUNCTION_DIRECTORY_ACK(int bytes) : base(meta156, bytes) { }
            public ushort result //result of acknowledge, 0=fail, 1=goo
            {
                get {  return (ushort)((ushort) BitUtils.get_bytes(data,  0, 2));}
                set {  BitUtils.set_bytes((ulong)(value), 2, data,  0);}
            ...
            static readonly Meta meta156 = new Meta(156, 1, 0, 0, 7, 56);
        } public class FLEXIFUNCTION_COMMAND : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal FLEXIFUNCTION_COMMAND() : base(meta157, 0) { }
            internal FLEXIFUNCTION_COMMAND(int bytes) : base(meta157, bytes) { }
            public byte target_system //System I
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  0, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  0);}
            ...
            public byte command_type //Flexifunction command typ
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  2, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  2);}
            }
            static readonly Meta meta157 = new Meta(157, 0, 0, 0, 3, 24);
        } public class FLEXIFUNCTION_COMMAND_ACK : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal FLEXIFUNCTION_COMMAND_ACK() : base(meta158, 0) { }
            internal FLEXIFUNCTION_COMMAND_ACK(int bytes) : base(meta158, bytes) { }
            public ushort command_type //Command acknowledge
            {
                get {  return (ushort)((ushort) BitUtils.get_bytes(data,  0, 2));}
                set {  BitUtils.set_bytes((ulong)(value), 2, data,  0);}
            }

            public ushort result //result of acknowledg
            {
                get {  return (ushort)((ushort) BitUtils.get_bytes(data,  2, 2));}
                set {  BitUtils.set_bytes((ulong)(value), 2, data,  2);}
            }
            static readonly Meta meta158 = new Meta(158, 2, 0, 0, 4, 32);
        } public class SERIAL_UDB_EXTRA_F2_A : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal SERIAL_UDB_EXTRA_F2_A() : base(meta170, 0) { }
            internal SERIAL_UDB_EXTRA_F2_A(int bytes) : base(meta170, bytes) { }
            public ushort sue_waypoint_index //Serial UDB Extra Waypoint Inde
            {
                get {  return (ushort)((ushort) BitUtils.get_bytes(data,  0, 2));}
                set {  BitUtils.set_bytes((ulong)(value), 2, data,  0);}
            }

            public ushort sue_cog //Serial UDB Extra GPS Course Over Groun
            {
                get {  return (ushort)((ushort) BitUtils.get_bytes(data,  2, 2));}
                set {  BitUtils.set_bytes((ulong)(value), 2, data,  2);}
            }

            public ushort sue_cpu_load //Serial UDB Extra CPU Loa
            {
                get {  return (ushort)((ushort) BitUtils.get_bytes(data,  4, 2));}
                set {  BitUtils.set_bytes((ulong)(value), 2, data,  4);}
            }

            public ushort sue_air_speed_3DIMU //Serial UDB Extra 3D IMU Air Spee
            {
                get {  return (ushort)((ushort) BitUtils.get_bytes(data,  6, 2));}
                set {  BitUtils.set_bytes((ulong)(value), 2, data,  6);}
            }

            public uint sue_time //Serial UDB Extra Tim
            {
                get {  return (uint)((uint) BitUtils.get_bytes(data,  8, 4));}
                set {  BitUtils.set_bytes((ulong)(value), 4, data,  8);}
            }

            public byte sue_status //Serial UDB Extra Statu
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  12, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  12);}
            }

            public int sue_latitude //Serial UDB Extra Latitud
            {
                get {  return (int)((int) BitUtils.get_bytes(data,  13, 4));}
                set {  BitUtils.set_bytes((uint)(value), 4, data,  13);}
            }

            public int sue_longitude //Serial UDB Extra Longitud
            {
                get {  return (int)((int) BitUtils.get_bytes(data,  17, 4));}
                set {  BitUtils.set_bytes((uint)(value), 4, data,  17);}
            }

            public int sue_altitude //Serial UDB Extra Altitud
            {
                get {  return (int)((int) BitUtils.get_bytes(data,  21, 4));}
                set {  BitUtils.set_bytes((uint)(value), 4, data,  21);}
            }

            public short sue_rmat0 //Serial UDB Extra Rmat
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  25, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  25);}
            }

            public short sue_rmat1 //Serial UDB Extra Rmat
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  27, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  27);}
            }

            public short sue_rmat2 //Serial UDB Extra Rmat
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  29, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  29);}
            }

            public short sue_rmat3 //Serial UDB Extra Rmat
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  31, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  31);}
            }

            public short sue_rmat4 //Serial UDB Extra Rmat
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  33, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  33);}
            }

            public short sue_rmat5 //Serial UDB Extra Rmat
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  35, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  35);}
            }

            public short sue_rmat6 //Serial UDB Extra Rmat
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  37, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  37);}
            }

            public short sue_rmat7 //Serial UDB Extra Rmat
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  39, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  39);}
            }

            public short sue_rmat8 //Serial UDB Extra Rmat
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  41, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  41);}
            }

            public short sue_sog //Serial UDB Extra Speed Over Groun
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  43, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  43);}
            }

            public short sue_estimated_wind_0 //Serial UDB Extra Estimated Wind
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  45, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  45);}
            }

            public short sue_estimated_wind_1 //Serial UDB Extra Estimated Wind
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  47, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  47);}
            }

            public short sue_estimated_wind_2 //Serial UDB Extra Estimated Wind
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  49, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  49);}
            }
            ...
            public short sue_magFieldEarth0 //Serial UDB Extra Magnetic Field Earth 0
            {
                ...
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  51);}
            }
            ...
            public short sue_magFieldEarth1 //Serial UDB Extra Magnetic Field Earth 1
            {
                ...
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  53);}
            }
            ...
            public short sue_magFieldEarth2 //Serial UDB Extra Magnetic Field Earth 2
            {
                ...
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  55);}
            }

            public short sue_svs //Serial UDB Extra Number of Sattelites in Vie
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  57, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  57);}
            }

            public short sue_hdop //Serial UDB Extra GPS Horizontal Dilution of Precisio
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  59, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  59);}
            }
            static readonly Meta meta170 = new Meta(170, 4, 1, 0, 61, 488);
        } public class SERIAL_UDB_EXTRA_F2_B : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal SERIAL_UDB_EXTRA_F2_B() : base(meta171, 0) { }
            internal SERIAL_UDB_EXTRA_F2_B(int bytes) : base(meta171, bytes) { }
            public uint sue_time //Serial UDB Extra Tim
            {
                get {  return (uint)((uint) BitUtils.get_bytes(data,  0, 4));}
                set {  BitUtils.set_bytes((ulong)(value), 4, data,  0);}
            ...
            public uint sue_flags //Serial UDB Extra Status Flag
            {
                get {  return (uint)((uint) BitUtils.get_bytes(data,  4, 4));}
                set {  BitUtils.set_bytes((ulong)(value), 4, data,  4);}
            }

            public short sue_pwm_input_1 //Serial UDB Extra PWM Input Channel
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  8, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  8);}
            }

            public short sue_pwm_input_2 //Serial UDB Extra PWM Input Channel
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  10, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  10);}
            }

            public short sue_pwm_input_3 //Serial UDB Extra PWM Input Channel
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  12, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  12);}
            }

            public short sue_pwm_input_4 //Serial UDB Extra PWM Input Channel
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  14, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  14);}
            }

            public short sue_pwm_input_5 //Serial UDB Extra PWM Input Channel
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  16, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  16);}
            }

            public short sue_pwm_input_6 //Serial UDB Extra PWM Input Channel
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  18, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  18);}
            }

            public short sue_pwm_input_7 //Serial UDB Extra PWM Input Channel
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  20, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  20);}
            }

            public short sue_pwm_input_8 //Serial UDB Extra PWM Input Channel
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  22, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  22);}
            }

            public short sue_pwm_input_9 //Serial UDB Extra PWM Input Channel
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  24, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  24);}
            }

            public short sue_pwm_input_10 //Serial UDB Extra PWM Input Channel 1
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  26, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  26);}
            }

            public short sue_pwm_input_11 //Serial UDB Extra PWM Input Channel 1
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  28, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  28);}
            }

            public short sue_pwm_input_12 //Serial UDB Extra PWM Input Channel 1
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  30, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  30);}
            }

            public short sue_pwm_output_1 //Serial UDB Extra PWM Output Channel
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  32, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  32);}
            }

            public short sue_pwm_output_2 //Serial UDB Extra PWM Output Channel
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  34, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  34);}
            }

            public short sue_pwm_output_3 //Serial UDB Extra PWM Output Channel
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  36, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  36);}
            }

            public short sue_pwm_output_4 //Serial UDB Extra PWM Output Channel
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  38, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  38);}
            }

            public short sue_pwm_output_5 //Serial UDB Extra PWM Output Channel
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  40, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  40);}
            }

            public short sue_pwm_output_6 //Serial UDB Extra PWM Output Channel
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  42, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  42);}
            }

            public short sue_pwm_output_7 //Serial UDB Extra PWM Output Channel
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  44, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  44);}
            }

            public short sue_pwm_output_8 //Serial UDB Extra PWM Output Channel
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  46, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  46);}
            }

            public short sue_pwm_output_9 //Serial UDB Extra PWM Output Channel
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  48, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  48);}
            }

            public short sue_pwm_output_10 //Serial UDB Extra PWM Output Channel 1
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  50, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  50);}
            }

            public short sue_pwm_output_11 //Serial UDB Extra PWM Output Channel 1
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  52, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  52);}
            }

            public short sue_pwm_output_12 //Serial UDB Extra PWM Output Channel 1
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  54, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  54);}
            }

            public short sue_imu_location_x //Serial UDB Extra IMU Location
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  56, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  56);}
            }

            public short sue_imu_location_y //Serial UDB Extra IMU Location
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  58, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  58);}
            }

            public short sue_imu_location_z //Serial UDB Extra IMU Location
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  60, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  60);}
            }

            public short sue_location_error_earth_x //Serial UDB Location Error Earth
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  62, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  62);}
            }

            public short sue_location_error_earth_y //Serial UDB Location Error Earth
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  64, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  64);}
            }

            public short sue_location_error_earth_z //Serial UDB Location Error Earth
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  66, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  66);}
            }

            public short sue_osc_fails //Serial UDB Extra Oscillator Failure Coun
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  68, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  68);}
            }

            public short sue_imu_velocity_x //Serial UDB Extra IMU Velocity
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  70, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  70);}
            }

            public short sue_imu_velocity_y //Serial UDB Extra IMU Velocity
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  72, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  72);}
            }

            public short sue_imu_velocity_z //Serial UDB Extra IMU Velocity
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  74, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  74);}
            }

            public short sue_waypoint_goal_x //Serial UDB Extra Current Waypoint Goal
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  76, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  76);}
            }

            public short sue_waypoint_goal_y //Serial UDB Extra Current Waypoint Goal
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  78, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  78);}
            }

            public short sue_waypoint_goal_z //Serial UDB Extra Current Waypoint Goal
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  80, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  80);}
            }

            public short sue_aero_x //Aeroforce in UDB X Axi
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  82, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  82);}
            }

            public short sue_aero_y //Aeroforce in UDB Y Axi
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  84, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  84);}
            }

            public short sue_aero_z //Aeroforce in UDB Z axi
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  86, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  86);}
            }

            public short sue_barom_temp //SUE barometer temperatur
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  88, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  88);}
            }

            public int sue_barom_press //SUE barometer pressur
            {
                get {  return (int)((int) BitUtils.get_bytes(data,  90, 4));}
                set {  BitUtils.set_bytes((uint)(value), 4, data,  90);}
            }

            public int sue_barom_alt //SUE barometer altitud
            {
                get {  return (int)((int) BitUtils.get_bytes(data,  94, 4));}
                set {  BitUtils.set_bytes((uint)(value), 4, data,  94);}
            }

            public short sue_bat_volt //SUE battery voltag
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  98, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  98);}
            }

            public short sue_bat_amp //SUE battery curren
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  100, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  100);}
            }

            public short sue_bat_amp_hours //SUE battery milli amp hours use
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  102, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  102);}
            }

            public short sue_desired_height //Sue autopilot desired heigh
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  104, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  104);}
            }

            public short sue_memory_stack_free //Serial UDB Extra Stack Memory Fre
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  106, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  106);}
            }
            static readonly Meta meta171 = new Meta(171, 0, 2, 0, 108, 864);
        } public class SERIAL_UDB_EXTRA_F4 : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal SERIAL_UDB_EXTRA_F4() : base(meta172, 0) { }
            internal SERIAL_UDB_EXTRA_F4(int bytes) : base(meta172, bytes) { }
            public byte sue_ROLL_STABILIZATION_AILERONS //Serial UDB Extra Roll Stabilization with Ailerons Enable
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  0, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  0);}
            }

            public byte sue_ROLL_STABILIZATION_RUDDER //Serial UDB Extra Roll Stabilization with Rudder Enable
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  1, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  1);}
            }

            public byte sue_PITCH_STABILIZATION //Serial UDB Extra Pitch Stabilization Enable
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  2, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  2);}
            }

            public byte sue_YAW_STABILIZATION_RUDDER //Serial UDB Extra Yaw Stabilization using Rudder Enable
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  3, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  3);}
            }

            public byte sue_YAW_STABILIZATION_AILERON //Serial UDB Extra Yaw Stabilization using Ailerons Enable
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  4, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  4);}
            }

            public byte sue_AILERON_NAVIGATION //Serial UDB Extra Navigation with Ailerons Enable
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  5, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  5);}
            }

            public byte sue_RUDDER_NAVIGATION //Serial UDB Extra Navigation with Rudder Enable
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  6, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  6);}
            }

            public byte sue_ALTITUDEHOLD_STABILIZED //Serial UDB Extra Type of Alitude Hold when in Stabilized Mod
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  7, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  7);}
            }

            public byte sue_ALTITUDEHOLD_WAYPOINT //Serial UDB Extra Type of Alitude Hold when in Waypoint Mod
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  8, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  8);}
            }

            public byte sue_RACING_MODE //Serial UDB Extra Firmware racing mode enable
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  9, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  9);}
            }
            static readonly Meta meta172 = new Meta(172, 0, 0, 0, 10, 80);
        } public class SERIAL_UDB_EXTRA_F5 : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal SERIAL_UDB_EXTRA_F5() : base(meta173, 0) { }
            internal SERIAL_UDB_EXTRA_F5(int bytes) : base(meta173, bytes) { }
            public float sue_YAWKP_AILERON //Serial UDB YAWKP_AILERON Gain for Proporional control of navigatio
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  0, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 0);}
            }

            public float sue_YAWKD_AILERON //Serial UDB YAWKD_AILERON Gain for Rate control of navigatio
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  4, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 4);}
            }

            public float sue_ROLLKP //Serial UDB Extra ROLLKP Gain for Proportional control of roll stabilizatio
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  8, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 8);}
            }

            public float sue_ROLLKD //Serial UDB Extra ROLLKD Gain for Rate control of roll stabilizatio
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  12, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 12);}
            }
            static readonly Meta meta173 = new Meta(173, 0, 0, 0, 16, 128);
        } public class SERIAL_UDB_EXTRA_F6 : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal SERIAL_UDB_EXTRA_F6() : base(meta174, 0) { }
            internal SERIAL_UDB_EXTRA_F6(int bytes) : base(meta174, bytes) { }
            public float sue_PITCHGAIN //Serial UDB Extra PITCHGAIN Proportional Contro
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  0, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 0);}
            }

            public float sue_PITCHKD //Serial UDB Extra Pitch Rate Contro
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  4, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 4);}
            }

            public float sue_RUDDER_ELEV_MIX //Serial UDB Extra Rudder to Elevator Mi
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  8, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 8);}
            }

            public float sue_ROLL_ELEV_MIX //Serial UDB Extra Roll to Elevator Mi
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  12, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 12);}
            }

            public float sue_ELEVATOR_BOOST //Gain For Boosting Manual Elevator control When Plane Stabilize
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  16, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 16);}
            }
            static readonly Meta meta174 = new Meta(174, 0, 0, 0, 20, 160);
        } public class SERIAL_UDB_EXTRA_F7 : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal SERIAL_UDB_EXTRA_F7() : base(meta175, 0) { }
            internal SERIAL_UDB_EXTRA_F7(int bytes) : base(meta175, bytes) { }
            public float sue_YAWKP_RUDDER //Serial UDB YAWKP_RUDDER Gain for Proporional control of navigatio
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  0, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 0);}
            }

            public float sue_YAWKD_RUDDER //Serial UDB YAWKD_RUDDER Gain for Rate control of navigatio
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  4, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 4);}
            }

            public float sue_ROLLKP_RUDDER //Serial UDB Extra ROLLKP_RUDDER Gain for Proportional control of roll stabilizatio
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  8, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 8);}
            }

            public float sue_ROLLKD_RUDDER //Serial UDB Extra ROLLKD_RUDDER Gain for Rate control of roll stabilizatio
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  12, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 12);}
            }

            public float sue_RUDDER_BOOST //SERIAL UDB EXTRA Rudder Boost Gain to Manual Control when stabilize
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  16, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 16);}
            }

            public float sue_RTL_PITCH_DOWN //Serial UDB Extra Return To Landing - Angle to Pitch Plane Dow
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  20, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 20);}
            }
            static readonly Meta meta175 = new Meta(175, 0, 0, 0, 24, 192);
        } public class SERIAL_UDB_EXTRA_F8 : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal SERIAL_UDB_EXTRA_F8() : base(meta176, 0) { }
            internal SERIAL_UDB_EXTRA_F8(int bytes) : base(meta176, bytes) { }
            public float sue_HEIGHT_TARGET_MAX //Serial UDB Extra HEIGHT_TARGET_MA
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  0, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 0);}
            }

            public float sue_HEIGHT_TARGET_MIN //Serial UDB Extra HEIGHT_TARGET_MI
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  4, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 4);}
            }

            public float sue_ALT_HOLD_THROTTLE_MIN //Serial UDB Extra ALT_HOLD_THROTTLE_MI
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  8, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 8);}
            }

            public float sue_ALT_HOLD_THROTTLE_MAX //Serial UDB Extra ALT_HOLD_THROTTLE_MA
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  12, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 12);}
            }

            public float sue_ALT_HOLD_PITCH_MIN //Serial UDB Extra ALT_HOLD_PITCH_MI
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  16, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 16);}
            }

            public float sue_ALT_HOLD_PITCH_MAX //Serial UDB Extra ALT_HOLD_PITCH_MA
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  20, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 20);}
            }

            public float sue_ALT_HOLD_PITCH_HIGH //Serial UDB Extra ALT_HOLD_PITCH_HIG
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  24, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 24);}
            }
            static readonly Meta meta176 = new Meta(176, 0, 0, 0, 28, 224);
        } public class SERIAL_UDB_EXTRA_F13 : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal SERIAL_UDB_EXTRA_F13() : base(meta177, 0) { }
            internal SERIAL_UDB_EXTRA_F13(int bytes) : base(meta177, bytes) { }
            public short sue_week_no //Serial UDB Extra GPS Week Numbe
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  0, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  0);}
            }

            public int sue_lat_origin //Serial UDB Extra MP Origin Latitud
            {
                get {  return (int)((int) BitUtils.get_bytes(data,  2, 4));}
                set {  BitUtils.set_bytes((uint)(value), 4, data,  2);}
            }

            public int sue_lon_origin //Serial UDB Extra MP Origin Longitud
            {
                get {  return (int)((int) BitUtils.get_bytes(data,  6, 4));}
                set {  BitUtils.set_bytes((uint)(value), 4, data,  6);}
            }

            public int sue_alt_origin //Serial UDB Extra MP Origin Altitude Above Sea Leve
            {
                get {  return (int)((int) BitUtils.get_bytes(data,  10, 4));}
                set {  BitUtils.set_bytes((uint)(value), 4, data,  10);}
            }
            static readonly Meta meta177 = new Meta(177, 0, 0, 0, 14, 112);
        } public class SERIAL_UDB_EXTRA_F14 : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal SERIAL_UDB_EXTRA_F14() : base(meta178, 0) { }
            internal SERIAL_UDB_EXTRA_F14(int bytes) : base(meta178, bytes) { }
            public uint sue_TRAP_SOURCE //Serial UDB Extra Type Program Address of Last Tra
            {
                get {  return (uint)((uint) BitUtils.get_bytes(data,  0, 4));}
                set {  BitUtils.set_bytes((ulong)(value), 4, data,  0);}
            }

            public byte sue_WIND_ESTIMATION //Serial UDB Extra Wind Estimation Enable
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  4, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  4);}
            }

            public byte sue_GPS_TYPE //Serial UDB Extra Type of GPS Uni
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  5, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  5);}
            }

            public byte sue_DR //Serial UDB Extra Dead Reckoning Enable
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  6, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  6);}
            }

            public byte sue_BOARD_TYPE //Serial UDB Extra Type of UDB Hardwar
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  7, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  7);}
            }

            public byte sue_AIRFRAME //Serial UDB Extra Type of Airfram
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  8, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  8);}
            }

            public short sue_RCON //Serial UDB Extra Reboot Register of DSPI
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  9, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  9);}
            }

            public short sue_TRAP_FLAGS //Serial UDB Extra  Last dspic Trap Flag
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  11, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  11);}
            }

            public short sue_osc_fail_count //Serial UDB Extra Number of Ocillator Failure
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  13, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  13);}
            }

            public byte sue_CLOCK_CONFIG //Serial UDB Extra UDB Internal Clock Configuratio
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  15, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  15);}
            }

            public byte sue_FLIGHT_PLAN_TYPE //Serial UDB Extra Type of Flight Pla
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  16, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  16);}
            }
            static readonly Meta meta178 = new Meta(178, 0, 1, 0, 17, 136);
        } public class SERIAL_UDB_EXTRA_F15 : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal SERIAL_UDB_EXTRA_F15() : base(meta179, 0) { }
            internal SERIAL_UDB_EXTRA_F15(int bytes) : base(meta179, bytes) { }
            public byte[] sue_ID_VEHICLE_MODEL_NAME //Serial UDB Extra Model Name Of Vehicl
            {
                get {return sue_ID_VEHICLE_MODEL_NAME_GET(new byte[40], 0);}
                set {sue_ID_VEHICLE_MODEL_NAME_SET(value, 0)  ;}
            }
            public byte[]sue_ID_VEHICLE_MODEL_NAME_GET(byte[] dst_ch, int pos)  //Serial UDB Extra Model Name Of Vehicl
            {
            ...
            public void sue_ID_VEHICLE_MODEL_NAME_SET(byte[] src, int pos)  //Serial UDB Extra Model Name Of Vehicl
            {
            ...
            public byte[] sue_ID_VEHICLE_REGISTRATION //Serial UDB Extra Registraton Number of Vehicl
            {
                get {return sue_ID_VEHICLE_REGISTRATION_GET(new byte[20], 0);}
                set {sue_ID_VEHICLE_REGISTRATION_SET(value, 0)  ;}
            }
            public byte[]sue_ID_VEHICLE_REGISTRATION_GET(byte[] dst_ch, int pos)  //Serial UDB Extra Registraton Number of Vehicl
            {
            ...
            public void sue_ID_VEHICLE_REGISTRATION_SET(byte[] src, int pos)  //Serial UDB Extra Registraton Number of Vehicl
            {
                for(int BYTE =  40, src_max = pos + 20; pos < src_max; pos++, BYTE += 1)
                    BitUtils.set_bytes((ulong)(src[pos]), 1, data,  BYTE);
            }

            static readonly Meta meta179 = new Meta(179, 0, 0, 0, 60, 480);
        } public class SERIAL_UDB_EXTRA_F16 : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal SERIAL_UDB_EXTRA_F16() : base(meta180, 0) { }
            internal SERIAL_UDB_EXTRA_F16(int bytes) : base(meta180, bytes) { }
            public byte[] sue_ID_LEAD_PILOT //Serial UDB Extra Name of Expected Lead Pilo
            {
                get {return sue_ID_LEAD_PILOT_GET(new byte[40], 0);}
                set {sue_ID_LEAD_PILOT_SET(value, 0)  ;}
            }
            public byte[]sue_ID_LEAD_PILOT_GET(byte[] dst_ch, int pos)  //Serial UDB Extra Name of Expected Lead Pilo
            {
                for(int BYTE = 0, dst_max = pos + 40; pos < dst_max ; pos++,  BYTE += 1)
                    dst_ch[pos] = (byte)((byte) BitUtils.get_bytes(data,  BYTE, 1));
                return dst_ch;
            ...
            public void sue_ID_LEAD_PILOT_SET(byte[] src, int pos)  //Serial UDB Extra Name of Expected Lead Pilo
            {
                for(int BYTE =  0, src_max = pos + 40; pos < src_max; pos++, BYTE += 1)
                    BitUtils.set_bytes((ulong)(src[pos]), 1, data,  BYTE);
            }
            ...
            public byte[] sue_ID_DIY_DRONES_URL //Serial UDB Extra URL of Lead Pilot or Tea
            {
                get {return sue_ID_DIY_DRONES_URL_GET(new byte[70], 0);}
                set {sue_ID_DIY_DRONES_URL_SET(value, 0)  ;}
            }
            public byte[]sue_ID_DIY_DRONES_URL_GET(byte[] dst_ch, int pos)  //Serial UDB Extra URL of Lead Pilot or Tea
            {
            ...
            public void sue_ID_DIY_DRONES_URL_SET(byte[] src, int pos)  //Serial UDB Extra URL of Lead Pilot or Tea
            {
                for(int BYTE =  40, src_max = pos + 70; pos < src_max; pos++, BYTE += 1)
                    BitUtils.set_bytes((ulong)(src[pos]), 1, data,  BYTE);
            }

            static readonly Meta meta180 = new Meta(180, 0, 0, 0, 110, 880);
        } public class ALTITUDES : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal ALTITUDES() : base(meta181, 0) { }
            internal ALTITUDES(int bytes) : base(meta181, bytes) { }
            public uint time_boot_ms //Timestamp (milliseconds since system boot
            {
                get {  return (uint)((uint) BitUtils.get_bytes(data,  0, 4));}
                set {  BitUtils.set_bytes((ulong)(value), 4, data,  0);}
            ...
            public int alt_gps //GPS altitude in meters, expressed as * 1000 (millimeters), above MS
            {
                get {  return (int)((int) BitUtils.get_bytes(data,  4, 4));}
                set {  BitUtils.set_bytes((uint)(value), 4, data,  4);}
            }
            ...
            static readonly Meta meta181 = new Meta(181, 0, 1, 0, 28, 224);
        } public class AIRSPEEDS : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal AIRSPEEDS() : base(meta182, 0) { }
            internal AIRSPEEDS(int bytes) : base(meta182, bytes) { }
            public uint time_boot_ms //Timestamp (milliseconds since system boot
            {
                get {  return (uint)((uint) BitUtils.get_bytes(data,  0, 4));}
                set {  BitUtils.set_bytes((ulong)(value), 4, data,  0);}
            ...
            public short airspeed_imu //Airspeed estimate from IMU, cm/
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  4, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  4);}
            }

            public short airspeed_pitot //Pitot measured forward airpseed, cm/
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  6, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  6);}
            }

            public short airspeed_hot_wire //Hot wire anenometer measured airspeed, cm/
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  8, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  8);}
            }

            public short airspeed_ultrasonic //Ultrasonic measured airspeed, cm/
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  10, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  10);}
            }

            public short aoa //Angle of attack sensor, degrees * 1
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  12, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  12);}
            }

            public short aoy //Yaw angle sensor, degrees * 1
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  14, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  14);}
            }
            static readonly Meta meta182 = new Meta(182, 0, 1, 0, 16, 128);
        } public class SERIAL_UDB_EXTRA_F17 : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal SERIAL_UDB_EXTRA_F17() : base(meta183, 0) { }
            internal SERIAL_UDB_EXTRA_F17(int bytes) : base(meta183, bytes) { }
            public float sue_feed_forward //SUE Feed Forward Gai
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  0, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 0);}
            }

            public float sue_turn_rate_nav //SUE Max Turn Rate when Navigatin
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  4, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 4);}
            }

            public float sue_turn_rate_fbw //SUE Max Turn Rate in Fly By Wire Mod
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  8, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 8);}
            }
            static readonly Meta meta183 = new Meta(183, 0, 0, 0, 12, 96);
        } public class SERIAL_UDB_EXTRA_F18 : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal SERIAL_UDB_EXTRA_F18() : base(meta184, 0) { }
            internal SERIAL_UDB_EXTRA_F18(int bytes) : base(meta184, bytes) { }
            public float angle_of_attack_normal //SUE Angle of Attack Norma
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  0, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 0);}
            }

            public float angle_of_attack_inverted //SUE Angle of Attack Inverte
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  4, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 4);}
            }

            public float elevator_trim_normal //SUE Elevator Trim Norma
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  8, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 8);}
            }

            public float elevator_trim_inverted //SUE Elevator Trim Inverte
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  12, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 12);}
            }

            public float reference_speed //SUE reference_spee
            {
                get {  return (float)(BitUtils.Int32BitsToFloat((uint) BitUtils.get_bytes(data,  16, 4)));}
                set {  BitUtils.set_bytes(BitUtils.FloatToInt32Bits(value), 4, data, 16);}
            }
            static readonly Meta meta184 = new Meta(184, 0, 0, 0, 20, 160);
        } public class SERIAL_UDB_EXTRA_F19 : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal SERIAL_UDB_EXTRA_F19() : base(meta185, 0) { }
            internal SERIAL_UDB_EXTRA_F19(int bytes) : base(meta185, bytes) { }
            public byte sue_aileron_output_channel //SUE aileron output channe
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  0, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  0);}
            }

            public byte sue_aileron_reversed //SUE aileron reverse
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  1, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  1);}
            }

            public byte sue_elevator_output_channel //SUE elevator output channe
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  2, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  2);}
            }

            public byte sue_elevator_reversed //SUE elevator reverse
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  3, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  3);}
            }

            public byte sue_throttle_output_channel //SUE throttle output channe
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  4, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  4);}
            }

            public byte sue_throttle_reversed //SUE throttle reverse
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  5, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  5);}
            }

            public byte sue_rudder_output_channel //SUE rudder output channe
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  6, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  6);}
            }

            public byte sue_rudder_reversed //SUE rudder reverse
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  7, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  7);}
            }
            static readonly Meta meta185 = new Meta(185, 0, 0, 0, 8, 64);
        } public class SERIAL_UDB_EXTRA_F20 : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal SERIAL_UDB_EXTRA_F20() : base(meta186, 0) { }
            internal SERIAL_UDB_EXTRA_F20(int bytes) : base(meta186, bytes) { }
            public byte sue_number_of_inputs //SUE Number of Input Channel
            {
                get {  return (byte)((byte) BitUtils.get_bytes(data,  0, 1));}
                set {  BitUtils.set_bytes((ulong)(value), 1, data,  0);}
            }

            public short sue_trim_value_input_1 //SUE UDB PWM Trim Value on Input
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  1, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  1);}
            }

            public short sue_trim_value_input_2 //SUE UDB PWM Trim Value on Input
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  3, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  3);}
            }

            public short sue_trim_value_input_3 //SUE UDB PWM Trim Value on Input
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  5, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  5);}
            }

            public short sue_trim_value_input_4 //SUE UDB PWM Trim Value on Input
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  7, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  7);}
            }

            public short sue_trim_value_input_5 //SUE UDB PWM Trim Value on Input
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  9, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  9);}
            }

            public short sue_trim_value_input_6 //SUE UDB PWM Trim Value on Input
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  11, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  11);}
            }

            public short sue_trim_value_input_7 //SUE UDB PWM Trim Value on Input
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  13, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  13);}
            }

            public short sue_trim_value_input_8 //SUE UDB PWM Trim Value on Input
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  15, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  15);}
            }

            public short sue_trim_value_input_9 //SUE UDB PWM Trim Value on Input
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  17, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  17);}
            }

            public short sue_trim_value_input_10 //SUE UDB PWM Trim Value on Input 1
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  19, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  19);}
            }

            public short sue_trim_value_input_11 //SUE UDB PWM Trim Value on Input 1
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  21, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  21);}
            }

            public short sue_trim_value_input_12 //SUE UDB PWM Trim Value on Input 1
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  23, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  23);}
            }
            static readonly Meta meta186 = new Meta(186, 0, 0, 0, 25, 200);
        } public class SERIAL_UDB_EXTRA_F21 : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal SERIAL_UDB_EXTRA_F21() : base(meta187, 0) { }
            internal SERIAL_UDB_EXTRA_F21(int bytes) : base(meta187, bytes) { }
            public short sue_accel_x_offset //SUE X accelerometer offse
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  0, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  0);}
            }

            public short sue_accel_y_offset //SUE Y accelerometer offse
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  2, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  2);}
            }

            public short sue_accel_z_offset //SUE Z accelerometer offse
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  4, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  4);}
            }

            public short sue_gyro_x_offset //SUE X gyro offse
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  6, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  6);}
            }

            public short sue_gyro_y_offset //SUE Y gyro offse
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  8, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  8);}
            }

            public short sue_gyro_z_offset //SUE Z gyro offse
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  10, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  10);}
            }
            static readonly Meta meta187 = new Meta(187, 0, 0, 0, 12, 96);
        } public class SERIAL_UDB_EXTRA_F22 : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            internal SERIAL_UDB_EXTRA_F22() : base(meta188, 0) { }
            internal SERIAL_UDB_EXTRA_F22(int bytes) : base(meta188, bytes) { }
            public short sue_accel_x_at_calibration //SUE X accelerometer at calibration tim
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  0, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  0);}
            }

            public short sue_accel_y_at_calibration //SUE Y accelerometer at calibration tim
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  2, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  2);}
            }

            public short sue_accel_z_at_calibration //SUE Z accelerometer at calibration tim
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  4, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  4);}
            }

            public short sue_gyro_x_at_calibration //SUE X gyro at calibration tim
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  6, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  6);}
            }

            public short sue_gyro_y_at_calibration //SUE Y gyro at calibration tim
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  8, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  8);}
            }

            public short sue_gyro_z_at_calibration //SUE Z gyro at calibration tim
            {
                get {  return (short)((short) BitUtils.get_bytes(data,  10, 2));}
                set {  BitUtils.set_bytes((ushort)(value), 2, data,  10);}
            }
            static readonly Meta meta188 = new Meta(188, 0, 0, 0, 12, 96);
        ...
        } public class HOME_POSITION : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            public void time_usec_SET(ulong src, Inside ph)//Timestamp (microseconds since UNIX epoch or microseconds since system boot
            {
                ...
                BitUtils.set_bytes((ulong)(src), 8, data,  ph.BYTE);
            } static readonly Meta meta242 = new Meta(242, 0, 0, 0, 53, 416, 0, _cZ);
        } public class SET_HOME_POSITION : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            public void time_usec_SET(ulong src, Inside ph)//Timestamp (microseconds since UNIX epoch or microseconds since system boot
            {
                ...
                BitUtils.set_bytes((ulong)(src), 8, data,  ph.BYTE);
            } static readonly Meta meta243 = new Meta(243, 0, 0, 0, 54, 424, 0, _ts);
        ...
        } public class ADSB_VEHICLE : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {callsign_SET(src.ToCharArray(), 0, src.Length, ph);} public void callsign_SET(char[] src, int pos, int items, Inside ph) //The callsign, 8+nul
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta246 = new Meta(246, 3, 1, 0, 28, 210, 0, _rs);
        ...
        } public class DEBUG_VECT : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {name_SET(src.ToCharArray(), 0, src.Length, ph);} public void name_SET(char[] src, int pos, int items, Inside ph) //Nam
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta250 = new Meta(250, 0, 0, 1, 21, 160, 0, _as);
        } public class NAMED_VALUE_FLOAT : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {name_SET(src.ToCharArray(), 0, src.Length, ph);} public void name_SET(char[] src, int pos, int items, Inside ph) //Name of the debug variabl
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta251 = new Meta(251, 0, 1, 0, 9, 64, 0, _cs);
        } public class NAMED_VALUE_INT : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {name_SET(src.ToCharArray(), 0, src.Length, ph);} public void name_SET(char[] src, int pos, int items, Inside ph) //Name of the debug variabl
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta252 = new Meta(252, 0, 1, 0, 9, 64, 0, _IW);
        } public class STATUSTEXT : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {text_SET(src.ToCharArray(), 0, src.Length, ph);} public void text_SET(char[] src, int pos, int items, Inside ph) //Status text message, without null termination characte
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta253 = new Meta(253, 0, 0, 0, 2, 4, 0, _HW);
        ...
        } public class PLAY_TUNE : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {tune_SET(src.ToCharArray(), 0, src.Length, ph);} public void tune_SET(char[] src, int pos, int items, Inside ph) //tune in board specific forma
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta258 = new Meta(258, 0, 0, 0, 3, 16, 0, _LW);
        } public class CAMERA_INFORMATION : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {cam_definition_uri_SET(src.ToCharArray(), 0, src.Length, ph);} public void cam_definition_uri_SET(char[] src, int pos, int items, Inside ph) //Camera definition URI (if any, otherwise only basic functions will be available)
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta259 = new Meta(259, 3, 2, 0, 93, 731, 0, _BW);
        ...
        } public class CAMERA_IMAGE_CAPTURED : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {file_url_SET(src.ToCharArray(), 0, src.Length, ph);} public void file_url_SET(char[] src, int pos, int items, Inside ph) //foo.jpg if camera provides an HTTP interface
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta263 = new Meta(263, 0, 1, 1, 51, 402, 2, _iy);
        ...
        } public class VIDEO_STREAM_INFORMATION : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {uri_SET(src.ToCharArray(), 0, src.Length, ph);} public void uri_SET(char[] src, int pos, int items, Inside ph) //Video stream UR
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta269 = new Meta(269, 3, 1, 0, 17, 130, 2, _Py);
        } public class SET_VIDEO_STREAM_SETTINGS : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {uri_SET(src.ToCharArray(), 0, src.Length, ph);} public void uri_SET(char[] src, int pos, int items, Inside ph) //Video stream UR
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta270 = new Meta(270, 3, 1, 0, 18, 138, 2, _Sy);
        } public class WIFI_CONFIG_AP : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {password_SET(src.ToCharArray(), 0, src.Length, ph);} public void password_SET(char[] src, int pos, int items, Inside ph) //Password. Leave it blank for an open AP
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta299 = new Meta(299, 0, 0, 0, 1, 2, 2, _ky, _Xy);
        ...
        } public class UAVCAN_NODE_INFO : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {name_SET(src.ToCharArray(), 0, src.Length, ph);} public void name_SET(char[] src, int pos, int items, Inside ph) //Node name string. For example, "sapog.px4.io"
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta311 = new Meta(311, 0, 2, 1, 37, 288, 0, _tr);
        } public class PARAM_EXT_REQUEST_READ : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            } public void param_id_SET(string src, Inside ph) {param_id_SET(src.ToCharArray(), 0, src.Length, ph);} public void param_id_SET(char[] src, int pos, int items, Inside ph)
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta320 = new Meta(320, 0, 0, 0, 5, 32, 0, _Zr);
        ...
        } public class PARAM_EXT_VALUE : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {param_value_SET(src.ToCharArray(), 0, src.Length, ph);} public void param_value_SET(char[] src, int pos, int items, Inside ph) //Parameter valu
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta322 = new Meta(322, 2, 0, 0, 5, 38, 2, _rr, _Cr);
        } public class PARAM_EXT_SET : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {param_value_SET(src.ToCharArray(), 0, src.Length, ph);} public void param_value_SET(char[] src, int pos, int items, Inside ph) //Parameter valu
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta323 = new Meta(323, 0, 0, 0, 3, 22, 2, _Br, _gr);
        } public class PARAM_EXT_ACK : Pack, LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
        {
            ...
            {param_value_SET(src.ToCharArray(), 0, src.Length, ph);} public void param_value_SET(char[] src, int pos, int items, Inside ph) //Parameter value (new value if PARAM_ACK_ACCEPTED, current value otherwise
            {
                ...
                for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                    BitUtils.set_bytes((ushort)(src[pos]), 2, data,  BYTE);
            } static readonly Meta meta324 = new Meta(324, 0, 0, 0, 2, 9, 2, _or, _hr);
                ...
                for(bool LOOP = false; ;)
                {
                    switch(id)
                    {
                        ...
                        case 150:
                            ...
                            if(OnFLEXIFUNCTION_SETReceive == null) return null;
                            ph.setPack(pack);
                            OnFLEXIFUNCTION_SETReceive(this, ph, (FLEXIFUNCTION_SET) pack);
                            if(LOOP) break;
                            return null;
                        case 151:
                            if(pack == null) return new FLEXIFUNCTION_READ_REQ();
                            if(OnFLEXIFUNCTION_READ_REQReceive == null) return null;
                            ph.setPack(pack);
                            OnFLEXIFUNCTION_READ_REQReceive(this, ph, (FLEXIFUNCTION_READ_REQ) pack);
                            if(LOOP) break;
                            return null;
                        case 152:
                            if(pack == null) return new FLEXIFUNCTION_BUFFER_FUNCTION();
                            if(OnFLEXIFUNCTION_BUFFER_FUNCTIONReceive == null) return null;
                            ph.setPack(pack);
                            OnFLEXIFUNCTION_BUFFER_FUNCTIONReceive(this, ph, (FLEXIFUNCTION_BUFFER_FUNCTION) pack);
                            if(LOOP) break;
                            return null;
                        case 153:
                            if(pack == null) return new FLEXIFUNCTION_BUFFER_FUNCTION_ACK();
                            if(OnFLEXIFUNCTION_BUFFER_FUNCTION_ACKReceive == null) return null;
                            ph.setPack(pack);
                            OnFLEXIFUNCTION_BUFFER_FUNCTION_ACKReceive(this, ph, (FLEXIFUNCTION_BUFFER_FUNCTION_ACK) pack);
                            if(LOOP) break;
                            return null;
                        case 155:
                            if(pack == null) return new FLEXIFUNCTION_DIRECTORY();
                            if(OnFLEXIFUNCTION_DIRECTORYReceive == null) return null;
                            ph.setPack(pack);
                            OnFLEXIFUNCTION_DIRECTORYReceive(this, ph, (FLEXIFUNCTION_DIRECTORY) pack);
                            if(LOOP) break;
                            return null;
                        case 156:
                            if(pack == null) return new FLEXIFUNCTION_DIRECTORY_ACK();
                            if(OnFLEXIFUNCTION_DIRECTORY_ACKReceive == null) return null;
                            ph.setPack(pack);
                            OnFLEXIFUNCTION_DIRECTORY_ACKReceive(this, ph, (FLEXIFUNCTION_DIRECTORY_ACK) pack);
                            if(LOOP) break;
                            return null;
                        case 157:
                            if(pack == null) return new FLEXIFUNCTION_COMMAND();
                            if(OnFLEXIFUNCTION_COMMANDReceive == null) return null;
                            ph.setPack(pack);
                            OnFLEXIFUNCTION_COMMANDReceive(this, ph, (FLEXIFUNCTION_COMMAND) pack);
                            if(LOOP) break;
                            return null;
                        case 158:
                            if(pack == null) return new FLEXIFUNCTION_COMMAND_ACK();
                            if(OnFLEXIFUNCTION_COMMAND_ACKReceive == null) return null;
                            ph.setPack(pack);
                            OnFLEXIFUNCTION_COMMAND_ACKReceive(this, ph, (FLEXIFUNCTION_COMMAND_ACK) pack);
                            if(LOOP) break;
                            return null;
                        case 170:
                            if(pack == null) return new SERIAL_UDB_EXTRA_F2_A();
                            if(OnSERIAL_UDB_EXTRA_F2_AReceive == null) return null;
                            ph.setPack(pack);
                            OnSERIAL_UDB_EXTRA_F2_AReceive(this, ph, (SERIAL_UDB_EXTRA_F2_A) pack);
                            if(LOOP) break;
                            return null;
                        case 171:
                            if(pack == null) return new SERIAL_UDB_EXTRA_F2_B();
                            if(OnSERIAL_UDB_EXTRA_F2_BReceive == null) return null;
                            ph.setPack(pack);
                            OnSERIAL_UDB_EXTRA_F2_BReceive(this, ph, (SERIAL_UDB_EXTRA_F2_B) pack);
                            if(LOOP) break;
                            return null;
                        case 172:
                            if(pack == null) return new SERIAL_UDB_EXTRA_F4();
                            if(OnSERIAL_UDB_EXTRA_F4Receive == null) return null;
                            ph.setPack(pack);
                            OnSERIAL_UDB_EXTRA_F4Receive(this, ph, (SERIAL_UDB_EXTRA_F4) pack);
                            if(LOOP) break;
                            return null;
                        case 173:
                            if(pack == null) return new SERIAL_UDB_EXTRA_F5();
                            if(OnSERIAL_UDB_EXTRA_F5Receive == null) return null;
                            ph.setPack(pack);
                            OnSERIAL_UDB_EXTRA_F5Receive(this, ph, (SERIAL_UDB_EXTRA_F5) pack);
                            if(LOOP) break;
                            return null;
                        case 174:
                            if(pack == null) return new SERIAL_UDB_EXTRA_F6();
                            if(OnSERIAL_UDB_EXTRA_F6Receive == null) return null;
                            ph.setPack(pack);
                            OnSERIAL_UDB_EXTRA_F6Receive(this, ph, (SERIAL_UDB_EXTRA_F6) pack);
                            if(LOOP) break;
                            return null;
                        case 175:
                            if(pack == null) return new SERIAL_UDB_EXTRA_F7();
                            if(OnSERIAL_UDB_EXTRA_F7Receive == null) return null;
                            ph.setPack(pack);
                            OnSERIAL_UDB_EXTRA_F7Receive(this, ph, (SERIAL_UDB_EXTRA_F7) pack);
                            if(LOOP) break;
                            return null;
                        case 176:
                            if(pack == null) return new SERIAL_UDB_EXTRA_F8();
                            if(OnSERIAL_UDB_EXTRA_F8Receive == null) return null;
                            ph.setPack(pack);
                            OnSERIAL_UDB_EXTRA_F8Receive(this, ph, (SERIAL_UDB_EXTRA_F8) pack);
                            if(LOOP) break;
                            return null;
                        case 177:
                            if(pack == null) return new SERIAL_UDB_EXTRA_F13();
                            if(OnSERIAL_UDB_EXTRA_F13Receive == null) return null;
                            ph.setPack(pack);
                            OnSERIAL_UDB_EXTRA_F13Receive(this, ph, (SERIAL_UDB_EXTRA_F13) pack);
                            if(LOOP) break;
                            return null;
                        case 178:
                            if(pack == null) return new SERIAL_UDB_EXTRA_F14();
                            if(OnSERIAL_UDB_EXTRA_F14Receive == null) return null;
                            ph.setPack(pack);
                            OnSERIAL_UDB_EXTRA_F14Receive(this, ph, (SERIAL_UDB_EXTRA_F14) pack);
                            if(LOOP) break;
                            return null;
                        case 179:
                            if(pack == null) return new SERIAL_UDB_EXTRA_F15();
                            if(OnSERIAL_UDB_EXTRA_F15Receive == null) return null;
                            ph.setPack(pack);
                            OnSERIAL_UDB_EXTRA_F15Receive(this, ph, (SERIAL_UDB_EXTRA_F15) pack);
                            if(LOOP) break;
                            return null;
                        case 180:
                            if(pack == null) return new SERIAL_UDB_EXTRA_F16();
                            if(OnSERIAL_UDB_EXTRA_F16Receive == null) return null;
                            ph.setPack(pack);
                            OnSERIAL_UDB_EXTRA_F16Receive(this, ph, (SERIAL_UDB_EXTRA_F16) pack);
                            if(LOOP) break;
                            return null;
                        case 181:
                            if(pack == null) return new ALTITUDES();
                            if(OnALTITUDESReceive == null) return null;
                            ph.setPack(pack);
                            OnALTITUDESReceive(this, ph, (ALTITUDES) pack);
                            if(LOOP) break;
                            return null;
                        case 182:
                            if(pack == null) return new AIRSPEEDS();
                            if(OnAIRSPEEDSReceive == null) return null;
                            ph.setPack(pack);
                            OnAIRSPEEDSReceive(this, ph, (AIRSPEEDS) pack);
                            if(LOOP) break;
                            return null;
                        case 183:
                            if(pack == null) return new SERIAL_UDB_EXTRA_F17();
                            if(OnSERIAL_UDB_EXTRA_F17Receive == null) return null;
                            ph.setPack(pack);
                            OnSERIAL_UDB_EXTRA_F17Receive(this, ph, (SERIAL_UDB_EXTRA_F17) pack);
                            if(LOOP) break;
                            return null;
                        case 184:
                            if(pack == null) return new SERIAL_UDB_EXTRA_F18();
                            if(OnSERIAL_UDB_EXTRA_F18Receive == null) return null;
                            ph.setPack(pack);
                            OnSERIAL_UDB_EXTRA_F18Receive(this, ph, (SERIAL_UDB_EXTRA_F18) pack);
                            if(LOOP) break;
                            return null;
                        case 185:
                            if(pack == null) return new SERIAL_UDB_EXTRA_F19();
                            if(OnSERIAL_UDB_EXTRA_F19Receive == null) return null;
                            ph.setPack(pack);
                            OnSERIAL_UDB_EXTRA_F19Receive(this, ph, (SERIAL_UDB_EXTRA_F19) pack);
                            if(LOOP) break;
                            return null;
                        case 186:
                            if(pack == null) return new SERIAL_UDB_EXTRA_F20();
                            if(OnSERIAL_UDB_EXTRA_F20Receive == null) return null;
                            ph.setPack(pack);
                            OnSERIAL_UDB_EXTRA_F20Receive(this, ph, (SERIAL_UDB_EXTRA_F20) pack);
                            if(LOOP) break;
                            return null;
                        case 187:
                            if(pack == null) return new SERIAL_UDB_EXTRA_F21();
                            if(OnSERIAL_UDB_EXTRA_F21Receive == null) return null;
                            ph.setPack(pack);
                            OnSERIAL_UDB_EXTRA_F21Receive(this, ph, (SERIAL_UDB_EXTRA_F21) pack);
                            if(LOOP) break;
                            return null;
                        case 188:
                            if(pack == null) return new SERIAL_UDB_EXTRA_F22();
                            if(OnSERIAL_UDB_EXTRA_F22Receive == null) return null;
                            ph.setPack(pack);
                            OnSERIAL_UDB_EXTRA_F22Receive(this, ph, (SERIAL_UDB_EXTRA_F22) pack);
                            if(LOOP) break;
                            return null;
                        case 230:
        ...
        static readonly Field _OY = new Field(0, false, 1, 4, 1, 0, 0, 0);
        static readonly Field _bY = new Field(0, true, 1, 4, 1, 0, 0, 0);
        static readonly Field _mY = new Field(0, true, 1, 4, 1, 0, 0, 0);
        static readonly Field _TY = new Field(0, true, 1, 4, 1, 0, 0, 0);
        static readonly Field _lY = new Field(0, true, 1, 4, 1, 0, 0, 0);
        static readonly Field _tH = new Field(0, true, 1, 2, 1, 0, 0, 0);
        static readonly Field _OH = new Field(0, true, 1, 2, 1, 0, 0, 0);
        static readonly Field _bH = new Field(0, true, 1, 2, 1, 0, 0, 0);
        static readonly Field _mH = new Field(0, true, 1, 2, 1, 0, 0, 0);
        static readonly Field _TH = new Field(0, true, 1, 2, 1, 0, 0, 0);
        static readonly Field _lH = new Field(0, true, 1, 2, 1, 0, 0, 0);
        static readonly Field _jH = new Field(0, true, 1, 2, 1, 0, 0, 0);
        static readonly Field _LH = new Field(0, true, 1, 2, 1, 0, 0, 0);
        static readonly Field _QV = new Field(0, true, 1, 8, 1, 0, 0, 0);
        static readonly Field _yV = new Field(0, true, 1, 8, 1, 0, 0, 0);
        static readonly Field _FV = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
        static readonly Field _Cd = new Field(0, false, 1, 1, 1, 0, 0, 0);
        static readonly Field _Fd = new Field(0, false, 1, 4, 1, 0, 0, 0);
        static readonly Field _vd = new Field(0, false, 1, 1, 1, 0, 0, 0);
        static readonly Field _Rd = new Field(0, false, 1, 1, 1, 0, 0, 0);
        static readonly Field _lO = new Field(0, false, 1, 4, 1, 0, 0, 0);
        static readonly Field _jO = new Field(0, false, 1, 4, 1, 0, 0, 0);
        static readonly Field _iQ = new Field(0, false, 18, 1, 1, 0, 0, 0);
        static readonly Field _lQ = new Field(0, false, 1, 4, 1, 0, 0, 0);
        static readonly Field _jQ = new Field(0, false, 1, 4, 1, 0, 0, 0);
        static readonly Field _LQ = new Field(0, false, 1, 4, 1, 0, 0, 0);
        static readonly Field _QQ = new Field(0, false, 4, 4, 1, 0, 0, 0);
        static readonly Field _sQ = new Field(0, false, 1, 1, 1, 0, 0, 0);
        static readonly Field _cZ = new Field(0, true, 1, 8, 1, 0, 0, 0);
        static readonly Field _ts = new Field(0, true, 1, 8, 1, 0, 0, 0);
        static readonly Field _rs = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
        static readonly Field _as = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
        static readonly Field _cs = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
        static readonly Field _IW = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
        static readonly Field _HW = new Field(5, true, -6, 2, 1, 0, 0, 0, 1);
        static readonly Field _LW = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
        static readonly Field _BW = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
        static readonly Field _iy = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
        static readonly Field _Py = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
        static readonly Field _Sy = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
        static readonly Field _ky = new Field(5, true, -6, 2, 1, 0, 0, 0, 1);
        static readonly Field _Xy = new Field(5, true, -7, 2, 1, 0, 0, 0, 1);
        static readonly Field _tr = new Field(5, true, -7, 2, 1, 0, 0, 0, 1);
        static readonly Field _Zr = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
        static readonly Field _rr = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
        static readonly Field _Cr = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
        static readonly Field _Br = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
        static readonly Field _gr = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
        static readonly Field _or = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
        static readonly Field _hr = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
