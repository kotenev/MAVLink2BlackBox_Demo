...
public class DemoDevice extends Host
{
    ...
    } public static class CHANGE_OPERATOR_CONTROL extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        ...
        } static final Meta meta = new Meta(5, 0, 0, 0, 4, 24, 0, _e);
...
//ke
        ...
        {key_SET(src.toCharArray(), 0, src.length(), ph);} public void key_SET(char[]  src, int pos, int items, Bounds.Inside ph) //ke
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(7, 0, 0, 0, 1, 0, 0, _u);
    ...
    } public static class PARAM_REQUEST_READ extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        ...
        } public void param_id_SET(String src, Bounds.Inside ph) {param_id_SET(src.toCharArray(), 0, src.length(), ph);} public void param_id_SET(char[]  src, int pos, int items, Bounds.Inside ph)
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(20, 0, 0, 0, 5, 32, 0, _O);
    ...
    } public static class PARAM_VALUE extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        ...
        } public void param_id_SET(String src, Bounds.Inside ph) {param_id_SET(src.toCharArray(), 0, src.length(), ph);} public void param_id_SET(char[]  src, int pos, int items, Bounds.Inside ph)
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(22, 2, 0, 0, 10, 68, 0, _t);
    } public static class PARAM_SET extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        ...
        } public void param_id_SET(String src, Bounds.Inside ph) {param_id_SET(src.toCharArray(), 0, src.length(), ph);} public void param_id_SET(char[]  src, int pos, int items, Bounds.Inside ph)
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(23, 0, 0, 0, 8, 52, 0, _n);
...
//Heading / track uncertainty in degrees * 1e5
        ...
        public void hdg_acc_SET(long  src, Bounds.Inside ph)//Heading / track uncertainty in degrees * 1e5
        {
            ...
            set_bytes((src) & -1L, 4, data,  ph.BYTE);
        } static final Meta meta = new Meta(24, 4, 0, 1, 31, 236, 0, _QW, _wW, _UW, _aW, _cW);
...
//Servo output 16 value, in microsecond
        ...
        public void servo16_raw_SET(char  src, Bounds.Inside ph)//Servo output 16 value, in microsecond
        {
            ...
            set_bytes((char)(src) & -1L, 2, data,  ph.BYTE);
        } static final Meta meta = new Meta(36, 8, 1, 0, 22, 168, 0, _dz, _Qz, _wz, _Uz, _az, _cz, _Zz, _yz);
    ...
    } public static class MISSION_ITEM extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        ...
        {
            switch((int)get_bits(data, 276, 8))
            {
                case 0:
        ...
        public @MAV_MISSION_TYPE int mission_type_GET()//Mission type, see MAV_MISSION_TYP
        {
            switch((int)get_bits(data, 284, 3))
            {
                case 0:
                    return MAV_MISSION_TYPE.MAV_MISSION_TYPE_MISSION;
                case 1:
...
//Timestamp (microseconds since UNIX epoch or microseconds since system boot
        ...
        } static final Meta meta = new Meta(48, 0, 0, 0, 14, 104, 0, _IS);
...
//Timestamp (microseconds since UNIX epoch or microseconds since system boot
        ...
        public void time_usec_SET(long  src, Bounds.Inside ph)//Timestamp (microseconds since UNIX epoch or microseconds since system boot
        {
            ...
            set_bytes((src) & -1L, 8, data,  ph.BYTE);
        } static final Meta meta = new Meta(49, 0, 0, 0, 13, 96, 0, _BS);
    } public static class PARAM_MAP_RC extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        ...
        } public void param_id_SET(String src, Bounds.Inside ph) {param_id_SET(src.toCharArray(), 0, src.length(), ph);} public void param_id_SET(char[]  src, int pos, int items, Bounds.Inside ph)
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(50, 0, 0, 0, 22, 168, 0, _vS);
    ...
    } public static class COMMAND_INT extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        ...
        {
            switch((int)get_bits(data, 260, 8))
            {
                case 0:
                    return MAV_CMD.MAV_CMD_PREFLIGHT_STORAGE_ADVANCED;
                case 1:
    ...
    } public static class COMMAND_LONG extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        ...
        {
            switch((int)get_bits(data, 248, 8))
            {
                case 0:
                    return MAV_CMD.MAV_CMD_PREFLIGHT_STORAGE_ADVANCED;
                case 1:
...
//WIP: Component which requested the command to be execute
        ...
        public void target_component_SET(char  src, Bounds.Inside ph)//WIP: Component which requested the command to be execute
        {
            ...
            set_bytes((char)(src) & -1L, 1, data,  ph.BYTE);
        } static final Meta meta = new Meta(77, 0, 0, 0, 3, 11, 0, _qx, _vx, _Vx, _Px);
...
//Flow rate in radians/second about Y axi
        ...
        public void flow_rate_y_SET(float  src, Bounds.Inside ph)//Flow rate in radians/second about Y axi
        {
            ...
            set_bytes(Float.floatToIntBits(src) & -1L, 4, data, ph.BYTE);
        } static final Meta meta = new Meta(100, 0, 0, 1, 27, 208, 0, _cQ, _ZQ);
    ...
    } public static class AUTOPILOT_VERSION extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        ...
        } public void uid2_SET(char[]  src, int pos, Bounds.Inside ph)
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + 18; pos < src_max; pos++, BYTE += 1)
                set_bytes((char)(src[pos]) & -1L, 1, data,  BYTE);
        } static final Meta meta = new Meta(148, 2, 4, 1, 54, 421, 0, _NI);
...
//Quaternion of landing target orientation (w, x, y, z order, zero-rotation is 1, 0, 0, 0
        ...
        public void position_valid_SET(char  src, Bounds.Inside ph)
        {
            ...
            set_bytes((char)(src) & -1L, 1, data,  ph.BYTE);
        } static final Meta meta = new Meta(149, 0, 0, 1, 31, 239, 0, _cI, _ZI, _yI, _II, _XI);
    } public static class FLEXIFUNCTION_SET extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        FLEXIFUNCTION_SET() { super(meta, 0); }
        FLEXIFUNCTION_SET(int bytes) { super(meta, bytes); }
        public char target_system_GET()//System I
        {  return (char)((char) get_bytes(data,  0, 1)); }
        public void target_system_SET(char  src) //System I
        {  set_bytes((char)(src) & -1L, 1, data,  0); }
        ...
        public void target_component_SET(char  src) //Component I
        {  set_bytes((char)(src) & -1L, 1, data,  1); }
        static final Meta meta = new Meta(150, 0, 0, 0, 2, 16);
    } public static class FLEXIFUNCTION_READ_REQ extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        FLEXIFUNCTION_READ_REQ() { super(meta, 0); }
        FLEXIFUNCTION_READ_REQ(int bytes) { super(meta, bytes); }
        public char target_system_GET()//System I
        {  return (char)((char) get_bytes(data,  0, 1)); }
        public void target_system_SET(char  src) //System I
        {  set_bytes((char)(src) & -1L, 1, data,  0); }
        ...
        public void target_component_SET(char  src) //Component I
        {  set_bytes((char)(src) & -1L, 1, data,  1); }
        public short read_req_type_GET()//Type of flexifunction data requeste
        {  return (short)((short) get_bytes(data,  2, 2)); }
        public void read_req_type_SET(short  src) //Type of flexifunction data requeste
        {  set_bytes((short)(src) & -1L, 2, data,  2); }
        public short data_index_GET()//index into data where neede
        {  return (short)((short) get_bytes(data,  4, 2)); }
        public void data_index_SET(short  src) //index into data where neede
        {  set_bytes((short)(src) & -1L, 2, data,  4); }
        static final Meta meta = new Meta(151, 0, 0, 0, 6, 48);
    } public static class FLEXIFUNCTION_BUFFER_FUNCTION extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        FLEXIFUNCTION_BUFFER_FUNCTION() { super(meta, 0); }
        FLEXIFUNCTION_BUFFER_FUNCTION(int bytes) { super(meta, bytes); }
        public char func_index_GET()//Function inde
        {  return (char)((char) get_bytes(data,  0, 2)); }
        public void func_index_SET(char  src) //Function inde
        {  set_bytes((char)(src) & -1L, 2, data,  0); }
        public char func_count_GET()//Total count of function
        {  return (char)((char) get_bytes(data,  2, 2)); }
        public void func_count_SET(char  src) //Total count of function
        {  set_bytes((char)(src) & -1L, 2, data,  2); }
        public char data_address_GET()//Address in the flexifunction data, Set to 0xFFFF to use address in target memor
        {  return (char)((char) get_bytes(data,  4, 2)); }
        public void data_address_SET(char  src) //Address in the flexifunction data, Set to 0xFFFF to use address in target memor
        {  set_bytes((char)(src) & -1L, 2, data,  4); }
        public char data_size_GET()//Size of the
        {  return (char)((char) get_bytes(data,  6, 2)); }
        public void data_size_SET(char  src) //Size of the
        {  set_bytes((char)(src) & -1L, 2, data,  6); }
        public char target_system_GET()//System I
        {  return (char)((char) get_bytes(data,  8, 1)); }
        public void target_system_SET(char  src) //System I
        ...
        public void target_component_SET(char  src) //Component I
        {  set_bytes((char)(src) & -1L, 1, data,  9); }
        public byte[] data__GET(byte[]  dst_ch, int pos)  //Settings dat
        {
            for(int BYTE = 10, dst_max = pos + 48; pos < dst_max ; pos++,  BYTE += 1)
                dst_ch[pos] = (byte)((byte) get_bytes(data,  BYTE, 1));
            return dst_ch;
        }
        public byte[] data__GET()//Settings dat
        {return data__GET(new byte[48], 0);} public void data__SET(byte[]  src, int pos)  //Settings dat
        {
            for(int BYTE =  10, src_max = pos + 48; pos < src_max; pos++, BYTE += 1)
                set_bytes((byte)(src[pos]) & -1L, 1, data,  BYTE);
        }
        static final Meta meta = new Meta(152, 4, 0, 0, 58, 464);
    } public static class FLEXIFUNCTION_BUFFER_FUNCTION_ACK extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        FLEXIFUNCTION_BUFFER_FUNCTION_ACK() { super(meta, 0); }
        FLEXIFUNCTION_BUFFER_FUNCTION_ACK(int bytes) { super(meta, bytes); }
        public char func_index_GET()//Function inde
        {  return (char)((char) get_bytes(data,  0, 2)); }
        public void func_index_SET(char  src) //Function inde
        {  set_bytes((char)(src) & -1L, 2, data,  0); }
        public char result_GET()//result of acknowledge, 0=fail, 1=goo
        {  return (char)((char) get_bytes(data,  2, 2)); }
        public void result_SET(char  src) //result of acknowledge, 0=fail, 1=goo
        {  set_bytes((char)(src) & -1L, 2, data,  2); }
        public char target_system_GET()//System I
        {  return (char)((char) get_bytes(data,  4, 1)); }
        public void target_system_SET(char  src) //System I
        ...
        public void target_component_SET(char  src) //Component I
        {  set_bytes((char)(src) & -1L, 1, data,  5); }
        static final Meta meta = new Meta(153, 2, 0, 0, 6, 48);
    } public static class FLEXIFUNCTION_DIRECTORY extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        FLEXIFUNCTION_DIRECTORY() { super(meta, 0); }
        FLEXIFUNCTION_DIRECTORY(int bytes) { super(meta, bytes); }
        public char target_system_GET()//System I
        {  return (char)((char) get_bytes(data,  0, 1)); }
        public void target_system_SET(char  src) //System I
        {  set_bytes((char)(src) & -1L, 1, data,  0); }
        ...
        public void target_component_SET(char  src) //Component I
        {  set_bytes((char)(src) & -1L, 1, data,  1); }
        public char directory_type_GET()//0=inputs, 1=output
        {  return (char)((char) get_bytes(data,  2, 1)); }
        public void directory_type_SET(char  src) //0=inputs, 1=output
        {  set_bytes((char)(src) & -1L, 1, data,  2); }
        public char start_index_GET()//index of first directory entry to writ
        {  return (char)((char) get_bytes(data,  3, 1)); }
        public void start_index_SET(char  src) //index of first directory entry to writ
        {  set_bytes((char)(src) & -1L, 1, data,  3); }
        public char count_GET()//count of directory entries to writ
        {  return (char)((char) get_bytes(data,  4, 1)); }
        public void count_SET(char  src) //count of directory entries to writ
        {  set_bytes((char)(src) & -1L, 1, data,  4); }
        public byte[] directory_data_GET(byte[]  dst_ch, int pos)  //Settings dat
        {
            for(int BYTE = 5, dst_max = pos + 48; pos < dst_max ; pos++,  BYTE += 1)
                dst_ch[pos] = (byte)((byte) get_bytes(data,  BYTE, 1));
            return dst_ch;
        }
        public byte[] directory_data_GET()//Settings dat
        {return directory_data_GET(new byte[48], 0);} public void directory_data_SET(byte[]  src, int pos)  //Settings dat
        {
            for(int BYTE =  5, src_max = pos + 48; pos < src_max; pos++, BYTE += 1)
                set_bytes((byte)(src[pos]) & -1L, 1, data,  BYTE);
        }
        static final Meta meta = new Meta(155, 0, 0, 0, 53, 424);
    } public static class FLEXIFUNCTION_DIRECTORY_ACK extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        FLEXIFUNCTION_DIRECTORY_ACK() { super(meta, 0); }
        FLEXIFUNCTION_DIRECTORY_ACK(int bytes) { super(meta, bytes); }
        public char result_GET()//result of acknowledge, 0=fail, 1=goo
        {  return (char)((char) get_bytes(data,  0, 2)); }
        public void result_SET(char  src) //result of acknowledge, 0=fail, 1=goo
        {  set_bytes((char)(src) & -1L, 2, data,  0); }
        ...
        public void count_SET(char  src) //count of directory entries to writ
        {  set_bytes((char)(src) & -1L, 1, data,  6); }
        static final Meta meta = new Meta(156, 1, 0, 0, 7, 56);
    } public static class FLEXIFUNCTION_COMMAND extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        FLEXIFUNCTION_COMMAND() { super(meta, 0); }
        FLEXIFUNCTION_COMMAND(int bytes) { super(meta, bytes); }
        public char target_system_GET()//System I
        {  return (char)((char) get_bytes(data,  0, 1)); }
        public void target_system_SET(char  src) //System I
        {  set_bytes((char)(src) & -1L, 1, data,  0); }
        ...
        public void target_component_SET(char  src) //Component I
        {  set_bytes((char)(src) & -1L, 1, data,  1); }
        public char command_type_GET()//Flexifunction command typ
        {  return (char)((char) get_bytes(data,  2, 1)); }
        public void command_type_SET(char  src) //Flexifunction command typ
        {  set_bytes((char)(src) & -1L, 1, data,  2); }
        static final Meta meta = new Meta(157, 0, 0, 0, 3, 24);
    } public static class FLEXIFUNCTION_COMMAND_ACK extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        FLEXIFUNCTION_COMMAND_ACK() { super(meta, 0); }
        FLEXIFUNCTION_COMMAND_ACK(int bytes) { super(meta, bytes); }
        public char command_type_GET()//Command acknowledge
        {  return (char)((char) get_bytes(data,  0, 2)); }
        public void command_type_SET(char  src) //Command acknowledge
        {  set_bytes((char)(src) & -1L, 2, data,  0); }
        public char result_GET()//result of acknowledg
        {  return (char)((char) get_bytes(data,  2, 2)); }
        public void result_SET(char  src) //result of acknowledg
        {  set_bytes((char)(src) & -1L, 2, data,  2); }
        static final Meta meta = new Meta(158, 2, 0, 0, 4, 32);
    } public static class SERIAL_UDB_EXTRA_F2_A extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        SERIAL_UDB_EXTRA_F2_A() { super(meta, 0); }
        SERIAL_UDB_EXTRA_F2_A(int bytes) { super(meta, bytes); }
        public char sue_waypoint_index_GET()//Serial UDB Extra Waypoint Inde
        {  return (char)((char) get_bytes(data,  0, 2)); }
        public void sue_waypoint_index_SET(char  src) //Serial UDB Extra Waypoint Inde
        {  set_bytes((char)(src) & -1L, 2, data,  0); }
        public char sue_cog_GET()//Serial UDB Extra GPS Course Over Groun
        {  return (char)((char) get_bytes(data,  2, 2)); }
        public void sue_cog_SET(char  src) //Serial UDB Extra GPS Course Over Groun
        {  set_bytes((char)(src) & -1L, 2, data,  2); }
        public char sue_cpu_load_GET()//Serial UDB Extra CPU Loa
        {  return (char)((char) get_bytes(data,  4, 2)); }
        public void sue_cpu_load_SET(char  src) //Serial UDB Extra CPU Loa
        {  set_bytes((char)(src) & -1L, 2, data,  4); }
        public char sue_air_speed_3DIMU_GET()//Serial UDB Extra 3D IMU Air Spee
        {  return (char)((char) get_bytes(data,  6, 2)); }
        public void sue_air_speed_3DIMU_SET(char  src) //Serial UDB Extra 3D IMU Air Spee
        {  set_bytes((char)(src) & -1L, 2, data,  6); }
        public long sue_time_GET()//Serial UDB Extra Tim
        {  return (get_bytes(data,  8, 4)); }
        public void sue_time_SET(long  src) //Serial UDB Extra Tim
        {  set_bytes((src) & -1L, 4, data,  8); }
        public char sue_status_GET()//Serial UDB Extra Statu
        {  return (char)((char) get_bytes(data,  12, 1)); }
        public void sue_status_SET(char  src) //Serial UDB Extra Statu
        {  set_bytes((char)(src) & -1L, 1, data,  12); }
        public int sue_latitude_GET()//Serial UDB Extra Latitud
        {  return (int)((int) get_bytes(data,  13, 4)); }
        public void sue_latitude_SET(int  src) //Serial UDB Extra Latitud
        {  set_bytes((int)(src) & -1L, 4, data,  13); }
        public int sue_longitude_GET()//Serial UDB Extra Longitud
        {  return (int)((int) get_bytes(data,  17, 4)); }
        public void sue_longitude_SET(int  src) //Serial UDB Extra Longitud
        {  set_bytes((int)(src) & -1L, 4, data,  17); }
        public int sue_altitude_GET()//Serial UDB Extra Altitud
        {  return (int)((int) get_bytes(data,  21, 4)); }
        public void sue_altitude_SET(int  src) //Serial UDB Extra Altitud
        {  set_bytes((int)(src) & -1L, 4, data,  21); }
        public short sue_rmat0_GET()//Serial UDB Extra Rmat
        {  return (short)((short) get_bytes(data,  25, 2)); }
        public void sue_rmat0_SET(short  src) //Serial UDB Extra Rmat
        {  set_bytes((short)(src) & -1L, 2, data,  25); }
        public short sue_rmat1_GET()//Serial UDB Extra Rmat
        {  return (short)((short) get_bytes(data,  27, 2)); }
        public void sue_rmat1_SET(short  src) //Serial UDB Extra Rmat
        {  set_bytes((short)(src) & -1L, 2, data,  27); }
        public short sue_rmat2_GET()//Serial UDB Extra Rmat
        {  return (short)((short) get_bytes(data,  29, 2)); }
        public void sue_rmat2_SET(short  src) //Serial UDB Extra Rmat
        {  set_bytes((short)(src) & -1L, 2, data,  29); }
        public short sue_rmat3_GET()//Serial UDB Extra Rmat
        {  return (short)((short) get_bytes(data,  31, 2)); }
        public void sue_rmat3_SET(short  src) //Serial UDB Extra Rmat
        {  set_bytes((short)(src) & -1L, 2, data,  31); }
        public short sue_rmat4_GET()//Serial UDB Extra Rmat
        {  return (short)((short) get_bytes(data,  33, 2)); }
        public void sue_rmat4_SET(short  src) //Serial UDB Extra Rmat
        {  set_bytes((short)(src) & -1L, 2, data,  33); }
        public short sue_rmat5_GET()//Serial UDB Extra Rmat
        {  return (short)((short) get_bytes(data,  35, 2)); }
        public void sue_rmat5_SET(short  src) //Serial UDB Extra Rmat
        {  set_bytes((short)(src) & -1L, 2, data,  35); }
        public short sue_rmat6_GET()//Serial UDB Extra Rmat
        {  return (short)((short) get_bytes(data,  37, 2)); }
        public void sue_rmat6_SET(short  src) //Serial UDB Extra Rmat
        {  set_bytes((short)(src) & -1L, 2, data,  37); }
        public short sue_rmat7_GET()//Serial UDB Extra Rmat
        {  return (short)((short) get_bytes(data,  39, 2)); }
        public void sue_rmat7_SET(short  src) //Serial UDB Extra Rmat
        {  set_bytes((short)(src) & -1L, 2, data,  39); }
        public short sue_rmat8_GET()//Serial UDB Extra Rmat
        {  return (short)((short) get_bytes(data,  41, 2)); }
        public void sue_rmat8_SET(short  src) //Serial UDB Extra Rmat
        {  set_bytes((short)(src) & -1L, 2, data,  41); }
        public short sue_sog_GET()//Serial UDB Extra Speed Over Groun
        {  return (short)((short) get_bytes(data,  43, 2)); }
        public void sue_sog_SET(short  src) //Serial UDB Extra Speed Over Groun
        {  set_bytes((short)(src) & -1L, 2, data,  43); }
        public short sue_estimated_wind_0_GET()//Serial UDB Extra Estimated Wind
        {  return (short)((short) get_bytes(data,  45, 2)); }
        public void sue_estimated_wind_0_SET(short  src) //Serial UDB Extra Estimated Wind
        {  set_bytes((short)(src) & -1L, 2, data,  45); }
        public short sue_estimated_wind_1_GET()//Serial UDB Extra Estimated Wind
        {  return (short)((short) get_bytes(data,  47, 2)); }
        public void sue_estimated_wind_1_SET(short  src) //Serial UDB Extra Estimated Wind
        {  set_bytes((short)(src) & -1L, 2, data,  47); }
        public short sue_estimated_wind_2_GET()//Serial UDB Extra Estimated Wind
        {  return (short)((short) get_bytes(data,  49, 2)); }
        public void sue_estimated_wind_2_SET(short  src) //Serial UDB Extra Estimated Wind
        {  set_bytes((short)(src) & -1L, 2, data,  49); }
        public short sue_magFieldEarth0_GET()//Serial UDB Extra Magnetic Field Earth 0
        {  return (short)((short) get_bytes(data,  51, 2)); }
        public void sue_magFieldEarth0_SET(short  src) //Serial UDB Extra Magnetic Field Earth 0
        {  set_bytes((short)(src) & -1L, 2, data,  51); }
        public short sue_magFieldEarth1_GET()//Serial UDB Extra Magnetic Field Earth 1
        {  return (short)((short) get_bytes(data,  53, 2)); }
        public void sue_magFieldEarth1_SET(short  src) //Serial UDB Extra Magnetic Field Earth 1
        {  set_bytes((short)(src) & -1L, 2, data,  53); }
        public short sue_magFieldEarth2_GET()//Serial UDB Extra Magnetic Field Earth 2
        {  return (short)((short) get_bytes(data,  55, 2)); }
        public void sue_magFieldEarth2_SET(short  src) //Serial UDB Extra Magnetic Field Earth 2
        {  set_bytes((short)(src) & -1L, 2, data,  55); }
        public short sue_svs_GET()//Serial UDB Extra Number of Sattelites in Vie
        {  return (short)((short) get_bytes(data,  57, 2)); }
        public void sue_svs_SET(short  src) //Serial UDB Extra Number of Sattelites in Vie
        {  set_bytes((short)(src) & -1L, 2, data,  57); }
        public short sue_hdop_GET()//Serial UDB Extra GPS Horizontal Dilution of Precisio
        {  return (short)((short) get_bytes(data,  59, 2)); }
        public void sue_hdop_SET(short  src) //Serial UDB Extra GPS Horizontal Dilution of Precisio
        {  set_bytes((short)(src) & -1L, 2, data,  59); }
        static final Meta meta = new Meta(170, 4, 1, 0, 61, 488);
    } public static class SERIAL_UDB_EXTRA_F2_B extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        SERIAL_UDB_EXTRA_F2_B() { super(meta, 0); }
        SERIAL_UDB_EXTRA_F2_B(int bytes) { super(meta, bytes); }
        public long sue_time_GET()//Serial UDB Extra Tim
        {  return (get_bytes(data,  0, 4)); }
        public void sue_time_SET(long  src) //Serial UDB Extra Tim
        {  set_bytes((src) & -1L, 4, data,  0); }
        public long sue_flags_GET()//Serial UDB Extra Status Flag
        {  return (get_bytes(data,  4, 4)); }
        public void sue_flags_SET(long  src) //Serial UDB Extra Status Flag
        {  set_bytes((src) & -1L, 4, data,  4); }
        public short sue_pwm_input_1_GET()//Serial UDB Extra PWM Input Channel
        {  return (short)((short) get_bytes(data,  8, 2)); }
        public void sue_pwm_input_1_SET(short  src) //Serial UDB Extra PWM Input Channel
        {  set_bytes((short)(src) & -1L, 2, data,  8); }
        public short sue_pwm_input_2_GET()//Serial UDB Extra PWM Input Channel
        {  return (short)((short) get_bytes(data,  10, 2)); }
        public void sue_pwm_input_2_SET(short  src) //Serial UDB Extra PWM Input Channel
        {  set_bytes((short)(src) & -1L, 2, data,  10); }
        public short sue_pwm_input_3_GET()//Serial UDB Extra PWM Input Channel
        {  return (short)((short) get_bytes(data,  12, 2)); }
        public void sue_pwm_input_3_SET(short  src) //Serial UDB Extra PWM Input Channel
        {  set_bytes((short)(src) & -1L, 2, data,  12); }
        public short sue_pwm_input_4_GET()//Serial UDB Extra PWM Input Channel
        {  return (short)((short) get_bytes(data,  14, 2)); }
        public void sue_pwm_input_4_SET(short  src) //Serial UDB Extra PWM Input Channel
        {  set_bytes((short)(src) & -1L, 2, data,  14); }
        public short sue_pwm_input_5_GET()//Serial UDB Extra PWM Input Channel
        {  return (short)((short) get_bytes(data,  16, 2)); }
        public void sue_pwm_input_5_SET(short  src) //Serial UDB Extra PWM Input Channel
        {  set_bytes((short)(src) & -1L, 2, data,  16); }
        public short sue_pwm_input_6_GET()//Serial UDB Extra PWM Input Channel
        {  return (short)((short) get_bytes(data,  18, 2)); }
        public void sue_pwm_input_6_SET(short  src) //Serial UDB Extra PWM Input Channel
        {  set_bytes((short)(src) & -1L, 2, data,  18); }
        public short sue_pwm_input_7_GET()//Serial UDB Extra PWM Input Channel
        {  return (short)((short) get_bytes(data,  20, 2)); }
        public void sue_pwm_input_7_SET(short  src) //Serial UDB Extra PWM Input Channel
        {  set_bytes((short)(src) & -1L, 2, data,  20); }
        public short sue_pwm_input_8_GET()//Serial UDB Extra PWM Input Channel
        {  return (short)((short) get_bytes(data,  22, 2)); }
        public void sue_pwm_input_8_SET(short  src) //Serial UDB Extra PWM Input Channel
        {  set_bytes((short)(src) & -1L, 2, data,  22); }
        public short sue_pwm_input_9_GET()//Serial UDB Extra PWM Input Channel
        {  return (short)((short) get_bytes(data,  24, 2)); }
        public void sue_pwm_input_9_SET(short  src) //Serial UDB Extra PWM Input Channel
        {  set_bytes((short)(src) & -1L, 2, data,  24); }
        public short sue_pwm_input_10_GET()//Serial UDB Extra PWM Input Channel 1
        {  return (short)((short) get_bytes(data,  26, 2)); }
        public void sue_pwm_input_10_SET(short  src) //Serial UDB Extra PWM Input Channel 1
        {  set_bytes((short)(src) & -1L, 2, data,  26); }
        public short sue_pwm_input_11_GET()//Serial UDB Extra PWM Input Channel 1
        {  return (short)((short) get_bytes(data,  28, 2)); }
        public void sue_pwm_input_11_SET(short  src) //Serial UDB Extra PWM Input Channel 1
        {  set_bytes((short)(src) & -1L, 2, data,  28); }
        public short sue_pwm_input_12_GET()//Serial UDB Extra PWM Input Channel 1
        {  return (short)((short) get_bytes(data,  30, 2)); }
        public void sue_pwm_input_12_SET(short  src) //Serial UDB Extra PWM Input Channel 1
        {  set_bytes((short)(src) & -1L, 2, data,  30); }
        public short sue_pwm_output_1_GET()//Serial UDB Extra PWM Output Channel
        {  return (short)((short) get_bytes(data,  32, 2)); }
        public void sue_pwm_output_1_SET(short  src) //Serial UDB Extra PWM Output Channel
        {  set_bytes((short)(src) & -1L, 2, data,  32); }
        public short sue_pwm_output_2_GET()//Serial UDB Extra PWM Output Channel
        {  return (short)((short) get_bytes(data,  34, 2)); }
        public void sue_pwm_output_2_SET(short  src) //Serial UDB Extra PWM Output Channel
        {  set_bytes((short)(src) & -1L, 2, data,  34); }
        public short sue_pwm_output_3_GET()//Serial UDB Extra PWM Output Channel
        {  return (short)((short) get_bytes(data,  36, 2)); }
        public void sue_pwm_output_3_SET(short  src) //Serial UDB Extra PWM Output Channel
        {  set_bytes((short)(src) & -1L, 2, data,  36); }
        public short sue_pwm_output_4_GET()//Serial UDB Extra PWM Output Channel
        {  return (short)((short) get_bytes(data,  38, 2)); }
        public void sue_pwm_output_4_SET(short  src) //Serial UDB Extra PWM Output Channel
        {  set_bytes((short)(src) & -1L, 2, data,  38); }
        public short sue_pwm_output_5_GET()//Serial UDB Extra PWM Output Channel
        {  return (short)((short) get_bytes(data,  40, 2)); }
        public void sue_pwm_output_5_SET(short  src) //Serial UDB Extra PWM Output Channel
        {  set_bytes((short)(src) & -1L, 2, data,  40); }
        public short sue_pwm_output_6_GET()//Serial UDB Extra PWM Output Channel
        {  return (short)((short) get_bytes(data,  42, 2)); }
        public void sue_pwm_output_6_SET(short  src) //Serial UDB Extra PWM Output Channel
        {  set_bytes((short)(src) & -1L, 2, data,  42); }
        public short sue_pwm_output_7_GET()//Serial UDB Extra PWM Output Channel
        {  return (short)((short) get_bytes(data,  44, 2)); }
        public void sue_pwm_output_7_SET(short  src) //Serial UDB Extra PWM Output Channel
        {  set_bytes((short)(src) & -1L, 2, data,  44); }
        public short sue_pwm_output_8_GET()//Serial UDB Extra PWM Output Channel
        {  return (short)((short) get_bytes(data,  46, 2)); }
        public void sue_pwm_output_8_SET(short  src) //Serial UDB Extra PWM Output Channel
        {  set_bytes((short)(src) & -1L, 2, data,  46); }
        public short sue_pwm_output_9_GET()//Serial UDB Extra PWM Output Channel
        {  return (short)((short) get_bytes(data,  48, 2)); }
        public void sue_pwm_output_9_SET(short  src) //Serial UDB Extra PWM Output Channel
        {  set_bytes((short)(src) & -1L, 2, data,  48); }
        public short sue_pwm_output_10_GET()//Serial UDB Extra PWM Output Channel 1
        {  return (short)((short) get_bytes(data,  50, 2)); }
        public void sue_pwm_output_10_SET(short  src) //Serial UDB Extra PWM Output Channel 1
        {  set_bytes((short)(src) & -1L, 2, data,  50); }
        public short sue_pwm_output_11_GET()//Serial UDB Extra PWM Output Channel 1
        {  return (short)((short) get_bytes(data,  52, 2)); }
        public void sue_pwm_output_11_SET(short  src) //Serial UDB Extra PWM Output Channel 1
        {  set_bytes((short)(src) & -1L, 2, data,  52); }
        public short sue_pwm_output_12_GET()//Serial UDB Extra PWM Output Channel 1
        {  return (short)((short) get_bytes(data,  54, 2)); }
        public void sue_pwm_output_12_SET(short  src) //Serial UDB Extra PWM Output Channel 1
        {  set_bytes((short)(src) & -1L, 2, data,  54); }
        public short sue_imu_location_x_GET()//Serial UDB Extra IMU Location
        {  return (short)((short) get_bytes(data,  56, 2)); }
        public void sue_imu_location_x_SET(short  src) //Serial UDB Extra IMU Location
        {  set_bytes((short)(src) & -1L, 2, data,  56); }
        public short sue_imu_location_y_GET()//Serial UDB Extra IMU Location
        {  return (short)((short) get_bytes(data,  58, 2)); }
        public void sue_imu_location_y_SET(short  src) //Serial UDB Extra IMU Location
        {  set_bytes((short)(src) & -1L, 2, data,  58); }
        public short sue_imu_location_z_GET()//Serial UDB Extra IMU Location
        {  return (short)((short) get_bytes(data,  60, 2)); }
        public void sue_imu_location_z_SET(short  src) //Serial UDB Extra IMU Location
        {  set_bytes((short)(src) & -1L, 2, data,  60); }
        public short sue_location_error_earth_x_GET()//Serial UDB Location Error Earth
        {  return (short)((short) get_bytes(data,  62, 2)); }
        public void sue_location_error_earth_x_SET(short  src) //Serial UDB Location Error Earth
        {  set_bytes((short)(src) & -1L, 2, data,  62); }
        public short sue_location_error_earth_y_GET()//Serial UDB Location Error Earth
        {  return (short)((short) get_bytes(data,  64, 2)); }
        public void sue_location_error_earth_y_SET(short  src) //Serial UDB Location Error Earth
        {  set_bytes((short)(src) & -1L, 2, data,  64); }
        public short sue_location_error_earth_z_GET()//Serial UDB Location Error Earth
        {  return (short)((short) get_bytes(data,  66, 2)); }
        public void sue_location_error_earth_z_SET(short  src) //Serial UDB Location Error Earth
        {  set_bytes((short)(src) & -1L, 2, data,  66); }
        public short sue_osc_fails_GET()//Serial UDB Extra Oscillator Failure Coun
        {  return (short)((short) get_bytes(data,  68, 2)); }
        public void sue_osc_fails_SET(short  src) //Serial UDB Extra Oscillator Failure Coun
        {  set_bytes((short)(src) & -1L, 2, data,  68); }
        public short sue_imu_velocity_x_GET()//Serial UDB Extra IMU Velocity
        {  return (short)((short) get_bytes(data,  70, 2)); }
        public void sue_imu_velocity_x_SET(short  src) //Serial UDB Extra IMU Velocity
        {  set_bytes((short)(src) & -1L, 2, data,  70); }
        public short sue_imu_velocity_y_GET()//Serial UDB Extra IMU Velocity
        {  return (short)((short) get_bytes(data,  72, 2)); }
        public void sue_imu_velocity_y_SET(short  src) //Serial UDB Extra IMU Velocity
        {  set_bytes((short)(src) & -1L, 2, data,  72); }
        public short sue_imu_velocity_z_GET()//Serial UDB Extra IMU Velocity
        {  return (short)((short) get_bytes(data,  74, 2)); }
        public void sue_imu_velocity_z_SET(short  src) //Serial UDB Extra IMU Velocity
        {  set_bytes((short)(src) & -1L, 2, data,  74); }
        public short sue_waypoint_goal_x_GET()//Serial UDB Extra Current Waypoint Goal
        {  return (short)((short) get_bytes(data,  76, 2)); }
        public void sue_waypoint_goal_x_SET(short  src) //Serial UDB Extra Current Waypoint Goal
        {  set_bytes((short)(src) & -1L, 2, data,  76); }
        public short sue_waypoint_goal_y_GET()//Serial UDB Extra Current Waypoint Goal
        {  return (short)((short) get_bytes(data,  78, 2)); }
        public void sue_waypoint_goal_y_SET(short  src) //Serial UDB Extra Current Waypoint Goal
        {  set_bytes((short)(src) & -1L, 2, data,  78); }
        public short sue_waypoint_goal_z_GET()//Serial UDB Extra Current Waypoint Goal
        {  return (short)((short) get_bytes(data,  80, 2)); }
        public void sue_waypoint_goal_z_SET(short  src) //Serial UDB Extra Current Waypoint Goal
        {  set_bytes((short)(src) & -1L, 2, data,  80); }
        public short sue_aero_x_GET()//Aeroforce in UDB X Axi
        {  return (short)((short) get_bytes(data,  82, 2)); }
        public void sue_aero_x_SET(short  src) //Aeroforce in UDB X Axi
        {  set_bytes((short)(src) & -1L, 2, data,  82); }
        public short sue_aero_y_GET()//Aeroforce in UDB Y Axi
        {  return (short)((short) get_bytes(data,  84, 2)); }
        public void sue_aero_y_SET(short  src) //Aeroforce in UDB Y Axi
        {  set_bytes((short)(src) & -1L, 2, data,  84); }
        public short sue_aero_z_GET()//Aeroforce in UDB Z axi
        {  return (short)((short) get_bytes(data,  86, 2)); }
        public void sue_aero_z_SET(short  src) //Aeroforce in UDB Z axi
        {  set_bytes((short)(src) & -1L, 2, data,  86); }
        public short sue_barom_temp_GET()//SUE barometer temperatur
        {  return (short)((short) get_bytes(data,  88, 2)); }
        public void sue_barom_temp_SET(short  src) //SUE barometer temperatur
        {  set_bytes((short)(src) & -1L, 2, data,  88); }
        public int sue_barom_press_GET()//SUE barometer pressur
        {  return (int)((int) get_bytes(data,  90, 4)); }
        public void sue_barom_press_SET(int  src) //SUE barometer pressur
        {  set_bytes((int)(src) & -1L, 4, data,  90); }
        public int sue_barom_alt_GET()//SUE barometer altitud
        {  return (int)((int) get_bytes(data,  94, 4)); }
        public void sue_barom_alt_SET(int  src) //SUE barometer altitud
        {  set_bytes((int)(src) & -1L, 4, data,  94); }
        public short sue_bat_volt_GET()//SUE battery voltag
        {  return (short)((short) get_bytes(data,  98, 2)); }
        public void sue_bat_volt_SET(short  src) //SUE battery voltag
        {  set_bytes((short)(src) & -1L, 2, data,  98); }
        public short sue_bat_amp_GET()//SUE battery curren
        {  return (short)((short) get_bytes(data,  100, 2)); }
        public void sue_bat_amp_SET(short  src) //SUE battery curren
        {  set_bytes((short)(src) & -1L, 2, data,  100); }
        public short sue_bat_amp_hours_GET()//SUE battery milli amp hours use
        {  return (short)((short) get_bytes(data,  102, 2)); }
        public void sue_bat_amp_hours_SET(short  src) //SUE battery milli amp hours use
        {  set_bytes((short)(src) & -1L, 2, data,  102); }
        public short sue_desired_height_GET()//Sue autopilot desired heigh
        {  return (short)((short) get_bytes(data,  104, 2)); }
        public void sue_desired_height_SET(short  src) //Sue autopilot desired heigh
        {  set_bytes((short)(src) & -1L, 2, data,  104); }
        public short sue_memory_stack_free_GET()//Serial UDB Extra Stack Memory Fre
        {  return (short)((short) get_bytes(data,  106, 2)); }
        public void sue_memory_stack_free_SET(short  src) //Serial UDB Extra Stack Memory Fre
        {  set_bytes((short)(src) & -1L, 2, data,  106); }
        static final Meta meta = new Meta(171, 0, 2, 0, 108, 864);
    } public static class SERIAL_UDB_EXTRA_F4 extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        SERIAL_UDB_EXTRA_F4() { super(meta, 0); }
        SERIAL_UDB_EXTRA_F4(int bytes) { super(meta, bytes); }
        public char sue_ROLL_STABILIZATION_AILERONS_GET()//Serial UDB Extra Roll Stabilization with Ailerons Enable
        {  return (char)((char) get_bytes(data,  0, 1)); }
        public void sue_ROLL_STABILIZATION_AILERONS_SET(char  src) //Serial UDB Extra Roll Stabilization with Ailerons Enable
        {  set_bytes((char)(src) & -1L, 1, data,  0); }
        public char sue_ROLL_STABILIZATION_RUDDER_GET()//Serial UDB Extra Roll Stabilization with Rudder Enable
        {  return (char)((char) get_bytes(data,  1, 1)); }
        public void sue_ROLL_STABILIZATION_RUDDER_SET(char  src) //Serial UDB Extra Roll Stabilization with Rudder Enable
        {  set_bytes((char)(src) & -1L, 1, data,  1); }
        public char sue_PITCH_STABILIZATION_GET()//Serial UDB Extra Pitch Stabilization Enable
        {  return (char)((char) get_bytes(data,  2, 1)); }
        public void sue_PITCH_STABILIZATION_SET(char  src) //Serial UDB Extra Pitch Stabilization Enable
        {  set_bytes((char)(src) & -1L, 1, data,  2); }
        public char sue_YAW_STABILIZATION_RUDDER_GET()//Serial UDB Extra Yaw Stabilization using Rudder Enable
        {  return (char)((char) get_bytes(data,  3, 1)); }
        public void sue_YAW_STABILIZATION_RUDDER_SET(char  src) //Serial UDB Extra Yaw Stabilization using Rudder Enable
        {  set_bytes((char)(src) & -1L, 1, data,  3); }
        public char sue_YAW_STABILIZATION_AILERON_GET()//Serial UDB Extra Yaw Stabilization using Ailerons Enable
        {  return (char)((char) get_bytes(data,  4, 1)); }
        public void sue_YAW_STABILIZATION_AILERON_SET(char  src) //Serial UDB Extra Yaw Stabilization using Ailerons Enable
        {  set_bytes((char)(src) & -1L, 1, data,  4); }
        public char sue_AILERON_NAVIGATION_GET()//Serial UDB Extra Navigation with Ailerons Enable
        {  return (char)((char) get_bytes(data,  5, 1)); }
        public void sue_AILERON_NAVIGATION_SET(char  src) //Serial UDB Extra Navigation with Ailerons Enable
        {  set_bytes((char)(src) & -1L, 1, data,  5); }
        public char sue_RUDDER_NAVIGATION_GET()//Serial UDB Extra Navigation with Rudder Enable
        {  return (char)((char) get_bytes(data,  6, 1)); }
        public void sue_RUDDER_NAVIGATION_SET(char  src) //Serial UDB Extra Navigation with Rudder Enable
        {  set_bytes((char)(src) & -1L, 1, data,  6); }
        public char sue_ALTITUDEHOLD_STABILIZED_GET()//Serial UDB Extra Type of Alitude Hold when in Stabilized Mod
        {  return (char)((char) get_bytes(data,  7, 1)); }
        public void sue_ALTITUDEHOLD_STABILIZED_SET(char  src) //Serial UDB Extra Type of Alitude Hold when in Stabilized Mod
        {  set_bytes((char)(src) & -1L, 1, data,  7); }
        public char sue_ALTITUDEHOLD_WAYPOINT_GET()//Serial UDB Extra Type of Alitude Hold when in Waypoint Mod
        {  return (char)((char) get_bytes(data,  8, 1)); }
        public void sue_ALTITUDEHOLD_WAYPOINT_SET(char  src) //Serial UDB Extra Type of Alitude Hold when in Waypoint Mod
        {  set_bytes((char)(src) & -1L, 1, data,  8); }
        public char sue_RACING_MODE_GET()//Serial UDB Extra Firmware racing mode enable
        {  return (char)((char) get_bytes(data,  9, 1)); }
        public void sue_RACING_MODE_SET(char  src) //Serial UDB Extra Firmware racing mode enable
        {  set_bytes((char)(src) & -1L, 1, data,  9); }
        static final Meta meta = new Meta(172, 0, 0, 0, 10, 80);
    } public static class SERIAL_UDB_EXTRA_F5 extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        SERIAL_UDB_EXTRA_F5() { super(meta, 0); }
        SERIAL_UDB_EXTRA_F5(int bytes) { super(meta, bytes); }
        public float sue_YAWKP_AILERON_GET()//Serial UDB YAWKP_AILERON Gain for Proporional control of navigatio
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  0, 4))); }
        public void sue_YAWKP_AILERON_SET(float  src) //Serial UDB YAWKP_AILERON Gain for Proporional control of navigatio
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 0); }
        public float sue_YAWKD_AILERON_GET()//Serial UDB YAWKD_AILERON Gain for Rate control of navigatio
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  4, 4))); }
        public void sue_YAWKD_AILERON_SET(float  src) //Serial UDB YAWKD_AILERON Gain for Rate control of navigatio
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 4); }
        public float sue_ROLLKP_GET()//Serial UDB Extra ROLLKP Gain for Proportional control of roll stabilizatio
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  8, 4))); }
        public void sue_ROLLKP_SET(float  src) //Serial UDB Extra ROLLKP Gain for Proportional control of roll stabilizatio
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 8); }
        public float sue_ROLLKD_GET()//Serial UDB Extra ROLLKD Gain for Rate control of roll stabilizatio
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  12, 4))); }
        public void sue_ROLLKD_SET(float  src) //Serial UDB Extra ROLLKD Gain for Rate control of roll stabilizatio
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 12); }
        static final Meta meta = new Meta(173, 0, 0, 0, 16, 128);
    } public static class SERIAL_UDB_EXTRA_F6 extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        SERIAL_UDB_EXTRA_F6() { super(meta, 0); }
        SERIAL_UDB_EXTRA_F6(int bytes) { super(meta, bytes); }
        public float sue_PITCHGAIN_GET()//Serial UDB Extra PITCHGAIN Proportional Contro
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  0, 4))); }
        public void sue_PITCHGAIN_SET(float  src) //Serial UDB Extra PITCHGAIN Proportional Contro
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 0); }
        public float sue_PITCHKD_GET()//Serial UDB Extra Pitch Rate Contro
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  4, 4))); }
        public void sue_PITCHKD_SET(float  src) //Serial UDB Extra Pitch Rate Contro
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 4); }
        public float sue_RUDDER_ELEV_MIX_GET()//Serial UDB Extra Rudder to Elevator Mi
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  8, 4))); }
        public void sue_RUDDER_ELEV_MIX_SET(float  src) //Serial UDB Extra Rudder to Elevator Mi
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 8); }
        public float sue_ROLL_ELEV_MIX_GET()//Serial UDB Extra Roll to Elevator Mi
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  12, 4))); }
        public void sue_ROLL_ELEV_MIX_SET(float  src) //Serial UDB Extra Roll to Elevator Mi
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 12); }
        public float sue_ELEVATOR_BOOST_GET()//Gain For Boosting Manual Elevator control When Plane Stabilize
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  16, 4))); }
        public void sue_ELEVATOR_BOOST_SET(float  src) //Gain For Boosting Manual Elevator control When Plane Stabilize
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 16); }
        static final Meta meta = new Meta(174, 0, 0, 0, 20, 160);
    } public static class SERIAL_UDB_EXTRA_F7 extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        SERIAL_UDB_EXTRA_F7() { super(meta, 0); }
        SERIAL_UDB_EXTRA_F7(int bytes) { super(meta, bytes); }
        public float sue_YAWKP_RUDDER_GET()//Serial UDB YAWKP_RUDDER Gain for Proporional control of navigatio
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  0, 4))); }
        public void sue_YAWKP_RUDDER_SET(float  src) //Serial UDB YAWKP_RUDDER Gain for Proporional control of navigatio
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 0); }
        public float sue_YAWKD_RUDDER_GET()//Serial UDB YAWKD_RUDDER Gain for Rate control of navigatio
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  4, 4))); }
        public void sue_YAWKD_RUDDER_SET(float  src) //Serial UDB YAWKD_RUDDER Gain for Rate control of navigatio
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 4); }
        public float sue_ROLLKP_RUDDER_GET()//Serial UDB Extra ROLLKP_RUDDER Gain for Proportional control of roll stabilizatio
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  8, 4))); }
        public void sue_ROLLKP_RUDDER_SET(float  src) //Serial UDB Extra ROLLKP_RUDDER Gain for Proportional control of roll stabilizatio
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 8); }
        public float sue_ROLLKD_RUDDER_GET()//Serial UDB Extra ROLLKD_RUDDER Gain for Rate control of roll stabilizatio
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  12, 4))); }
        public void sue_ROLLKD_RUDDER_SET(float  src) //Serial UDB Extra ROLLKD_RUDDER Gain for Rate control of roll stabilizatio
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 12); }
        public float sue_RUDDER_BOOST_GET()//SERIAL UDB EXTRA Rudder Boost Gain to Manual Control when stabilize
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  16, 4))); }
        public void sue_RUDDER_BOOST_SET(float  src) //SERIAL UDB EXTRA Rudder Boost Gain to Manual Control when stabilize
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 16); }
        public float sue_RTL_PITCH_DOWN_GET()//Serial UDB Extra Return To Landing - Angle to Pitch Plane Dow
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  20, 4))); }
        public void sue_RTL_PITCH_DOWN_SET(float  src) //Serial UDB Extra Return To Landing - Angle to Pitch Plane Dow
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 20); }
        static final Meta meta = new Meta(175, 0, 0, 0, 24, 192);
    } public static class SERIAL_UDB_EXTRA_F8 extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        SERIAL_UDB_EXTRA_F8() { super(meta, 0); }
        SERIAL_UDB_EXTRA_F8(int bytes) { super(meta, bytes); }
        public float sue_HEIGHT_TARGET_MAX_GET()//Serial UDB Extra HEIGHT_TARGET_MA
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  0, 4))); }
        public void sue_HEIGHT_TARGET_MAX_SET(float  src) //Serial UDB Extra HEIGHT_TARGET_MA
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 0); }
        public float sue_HEIGHT_TARGET_MIN_GET()//Serial UDB Extra HEIGHT_TARGET_MI
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  4, 4))); }
        public void sue_HEIGHT_TARGET_MIN_SET(float  src) //Serial UDB Extra HEIGHT_TARGET_MI
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 4); }
        public float sue_ALT_HOLD_THROTTLE_MIN_GET()//Serial UDB Extra ALT_HOLD_THROTTLE_MI
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  8, 4))); }
        public void sue_ALT_HOLD_THROTTLE_MIN_SET(float  src) //Serial UDB Extra ALT_HOLD_THROTTLE_MI
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 8); }
        public float sue_ALT_HOLD_THROTTLE_MAX_GET()//Serial UDB Extra ALT_HOLD_THROTTLE_MA
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  12, 4))); }
        public void sue_ALT_HOLD_THROTTLE_MAX_SET(float  src) //Serial UDB Extra ALT_HOLD_THROTTLE_MA
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 12); }
        public float sue_ALT_HOLD_PITCH_MIN_GET()//Serial UDB Extra ALT_HOLD_PITCH_MI
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  16, 4))); }
        public void sue_ALT_HOLD_PITCH_MIN_SET(float  src) //Serial UDB Extra ALT_HOLD_PITCH_MI
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 16); }
        public float sue_ALT_HOLD_PITCH_MAX_GET()//Serial UDB Extra ALT_HOLD_PITCH_MA
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  20, 4))); }
        public void sue_ALT_HOLD_PITCH_MAX_SET(float  src) //Serial UDB Extra ALT_HOLD_PITCH_MA
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 20); }
        public float sue_ALT_HOLD_PITCH_HIGH_GET()//Serial UDB Extra ALT_HOLD_PITCH_HIG
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  24, 4))); }
        public void sue_ALT_HOLD_PITCH_HIGH_SET(float  src) //Serial UDB Extra ALT_HOLD_PITCH_HIG
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 24); }
        static final Meta meta = new Meta(176, 0, 0, 0, 28, 224);
    } public static class SERIAL_UDB_EXTRA_F13 extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        SERIAL_UDB_EXTRA_F13() { super(meta, 0); }
        SERIAL_UDB_EXTRA_F13(int bytes) { super(meta, bytes); }
        public short sue_week_no_GET()//Serial UDB Extra GPS Week Numbe
        {  return (short)((short) get_bytes(data,  0, 2)); }
        public void sue_week_no_SET(short  src) //Serial UDB Extra GPS Week Numbe
        {  set_bytes((short)(src) & -1L, 2, data,  0); }
        public int sue_lat_origin_GET()//Serial UDB Extra MP Origin Latitud
        {  return (int)((int) get_bytes(data,  2, 4)); }
        public void sue_lat_origin_SET(int  src) //Serial UDB Extra MP Origin Latitud
        {  set_bytes((int)(src) & -1L, 4, data,  2); }
        public int sue_lon_origin_GET()//Serial UDB Extra MP Origin Longitud
        {  return (int)((int) get_bytes(data,  6, 4)); }
        public void sue_lon_origin_SET(int  src) //Serial UDB Extra MP Origin Longitud
        {  set_bytes((int)(src) & -1L, 4, data,  6); }
        public int sue_alt_origin_GET()//Serial UDB Extra MP Origin Altitude Above Sea Leve
        {  return (int)((int) get_bytes(data,  10, 4)); }
        public void sue_alt_origin_SET(int  src) //Serial UDB Extra MP Origin Altitude Above Sea Leve
        {  set_bytes((int)(src) & -1L, 4, data,  10); }
        static final Meta meta = new Meta(177, 0, 0, 0, 14, 112);
    } public static class SERIAL_UDB_EXTRA_F14 extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        SERIAL_UDB_EXTRA_F14() { super(meta, 0); }
        SERIAL_UDB_EXTRA_F14(int bytes) { super(meta, bytes); }
        public long sue_TRAP_SOURCE_GET()//Serial UDB Extra Type Program Address of Last Tra
        {  return (get_bytes(data,  0, 4)); }
        public void sue_TRAP_SOURCE_SET(long  src) //Serial UDB Extra Type Program Address of Last Tra
        {  set_bytes((src) & -1L, 4, data,  0); }
        public char sue_WIND_ESTIMATION_GET()//Serial UDB Extra Wind Estimation Enable
        {  return (char)((char) get_bytes(data,  4, 1)); }
        public void sue_WIND_ESTIMATION_SET(char  src) //Serial UDB Extra Wind Estimation Enable
        {  set_bytes((char)(src) & -1L, 1, data,  4); }
        public char sue_GPS_TYPE_GET()//Serial UDB Extra Type of GPS Uni
        {  return (char)((char) get_bytes(data,  5, 1)); }
        public void sue_GPS_TYPE_SET(char  src) //Serial UDB Extra Type of GPS Uni
        {  set_bytes((char)(src) & -1L, 1, data,  5); }
        public char sue_DR_GET()//Serial UDB Extra Dead Reckoning Enable
        {  return (char)((char) get_bytes(data,  6, 1)); }
        public void sue_DR_SET(char  src) //Serial UDB Extra Dead Reckoning Enable
        {  set_bytes((char)(src) & -1L, 1, data,  6); }
        public char sue_BOARD_TYPE_GET()//Serial UDB Extra Type of UDB Hardwar
        {  return (char)((char) get_bytes(data,  7, 1)); }
        public void sue_BOARD_TYPE_SET(char  src) //Serial UDB Extra Type of UDB Hardwar
        {  set_bytes((char)(src) & -1L, 1, data,  7); }
        public char sue_AIRFRAME_GET()//Serial UDB Extra Type of Airfram
        {  return (char)((char) get_bytes(data,  8, 1)); }
        public void sue_AIRFRAME_SET(char  src) //Serial UDB Extra Type of Airfram
        {  set_bytes((char)(src) & -1L, 1, data,  8); }
        public short sue_RCON_GET()//Serial UDB Extra Reboot Register of DSPI
        {  return (short)((short) get_bytes(data,  9, 2)); }
        public void sue_RCON_SET(short  src) //Serial UDB Extra Reboot Register of DSPI
        {  set_bytes((short)(src) & -1L, 2, data,  9); }
        public short sue_TRAP_FLAGS_GET()//Serial UDB Extra  Last dspic Trap Flag
        {  return (short)((short) get_bytes(data,  11, 2)); }
        public void sue_TRAP_FLAGS_SET(short  src) //Serial UDB Extra  Last dspic Trap Flag
        {  set_bytes((short)(src) & -1L, 2, data,  11); }
        public short sue_osc_fail_count_GET()//Serial UDB Extra Number of Ocillator Failure
        {  return (short)((short) get_bytes(data,  13, 2)); }
        public void sue_osc_fail_count_SET(short  src) //Serial UDB Extra Number of Ocillator Failure
        {  set_bytes((short)(src) & -1L, 2, data,  13); }
        public char sue_CLOCK_CONFIG_GET()//Serial UDB Extra UDB Internal Clock Configuratio
        {  return (char)((char) get_bytes(data,  15, 1)); }
        public void sue_CLOCK_CONFIG_SET(char  src) //Serial UDB Extra UDB Internal Clock Configuratio
        {  set_bytes((char)(src) & -1L, 1, data,  15); }
        public char sue_FLIGHT_PLAN_TYPE_GET()//Serial UDB Extra Type of Flight Pla
        {  return (char)((char) get_bytes(data,  16, 1)); }
        public void sue_FLIGHT_PLAN_TYPE_SET(char  src) //Serial UDB Extra Type of Flight Pla
        {  set_bytes((char)(src) & -1L, 1, data,  16); }
        static final Meta meta = new Meta(178, 0, 1, 0, 17, 136);
    } public static class SERIAL_UDB_EXTRA_F15 extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        SERIAL_UDB_EXTRA_F15() { super(meta, 0); }
        SERIAL_UDB_EXTRA_F15(int bytes) { super(meta, bytes); }
        public char[] sue_ID_VEHICLE_MODEL_NAME_GET(char[]  dst_ch, int pos)  //Serial UDB Extra Model Name Of Vehicl
        {
            for(int BYTE = 0, dst_max = pos + 40; pos < dst_max ; pos++,  BYTE += 1)
                dst_ch[pos] = (char)((char) get_bytes(data,  BYTE, 1));
            return dst_ch;
        }
        public char[] sue_ID_VEHICLE_MODEL_NAME_GET()//Serial UDB Extra Model Name Of Vehicl
        {return sue_ID_VEHICLE_MODEL_NAME_GET(new char[40], 0);} public void sue_ID_VEHICLE_MODEL_NAME_SET(char[]  src, int pos)  //Serial UDB Extra Model Name Of Vehicl
        {
            for(int BYTE =  0, src_max = pos + 40; pos < src_max; pos++, BYTE += 1)
                set_bytes((char)(src[pos]) & -1L, 1, data,  BYTE);
        }
        public char[] sue_ID_VEHICLE_REGISTRATION_GET(char[]  dst_ch, int pos)  //Serial UDB Extra Registraton Number of Vehicl
        {
            for(int BYTE = 40, dst_max = pos + 20; pos < dst_max ; pos++,  BYTE += 1)
                dst_ch[pos] = (char)((char) get_bytes(data,  BYTE, 1));
            return dst_ch;
        }
        public char[] sue_ID_VEHICLE_REGISTRATION_GET()//Serial UDB Extra Registraton Number of Vehicl
        {return sue_ID_VEHICLE_REGISTRATION_GET(new char[20], 0);} public void sue_ID_VEHICLE_REGISTRATION_SET(char[]  src, int pos)  //Serial UDB Extra Registraton Number of Vehicl
        {
            for(int BYTE =  40, src_max = pos + 20; pos < src_max; pos++, BYTE += 1)
                set_bytes((char)(src[pos]) & -1L, 1, data,  BYTE);
        }
        static final Meta meta = new Meta(179, 0, 0, 0, 60, 480);
    } public static class SERIAL_UDB_EXTRA_F16 extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        SERIAL_UDB_EXTRA_F16() { super(meta, 0); }
        SERIAL_UDB_EXTRA_F16(int bytes) { super(meta, bytes); }
        public char[] sue_ID_LEAD_PILOT_GET(char[]  dst_ch, int pos)  //Serial UDB Extra Name of Expected Lead Pilo
        {
            for(int BYTE = 0, dst_max = pos + 40; pos < dst_max ; pos++,  BYTE += 1)
                dst_ch[pos] = (char)((char) get_bytes(data,  BYTE, 1));
            return dst_ch;
        }
        public char[] sue_ID_LEAD_PILOT_GET()//Serial UDB Extra Name of Expected Lead Pilo
        {return sue_ID_LEAD_PILOT_GET(new char[40], 0);} public void sue_ID_LEAD_PILOT_SET(char[]  src, int pos)  //Serial UDB Extra Name of Expected Lead Pilo
        {
            for(int BYTE =  0, src_max = pos + 40; pos < src_max; pos++, BYTE += 1)
                set_bytes((char)(src[pos]) & -1L, 1, data,  BYTE);
        }
        public char[] sue_ID_DIY_DRONES_URL_GET(char[]  dst_ch, int pos)  //Serial UDB Extra URL of Lead Pilot or Tea
        {
            for(int BYTE = 40, dst_max = pos + 70; pos < dst_max ; pos++,  BYTE += 1)
                dst_ch[pos] = (char)((char) get_bytes(data,  BYTE, 1));
            return dst_ch;
        }
        public char[] sue_ID_DIY_DRONES_URL_GET()//Serial UDB Extra URL of Lead Pilot or Tea
        {return sue_ID_DIY_DRONES_URL_GET(new char[70], 0);} public void sue_ID_DIY_DRONES_URL_SET(char[]  src, int pos)  //Serial UDB Extra URL of Lead Pilot or Tea
        {
            for(int BYTE =  40, src_max = pos + 70; pos < src_max; pos++, BYTE += 1)
                set_bytes((char)(src[pos]) & -1L, 1, data,  BYTE);
        }
        static final Meta meta = new Meta(180, 0, 0, 0, 110, 880);
    } public static class ALTITUDES extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        ALTITUDES() { super(meta, 0); }
        ALTITUDES(int bytes) { super(meta, bytes); }
        public long time_boot_ms_GET()//Timestamp (milliseconds since system boot
        {  return (get_bytes(data,  0, 4)); }
        public void time_boot_ms_SET(long  src) //Timestamp (milliseconds since system boot
        {  set_bytes((src) & -1L, 4, data,  0); }
        public int alt_gps_GET()//GPS altitude in meters, expressed as * 1000 (millimeters), above MS
        {  return (int)((int) get_bytes(data,  4, 4)); }
        public void alt_gps_SET(int  src) //GPS altitude in meters, expressed as * 1000 (millimeters), above MS
        {  set_bytes((int)(src) & -1L, 4, data,  4); }
        public int alt_imu_GET()//IMU altitude above ground in meters, expressed as * 1000 (millimeters
        {  return (int)((int) get_bytes(data,  8, 4)); }
        public void alt_imu_SET(int  src) //IMU altitude above ground in meters, expressed as * 1000 (millimeters
        {  set_bytes((int)(src) & -1L, 4, data,  8); }
        public int alt_barometric_GET()//barometeric altitude above ground in meters, expressed as * 1000 (millimeters
        {  return (int)((int) get_bytes(data,  12, 4)); }
        public void alt_barometric_SET(int  src) //barometeric altitude above ground in meters, expressed as * 1000 (millimeters
        {  set_bytes((int)(src) & -1L, 4, data,  12); }
        public int alt_optical_flow_GET()//Optical flow altitude above ground in meters, expressed as * 1000 (millimeters
        {  return (int)((int) get_bytes(data,  16, 4)); }
        public void alt_optical_flow_SET(int  src) //Optical flow altitude above ground in meters, expressed as * 1000 (millimeters
        {  set_bytes((int)(src) & -1L, 4, data,  16); }
        public int alt_range_finder_GET()//Rangefinder Altitude above ground in meters, expressed as * 1000 (millimeters
        {  return (int)((int) get_bytes(data,  20, 4)); }
        public void alt_range_finder_SET(int  src) //Rangefinder Altitude above ground in meters, expressed as * 1000 (millimeters
        {  set_bytes((int)(src) & -1L, 4, data,  20); }
        public int alt_extra_GET()//Extra altitude above ground in meters, expressed as * 1000 (millimeters
        {  return (int)((int) get_bytes(data,  24, 4)); }
        public void alt_extra_SET(int  src) //Extra altitude above ground in meters, expressed as * 1000 (millimeters
        {  set_bytes((int)(src) & -1L, 4, data,  24); }
        static final Meta meta = new Meta(181, 0, 1, 0, 28, 224);
    } public static class AIRSPEEDS extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        AIRSPEEDS() { super(meta, 0); }
        AIRSPEEDS(int bytes) { super(meta, bytes); }
        public long time_boot_ms_GET()//Timestamp (milliseconds since system boot
        {  return (get_bytes(data,  0, 4)); }
        public void time_boot_ms_SET(long  src) //Timestamp (milliseconds since system boot
        {  set_bytes((src) & -1L, 4, data,  0); }
        public short airspeed_imu_GET()//Airspeed estimate from IMU, cm/
        {  return (short)((short) get_bytes(data,  4, 2)); }
        public void airspeed_imu_SET(short  src) //Airspeed estimate from IMU, cm/
        {  set_bytes((short)(src) & -1L, 2, data,  4); }
        public short airspeed_pitot_GET()//Pitot measured forward airpseed, cm/
        {  return (short)((short) get_bytes(data,  6, 2)); }
        public void airspeed_pitot_SET(short  src) //Pitot measured forward airpseed, cm/
        {  set_bytes((short)(src) & -1L, 2, data,  6); }
        public short airspeed_hot_wire_GET()//Hot wire anenometer measured airspeed, cm/
        {  return (short)((short) get_bytes(data,  8, 2)); }
        public void airspeed_hot_wire_SET(short  src) //Hot wire anenometer measured airspeed, cm/
        {  set_bytes((short)(src) & -1L, 2, data,  8); }
        public short airspeed_ultrasonic_GET()//Ultrasonic measured airspeed, cm/
        {  return (short)((short) get_bytes(data,  10, 2)); }
        public void airspeed_ultrasonic_SET(short  src) //Ultrasonic measured airspeed, cm/
        {  set_bytes((short)(src) & -1L, 2, data,  10); }
        public short aoa_GET()//Angle of attack sensor, degrees * 1
        {  return (short)((short) get_bytes(data,  12, 2)); }
        public void aoa_SET(short  src) //Angle of attack sensor, degrees * 1
        {  set_bytes((short)(src) & -1L, 2, data,  12); }
        public short aoy_GET()//Yaw angle sensor, degrees * 1
        {  return (short)((short) get_bytes(data,  14, 2)); }
        public void aoy_SET(short  src) //Yaw angle sensor, degrees * 1
        {  set_bytes((short)(src) & -1L, 2, data,  14); }
        static final Meta meta = new Meta(182, 0, 1, 0, 16, 128);
    } public static class SERIAL_UDB_EXTRA_F17 extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        SERIAL_UDB_EXTRA_F17() { super(meta, 0); }
        SERIAL_UDB_EXTRA_F17(int bytes) { super(meta, bytes); }
        public float sue_feed_forward_GET()//SUE Feed Forward Gai
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  0, 4))); }
        public void sue_feed_forward_SET(float  src) //SUE Feed Forward Gai
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 0); }
        public float sue_turn_rate_nav_GET()//SUE Max Turn Rate when Navigatin
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  4, 4))); }
        public void sue_turn_rate_nav_SET(float  src) //SUE Max Turn Rate when Navigatin
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 4); }
        public float sue_turn_rate_fbw_GET()//SUE Max Turn Rate in Fly By Wire Mod
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  8, 4))); }
        public void sue_turn_rate_fbw_SET(float  src) //SUE Max Turn Rate in Fly By Wire Mod
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 8); }
        static final Meta meta = new Meta(183, 0, 0, 0, 12, 96);
    } public static class SERIAL_UDB_EXTRA_F18 extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        SERIAL_UDB_EXTRA_F18() { super(meta, 0); }
        SERIAL_UDB_EXTRA_F18(int bytes) { super(meta, bytes); }
        public float angle_of_attack_normal_GET()//SUE Angle of Attack Norma
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  0, 4))); }
        public void angle_of_attack_normal_SET(float  src) //SUE Angle of Attack Norma
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 0); }
        public float angle_of_attack_inverted_GET()//SUE Angle of Attack Inverte
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  4, 4))); }
        public void angle_of_attack_inverted_SET(float  src) //SUE Angle of Attack Inverte
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 4); }
        public float elevator_trim_normal_GET()//SUE Elevator Trim Norma
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  8, 4))); }
        public void elevator_trim_normal_SET(float  src) //SUE Elevator Trim Norma
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 8); }
        public float elevator_trim_inverted_GET()//SUE Elevator Trim Inverte
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  12, 4))); }
        public void elevator_trim_inverted_SET(float  src) //SUE Elevator Trim Inverte
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 12); }
        public float reference_speed_GET()//SUE reference_spee
        {  return (float)(Float.intBitsToFloat((int) get_bytes(data,  16, 4))); }
        public void reference_speed_SET(float  src) //SUE reference_spee
        {  set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 16); }
        static final Meta meta = new Meta(184, 0, 0, 0, 20, 160);
    } public static class SERIAL_UDB_EXTRA_F19 extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        SERIAL_UDB_EXTRA_F19() { super(meta, 0); }
        SERIAL_UDB_EXTRA_F19(int bytes) { super(meta, bytes); }
        public char sue_aileron_output_channel_GET()//SUE aileron output channe
        {  return (char)((char) get_bytes(data,  0, 1)); }
        public void sue_aileron_output_channel_SET(char  src) //SUE aileron output channe
        {  set_bytes((char)(src) & -1L, 1, data,  0); }
        public char sue_aileron_reversed_GET()//SUE aileron reverse
        {  return (char)((char) get_bytes(data,  1, 1)); }
        public void sue_aileron_reversed_SET(char  src) //SUE aileron reverse
        {  set_bytes((char)(src) & -1L, 1, data,  1); }
        public char sue_elevator_output_channel_GET()//SUE elevator output channe
        {  return (char)((char) get_bytes(data,  2, 1)); }
        public void sue_elevator_output_channel_SET(char  src) //SUE elevator output channe
        {  set_bytes((char)(src) & -1L, 1, data,  2); }
        public char sue_elevator_reversed_GET()//SUE elevator reverse
        {  return (char)((char) get_bytes(data,  3, 1)); }
        public void sue_elevator_reversed_SET(char  src) //SUE elevator reverse
        {  set_bytes((char)(src) & -1L, 1, data,  3); }
        public char sue_throttle_output_channel_GET()//SUE throttle output channe
        {  return (char)((char) get_bytes(data,  4, 1)); }
        public void sue_throttle_output_channel_SET(char  src) //SUE throttle output channe
        {  set_bytes((char)(src) & -1L, 1, data,  4); }
        public char sue_throttle_reversed_GET()//SUE throttle reverse
        {  return (char)((char) get_bytes(data,  5, 1)); }
        public void sue_throttle_reversed_SET(char  src) //SUE throttle reverse
        {  set_bytes((char)(src) & -1L, 1, data,  5); }
        public char sue_rudder_output_channel_GET()//SUE rudder output channe
        {  return (char)((char) get_bytes(data,  6, 1)); }
        public void sue_rudder_output_channel_SET(char  src) //SUE rudder output channe
        {  set_bytes((char)(src) & -1L, 1, data,  6); }
        public char sue_rudder_reversed_GET()//SUE rudder reverse
        {  return (char)((char) get_bytes(data,  7, 1)); }
        public void sue_rudder_reversed_SET(char  src) //SUE rudder reverse
        {  set_bytes((char)(src) & -1L, 1, data,  7); }
        static final Meta meta = new Meta(185, 0, 0, 0, 8, 64);
    } public static class SERIAL_UDB_EXTRA_F20 extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        SERIAL_UDB_EXTRA_F20() { super(meta, 0); }
        SERIAL_UDB_EXTRA_F20(int bytes) { super(meta, bytes); }
        public char sue_number_of_inputs_GET()//SUE Number of Input Channel
        {  return (char)((char) get_bytes(data,  0, 1)); }
        public void sue_number_of_inputs_SET(char  src) //SUE Number of Input Channel
        {  set_bytes((char)(src) & -1L, 1, data,  0); }
        public short sue_trim_value_input_1_GET()//SUE UDB PWM Trim Value on Input
        {  return (short)((short) get_bytes(data,  1, 2)); }
        public void sue_trim_value_input_1_SET(short  src) //SUE UDB PWM Trim Value on Input
        {  set_bytes((short)(src) & -1L, 2, data,  1); }
        public short sue_trim_value_input_2_GET()//SUE UDB PWM Trim Value on Input
        {  return (short)((short) get_bytes(data,  3, 2)); }
        public void sue_trim_value_input_2_SET(short  src) //SUE UDB PWM Trim Value on Input
        {  set_bytes((short)(src) & -1L, 2, data,  3); }
        public short sue_trim_value_input_3_GET()//SUE UDB PWM Trim Value on Input
        {  return (short)((short) get_bytes(data,  5, 2)); }
        public void sue_trim_value_input_3_SET(short  src) //SUE UDB PWM Trim Value on Input
        {  set_bytes((short)(src) & -1L, 2, data,  5); }
        public short sue_trim_value_input_4_GET()//SUE UDB PWM Trim Value on Input
        {  return (short)((short) get_bytes(data,  7, 2)); }
        public void sue_trim_value_input_4_SET(short  src) //SUE UDB PWM Trim Value on Input
        {  set_bytes((short)(src) & -1L, 2, data,  7); }
        public short sue_trim_value_input_5_GET()//SUE UDB PWM Trim Value on Input
        {  return (short)((short) get_bytes(data,  9, 2)); }
        public void sue_trim_value_input_5_SET(short  src) //SUE UDB PWM Trim Value on Input
        {  set_bytes((short)(src) & -1L, 2, data,  9); }
        public short sue_trim_value_input_6_GET()//SUE UDB PWM Trim Value on Input
        {  return (short)((short) get_bytes(data,  11, 2)); }
        public void sue_trim_value_input_6_SET(short  src) //SUE UDB PWM Trim Value on Input
        {  set_bytes((short)(src) & -1L, 2, data,  11); }
        public short sue_trim_value_input_7_GET()//SUE UDB PWM Trim Value on Input
        {  return (short)((short) get_bytes(data,  13, 2)); }
        public void sue_trim_value_input_7_SET(short  src) //SUE UDB PWM Trim Value on Input
        {  set_bytes((short)(src) & -1L, 2, data,  13); }
        public short sue_trim_value_input_8_GET()//SUE UDB PWM Trim Value on Input
        {  return (short)((short) get_bytes(data,  15, 2)); }
        public void sue_trim_value_input_8_SET(short  src) //SUE UDB PWM Trim Value on Input
        {  set_bytes((short)(src) & -1L, 2, data,  15); }
        public short sue_trim_value_input_9_GET()//SUE UDB PWM Trim Value on Input
        {  return (short)((short) get_bytes(data,  17, 2)); }
        public void sue_trim_value_input_9_SET(short  src) //SUE UDB PWM Trim Value on Input
        {  set_bytes((short)(src) & -1L, 2, data,  17); }
        public short sue_trim_value_input_10_GET()//SUE UDB PWM Trim Value on Input 1
        {  return (short)((short) get_bytes(data,  19, 2)); }
        public void sue_trim_value_input_10_SET(short  src) //SUE UDB PWM Trim Value on Input 1
        {  set_bytes((short)(src) & -1L, 2, data,  19); }
        public short sue_trim_value_input_11_GET()//SUE UDB PWM Trim Value on Input 1
        {  return (short)((short) get_bytes(data,  21, 2)); }
        public void sue_trim_value_input_11_SET(short  src) //SUE UDB PWM Trim Value on Input 1
        {  set_bytes((short)(src) & -1L, 2, data,  21); }
        public short sue_trim_value_input_12_GET()//SUE UDB PWM Trim Value on Input 1
        {  return (short)((short) get_bytes(data,  23, 2)); }
        public void sue_trim_value_input_12_SET(short  src) //SUE UDB PWM Trim Value on Input 1
        {  set_bytes((short)(src) & -1L, 2, data,  23); }
        static final Meta meta = new Meta(186, 0, 0, 0, 25, 200);
    } public static class SERIAL_UDB_EXTRA_F21 extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        SERIAL_UDB_EXTRA_F21() { super(meta, 0); }
        SERIAL_UDB_EXTRA_F21(int bytes) { super(meta, bytes); }
        public short sue_accel_x_offset_GET()//SUE X accelerometer offse
        {  return (short)((short) get_bytes(data,  0, 2)); }
        public void sue_accel_x_offset_SET(short  src) //SUE X accelerometer offse
        {  set_bytes((short)(src) & -1L, 2, data,  0); }
        public short sue_accel_y_offset_GET()//SUE Y accelerometer offse
        {  return (short)((short) get_bytes(data,  2, 2)); }
        public void sue_accel_y_offset_SET(short  src) //SUE Y accelerometer offse
        {  set_bytes((short)(src) & -1L, 2, data,  2); }
        public short sue_accel_z_offset_GET()//SUE Z accelerometer offse
        {  return (short)((short) get_bytes(data,  4, 2)); }
        public void sue_accel_z_offset_SET(short  src) //SUE Z accelerometer offse
        {  set_bytes((short)(src) & -1L, 2, data,  4); }
        public short sue_gyro_x_offset_GET()//SUE X gyro offse
        {  return (short)((short) get_bytes(data,  6, 2)); }
        public void sue_gyro_x_offset_SET(short  src) //SUE X gyro offse
        {  set_bytes((short)(src) & -1L, 2, data,  6); }
        public short sue_gyro_y_offset_GET()//SUE Y gyro offse
        {  return (short)((short) get_bytes(data,  8, 2)); }
        public void sue_gyro_y_offset_SET(short  src) //SUE Y gyro offse
        {  set_bytes((short)(src) & -1L, 2, data,  8); }
        public short sue_gyro_z_offset_GET()//SUE Z gyro offse
        {  return (short)((short) get_bytes(data,  10, 2)); }
        public void sue_gyro_z_offset_SET(short  src) //SUE Z gyro offse
        {  set_bytes((short)(src) & -1L, 2, data,  10); }
        static final Meta meta = new Meta(187, 0, 0, 0, 12, 96);
    } public static class SERIAL_UDB_EXTRA_F22 extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        SERIAL_UDB_EXTRA_F22() { super(meta, 0); }
        SERIAL_UDB_EXTRA_F22(int bytes) { super(meta, bytes); }
        public short sue_accel_x_at_calibration_GET()//SUE X accelerometer at calibration tim
        {  return (short)((short) get_bytes(data,  0, 2)); }
        public void sue_accel_x_at_calibration_SET(short  src) //SUE X accelerometer at calibration tim
        {  set_bytes((short)(src) & -1L, 2, data,  0); }
        public short sue_accel_y_at_calibration_GET()//SUE Y accelerometer at calibration tim
        {  return (short)((short) get_bytes(data,  2, 2)); }
        public void sue_accel_y_at_calibration_SET(short  src) //SUE Y accelerometer at calibration tim
        {  set_bytes((short)(src) & -1L, 2, data,  2); }
        public short sue_accel_z_at_calibration_GET()//SUE Z accelerometer at calibration tim
        {  return (short)((short) get_bytes(data,  4, 2)); }
        public void sue_accel_z_at_calibration_SET(short  src) //SUE Z accelerometer at calibration tim
        {  set_bytes((short)(src) & -1L, 2, data,  4); }
        public short sue_gyro_x_at_calibration_GET()//SUE X gyro at calibration tim
        {  return (short)((short) get_bytes(data,  6, 2)); }
        public void sue_gyro_x_at_calibration_SET(short  src) //SUE X gyro at calibration tim
        {  set_bytes((short)(src) & -1L, 2, data,  6); }
        public short sue_gyro_y_at_calibration_GET()//SUE Y gyro at calibration tim
        {  return (short)((short) get_bytes(data,  8, 2)); }
        public void sue_gyro_y_at_calibration_SET(short  src) //SUE Y gyro at calibration tim
        {  set_bytes((short)(src) & -1L, 2, data,  8); }
        public short sue_gyro_z_at_calibration_GET()//SUE Z gyro at calibration tim
        {  return (short)((short) get_bytes(data,  10, 2)); }
        public void sue_gyro_z_at_calibration_SET(short  src) //SUE Z gyro at calibration tim
        {  set_bytes((short)(src) & -1L, 2, data,  10); }
        static final Meta meta = new Meta(188, 0, 0, 0, 12, 96);
...
//Timestamp (microseconds since UNIX epoch or microseconds since system boot
        ...
        public void time_usec_SET(long  src, Bounds.Inside ph)//Timestamp (microseconds since UNIX epoch or microseconds since system boot
        {
            ...
            set_bytes((src) & -1L, 8, data,  ph.BYTE);
        } static final Meta meta = new Meta(242, 0, 0, 0, 53, 416, 0, _nY);
...
//Timestamp (microseconds since UNIX epoch or microseconds since system boot
        ...
        public void time_usec_SET(long  src, Bounds.Inside ph)//Timestamp (microseconds since UNIX epoch or microseconds since system boot
        {
            ...
            set_bytes((src) & -1L, 8, data,  ph.BYTE);
        } static final Meta meta = new Meta(243, 0, 0, 0, 54, 424, 0, _dX);
...
//The callsign, 8+nul
        ...
        {callsign_SET(src.toCharArray(), 0, src.length(), ph);} public void callsign_SET(char[]  src, int pos, int items, Bounds.Inside ph) //The callsign, 8+nul
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(246, 3, 1, 0, 28, 210, 0, _rX);
...
//Nam
        ...
        {name_SET(src.toCharArray(), 0, src.length(), ph);} public void name_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Nam
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(250, 0, 0, 1, 21, 160, 0, _LX);
...
//Name of the debug variabl
        ...
        {name_SET(src.toCharArray(), 0, src.length(), ph);} public void name_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Name of the debug variabl
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(251, 0, 1, 0, 9, 64, 0, _nX);
...
//Name of the debug variabl
        ...
        {name_SET(src.toCharArray(), 0, src.length(), ph);} public void name_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Name of the debug variabl
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(252, 0, 1, 0, 9, 64, 0, _lC);
...
//Status text message, without null termination characte
        ...
        {text_SET(src.toCharArray(), 0, src.length(), ph);} public void text_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Status text message, without null termination characte
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(253, 0, 0, 0, 2, 4, 0, _zC);
...
//tune in board specific forma
        ...
        {tune_SET(src.toCharArray(), 0, src.length(), ph);} public void tune_SET(char[]  src, int pos, int items, Bounds.Inside ph) //tune in board specific forma
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(258, 0, 0, 0, 3, 16, 0, _yC);
...
//Camera definition URI (if any, otherwise only basic functions will be available)
        ...
        {cam_definition_uri_SET(src.toCharArray(), 0, src.length(), ph);} public void cam_definition_uri_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Camera definition URI (if any, otherwise only basic functions will be available)
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(259, 3, 2, 0, 93, 731, 0, _sC);
...
//foo.jpg if camera provides an HTTP interface
        ...
        {file_url_SET(src.toCharArray(), 0, src.length(), ph);} public void file_url_SET(char[]  src, int pos, int items, Bounds.Inside ph) //foo.jpg if camera provides an HTTP interface
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(263, 0, 1, 1, 51, 402, 2, _NB);
...
//Video stream UR
        ...
        {uri_SET(src.toCharArray(), 0, src.length(), ph);} public void uri_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Video stream UR
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(269, 3, 1, 0, 17, 130, 2, _pB);
...
//Video stream UR
        ...
        {uri_SET(src.toCharArray(), 0, src.length(), ph);} public void uri_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Video stream UR
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(270, 3, 1, 0, 18, 138, 2, _gB);
...
//Password. Leave it blank for an open AP
        ...
        {password_SET(src.toCharArray(), 0, src.length(), ph);} public void password_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Password. Leave it blank for an open AP
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(299, 0, 0, 0, 1, 2, 2, _iB, _DB);
...
//Node name string. For example, "sapog.px4.io"
        ...
        {name_SET(src.toCharArray(), 0, src.length(), ph);} public void name_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Node name string. For example, "sapog.px4.io"
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(311, 0, 2, 1, 37, 288, 0, _dr);
    } public static class PARAM_EXT_REQUEST_READ extends Pack  implements LoopBackDemoChannel.Sendable, LoopBackDemoChannel_ADV.Sendable
    {
        ...
        } public void param_id_SET(String src, Bounds.Inside ph) {param_id_SET(src.toCharArray(), 0, src.length(), ph);} public void param_id_SET(char[]  src, int pos, int items, Bounds.Inside ph)
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(320, 0, 0, 0, 5, 32, 0, _Yr);
...
//Parameter valu
        ...
        {param_value_SET(src.toCharArray(), 0, src.length(), ph);} public void param_value_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Parameter valu
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(322, 2, 0, 0, 5, 38, 2, _rr, _qr);
...
//Parameter valu
        ...
        {param_value_SET(src.toCharArray(), 0, src.length(), ph);} public void param_value_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Parameter valu
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(323, 0, 0, 0, 3, 22, 2, _sr, _Gr);
...
//Parameter value (new value if PARAM_ACK_ACCEPTED, current value otherwise
        ...
        {param_value_SET(src.toCharArray(), 0, src.length(), ph);} public void param_value_SET(char[]  src, int pos, int items, Bounds.Inside ph) //Parameter value (new value if PARAM_ACK_ACCEPTED, current value otherwise
        {
            ...
            for(int BYTE =  ph.BYTE, src_max = pos + ph.items; pos < src_max; pos++, BYTE += 2)
                set_bytes((short)(src[pos]) & -1L, 2, data,  BYTE);
        } static final Meta meta = new Meta(324, 0, 0, 0, 2, 9, 2, _ur, _Rr);
    ...
    public static class LoopBackDemoChannel  extends Channel
    {
        ...
        public static FLEXIFUNCTION_SET new_FLEXIFUNCTION_SET() {return new  FLEXIFUNCTION_SET();}
        public static FLEXIFUNCTION_READ_REQ new_FLEXIFUNCTION_READ_REQ() {return new  FLEXIFUNCTION_READ_REQ();}
        public static FLEXIFUNCTION_BUFFER_FUNCTION new_FLEXIFUNCTION_BUFFER_FUNCTION() {return new  FLEXIFUNCTION_BUFFER_FUNCTION();}
        public static FLEXIFUNCTION_BUFFER_FUNCTION_ACK new_FLEXIFUNCTION_BUFFER_FUNCTION_ACK() {return new  FLEXIFUNCTION_BUFFER_FUNCTION_ACK();}
        public static FLEXIFUNCTION_DIRECTORY new_FLEXIFUNCTION_DIRECTORY() {return new  FLEXIFUNCTION_DIRECTORY();}
        public static FLEXIFUNCTION_DIRECTORY_ACK new_FLEXIFUNCTION_DIRECTORY_ACK() {return new  FLEXIFUNCTION_DIRECTORY_ACK();}
        public static FLEXIFUNCTION_COMMAND new_FLEXIFUNCTION_COMMAND() {return new  FLEXIFUNCTION_COMMAND();}
        public static FLEXIFUNCTION_COMMAND_ACK new_FLEXIFUNCTION_COMMAND_ACK() {return new  FLEXIFUNCTION_COMMAND_ACK();}
        public static SERIAL_UDB_EXTRA_F2_A new_SERIAL_UDB_EXTRA_F2_A() {return new  SERIAL_UDB_EXTRA_F2_A();}
        public static SERIAL_UDB_EXTRA_F2_B new_SERIAL_UDB_EXTRA_F2_B() {return new  SERIAL_UDB_EXTRA_F2_B();}
        public static SERIAL_UDB_EXTRA_F4 new_SERIAL_UDB_EXTRA_F4() {return new  SERIAL_UDB_EXTRA_F4();}
        public static SERIAL_UDB_EXTRA_F5 new_SERIAL_UDB_EXTRA_F5() {return new  SERIAL_UDB_EXTRA_F5();}
        public static SERIAL_UDB_EXTRA_F6 new_SERIAL_UDB_EXTRA_F6() {return new  SERIAL_UDB_EXTRA_F6();}
        public static SERIAL_UDB_EXTRA_F7 new_SERIAL_UDB_EXTRA_F7() {return new  SERIAL_UDB_EXTRA_F7();}
        public static SERIAL_UDB_EXTRA_F8 new_SERIAL_UDB_EXTRA_F8() {return new  SERIAL_UDB_EXTRA_F8();}
        public static SERIAL_UDB_EXTRA_F13 new_SERIAL_UDB_EXTRA_F13() {return new  SERIAL_UDB_EXTRA_F13();}
        public static SERIAL_UDB_EXTRA_F14 new_SERIAL_UDB_EXTRA_F14() {return new  SERIAL_UDB_EXTRA_F14();}
        public static SERIAL_UDB_EXTRA_F15 new_SERIAL_UDB_EXTRA_F15() {return new  SERIAL_UDB_EXTRA_F15();}
        public static SERIAL_UDB_EXTRA_F16 new_SERIAL_UDB_EXTRA_F16() {return new  SERIAL_UDB_EXTRA_F16();}
        public static ALTITUDES new_ALTITUDES() {return new  ALTITUDES();}
        public static AIRSPEEDS new_AIRSPEEDS() {return new  AIRSPEEDS();}
        public static SERIAL_UDB_EXTRA_F17 new_SERIAL_UDB_EXTRA_F17() {return new  SERIAL_UDB_EXTRA_F17();}
        public static SERIAL_UDB_EXTRA_F18 new_SERIAL_UDB_EXTRA_F18() {return new  SERIAL_UDB_EXTRA_F18();}
        public static SERIAL_UDB_EXTRA_F19 new_SERIAL_UDB_EXTRA_F19() {return new  SERIAL_UDB_EXTRA_F19();}
        public static SERIAL_UDB_EXTRA_F20 new_SERIAL_UDB_EXTRA_F20() {return new  SERIAL_UDB_EXTRA_F20();}
        public static SERIAL_UDB_EXTRA_F21 new_SERIAL_UDB_EXTRA_F21() {return new  SERIAL_UDB_EXTRA_F21();}
        public static SERIAL_UDB_EXTRA_F22 new_SERIAL_UDB_EXTRA_F22() {return new  SERIAL_UDB_EXTRA_F22();}
            ...
            for(boolean LOOP = false; ;)
            {
                switch(id)
                {
                    ...
                    case 150:
                        ...
                        final FLEXIFUNCTION_SET pi150 = (FLEXIFUNCTION_SET) pack;
                        ph.setPack(pi150);
                        on_FLEXIFUNCTION_SET.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi150));
                        if(LOOP) break;
                        return null;
                    case 151:
                        if(pack == null) return new FLEXIFUNCTION_READ_REQ();
                        final FLEXIFUNCTION_READ_REQ pi151 = (FLEXIFUNCTION_READ_REQ) pack;
                        ph.setPack(pi151);
                        on_FLEXIFUNCTION_READ_REQ.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi151));
                        if(LOOP) break;
                        return null;
                    case 152:
                        if(pack == null) return new FLEXIFUNCTION_BUFFER_FUNCTION();
                        final FLEXIFUNCTION_BUFFER_FUNCTION pi152 = (FLEXIFUNCTION_BUFFER_FUNCTION) pack;
                        ph.setPack(pi152);
                        on_FLEXIFUNCTION_BUFFER_FUNCTION.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi152));
                        if(LOOP) break;
                        return null;
                    case 153:
                        if(pack == null) return new FLEXIFUNCTION_BUFFER_FUNCTION_ACK();
                        final FLEXIFUNCTION_BUFFER_FUNCTION_ACK pi153 = (FLEXIFUNCTION_BUFFER_FUNCTION_ACK) pack;
                        ph.setPack(pi153);
                        on_FLEXIFUNCTION_BUFFER_FUNCTION_ACK.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi153));
                        if(LOOP) break;
                        return null;
                    case 155:
                        if(pack == null) return new FLEXIFUNCTION_DIRECTORY();
                        final FLEXIFUNCTION_DIRECTORY pi155 = (FLEXIFUNCTION_DIRECTORY) pack;
                        ph.setPack(pi155);
                        on_FLEXIFUNCTION_DIRECTORY.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi155));
                        if(LOOP) break;
                        return null;
                    case 156:
                        if(pack == null) return new FLEXIFUNCTION_DIRECTORY_ACK();
                        final FLEXIFUNCTION_DIRECTORY_ACK pi156 = (FLEXIFUNCTION_DIRECTORY_ACK) pack;
                        ph.setPack(pi156);
                        on_FLEXIFUNCTION_DIRECTORY_ACK.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi156));
                        if(LOOP) break;
                        return null;
                    case 157:
                        if(pack == null) return new FLEXIFUNCTION_COMMAND();
                        final FLEXIFUNCTION_COMMAND pi157 = (FLEXIFUNCTION_COMMAND) pack;
                        ph.setPack(pi157);
                        on_FLEXIFUNCTION_COMMAND.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi157));
                        if(LOOP) break;
                        return null;
                    case 158:
                        if(pack == null) return new FLEXIFUNCTION_COMMAND_ACK();
                        final FLEXIFUNCTION_COMMAND_ACK pi158 = (FLEXIFUNCTION_COMMAND_ACK) pack;
                        ph.setPack(pi158);
                        on_FLEXIFUNCTION_COMMAND_ACK.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi158));
                        if(LOOP) break;
                        return null;
                    case 170:
                        if(pack == null) return new SERIAL_UDB_EXTRA_F2_A();
                        final SERIAL_UDB_EXTRA_F2_A pi170 = (SERIAL_UDB_EXTRA_F2_A) pack;
                        ph.setPack(pi170);
                        on_SERIAL_UDB_EXTRA_F2_A.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi170));
                        if(LOOP) break;
                        return null;
                    case 171:
                        if(pack == null) return new SERIAL_UDB_EXTRA_F2_B();
                        final SERIAL_UDB_EXTRA_F2_B pi171 = (SERIAL_UDB_EXTRA_F2_B) pack;
                        ph.setPack(pi171);
                        on_SERIAL_UDB_EXTRA_F2_B.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi171));
                        if(LOOP) break;
                        return null;
                    case 172:
                        if(pack == null) return new SERIAL_UDB_EXTRA_F4();
                        final SERIAL_UDB_EXTRA_F4 pi172 = (SERIAL_UDB_EXTRA_F4) pack;
                        ph.setPack(pi172);
                        on_SERIAL_UDB_EXTRA_F4.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi172));
                        if(LOOP) break;
                        return null;
                    case 173:
                        if(pack == null) return new SERIAL_UDB_EXTRA_F5();
                        final SERIAL_UDB_EXTRA_F5 pi173 = (SERIAL_UDB_EXTRA_F5) pack;
                        ph.setPack(pi173);
                        on_SERIAL_UDB_EXTRA_F5.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi173));
                        if(LOOP) break;
                        return null;
                    case 174:
                        if(pack == null) return new SERIAL_UDB_EXTRA_F6();
                        final SERIAL_UDB_EXTRA_F6 pi174 = (SERIAL_UDB_EXTRA_F6) pack;
                        ph.setPack(pi174);
                        on_SERIAL_UDB_EXTRA_F6.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi174));
                        if(LOOP) break;
                        return null;
                    case 175:
                        if(pack == null) return new SERIAL_UDB_EXTRA_F7();
                        final SERIAL_UDB_EXTRA_F7 pi175 = (SERIAL_UDB_EXTRA_F7) pack;
                        ph.setPack(pi175);
                        on_SERIAL_UDB_EXTRA_F7.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi175));
                        if(LOOP) break;
                        return null;
                    case 176:
                        if(pack == null) return new SERIAL_UDB_EXTRA_F8();
                        final SERIAL_UDB_EXTRA_F8 pi176 = (SERIAL_UDB_EXTRA_F8) pack;
                        ph.setPack(pi176);
                        on_SERIAL_UDB_EXTRA_F8.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi176));
                        if(LOOP) break;
                        return null;
                    case 177:
                        if(pack == null) return new SERIAL_UDB_EXTRA_F13();
                        final SERIAL_UDB_EXTRA_F13 pi177 = (SERIAL_UDB_EXTRA_F13) pack;
                        ph.setPack(pi177);
                        on_SERIAL_UDB_EXTRA_F13.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi177));
                        if(LOOP) break;
                        return null;
                    case 178:
                        if(pack == null) return new SERIAL_UDB_EXTRA_F14();
                        final SERIAL_UDB_EXTRA_F14 pi178 = (SERIAL_UDB_EXTRA_F14) pack;
                        ph.setPack(pi178);
                        on_SERIAL_UDB_EXTRA_F14.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi178));
                        if(LOOP) break;
                        return null;
                    case 179:
                        if(pack == null) return new SERIAL_UDB_EXTRA_F15();
                        final SERIAL_UDB_EXTRA_F15 pi179 = (SERIAL_UDB_EXTRA_F15) pack;
                        ph.setPack(pi179);
                        on_SERIAL_UDB_EXTRA_F15.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi179));
                        if(LOOP) break;
                        return null;
                    case 180:
                        if(pack == null) return new SERIAL_UDB_EXTRA_F16();
                        final SERIAL_UDB_EXTRA_F16 pi180 = (SERIAL_UDB_EXTRA_F16) pack;
                        ph.setPack(pi180);
                        on_SERIAL_UDB_EXTRA_F16.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi180));
                        if(LOOP) break;
                        return null;
                    case 181:
                        if(pack == null) return new ALTITUDES();
                        final ALTITUDES pi181 = (ALTITUDES) pack;
                        ph.setPack(pi181);
                        on_ALTITUDES.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi181));
                        if(LOOP) break;
                        return null;
                    case 182:
                        if(pack == null) return new AIRSPEEDS();
                        final AIRSPEEDS pi182 = (AIRSPEEDS) pack;
                        ph.setPack(pi182);
                        on_AIRSPEEDS.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi182));
                        if(LOOP) break;
                        return null;
                    case 183:
                        if(pack == null) return new SERIAL_UDB_EXTRA_F17();
                        final SERIAL_UDB_EXTRA_F17 pi183 = (SERIAL_UDB_EXTRA_F17) pack;
                        ph.setPack(pi183);
                        on_SERIAL_UDB_EXTRA_F17.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi183));
                        if(LOOP) break;
                        return null;
                    case 184:
                        if(pack == null) return new SERIAL_UDB_EXTRA_F18();
                        final SERIAL_UDB_EXTRA_F18 pi184 = (SERIAL_UDB_EXTRA_F18) pack;
                        ph.setPack(pi184);
                        on_SERIAL_UDB_EXTRA_F18.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi184));
                        if(LOOP) break;
                        return null;
                    case 185:
                        if(pack == null) return new SERIAL_UDB_EXTRA_F19();
                        final SERIAL_UDB_EXTRA_F19 pi185 = (SERIAL_UDB_EXTRA_F19) pack;
                        ph.setPack(pi185);
                        on_SERIAL_UDB_EXTRA_F19.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi185));
                        if(LOOP) break;
                        return null;
                    case 186:
                        if(pack == null) return new SERIAL_UDB_EXTRA_F20();
                        final SERIAL_UDB_EXTRA_F20 pi186 = (SERIAL_UDB_EXTRA_F20) pack;
                        ph.setPack(pi186);
                        on_SERIAL_UDB_EXTRA_F20.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi186));
                        if(LOOP) break;
                        return null;
                    case 187:
                        if(pack == null) return new SERIAL_UDB_EXTRA_F21();
                        final SERIAL_UDB_EXTRA_F21 pi187 = (SERIAL_UDB_EXTRA_F21) pack;
                        ph.setPack(pi187);
                        on_SERIAL_UDB_EXTRA_F21.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi187));
                        if(LOOP) break;
                        return null;
                    case 188:
                        if(pack == null) return new SERIAL_UDB_EXTRA_F22();
                        final SERIAL_UDB_EXTRA_F22 pi188 = (SERIAL_UDB_EXTRA_F22) pack;
                        ph.setPack(pi188);
                        on_SERIAL_UDB_EXTRA_F22.forEach(h -> h.handle(LoopBackDemoChannel.this, ph, pi188));
                        if(LOOP) break;
                        return null;
                    case 230:
        ...
        public final Collection<OnReceive.Handler<FLEXIFUNCTION_SET, LoopBackDemoChannel>> on_FLEXIFUNCTION_SET = new OnReceive<>();
        public final Collection<OnReceive.Handler<FLEXIFUNCTION_READ_REQ, LoopBackDemoChannel>> on_FLEXIFUNCTION_READ_REQ = new OnReceive<>();
        public final Collection<OnReceive.Handler<FLEXIFUNCTION_BUFFER_FUNCTION, LoopBackDemoChannel>> on_FLEXIFUNCTION_BUFFER_FUNCTION = new OnReceive<>();
        public final Collection<OnReceive.Handler<FLEXIFUNCTION_BUFFER_FUNCTION_ACK, LoopBackDemoChannel>> on_FLEXIFUNCTION_BUFFER_FUNCTION_ACK = new OnReceive<>();
        public final Collection<OnReceive.Handler<FLEXIFUNCTION_DIRECTORY, LoopBackDemoChannel>> on_FLEXIFUNCTION_DIRECTORY = new OnReceive<>();
        public final Collection<OnReceive.Handler<FLEXIFUNCTION_DIRECTORY_ACK, LoopBackDemoChannel>> on_FLEXIFUNCTION_DIRECTORY_ACK = new OnReceive<>();
        public final Collection<OnReceive.Handler<FLEXIFUNCTION_COMMAND, LoopBackDemoChannel>> on_FLEXIFUNCTION_COMMAND = new OnReceive<>();
        public final Collection<OnReceive.Handler<FLEXIFUNCTION_COMMAND_ACK, LoopBackDemoChannel>> on_FLEXIFUNCTION_COMMAND_ACK = new OnReceive<>();
        public final Collection<OnReceive.Handler<SERIAL_UDB_EXTRA_F2_A, LoopBackDemoChannel>> on_SERIAL_UDB_EXTRA_F2_A = new OnReceive<>();
        public final Collection<OnReceive.Handler<SERIAL_UDB_EXTRA_F2_B, LoopBackDemoChannel>> on_SERIAL_UDB_EXTRA_F2_B = new OnReceive<>();
        public final Collection<OnReceive.Handler<SERIAL_UDB_EXTRA_F4, LoopBackDemoChannel>> on_SERIAL_UDB_EXTRA_F4 = new OnReceive<>();
        public final Collection<OnReceive.Handler<SERIAL_UDB_EXTRA_F5, LoopBackDemoChannel>> on_SERIAL_UDB_EXTRA_F5 = new OnReceive<>();
        public final Collection<OnReceive.Handler<SERIAL_UDB_EXTRA_F6, LoopBackDemoChannel>> on_SERIAL_UDB_EXTRA_F6 = new OnReceive<>();
        public final Collection<OnReceive.Handler<SERIAL_UDB_EXTRA_F7, LoopBackDemoChannel>> on_SERIAL_UDB_EXTRA_F7 = new OnReceive<>();
        public final Collection<OnReceive.Handler<SERIAL_UDB_EXTRA_F8, LoopBackDemoChannel>> on_SERIAL_UDB_EXTRA_F8 = new OnReceive<>();
        public final Collection<OnReceive.Handler<SERIAL_UDB_EXTRA_F13, LoopBackDemoChannel>> on_SERIAL_UDB_EXTRA_F13 = new OnReceive<>();
        public final Collection<OnReceive.Handler<SERIAL_UDB_EXTRA_F14, LoopBackDemoChannel>> on_SERIAL_UDB_EXTRA_F14 = new OnReceive<>();
        public final Collection<OnReceive.Handler<SERIAL_UDB_EXTRA_F15, LoopBackDemoChannel>> on_SERIAL_UDB_EXTRA_F15 = new OnReceive<>();
        public final Collection<OnReceive.Handler<SERIAL_UDB_EXTRA_F16, LoopBackDemoChannel>> on_SERIAL_UDB_EXTRA_F16 = new OnReceive<>();
        public final Collection<OnReceive.Handler<ALTITUDES, LoopBackDemoChannel>> on_ALTITUDES = new OnReceive<>();
        public final Collection<OnReceive.Handler<AIRSPEEDS, LoopBackDemoChannel>> on_AIRSPEEDS = new OnReceive<>();
        public final Collection<OnReceive.Handler<SERIAL_UDB_EXTRA_F17, LoopBackDemoChannel>> on_SERIAL_UDB_EXTRA_F17 = new OnReceive<>();
        public final Collection<OnReceive.Handler<SERIAL_UDB_EXTRA_F18, LoopBackDemoChannel>> on_SERIAL_UDB_EXTRA_F18 = new OnReceive<>();
        public final Collection<OnReceive.Handler<SERIAL_UDB_EXTRA_F19, LoopBackDemoChannel>> on_SERIAL_UDB_EXTRA_F19 = new OnReceive<>();
        public final Collection<OnReceive.Handler<SERIAL_UDB_EXTRA_F20, LoopBackDemoChannel>> on_SERIAL_UDB_EXTRA_F20 = new OnReceive<>();
        public final Collection<OnReceive.Handler<SERIAL_UDB_EXTRA_F21, LoopBackDemoChannel>> on_SERIAL_UDB_EXTRA_F21 = new OnReceive<>();
        public final Collection<OnReceive.Handler<SERIAL_UDB_EXTRA_F22, LoopBackDemoChannel>> on_SERIAL_UDB_EXTRA_F22 = new OnReceive<>();
    ...
    private static final Field _e = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
    private static final Field _u = new Field(5, true, -6, 2, 1, 0, 0, 0, 1);
    private static final Field _O = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
    private static final Field _t = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
    private static final Field _n = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
    private static final Field _QW = new Field(0, false, 1, 4, 1, 0, 0, 0);
    private static final Field _wW = new Field(0, true, 1, 4, 1, 0, 0, 0);
    private static final Field _UW = new Field(0, true, 1, 4, 1, 0, 0, 0);
    private static final Field _aW = new Field(0, true, 1, 4, 1, 0, 0, 0);
    private static final Field _cW = new Field(0, true, 1, 4, 1, 0, 0, 0);
    private static final Field _dz = new Field(0, true, 1, 2, 1, 0, 0, 0);
    private static final Field _Qz = new Field(0, true, 1, 2, 1, 0, 0, 0);
    private static final Field _wz = new Field(0, true, 1, 2, 1, 0, 0, 0);
    private static final Field _Uz = new Field(0, true, 1, 2, 1, 0, 0, 0);
    private static final Field _az = new Field(0, true, 1, 2, 1, 0, 0, 0);
    private static final Field _cz = new Field(0, true, 1, 2, 1, 0, 0, 0);
    private static final Field _Zz = new Field(0, true, 1, 2, 1, 0, 0, 0);
    private static final Field _yz = new Field(0, true, 1, 2, 1, 0, 0, 0);
    private static final Field _IS = new Field(0, true, 1, 8, 1, 0, 0, 0);
    private static final Field _BS = new Field(0, true, 1, 8, 1, 0, 0, 0);
    private static final Field _vS = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
    private static final Field _qx = new Field(0, false, 1, 1, 1, 0, 0, 0);
    private static final Field _vx = new Field(0, false, 1, 4, 1, 0, 0, 0);
    private static final Field _Vx = new Field(0, false, 1, 1, 1, 0, 0, 0);
    private static final Field _Px = new Field(0, false, 1, 1, 1, 0, 0, 0);
    private static final Field _cQ = new Field(0, false, 1, 4, 1, 0, 0, 0);
    private static final Field _ZQ = new Field(0, false, 1, 4, 1, 0, 0, 0);
    private static final Field _NI = new Field(0, false, 18, 1, 1, 0, 0, 0);
    private static final Field _cI = new Field(0, false, 1, 4, 1, 0, 0, 0);
    private static final Field _ZI = new Field(0, false, 1, 4, 1, 0, 0, 0);
    private static final Field _yI = new Field(0, false, 1, 4, 1, 0, 0, 0);
    private static final Field _II = new Field(0, false, 4, 4, 1, 0, 0, 0);
    private static final Field _XI = new Field(0, false, 1, 1, 1, 0, 0, 0);
    private static final Field _nY = new Field(0, true, 1, 8, 1, 0, 0, 0);
    private static final Field _dX = new Field(0, true, 1, 8, 1, 0, 0, 0);
    private static final Field _rX = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
    private static final Field _LX = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
    private static final Field _nX = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
    private static final Field _lC = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
    private static final Field _zC = new Field(5, true, -6, 2, 1, 0, 0, 0, 1);
    private static final Field _yC = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
    private static final Field _sC = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
    private static final Field _NB = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
    private static final Field _pB = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
    private static final Field _gB = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
    private static final Field _iB = new Field(5, true, -6, 2, 1, 0, 0, 0, 1);
    private static final Field _DB = new Field(5, true, -7, 2, 1, 0, 0, 0, 1);
    private static final Field _dr = new Field(5, true, -7, 2, 1, 0, 0, 0, 1);
    private static final Field _Yr = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
    private static final Field _rr = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
    private static final Field _qr = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
    private static final Field _sr = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
    private static final Field _Gr = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
    private static final Field _ur = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
    private static final Field _Rr = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
