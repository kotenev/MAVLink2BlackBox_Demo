...
public class GroundControl extends Host {
	...
	public static class PARAM_VALUE extends Pack {
		...
		static final Meta meta = new Meta(22, 2, 0, 0, 10, 68, 0, _o);
	}
	...
	public static class PARAM_SET extends Pack {
		...
		static final Meta meta = new Meta(23, 0, 0, 0, 8, 52, 0, _v);
	}
	...
	public static class GPS_RAW_INT extends Pack {
		...
		static final Meta meta = new Meta(24, 4, 0, 1, 31, 236, 0, _fQ, _pQ, _lQ, _cQ, _tQ);
	}
	...
	public static class GPS_STATUS extends Pack {
		...
		{return satellite_prn_GET(new char[20], 0);}

		public char[] satellite_used_GET(char[] dst_ch, int pos)  //0: Satellite not used, 1: used for localization
		{
		...
		{return satellite_used_GET(new char[20], 0);}

		public char[] satellite_elevation_GET(char[] dst_ch, int pos)  //Elevation (0: right on top of receiver, 90: on the horizon) of satellite
		{
		...
		{return satellite_elevation_GET(new char[20], 0);}
		...
		{return satellite_azimuth_GET(new char[20], 0);}

		public char[] satellite_snr_GET(char[] dst_ch, int pos)  //Signal to noise ratio of satellite
		{
		...
		{return satellite_snr_GET(new char[20], 0);}
	...
	public static class SERVO_OUTPUT_RAW extends Pack {
		...
		static final Meta meta = new Meta(36, 8, 1, 0, 22, 168, 0, _dG, _fG, _pG, _lG, _cG, _tG, _OG, _DG);
	}
	...
	public static class SET_GPS_GLOBAL_ORIGIN extends Pack {
		...
		static final Meta meta = new Meta(48, 0, 0, 0, 14, 104, 0, _TP);
	}
	...
	public static class GPS_GLOBAL_ORIGIN extends Pack {
		...
		static final Meta meta = new Meta(49, 0, 0, 0, 13, 96, 0, _sP);
	}
	...
	public static class PARAM_MAP_RC extends Pack {
		...
		static final Meta meta = new Meta(50, 0, 0, 0, 22, 168, 0, _HP);
	}
	...
	public static class ATTITUDE_QUATERNION_COV extends Pack {
		...
		{return covariance_GET(new float[9], 0);}
	...
	public static class GLOBAL_POSITION_INT_COV extends Pack {
		...
		{return covariance_GET(new float[36], 0);}
	...
	public static class LOCAL_POSITION_NED_COV extends Pack {
		 ...
		 * the second row, etc.
		 */
		public float[] covariance_GET() {return covariance_GET(new float[45], 0);}
	...
	public static class COMMAND_ACK extends Pack {
		...
		static final Meta meta = new Meta(77, 0, 0, 0, 3, 11, 0, _gu, _Hu, _Ru, _eu);
	}
	...
	public static class HIL_ACTUATOR_CONTROLS extends Pack implements CommunicationChannel.Sendable {
		...
		{return controls_GET(new float[16], 0);}
	...
	public static class OPTICAL_FLOW extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(100, 0, 0, 1, 27, 208, 0, _tf, _Of);
	}
	...
	public static class FILE_TRANSFER_PROTOCOL extends Pack implements CommunicationChannel.Sendable {
		 ...
		 * as part of the mavlink specification
		 */
		public char[] payload_GET() {return payload_GET(new char[251], 0);}
	...
	public static class HIL_STATE_QUATERNION extends Pack implements CommunicationChannel.Sendable {
		...
		{return attitude_quaternion_GET(new float[4], 0);}
	...
	public static class LOG_DATA extends Pack implements CommunicationChannel.Sendable {
		...
		{return data__GET(new char[90], 0);}

		public void data__SET(char[] src, int pos)  //log data
		{
	...
	public static class GPS_INJECT_DATA extends Pack implements CommunicationChannel.Sendable {
		...
		{return data__GET(new char[110], 0);}

		public void data__SET(char[] src, int pos)  //raw data (110 is enough for 12 satellites of RTCMv2)
		{
	...
	public static class SERIAL_CONTROL extends Pack implements CommunicationChannel.Sendable {
		...
		{return data__GET(new char[70], 0);}

		public void data__SET(char[] src, int pos)  //serial data
		{
	...
	public static class ENCAPSULATED_DATA extends Pack implements CommunicationChannel.Sendable {
		...
		{return data__GET(new char[253], 0);}

		public void data__SET(char[] src, int pos)  //image data bytes
		{
	...
	public static class TERRAIN_DATA extends Pack implements CommunicationChannel.Sendable {
		...
		{return data__GET(new short[16], 0);}
	...
	public static class AUTOPILOT_VERSION extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(148, 2, 4, 1, 54, 421, 0, _KT);
	}
	...
	public static class LANDING_TARGET extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(149, 0, 0, 1, 31, 239, 0, _tT, _OT, _DT, _TT, _FT);
	}

	/**
	 * Depreciated but used as a compiler flag.  Do not remove
	 */
	public static class FLEXIFUNCTION_SET extends Pack implements CommunicationChannel.Sendable {
	 ...
	 */
	public static class FLEXIFUNCTION_READ_REQ extends Pack implements CommunicationChannel.Sendable {
		...
		public void read_req_type_SET(short src) //Type of flexifunction data requested
		{ set_bytes((short) (src) & -1L, 2, data, 2); }

		public void data_index_SET(short src) //index into data where needed
		{ set_bytes((short) (src) & -1L, 2, data, 4); }
	 ...
	 */
	public static class FLEXIFUNCTION_BUFFER_FUNCTION extends Pack implements CommunicationChannel.Sendable {

		FLEXIFUNCTION_BUFFER_FUNCTION() { super(meta, 0); }

		public void func_index_SET(char src) //Function index
		{ set_bytes((char) (src) & -1L, 2, data, 0); }

		public void func_count_SET(char src) //Total count of functions
		{ set_bytes((char) (src) & -1L, 2, data, 2); }

		public void data_address_SET(char src) //Address in the flexifunction data, Set to 0xFFFF to use address in target memory
		{ set_bytes((char) (src) & -1L, 2, data, 4); }
		...
		public void data__SET(byte[] src, int pos)  //Settings data
		{
	 ...
	 * Flexifunction type and parameters for component at function index from buffer
	 */
	public static class FLEXIFUNCTION_BUFFER_FUNCTION_ACK extends Pack implements CommunicationChannel.Sendable {
		...
		public void result_SET(char src) //result of acknowledge, 0=fail, 1=good
		{ set_bytes((char) (src) & -1L, 2, data, 2); }
	 ...
	 */
	public static class FLEXIFUNCTION_DIRECTORY extends Pack implements CommunicationChannel.Sendable {
		...
		public void directory_type_SET(char src) //0=inputs, 1=outputs
		{ set_bytes((char) (src) & -1L, 1, data, 2); }

		public void start_index_SET(char src) //index of first directory entry to write
		{ set_bytes((char) (src) & -1L, 1, data, 3); }

		public void count_SET(char src) //count of directory entries to write
		{ set_bytes((char) (src) & -1L, 1, data, 4); }

		public void directory_data_SET(byte[] src, int pos)  //Settings data
		{
	 ...
	 * Acknowldge sucess or failure of a flexifunction command
	 */
	public static class FLEXIFUNCTION_DIRECTORY_ACK extends Pack implements CommunicationChannel.Sendable {
	 ...
	 * Acknowldge sucess or failure of a flexifunction command
	 */
	public static class FLEXIFUNCTION_COMMAND extends Pack implements CommunicationChannel.Sendable {
		...
		public void command_type_SET(char src) //Flexifunction command type
		{ set_bytes((char) (src) & -1L, 1, data, 2); }
	 ...
	 * Acknowldge sucess or failure of a flexifunction command
	 */
	public static class FLEXIFUNCTION_COMMAND_ACK extends Pack implements CommunicationChannel.Sendable {

		FLEXIFUNCTION_COMMAND_ACK() { super(meta, 0); }

		public void command_type_SET(char src) //Command acknowledged
		{ set_bytes((char) (src) & -1L, 2, data, 0); }

		public void result_SET(char src) //result of acknowledge
		{ set_bytes((char) (src) & -1L, 2, data, 2); }
	 ...
	 */
	public static class SERIAL_UDB_EXTRA_F2_A extends Pack implements CommunicationChannel.Sendable {

		SERIAL_UDB_EXTRA_F2_A() { super(meta, 0); }

		public void sue_waypoint_index_SET(char src) //Serial UDB Extra Waypoint Index
		{ set_bytes((char) (src) & -1L, 2, data, 0); }

		public void sue_cog_SET(char src) //Serial UDB Extra GPS Course Over Ground
		{ set_bytes((char) (src) & -1L, 2, data, 2); }

		public void sue_cpu_load_SET(char src) //Serial UDB Extra CPU Load
		{ set_bytes((char) (src) & -1L, 2, data, 4); }

		public void sue_air_speed_3DIMU_SET(char src) //Serial UDB Extra 3D IMU Air Speed
		{ set_bytes((char) (src) & -1L, 2, data, 6); }

		public void sue_time_SET(long src) //Serial UDB Extra Time
		{ set_bytes((src) & -1L, 4, data, 8); }

		public void sue_status_SET(char src) //Serial UDB Extra Status
		{ set_bytes((char) (src) & -1L, 1, data, 12); }

		public void sue_latitude_SET(int src) //Serial UDB Extra Latitude
		{ set_bytes((int) (src) & -1L, 4, data, 13); }

		public void sue_longitude_SET(int src) //Serial UDB Extra Longitude
		{ set_bytes((int) (src) & -1L, 4, data, 17); }

		public void sue_altitude_SET(int src) //Serial UDB Extra Altitude
		{ set_bytes((int) (src) & -1L, 4, data, 21); }

		public void sue_rmat0_SET(short src) //Serial UDB Extra Rmat 0
		{ set_bytes((short) (src) & -1L, 2, data, 25); }

		public void sue_rmat1_SET(short src) //Serial UDB Extra Rmat 1
		{ set_bytes((short) (src) & -1L, 2, data, 27); }

		public void sue_rmat2_SET(short src) //Serial UDB Extra Rmat 2
		{ set_bytes((short) (src) & -1L, 2, data, 29); }

		public void sue_rmat3_SET(short src) //Serial UDB Extra Rmat 3
		{ set_bytes((short) (src) & -1L, 2, data, 31); }

		public void sue_rmat4_SET(short src) //Serial UDB Extra Rmat 4
		{ set_bytes((short) (src) & -1L, 2, data, 33); }

		public void sue_rmat5_SET(short src) //Serial UDB Extra Rmat 5
		{ set_bytes((short) (src) & -1L, 2, data, 35); }

		public void sue_rmat6_SET(short src) //Serial UDB Extra Rmat 6
		{ set_bytes((short) (src) & -1L, 2, data, 37); }

		public void sue_rmat7_SET(short src) //Serial UDB Extra Rmat 7
		{ set_bytes((short) (src) & -1L, 2, data, 39); }

		public void sue_rmat8_SET(short src) //Serial UDB Extra Rmat 8
		{ set_bytes((short) (src) & -1L, 2, data, 41); }

		public void sue_sog_SET(short src) //Serial UDB Extra Speed Over Ground
		{ set_bytes((short) (src) & -1L, 2, data, 43); }

		public void sue_estimated_wind_0_SET(short src) //Serial UDB Extra Estimated Wind 0
		{ set_bytes((short) (src) & -1L, 2, data, 45); }

		public void sue_estimated_wind_1_SET(short src) //Serial UDB Extra Estimated Wind 1
		{ set_bytes((short) (src) & -1L, 2, data, 47); }

		public void sue_estimated_wind_2_SET(short src) //Serial UDB Extra Estimated Wind 2
		...
		public void sue_svs_SET(short src) //Serial UDB Extra Number of Sattelites in View
		{ set_bytes((short) (src) & -1L, 2, data, 57); }

		public void sue_hdop_SET(short src) //Serial UDB Extra GPS Horizontal Dilution of Precision
	 ...
	 */
	public static class SERIAL_UDB_EXTRA_F2_B extends Pack implements CommunicationChannel.Sendable {
		...
		public void sue_flags_SET(long src) //Serial UDB Extra Status Flags
		{ set_bytes((src) & -1L, 4, data, 4); }

		public void sue_pwm_input_1_SET(short src) //Serial UDB Extra PWM Input Channel 1
		{ set_bytes((short) (src) & -1L, 2, data, 8); }

		public void sue_pwm_input_2_SET(short src) //Serial UDB Extra PWM Input Channel 2
		{ set_bytes((short) (src) & -1L, 2, data, 10); }

		public void sue_pwm_input_3_SET(short src) //Serial UDB Extra PWM Input Channel 3
		{ set_bytes((short) (src) & -1L, 2, data, 12); }

		public void sue_pwm_input_4_SET(short src) //Serial UDB Extra PWM Input Channel 4
		{ set_bytes((short) (src) & -1L, 2, data, 14); }

		public void sue_pwm_input_5_SET(short src) //Serial UDB Extra PWM Input Channel 5
		{ set_bytes((short) (src) & -1L, 2, data, 16); }

		public void sue_pwm_input_6_SET(short src) //Serial UDB Extra PWM Input Channel 6
		{ set_bytes((short) (src) & -1L, 2, data, 18); }

		public void sue_pwm_input_7_SET(short src) //Serial UDB Extra PWM Input Channel 7
		{ set_bytes((short) (src) & -1L, 2, data, 20); }

		public void sue_pwm_input_8_SET(short src) //Serial UDB Extra PWM Input Channel 8
		{ set_bytes((short) (src) & -1L, 2, data, 22); }

		public void sue_pwm_input_9_SET(short src) //Serial UDB Extra PWM Input Channel 9
		{ set_bytes((short) (src) & -1L, 2, data, 24); }

		public void sue_pwm_input_10_SET(short src) //Serial UDB Extra PWM Input Channel 10
		{ set_bytes((short) (src) & -1L, 2, data, 26); }

		public void sue_pwm_input_11_SET(short src) //Serial UDB Extra PWM Input Channel 11
		{ set_bytes((short) (src) & -1L, 2, data, 28); }

		public void sue_pwm_input_12_SET(short src) //Serial UDB Extra PWM Input Channel 12
		{ set_bytes((short) (src) & -1L, 2, data, 30); }

		public void sue_pwm_output_1_SET(short src) //Serial UDB Extra PWM Output Channel 1
		{ set_bytes((short) (src) & -1L, 2, data, 32); }

		public void sue_pwm_output_2_SET(short src) //Serial UDB Extra PWM Output Channel 2
		{ set_bytes((short) (src) & -1L, 2, data, 34); }

		public void sue_pwm_output_3_SET(short src) //Serial UDB Extra PWM Output Channel 3
		{ set_bytes((short) (src) & -1L, 2, data, 36); }

		public void sue_pwm_output_4_SET(short src) //Serial UDB Extra PWM Output Channel 4
		{ set_bytes((short) (src) & -1L, 2, data, 38); }

		public void sue_pwm_output_5_SET(short src) //Serial UDB Extra PWM Output Channel 5
		{ set_bytes((short) (src) & -1L, 2, data, 40); }

		public void sue_pwm_output_6_SET(short src) //Serial UDB Extra PWM Output Channel 6
		{ set_bytes((short) (src) & -1L, 2, data, 42); }

		public void sue_pwm_output_7_SET(short src) //Serial UDB Extra PWM Output Channel 7
		{ set_bytes((short) (src) & -1L, 2, data, 44); }

		public void sue_pwm_output_8_SET(short src) //Serial UDB Extra PWM Output Channel 8
		{ set_bytes((short) (src) & -1L, 2, data, 46); }

		public void sue_pwm_output_9_SET(short src) //Serial UDB Extra PWM Output Channel 9
		{ set_bytes((short) (src) & -1L, 2, data, 48); }

		public void sue_pwm_output_10_SET(short src) //Serial UDB Extra PWM Output Channel 10
		{ set_bytes((short) (src) & -1L, 2, data, 50); }

		public void sue_pwm_output_11_SET(short src) //Serial UDB Extra PWM Output Channel 11
		{ set_bytes((short) (src) & -1L, 2, data, 52); }

		public void sue_pwm_output_12_SET(short src) //Serial UDB Extra PWM Output Channel 12
		{ set_bytes((short) (src) & -1L, 2, data, 54); }

		public void sue_imu_location_x_SET(short src) //Serial UDB Extra IMU Location X
		{ set_bytes((short) (src) & -1L, 2, data, 56); }

		public void sue_imu_location_y_SET(short src) //Serial UDB Extra IMU Location Y
		{ set_bytes((short) (src) & -1L, 2, data, 58); }

		public void sue_imu_location_z_SET(short src) //Serial UDB Extra IMU Location Z
		{ set_bytes((short) (src) & -1L, 2, data, 60); }

		public void sue_location_error_earth_x_SET(short src) //Serial UDB Location Error Earth X
		{ set_bytes((short) (src) & -1L, 2, data, 62); }

		public void sue_location_error_earth_y_SET(short src) //Serial UDB Location Error Earth Y
		{ set_bytes((short) (src) & -1L, 2, data, 64); }

		public void sue_location_error_earth_z_SET(short src) //Serial UDB Location Error Earth Z
		{ set_bytes((short) (src) & -1L, 2, data, 66); }

		public void sue_osc_fails_SET(short src) //Serial UDB Extra Oscillator Failure Count
		{ set_bytes((short) (src) & -1L, 2, data, 68); }

		public void sue_imu_velocity_x_SET(short src) //Serial UDB Extra IMU Velocity X
		{ set_bytes((short) (src) & -1L, 2, data, 70); }

		public void sue_imu_velocity_y_SET(short src) //Serial UDB Extra IMU Velocity Y
		{ set_bytes((short) (src) & -1L, 2, data, 72); }

		public void sue_imu_velocity_z_SET(short src) //Serial UDB Extra IMU Velocity Z
		{ set_bytes((short) (src) & -1L, 2, data, 74); }

		public void sue_waypoint_goal_x_SET(short src) //Serial UDB Extra Current Waypoint Goal X
		{ set_bytes((short) (src) & -1L, 2, data, 76); }

		public void sue_waypoint_goal_y_SET(short src) //Serial UDB Extra Current Waypoint Goal Y
		{ set_bytes((short) (src) & -1L, 2, data, 78); }

		public void sue_waypoint_goal_z_SET(short src) //Serial UDB Extra Current Waypoint Goal Z
		{ set_bytes((short) (src) & -1L, 2, data, 80); }

		public void sue_aero_x_SET(short src) //Aeroforce in UDB X Axis
		{ set_bytes((short) (src) & -1L, 2, data, 82); }

		public void sue_aero_y_SET(short src) //Aeroforce in UDB Y Axis
		{ set_bytes((short) (src) & -1L, 2, data, 84); }

		public void sue_aero_z_SET(short src) //Aeroforce in UDB Z axis
		{ set_bytes((short) (src) & -1L, 2, data, 86); }

		public void sue_barom_temp_SET(short src) //SUE barometer temperature
		{ set_bytes((short) (src) & -1L, 2, data, 88); }

		public void sue_barom_press_SET(int src) //SUE barometer pressure
		{ set_bytes((int) (src) & -1L, 4, data, 90); }

		public void sue_barom_alt_SET(int src) //SUE barometer altitude
		{ set_bytes((int) (src) & -1L, 4, data, 94); }

		public void sue_bat_volt_SET(short src) //SUE battery voltage
		{ set_bytes((short) (src) & -1L, 2, data, 98); }

		public void sue_bat_amp_SET(short src) //SUE battery current
		{ set_bytes((short) (src) & -1L, 2, data, 100); }

		public void sue_bat_amp_hours_SET(short src) //SUE battery milli amp hours used
		{ set_bytes((short) (src) & -1L, 2, data, 102); }

		public void sue_desired_height_SET(short src) //Sue autopilot desired height
		{ set_bytes((short) (src) & -1L, 2, data, 104); }

		public void sue_memory_stack_free_SET(short src) //Serial UDB Extra Stack Memory Free
	 ...
	 */
	public static class SERIAL_UDB_EXTRA_F4 extends Pack implements CommunicationChannel.Sendable {

		SERIAL_UDB_EXTRA_F4() { super(meta, 0); }

		public void sue_ROLL_STABILIZATION_AILERONS_SET(char src) //Serial UDB Extra Roll Stabilization with Ailerons Enabled
		{ set_bytes((char) (src) & -1L, 1, data, 0); }

		public void sue_ROLL_STABILIZATION_RUDDER_SET(char src) //Serial UDB Extra Roll Stabilization with Rudder Enabled
		{ set_bytes((char) (src) & -1L, 1, data, 1); }

		public void sue_PITCH_STABILIZATION_SET(char src) //Serial UDB Extra Pitch Stabilization Enabled
		{ set_bytes((char) (src) & -1L, 1, data, 2); }

		public void sue_YAW_STABILIZATION_RUDDER_SET(char src) //Serial UDB Extra Yaw Stabilization using Rudder Enabled
		{ set_bytes((char) (src) & -1L, 1, data, 3); }

		public void sue_YAW_STABILIZATION_AILERON_SET(char src) //Serial UDB Extra Yaw Stabilization using Ailerons Enabled
		{ set_bytes((char) (src) & -1L, 1, data, 4); }

		public void sue_AILERON_NAVIGATION_SET(char src) //Serial UDB Extra Navigation with Ailerons Enabled
		{ set_bytes((char) (src) & -1L, 1, data, 5); }

		public void sue_RUDDER_NAVIGATION_SET(char src) //Serial UDB Extra Navigation with Rudder Enabled
		{ set_bytes((char) (src) & -1L, 1, data, 6); }

		public void sue_ALTITUDEHOLD_STABILIZED_SET(char src) //Serial UDB Extra Type of Alitude Hold when in Stabilized Mode
		{ set_bytes((char) (src) & -1L, 1, data, 7); }

		public void sue_ALTITUDEHOLD_WAYPOINT_SET(char src) //Serial UDB Extra Type of Alitude Hold when in Waypoint Mode
		{ set_bytes((char) (src) & -1L, 1, data, 8); }

		public void sue_RACING_MODE_SET(char src) //Serial UDB Extra Firmware racing mode enabled
		{ set_bytes((char) (src) & -1L, 1, data, 9); }
	 ...
	 */
	public static class SERIAL_UDB_EXTRA_F5 extends Pack implements CommunicationChannel.Sendable {

		SERIAL_UDB_EXTRA_F5() { super(meta, 0); }

		public void sue_YAWKP_AILERON_SET(float src) //Serial UDB YAWKP_AILERON Gain for Proporional control of navigation
		{ set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 0); }

		public void sue_YAWKD_AILERON_SET(float src) //Serial UDB YAWKD_AILERON Gain for Rate control of navigation
		{ set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 4); }

		public void sue_ROLLKP_SET(float src) //Serial UDB Extra ROLLKP Gain for Proportional control of roll stabilization
		{ set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 8); }

		public void sue_ROLLKD_SET(float src) //Serial UDB Extra ROLLKD Gain for Rate control of roll stabilization
		{ set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 12); }
	 ...
	 */
	public static class SERIAL_UDB_EXTRA_F6 extends Pack implements CommunicationChannel.Sendable {

		SERIAL_UDB_EXTRA_F6() { super(meta, 0); }

		public void sue_PITCHGAIN_SET(float src) //Serial UDB Extra PITCHGAIN Proportional Control
		{ set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 0); }

		public void sue_PITCHKD_SET(float src) //Serial UDB Extra Pitch Rate Control
		{ set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 4); }

		public void sue_RUDDER_ELEV_MIX_SET(float src) //Serial UDB Extra Rudder to Elevator Mix
		{ set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 8); }

		public void sue_ROLL_ELEV_MIX_SET(float src) //Serial UDB Extra Roll to Elevator Mix
		{ set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 12); }

		public void sue_ELEVATOR_BOOST_SET(float src) //Gain For Boosting Manual Elevator control When Plane Stabilized
		{ set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 16); }
	 ...
	 */
	public static class SERIAL_UDB_EXTRA_F7 extends Pack implements CommunicationChannel.Sendable {

		SERIAL_UDB_EXTRA_F7() { super(meta, 0); }

		public void sue_YAWKP_RUDDER_SET(float src) //Serial UDB YAWKP_RUDDER Gain for Proporional control of navigation
		{ set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 0); }

		public void sue_YAWKD_RUDDER_SET(float src) //Serial UDB YAWKD_RUDDER Gain for Rate control of navigation
		{ set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 4); }

		public void sue_ROLLKP_RUDDER_SET(float src) //Serial UDB Extra ROLLKP_RUDDER Gain for Proportional control of roll stabilization
		{ set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 8); }

		public void sue_ROLLKD_RUDDER_SET(float src) //Serial UDB Extra ROLLKD_RUDDER Gain for Rate control of roll stabilization
		{ set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 12); }

		public void sue_RUDDER_BOOST_SET(float src) //SERIAL UDB EXTRA Rudder Boost Gain to Manual Control when stabilized
		{ set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 16); }

		public void sue_RTL_PITCH_DOWN_SET(float src) //Serial UDB Extra Return To Landing - Angle to Pitch Plane Down
		{ set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 20); }
	 ...
	 */
	public static class SERIAL_UDB_EXTRA_F8 extends Pack implements CommunicationChannel.Sendable {

		SERIAL_UDB_EXTRA_F8() { super(meta, 0); }

		public void sue_HEIGHT_TARGET_MAX_SET(float src) //Serial UDB Extra HEIGHT_TARGET_MAX
		{ set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 0); }

		public void sue_HEIGHT_TARGET_MIN_SET(float src) //Serial UDB Extra HEIGHT_TARGET_MIN
		{ set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 4); }

		public void sue_ALT_HOLD_THROTTLE_MIN_SET(float src) //Serial UDB Extra ALT_HOLD_THROTTLE_MIN
		{ set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 8); }

		public void sue_ALT_HOLD_THROTTLE_MAX_SET(float src) //Serial UDB Extra ALT_HOLD_THROTTLE_MAX
		{ set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 12); }

		public void sue_ALT_HOLD_PITCH_MIN_SET(float src) //Serial UDB Extra ALT_HOLD_PITCH_MIN
		{ set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 16); }

		public void sue_ALT_HOLD_PITCH_MAX_SET(float src) //Serial UDB Extra ALT_HOLD_PITCH_MAX
		{ set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 20); }

		public void sue_ALT_HOLD_PITCH_HIGH_SET(float src) //Serial UDB Extra ALT_HOLD_PITCH_HIGH
		{ set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 24); }
	 ...
	 */
	public static class SERIAL_UDB_EXTRA_F13 extends Pack implements CommunicationChannel.Sendable {

		SERIAL_UDB_EXTRA_F13() { super(meta, 0); }

		public void sue_week_no_SET(short src) //Serial UDB Extra GPS Week Number
		{ set_bytes((short) (src) & -1L, 2, data, 0); }

		public void sue_lat_origin_SET(int src) //Serial UDB Extra MP Origin Latitude
		{ set_bytes((int) (src) & -1L, 4, data, 2); }

		public void sue_lon_origin_SET(int src) //Serial UDB Extra MP Origin Longitude
		{ set_bytes((int) (src) & -1L, 4, data, 6); }

		public void sue_alt_origin_SET(int src) //Serial UDB Extra MP Origin Altitude Above Sea Level
		{ set_bytes((int) (src) & -1L, 4, data, 10); }
	 ...
	 */
	public static class SERIAL_UDB_EXTRA_F14 extends Pack implements CommunicationChannel.Sendable {

		SERIAL_UDB_EXTRA_F14() { super(meta, 0); }

		public void sue_TRAP_SOURCE_SET(long src) //Serial UDB Extra Type Program Address of Last Trap
		{ set_bytes((src) & -1L, 4, data, 0); }

		public void sue_WIND_ESTIMATION_SET(char src) //Serial UDB Extra Wind Estimation Enabled
		{ set_bytes((char) (src) & -1L, 1, data, 4); }

		public void sue_GPS_TYPE_SET(char src) //Serial UDB Extra Type of GPS Unit
		{ set_bytes((char) (src) & -1L, 1, data, 5); }

		public void sue_DR_SET(char src) //Serial UDB Extra Dead Reckoning Enabled
		{ set_bytes((char) (src) & -1L, 1, data, 6); }

		public void sue_BOARD_TYPE_SET(char src) //Serial UDB Extra Type of UDB Hardware
		{ set_bytes((char) (src) & -1L, 1, data, 7); }

		public void sue_AIRFRAME_SET(char src) //Serial UDB Extra Type of Airframe
		{ set_bytes((char) (src) & -1L, 1, data, 8); }

		public void sue_RCON_SET(short src) //Serial UDB Extra Reboot Register of DSPIC
		{ set_bytes((short) (src) & -1L, 2, data, 9); }

		public void sue_TRAP_FLAGS_SET(short src) //Serial UDB Extra  Last dspic Trap Flags
		{ set_bytes((short) (src) & -1L, 2, data, 11); }

		public void sue_osc_fail_count_SET(short src) //Serial UDB Extra Number of Ocillator Failures
		{ set_bytes((short) (src) & -1L, 2, data, 13); }

		public void sue_CLOCK_CONFIG_SET(char src) //Serial UDB Extra UDB Internal Clock Configuration
		{ set_bytes((char) (src) & -1L, 1, data, 15); }

		public void sue_FLIGHT_PLAN_TYPE_SET(char src) //Serial UDB Extra Type of Flight Plan
		{ set_bytes((char) (src) & -1L, 1, data, 16); }
	 ...
	 */
	public static class SERIAL_UDB_EXTRA_F15 extends Pack implements CommunicationChannel.Sendable {

		SERIAL_UDB_EXTRA_F15() { super(meta, 0); }

		public void sue_ID_VEHICLE_MODEL_NAME_SET(char[] src, int pos)  //Serial UDB Extra Model Name Of Vehicle
		{
			for (int BYTE = 0, src_max = pos + 40; pos < src_max; pos++, BYTE += 1)
				set_bytes((char) (src[pos]) & -1L, 1, data, BYTE);
		}

		public void sue_ID_VEHICLE_REGISTRATION_SET(char[] src, int pos)  //Serial UDB Extra Registraton Number of Vehicle
		{
	 ...
	 */
	public static class SERIAL_UDB_EXTRA_F16 extends Pack implements CommunicationChannel.Sendable {

		SERIAL_UDB_EXTRA_F16() { super(meta, 0); }

		public void sue_ID_LEAD_PILOT_SET(char[] src, int pos)  //Serial UDB Extra Name of Expected Lead Pilot
		{
			for (int BYTE = 0, src_max = pos + 40; pos < src_max; pos++, BYTE += 1)
				set_bytes((char) (src[pos]) & -1L, 1, data, BYTE);
		}

		public void sue_ID_DIY_DRONES_URL_SET(char[] src, int pos)  //Serial UDB Extra URL of Lead Pilot or Team
		{
	 ...
	 */
	public static class ALTITUDES extends Pack implements CommunicationChannel.Sendable {
		...
		public void alt_gps_SET(int src) //GPS altitude in meters, expressed as * 1000 (millimeters), above MSL
		{ set_bytes((int) (src) & -1L, 4, data, 4); }
	 ...
	 */
	public static class AIRSPEEDS extends Pack implements CommunicationChannel.Sendable {
		...
		public void airspeed_imu_SET(short src) //Airspeed estimate from IMU, cm/s
		{ set_bytes((short) (src) & -1L, 2, data, 4); }

		public void airspeed_pitot_SET(short src) //Pitot measured forward airpseed, cm/s
		{ set_bytes((short) (src) & -1L, 2, data, 6); }

		public void airspeed_hot_wire_SET(short src) //Hot wire anenometer measured airspeed, cm/s
		{ set_bytes((short) (src) & -1L, 2, data, 8); }

		public void airspeed_ultrasonic_SET(short src) //Ultrasonic measured airspeed, cm/s
		{ set_bytes((short) (src) & -1L, 2, data, 10); }

		public void aoa_SET(short src) //Angle of attack sensor, degrees * 10
		{ set_bytes((short) (src) & -1L, 2, data, 12); }

		public void aoy_SET(short src) //Yaw angle sensor, degrees * 10
		{ set_bytes((short) (src) & -1L, 2, data, 14); }
	 ...
	 */
	public static class SERIAL_UDB_EXTRA_F17 extends Pack implements CommunicationChannel.Sendable {

		SERIAL_UDB_EXTRA_F17() { super(meta, 0); }

		public void sue_feed_forward_SET(float src) //SUE Feed Forward Gain
		{ set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 0); }

		public void sue_turn_rate_nav_SET(float src) //SUE Max Turn Rate when Navigating
		{ set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 4); }

		public void sue_turn_rate_fbw_SET(float src) //SUE Max Turn Rate in Fly By Wire Mode
		{ set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 8); }
	 ...
	 */
	public static class SERIAL_UDB_EXTRA_F18 extends Pack implements CommunicationChannel.Sendable {

		SERIAL_UDB_EXTRA_F18() { super(meta, 0); }

		public void angle_of_attack_normal_SET(float src) //SUE Angle of Attack Normal
		{ set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 0); }

		public void angle_of_attack_inverted_SET(float src) //SUE Angle of Attack Inverted
		{ set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 4); }

		public void elevator_trim_normal_SET(float src) //SUE Elevator Trim Normal
		{ set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 8); }

		public void elevator_trim_inverted_SET(float src) //SUE Elevator Trim Inverted
		{ set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 12); }

		public void reference_speed_SET(float src) //SUE reference_speed
		{ set_bytes(Float.floatToIntBits(src) & -1L, 4, data, 16); }
	 ...
	 */
	public static class SERIAL_UDB_EXTRA_F19 extends Pack implements CommunicationChannel.Sendable {

		SERIAL_UDB_EXTRA_F19() { super(meta, 0); }

		public void sue_aileron_output_channel_SET(char src) //SUE aileron output channel
		{ set_bytes((char) (src) & -1L, 1, data, 0); }

		public void sue_aileron_reversed_SET(char src) //SUE aileron reversed
		{ set_bytes((char) (src) & -1L, 1, data, 1); }

		public void sue_elevator_output_channel_SET(char src) //SUE elevator output channel
		{ set_bytes((char) (src) & -1L, 1, data, 2); }

		public void sue_elevator_reversed_SET(char src) //SUE elevator reversed
		{ set_bytes((char) (src) & -1L, 1, data, 3); }

		public void sue_throttle_output_channel_SET(char src) //SUE throttle output channel
		{ set_bytes((char) (src) & -1L, 1, data, 4); }

		public void sue_throttle_reversed_SET(char src) //SUE throttle reversed
		{ set_bytes((char) (src) & -1L, 1, data, 5); }

		public void sue_rudder_output_channel_SET(char src) //SUE rudder output channel
		{ set_bytes((char) (src) & -1L, 1, data, 6); }

		public void sue_rudder_reversed_SET(char src) //SUE rudder reversed
		{ set_bytes((char) (src) & -1L, 1, data, 7); }
	 ...
	 */
	public static class SERIAL_UDB_EXTRA_F20 extends Pack implements CommunicationChannel.Sendable {

		SERIAL_UDB_EXTRA_F20() { super(meta, 0); }

		public void sue_number_of_inputs_SET(char src) //SUE Number of Input Channels
		{ set_bytes((char) (src) & -1L, 1, data, 0); }

		public void sue_trim_value_input_1_SET(short src) //SUE UDB PWM Trim Value on Input 1
		{ set_bytes((short) (src) & -1L, 2, data, 1); }

		public void sue_trim_value_input_2_SET(short src) //SUE UDB PWM Trim Value on Input 2
		{ set_bytes((short) (src) & -1L, 2, data, 3); }

		public void sue_trim_value_input_3_SET(short src) //SUE UDB PWM Trim Value on Input 3
		{ set_bytes((short) (src) & -1L, 2, data, 5); }

		public void sue_trim_value_input_4_SET(short src) //SUE UDB PWM Trim Value on Input 4
		{ set_bytes((short) (src) & -1L, 2, data, 7); }

		public void sue_trim_value_input_5_SET(short src) //SUE UDB PWM Trim Value on Input 5
		{ set_bytes((short) (src) & -1L, 2, data, 9); }

		public void sue_trim_value_input_6_SET(short src) //SUE UDB PWM Trim Value on Input 6
		{ set_bytes((short) (src) & -1L, 2, data, 11); }

		public void sue_trim_value_input_7_SET(short src) //SUE UDB PWM Trim Value on Input 7
		{ set_bytes((short) (src) & -1L, 2, data, 13); }

		public void sue_trim_value_input_8_SET(short src) //SUE UDB PWM Trim Value on Input 8
		{ set_bytes((short) (src) & -1L, 2, data, 15); }

		public void sue_trim_value_input_9_SET(short src) //SUE UDB PWM Trim Value on Input 9
		{ set_bytes((short) (src) & -1L, 2, data, 17); }

		public void sue_trim_value_input_10_SET(short src) //SUE UDB PWM Trim Value on Input 10
		{ set_bytes((short) (src) & -1L, 2, data, 19); }

		public void sue_trim_value_input_11_SET(short src) //SUE UDB PWM Trim Value on Input 11
		{ set_bytes((short) (src) & -1L, 2, data, 21); }

		public void sue_trim_value_input_12_SET(short src) //SUE UDB PWM Trim Value on Input 12
		{ set_bytes((short) (src) & -1L, 2, data, 23); }
	 ...
	 */
	public static class SERIAL_UDB_EXTRA_F21 extends Pack implements CommunicationChannel.Sendable {

		SERIAL_UDB_EXTRA_F21() { super(meta, 0); }

		public void sue_accel_x_offset_SET(short src) //SUE X accelerometer offset
		{ set_bytes((short) (src) & -1L, 2, data, 0); }

		public void sue_accel_y_offset_SET(short src) //SUE Y accelerometer offset
		{ set_bytes((short) (src) & -1L, 2, data, 2); }

		public void sue_accel_z_offset_SET(short src) //SUE Z accelerometer offset
		{ set_bytes((short) (src) & -1L, 2, data, 4); }

		public void sue_gyro_x_offset_SET(short src) //SUE X gyro offset
		{ set_bytes((short) (src) & -1L, 2, data, 6); }

		public void sue_gyro_y_offset_SET(short src) //SUE Y gyro offset
		{ set_bytes((short) (src) & -1L, 2, data, 8); }

		public void sue_gyro_z_offset_SET(short src) //SUE Z gyro offset
		{ set_bytes((short) (src) & -1L, 2, data, 10); }
	 ...
	 */
	public static class SERIAL_UDB_EXTRA_F22 extends Pack implements CommunicationChannel.Sendable {

		SERIAL_UDB_EXTRA_F22() { super(meta, 0); }

		public void sue_accel_x_at_calibration_SET(short src) //SUE X accelerometer at calibration time
		{ set_bytes((short) (src) & -1L, 2, data, 0); }

		public void sue_accel_y_at_calibration_SET(short src) //SUE Y accelerometer at calibration time
		{ set_bytes((short) (src) & -1L, 2, data, 2); }

		public void sue_accel_z_at_calibration_SET(short src) //SUE Z accelerometer at calibration time
		{ set_bytes((short) (src) & -1L, 2, data, 4); }

		public void sue_gyro_x_at_calibration_SET(short src) //SUE X gyro at calibration time
		{ set_bytes((short) (src) & -1L, 2, data, 6); }

		public void sue_gyro_y_at_calibration_SET(short src) //SUE Y gyro at calibration time
		{ set_bytes((short) (src) & -1L, 2, data, 8); }

		public void sue_gyro_z_at_calibration_SET(short src) //SUE Z gyro at calibration time
		{ set_bytes((short) (src) & -1L, 2, data, 10); }
	...
	public static class HOME_POSITION extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(242, 0, 0, 0, 53, 416, 0, _vZ);
	}
	...
	public static class SET_HOME_POSITION extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(243, 0, 0, 0, 54, 424, 0, _dF);
	}
	...
	public static class ADSB_VEHICLE extends Pack implements CommunicationChannel.Sendable {
		...
		{callsign_SET(src.toCharArray(), 0, src.length(), ph);}

		public void callsign_SET(char[] src, int pos, int items, Bounds.Inside ph) //The callsign, 8+null
		{
		...
		static final Meta meta = new Meta(246, 3, 1, 0, 28, 210, 0, _AF);
	}
	...
	public static class DEBUG_VECT extends Pack implements CommunicationChannel.Sendable {
		...
		{name_SET(src.toCharArray(), 0, src.length(), ph);}

		public void name_SET(char[] src, int pos, int items, Bounds.Inside ph) //Name
		{
		...
		static final Meta meta = new Meta(250, 0, 0, 1, 21, 160, 0, _JF);
	}
	...
	public static class NAMED_VALUE_FLOAT extends Pack implements CommunicationChannel.Sendable {
		...
		public void name_SET(char[] src, int pos, int items, Bounds.Inside ph) //Name of the debug variable
		{
		...
		static final Meta meta = new Meta(251, 0, 1, 0, 9, 64, 0, _vF);
	}
	...
	public static class NAMED_VALUE_INT extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(252, 0, 1, 0, 9, 64, 0, _qB);
	}
	...
	public static class STATUSTEXT extends Pack implements CommunicationChannel.Sendable {
		...
		{text_SET(src.toCharArray(), 0, src.length(), ph);}

		public void text_SET(char[] src, int pos, int items, Bounds.Inside ph) //Status text message, without null termination character
		{
		...
		static final Meta meta = new Meta(253, 0, 0, 0, 2, 4, 0, _GB);
	}
	...
	public static class PLAY_TUNE extends Pack implements CommunicationChannel.Sendable {
		...
		{tune_SET(src.toCharArray(), 0, src.length(), ph);}

		public void tune_SET(char[] src, int pos, int items, Bounds.Inside ph) //tune in board specific format
		{
		...
		static final Meta meta = new Meta(258, 0, 0, 0, 3, 16, 0, _DB);
	}
	...
	public static class CAMERA_INFORMATION extends Pack implements CommunicationChannel.Sendable {
		...
		{cam_definition_uri_SET(src.toCharArray(), 0, src.length(), ph);}

		public void cam_definition_uri_SET(char[] src, int pos, int items, Bounds.Inside ph) //Camera definition URI (if any, otherwise only basic functions will be available).
		{
		...
		static final Meta meta = new Meta(259, 3, 2, 0, 93, 731, 0, _SB);
	}
	...
	public static class CAMERA_IMAGE_CAPTURED extends Pack implements CommunicationChannel.Sendable {
		...
		{file_url_SET(src.toCharArray(), 0, src.length(), ph);}

		public void file_url_SET(char[] src, int pos, int items, Bounds.Inside ph) //URL of image taken. Either local storage or http:foo.jpg if camera provides an HTTP interface.
		{
		...
		static final Meta meta = new Meta(263, 0, 1, 1, 51, 402, 2, _Ks);
	}
	...
	public static class VIDEO_STREAM_INFORMATION extends Pack implements CommunicationChannel.Sendable {
		...
		{uri_SET(src.toCharArray(), 0, src.length(), ph);}

		public void uri_SET(char[] src, int pos, int items, Bounds.Inside ph) //Video stream URI
		{
		...
		static final Meta meta = new Meta(269, 3, 1, 0, 17, 130, 2, _hs);
	}
	...
	public static class SET_VIDEO_STREAM_SETTINGS extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(270, 3, 1, 0, 18, 138, 2, _Ns);
	}
	...
	public static class WIFI_CONFIG_AP extends Pack implements CommunicationChannel.Sendable {
		...
		{ssid_SET(src.toCharArray(), 0, src.length(), ph);}

		public void ssid_SET(char[] src, int pos, int items, Bounds.Inside ph) //Name of Wi-Fi network (SSID). Leave it blank to leave it unchanged.
		{
		...
		{password_SET(src.toCharArray(), 0, src.length(), ph);}

		public void password_SET(char[] src, int pos, int items, Bounds.Inside ph) //Password. Leave it blank for an open AP.
		{
		...
		static final Meta meta = new Meta(299, 0, 0, 0, 1, 2, 2, _bs, _Xs);
	}
	...
	public static class UAVCAN_NODE_INFO extends Pack implements CommunicationChannel.Sendable {
		...
		public void name_SET(char[] src, int pos, int items, Bounds.Inside ph) //Node name string. For example, "sapog.px4.io".
		{
		...
		static final Meta meta = new Meta(311, 0, 2, 1, 37, 288, 0, _dA);
	}
	...
	public static class PARAM_EXT_REQUEST_READ extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(320, 0, 0, 0, 5, 32, 0, _ZA);
	}
	...
	public static class PARAM_EXT_VALUE extends Pack implements CommunicationChannel.Sendable {
		...
		{param_value_SET(src.toCharArray(), 0, src.length(), ph);}

		public void param_value_SET(char[] src, int pos, int items, Bounds.Inside ph) //Parameter value
		{
		...
		static final Meta meta = new Meta(322, 2, 0, 0, 5, 38, 2, _AA, _gA);
	}
	...
	public static class PARAM_EXT_SET extends Pack implements CommunicationChannel.Sendable {
		...
		static final Meta meta = new Meta(323, 0, 0, 0, 3, 22, 2, _SA, _LA);
	}
	...
	public static class PARAM_EXT_ACK extends Pack implements CommunicationChannel.Sendable {
		...
		public void param_value_SET(char[] src, int pos, int items, Bounds.Inside ph) //Parameter value (new value if PARAM_ACK_ACCEPTED, current value otherwise)
		{
		...
		static final Meta meta = new Meta(324, 0, 0, 0, 2, 9, 2, _WA, _yA);
	}
	...
	private static final Field _fQ = new Field(0, false, 1, 4, 1, 0, 0, 0);
	private static final Field _pQ = new Field(0, true, 1, 4, 1, 0, 0, 0);
	private static final Field _lQ = new Field(0, true, 1, 4, 1, 0, 0, 0);
	private static final Field _cQ = new Field(0, true, 1, 4, 1, 0, 0, 0);
	private static final Field _tQ = new Field(0, true, 1, 4, 1, 0, 0, 0);
	private static final Field _dG = new Field(0, true, 1, 2, 1, 0, 0, 0);
	private static final Field _fG = new Field(0, true, 1, 2, 1, 0, 0, 0);
	private static final Field _pG = new Field(0, true, 1, 2, 1, 0, 0, 0);
	private static final Field _lG = new Field(0, true, 1, 2, 1, 0, 0, 0);
	private static final Field _cG = new Field(0, true, 1, 2, 1, 0, 0, 0);
	private static final Field _tG = new Field(0, true, 1, 2, 1, 0, 0, 0);
	private static final Field _OG = new Field(0, true, 1, 2, 1, 0, 0, 0);
	private static final Field _DG = new Field(0, true, 1, 2, 1, 0, 0, 0);
	private static final Field _TP = new Field(0, true, 1, 8, 1, 0, 0, 0);
	private static final Field _sP = new Field(0, true, 1, 8, 1, 0, 0, 0);
	private static final Field _HP = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
	private static final Field _gu = new Field(0, false, 1, 1, 1, 0, 0, 0);
	private static final Field _Hu = new Field(0, false, 1, 4, 1, 0, 0, 0);
	private static final Field _Ru = new Field(0, false, 1, 1, 1, 0, 0, 0);
	private static final Field _eu = new Field(0, false, 1, 1, 1, 0, 0, 0);
	private static final Field _tf = new Field(0, false, 1, 4, 1, 0, 0, 0);
	private static final Field _Of = new Field(0, false, 1, 4, 1, 0, 0, 0);
	private static final Field _KT = new Field(0, false, 18, 1, 1, 0, 0, 0);
	private static final Field _tT = new Field(0, false, 1, 4, 1, 0, 0, 0);
	private static final Field _OT = new Field(0, false, 1, 4, 1, 0, 0, 0);
	private static final Field _DT = new Field(0, false, 1, 4, 1, 0, 0, 0);
	private static final Field _TT = new Field(0, false, 4, 4, 1, 0, 0, 0);
	private static final Field _FT = new Field(0, false, 1, 1, 1, 0, 0, 0);
	private static final Field _vZ = new Field(0, true, 1, 8, 1, 0, 0, 0);
	private static final Field _dF = new Field(0, true, 1, 8, 1, 0, 0, 0);
	private static final Field _AF = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
	private static final Field _JF = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
	private static final Field _vF = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
	private static final Field _qB = new Field(5, true, -4, 2, 1, 0, 0, 0, 1);
	private static final Field _GB = new Field(5, true, -6, 2, 1, 0, 0, 0, 1);
	private static final Field _DB = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
	private static final Field _SB = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
	private static final Field _Ks = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
	private static final Field _hs = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
	private static final Field _Ns = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
	private static final Field _bs = new Field(5, true, -6, 2, 1, 0, 0, 0, 1);
	private static final Field _Xs = new Field(5, true, -7, 2, 1, 0, 0, 0, 1);
	private static final Field _dA = new Field(5, true, -7, 2, 1, 0, 0, 0, 1);
	private static final Field _ZA = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
	private static final Field _AA = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
	private static final Field _gA = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
	private static final Field _SA = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
	private static final Field _LA = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
	private static final Field _WA = new Field(5, true, -5, 2, 1, 0, 0, 0, 1);
	private static final Field _yA = new Field(5, true, -8, 2, 1, 0, 0, 0, 1);
