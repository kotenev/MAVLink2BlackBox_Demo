...
static const Field _yW = {0, false, 1, 4, 1, 0, 0, 0, 0   };
static const Field _FW = {0, true, 1, 4, 1, 0, 0, 0, 0   };
static const Field _kW = {0, true, 1, 4, 1, 0, 0, 0, 0   };
static const Field _uW = {0, true, 1, 4, 1, 0, 0, 0, 0   };
static const Field _pW = {0, true, 1, 4, 1, 0, 0, 0, 0   };
static const Field _jl = {0, true, 1, 2, 1, 0, 0, 0, 0   };
static const Field _yl = {0, true, 1, 2, 1, 0, 0, 0, 0   };
static const Field _Fl = {0, true, 1, 2, 1, 0, 0, 0, 0   };
static const Field _kl = {0, true, 1, 2, 1, 0, 0, 0, 0   };
static const Field _ul = {0, true, 1, 2, 1, 0, 0, 0, 0   };
static const Field _pl = {0, true, 1, 2, 1, 0, 0, 0, 0   };
static const Field _wl = {0, true, 1, 2, 1, 0, 0, 0, 0   };
static const Field _Sl = {0, true, 1, 2, 1, 0, 0, 0, 0   };
static const Field _cL = {0, true, 1, 8, 1, 0, 0, 0, 0   };
static const Field _DL = {0, true, 1, 8, 1, 0, 0, 0, 0   };
static const Field _CL = {5, true, -5, 2, 1, 0, 0, 0, 1, 1 };
static const Field _Ye = {0, false, 1, 1, 1, 0, 0, 0, 0   };
static const Field _Ce = {0, false, 1, 4, 1, 0, 0, 0, 0   };
static const Field _Ge = {0, false, 1, 1, 1, 0, 0, 0, 0   };
static const Field _se = {0, false, 1, 1, 1, 0, 0, 0, 0   };
static const Field _py = {0, false, 1, 4, 1, 0, 0, 0, 0   };
static const Field _wy = {0, false, 1, 4, 1, 0, 0, 0, 0   };
static const Field _Oc = {0, false, 18, 1, 1, 0, 0, 0, 0   };
static const Field _pc = {0, false, 1, 4, 1, 0, 0, 0, 0   };
static const Field _wc = {0, false, 1, 4, 1, 0, 0, 0, 0   };
static const Field _Sc = {0, false, 1, 4, 1, 0, 0, 0, 0   };
static const Field _cc = {0, false, 4, 4, 1, 0, 0, 0, 0   };
static const Field _Kc = {0, false, 1, 1, 1, 0, 0, 0, 0   };
static const Field _av = {0, true, 1, 8, 1, 0, 0, 0, 0   };
static const Field _jK = {0, true, 1, 8, 1, 0, 0, 0, 0   };
static const Field _NK = {5, true, -4, 2, 1, 0, 0, 0, 1, 1 };
static const Field _xK = {5, true, -4, 2, 1, 0, 0, 0, 1, 1 };
static const Field _aK = {5, true, -4, 2, 1, 0, 0, 0, 1, 1 };
static const Field _AI = {5, true, -4, 2, 1, 0, 0, 0, 1, 1 };
static const Field _lI = {5, true, -6, 2, 1, 0, 0, 0, 1, 1 };
static const Field _SI = {5, true, -5, 2, 1, 0, 0, 0, 1, 1 };
static const Field _oI = {5, true, -8, 2, 1, 0, 0, 0, 1, 1 };
static const Field _OD = {5, true, -8, 2, 1, 0, 0, 0, 1, 1 };
static const Field _hD = {5, true, -8, 2, 1, 0, 0, 0, 1, 1 };
static const Field _XD = {5, true, -8, 2, 1, 0, 0, 0, 1, 1 };
static const Field _JD = {5, true, -6, 2, 1, 0, 0, 0, 1, 1 };
static const Field _PD = {5, true, -7, 2, 1, 0, 0, 0, 1, 1 };
static const Field _jN = {5, true, -7, 2, 1, 0, 0, 0, 1, 1 };
static const Field _vN = {5, true, -5, 2, 1, 0, 0, 0, 1, 1 };
static const Field _NN = {5, true, -5, 2, 1, 0, 0, 0, 1, 1 };
static const Field _YN = {5, true, -8, 2, 1, 0, 0, 0, 1, 1 };
static const Field _oN = {5, true, -5, 2, 1, 0, 0, 0, 1, 1 };
static const Field _iN = {5, true, -8, 2, 1, 0, 0, 0, 1, 1 };
static const Field _QN = {5, true, -5, 2, 1, 0, 0, 0, 1, 1 };
static const Field _RN = {5, true, -8, 2, 1, 0, 0, 0, 1, 1 };
...
static const Field * meta20fields[] = {&_z};
...
static const Field * meta24fields[] = {&_yW, &_FW, &_kW, &_uW, &_pW};
...
static const Field * meta36fields[] = {&_jl, &_yl, &_Fl, &_kl, &_ul, &_pl, &_wl, &_Sl};
...
static const Field * meta48fields[] = {&_cL};
...
static const Field * meta49fields[] = {&_DL};
...
static const Field * meta50fields[] = {&_CL};
...
static const Field * meta77fields[] = {&_Ye, &_Ce, &_Ge, &_se};
...
static const Field * meta100fields[] = {&_py, &_wy};
...
static const Field * meta148fields[] = {&_Oc};
...
static const Field * meta149fields[] = {&_pc, &_wc, &_Sc, &_cc, &_Kc};
...
static const Field * meta242fields[] = {&_av};
...
static const Field * meta243fields[] = {&_jK};
...
static const Field * meta246fields[] = {&_NK};
...
static const Field * meta258fields[] = {&_SI};
static const Meta meta258 = {258, 0, 0, 0, 0, 16,  3, 1, (Field**)&meta258fields};
static const Field * meta259fields[] = {&_oI};
...
static const Field * meta263fields[] = {&_OD};
    ...
    for(bool LOOP = false;;)
    {
        switch(id)
        {
            ...
            case 150:
                ...
                c_CommunicationChannel_on_FLEXIFUNCTION_SET_150(&ph, pack); //handle received pack
                break;
            case 151:
                if(pack == NULL) //request to create new empty pack
                {
                ...
                c_CommunicationChannel_on_FLEXIFUNCTION_READ_REQ_151(&ph, pack); //handle received pack
                break;
            case 152:
                if(pack == NULL) //request to create new empty pack
                {
                ...
                c_CommunicationChannel_on_FLEXIFUNCTION_BUFFER_FUNCTION_152(&ph, pack); //handle received pack
                break;
            case 153:
                if(pack == NULL) //request to create new empty pack
                {
                ...
                c_CommunicationChannel_on_FLEXIFUNCTION_BUFFER_FUNCTION_ACK_153(&ph, pack); //handle received pack
                break;
            case 155:
                if(pack == NULL) //request to create new empty pack
                {
                ...
                c_CommunicationChannel_on_FLEXIFUNCTION_DIRECTORY_155(&ph, pack); //handle received pack
                break;
            case 156:
                if(pack == NULL) //request to create new empty pack
                {
                ...
                c_CommunicationChannel_on_FLEXIFUNCTION_DIRECTORY_ACK_156(&ph, pack); //handle received pack
                break;
            case 157:
                if(pack == NULL) //request to create new empty pack
                {
                ...
                c_CommunicationChannel_on_FLEXIFUNCTION_COMMAND_157(&ph, pack); //handle received pack
                break;
            case 158:
                if(pack == NULL) //request to create new empty pack
                {
                ...
                c_CommunicationChannel_on_FLEXIFUNCTION_COMMAND_ACK_158(&ph, pack); //handle received pack
                break;
            case 170:
                if(pack == NULL) //request to create new empty pack
                {
                ...
                c_CommunicationChannel_on_SERIAL_UDB_EXTRA_F2_A_170(&ph, pack); //handle received pack
                break;
            case 171:
                if(pack == NULL) //request to create new empty pack
                {
                ...
                c_CommunicationChannel_on_SERIAL_UDB_EXTRA_F2_B_171(&ph, pack); //handle received pack
                break;
            case 172:
                if(pack == NULL) //request to create new empty pack
                {
                ...
                c_CommunicationChannel_on_SERIAL_UDB_EXTRA_F4_172(&ph, pack); //handle received pack
                break;
            case 173:
                if(pack == NULL) //request to create new empty pack
                {
                ...
                c_CommunicationChannel_on_SERIAL_UDB_EXTRA_F5_173(&ph, pack); //handle received pack
                break;
            case 174:
                if(pack == NULL) //request to create new empty pack
                {
                ...
                c_CommunicationChannel_on_SERIAL_UDB_EXTRA_F6_174(&ph, pack); //handle received pack
                break;
            case 175:
                if(pack == NULL) //request to create new empty pack
                {
                ...
                c_CommunicationChannel_on_SERIAL_UDB_EXTRA_F7_175(&ph, pack); //handle received pack
                break;
            case 176:
                if(pack == NULL) //request to create new empty pack
                {
                ...
                c_CommunicationChannel_on_SERIAL_UDB_EXTRA_F8_176(&ph, pack); //handle received pack
                break;
            case 177:
                if(pack == NULL) //request to create new empty pack
                {
                ...
                c_CommunicationChannel_on_SERIAL_UDB_EXTRA_F13_177(&ph, pack); //handle received pack
                break;
            case 178:
                if(pack == NULL) //request to create new empty pack
                {
                ...
                c_CommunicationChannel_on_SERIAL_UDB_EXTRA_F14_178(&ph, pack); //handle received pack
                break;
            case 179:
                if(pack == NULL) //request to create new empty pack
                {
                ...
                c_CommunicationChannel_on_SERIAL_UDB_EXTRA_F15_179(&ph, pack); //handle received pack
                break;
            case 180:
                if(pack == NULL) //request to create new empty pack
                {
                ...
                c_CommunicationChannel_on_SERIAL_UDB_EXTRA_F16_180(&ph, pack); //handle received pack
                break;
            case 181:
                if(pack == NULL) //request to create new empty pack
                {
                ...
                c_CommunicationChannel_on_ALTITUDES_181(&ph, pack); //handle received pack
                break;
            case 182:
                if(pack == NULL) //request to create new empty pack
                {
                ...
                c_CommunicationChannel_on_AIRSPEEDS_182(&ph, pack); //handle received pack
                break;
            case 183:
                if(pack == NULL) //request to create new empty pack
                {
                ...
                c_CommunicationChannel_on_SERIAL_UDB_EXTRA_F17_183(&ph, pack); //handle received pack
                break;
            case 184:
                if(pack == NULL) //request to create new empty pack
                {
                ...
                c_CommunicationChannel_on_SERIAL_UDB_EXTRA_F18_184(&ph, pack); //handle received pack
                break;
            case 185:
                if(pack == NULL) //request to create new empty pack
                {
                ...
                c_CommunicationChannel_on_SERIAL_UDB_EXTRA_F19_185(&ph, pack); //handle received pack
                break;
            case 186:
                if(pack == NULL) //request to create new empty pack
                {
                ...
                c_CommunicationChannel_on_SERIAL_UDB_EXTRA_F20_186(&ph, pack); //handle received pack
                break;
            case 187:
                if(pack == NULL) //request to create new empty pack
                {
                ...
                c_CommunicationChannel_on_SERIAL_UDB_EXTRA_F21_187(&ph, pack); //handle received pack
                break;
            case 188:
                if(pack == NULL) //request to create new empty pack
                {
                ...
                c_CommunicationChannel_on_SERIAL_UDB_EXTRA_F22_188(&ph, pack); //handle received pack
                break;
            case 230:
                if(pack == NULL) //request to create new empty pack
                {
